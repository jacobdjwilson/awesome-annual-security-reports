...
### Open source in 2020
*A graphic is displayed showing the following data:*

**1,500+** CODEBASES AUDITED IN 2020

**17** INDUSTRIES REPRESENTED

**65%** OF CODEBASES HAD LICENSE CONFLICTS

**4.1** THE AVERAGE VULNERABILITY FOUND WAS YEARS OLD

**84%** OF CODEBASES HAD AT LEAST ONE VULNERABILITY WITH AN AVERAGE OF 528 PER CODEBASE

**91%** OF ALL CODEBASES WERE COMPOSED OF OPEN SOURCE

**C** **O** **D** **E** **B** **A** **S** **E** **S** **C** **O** **N** **T** **A** **I** **N** **E** **D** **O** **P** **E** **N** **S** **O** **U** **R** **C** **E**
...
Ed Tech 82%
Retail and E-Commerce 82%
Internet and Mobile Apps 81%
Big Data, AI, BI, Machine Learning 79%
Virtual Reality, Gaming, Entertainment, Media 76%
Enterprise Software/SaaS 76%
Internet and Software Infrastructure 74%
Aerospace, Aviation, Auto, Transportation, Logistics 72%
Telecommunications and Wireless 70%
Energy and Clean Tech 69%
Internet of Things 89%
Computer Hardware and Semiconductors 57%
Manufacturing, Industrials, Robotics 48%
Financial Services and FinTech 84%
...
**Percentage of Codebases Containing Components That Have Had No Development Activity Within the Past Two Years**
...
of building software—65%—have policies in place allowing their developers to contribute to open source projects.
...
**100+ BILLION LINES OF CODE SCANNED**
**10000+ ACTIVE PROJECTS SCANNED**
...
Memory corruptions (75)
Uninitialized variables (8)
Memory (illegal accesses) (4)
Various (1)
...
[^2]: David Sharp, L.L. Bean Sees Sales Boom Amid Pandemic’s Push to Outdoors, U.S. News, 3/19/2