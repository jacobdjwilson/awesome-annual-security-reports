...
![Graphic showing 50% of Board, CEO, and C-suite executives indicate cybersecurity is a high priority, while only 26% of employees view cybersecurity similarly.]
...
- **Breach History**: 75% of Critical Infrastructure SMBs experienced a breach at least once in company history; 45% experienced a breach within the past year.
- **Consequences**: On average, it took companies 7.5 months to fully recover from a breach. 59% reported the breach stopped daily productivity; 46% lost customers. Companies spent $170,000 on average to resolve a cyber breach.

### Preparedness
- **Confidence**: 72% of SMBs surveyed believe their organization is prepared to some extent to prevent or recover from a cyberattack.
- **Actions in Support of Resiliency**: 87% have cybersecurity policies and procedures in place; 74% completed a cyber risk assessment within the past 12 months; 75% have existing cybersecurity insurance policies; 52% use an outsourced cybersecurity provider; 13% used government guidance to make cybersecurity decisions; 26% of IT budgets are used for cybersecurity.
...
Survey findings suggest Critical Infrastructure SMB enterprises are distinctly vulnerable to breaches that can take longer to detect and from which to recover. Heightened vulnerabilities are evident across the following vectors — social media; electronically held customer information; online bank accounts; VPNs; social engineering; and industrial control systems. To improve the cyber defensive postures of Critical Infrastructure SMBs and SMBs more generally, both enterprises and policymakers must take deliberate, focused, and prioritized action.

#### Top Recommendations for SMBs
- Conduct regular cybersecurity training and test staff based on readily available best practices and controls.
- Revisit and update policies and procedures annually.
- Update system configurations and have structured protocols in place to patch vulnerabilities.
- Conduct annual risk assessments that put cyber risks in empirical and economic terms.
- Conduct post-breach assessments and communicate findings to appropriate management.
- Annually evaluate in-house capabilities and consider retaining outsourced, managed service providers.
- Obtain cyber insurance and review policies annually.
- Identify and participate in valuable formal and informal information sharing venues.
- Establish regular briefings for appropriate levels of management and senior executives.
- Dedicate at least 10-15% of their IT budget toward cybersecurity.
...
Criminals are incentivized to steal data from large and small businesses alike. As such, breaches targeting SMBs are increasing in frequency, impact, and size.[^7] 53% of survey respondents reported an increase in phishing since the start of the coronavirus pandemic and 37% have experienced a cyber breach in the same timeframe.

#### Common Experiences of Critical Infrastructure SMBs
SMBs that experienced a cyber breach in the past year are significantly more likely to take actions to repair the breach and improve cybersecurity. This includes heightened awareness of vulnerabilities, higher percentages of annual IT spending directed to cybersecurity (31% average), and higher volumes of cyberattacks.

#### SMB Breach Detection, Costs, and Recovery
It takes 7.5 months for organizations to fully recover from a breach. 59% reported the breach stopped staff from carrying out daily work, and 46% lost customers. Organizations spent $170,000 on average to resolve a cyber breach.

### 2. Preparedness
72% of survey participants believe their organization is prepared to some extent to prevent or recover from a cyberattack. However, confidence to defend against attacks varied considerably based on organization size. 52% use an outsourced cybersecurity provider. The average percent of IT budget related to cybersecurity across all size organizations was 26%. 74% of survey respondents reported they had completed a cyber risk assessment within the past 12 months. 87% reported they have cybersecurity policies and procedures in place. 75% of participants have existing cybersecurity insurance policies. 13% of SMBs use guidance issued by DHS/CISA to make cybersecurity decisions.

---

## Survey Methodology and Parameters
1. **Qualitative**: Fourteen in-depth surveys with SMB CEOs and C-Level executives.
2. **Quantitative**: An online survey of employees, directors/managers, and executives of SMBs with up to 2,500 employees. A total of 323 people completed the survey.

---

## Acknowledgements
**Executive Sponsor**: USTelecom, Robert H. Mayer (Senior Vice President, Cybersecurity & Innovation).
**Contributors**: Mike Saperstein, Paul Eisler, Michael Steckler.
**Survey Partner**: Dr. Dustin Williams (Research Psychologist, CyberRx), Ola Sage (CEO, CyberRx).
