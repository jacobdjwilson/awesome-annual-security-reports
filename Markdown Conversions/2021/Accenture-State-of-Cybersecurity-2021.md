...
The figure is a 2x2 matrix with "Cybersecurity Resilience" on the vertical axis (from weak to strong) and "Business Strategy Alignment" on the horizontal axis (from weak to strong). The four quadrants are labeled as follows:

*   **Top Left:** Business Blockers - Prioritize cyber resilience over alignment with business strategy, sometimes perceived as an impediment to business objectives.
*   **Top Right:** Cyber Champions - Strike a balance between cyber resilience and business objectives with strong alignment to business strategy, best at protecting key assets.
*   **Bottom Left:** The Vulnerable - Security not aligned with business strategy, immature cybersecurity operations, secure the bare minimum.
*   **Bottom Right:** Cyber Risk Takers - Prioritize business growth and speed to market, most aligned with business strategy, accept higher cyber risk.
...
The figure is a bar chart comparing the average number of attempted and successful attacks per company in 2020 and 2021. The chart shows:

*   **Attempted:** 2020 - 184, 2021 - 241
*   **Successful:** 2020 - 22, 2021 - 29
*   A 31% increase in total attacks from 2020 to 2021 (206 to 270).
...
IT security budgets are increasing, with more than 82% of our survey respondents saying their budgets have increased in the last year (Figure 3). IT security budgets are now up to 15% of total IT spend, 5 percentage points higher than the spend reported in 2020.[^2]
...
The figure is a pie chart showing the percentage of respondents who reported different levels of increase or decrease in their cybersecurity spending compared to 2020. The chart shows:

*   Higher by 25% or more: 3%
*   Higher by 10%-24%: 22%
*   Higher by 1-9%: 57%
*   About the same: 16%
*   Lower by 1-9%: 1%
*   Lower by 10% or more: 0%
*   82% of budgets have increased over last year
...
The figure is a pie chart showing the level of security involvement in cloud discussions. The chart shows:
...
The figure is a table comparing the four cyber resilience groups across four key measures. The table shows:
...
The figure consists of two bar charts comparing the four cyber resilience groups across two metrics. The charts show:

*   **Percentage of attacks that result in a breach:** Cyber Champions (17%), Business Blockers (25%), Cyber Risk Takers (53%), The Vulnerable (43%)
*   **Average share attacks that result in significant damage:** Cyber Champions (4%), Business Blockers (7%), Cyber Risk Takers (23%), The Vulnerable (19%)
...
The figure is a bar chart showing the expected cost of cyber crime per successful attack for a Business Blocker, and the expected cost if they performed like a Cyber Champion. The chart shows:

*   Cost of attack for a Business Blocker: $611,000
*   Expected cost if a Business Blocker performs like a Cyber Champion: $317,000
*   Cost reduction related to faster detection and remediation: $227,000
*   Cost reduction related to lower proportion of attacks: $67,000
*   A 48% reduction in cost per successful attack
...
The figure is a bar chart showing the expected cost of cyber crime per successful attack for a Cyber Risk Taker, and the expected cost if they performed like a Cyber Champion. The chart shows:

*   Cost of attack for a Cyber Risk Taker: $343,000
*   Expected cost if a Cyber Risk Taker performs like a Cyber Champion: $117,000
*   Cost reduction related to faster detection and remediation: $192,000
*   Cost reduction related to lower proportions of attacks: $34,000
*   A 65% reduction in cost per successful attack
...
The figure is a bar chart showing the top countries and industries represented in the Cyber Champions group. The chart shows:

*   **Top Countries:** United States (13%), Japan (12%), United Kingdom (10%), Germany (9%), Brazil (8%), Norway (7%), Other (42%)
*   **Top Industries:** Insurance (19%), Telecommunications (19%), High Tech (12%), Retail (12%), Media (8%), Oil & Gas (8%), Other (24%)
...
CISOs must move away from security-focused silos and collaborate with the right executives in the organization to understand business risks and priorities. By drawing on the experience and insights of the wider leadership team, CISOs can gain a broader perspective that serves the whole business well. We found that Cyber Champions set themselves apart in terms of their reporting structures. Around 70% of the group report to the CEO and Board and they demonstrate a far closer relationship with the CFO—reporting is 7X higher than the other groups.
...
The figure is a bar chart comparing the percentage of each cyber resilience group that has their budget authorized by the CEO/Executive Committee or Board of Directors. The chart shows:

*   **CEO/Executive Committee:** Cyber Champions (9%), Business Blockers (17%), Cyber Risk Takers (14%), The Vulnerable (15%)
*   **Board of Directors:** Cyber Champions (8%), Business Blockers (15%), Cyber Risk Takers (22%), The Vulnerable (18%)
...
The figure is a bar chart comparing the percentage of each cyber resilience group that measures their cybersecurity maturity frequently. The chart shows:

*   Cyber Champions (87%), Business Blockers (69%), Cyber Risk Takers (66%), The Vulnerable (65%)
...
The figure is a bar chart comparing the percentage of each cyber resilience group that considers security a major consideration when moving operations to the cloud. The chart shows:

*   Cyber Champions (83%), Business Blockers (78%), Cyber Risk Takers (72%), The Vulnerable (64%)

Source: Accenture State of Cybersecurity Resilience 2021, security executives (N=3,455: Cyber Champions N=172, Business Blockers N=522, Cyber Risk Takers N=885, The Vulnerable N=1,876)

*Figure 15. Differences of opinion between security executives and non-security executives*

The figure is a table comparing the responses of security and non-security executives across three metrics. The table shows:
...
Austria (50), Australia (372), Brazil (177), Canada (194), France (369), Germany (364), Ireland (100), Italy (307), Japan (388), Netherlands (118), Norway (124), Portugal (100), Saudi Arabia (111), Singapore (102), Spain (251), Switzerland (50), United Kingdom (489), United States (1,078)

**Industries:**

Aerospace & Defense (101), Automotive (101), Banking (345), Biotech (11), Capital Markets (121), Chemicals (200), Consumer Goods & Services (440), Energy (210), Healthcare Payers (102), Healthcare Providers (102), High Tech (343), Industrial Equipment (434), Insurance (456), Life Sciences (139), Media (222), Metals and Mining (100), Pharmaceutical (49), US Federal Services (100), Retail (438), Software & Platforms (220), Telecommunications (207), Travel & Hospitality (93), Utilities (210)
...
The figure is a diagram showing the formula used to assess the cost of cyber crime. The formula is:

```
Cost of cyber crime for a company = Total number of attacks of type i * Average cost per attack of type i

Where:

Total number of attacks of type i = Successful breach ratio * Total attempted breaches

Average cost per attack of type i =  Σ (Proportion of attacks of damage type i * Days to detect and fix an attack of damage type i * Daily cost of an attack of damage type i)
```
...
Next, we examined how strength of alignment between cybersecurity strategy and business strategy impacted cyber resilience. Strength of alignment was