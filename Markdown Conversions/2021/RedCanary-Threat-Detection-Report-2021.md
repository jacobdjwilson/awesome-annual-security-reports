...
4.  [Top Threats](#top-threats)
    ...
    *   [TrickBot](#trickbot)
    *   [Gamarue](#gamarue)
5.  [Other Threats](#other-threats)
    *   [Ransomware](#ransomware)
    *   [Bazar](#bazar)
    *   [Blue Mockingbird](#blue-mockingbird)
    *   [Yellow Cockatoo](#yellow-cockatoo)
    *   [Solorigate and beyond](#solorigate-and-beyond)
...
*Image Description: A bar chart ranking the top 10 MITRE ATT&CK techniques by percentage of total threats. The techniques are listed from most to least prevalent with corresponding percentages. The techniques are: Command and Scripting Interpreter (24%), Signed Binary Process Execution (19%), Create and Modify System Process (16%), Obfuscated Files or Information (16%), Scheduled Task / Job (7%), OS Credential Dumping (7%), Process Injection (6%), Ingress Tool Transfer (5%), System Services (4%), and Masquerading (4%).*
...
While these obfuscated commands may evade simple