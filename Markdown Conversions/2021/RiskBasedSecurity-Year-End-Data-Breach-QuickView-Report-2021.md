...
- [Looking Back at Six Years of Breach History](#looking-back-at-six-years-of-breach-history)
  - [Will Ransomware Ever Go Away?](#will-ransomware-ever-go-away)
  - [Better Late Than Never, But Never Late Is Better](#better-late-than-never-but-never-late-is-better)
  - [Notable & Newsworthy Breaches](#notable--newsworthy-breaches)
- [2021 Trends in Data Theft and Malware](#2021-trends-in-data-theft-and-malware)
  - [Most Discussed Malware Types and Hacking Services](#most-discussed-malware-types-and-hacking-services)
  - [Most Popular Forums](#most-popular-forums)
  - [Most Targeted Sectors](#most-targeted-sectors)
  - [Most Popular Access Types Advertised](#most-popular-access-types-advertised)
  - [Rise of SQL Injection Ads](#rise-of-sql-injection-ads)
  - [Pricing is Being Withheld](#pricing-is-being-withheld)
  - [Negotiations Via Chat](#negotiations-via-chat)
  - [Geographic Disclosures](#geographic-disclosures)
  - [Zero-Day and Phishing Ads Dominate Raid](#zero-day-and-phishing-ads-dominate-raid)
  - [Ransomware is Taboo](#ransomware-is-taboo)
...
- [Methodology and Terms](#methodology-and-terms)
- [Data Standards and the Use of “Unknown”](#data-standards-and-the-use-of-unknown)
- [The Risk Based Security Platform](#the-risk-based-security-platform)
...
focused publications. Ashley holds an M.S. in Cybersecurity from Fordham University, which
...
![Figure 1. Number of breaches reported by EOY, for the past eight years](placeholder_image_description)
...
![Figure 2: Number of records lost (in billions) reported by EOY, for the past eight years](placeholder_image_description)
...
![Figure 3: Number of breaches by breach type, reported by EOY 2021](placeholder_image_description)

![Figure 4: Number of records lost by breach type (in billions),
reported by EOY 2021](placeholder_image_description)
...
![Figure 5: Number of breaches by attack vector, reported by EOY 2021](placeholder_image_description)
...
![Figure 6: Number of breaches by known confidentiality impact, reported by EOY 2021](placeholder_image_description)
...
![Figure 7: Severity distribution of breaches in 2021 H1 and H2](placeholder_image_description)

![Figure 8: Severity distribution of breaches in 2020 and 2021](placeholder_image_description)
...
In the 2018 Year End Report, we took a closer look at the
disclosure timeline. With GDPR regulations taking effect that year,
significant attention was being given to the 72 hour deadline
for informing data protection offices of the breach. The prevailing
question at the time was whether this attention would impact how long
it would take to go from initial discovery to the date of first public
disclosure (though it should be noted, specific reports made to
European regulators are generally not public information). Sadly, the
progress that had been made in closing the gap between discovery and
disclosure has only lengthened since that time. By 2021, the average
number of days to disclose a breach had climbed to 89, just 2 days
shorter than the high water mark set in 2014.
...
![Figure 9: Data types exposed in breaches reported by EOY 2021](placeholder_image_description)
...
![Figure 10: Number of breaches by economic sector, reported by EOY 2021](placeholder_image_description)
...
![Figure 11: Distribution of breaches reported by EOY 2021](placeholder_image_description)
...
![Figure 12: Percentage of breaches by country, reported by EOY 2021](placeholder_image_description)
