...
**REPORT CONDUCTED BY:** Sonatype & Fugue
...
![Infographic showing key cloud misconfiguration statistics]
...
- **21%** said they are not checking infrastructure as code prior to deployment, which can result in automating the propagation of misconfiguration and compliance violations at scale in a cloud environment.
- **20%** said they are not adequately monitoring their cloud environment for misconfiguration.
- **23%** cited the negligence of team members as a cause of misconfiguration.
...
#### Who defines cloud policy? vs. Who audits and enforces cloud policy?
- **Engineering**: 66% (Defines) | 56% (Audits/Enforces)
- **Security**: 55% (Defines) | 54% (Audits/Enforces)
- **Compliance**: 50% (Defines) | 49% (Audits/Enforces)
- **Outside Consultants**: 22% (Defines) | 29% (Audits/Enforces)
...
About half of respondents say their MTTR for cloud misconfiguration should be under one hour, but many are falling short of that goal. The MTTR for cloud misconfiguration remains largely unchanged from 2020.

#### MTTR for Cloud Misconfiguration
| Timeframe | Ideal MTTR | Real MTTR |
| :--- | :--- | :--- |
