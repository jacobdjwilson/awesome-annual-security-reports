...
![Chart showing 83% concern regarding risk, 36% breach rate, and future outlook on misconfiguration rates]
...
![Table of Cloud Misconfiguration Incidents per day: 1-10 (24%), 10-50 (21%), 50-100 (19%), 100-250 (13%), 250-500 (6%), 500-1,000 (8%), More than 1,000 (3%)]
...
![Chart of Causes of Misconfiguration: Lack of adequate controls (31%), Lack of team awareness (27%), Too many cloud APIs (32%), Not checking IaC (21%), Not adequately monitoring (20%), Negligent insider behavior (23%), Not enough expertise (23%)]
...
![Chart of Common cloud misconfigurations: Security group/firewall (40%), Unused security groups (25%), Object storage access policies (31%), IAM (41%), Logging disabled (27%), Encryption at rest disabled (28%), Encryption in transit disabled (31%), Orphaned resources (26%)]
...
![Charts showing responsibility breakdown for defining and auditing cloud policy across Engineering, Security, Compliance, and Outside Consultants]
...
![Chart showing usage of: Manual rules (35%), Open source PaC (39%), Proprietary vendor rules (31%), CSP compliance tools (58%), Vendor tools for compliance (47%)]
...
![Chart of Engineering Hours Invested in IaC Security Per Week: <10 (13%), 10-50 (35%), 50-100 (31%), 100-500 (15%), >500 (4%)]
...
![Chart comparing Ideal MTTR vs Real MTTR]
...
![Charts showing Cloud Audit Frequency and Average time to bring cloud environments into compliance]
...
![Chart of Hours per week: <10 (22%), 10-50 (29%), 50-100 (35%), 100-500 (11%), >500 (4%)]
...
![Chart of Cloud Security Issues: Alert fatigue (21%), False positives (27%), Human error (38%), Hiring/retaining (36%), Training (35%), Different tools/frameworks (45%)]
...
![Chart of Cloud Security Challenges: Prevention/detection/remediation (38%), Visibility (34%), Inadequate tools (28%), Compliance reporting (30%), Bringing environments into compliance (34%)]
...
The scale and complexity of cloud risk is growing. Cloud adoption continues at a rapid pace and shows no signs of slowing, which means the average enterprise cloud footprint keeps expanding. Multi-cloud usage is also growing, with 45% of respondents now saying they manage cloud environments that span providers.

The proliferation of cloud resource types also continues unabated, with AWS alone offering more than 200 infrastructure services. Each cloud service has unique configuration attributes and security profile that must be carefully considered.

The nature of cloud threats has also evolved, and attacks have become more sophisticated. Attackers now employ automation to scan the internet for misconfigured cloud resources in minutes. The result: a vast majority of respondents (83%) are concerned their organization is at risk of a cloud-based data breach.

Cloud security is both a people problem—and a technology one. Cloud misconfiguration is the result of human error. Modern enterprise cloud environments are too vast and complex for humans to manage without effective tooling. As a result, half of the cloud teams surveyed are now experiencing a significant number of misconfiguration incidents per day.

Cloud professionals point the way forward on cloud security. 96% of cloud professionals say that having a cloud security platform and policy framework that work across the SDLC—from infrastructure as code through the runtime—would be valuable.
