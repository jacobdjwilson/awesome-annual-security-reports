...
![Chart showing percentage of respondents concerned about cloud misconfiguration risk and percentage who experienced a breach.](placeholder_image_1.png)
...
![Bar chart showing the distribution of cloud misconfiguration incidents per day.](placeholder_image_2.png)
...
21% said they are not checking infrastructure as code prior to deployment, which can
result in automating the propagation of misconfiguration and compliance violations at scale in a
...
- Too many cloud APIs and interfaces to adequately govern: 32%
- Lack of adequate controls and oversight: 31%
- Lack of team awareness of security and policies: 27%
- Negligent insider behavior: 23%
- Not enough cloud security expertise on team: 23%
- Not checking our infrastructure as code prior to deployment: 21%
- Not adequately monitoring our cloud environment: 20%

![Bar chart illustrating the various causes of cloud misconfiguration.](placeholder_image_3.png)
...
- Identity and Access Management (IAM): 41%
- Security group or firewall rules: 40%
- Object storage access policies (e.g., Amazon S3): 31%
- Encryption at rest disabled (or not enabled): 31%
- Orphaned resources left unscanned/unpatched: 28%
- Encryption in transit disabled (or not enabled): 27%
- Logging has been disabled (or not enabled): 26%
- Unused security groups: 25%

![Bar chart showing the prevalence of different cloud misconfigurations.](placeholder_image_4.png)
...
![Pie charts illustrating who defines and who audits/enforces cloud policy.](placeholder_image_5.png)
...
![Bar chart showing different approaches to cloud policy implementation and enforcement.](placeholder_image_6.png)

- 58% use native cloud security tools that don’t work in multi-cloud environments
- Manual rules, checklists, and reviews: 35%
- Open source Policy as Code: 39%
- Proprietary vendor rules: 31%
- Cloud Service Provider compliance tools: 58%
- Vendor tools for compliance checking: 47%
...
on cloud security and compliance and build security into cloud development, but there is a level of
effort required.
...
![Bar chart showing the distribution of engineering hours invested in IaC security per week.](placeholder_image_7.png)
...
![Bar chart comparing ideal vs. real Mean Time to Remediation (MTTR) for cloud misconfigurations.](placeholder_image_8.png)
...
![Bar charts showing cloud audit frequency and average time to achieve compliance.](placeholder_image_9.png)
...
![Bar chart showing the weekly hours spent managing cloud security and compliance.](placeholder_image_10.png)
...
- Using different tools and policy frameworks: 45%
- Human error: 38%
- Hiring and retaining expertise: 36%
- Training team members on risks: 35%
- False positives: 27%
- Alert fatigue: 21%

![Bar chart illustrating various cloud security issues experienced by teams.](placeholder_image_11.png)
...
- Preventing, detecting, and remediating cloud misconfiguration: 38%
- Getting visibility into cloud environments: 34%
- Bringing existing environments into compliance: 34%
- Cloud compliance reporting and audit preparation: 30%
- Inadequate cloud security tools: 28%

![Bar chart showing technology gaps in cloud security.](placeholder_image_12.png)
...
![Bar chart showing the impact of cloud security on the organization.](placeholder_image_13.png)

- Primary factor impeding velocity in the cloud: 42%
- Requires significant investment of engineering resources: 60%
- Causes significant friction between teams: 38%
...
![Bar chart showing what cloud professionals need to improve cloud security.](placeholder_image_14.png)
