...
| Causes of Misconfiguration | Percentage |
|------------------------------------------------------------------|------------|
...
| Common cloud misconfigurations experienced | Percentage |
|------------------------------------------------------------------|------------|
...
| Logging has been disabled (or not enabled) | 27% |
| Encryption at rest disabled (or not enabled) | 28% |
| Encryption in transit disabled (or not enabled) | 31% |
| Orphaned resources left unscanned/unpatched | 26% |
...
| Who defines cloud policy? | Percentage |
|---------------------------|------------|
| Engineering | 66% |
| Security | 55% |
| Compliance | 50% |
...
| Who audits and enforces cloud policy? | Percentage |
|--------------------------------------|------------|
| Engineering | 56% |
| Security | 54% |
| Compliance | 49% |
...
| Cloud Policy Implementation Methods | Percentage |
|-------------------------------------------------|------------|
...
The adoption of infrastructure as code (IaC) presents cloud teams with the opportunity to shift left on cloud security and compliance and build security into cloud development, but there isa level of effort required.
...
| Engineering Hours Invested in IaC Security Per Week | Percentage |
|-----------------------------------------------------|------------|
| Fewer than 10 | 13% |
| 10-50 | 35% |
| 50-100 | 31% |
...
| MTTR for Cloud Misconfiguration | Ideal MTTR | Real MTTR |
|---------------------------------|------------|-----------|
...
| Cloud Audit Frequency | Percentage |
|-----------------------|------------|
| Daily | 26% |
| Weekly | 37% |
| Monthly | 20% |
...
| Average time to bring cloud environments into compliance | Percentage |
|---------------------------------------------------------|------------|
| Less than 1 week | 19% |
| About 1 week | 30% |
...
| Cloud Security Issues Experienced | Percentage |
|------------------------------------|------------|
| Alert fatigue | 21% |
| False positives | 27% |
| Human error | 38% |
...
| Cloud Security Challenges | Percentage |
|-----------------------------------------------------------------|------------|
...
| The impact cloud security has on the organization | Percentage |
|---------------------------------------------------|------------|
...
## Table of Contents
* [CLOUD SECURITY 2021](#cloud-security-2021)
    * [THE STATE OF](#the-state-of)
    * [Introduction](#introduction)
    * [The Nature and Scale of Cloud Misconfiguration Risk](#the-nature-and-scale-of-cloud-misconfiguration-risk)
        * [Misconfiguration: The #1 Cause of Cloud Breaches](#misconfiguration-the-1-cause-of-cloud-breaches)
    ...
    * [The Most Prevalent Cloud Misconfigurations](#the-most-prevalent-cloud-misconfigurations)
        * [Identity and Access Management (IAM) is now #1](#identity-and-access-management-iam-is-now-1)
    * [Preventing Cloud Misconfiguration](#preventing-cloud-misconfiguration)
        * [Cloud Security: Whose Job Is It?](#cloud-security-whose-job-is-it)
    ...
    * [Managing Cloud Misconfiguration](#managing-cloud-misconfiguration)
        * [Detecting and Remediating Cloud Misconfigurations](#detecting-and-remediating-cloud-misconfigurations)
    ...
    * [Conclusions: Where Cloud Security is Going](#conclusions-where-cloud-security-is-going)
        * [The scale and complexity of cloud risk is growing](#the-scale-and-complexity-of-cloud-risk-is-growing)
        * [Cloud security is both a people problem—and a technology one](#cloud-security-is-both-a-people-problemand-a-technology-one)
        * [Cloud professionals point the way forward on cloud security](#cloud-professionals-point-the-way-forward-on-cloud-security)
