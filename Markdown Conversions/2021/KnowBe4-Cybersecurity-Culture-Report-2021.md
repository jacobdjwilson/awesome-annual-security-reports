...
*A histogram showing the distribution of organizations based on their security culture score. The x-axis represents the security culture score ranging from 60 to 80, and the y-axis represents the number of organizations. The majority of organizations fall within the 70 to 80 range, with a smaller number in the 60 to 70 range. There are a few organizations scoring below 60 and none above 80.*
...
*A bar chart comparing the security culture scores across different industries. The x-axis lists the industries, and the y-axis shows the security culture score ranging from 65 to 80. The industries are ordered from lowest to highest score. The lowest scoring industries are Construction and Education, and the highest scoring industries are Banking and Financial Services.*
...
**Figure: Attitudes Dimension Comparison**

*A bar chart comparing the attitudes dimension score across different industries. The x-axis lists the industries, and the y-axis shows the score ranging from 65 to 80. The industries are ordered from lowest to highest score. The lowest scoring industry is Technology and the highest scoring industries are Construction, Consumer Services, and Education.*

**Figure: Communication Dimension Comparison**

*A bar chart comparing the communication dimension score across different industries. The x-axis lists the industries, and the y-axis shows the score ranging from 65 to 80. The industries are ordered from lowest to highest score. The lowest scoring industry is Insurance and the highest scoring industries are Education and Transportation.*

**Figure: Compliance Dimension Comparison**

*A bar chart comparing the compliance dimension score across different industries. The x-axis lists the industries, and the y-axis shows the score ranging from 65 to 80. The industries are ordered from lowest to highest score. The lowest scoring industry is Banking and the highest scoring industry is Education.*

**Figure: Behaviors Dimension Comparison**

*A bar chart comparing the behaviors dimension score across different industries. The x-axis lists the industries, and the y-axis shows the score ranging from 65 to 80. The industries are ordered from lowest to highest score. The lowest scoring industry is Banking and the highest scoring industry is Education.*

**Figure: Cognition Dimension Comparison**

*A bar chart comparing the cognition dimension score across different industries. The x-axis lists the industries, and the y-axis shows the score ranging from 65 to 80. The industries are ordered from lowest to highest score. The lowest scoring industry is Banking and the highest scoring industry is Construction.*

**Figure: Norms Dimension Comparison**

*A bar chart comparing the norms dimension score across different industries. The x-axis lists the industries, and the y-axis shows the score ranging from 65 to 80. The industries are ordered from lowest to highest score. The lowest scoring industry is Banking and the highest scoring industry is Construction.*

**Figure: Responsibilities Dimension Comparison**

*A bar chart comparing the responsibilities dimension score across different industries. The x-axis lists the industries, and the y-axis shows the score ranging from 65 to 80. The industries are ordered from lowest to highest score. The lowest scoring industry is Technology and the highest scoring industry is Construction.*
...
*A diagram showing the security culture index scale, with five levels: Poor (0-60), Mediocre (60-70), Moderate (70-80), Good (80-90), and Excellent (90-100).*
...
*An example of a box plot and a column chart, with annotations explaining how to read them.*
...
*An infographic for the Banking industry, showing a score of 76, 148 organizations, and 36,710 employees, with no change from last year. A box plot shows the distribution of scores, and a column chart shows the scores for each of the seven dimensions.*
...
*An infographic for the Business Services industry, showing a score of 74, 130 organizations, and 12,867 employees, with a decrease of 1 point from last year. A box plot shows the distribution of scores, and a column chart shows the scores for each of the seven dimensions.*
...
*An infographic for the Construction industry