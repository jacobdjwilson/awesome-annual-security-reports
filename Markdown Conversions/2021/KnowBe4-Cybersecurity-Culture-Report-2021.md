...
- [The Security Culture Index](#the-security-culture-index)
- [Banking](#banking)
...
![Image description: Distribution of Organizations According to Their Security Culture Score. A bar chart showing the number of organizations on the y-axis and security culture score on the x-axis, with bars peaking around the 70-80 range.]
...
![Image description: A pie chart showing that 20% of employees report "We do not receive enough training on information security".]
...
![Image description: A pie chart showing that 57% of employees believe "I will notice if my computer is compromised".]
...
![Image description: A pie chart showing that 24% of employees think "Short and simple passwords are not helping hackers".]

![Image description: A pie chart showing that 12% of employees report "Do not understand why it is important to change passwords".]
...
![Image description: A pie chart showing that 23% of employees report "I store (some of) my passwords on my device".]
...
![Image description: A pie chart showing that 30% of employees report "It is difficult to reach IT-support in our organization".]
...
![Image description: A bar chart comparing security culture scores across different industries. The industries are listed on the y-axis and the scores on the x-axis. The highest scores are for Financial Services and Banking (76), followed by Technology and Insurance (75), and so on, down to Construction and Education (70).]
...
![Image description: A bar chart showing the ranking of industries by their Attitudes dimension score. Technology, Insurance, Financial Services, and Banking are at the top with scores around 79.]
...
![Image description: A bar chart showing the ranking of industries by their Communication dimension score. Insurance, Financial Services, and Consulting are at the top with scores around 79.]

#### Compliance

The knowledge of written security policies and the extent that employees follow them.

![Image description: A bar chart showing the ranking of industries by their Compliance dimension score. Banking, Insurance, and Financial Services are at the top with scores around 72.]

#### Behaviors

The actions and activities of employees that have direct or indirect impact on the security of the organization.

![Image description: A bar chart showing the ranking of industries by their Behaviors dimension score. Banking, Technology, and Healthcare & Pharmaceuticals are at the top with scores around 78.]

#### Cognition

Employees’ understanding, knowledge and awareness of security issues and activities.

![Image description: A bar chart showing the ranking of industries by their Cognition dimension score. Technology, Consulting, and Financial Services are at the top with scores around 69.]

#### Norms

The knowledge of and adherence to unwritten rules of conduct in the organization.

![Image description: A bar chart showing the ranking of industries by their Norms dimension score. Banking, Technology, and Insurance are at the top with scores around 73.]

#### Responsibilities

How employees perceive their role as a critical factor in sustaining or endangering the security of the organization.

![Image description: A bar chart showing the ranking of industries by their Responsibilities dimension score. Technology, Financial Services, and Consulting are at the top with scores around 73.]
...
![Image description: A column chart showing the seven dimensions of security culture for an industry. The horizontal line represents the overall industry score.]

## Banking

76

![Image description: Infographic for the Banking industry. Shows industry name, benchmark score (76), number of organizations (148), and number of employees (36,710). Also includes a box plot showing the distribution of scores, with a median of 76, mean of 76, and a range from 68 to 87.]
...
*   **Industry name**: This is the name of the industry as used in this report.
*   **Industry benchmark score**: This is the score for the industry. Use this to compare your own score with that of your peers.
*   **Change from last year**: This number shows how your industry benchmark has changed since last time. The number is either 0 (no change), +x (an improvement by x points) or -x (a decline by x points).
*   **Number of employees**: This is the number of employees responding to the survey in this industry.
*   **Number of organizations**: This is the number of organizations in this industry.
...
![Image description: A column chart showing the seven dimensions of security culture for the Banking industry. The overall score is 76. Attitudes, Communication, and Compliance are high (79). Behaviors is 78. Cognition is 72. Norms and Responsibilities are 73.]
...
![Image description: Infographic for the Business Services industry. Shows industry name, benchmark score (74), number of organizations (130), and number of employees (12,867). Also includes a box plot showing the distribution of scores, with a median of 74, mean of 74, and a range from 64 to 84.]
...
![Image description: A column chart showing the seven dimensions of security culture for the Business Services industry. The overall score is 74. Attitudes is 77. Communication is 79. Compliance is 75. Behaviors is 72. Cognition is 72. Norms is 71. Responsibilities is 71.]
...
![Image description: Infographic for the Construction industry. Shows industry name, benchmark score (70), number of organizations (48), and number of employees (6,815). Also includes a box plot showing the distribution of scores, with a median of 70, mean of 70, and a range from 55 to 78.]
...
![Image description: A column chart showing the seven dimensions of security culture for the Construction industry. The overall score is 70. Communication is 76. Attitudes is 72. Behaviors is 69. Cognition is 66. Norms is 68. Responsibilities is 68.]
...
![Image description: Infographic for the Consulting industry. Shows industry name, benchmark score (75), number of organizations (69), and number of employees (5,975). Also includes a box plot showing the distribution of scores, with a median of 75, mean of 75, and a range from 66 to 82.]
