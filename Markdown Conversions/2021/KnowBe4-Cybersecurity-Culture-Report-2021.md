ed a massive disruption in the global supply chain, forcing manufacturers to
re-evaluate their reliance on just-in-time inventory and their geographic
footprint. This has led to a push for more digital transformation, including
the adoption of Industrial Internet of Things (IIoT) devices and increased
automation. While these technologies offer efficiency gains, they also
expand the attack surface, making the Manufacturing sector a prime target
for ransomware and intellectual property theft.

The Manufacturing sector’s security culture score of 71 is consistent with
last year’s report. This moderate score reflects the industry’s ongoing
struggle to balance operational technology (OT) uptime with the need for
robust information technology (IT) security.

The industry shows a moderate score of 74 in the Attitudes dimension,
unchanged from last year. This suggests that while employees understand
the importance of security, there is a disconnect between that understanding
and the daily operational pressures of the factory floor.

Areas for Improvement
The Manufacturing sector faces significant challenges in the Cognition
dimension, which scored 67, a one-point decrease from last year. This
indicates a need for more targeted, role-based training that addresses the
specific risks associated with both IT and OT environments.

The sector also scored 69 in the Norms dimension, unchanged from last
year. To improve this, organizations should focus on integrating security
into the existing safety culture that is already prevalent in manufacturing.
By treating cybersecurity as a component of physical safety, organizations
can better foster the unwritten rules and behaviors necessary to protect
the organization.
...
The Not for Profit sector, with an overall security culture score of 71,
faces unique challenges. Often operating with limited budgets and
relying on a mix of staff and volunteers, these organizations are
frequently targeted by cybercriminals who perceive them as having
weaker security controls.

The sector shows a moderate score of 75 in the Attitudes dimension,
a one-point increase from last year. This is a positive sign, indicating
that despite resource constraints, there is a growing awareness of the
importance of security.

Areas for Improvement
The Cognition dimension scored 67, a one-point decrease from last year.
This highlights the difficulty of providing consistent training across a
diverse and often transient workforce. Organizations in this sector
should leverage free or low-cost security awareness resources and
focus on high-impact, low-effort security practices.

The Responsibilities dimension scored 70, unchanged from last year.
Clear communication regarding the role of every individual—staff
and volunteer alike—in maintaining the security of the organization
is essential to improving this score.
...
The "Other" category encompasses a wide range of organizations that
do not fit neatly into the predefined industry sectors. With an overall
security culture score of 74, this group demonstrates a moderate
level of security maturity.

The sector shows a strong score of 76 in the Attitudes dimension,
a one-point increase from last year. This suggests that employees
across these diverse organizations are generally supportive of
security initiatives.

Areas for Improvement
The Cognition dimension scored 67, unchanged from last year.
Given the diversity of this group, there is no "one-size-fits-all"
approach to training. Organizations should focus on identifying
the specific threats relevant to their unique business models
and tailoring their training programs accordingly.

The Norms dimension scored 69, a one-point decrease from last year.
Establishing clear, consistent security expectations is vital,
regardless of the industry, to ensure that employees understand
...
The Retail and Wholesale sector has been significantly impacted by the
shift to e-commerce and the need for secure digital payment processing.
With an overall security culture score of 71, the industry is working to
keep pace with the evolving threat landscape.

The sector shows a moderate score of 74 in the Attitudes dimension,
a one-point increase from last year. This indicates a growing
recognition of the importance of security in protecting customer
data and maintaining brand reputation.

Areas for Improvement
The Cognition dimension scored 66, a one-point decrease from last year.
This is a critical area for improvement, particularly as the industry
continues to adopt new technologies for customer engagement and
supply chain management.

The Responsibilities dimension scored 70, unchanged from last year.
Retail and wholesale organizations should focus on empowering
employees to take ownership of security, emphasizing that every
interaction—whether with a customer or a system—is an opportunity
...
The Technology sector, with an overall security culture score of 75,
is at the forefront of digital innovation. However, this also makes
it a primary target for sophisticated cyber attacks.

The sector shows a strong score of 79 in the Attitudes dimension,
a one-point increase from last year. This reflects a culture that
is generally supportive of security, though it must constantly
balance innovation with risk management.

Areas for Improvement
The Cognition dimension scored 69, a one-point decrease from last year.
Even in a tech-savvy industry, there is a need for continuous
security awareness training to address the human element of security.

The Norms dimension scored 72, unchanged from last year.
Technology organizations should focus on fostering a culture
where security is "baked in" to the development process,
...
The Transportation sector, which includes logistics, shipping, and
public transit, is critical to the global economy. With an overall
security culture score of 71, the industry is facing increasing
pressure to secure its complex, interconnected systems.

The sector shows a moderate score of 75 in the Attitudes dimension,
a one-point increase from last year. This is a positive trend,
indicating that employees are becoming more aware of the
security risks associated with their roles.

Areas for Improvement
The Cognition dimension scored 67, a one-point decrease from last year.
Transportation organizations should focus on providing relevant,
accessible training to a workforce that is often on the move and
may not have regular access to traditional training platforms.

The Responsibilities dimension scored 69, unchanged from last year.
Clear communication regarding the role of every employee in
securing the transportation infrastructure is essential.
...
The data for this report was collected through a standardized security culture survey, which was distributed to employees across a wide range of organizations and industries. The survey was designed to measure the seven dimensions of security culture: Attitudes, Behaviors, Cognition, Communication, Compliance, Norms, and Responsibilities.

### Data Preprocessing
To ensure the quality and reliability of the data, a rigorous preprocessing phase was conducted. This included:
- **Data Cleaning**: Removing incomplete or invalid responses.
- **Anonymization**: Ensuring that all individual and organizational data remained anonymous.
- **Normalization**: Standardizing scores across different survey versions and languages.

### Statistical Analyses
The data was analyzed using a variety of statistical methods to identify trends, correlations, and differences across industries and regions. This included:
- **Descriptive Statistics**: Calculating means, medians, and distributions for each dimension and industry.
- **Comparative Analysis**: Comparing scores across industries and regions to identify benchmarks and areas for improvement.
- **Correlation Analysis**: Examining the relationship between security culture scores and other variables, such as organization size and industry type.

### Data Size
This report is based on data from over 320,000 employees in 1,872 organizations around the world.

### Table: Frequencies of employees and organizations with complete data per industry

| Industry | Organizations | Employees |
| :--- | :--- | :--- |
| Banking | 148 | 36,710 |
...
| Insurance | 65 | 15,058 |
| Legal | 26 | 2,522 |
| Manufacturing | 118 | 14,201 |
| Not for Profit | 42 | 3,210 |
| Other | 102 | 11,542 |
| Retail and Wholesale | 89 | 12,450 |
| Technology | 182 | 28,450 |
| Transportation | 45 | 7,230 |
...
Anita-Catrin Eriksen is a researcher at CLTRe, a research division of KnowBe4. She specializes in the human factors of information security and has extensive experience in developing and validating security culture assessment tools.

**Kai Roer**
Kai Roer is a recognized expert in security culture and the founder of CLTRe. He is a frequent speaker and author on the topic of security culture and has helped numerous organizations around the world to assess and improve their security posture.

**Dr. Gregor Petrič**
Dr. Gregor Petrič is a professor at the University of Ljubljana and a senior researcher at CLTRe. His research focuses on the intersection of technology, society, and organizational behavior.

**Joanna Huisman**
Joanna Huisman is the Senior Vice President of Strategic Insights at KnowBe4. She brings a wealth of experience in security awareness training and organizational change management.

**Rosa L. Smothers**
Rosa L. Smothers is the Senior Vice President of Cyber Operations at KnowBe4. She has a background in intelligence and cybersecurity and is a frequent contributor to industry research.

**Perry Carpenter**
Perry Carpenter is the Chief Evangelist and Strategy Officer at KnowBe4. He is a well-known author and speaker on the topics of security awareness, human behavior, and security culture.

42

## CLTRe, a Research Division of KnowBe4
CLTRe is a research division of KnowBe4 that focuses on the scientific study of security culture. Our mission is to provide organizations with the tools, data, and insights they need to build a strong, resilient security culture.

## KnowBe4 Research
KnowBe4 Research is dedicated to providing actionable insights into the human element of cybersecurity. Through our ongoing research and analysis, we help organizations understand the risks they face and the strategies they can use to mitigate those risks.

## KnowBe4, Inc.
KnowBe4 is the world’s largest provider of security awareness training and simulated phishing platforms. We help organizations manage the ongoing problem of social engineering by helping them train employees to make smarter security decisions every day.

44

---

ed the greatest disruption to manufacturing
