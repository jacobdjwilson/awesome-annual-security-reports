...
![Chart showing the percentage of organizations concerned about public cloud security.](Image description)
...
![Chart showing the biggest cloud security concerns.](Image description)

*   Data loss/leakage: 67%
*   Data privacy/confidentiality: 61%
*   Accidental exposure of credentials: 49%
*   Legal and regulatory compliance: 46%
*   Visibility and transparency: 43%
*   Incident response: 41%
*   Data sovereignty/control: 36%
...
![Chart showing the biggest security threats in public clouds, comparing 2020 and 2021.](Image description)

*   Misconfiguration of the cloud platform/wrong set-up: 71% (An increase of 22% from last year)
*   Exfiltration of sensitive data: 59%
*   Insecure interfaces/APIs: 54% (47% in 2020)
*   Unauthorized access: 53% (42% in 2020)
*   External sharing of data: 44% (36% in 2020)
...
![Chart showing who is accountable for actual technical changes to systems for security or compliance remediation.](Image description)
...
![Chart showing the primary method for managing remediation of security and compliance issues with system owners.](Image description)

*   Periodic vulnerability and compliance reports: 58%
*   Tickets automatically opened in operational tools (e.g., Jira, Service Now, etc.): 47%
*   Scheduled meetings: 42%
*   Ad-hoc emails: 33%
*   System owners have access to tools operated by information security: 32%
...
![Chart showing the cadence for managing remediation of security and compliance issues with system owners, comparing 2020 and 2021.](Image description)

*   Before audits: 2% (2020), 2% (2021)
*   Ad-hoc: 33% (2020), 20% (2021)
*   Real-time: 27% (2020), 14% (2021)
*   Daily: 26% (2020), 10% (2021)
*   Weekly: 25% (2020), 27% (2021)
*   Monthly: 37% (2020), 52% (2021)
*   Quarterly: 43% (2020), 15% (2021)
...
![Chart showing primary cloud deployment strategy.](Image description)

*   HYBRID (e.g., integration between multiple providers, managed as a single cloud): 44%
*   MULTI-CLOUD (e.g., multiple providers without integration): 43%
*   SINGLE CLOUD: 11%
*   Other: 2%

How many cloud providers does your organization currently use?

![Chart showing the number of cloud providers used by organizations.](Image description)

*   use two or more cloud providers: 90%
*   One: 8%
*   Two: 41%
*   Three: 24%
*   More than 3: 25%
...
![Chart showing biggest challenges securing multi-cloud environments.](Image description)
...
![Chart showing the number of dashboards for separate security solutions users have to access to configure policies for the enterprise's entire cloud footprint.](Image description)

*   need to access between three to six dashboards to configure cloud security policies: 66%
*   1-2: 17%
*   3-4: 38%
*   5-6: 28%
*   7-8: 6%
...
![Chart showing how helpful it would be to have a single cloud security platform with a single dashboard to configure policies across the cloud footprint.](Image description)
...
![Chart showing the main drivers for considering cloud-based security solutions.](Image description)
...
![Chart showing what organizations look for in their cloud security provider.](Image description)
...
*   Easily manageable platform: 43%
*   Policy customization: 42%
...
![Chart showing how cloud security budgets are changing in the next 12 months.](Image description)

*   Budget will increase: 55% (will increase by a little less than one-third, down from 65% in 2020)
*   Budget will stay flat: 40% (up from 30% in 2020)
...
![Chart showing the distribution of career levels among survey respondents.](Image description)
...
![Chart showing the distribution of departments among survey respondents.](Image description)
...
![Chart showing the distribution of company sizes among survey respondents.](Image description)
...
![Chart showing the distribution of industries among survey respondents.](Image description)
