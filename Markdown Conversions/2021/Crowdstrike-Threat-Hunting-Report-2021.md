# Nowhere to Hide: 2021 Threat Hunting Report - Insights From the Falcon OverWatch Team
...
- **65,000 potential intrusions** were identified and stopped with the help of OverWatch
- **8 minutes** is the average interval at which threat hunters uncovered potential intrusions
...
![OVERWATCH SEARCH Threat Hunting Methodology: SENSE, ENRICH, ANALYZE, RECONSTRUCT, COMMUNICATE, HONE]
...
![Figure 1. Relative distribution of targeted intrusion, eCrime and hacktivist activity uncovered by OverWatch (2020 vs 2021)]
...
OverWatch measures **breakout time** — the time an adversary takes to move laterally, from an initially compromised host to another host within the victim environment. 

Of the hands-on eCrime intrusion activity from July 1, 2020 to June 30, 2021 where breakout time could be derived, the **average was just 1 hour 32 minutes**. Moreover, the OverWatch team found that in **36%** of those intrusions, the adversary was able to move laterally to additional hosts in less than 30 minutes.
...
![Figure 2. Proportion of targeted intrusion activity conducted by different targeted adversary groups, July 2020 to June 2021: PANDAs (China) 67%, CHOLLIMAs (North Korea) 20%, KITTENs (Iran) 7%, SUSPECTED STATE-SPONSORED (Not Attributed) 5%, BEARs (Russia) 1%, BUFFALOs (Vietnam) 1%]
...
![Figure 3. The figure shows which industry verticals were most frequently impacted by interactive intrusions and also shows any changes relative to the period from July 2019 to June 2020 (Technology, Telecommunications, Manufacturing, Financial, Professional Services, Academic, Healthcare, Retail, Government, Engineering)]
...
![Figure 4. Comparison of the industry verticals most frequently impacted by targeted intrusion vs. eCrime threat actors. July 2020 to June 2021 (Targeted: Telecommunications, Technology, Healthcare, Government, Academic | eCrime: Technology, Manufacturing, Professional Services, Financial, Retail)]
...
![MITRE ATT&CK Heat Map Parts 1, 2, and 3 covering Initial Access, Execution, Persistence, Privilege Escalation, Defense Evasion, Credential Access, Discovery, Lateral Movement, Collection, Command and Control, Exfiltration, and Impact]

---
*(Note: Remaining sections of the report follow the structure and formatting standards above.)*

---

---------- | --- | --- | --------------------- | --- | ------------ |
Data Staged Application Layer Protocol
Default Accounts Unix Shell Default Accounts Default Accounts Default Accounts NTDS Domain Account SSH Remote Data Staging F i l e  T r a n s fer  E x fi ltr a t io n  O v e r  Other  Service Stop
P r o t o c o l s N e tw o r k  M e d i u m
C o m m a n d  and Scripting  Account Discovery Remote Services E x fi l tr a t i o n  O v e r
E x p l o it  P ub lic-Facing  In te rp re t e r D y n a m i c-link Library  M a tc h   L e g it im a te   /e tc / p a s s w d and / Di s t r i b u te d   E x fi l tr a ti on Over Alternative  U n e n c r y p te d /
A p p l ic a tio n Visual Basic Scheduled Task In je c t io n N a m e   o r  L o c at io n OS Credential Dumping e tc / s h a d o w Local Account C o m p o n e n t Object  Archive via Utility Mail Protocols Pr o t o c o l O b f u s c a te d  N o n -C2  Resource Hijacking
Scheduled Task/Job M o d e l Archive Collected Data Pr o t o c o l
S p e a r p h is h ing  Python Cron Process Hollowing Masquerading M a s q u erade Task or  LSA Secrets System Information Discovery VNC A r c h i ve  via Custom  External Proxy System Shutdown/Reboot
| At t a c h m e n t |     |     |     |     | Process Injection |     |     | Se r v ic e |     |     |     |     |     | M e t h o d |     |
| ------------------ | --- | --- | --- | --- | ----------------- | --- | --- | ----------- | --- | --- | --- | --- | --- | ----------- | --- |
P o r ta b le  Executable  R e n a m e System  C a c h e d   D o main  W in d o w s R e m ote  D a ta  f r o m   I n formation
Phishing Spearphishing Link JavaScript Local Account Process Discovery Proxy Internal Proxy Data Destruction
Create Account I n je c t io n U til it ie s C re d e n t i al s Ma n a g em e n t R e p o s i to r i e s
S p e a rp hishing via  W in d o w s  M a n a gement  T h re a d  E xecution  S y s t em  N etwork Configuration I n t e r n e t  C onnection
S er v ic e Ins tr u m e n ta ti o n Domain Account H ija c k in g File Deletion DCSync D is c o ve ry D i s c o v e r y Lateral Tool Transfer Automated Collection Multi-hop Proxy Endpoint Denial of Service
C le a r Windows Event  R e m o t e  Service Session  D a t a  from Network Shared
External Remote Services Scheduled Task Server Software Component Web Shell Scheduled Task Lo g s Password Spraying File and Directory Discovery H ija c k in g RDP Hijacking D ri v e Data Encoding Standard Encoding Account Access Removal
|     | Scheduled Task/Job |     |     |     | Scheduled Task/Job |     |     |     | Brute Force |     |     |     |     |     |     |
| --- | ------------------ | --- | --- | --- | ------------------ | --- | --- | --- | ----------- | --- | --- | --- | --- | --- | --- |
Drive-by Compromise Cron Account Manipulation SSH Authorized Keys Cron N e t w o r k   S h a r e   Password Guessing Domain Groups U s e  A l t e rnate Authentication  Pass the Hash Screen Capture Protocol Tunneling
|     |     |     |     |     |     |     |     | C o n n e c t i on   R e | m oval |     |     | M a te r i a l |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ------------------------ | ------ | --- | --- | -------------- | --- | --- | --- |
Permission Groups Discovery
Trusted Relationship System Services Service Execution A c c e s s i bility  By p a s s  User Account  Indicator Removal on Host Timestomp Credentials In Files Local Groups E x p lo it a tion of Remote  Keylogging Ingress Tool Transfer
|     |     |     |     | Fe a t u r e s |     | C o n tr o l |     |     |     |     |     | S e rv ic e s |     |     |     |
| --- | --- | --- | --- | -------------- | --- | ------------ | --- | --- | --- | --- | --- | ------------- | --- | --- | --- |
I m a g e  F i le   E xe cu tion  El e v a t e d  E x ecution  C le a r  Lin u x  o r Mac  S y s t em  N etwork Connections  Input Capture
Malicious File Bash History Web Portal Capture Non-Standard Port
O p t io n s  I n j ec tio n w i th   P r o m p t Sy s te m  L o g s D is c o ve ry
A b u s e  E l e vation Control
|     | User Execution |     | Event Triggered Execution | W in d o w s   | M e c h a ni s m |     |     |     |     |     |     |     |     |     |     |
| --- | -------------- | --- | ------------------------- | -------------- | ---------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
Malicious Link M a n a g e m e n t   Setuid and Setgid C l e a r  C ommand  Unsecured Credentials Private Keys Domain Trust Discovery Email Collection R e m o t e  E mail  Remote Access Software
|     |     |     |     | Ins t r u m e n t a t io n  |     |     |     | Hi s t o r y |     |     |     |     |     | C o lle c t io n |     |
| --- | --- | --- | --- | --------------------------- | --- | --- | --- | ------------ | --- | --- | --- | --- | --- | ---------------- | --- |
Event Subscription
E x p lo it a t ion for Client  C o m p o n e n t  O b ject  S u d o   a n d Sudo  D is a ble or Modify  C re d e n tials in  Network Service Scanning Web Service B i d ire c ti o n a l
E xe c u t io n M o de l  H i ja c k in g C a c h i n g To o ls Re g is t ry C o m m u n i c a t ion
Impair Defenses
Inter-Process Communication D y n a m i c  Data  R e g i s t ry  R u n  K eys /  A c c e s s i bility  D is a b le  o r  M o d i fy  G r o u p  P o l ic y  Software Discovery Se c u r it y  S oftware  Data Obfuscation
Ex c h a n g e Boot or Logon Autostart  St a r t u p  F o ld e r Fe a t u r e s Sy s t em   F ir ew a l l Pr e f e re n c e s D is c o v e r y
Execution S e c u ri ty  Support  I m a g e  F i le   E xe cu tion  C r e d en ti al s  fr o m  S y m m e t r ic
Shared Modules Rundll32 Network Share Discovery Encrypted Channel
Pr o v id e r O p t io n s  I n j ec tio n W e b  B ro w s e r s C ry p to g r a p hy
C r e d e ntials from Password
|     |     |     |     |     | Event Triggered Execution | W in d o w s   |     |     | St o r e s |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | ------------------------- | -------------- | --- | --- | ---------- | --- | --- | --- | --- | --- | --- |
C r e a te   or Modify System  Windows Service M a n a g e m e n t   Regsvr32 W in d o w s Credential  Query Registry N o n -A p p lication Layer
P r o c e s s Ins t r u m e n t a t io n  Ma n a g er Pr o to c o l
|     |     |     |     |     |     | Event Subscription | Signed Binary Proxy Execution |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | ------------------ | ----------------------------- | --- | --- | --- | --- | --- | --- | --- | --- |
External Remote Services C o m p o n e n t  O b ject  Mshta S t e a l  o r Forge Kerberos  Kerberoasting System Service Discovery
|     |     |     |     |     |     | M o de l  H i ja c k in g |     |     | Ti c k e t s |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | ------------------------- | --- | --- | ------------ | --- | --- | --- | --- | --- | --- |
D L L   S e a r c h  O rd e r  R e g i s t r y   R u n  K e y s /  M s i e x e c K e y lo g g i n g S y s te m  T im e D i scovery
|     |     |     |     | H ija c k i n g | B o o t  o r   L ogon Autostart  | S t a r t u p   F o ld e r  |      |                             |               |     |     |     |     |     |     |
| --- | --- | --- | --- | --------------- | -------------------------------- | --------------------------- | ---- | --------------------------- | ------------- | --- | --- | --- | --- | --- | --- |
|     |     |     |     |                 | Ex e c u t i o n                 | S e c u r i t y   S u p p o | r t  | D y n a m i c-link Library  | Input Capture |     |     |     |     |     |     |
D L L   S i d e - L o ad in g W e b  P o r t a l Capture N e tw o rk  S ni n g Figure 6. MITRE ATT&CK heat map showing the techniques and sub-techniques observed by OverWatch in interactive
|     |     |     | Hijack Execution Flow |     |     | Pr o v i d e r |     | In j e c t i o n |     |     |     |     |     |     |     |
| --- | --- | --- | --------------------- | --- | --- | -------------- | --- | ---------------- | --- | --- | --- | --- | --- | --- | --- |
P a t h   I n t e r c e p t ion by  intrusion attempts from Jan. 1 to June 30, 2021
C r e a te   or Modify System
S e a r c h   O r d e r   P r o c e s s Windows Service Process Hollowing Network Sni ng Password Policy Discovery
|     |     |     |                          | H ija c k in g    |                                    |                         | Process Injection |                            |                          |     |     |     |     |     |     |
| --- | --- | --- | ------------------------ | ----------------- | ---------------------------------- | ----------------------- | ----------------- | -------------------------- | ------------------------ | --- | --- | --- | --- | --- | --- |
|     |     |     |                          |                   | E x p lo it a ti on for Privilege  |                         |                   | P o r ta b le  Executable  |                          |     |     |     |     |     |     |
|     |     |     | BITS Jobs                |                   |                                    |                         |                   |                            | Steal Web Session Cookie |     |     |     |     |     |     |
|     |     |     |                          |                   | Es c a la t io n                   |                         |                   | I n je c t io n            |                          |     |     |     |     |     |     |
|     |     |     |                          | O c e  T emplate  |                                    | D L L  S e a rch Order  |                   | T h re a d  E xecution     |                          |     |     |     |     |     |     |
|     |     |     | O ce Application Startup | Mac r o s         |                                    | H ija c k in g          |                   | H ija c k in g             |                          |     |     |     |     |     |     |
|     |     |     | Browser Extensions       |                   |                                    | DLL Side-Loading        | Modify Registry   |                            |                          |     |     |     |     |     |     |
Hijack Execution Flow
|     |     |     | C o m p romise Client Software  |     |     | Pa t h   I n t e r c e p t ion by  |     | C o m p il e After  |     |     |     |     |     |     |     |
| --- | --- | --- | ------------------------------- | --- | --- | ---------------------------------- | --- | ------------------- | --- | --- | --- | --- | --- | --- | --- |
|     |     |     | Bi n ar y                       |     |     | S e a r c h   O r d e r            |     | De l iv er y        |     |     |     |     |     |     |     |
H ija c k in g
Obfuscated Files or
|     |     |     |     |     | Domain Policy Modification | G r o u p  P o l ic y  | Information | Software Packing |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | -------------------------- | ---------------------- | ----------- | ---------------- | --- | --- | --- | --- | --- | --- | --- |
M o d ifi c a ti o n
I n d ic a t o r  R emoval
Access Token Manipulation
f ro m   T o o l s
Hidden Window
Hidden Files and
|     |     |     |     |     |     |     | Hide Artifacts | Directories |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | -------------- | ----------- | --- | --- | --- | --- | --- | --- | --- |
Hidden Users
...
Control
Elevated Execution
|     |     |     |     |     |     |     | Abuse Elevation Control  | with Prompt |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | ------------------------ | ----------- | --- | --- | --- | --- | --- | --- | --- |
Mechanism
Setuid and Setgid
Sudo and Sudo
...
Search Order
Hijacking
|     |     |     |     |     |     |     | Tr u s t e d  D e v e l o per Utilities  | MSBuild |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | ---------------------------------------- | ------- | --- | --- | --- | --- | --- | --- | --- |
P r o x y  E x e c u ti o n
BITS Jobs
|     |     |     |     |     |     |     | Domain Policy Modification | G r o u p  P o l ic y  |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | -------------------------- | ---------------------- | --- | --- | --- | --- | --- | --- | --- |
M o d ifi c a ti o n
Indirect Command Execution
U s e  A l t e rnate Authentication
|     |     |     |     |     |     |     | M a te r i a l | Pass the Hash |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | -------------- | ------------- | --- | --- | --- | --- | --- | --- | --- |
Access Token Manipulation
Exploitation for Defense
Evasion

2021 Threat Hunting Report 22
...
Intrusion Activity and Unique to eCrime Intrusions
Activity
eCrime Intrusions
...
T1070.006 Indicator Removal on Host:  T1496 Resource Hijacking
Timestomp
|       | Persistence           |           | Privilege Escalation             |
| ----- | --------------------- | --------- | -------------------------------- |
|       | Privilege Escalation  |           | Defense Evasion                  |
|       |                       |           |                                  |
|       | Defense Evasion       | T1055.001 | Process Injection: Dynamic-link  |
| T1574 | Hijack Execution Flow |           | Library Injection                |
|       | Exfiltration          |           | Credential Access                |
T1048 Exfiltration Over Alternative  T1110.001 Brute Force: Password
|     | Protocol   |     | Guessing       |
| --- | ---------- | --- | -------------- |
|     | Collection |     | Initial Access |
Credential Access

| T1056  | Input Capture   | T1189  | Drive-by Compromise  |
| ------ | --------------- | ------ | -------------------- |
|        | Defense Evasion |        | Privilege Escalation |
Defense Evasion

T1070.003  Indicator Removal on Host:  T1484 Domain Policy Modification
Clear Command History
Targeted intrusion actors leverage  On the other hand, eCrime actors are
techniques that are inherently more stealthy  opportunistic in their targeting, as
and focused on long-term access, such  evidenced by Brute Force and Drive-by
as Indicator Removal on Host and Clear  Compromise techniques. Financial
Command History. Further, use of Input  motivations also come through clearly, as
Capture and Exfiltration over Alternative  a rise in cryptojacking operations in recent
Protocol is illustrative of intelligence  months has placed Resource Hijacking
| gathering objectives. |     | firmly in this list. |     |
| --------------------- | --- | -------------------- | --- |

2021 Threat Hunting Report 24
...
Use Alternate Authentication Material: Pass the Ticket10 T1550.003
...
2021 Threat Hunting Report 25
Hijack Execution Flow: COR_PROFILER11 T1574.012
...
Compromise Client Software Binary12 T1554
...
Cloud Service Discovery13 T1526
...
BEAR (Suspected) cloud providers.
What OverWatch Observed
...
Supply Chain Compromise15 T1195
...
State-sponsored backdoor or compromising the software to facilitate later delivery of malware.
(Suspected)
What OverWatch Observed
...
2277
22002211  TThhrreeaatt  HHuunnttiinngg  RReeppoorrtt
In Pursuit of PROPHET
F rom developers to money mules, it takes multiple criminal actors fulfilling a wide
INTRUSION
...
into the interactive intrusion  gain a foothold in a network.
activity that OverWatch
uncovers daily. This cross  PROPHET SPIDER has earned a reputation for gaining initial access by compromising
section of eCrime and  vulnerable web servers. This eCrime adversary typically targets Oracle WebLogic
targeted intrusion activity has  servers and has been observed exploiting CVE-2016-0545, CVE-2020-14882 and
been selected to provide a  CVE-2020-14750, but CrowdStrike has also observed this actor targeting other
closer look at how some of  web servers. To enable persistence, PROPHET SPIDER often deploys a variety of
the intrusion trends from the  backdoors and reverse shell tools, such as GOTROJ, that connect to hard-coded
past year have played out in  command and control (C2) IP addresses. Securing redundant access to these
the wild. compromised networks is likely an attempt by access brokers to increase the value of
...
| INITIAL ACCESS | DISCOVERY             | COMMAND & CONTROL   | DISCOVERY               |
| -------------- | --------------------- | ------------------- | ----------------------- |
| A vulnerable   | The adversary used a  | The adversary used  | Finally, the adversary  |
WebLogic server  cmd shell to perform  PowerShell and wget  searched for open
was compromised various preliminary  for ingress tool  SMB ports using a
|     | discovery commands | transfer | scanning tool, in  |
| --- | ------------------ | -------- | ------------------ |
likely preparation for
lateral movement
| INITIAL ACCESS | EXECUTION | PERSISTENCE | DEFENSE EVASION |
| -------------- | --------- | ----------- | --------------- |
The adversary  The user unwittingly  The Prilex malware  The Prilex malware hid
| conducted  | executed legitimate  | attempted to achieve  | directories containing  |
| ---------- | -------------------- | --------------------- | ----------------------- |
spearphishing via a  remote access  persistence using  malicious binaries and
| telephone call | software configured  | registry run keys and  | also attempted to  |
| -------------- | -------------------- | ---------------------- | ------------------ |
|                | for adversary C2     | scheduled tasks        | exclude those      |
|                |                      | masqueraded as         | directories from   |
|                |                      | operating system       | Windows Defender   |
|                |                      | functions              | scans              |
...
WebLogic server  cmd shell to perform  PowerShell and wget  searched for open
waps ocoinmtp-roofm-sisaedle (POS) vvaerinoudso prr.e Flimoilnloarwy ing instrucfotri oingnrse sfsr toomol  the callerS, MthBe p oermts pusloinyg ea e
|     | discovery commands | transfer | scanning tool, in  |
| --- | ------------------ | -------- | ------------------ |
...
movement and  persistence, and alerted the victim organization.
persistence, and
alerted the victim
organization.
| INITIAL ACCESS | EXECUTION | PERSISTENCE | DEFENSE EVASION |
...
31 https://front.un-arm.org/wp-content/uploads/2021/06/final-report-2019-2021-gge-1-advance-copy.pdf
...
| -------------------- | ---------------------------------- | ----------------- | ---------------------- | --- | -------------------------- | -------------------------- | ---------------------- | ----------------- |
| Use of a collection  |                                    |                   | Host and user          |     |                            |                            | Use of unique          |                   |
| of valid and         |                                    |                   | reconnaissance         |     |                            |                            | keylogging and screen  |                   |
| backdoored           |                                    |                   | conducted, including   |     |                            | capture tooling for input  |                        |                   |
| accounts on Linux    |                                    |                   | enumeration of domain  |     |                            |                            | capture                |                   |
| and Windows          |                                    |                   | group and host         |     |                            |                            |                        |                   |
| hosts                |                                    |                   | information            |     |                            |                            |                        |                   |
|                      |                                    | CREDENTIAL ACCESS |                        |     | DEFENSE EVASION            |                            |                        | LATERAL MOVEMENT  |
|                      | Numerous credential dumping        |                   |                        |     | Use of disguised and       |                            |                        | Lateral movement  |
|                      | and harvesting techniques          |                   |                        |     | renamed actor tooling and  |                            |                        | between multiple  |
|                      | employed, inducing sensitive file  |                   |                        |     | anti-forensic techniques,  |                            |                        | hosts using SSH,  |
|                      | enumeration, use of disguised      |                   |                        |     | and attempts to weaken     |                            |                        | RDP and WMI       |
|                      | keyloggers and a distinctive       |                   |                        |     | host security posture      |                            |                        |                   |
screen capture tool
INITIAL ACCESS EXECUTION  PERSISTENCE DEFENSE EVASION COMMAND & CONTROL
The adversary  The adversary  The adversary  The adversary  PowerShell
accessed an  used the Smbexec  created a  stored binaries  requests were
internal host via a  utility to perform  Windows service  within legitimate  used to perform
local account extensive  to execute  Windows  C2 communication
|     |     | reconnaissance  |     | malware code  |        | directories and      |           | over HTTP  |
| --- | --- | --------------- | --- | ------------- | ------ | -------------------- | --------- | ---------- |
|     |     | and execute     |     | upon system   |        | overwrote malicious  |           |            |
|     |     | GifStealer and  |     |               | reboot | code following       |           |            |
|     |     | Valefor malware |     |               |        |                      | execution |            |

2021 Threat Hunting Report 40
...
INITIAL ACCESScampaign.38 This adveDrISsCaOVrEyR,Y operating out of the DCeOLmLEoCTcIOrNatic People’s
Republic of Korea (DPRK), is known to perform targeted economic espionage
| Use of a collection  |     |     | Host and user  |     |     | Use of unique  |     |
| -------------------- | --- | --- | -------------- | --- | --- | -------------- | --- |
caomf vpaalidig annds . In the past year, CrercoownndaSisstrainkcee  Intelligence hakse ylliongkgeindg  aSndIL sEcrNeeTn  CHOLLIMA
| backdoored  |     |     | conducted, including  |     | capture tooling for input  |     |     |
| ----------- | --- | --- | --------------------- | --- | -------------------------- | --- | --- |
to several intrusions targeting the pharmaceuticals industry and suspects these
| accounts on Linux                                                      |     |                   | enumeration of domain  |                                      |     | capture |                  |
| ---------------------------------------------------------------------- | --- | ----------------- | ---------------------- | ------------------------------------ | --- | ------- | ---------------- |
| inatnrdu Wsiiondnosw ws ere possibly in supgrpoouprt a nodf  heoffsto  |     |                   |                        | rts by DPRK to produce counterfeit   |     |         |                  |
| pharmaceuticals. hosts                                                 |     |                   | information            |                                      |     |         |                  |
|                                                                        |     | CREDENTIAL ACCESS |                        | DEFENSE EVASION                      |     |         | LATERAL MOVEMENT |
The routinNeu minevroeusst cirgeadetinotinal  doufm ap inbgu rst of unuUsseu oafl d risegcuoisendn aanids sance activityL laetedr al movement
OverWatcha ntod  htarravecskti ndgo tewchnn iaquneds  disrupt trheena amdevd eacrtsoar troyo lainsg  atnhde y attemptedb etotw deeenp mloulytip le
CrowdStrike
|     | employed, inducing sensitive file  |     |     | anti-forensic techniques,  |     |     | hosts using SSH,  |
| --- | ---------------------------------- | --- | --- | -------------------------- | --- | --- | ----------------- |
malicious tooling within the victim environment.
Intelligence  enumeration, use of disguised  and attempts to weaken  RDP and WMI
|     | keyloggers and a distinctive  |     |     | host security posture |     |     |     |
| --- | ----------------------------- | --- | --- | --------------------- | --- | --- | --- |
The intrusion socrreigeinn caatpetudre f trooolm a host within the victim environment that was not
linked SILENT
covered by the Falcon sensor. As the sensor was progressively deployed across
CHOLLIMA to  the victim network, the full scope of this intrusion was laid bare. CrowdStrike
several intrusions Intelligence's analysis of several pieces of custom tooling seen over the course
