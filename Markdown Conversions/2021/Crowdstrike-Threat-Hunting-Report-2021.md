...
- [Expect the Unexpected: Five Uncommon Techniques That Underscore the Need for Comprehensive Hunting Capabilities](#expect-the-unexpected-five-uncommon-techniques-that-underscore-the-need-for-comprehensive-hunting-capabilities)
...
[^1]: For more information on how Falcon OverWatch performs its mission, please see [https://www.crowdstrike.com/endpoint-security-products/falcon-overwatch-threat-hunting/](https://www.crowdstrike.com/endpoint-security-products/falcon-overwatch-threat-hunting/).
...
![Diagram illustrating the OverWatch SEARCH Threat Hunting Methodology, with steps: Sense, Enrich, Analyze, Reconstruct, Communicate, Hone, arranged in a circular flow around "OVERWATCH SEARCH"]
...
![Figure 1. Pie charts showing the relative distribution of targeted intrusion, eCrime, and hacktivist activity uncovered by OverWatch for July 2019 to June 2020 (2020: Targeted Intrusion 24%, Hacktivist 1%, eCrime 76%) and July 2020 to June 2021 (2021: Targeted Intrusion 23%, Hacktivist 1%, eCrime 75%).]
...
![Figure 2. Bar chart showing the proportion of targeted intrusion activity conducted by different targeted adversary groups from July 2020 to June 2021. Groups include PANDAs (China) 67%, SUSPECTED STATE-SPONSORED (Not Attributed) 20%, KITTENs (Iran) 7%, CHOLLIMAs (North Korea) 5%, BEARs (Russia) 1%, BUFFALOs (Vietnam) 1%.]
...
![Figure 3. Bar chart showing the top 10 industry verticals by intrusion frequency from July 2020 to June 2021, and changes relative to July 2019 to June 2020. Industries include Technology, Telecommunications, Manufacturing, Financial, Professional Services, Academic, Healthcare, Retail, Government, and Engineering, with percentages ranging from 0% to 20%.]
...
![Figure 4. Bar charts comparing the top 5 industry verticals most frequently impacted by targeted intrusion vs. eCrime threat actors from July 2020 to June 2021. Targeted Intrusions: Telecommunications (40%), Technology, Healthcare, Government, Academic. eCrime: Technology, Manufacturing, Professional Services, Financial, Retail, with percentages ranging from 0% to 50%.]
...
![Figure 5. Heat map of intrusion campaigns by adversary group and industry vertical from July 2020 to June 2021. Adversary groups include BEARs (Russia), BUFFALOs (Vietnam), CHOLLIMAs (N. Korea), JACKALs (Hacktivist), KITTENs (Iran), PANDAs (China), SPIDERs (eCrime). Industry verticals include Academic, Aerospace, Agriculture, Automotive, Aviation, Biotechnology, Chemical, Conglomerate, Defense, Education, Energy, Engineering, Entertainment, Financial, Food & Beverage, Government, Healthcare, Hospitality, Insurance, Law Enforcement, Legal, Manufacturing, Maritime, Media, Mining, NGO, Nonprofit, Oil & Gas, Pharmaceutical, Professional Services, Rail, Real Estate, Retail, Services, Technology, Telecommunications, Think Tanks, Transportation & Logistics.]
...
![Figure 6. MITRE ATT&CK heat map showing the prevalence of adversary tactics, techniques, and sub-techniques observed by OverWatch in interactive intrusion attempts from Jan. 1 to June 30, 2021. The map covers tactics such as Initial Access, Execution, Persistence, Privilege Escalation, Defense Evasion, Credential Access, Discovery, Lateral Movement, Collection, Command and Control, Exfiltration, and Impact, with various techniques and sub-techniques listed under each. The intensity of color indicates prevalence.]
...
| :---------- | :---------------------------------------------------------- | :-------------------------- | :----------------------------------- |
| 1.          | Mimikatz                                                    | NS.exe (and name variants)  | nmap                                 |
| 2.          | Cobalt Strike Beacon                                        | GMER                        | dirtycow                             |
| 3.          | PsExec                                                      | Process Hacker              | Tiny Shell (tshd)                    |
| 4.          | ProcDump                                                    | Defender Control            | OpenSSH                              |
| 5.          | Advanced IP Scanner                                         | Dharma                      | Fatedier                             |
...
| T1070.006 Indicator Removal on Host: Timestomp              | T1496 Resource Hijacking                          |
| **Persistence**                                             | **Privilege Escalation**                          |
| **Defense Evasion**                                         | **Defense Evasion**                               |
| T1055.001 Process Injection: Dynamic-link Library Injection | T1574 Hijack Execution Flow                       |
| **Exfiltration**                                            | **Credential Access**                             |
| T1048 Exfiltration Over Alternative Protocol                | T1110.001 Brute Force: Password Guessing          |
| **Collection**                                              | **Initial Access**                                |
| **Credential Access**                                       | T1189 Drive-by Compromise                         |
| T1056 Input Capture                                         | **Privilege Escalation**                          |
| **Defense Evasion**                                         | **Defense Evasion**                               |
| T1070.003 Indicator Removal on Host: Clear Command History  | T1484 Domain Policy Modification                  |
...
trusion and preventing follow on actions on objectives.
...
F alcon OverWatch’s mission is to expose advanced interactive threats,
...
ﬁrst detection and began response
...
2021 Threat Hunting ReportConclusion

2021 Threat Hunting Report

55

O ne year ago, OverWatch reported on mounting cyber threats facing
