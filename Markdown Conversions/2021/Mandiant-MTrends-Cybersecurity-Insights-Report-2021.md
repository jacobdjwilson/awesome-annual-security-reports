...
![Detection by Source Graph](https://i.imgur.com/12345.png)

### DETECTION BY SOURCE BY REGION, 2020

![Detection by Source by Region Graph](https://i.imgur.com/67890.png)

### DETECTION BY SOURCE BY REGION, 2019-2020 COMPARISON

![Detection by Source by Region Comparison Graph](https://i.imgur.com/abcde.png)
...
| :----------------------- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| All                      | 416  | 243  | 229  | 205  | 146  | 99   | 78   | 57.5 | 30   | 24   |
| External Notification    | —    | —    | —    | —    | —    | —    | 184  | 141  | 73   | 73   |
| Internal Detection       | —    | —    | —    | —    | —    | —    | 56   | 50.5 | 12   | 12   |

### GLOBAL MEDIAN DWELL TIME DISTRIBUTION, 2018-2020

![Global Median Dwell Time Distribution Graph](https://i.imgur.com/fghij.png)
...
![Global Dwell Time by Investigation Type Graph](https://i.imgur.com/klmno.png)
...
![Americas Median Dwell Time Graph](https://i.imgur.com/pqrst.png)
...
![APAC Median Dwell Time Graph](https://i.imgur.com/uvwxy.png)
...
![EMEA Median Dwell Time Graph](https://i.imgur.com/zabcd.png)
...
| :--- | :------------------------ | :------------------------ | :------------------------ | :------------------------ | :------------------------ |
| 1    | Manufacturing             | Manufacturing             | Manufacturing             | Entertainment/Media       | Business/ Professional Services |
| 2    | Biotechnology             | Biotechnology             | Biotechnology             | Business/ Professional Services | Retail/ Hospitality       |
| 3    | Business/ Professional Services | Business/ Professional Services | Business/ Professional Services | Retail/ Hospitality       | Healthcare                |
| 4    | Retail/ Hospitality       | Retail/ Hospitality       | Retail/ Hospitality       | Healthcare                | Financial                 |
| 5    | Healthcare                | Healthcare                | Healthcare                | Financial                 | High Tech                 |
| 6    | Financial                 | Financial                 | Financial                 | High Tech                 | Entertainment/Media       |
| 7    | High Tech                 | High Tech                 | High Tech                 | Manufacturing             | Construction/ Engineering |
| 8    | Construction/ Engineering | Construction/ Engineering | Construction/ Engineering | Telecommunications        | Telecommunications        |
| 9    | Entertainment/Media       | Entertainment/Media       | Entertainment/Media       | Education                 | Education                 |
| 10   | Telecommunications        | Telecommunications        | Telecommunications        | Government                | Government                |
| 11   | Education                 | Education                 | Education                 | Transportation/ Logistics | Transportation/ Logistics |
| 12   | Government                | Government                | Government                | Aerospace/ Defense        | Aerospace/ Defense        |
| 13   | Transportation/ Logistics | Transportation/ Logistics | Transportation/ Logistics | Energy                    | Energy                    |
| 14   | Aerospace/ Defense        | Aerospace/ Defense        | Aerospace/ Defense        | Utilities                 | Utilities                 |
| 15   | Energy                    | Energy                    | Energy                    | Nonprofit                 | Nonprofit                 |
...
![Targeted Attacks Summary Graph](https://i.imgur.com/qrstu.png)
...
![Threat Groups Summary Graph](https://i.imgur.com/vwxyz.png)

¹ FireEye (December 17, 2020). DebUNCing Attribution: How Mandiant Tracks Uncategorized Threat Actors.
...
![Newly Tracked Malware Families by Category Graph](https://i.imgur.com/cdefg.png)
...
![Observed Malware Families by Category Graph](https://i.imgur.com/hijkl.png)
...
![Newly Tracked Malware Families by Availability Graph](https://i.imgur.com/mnopqr.png)
...
![Observed Malware Families by Availability Graph](https://i.imgur.com/stuvw.png)
...
![Most Frequently Seen Malware Families Graph](https://i.imgur.com/xyzab.png)
...
![Effectiveness of Newly Tracked Malware Families by OS Graph](https://i.imgur.com/cdefg.png)
...
![Effectiveness of Observed Malware Families by OS Graph](https://i.imgur.com/hijkl.png)
...
![MITRE ATT&CK Techniques Used Most Frequently Graph](https://i.imgur.com/lmnop.png)
...
![MITRE ATT&CK Techniques Related to Attack Lifecycle Part 1 Graph](https://i.imgur.com/qrstu.png)

![MITRE ATT&CK Techniques Related to Attack Lifecycle Part 2 Graph](https://i.imgur.com/vwxyz.png)

![MITRE ATT&CK Techniques Related to Attack Lifecycle Part 3 Graph](https://i.imgur.com/zabcd.png)

![MITRE ATT&CK Techniques Related to Attack Lifecycle Part 4 Graph](https://i.imgur.com/efghi.png)
