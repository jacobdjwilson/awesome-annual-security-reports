# The State of Open Source Security Vulnerabilities: WhiteSource Annual Report 2021
...
- [Open Source Vulnerabilities in 2020: Top CWEs](#open-source-vulnerabilities-in-2020-top-cwes)
  - [Top CWEs Historical Trend (2015–2020)](#top-cwes-historical-trend-20152020)
  - [Analysis of Top 2020 CWEs](#analysis-of-top-2020-cwes)
...
![Bar chart showing Open Source Vulnerabilities per Year from 2009 to 2020: 2009 (500), 2010 (700), 2011 (800), 2012 (1,012), 2013 (1,213), 2014 (1,235), 2015 (1,426), 2016 (1,421), 2017 (4,092), 2018 (4,217), 2019 (6,111), 2020 (9,658)]

### Open Source Vulnerabilities per Year: 2009–2020

| Year | Published Vulnerabilities |
| :--- | :------------------------ |
| 2009 | 500                       |
| 2010 | 700                       |
| 2011 | 800                       |
...
### Top CWEs Historical Trend (2015–2020)

| Rank | 2015 | 2016 | 2017 | 2018 | 2019 | 2020 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **1** | CWE-79<br>_XSS_ | CWE-119<br>_Buffer Overflow_ | CWE-119<br>_Buffer Overflow_ | CWE-79<br>_XSS_ | CWE-79<br>_XSS_ | CWE-79<br>_XSS_ |
| **2** | CWE-119<br>_Buffer Overflow_ | CWE-264<br>_Permissions, Privileges, and Access Controls_ | CWE-79<br>_XSS_ | CWE-190<br>_Integer Overflow_ | CWE-20<br>_Improper Input Validation_ | CWE-787<br>_Out-of-bounds Write_ |
| **3** | CWE-264<br>_Permissions, Privileges, and Access Controls_ | CWE-20<br>_Improper Input Validation_ | CWE-125<br>_Out-of-bounds Read_ | CWE-119<br>_Buffer Overflow_ | CWE-125<br>_Out-of-bounds Read_ | CWE-125<br>_Out-of-bounds Read_ |
| **4** | CWE-200<br>_Information Exposure_ | CWE-200<br>_Information Exposure_ | CWE-200<br>_Information Exposure_ | CWE-20<br>_Improper Input Validation_ | CWE-89<br>_SQL Injection_ | CWE-20<br>_Improper Input Validation_ |
| **5** | CWE-20<br>_Improper Input Validation_ | CWE-79<br>_XSS_ | CWE-20<br>_Improper Input Validation_ | CWE-125<br>_Out-of-bounds Read_ | CWE-352<br>_CSRF_ | CWE-200<br>_Information Exposure_ |

### Analysis of Top 2020 CWEs
...
| :--- | :--- | :--- |
| **CWE-79**<br>XSS | **CWE-862**<br>Missing Authorization | **CWE-502**<br>Deserialization of Untrusted Data |
| **CWE-79**<br>XSS | **CWE-20**<br>Improper Input Validation | **CWE-787**<br>Out-of-bounds Write |
| **CWE-79**<br>XSS | **CWE-89**<br>SQL Injection | **CWE-352**<br>Cross-Site Request Forgery |
| **CWE-79**<br>XSS | **CWE-20**<br>Improper Input Validation | **CWE-200**<br>Information Exposure |
| **CWE-200**<br>Information Exposure | **CWE-79**<br>XSS | **CWE-863**<br>Incorrect Authorization |
| **CWE-787**<br>Out-of-bounds Write | **CWE-125**<br>Out-of-bounds Read | **CWE-476**<br>NULL Pointer Dereference |
| **CWE-732**<br>Incorrect Permission Assignment for Critical Resource | **CWE-200**<br>Information Exposure | **CWE-20**<br>Improper Input Validation |
...
![Bar chart comparing open source vulnerability percentages in top programming languages between 2019 and 2020, focusing on C and C++]
...
One parameter that many organizations look to when attempting to decide what to remediate first is the vulnerabilities’ severity score. We checked the breakdown of open source vulnerabilities’ severity scores to see if this is an effective technique.
...
![Donut chart showing breakdown of 2020 open source vulnerabilities by severity: Medium (45%), High (38%), Critical (15%), and Low (3%)]

### Severity Score Breakdown (2020)
- **Medium**: 45%
- **High**: 38%
- **Critical**: 15%
- **Low**: 3%
...
<!-- CONVERSION_METADATA: {"source": "https://github.com/jacobdjwilson/awesome-annual-security-reports", "date": "2026-09-17", "model": "gemini-3.8-flash"} -->
