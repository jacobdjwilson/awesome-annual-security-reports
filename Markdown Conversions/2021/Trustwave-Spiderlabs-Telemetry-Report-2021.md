...
- [Number of Vulnerabilities Published Over Time](#number-of-vulnerabilities-published-over-time)
- [Monthly Vulnerability Trends](#monthly-vulnerability-trends)
- [Severity Breakdown of Vulnerabilities](#severity-breakdown-of-vulnerabilities)
...
# Number of Vulnerabilities Published Over Time

![Figure 1: Number of vulnerabilities published in NVD from 2011-2021 (As of September 1, 2021)](Image description)
...
![Figure 2: Number of vulnerabilities in NVD per month in 2020-2021 (As of September 1, 2021)](Image description)
...
![Figure 3: Severity breakdown of vulnerabilities on NVD in 2021 (As of September 1, 2021)](Image description)
...
![Figure 4: High-profile vulnerabilities of 2021](Image description)
...
![Figure 5: Facet Analysis on Shodan – CVE breakdown for Microsoft Exchange ProxyShell (Source: https://www.shodan.io/search/facet?query=http.favicon.hash%3A1768726119&facet=vuln.verified)](Image description)
...
![Figure 6: Heatmap of Exchange Servers vulnerable to ProxyShell (As of August 31, 2021)](Image description)
...
![Figure 7: Exchange Servers vulnerable to ProxyShell with SMBv1 and RDP enabled (As of August 31, 2021)](Image description)
...
![Figure 8: Heatmap of Exchange Servers vulnerable to ProxyToken (As of August 31, 2021)](Image description)
...
![Figure 9: Breakdown of Tomcat version series on Shodan](Image description)
...
![Figure 10: Breakdown of Tomcat instances on Shodan as of July 22, 2021](Image description)
...
![Figure 11: QNAP hosts vulnerable to CVE-2021-28800 4-7 weeks after patch release](Image description)

## Vmware vCenter Multiple Vulnerabilities

(CVE-2021-21985, CVE-2021-21986)

On May 25, 2021, VMware released patches to address VMSA-2021-0010, a critical security advisory for VMware vCenter Server addressing two vulnerabilities. Approximately a week after patch release, SpiderLabs created scripts to check how many vulnerable instances existed on Shodan. Read our blog for more information.
...
![Figure 12: Breakdown of Vmware vCenter versions vulnerable to CVE-2021-21985, CVE-2021-21986](Image description)
...
![Figure 13: Heatmap of Pulse Connect Secure hosts affected by CVE-2021-22893, CVE-2021-22894, CVE-2021-22899, CVE-2021-22900 (As of August 4, 2021)](Image description)
...
![Figure 14: Successful exploitation of F5 BIG-IP CVE-2021-22986](Image description)
...
![Figure 15: Exchange Servers vulnerable to ProxyLogon with SMBv1 and RDP enabled (As of August 4, 2021)](Image description)
...
![Figure 16: Heatmap of Exchange Servers vulnerable to ProxyLogon (As of August 31, 2021)](Image description)
...
![Figure 17: POST Request to check if the host is vulnerable to Oracle Weblogic vulnerabilities (CVE-2021-2109 & CVE-2020-14882)](Image description)
...
![Figure 18: Breakdown of WebLogic Server instances vulnerable to CVE-2021-2109 & CVE-2020-14882 as of August 20, 2021](Image description)
