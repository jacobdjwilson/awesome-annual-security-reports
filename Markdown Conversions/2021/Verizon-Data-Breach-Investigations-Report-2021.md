...
*   [github.com/vz-risk/dbir/tree/gh-pages/2021](github.com/vz-risk/dbir/tree/gh-pages/2021) includes DBIR facts, figures and figure data
*   [veriscommunity.net](veriscommunity.net) features information on the framework with examples and enumeration listings
*   [github.com/vz-risk/veris](github.com/vz-risk/veris) features the full VERIS schema
*   [github.com/vz-risk/vcdb](github.com/vz-risk/vcdb) provides access to our database of publicly disclosed breaches, the VERIS Community Database
...
*Figure 3. Example dot plot (n=672) Each dot represents 0.5% of organizations*
...
8 [https://en.wikipedia.org/wiki/Gini_coefficient](https://en.wikipedia.org/wiki/Gini_coefficient)
...
18 [https://enterprise.verizon.com/resources/articles/analyzing-covid-19-data-breach-landscape/](https://enterprise.verizon.com/resources/articles/analyzing-covid-19-data-breach-landscape/)
