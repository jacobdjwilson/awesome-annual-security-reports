...
**Over 50%**
of phish reported by end users to the Cofense PDC are credential phish
...
*Figure 1 - Layering*
*Description: A diagram illustrating the layering technique. It shows a sequence of four steps: 1) A OneNote file with a link, 2) a page with a "View Document" button, 3) a login page with email platform options, and 4) a fake Microsoft login page.*
...
*Description: An image showing a webpage with multiple email provider logos, allowing the user to select their email platform.*
...
*Description: An image of an email showing a reply-chain format, with a malicious attachment.*
...
*Description: An image showing a Google Docs page with a link to a malicious executable.*
...
*Description: An image of an email with a subject related to employment termination.*
...
When malicious emails reach the inbox, the chance of at