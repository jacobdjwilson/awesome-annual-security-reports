...
- [Let's Get Started—The Phishing Defense Center (PDC) Today](#lets-get-startedthe-phishing-defense-center-pdc-today)
...
## SECTION 2: Let’s Get Started—The Phishing Defense Center (PDC) Today
...
| Cisco                   | 4%                              | 2%      | 12%        |
| FortiNet                | 3%                              | 6%      | 4%         |
| Microsoft Defender for O365 | 20%                             | 10%     | 4%         |
| Microsoft EOP           | 6%                              | 3%      | 9%         |
| Mimecast                | 19%                             | 19%     | 18%        |
| Proofpoint              | 19%                             | 67%     | 55%        |
| Symantec                | 4%                              | 74%     | 62%        |
...
![Figure 1 - Layering shows a multi-step process starting with a OneNote file, leading to a PDF document link, then a login page with email platform options, and finally a fake Microsoft login page.](Image description)
...
![Figure 2 - Example of abusing trusted platforms shows a phishing email with multiple webmail login options.](Image description)
...
![Figure 3 - Example of abusing trusted platforms shows a phishing email with a JNLP file attachment.](Image description)
...
![Figure 4 - Emotet Reply-Chain Sample shows an email thread with a malicious attachment.](Image description)
...
![Figure 5 - Ryuk Example shows a phishing email with a link to a Google Docs page.](Image description)
...
![Figure 6 - Ryuk Example 2 shows a phishing email with a subject line related to termination.](Image description)
...
*   490 Threat Actors Capitalize on Global Concern About Coronavirus in New Phishing Campaigns
*   469 Staff Members’ Inbox Positive for Coronavirus-Themed Phish
*   381 Coronavirus Test Results Return Data-Exfiltrating Ransomware
*   315 Coronavirus Redefines the Phishing Threat Landscape
*   450 Coronavirus-Themed Phish Continue to Surge
*   677 Coronavirus Phishing Webinar Attendees
*   381 Phish Friday Podcast Downloads Coronavirus Awareness Training
...
Attackers are diversifying the malware used in phishing campaigns and finding new ways to monetize phishing. In 2020, Cofense Intelligence identified a major diversification in malware families prominent in phishing. As of August 20, we saw 31 new or previously dormant malware families in phishing campaigns. Two major newcomers include Mass Logger and Avaddon ransomware. Mass Logger is routinely updated and modular in capability, while Avaddon suggests a return to broadly targeted ransomware operations. Increasingly, ransomware operators are pairing traditional ransomware with malware capable of data theft, then leaking the victim’s data to accelerate ransom payment. Avaddon ransomware seems to have joined this trend. Cofense Intelligence has seen these campaigns reach the inbox in different sectors and in environments protected by multiple SEGs.
...
## SECTION 6: The Need for Decreasing D