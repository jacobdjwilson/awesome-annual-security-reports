...
- [Biggest Security Threats](#biggest-security-threats)
- [Cloud Security Factors](#cloud-security-factors)
...
- [Popular Cloud Providers](#popular-cloud-providers)
- [Cloud Security Path](#cloud-security-path)
- [Cloud Adoption Barriers](#cloud-adoption-barriers)
- [Cloud Security Criteria](#cloud-security-criteria)
...
However, cloud security concerns remain high as the adoption of public cloud computing continues to surge in the wake of the pandemic and the resulting massive shift to remote work. The 2021 Cloud Security Report is based on a comprehensive global survey of 572 cybersecurity professionals to reveal how organizations are responding to security threats in the cloud, and what tools and best practices IT cybersecurity leaders are prioritizing in their move to the cloud.
...
![Chart showing concern levels regarding public cloud security: 3% Not at all concerned, 1% Slightly concerned, 23% Moderately concerned, 41% Very concerned, 32% Extremely concerned.]
...
![Chart showing useful features in a cloud security solution: Third-party security certifications (54%), Integration with security scanner tools (52%), Ability to write custom rules and remediation actions (49%), Integration with change management platforms (46%), Integration with end-to-end vulnerability remediation tools (41%), Research-based policies (36%), Billing model (32%), Billing by usage (31%), Integration with alerting tools (30%), User community support (20%), Other (2%).]
...
![Chart comparing current workload percentages vs. next 12-18 months: Today (Up to 25%: 41%, 26-50%: 26%, 51-75%: 17%, +75%: 16%) vs. Next 12-18 months (Up to 25%: 29%, 26-50%: 27%, 51-75%: 27%, +75%: 17%).]
...
![Chart showing business outcomes: Accelerated time to market (53%), Increased responsiveness (51%), Saved money (41%), Reduced risk and improved security (35%), Expanded market reach to new markets (22%), Accelerated revenue growth in existing markets (20%), Gained parity with competitors (14%), Other (7%).]
...
![Chart showing primary cloud deployment strategy: Hybrid (36%), Multi-cloud (35%), Single cloud (27%), Other (2%).]
![Chart showing number of cloud providers: One (21%), Two (35%), Three (17%), More than 3 (24%), None (3%).]
...
![Chart showing cloud IaaS provider usage: Microsoft Azure (73%), Amazon Web Services (70%), Google Cloud Platform (37%), IBM Cloud (15%), Oracle Cloud (12%), Alibaba Cloud (7%), Other (5%).]
...
![Chart showing cloud security sourcing: Cloud-native security (74%), Third-party cloud security (48%), Managed services cloud security (34%).]
...
![Chart showing criteria for choosing cloud security: Cost (60%), Less solution complexity (59%), Ease of use (52%), Performance (46%), Quicker deployments (32%), No need to manage another vendor (30%), Cloud vendor security is good enough (12%), Other (5%).]
...
![Chart showing multi-cloud security challenges: Ensuring data protection and privacy (58%), Having the right skills (57%), Understanding how different solutions fit together (52%), Loss of visibility and control (46%), Keeping up with the rate of change (44%), Understanding service integration (42%), Selecting the right set of services (35%), Providing seamless access (28%), Managing the costs (28%), Other (3%).]
...
![Chart showing helpfulness of a single cloud security platform: Not at all helpful (3%), Slightly helpful (4%), Moderately helpful (15%), Very helpful (40%), Extremely helpful (38%).]

---

## Methodology & Demographics
The 2021 Cloud Security Report is based on the results of a comprehensive online global survey of 572 cybersecurity professionals, conducted in April 2021.

**Career Level**: Specialist (20%), Consultant (18%), Manager/Supervisor (17%), CTO, CIO, CISO, CMO, CFO, COO (17%), Director (14%), Vice President (4%), Other (10%).

**Department**: IT Security (57%), IT Operations (15%), Engineering (7%), Operations (4%), Compliance (4%), DevOps (2%), Product Management (2%), SecOps (2%), Other (7%).
