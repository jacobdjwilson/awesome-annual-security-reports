...
![Ransomware leak site statistics as of mid-August 2021. The number that follows the slash represents the "Number of days between new victims". (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/ransomware-leak-site-statistics.png)
...
# This is a placeholder for the actual script content, as it was not provided in the text.
```
...
![REvil Linux variant (‘REvix’) attempting to shut down VMs prior to encryption of the hypervisor. (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/revil-linux-variant.png)
*REvil Linux variant (‘REvix’) attempting to shut down VMs prior to encryption of the hypervisor. (Source: Secureworks)*

![May 2021 forum post advertising REvil Linux variant. (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/revil-linux-variant-forum-post.png)
...
![Ransomware operators are adding extra tactics to exert extra pressure. (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/ransomware-extortion-tactics.png)
...
![The ransomware ecosystem. (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/ransomware-ecosystem.png)
...
![An example of an access for sale. (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/access-for-sale.png)
*An example of an access for sale. (Source: Secureworks)*

![BlackMatter operator advertising to buy access. (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/blackmatter-operator-advertising.png)
...
![Groups looking for affiliates on underground forums often advertise for ‘pentesters’. (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/groups-looking-for-affiliates.png)
*Groups looking for affiliates on underground forums often advertise for ‘pentesters’. (Source: Secureworks)*

![Babuk advertising for two affiliates. (Source: Secureworks)](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/babuk-advertising-for-affiliates.png)
...
In early June 2021, the FBI director, Christopher Wray, said[^3] that the cybercrime threat presented “a lot of parallels” to the threat of terrorism before 9/11. In response to a question about whether the U.S. was considering military action against ransomware operators, the commerce secretary, Gina Raimondo, said[^4] that “all the options” were being considered. So far, a range of different response options are being used.
...
![Security basics add up to ransomware protection.](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/security-basics-ransomware-protection.png)
...
# Scan-and-Exploit— Patch or Be Punished
...
![Prominent attacks leveraging zero-day exploits](https://www.secureworks.com/resources/rp-state-of-the-threat-2022/images/prominent-zero-day-attacks.png)
