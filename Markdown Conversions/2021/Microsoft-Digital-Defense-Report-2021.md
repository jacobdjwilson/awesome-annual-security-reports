...
![Image: Microsoft security signals - Volume and diversity of signals processed by Microsoft]
...
Through our investigations of online organized crime networks, frontline investigations of customer attacks, security and attack research, nation state threat tracking, and security tool development, we continue to see the cybercrime supply chain consolidate and mature. It used to be that cybercriminals had to develop all the technology for their attacks. Today, they rely on a mature supply chain, where specialists create cybercrime kits and services that other actors buy and incorporate into their campaigns.
...
![Image: Sample analysis of roles and relationships between entities within the ransomware ecosystem]

![Image: Stakeholders and roles involved in post-breach response]

![Image: Ransomware negotiation chat]

![Image: Ransom recovery site]

![Image: Chat session following ransom note upload]

![Image: Conti News site]

![Image: Phishing email using compromised service on behalf of legitimate companies]

![Image: Legitimate infrastructure abuse]

---

il Malware Malicious domains Adversarial machine learning
