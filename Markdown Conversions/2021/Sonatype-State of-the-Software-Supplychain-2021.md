...
The official report URL is: https://www.sonatype.com/resources/whitepapers/2021-state-of-the-software-supply-chain-report-2021
...
| :------------ | :------------- | :--------------------- | :--------------------- | :------------------ | :---------------------------- | :------------------------------------------------- | :------------------------------------------------- |
| Java          | 431k           | 7.3M                   | 457B                   | 71%                 | 15%                           | 29%                                                | 6.5%                                               |
| JavaScript    | 1.9M           | 21M                    | 1.5T                   | 50%                 | 2%                            | 39%                                                | 8%                                                 |
| Python        | 336K           | 3M                     | 127B                   | 92%²                | 4%                            | 38%                                                | 8%                                                 |
| .NET          | 338K           | 5.6M                   | 78B                    | 78%                 | 2%                            | 15%                                                | 4%                                                 |
| Totals/Averages | 3M             | 37M                    | 2.2T                   | 73%                 | 6%                            | 23%                                                | 6%                                                 |

² YoY growth estimated based on known PyPi downloads from March to August 2021 as queried from pypistats.org.

![Figure 1.2: Available Supply of Open Source, 2021](https://example.com/image1.2.png)
...
![Figure 1.3: Increase in Downloads Year Over Year 2020 – 2021](https://example.com/image1.3.png)

![Figure 1.4: Annual Download Volumes, 2021](https://example.com/image1.4.png)
...
![Figure 1.5: Vulnerable Release Density vs. Popularity](https://example.com/image1.5.png)
...
![Figure 1.6: Next Generation Software Supply Chain Attacks (2015 – 2021) Dependency Confusion, Typosquatting, and Malicious Code Injection](https://example.com/image1.6.png)
...
![Figure 1.7: Next Generation Software Supply Chain Attacks July 2019 – July 2021](https://example.com/image1.7.png)

![Figure 1.8: A Timeline of Dependency Confusion July 2020 – March 2021](https://example.com/image1.8.png)
...
![Figure 2.1: Calculating MTTU](https://example.com/image2.1.png)

![Figure 2.2: MTTU Performance, 2020](https://example.com/image2.2.png)
...
---
⁶ Since 2021 has not yet ended, it is possible this number will change.
---
...
OpenSSF has a set of analyses that combine into a metric called “criticality." Criticality measures a project's community, usage, and