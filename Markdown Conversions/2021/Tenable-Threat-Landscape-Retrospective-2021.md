...
We tracked government, vendor and researcher advisories to understand the vulnerability and threat landscapes. Our breach data was compiled by collecting publicly available information from national and local news outlets reporting on data breaches from November 2020 through October 2021. The common vulnerability scoring system (CVSS) scores found throughout the report are derived from the National Institute of Standards and Technology’s (NIST) National Vulnerability Database (NVD). In cases where no NVD score is available, scoring is based on the vendor advisory or vulnerability disclosure.
...
![Timeline of Print Spooler Disclosures](placeholder_image_description)
...
![2021 Zero-Day Vulnerabilities by Software/Hardware Type](placeholder_image_description)
...
![2021 Zero-Day Vulnerabilities by Vendors](placeholder_image_description)
...
![2021 Zero-Day Vulnerabilities by Products](placeholder_image_description)

Our analysis shows that 83% of the zero-day vulnerabilities we’ve tracked in 2021 have been exploited in the wild.

![2021 Zero-Day Vulnerabilities by In-the-Wild Exploitation](placeholder_image_description)
...
In the same month, on September 14, researchers from the Wiz Research Team disclosed OMIGOD, four vulnerabilities in Microsoft Azure’s