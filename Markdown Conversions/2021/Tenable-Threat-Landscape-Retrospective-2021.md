...
Tenable  
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 3
...
21,957  
New CVEs Assigned in 2021

1,825  
Total Breach Entries*
...
1. **PROXYLOGON**, MICROSOFT WINDOWS EXCHANGE SERVER (`CVE-2021-26855`)
2. **PRINTNIGHTMARE**, PRINT SPOOLER (`CVE-2021-34527`)
3. **VMWARE VSPHERE**, PULSE CONNECT SECURE (`CVE-2021-21985`)
4. **ZEROLOGON**, WINDOWS NETLOGON PROTOCOL (`CVE-2021-22893` / `CVE-2020-1472`)
5. **ZEROLOGON**, WINDOWS NETLOGON PROTOCOL (`CVE-2020-1472`)

*\* November 2020 - October 2021*  
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 4

---

## Key Takeaways
- **Evolution of the perimeter:** Adoption of cloud solutions, software and infrastructure as a service, and the increasingly complex service provider ecosystem all continue to challenge traditional conceptions of the perimeter. However, traditional perimeter devices like VPNs remain valuable targets for attackers.
- **Patching problems:** Staying on top of patching assets is difficult enough, but in 2021 it was even more challenging due to incomplete patches, miscommunications from vendors and patch bypasses, making it even harder for defenders to stay on top of securing critical systems.
- **Majority of zero-days exploited in the wild:** 83% of zero-day vulnerabilities disclosed in 2021 were exploited in attacks with web browser zero-days accounting for over 30% of them.
- **Ongoing risks of interconnection:** Code and library re-use have resulted in vulnerabilities persisting for years across potentially millions of sensitive operational technology (OT) devices. Software libraries and network stacks used commonly amongst OT devices often introduce additional risk when security controls and code audits are not in place.
- **Misconfigurations increase risk:** Cloud and Active Directory (AD) misconfigurations are low hanging fruit for threat actors. Openly accessible cloud databases and overly permissive AD configurations give attackers access to an organization’s most sensitive information.
- **Attackers target AD environments:** Threat groups, particularly ransomware, have increasingly exploited vulnerabilities and misconfigurations in Active Directory.
- **Surging ransomware attacks:** Ransomware attacks increased in both volume and sophistication. Ransomware groups leveraged zero-days and legacy vulnerabilities alike to target sensitive sectors like healthcare, education and the physical supply chain.
- **Physical and software supply chains under attack:** Supply chains of all kinds were targeted by diverse threat groups in 2021. Ransomware groups favored physical supply chain disruption as a tactic to extort payment while cyberespionage campaigns exploited the software supply chain to access sensitive data. And 61% of security leaders reported that their organization was exposed to increased risk related to its expanding supply chain.
- **Data breaches continue to increase:** Over 2.5 times as many breaches were reported in 2021 than in 2020. Additionally, there was a 78% increase in the number of records exposed.

TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 5
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 6
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 7

---

## SECTION 1: VULNERABILITY LANDSCAPE
Each year, members of the security community disclose tens of thousands of vulnerabilities in a variety of products used for business. From 2016 to 2021, the number of reported CVEs increased at an average annual growth rate of 28.3%. The 21,957 CVEs reported in 2021 represent a 19.6% increase over the 18,358 reported in 2020 and a 241% increase over the 6,447 disclosed in 2016.
...
| --- | --- | --- |
| **ProxyLogon** | | |
| `CVE-2021-26855` | Server-Side Request Forgery | 9.8 |
...
| **ProxyShell** | | |
| `CVE-2021-34473` | Remote Code Execution | 9.8 |
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 8
...
> THE PROXYSHELL ATTACK CHAIN WILL REMAIN AMONG THE TOP EXPLOITED VULNERABILITIES FROM 2021.
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 9
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 10
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 11
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 12
...
- `CVE-2019-11510`: Pulse Connect Secure Arbitrary File Disclosure
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 13

> UNPATCHED SSL VPNS ARE AN IDEAL ENTRY POINT FOR ATTACKERS TO GAIN A FOOTHOLD IN A NETWORK TO PERFORM CYBERESPIONAGE, EXFILTRATE SENSITIVE AND PROPRIETARY INFORMATION AS WELL AS ENCRYPT NETWORKS AND HOLD THEM FOR RANSOM.
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 14
...
The joint cybersecurity advisory from CISA, the FBI, ACSC and NCSC that listed the most exploited vulnerabilities in 2020 and the first half of 2021 stated that threat actors have been prioritizing “perimeter-type devices” in their attacks. Microsoft Exchange, Accellion, Pulse Secure and Fortinet SSL VPNs were the most exploited for the first half of the year and are covered in other sections of this report.

The Accellion incident at the beginning of the year, wherein threat actors leveraged a vulnerability in the File Transfer Appliance, had a far-reaching impact. Dozens of organizations have disclosed data breaches linked to the four zero-days patched by Accellion.
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 15
...
| Date | Campaign | Number of Vulnerabilities Identified |
| --- | --- | --- |
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 16
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 17
...
42% of organizations moved business-critical function to the cloud  
36% moved non-business-critical functions  
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 18
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 19
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 20
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 21

### Ransomware
> RANSOMWARE IS MALICIOUS SOFTWARE (OR MALWARE) DESIGNED TO ENCRYPT FILES ON SYSTEMS, HOLDING ORGANIZATIONS HOSTAGE UNLESS A RANSOM DEMAND HAS BEEN PAID.
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 22
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 23
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 24
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 25

![2021 Breaches by Industry]

This year’s breaches may seem like deja vu, because the same most-targeted industries from 2020, healthcare and education, remained firmly at the top.
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 26
...
As organizations continue to collect troves of data, often out of necessity and in some cases indirectly collected from use of service, the stakes grow higher for the stewards of such data to properly store and secure all they collect. Ransomware groups, vulnerabilities and misconfigurations are just a few of the threats organizations face today — and these threats will continue to pose a risk for years to come.

---

## CONCLUSION
[Content continues or concludes based on document structure]

---

## SECTION 3: A CLOSER LOOK AT THE KEY VULNERABILITIES IN 2021
[Content continues based on document structure]

---

althcare, education, government and technology companies have proven
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 27
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 28
...
Zero-day Noteworthy Exploited in Top 5
the Wild
R
...
crafted request as part of the Host header to the document_root file on a vulnerable FTA endpoint.
...
malicious file.
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 29
...
also lead to RCE.
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 30
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 31
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 32
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 33
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 34
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 35
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  36
...
SSL VPN endpoint. This would allow the attacker to read arbitrary files from the device including the contents of the “sslvpn_
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 37
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 38
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 39
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 40
...
• Azure Automation • Azure Configuration Management
• Azure Automatic Update • Azure Diagnostics
• Azure Operations Management Suite • Azure Container Insights
• Azure Log Analytics
Please note that this may not be a complete list and additional services may deploy OMI.
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 41
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 42
...
controllers.
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 43
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 44
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 45
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  46
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  47
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 48
...
| -------------- | ------------------------------ | -------- | --- | --- |
| CVE-2021-27439 | Integer Overflow or Wraparound |          |     | 7.3 |
TencentOS-tiny
...
| CVE-2021-30636 | Integer Overflow or Wraparound |     |     | 7.3 |
| -------------- | ------------------------------ | --- | --- | --- |
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  49
...
providers including:
| •  Amazon Nimble Studio AMI |     | •  Accops HyWorks DVM Tools        |     |     |     |
| --------------------------- | --- | ---------------------------------- | --- | --- | --- |
| •  Amazon NICE DCV          |     | •  Eltima USB Network Gate         |     |     |     |
| •  Amazon WorkSpaces        |     | •  Amzetta zPortal Windows zClient |     |     |     |
| •  Amazon AppStream         |     | •  Amzetta zPortal DVM Tools       |     |     |     |
| •  NoMachine                |     | •  FlexiHub                        |     |     |     |
| •  Accops HyWorks           |     | •  Donglify                        |     |     |     |
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  50
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  51
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  52
...
| CVE-2020-7461  |             | Message Compression       | RCE              | 7.3    |
FreeBSD
...
| CVE-2021-31884 | DHCP Client |     |     | 9.8 |
| -------------- | ----------- | --- | --- | --- |
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  53
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE                                  54
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 55
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 56
...
• vSAN Health Check • vSphere Lifecycle Manager
• Site Recovery • VMware Cloud Director Availability
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 57
...
About the Authors
Scott Caveza, Research Engineering Manager Satnam Narang, Staff Research Engineer
...
TENABLE’S 2021 THREAT LANDSCAPE RETROSPECTIVE 58
