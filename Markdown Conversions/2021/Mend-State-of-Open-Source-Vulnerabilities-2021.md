...
- [Open Source Vulnerabilities per Year: 2009-2020](#open-source-vulnerabilities-per-year-2009-2020)
...
- [Most Common CWEs in Open Source Components](#most-common-cwe-in-open-source-components)
- [Open Source Vulnerabilities in 2020: Top CWEs](#open-source-vulnerabilities-in-2020-top-cwe)
- [Open Source Vulnerabilities in 2020: Top CWEs (Continued)](#open-source-vulnerabilities-in-2020-top-cwe-continued)
- [Top CWEs per Programming Language 2020](#top-cwe-per-programming-language-2020)
...
![Bar chart showing the number of open source vulnerabilities per year from 2009 to 2020. The number of vulnerabilities shows a significant increase in 2020.](open-source-vulnerabilities-per-year.png)
...
![Table showing the top CWEs in open source components from 2015 to 2020. CWE-79 (XSS) consistently appears as a top vulnerability.](top-cwe-in-open-source-components.png)

## Open Source Vulnerabilities in 2020: Top CWEs (Continued)
...
![Table showing the top CWEs per programming language in 2020. Different languages show different dominant CWEs.](top-cwe-per-programming-language.png)
...
![Bar chart comparing the percentage of vulnerabilities in top programming languages for 2019 and 2020.](vulnerabilities-in-top-programming-languages.png)
...
![Pie chart showing the severity breakdown of open source vulnerabilities in 2020. Critical and High vulnerabilities make up a significant portion.](open-source-vulnerabilities-severity-breakdown.png)
