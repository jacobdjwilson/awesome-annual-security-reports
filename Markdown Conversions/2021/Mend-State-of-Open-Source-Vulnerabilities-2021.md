...
## Table of Contents
1. [The Number of Open Source Vulnerabilities Continues to Rise](#the-number-of-open-source-vulnerabilities-continues-to-rise)
2. [Most Common CWEs in Open Source Components](#most-common-cwes-in-open-source-components)
3. [Open Source Vulnerabilities: Severity Breakdown](#open-source-vulnerabilities-severity-breakdown)
4. [Final Thoughts](#final-thoughts)
5. [About Mend](#about-mend)
...
*Image Description: A bar chart showing the number of open source vulnerabilities per year from 2009 to 2020. The y-axis represents the number of vulnerabilities, ranging from 0 to 10,000, and the x-axis represents the years. The chart shows a steady increase in vulnerabilities over the years, with a significant jump in 2020.*
...
| Year | CWE-79 (XSS) | CWE-119 (Buffer Overflow) | CWE-264 (Permissions, Privileges, and Access Controls) | CWE-190 (Integer Overflow) | CWE-20 (Improper Input Validation) | CWE-787 (Out-of-bounds Write) | CWE-125 (Out-of-bounds Read) | CWE-200 (Information Exposure) | CWE-89 (SQL Injection) | CWE-325 (CSRF) |
|---|---|---|---|---|---|---|---|---|---|---|
| 2015 | XSS | Buffer Overflow | Permissions, Privileges, and Access Controls | Integer Overflow | Improper Input Validation |  | Out-of-bounds Read | Information Exposure | SQL Injection | CSRF |
| 2016 | XSS | Buffer Overflow | Permissions, Privileges, and Access Controls |  | Improper Input Validation |  | Out-of-bounds Read | Information Exposure | Improper Input Validation |  |
| 2017 | XSS | Buffer Overflow |  |  | Improper Input Validation |  | Out-of-bounds Read | Information Exposure | Improper Input Validation |  |
| 2018 | XSS |  |  |  | Improper Input Validation |  | Out-of-bounds Read | Information Exposure |  |  |
| 2019 | XSS |  |  |  | Improper Input Validation |  | Out-of-bounds Read | Information Exposure |  |  |
| 2020 | XSS |  |  |  | Improper Input Validation | Out-of-bounds Write | Out-of-bounds Read | Information Exposure |  |  |
...
| Language | Top CWEs |
|---|---|
| JavaScript | CWE-79 (XSS), CWE-862 (Missing Authorization), CWE-502 (Deserialization of Untrusted Data) |
| Java | CWE-79 (XSS), CWE-20 (Improper Input Validation), CWE-787 (Out-of-bounds Write) |
| PHP | CWE-79 (XSS), CWE-89 (SQL Injection), CWE-352 (Cross-Site Request Forgery) |
| Python | CWE-79 (XSS), CWE-20 (Improper Input Validation), CWE-200 (Information Exposure) |
| Ruby | CWE-200 (Information Exposure), CWE-79 (XSS), CWE-863 (Improper Input Validation) |
| C | CWE-787 (Out-of-bounds Write), CWE-125 (Out-of-bounds Write), CWE-476 (NULL Pointer Dereference) |
| C++ | CWE-732 (Incorrect Permission Assignment for Critical Resource), CWE-200 (Information Exposure), CWE-20 (Improper Input Validation) |
...
*Image Description: A bar chart comparing the percentage of vulnerabilities in different programming languages between 2019 and 2020. The y-axis represents the percentage of vulnerabilities, ranging from 0% to 30%, and the x-axis represents the programming languages. The chart shows that some languages like C and Go saw an increase in vulnerabilities, while others like PHP saw a decrease.*
...
*Image Description: A pie chart showing the severity breakdown of open source vulnerabilities in 2020. The chart is divided into four sections: Low (3%), Medium (45%), High (38%), and Critical (15%).*
...
For more information, visit [www.mend.io](www.mend.io), the Mend blog, and Mend on LinkedIn and Twitter.
