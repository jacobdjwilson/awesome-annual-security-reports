...
[Appendix](#appendix)
[Key industry highlights](#key-industry-highlights)
[Key regional highlights](#key-regional-highlights)
[Methodology and demography](#methodology-and-demography)
...
*   19% Public disclosure of a data breach
*   18% Employees terminated/prosecuted
*   17% Criminal investigation
*   16% Suffered incidents, no major impact

To do so, survey respondents claim they will conduct more security controls audits (35%), scan software updates more frequently (30%), increase penetration testing (27%) and ramp up multifactor authentication (26%). While these actions can improve security, they also stretch already limited resources.

On that point: 78% of organizations report one or more challenges related to the cybersecurity team’s capabilities or scalability, including the sheer volume of security alerts that redirect efforts from proactive improvement to tactical firefighting, and the drag caused by manual processes.
...
*   Image: A bar chart showing the percentage of extensive and moderate users of SaaS, IaaS, and PaaS.
    *   SaaS: 69% Extensive users, 28% Moderate users
    *   IaaS: 58% Extensive users, 34% Moderate users
    *   PaaS: 46% Extensive users, 41% Moderate users
...
*   Image: A graphic showing the ubiquity of public cloud approaches, with percentages for SaaS, IaaS, and PaaS.
    *   SaaS: 97% total users
    *   IaaS: 92% total users
    *   PaaS: 87% total users
...
*   Image: A pie chart showing the percentage of organizations' business-critical applications and workloads residing in any public cloud.
    *   44% percent report more than 75% are in the public cloud
    *   32% percent report 51% to 75% are in the public cloud
    *   9% percent report 26% to 50% of their applications/workloads are in the public cloud
...
*   50% struggle to maintain security consistency across data center and public cloud environments
*   42% find using multiple cybersecurity controls increases associated costs and complexity
*   29% struggle with a lack of visibility into public cloud infrastructure
...
*   Image: A pie chart showing how respondents feel about keeping up with security requirements in the past two years.
...
*   Image: A bar chart showing the top remote worker security challenges, with percentages for strongly agree, agree, neither agree nor disagree, and disagree.
    *   Ensuring remote employee devices run endpoint security software: 2% Strongly agree, 36% Agree, 47% Neither agree nor disagree, 15% Disagree
    *   Ensuring remote employee devices have secure configuration: 2% Strongly agree, 34% Agree, 49% Neither agree nor disagree, 15% Disagree
    *   Providing secure access to cloud-based apps/resources: 3% Strongly agree, 32% Agree, 49% Neither agree nor disagree, 16% Disagree
    *   Providing secure access to the corporate network: 3% Strongly agree, 30% Agree, 53% Neither agree nor disagree, 14% Disagree
...
*   Image: A bar chart showing the security implications of remote work, with percentages for strongly agree, agree, neither agree nor disagree, and disagree.
    *   The remote work shift strengthened collaboration between IT/security operations teams: % Strongly agree, % Agree, % Neither agree nor disagree, % Disagree
    *   The rise of remote work led to better security process automation: % Strongly agree, % Agree, % Neither agree nor disagree, % Disagree
    *   Remote work trends caused an increase in cloud-based security technologies: % Strongly agree, % Agree, % Neither agree nor disagree, % Disagree
    *   SOC continually implements rules to address remote-work-related risks: % Strongly agree, % Agree, % Neither agree nor disagree, % Disagree
...
*   Image: A pie chart showing the percentage of organizations in which the CISO had briefed senior executives/board about the SolarWinds hacks as of Feb. 2021.
    *   47% Yes
    *   36% Not yet, but will likely happen
    *   15% No
    *   2% Don’t know
...
*   Image: A bar chart showing the percentage of organizations that took specific actions after the SolarWinds hacks.
    *   23% Segmented org network
    *   35% Assessed current security controls
    *   31% Increased cybersecurity budget
    *   30% Increased software update scanning efforts
    *   29% Added new detection rules
    *   27% Adopted more supply chain security policies
    *   27% Conducted penetration testing or red teaming exercise
    *   26% Adopted strong authentication tech
    *   26% Conducted incident response activities
    *   26% Conducted third-party risk assessment
    *   24% Increased meetings between CISO/executives/board
    *   23% Reassessed vendor risk management policies
    *   17% Replaced infrastructure software with suboptimal security policies
...
On the other hand, we’d have expected to turn up a pretty similar list in 2019. For security leaders to adapt their strategies to 2021’s realities, the new technologies deployed should include a zero trust strategy — because the old network-focused idea of “perimeter protection” just won’t cut it. They should pay particular attention to the new cloud technologies hurriedly deployed to cope with remote workforces because of the pandemic. And tests of security processes should consider the new circumstances: more data in the cloud, and more employees — including security staff — working remotely. (For more, see key recommendations.)
...
*   Image: A pie chart showing how respondents feel about the role of security analytics in security strategy today compared with two years ago.
    ...
    *   35% Agree security analytics plays a bigger role now
    *   47% Agree security analytics plays a somewhat bigger role now
    *   16% Agree security analytics plays the same role now
...
*   Image: A bar chart showing the decisions most influenced by security analytics.
    *   45% Threat detection/response decision
    *   41% Risk identification
    *   39% Security controls decisions
    *   36% Determining areas where more analytics are needed
    *   23% Process automation decisions
    *   25% Investment decision
    *   23% Budgeting decisions
    *   15% Staffing decisions
    *   22% Outsourcing/services decisions
...
*   Image: A bar chart showing how organizations are deploying ML for security.
    *   24% Using extensively
    *   30% Using on a limited basis
    *   21% Currently deploying
    *   13% Planning ML projects
    *   9% Not yet, but interested
    *   3% Not interested or don’t know
...
*   Image: A bar chart showing the areas prioritized for increases in security spending.
    *   41% Cloud security
    ...
    *   19% Training cybersecurity staff
    *   15% Staffing
...
3.  **Rethink your approach to supply chain threats.**
    ...
    For supply chain threats (and any other kind), you need to improve your ability to see suspicious lateral movement within your networks. Whether bad guys sneak in through a vendor’s software patch or an employee’s stolen credentials, you’ll