...
**Figure 1:** Frequency of successful cyberattacks in the last 12 months. *[Description: A bar chart showing the frequency of successful cyberattacks, with categories ranging from 0 to 10+ incidents. The majority of respondents reported 1-5 incidents, with a significant portion reporting 6+ incidents.]*

**Figure 2:** Percentage of organizations compromised by at least one successful attack. *[Description: A line graph showing the percentage of organizations experiencing at least one successful attack from 2014 to 2021. The line shows a steady increase over time, reaching over 85% in 2021.]*

> “This year, we saw the largest annual increase in successful attacks within the last six years.”

**Figure 3:** Percentage compromised by at least one successful attack in the past 12 months, by industry. *[Description: A bar chart comparing the percentage of organizations compromised by at least one successful attack across different industries, including Education, Manufacturing, Telecom & Technology, Finance, Healthcare, Retail, and Government. Education and Manufacturing have the highest percentages.]*

**Figure 4:** Percentage compromised by at least one successful attack in the past 12 months, by country. *[Description: A bar chart comparing the percentage of organizations compromised by at least one successful attack across different countries. Colombia, China, and Germany have the highest percentages, while the United Kingdom, Japan, and Australia have the lowest.]*
...
**Figure 5:** Percentage indicating compromise is “more likely to occur than not” in the next 12 months. *[Description: A line graph showing the percentage of respondents who believe a successful cyberattack is more likely than not in the next 12 months, from 2014 to 2021. The line shows a significant increase over time, reaching over 75% in 2021.]*
...
**Figure 6:** Percentage indicating compromise is “more likely to occur than not” in the next 12 months, by industry. *[Description: A bar chart comparing the percentage of respondents who believe a successful cyberattack is more likely than not in the next 12 months across different industries. Manufacturing and Retail have the highest percentages, while Healthcare and Government have the lowest.]*
...
**Figure 7:** Perceived security posture by IT domain. *[Description: A bar chart showing the average security posture rating (on a scale of 1 to 5) for various IT domains, including Mobile Devices, IoT Devices, ICS/SCADA, Servers, Websites/Web Apps, Datastores, Cloud Applications, Cloud Infrastructure, Application Containers, Network Perimeter/DMZ, Email Servers, and Wireless Networks. Mobile Devices have the lowest rating, indicating the weakest security posture.]*
...
**Figure 8:** Perceived adequacy of functional security capabilities. *[Description: A bar chart showing the average adequacy rating (on a scale of 1 to 5) for various IT security functions, including Third-Party Risk Management, Attack Surface Reduction, Incident Investigation & Response, Brand Protection, GRC, Security Awareness Training, Security Operations, Security Engineering/Architecture, Threat Intelligence, Security Monitoring, and Security Policy Development. Third-Party Risk Management has the lowest rating, indicating the most challenging area.]*
...
**Figure 9:** Percent of organizations experiencing a shortfall of skilled IT security personnel. *[Description: A bar chart showing the percentage of organizations experiencing a shortfall of skilled IT security personnel from 2014 to 2021. The line shows a steady increase over time, reaching 87% in 2021.]*
...
**Figure 10:** Cybersecurity skills shortage, by role. *[Description: A bar chart comparing the percentage of organizations experiencing a skills shortage across different IT security roles, including IT Security Administrators, IT Security Analysts/Operators/Incident Responders, IT Security Architects/Engineers, DevSecOps Engineers, and Other. IT Security Administrators have the highest percentage, followed by IT Security Analysts/Operators/Incident Responders.]*
...
On a scale of 1 to 5, with 5 being highest, rate your overall concern