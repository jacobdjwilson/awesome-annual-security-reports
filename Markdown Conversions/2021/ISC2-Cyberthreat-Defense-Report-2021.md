...
The official report URL is: https://www.isc2.org/certifications/cissp
...
- [Section 4: Practices and Strategies](#section-4-practices-and-strategies)
  ...
  - [SSL/TLS Traffic Decryption Challenges](#ssl-tls-traffic-decryption-challenges)
...
In last year’s CDR, we saw a small uptick in successful cyber-attacks as we crossed the 80% threshold for the first time in our report’s history. This year, we saw the largest annual increase in successful attacks within the last six years. Just over 86% of our responding organizations experienced at least one successful cyberattack within the preceding 12 months, with about four in 10 organizations experiencing six incidents or more (see Figures 1 and 2).
...
![Figure 1: Frequency of successful cyberattacks in the last 12 months.](Image description)
![Figure 2: Percentage of organizations compromised by at least one successful attack.](Image description)
![Figure 3: Percentage compromised by at least one successful attack in the past 12 months, by industry.](Image description)
![Figure 4: Percentage compromised by at least one successful attack in the past 12 months, by country.](Image description)
...
![Figure 5: Percentage indicating compromise is “more likely to occur than not” in the next 12 months.](Image description)
![Figure 6: Percentage indicating compromise is “more likely to occur than not” in the next 12 months, by industry.](Image description)
...
![Figure 7: Perceived security posture by IT domain.](Image description)
...
![Figure 8: Perceived adequacy of functional security capabilities.](Image description)
...
![Figure 9: Percent of organizations experiencing a shortfall of skilled IT security personnel.](Image description)
![Figure 10: Cybersecurity skills shortage, by role.](Image description)
