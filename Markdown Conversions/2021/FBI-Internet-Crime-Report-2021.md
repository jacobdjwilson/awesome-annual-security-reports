...
- [2021 Crime Types](#2021-crime-types)
  - [By Victim Count](#by-victim-count)
  - [By Victim Loss](#by-victim-loss)
- [Last 3 Year Complaint Count Comparison](#last-3-year-complaint-count-comparison)
  - [By Victim Count](#by-victim-count-1)
- [Last 3 Year Complaint Loss Comparison](#last-3-year-complaint-loss-comparison)
  - [By Victim Loss](#by-victim-loss-1)
- [Overall State Statistics](#overall-state-statistics)
  - [Victim per State*](#victim-per-state)
  - [Total Victim Losses by State*](#total-victim-losses-by-state)
  - [Count by Subject per State*](#count-by-subject-per-state)
  - [Subject Earnings per Destination State*](#subject-earnings-per-destination-state)
...
The official report URL is: https://www.fbi.gov/news/press-releases/fbi-releases-the-internet-crime-complaint-center-2021-internet-crime-report
...
![Image description: Image lists IC3’s primary functions including partnering with private sector and with local, state, federal, and international agencies: hosting a victim reporting portal at www.ic3.gov; providing a central hub to alert the public to threats; Perform Analysis, Complaint Referrals, and Asset Recovery; and hosting a remote access database for all law enforcement via the FBI’s LEEP website.]
...
*   **COLLECTION**: The IC3 is the central
...
3 ![Image description: Chart includes yearly and aggregate data for complaints and losses over the years 2017 to
...
4 ![Image description: Chart includes a victim loss comparison for the top five reported crime types for the years
of 2017 to 2021.]
...
sophisticated scam targeting both businesses and individuals performing transfers
of funds. The scam is frequently carried out when a subject compromises legitimate business
...
5 ![Image description: Image shows the different stages of a complaint in the RAT process.]
...
6 ![Image description: Image shows Success to Date to include 74% Success Rate; 1,726 Incidents; $433.48 Million
...
who experienced more than $956 million in
losses to Confidence
...
Con artists are present on most dating and
social media sites. In 2021, the IC3 received thousands of
...
7 ![Image description: Chart shows Confidence Fraud/Romance Scam Victim by Reported Age Group. Under 20
...
11 ![Image description: Image shows actions you can Take to Protect Against Ransomware: Update your operating
...
13 ![Image description: Chart shows Infrastructure Sectors Victimized by Ransomware. Healthcare and Public
...
14 ![Image description: Chart shows top variants Victimizing Critical Infrastructure 2021 Incidents.
...
Tech Support Fraud involves a criminal claiming to provide customer, security, or technical
support or service to defraud unwitting individuals. Criminal