...
3.  [Section 1: A thriving dark web market for cloud access](#section-1-a-thriving-dark-web-market-for-cloud-access)
4.  [Section 2: Vulnerabilities in cloud environments grow in number and severity](#section-2-vulnerabilities-in-cloud-environments-grow-in-number-and-severity)
5.  [Section 3: How threat actors are getting into cloud environments](#section-3-how-threat-actors-are-getting-into-cloud-environments)
6.  [Section 4: Threat actors using cloud environments for miners, ransomware, botnets and worse](#section-4-threat-actors-using-cloud-environments-for-miners-ransomware-botnets-and-worse)
7.  [Section 5: Recommendations and best practices for preparing for and reacting to cloud breaches](#section-5-recommendations-and-best-practices-for-preparing-for-and-reacting-to-cloud-breaches)
...
*   **Image:** A line graph shows the number of cloud vulnerabilities tracked by X-Force from 2006 to 2021. The number of vulnerabilities increases steadily over time, with a significant jump in the last few years. The Y-axis is labeled "Number of cloud vulnerabilities tracked by X-Force" and the X-axis is labeled with years from 2006 to 2021.
...
*   **Image:** A pie chart shows the distribution of cloud account access types found on the dark web. RDP access accounts for 71%, cPanel and Shell access each account for 4.5%, and other access types account for 20%.
...
*   **Image:** A bar chart shows the frequency of unique code strings for different malware categories. Miners have the highest frequency, followed by ransomware, botnets, and then bankers. The Y-axis is labeled "Unique code string frequency" and the X-axis is labeled "Malware category".
