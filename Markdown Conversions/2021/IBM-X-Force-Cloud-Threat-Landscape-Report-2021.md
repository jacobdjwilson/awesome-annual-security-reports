...
- **Public API policies** represented a significant security gap. Two-thirds of the incidents analyzed involved improperly configured Application Programming Interfaces (APIs), based on analysis of X-Force Incident Response data of impacted clients.
...
![Number of cloud vulnerabilities tracked by X-Force chart showing growth up to 2500 total vulnerabilities from 2006 to 2021]
...
![Dark web cloud accounts by access type pie chart showing 71% RDP, 20% Other, 4.5% cPanel, and 4.5% Shell]
...
![Frequency of unique code strings chart comparing Banker, Botnet, Miner, and Ransomware]
