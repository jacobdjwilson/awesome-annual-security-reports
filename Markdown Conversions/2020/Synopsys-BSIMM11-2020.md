...
- [BSIMM11 Table of Contents](#bsimm11-table-of-contents)
...
NEC Platforms | Adobe | F-Secure | NetApp
--- | --- | --- | ---
Aetna | Fannie Mae | NewsCorp | Alibaba
Freddie Mac | NVIDIA | Ally Bank | General Electric
PayPal | Autodesk | Genetec | Axway
Global Payments | Pegasystems | Bank of America | Bell
Highmark Health Solutions | Royal Bank of Canada | BMO Financial Group | Black Duck Software
Horizon Healthcare Services, Inc. | ServiceNow | HSBC | Synopsys
Black Knight Financial Services | Box | iPipeline | TD Ameritrade
Johnson & Johnson | The Home Depot | Canadian Imperial Bank of Commerce | JPMorgan Chase & Co.
The Vanguard Group | City National Bank | Lenovo | Cisco
MassMutual | Trainline | Citigroup | McKesson
Trane | Dahua | Medtronic | U.S. Bank
Depository Trust & Clearing Corporation | Morningstar | Veritas | Eli Lilly
Navient | Verizon | Equifax | Navy Federal Credit Union
Verizon Media | Experian | NCR | Wells Fargo
Zendesk | | |
...
Executive Summary. ...................................................3 PART TWO: BSIMM11
...
- A Description of Two Journeys .................................28 Intelligence .................................................................   67
...
- Intelligence: Security Features & Design (SFD)    ....69
  ...
  - Select In-Scope Software SSDL Touchpoints ........................................................   73
...
Deployment .................................................................  79
  ...
  - Document and Socialize the SSI
...
Figure 9. Financial vs. FinTech Spider Chart .................           51
...
Other work around modeling SSIs has either described the experience of a single organization or offered prescriptive guidance based purely on a combination of personal experience and opinion.
...
PAGE 12 | BUILDING SECURITY IN MATURITY MODEL (BSIMM) – VERSION 11
...
BUILDING SECURITY IN MATURITY MODEL (BSIMM) – VERSION 11 | PAGE 13
...
PAGE 14 | BUILDING SECURITY IN MATURITY MODEL (BSIMM) – VERSION 11
...
BUILDING SECURITY IN MATURITY MODEL (BSIMM) – VERSION 11 | PAGE 15
...
PAGE 16 | BUILDING SECURITY IN MATURITY MODEL (BSIMM) – VERSION 11
...
BUILDING SECURITY IN MATURITY MODEL (BSIMM) – VERSION 11 | PAGE 17
...
Today, especially in engineering-led organizations, builders often invite SSG members to participate directly in engineering processes to deliver software and other empowering value rather than written policy and rules. In some cases, the builders are creating their own security microcosms and pressing forward when SSG involvement might be too cumbersome. We often don’t explicitly point out whether a given activity is to be carried out by the SSG, developers, or testers. Each organization should come up with an approach that suits its culture.

---

ach that makes sense and accounts for its own
workload and software lifecycles.
Testers
Be it test cases driven by a framework such as Cucumber or Selenium to simulate denial of service, by malformed and
malicious input, or by more strategic testing of failure through frameworks like ChaosMonkey, some testing regimes
are beginning to incorporate nontrivial security test cases. Facilities provided by cloud service providers actively
encourage consideration of failure and abuse across the full stack of deployment, such as a microservice component, a
data center, or even an entire region going dark.
...
Note that there’s no inherent reason to adopt all activities in with other activities, or
every level for each practice. Adopt the ones that make sense
for your organization and ignore those that don’t but revisit perhaps scale current
those choices periodically. Once they’ve adopted an activity
set, most organizations then begin to work on the depth, activities across more of
...
| ---------- | -------- | -------- | ------------ | -------- | -------- | ---------------- | -------- | -------- | --- | ---------- | -------- |
|            | BSIMM11  |          |              | BSIMM11  |          |                  | BSIMM11  |          |     | BSIMM11    |          |
|            |          | EXAMPLE  |              |          | EXAMPLE  |                  |          | EXAMPLE  |     |            | EXAMPLE  |
ACTIVITY FIRMS  FIRM ACTIVITY FIRMS  FIRM ACTIVITY FIRMS  FIRM ACTIVITY FIRMS   FIRM
...
Experience shows that SSIs they qualify as emerging, maturing, or otherwise. However,
experience shows that SSIs can reach a “maturing” stage
can reach a ‘maturing’ by starting with the activities that are right for them (e.g.,
to meet external contractual or compliance requirements)
stage by starting with the without regard for the total activity count. This is especially
...
them without regard for In addition, organizations don’t always progress from
emerging to optimizing in one direction or in a straight
the total activity count. path. We have seen SSIs form, break up, and re-form over
...
SSI genesis was the executive team or the architecture team. lives in a corporate group or
They practice proactive risk management through assurance-
based activities, resulting in the creation of “rules that people in engineering, both cultures
must follow” and “expectations software must meet” (e.g.,
policy, standards, checkpoints, sensors). This has almost historically ended up with
...
When software security activities are developed within centralized, dedicated SSG
the context of an engineering team, they are often well-
tuned to that team’s risk tolerance, which might generate whose function is to ensure
friction with groups like audit, compliance, or even other
engineering teams. Where central groups dictate policy and appropriate software security
...
as opposed to human-driven tasks. Automation in the form and checkpoints is removing
of software-defined sensors and checkpoints is removing
unexpected variability in human processes but is often also unexpected variability in
replacing human discretion, conversations, and risk decisions
that should involve multiple stakeholders. Many application human processes but is often
...
might provide.
The governance-driven approach we’ve seen for years and risk decisions that should
along with the emerging engineering-driven efforts are
increasingly coexisting within the same organization and involve multiple stakeholders.
...
citizen of their feature sets, user guides, and knowledge bases. engineering-led efforts
For example, organizations are seeing platforms like GitHub
and GitLab beginning to compete vigorously using security are making technology-
as a differentiator, leading both providers to create publicly
available security documentation with a 12- to 36-month specific changes to their
...
focus on rules, gates, and processing external security research, responsibly disclosing
vulnerabilities and notifying users, and providing some
compliance, while emerging on-by-default defect discovery, vulnerability management,
and remediation management workflows. This allows
engineering-led efforts engineering-driven firms to share success between teams
...
through automation, and Though the BSIMM data and our analyses don’t dictate
...
order to keep the firm safe. in order to keep the firm safe. That means the groups must
...
cultural boundaries, even if the security culture is one of technology drivers, executive
central and proactive governance or is engineering-driven, or
if both are learning to coexist. expectations, security
...
and one or more BSIMM activities. The references don’t aspirations, as well as current
mean that the topic being discussed is fully equivalent
to the activity. For example, when we say, “Inventory organizational strengths and
software [SM3.1],” we don’t mean that having an inventory
encompasses the totality of [SM3.1], just that having an weaknesses, will motivate
...
these cultures prefer to cast a wide net using questionnaire- 1. Leadership. Put someone in charge of
style data gathering to build their initial application inventory software security and provide the resources
[CMVM2.3]. These SSIs tend to focus on applications (with they will need to succeed.
owners who are responsible for risk management) as the unit of
2. Inventory software. Know what you have,
...
and flows (e.g., PII inventory) [CP2.1] along with the status of 4. Ensure host and network security
active development projects. basics. Don’t put good software on bad
The nature of inventorying software is evolving dynamically. systems or in poorly constructed networks
Simple spreadsheet lists of application names gave way to (cloud or otherwise).
...
Select In-Scope Software design, and code, and involve them in the
...
(e.g., high, medium, low) to each application in their inventory 8. Repeat. Expand the team, improve
[AA1.4]. SSI leaders then define the initial set of software the inventory, automate the basics, do more
...
[CR1.2] and tend to target the most critical software with Enrolling development
...
the intended target is naturally progressing through (e.g., do security efforts.
...
defects in its most important software assets, SSI leaders in detective controls with
governance-led firms seek to balance detective controls with
preventive controls for avoiding security issues and changing preventive controls
developer behavior.
...
leaders begin educating the organization on the need to shift issues and changing
left through adoption of tools that can be integrated into
developer workflows. These firms typically rely on tool vendor developer behavior.
...
implementation working well? Where are we lagging? How progress from emerging to
can we go faster with less overhead? What’s our message
to the Board? The efficacy of an SSI will be supported by optimizing in one direction
ongoing data collection and metrics reporting that seeks to
answer such questions [SM3.3]. or on a straight path, and
...
some SSI capabilities might be optimizing while others are still be optimizing while others
emerging. Based on our experience, firms with some portion
of their SSI operating in an optimized state have likely been are still emerging.
...
about accomplishing these activities differs and usually parallels 1. Inventory software. Know what you have,
their software-delivery focus. where it is, and when it changes.
...
same tools they use to manage their IT assets. By scraping 4. Choose application controls. Apply
these software and infrastructure configuration management controls that deliver the right security
databases (CMDBs), they craft an inventory brick-by-brick features and also help prevent some classes
rather than top-down. They use the metadata and tagging that of vulnerabilities.
...
they might seek to gain leverage from those accomplishments greater frequency helps
through the organization’s knowledge management
systems and personally evangelize their use. This level of them better respond and
intimacy between a developer and the security improvements
they spread to other projects and teams—often regardless prioritize the appropriate
...
more familiar with application logic might be able to facilitate Because engineering-led
more instructive monitoring and logging. They can coordinate
with DevOps engineers to generate in-application defenses security culture relies
that are tailored for business logic and expected behavior,
therefore likely being more effective than, for example, WAF heavily on the individual
...
orchestration might respond to incidents, or to data engineers distributed within
indicating imminent incidents, with an increase in logging,
perhaps by adjusting traffic to the distribution of image types development teams, these
in production. Much of this is possible only with embedded
security engineers who are steeped in the business context firms seek to follow through
...
Document the SSDL
Engineering-led cultures typically eschew document- or As the group seeks to
...
knowledge management, and evangelize it through internal to institute some form of
...
meet-ups and conferences. Security leads might use these applied across teams.
...
•  SM2.2 Verify release conditions with  compliance-related risk. •  T2.8 Create and use material specific
| measurements and track exceptions. |     | to company history. |
| ---------------------------------- | --- | ------------------- |
•  CP2.3 Implement and track controls
| •  SM2.3 Create or grow a satellite. | for compliance.                           |     |
| ------------------------------------ | ----------------------------------------- | --- |
...
| ------- | ------- | ------- |
•  SM3.1 Use a software asset tracking  •  CP3.1 Create a regulator   •  T3.1 Reward progression
...
| marketing program. |     | and outsourced workers. |
| ------------------ | --- | ----------------------- |
•  CP3.3 Drive feedback from software
•  SM3.3 Identify metrics and use them   lifecycle data back to policy. •  T3.3 Host software security events.
to drive resourcing.
...
| ------- | -------------- | ------------------- |
| LEVEL 1 | LEVEL 1        | LEVEL 1             |
•  AM1.2 Create a data classification  •  SFD1.1 Integrate and deliver security  •  SR1.1 Create security standards.
scheme and inventory.
|     | features. | •  SR1.2 Create a security portal. |
| --- | --------- | ---------------------------------- |
•  AM1.3 Identify potential attackers.
•  SFD1.2 Engage the SSG with
•  SR1.3 Translate compliance
| •  AM1.5 Gather and use attack   | architecture teams. |     |
| -------------------------------- | ------------------- | --- |
constraints to requirements.
intelligence.
| LEVEL 2 | LEVEL 2 | LEVEL 2 |
| ------- | ------- | ------- |
•  AM2.1 Build attack patterns and abuse  •  SFD2.1 Leverage secure-by-design  •  SR2.2 Create a standards review board.
| cases tied to potential attackers. | components and services. |     |
| ---------------------------------- | ------------------------ | --- |
•  SR2.4 Identify open source.
| •  AM2.2 Create technology-specific  | •  SFD2.2 Create capability to solve  |     |
| ------------------------------------ | ------------------------------------- | --- |
•  SR2.5 Create SLA boilerplate.
| attack patterns. | difficult design problems. |     |
| ---------------- | -------------------------- | --- |
...
| LEVEL 3 | LEVEL 3 | LEVEL 3 |
| ------- | ------- | ------- |
•  AM3.1 Have a research group that  •  SFD3.1 Form a review board or central  •  SR3.1 Control open source risk.
| develops new attack methods. | committee to approve and maintain  |     |
| ---------------------------- | ---------------------------------- | --- |
...
| asset creation. | •  SFD3.3 Find and publish secure design  |     |
| --------------- | ----------------------------------------- | --- |
technology stacks.
...
|     | •  CR1.2 Perform opportunistic   | •  ST1.1 Ensure QA performs edge/  |
| --- | -------------------------------- | ---------------------------------- |
•  AA1.2 Perform design review for   code review. boundary value condition testing.
high-risk applications.
|     | •  CR1.4 Use automated tools along   | •  ST1.3 Drive tests with security   |
| --- | ------------------------------------ | ------------------------------------ |
|     | with manual review.                  | requirements and security features.  |
•  AA1.3 Have SSG lead design
| review efforts. | •  CR1.5 Make code review mandatory   |     |
| --------------- | ------------------------------------- | --- |
for all projects.
•  AA1.4 Use a risk methodology to
| rank applications. | •  CR1.6 Use centralized reporting to close  |     |
| ------------------ | -------------------------------------------- | --- |
the knowledge loop and drive training.
•  CR1.7 Assign tool mentors.
| LEVEL 2 | LEVEL 2 | LEVEL 2 |
| ------- | ------- | ------- |
•  AA2.1 Define and use AA process. •  CR2.6 Use automated tools with  •  ST2.1 Integrate black-box security
|     | tailored rules. | tools into the QA process. |
| --- | --------------- | -------------------------- |
•  AA2.2 Standardize architectural
descriptions. •  CR2.7 Use a top N bugs list   •  ST2.4 Share security results with QA.
(real data preferred).
...
| standard architecture patterns. | eradicate bugs. |     |
| ------------------------------- | --------------- | --- |
•  ST3.5 Begin to build and apply
•  AA3.3 Make the SSG available as an  •  CR3.4 Automate malicious   adversarial security tests (abuse cases).
| AA resource or mentor. | code detection. |     |
| ---------------------- | --------------- | --- |
•  ST3.6 Implement event-driven
|     | •  CR3.5 Enforce coding standards. | security testing in automation. |
| --- | ---------------------------------- | ------------------------------- |
...
|     | •  SE1.1 Use application input monitoring. | •  CMVM1.1 Create or interface with  |
| --- | ------------------------------------------ | ------------------------------------ |
to find problems.
incident response.
•  SE1.2 Ensure host and network security
•  PT1.2 Feed results to the defect
|     | basics are in place. | •  CMVM1.2 Identify software defects  |
| --- | -------------------- | ------------------------------------- |
...
| LEVEL 2 | LEVEL 2 | LEVEL 2 |
| ------- | ------- | ------- |
•  PT2.2 Penetration testers use all   •  SE2.2 Define secure deployment  •  CMVM2.1 Have emergency response.
| available information. | parameters and configurations. |     |
| ---------------------- | ------------------------------ | --- |
•  CMVM2.2 Track software bugs found
•  PT2.3 Schedule periodic penetration  •  SE2.4 Protect code integrity. in operations through the fix process.
tests for application coverage.
|     | •  SE2.5 Use application containers.   | •  CMVM2.3 Develop an operations  |
| --- | -------------------------------------- | --------------------------------- |
|     | •  SE2.6 Ensure cloud security basics. | inventory of software delivery    |
value streams.
| LEVEL 3 | LEVEL 3 | LEVEL 3 |
| ------- | ------- | ------- |
...
•  PT3.2 Customize penetration   monitoring and diagnostics. •  CMVM3.2 Enhance the SSDL to
| testing tools. |     | prevent software bugs found   |
| -------------- | --- | ----------------------------- |
•  SE3.5 Use orchestration for containers
|     | and virtualized environments. | in operations. |
| --- | ----------------------------- | -------------- |
•  CMVM3.3 Simulate software crises.
•  SE3.6 Enhance application inventory
|     | with operations bill of materials. | •  CMVM3.4 Operate a bug   |
| --- | ---------------------------------- | -------------------------- |
bounty program.
...
| GOVERNANCE |     |     | INTELLIGENCE |     | SSDL TOUCHPOINTS |     | DEPLOYMENT |     |
| ---------- | --- | --- | ------------ | --- | ---------------- | --- | ---------- | --- |
BSIMM11  BSIMM11  BSIMM11  BSIMM11  BSIMM11  BSIMM11  BSIMM11  BSIMM11
ACTIVITY FIRMS  FIRMS ACTIVITY FIRMS  FIRMS  ACTIVITY FIRMS  FIRMS  ACTIVITY FIRMS (out  FIRMS
 (out of 130)  (%) (out of 130) (%)  (out of 130) (%) of 130) (%)
STRATEGY & METRICS ATTACK MODELS ARCHITECTURE ANALYSIS PENETRATION TESTING
...
TRAINING STANDARDS & REQUIREMENTS SECURITY TESTING CONFIG. MGMT. & VULN. MGMT.
[CMVM1.1]
| [T1.1] | 83  | 63.8% | [SR1.1] | 93 71.5% | [ST1.1] | 104 80.0% |     | 108 83.1% |
| ------ | --- | ----- | ------- | -------- | ------- | --------- | --- | --------- |
...
ARCHITECTURE
ANALYSIS
CLOUD (30 of 130) INTERNET OF THINGS (17 of 130) TECH (27 of 130)
...
ARCHITECTURE
ANALYSIS
FINANCIAL (42 of 130) HEALTHCARE (14 of 130) INSURANCE (14 of 130)
...
ARCHITECTURE
ANALYSIS
TECH (27 of 130) HEALTHCARE (14 of 130)
...
ARCHITECTURE
ANALYSIS
FINANCIAL (42 of 130) FINTECH (21 of 130)
...
SSI must provide a way of incorporating automated detection For it to be an effective
of drift in this policy beyond the mandated guardrails, often as
code configurations without human audit. part of a security initiative,
...
necessary reliance on automation to provide aggregation for with finding a way to
increasingly fragmented single data points to make them
actionable as vulnerability or risk data. coalesce individual security
...
with integrating and operating myriad sets of tools to picture of risk from which
successfully implement security at speed and scale. To
ensure that everyone contributing to security efforts they can govern, report,
focuses precious time on SSI priorities, there is a push for
many SSDL activities (particularly defect discovery and and analyze trends.
...
of attack. This requires building capabilities focused on We observe engineering-led
inventorying software, on cataloging its constituency, on
understanding the means by which it was built, configured, security initiatives having
...
Where automated response isn’t possible, these firms strive face of attack.
...
development process, even security efforts of 490,167 developers.
...
SATELLITE
6,656 6,298 6,291 3,501 3,595 2,111 1,954 2,039 1,750 1,150 710
MEMBERS
...
AVG. SSG AGE
|     | 4.32 4.53 | 4.13 3.88 | 3.94 3.98 | 4.28 4.13 | 4.32 4.49 | 5.32 |
| --- | --------- | --------- | --------- | --------- | --------- | ---- |
(YEARS)
SSG AVG.
2.01 / 100 1.37 / 100 1.33 / 100 1.60 / 100 1.61 / 100 1.51 / 100 1.4 / 100 1.95 / 100 1.99 / 100 1.02 / 100 1.13 / 100
OF AVGs
FINANCIAL
|     | 42 57 | 50 47 | 42 33 | 26 19 | 17 12 | 4   |
| --- | ----- | ----- | ----- | ----- | ----- | --- |
SERVICES
| FINTECH    | 21    |       |       |       |      |     |
| ---------- | ----- | ----- | ----- | ----- | ---- | --- |
...
(OF 53)  (OF 53) (OF 53) (OF 53) (OF 53) (OF 53) (OF 53) (OF 53)
...
GOVERNANCE
FINANCIAL   FINTECH  ISV   TECH   HEALTHCARE   IOT   INSURANCE  CLOUD   RETAIL
ACTIVITY
(OF 42) (OF 21) (OF 46) (OF 27) (OF 14) (OF 17) (OF 14) (OF 30) (OF 8)
...
• T2.6 Include security resources in onboarding became T1.8.
• CR2.5 Assign tool mentors became CR1.7.
SEPTEMBER • SE3.4 Use application containers became SE2.5.
2020 • SE3.7 Ensure cloud security basics became SE2.6.
• ST3.6 Implement event-driven security testing in automation added to the model.
• CMVM3.6 Publish risk data for deployable artifacts added to the model.
...
SEPTEMBER • T2.7 Identify new satellite through observation became T3.6.
2017 • AA2.3 Make SSG available as an AA resource or mentor became AA3.3.
...
OCTOBER • AM1.6 Build an internal forum to discuss attacks became AM2.7.
2016 • CR1.1 Use a top N bugs list became (real data preferred) CR2.7.
...
OCTOBER • SR1.4 Use secure coding standards became SR2.6.
2015 • ST3.1 Include security tests in QA automation became ST2.5.
