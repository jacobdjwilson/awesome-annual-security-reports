...
![Figure 1: A bar chart showing the maturity of DevSecOps adoption.](Image description: Bar chart illustrating DevSecOps adoption maturity with percentages for each category.)
...
![Figure 2: A pie chart showing who is responsible for application security.](Image description: Pie chart detailing responsibility for application security within organizations.)
...
![Figure 3: A bar chart showing the usage of various security tools.](Image description: Bar chart displaying the adoption rates of different security tools.)
...
![Figure 4: A pie chart showing whether organizations have a published policy for open source use.](Image description: Pie chart indicating the presence of a published open source use policy.)
...
![Figure 5: A bar chart showing requirements within open source use policies.](Image description: Bar chart detailing common requirements in open source use policies.)
...
![Figure 6: A pie chart showing the existence of an open source governance board or individual.](Image description: Pie chart indicating the presence of an open source governance board or individual.)
...
![Figure 7: A bar chart showing criteria used in vetting open source components.](Image description: Bar chart detailing criteria for vetting new open source components.)
...
![Figure 8: A bar chart showing the time taken to fix critical open source vulnerabilities.](Image description: Bar chart illustrating the average time to fix critical open source vulnerabilities.)
...
![Figure 9: Two bar charts comparing the impact of critical open source patches on software delivery schedules globally and in the United States.](Image description: Comparative bar charts showing the impact of critical open source patches on software delivery schedules.)
...
![Figure 10: A bar chart showing organizational responses to media coverage of open source issues.](Image description: Bar chart detailing how media coverage of open source issues affects organizations.)
