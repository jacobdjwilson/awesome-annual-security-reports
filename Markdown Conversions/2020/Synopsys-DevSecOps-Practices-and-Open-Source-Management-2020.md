...
![Figure 1: A bar chart showing the maturity of DevSecOps adoption.](Image description: A bar chart illustrating the maturity of DevSecOps adoption within teams, with categories ranging from "Mature or deployed widely" to "Not sure" and corresponding percentage values.)
...
![Figure 2: A pie chart showing who is responsible for application security.](Image description: A pie chart detailing the distribution of responsibility for application security within organizations, with categories including "Security team," "Development," "Shared by one or more team," and "Operations.")
...
![Figure 3: A bar chart showing the usage of various security tools.](Image description: A bar chart displaying the adoption rates of different security tools used by teams, including "Web application firewall," "Software composition analysis (SCA)," "Dynamic application security testing (DAST)," and others.)
...
![Figure 4: A pie chart showing whether organizations have a published policy for open source use.](Image description: A pie chart illustrating the percentage of organizations that have a published policy for open source use versus those that do not.)
...
![Figure 5: A bar chart showing requirements in open source use policies.](Image description: A bar chart detailing the various requirements included in organizations' policies for open source use, such as defining acceptable licenses and prescribing patch requirements.)
...
![Figure 6: A pie chart showing the presence of an open source governance board or individual.](Image description: A pie chart indicating whether organizations have a dedicated open source governance board or individual responsible for oversight.)
...
![Figure 7: A bar chart showing criteria used in vetting open source components.](Image description: A bar chart illustrating the various criteria organizations use when vetting new open source components, including research on vulnerabilities and community viability.)
...
![Figure 8: A bar chart showing the time taken to fix critical open source vulnerabilities.](Image description: A bar chart illustrating the average time it takes for organizations to provide a fix for critical open source vulnerabilities, categorized by timeframes like "In 2-3 weeks" and "In a month.")
...
*   **Global:**
    *   Yes: 40%
    *   No: 53%
    *   Not in the past year: 7%
*   **United States:**
    *   Yes: 52%
    *   No: 42%
    *   Not in the past year: 6%

![Figure 9: Two bar charts comparing the impact of critical open source patches on software delivery schedules globally and in the United States.](Image description: Two comparative bar charts showing whether addressing critical open source patches has impacted software delivery schedules, presented for both global respondents and specifically for the United States.)
...
![Figure 10: A bar chart showing the impact of media coverage on open source management.](Image description: A bar chart illustrating how media coverage of open source issues has influenced organizations' actions, such as implementing stricter controls or adopting management tools.)
...
*   Developers can select any component providing it is currently patched and up to date: 37%
...
Synopsys helps development teams build secure, high-quality software, minimizing risks while maximizing speed and productivity. Synopsys, a recognized leader in application security, provides static analysis, software composition analysis, and dynamic analysis solutions that enable teams to quickly find and