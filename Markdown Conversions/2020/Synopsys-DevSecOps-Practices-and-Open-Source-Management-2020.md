...
![Figure 1: Chart showing the maturity of DevSecOps adoption within teams.](Image description: A bar chart illustrating the responses to the question "How mature is the adoption of DevSecOps practices within your team?". The bars represent the following percentages: Mature or deployed widely within our business (33%), Limited to use within specific projects, but expanding (30%), We’re still researching how to apply it (11%), We aren’t investigating DevSecOps practices at this time (10%), Immature or running pilot programs (10%), and Not sure (6%).)
...
![Figure 2: Pie chart showing who is responsible for application security.](Image description: A pie chart illustrating the responses to the question "Who, if anyone, is responsible for application security in your organization?". The slices represent the following percentages: Security team (42%), Development (29%), Shared by one or more team (18%), Operations (9%), No one (1%), and Other, please specify (0.20%).)
...
![Figure 3: Bar chart showing the usage of various security tools.](Image description: A horizontal bar chart displaying the percentage of respondents using different security tools. The tools and their respective usage percentages are: Web application firewall (45%), Software composition analysis (SCA) (38%), Dynamic application security testing (DAST) (37%), Intrusion/detection protection system (37%), Runtime application self-protection (RASP) (34%), Static analysis security testing (SAST) (33%), Interactive application security testing (IAST) (33%), Penetration testing (27%), Protocol or API fuzzing (23%), Container security (21%), and None of the above (7%).)
...
![Figure 4: Pie chart showing whether organizations have a published policy for open source use.](Image description: A pie chart illustrating the responses to the question "Does your organization have a published policy for open source use?". The slices represent: Yes (72%) and No (28%).)
...
![Figure 5: Bar chart showing requirements in open source use policies.](Image description: A horizontal bar chart showing the requirements that are true for an organization's policy on open source use. The requirements and their percentages are: Defines acceptable open source licenses (62%), Prescribes patch or update requirements (55%), Provides a whitelist or blacklist of components (49%), Includes a manual review process from groups outside your team (47%), and Includes standards around the age of components (47%).)
...
![Figure 6: Pie chart showing the existence of an open source governance board or individual.](Image description: A pie chart illustrating the responses to the question "Do you have an open source governance board or specific individual charged with open source governance?". The slices represent: Yes (64%) and No (36%).)
...
![Figure 7: Bar chart showing criteria used in vetting new open source components.](Image description: A horizontal bar chart showing the criteria used in the vetting process for a new open source component. The criteria and their percentages are: Research on known vulnerabilities (50%), Completeness of component’s implementation (45%), Development team’s familiarity with the component or its community (44%), Frequency of releases/patches (44%), Research on license restrictions (40%), Viability of community (34%), and One of our team members is directly engaged with the community (28%).)
...
![Figure 8: Bar chart showing the time taken to provide a fix for critical open source vulnerabilities.](Image description: A horizontal bar chart illustrating the average time it takes for teams to provide a fix when a critical open source vulnerability is identified. The categories and percentages are: In 2-3 weeks (51%), In a month (24%), Within a week (16%), We have not had to address a critical open source vulnerability (5%), and Not sure (5%).)

Has addressing a critical open source patch impacted your software delivery schedule within the past year?

*   Global: Yes (40%), No (53%), Not in the past year (7%)
*   United States: Yes (52%), No (42%), Not in the past year (6%)

![Figure 9: Two pie charts comparing the impact of critical open source patches on software delivery schedules globally and in the United States.](Image description: Two pie charts. The left chart shows the global impact, with slices for Yes (40%), No (53%), and Not in the past year (7%). The right chart shows the impact in the United States, with slices for Yes (52%), No (42%), and Not in the past year (6%).)
...
![Figure 10: Bar chart showing organizational responses to media coverage of open source issues.](Image description: A horizontal bar chart illustrating the actions organizations have taken in response to media coverage of open source issues. The actions and their percentages are: Place more stringent controls on open source usage (46%), Put open source management tools in place to address risk (i.e., SCA) (45%), Use different open source components (36%), Use commercial components in place of open source (33%), No open source issue reported by the media has impacted us (10%), and None of the above (10%).)
...
![Image description: A bar chart showing the age distribution of respondents.](Image description: A horizontal bar chart displaying the age distribution of respondents. The age groups and their percentages are: 55+ (8%), 45-54 (15%), 35-44 (34%), 25-34 (38%), and 16-24 (5%).)
...
![Image description: A pie chart showing the gender distribution of respondents.](Image description: A pie chart illustrating the gender distribution of respondents. The slices represent: Male (71%), Female (28%), and Prefer not to say (1%).)
...
![Image description: A bar chart showing the job titles of respondents.](Image description: A horizontal bar chart displaying the job titles of respondents. The job titles and their percentages are: Software development (52%), Software engineering (21%), Cyber security (21%), and Web development (7%).)
...
![Image description: A bar chart showing the company sizes of respondents.](Image description: A horizontal bar chart displaying the company sizes of respondents. The company sizes and their percentages are: 500+ (27%), 100-249 (27%), 250-500 (15%), 50-99 (20%), 10-49 (9%), and 1-9 (3%).)

### Respondents geographically

*   Asia (China, Japan, Singapore): 65%
*   Europe (Finland, Germany, U.K.): 18%
*   North America (United States): 17%

![Image description: A pie chart showing the geographical distribution of respondents.](Image description: A pie chart illustrating the geographical distribution of respondents. The regions and their percentages are: Asia (China, Japan, Singapore) (65%), Europe (Finland, Germany, U.K.) (18%), and North America (United States) (17%).)
...
*   Developers can select any open source component providing it is currently patched and up to date: 37%
