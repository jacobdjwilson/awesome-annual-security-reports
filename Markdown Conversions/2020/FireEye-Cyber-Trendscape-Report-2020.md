...
Report Title: Cyber Trendscape Report  
Year: 2020  
...
Setup questions were used to ensure that only cyber security executives were in the sample. The findings represent the views from three senior organizational roles with 45% of participants at C-level an above, 17% at the vice president level and 38% at the senior director level. The participants were 68% men and 32% women. Canada had the largest percentage of women participants (42%). 

![Figure 1. Participant role in their organization. C-Level Executive: 45%, Vice President: 17%, Senior Director: 38%]
...
![Figure 2. Department of the participant (US vs Global breakdown across IT, Business Operations, Finance/Accounting, Cyber Security, Legal)]
...
![Figure 3. Participant industry segment (Education, Infrastructure and Utilities, Finance and Banking, Government, Healthcare, Industrial and Manufacturing, Insurance, Retail, Legal, Technology, Other)]

![Figure 4. Participant organization size (500-999: 23%, 1,000-4,999: 52%, 5,000-9,999: 16%, 10,000 or more: 9%)]
...
![Figure 5. Presence of senior roles in organization (Chief Risk Officer, Chief Privacy Officer, Chief Information Security Officer, Chief Information Officer, General Counsel, Chief Compliance Officer)]
...
![Figure 6. Understanding and defending against cyber threats (Scale 1 to 5 from Easier to More Difficult)]
...
![Figure 7. Ease of finding a good balance between cyber security and operational requirements (Scale 1 to 5 from Easier to More Difficult)]
...
![Figure 8. Current size of security budget as a percentage of the overall IT budget (Breakdown across 1-3%, 4-5%, 6-7%, 8-10%, Above 10% for Global and Japan)]
...
![Figure 9. Planned budget change for 2020 (Increase 10%+, Increase 5-9%, Increase 1-4%, Same as 2019, Decrease 1-4%, Decrease 5-9%, Decrease 10%+)]
...
![Figure 10. Value of cyber security spend for value provided (Reasonable: 57%, Inexpensive: 25%, Expensive: 18%)]

### Analyst Observation
The U.S. expressed the highest rate of the most negative views of governments and regulatory agencies with very bad gathering over 15% of the views. The U.S. response for net bad was in line with other regions (21%).

China expressed the most negative perception overall with 41% reporting a bad job 4% reporting a very bad job. The most positive perceptions were from Japan with 54% good 10% very good followed by the UK with 49% good and 15% very good.
...
![Figure 11. Scorecard of vendors, governments and regulatory agencies (Scale 1 to 5 from Very Bad to Very Good)]

## Cyber Attacks

Over 90% of organizations believe cyber threats will stay the same or worsen in 2020.

![Figure 12. Expected change in cyber threats for 2020 (Increase, Stay the same, Decrease)]
...
![Figure 13. Industry sector most likely to be the target of a cyber attack (Education, Elections, Entertainment / Media, Technology, Finance and Banking, Gaming, Government, Healthcare, Industrial / Manufacturing, Infrastructure and Utilities, Insurance, Legal, Retail)]
...
![Figure 14. Components most likely to be a target of or vulnerable to a cyber attack (Endpoints, Firewalls, IoT non Medical, Medical Devices, Mobile Devices, Operational Technologies, Servers and OS, Server Hosted Applications, Web Servers)]
...
### Analyst Observation
The participants from China reported that successful attacks based on exploited vulnerabilities occurred 70% more often than the overall average. Canada and Korea reported the success of similar attacks occurred 30% more often than the overall average.

![Figure 15. Types of cyber attacks most likely to be the cause a breach (Crypto-Currency Miners, Exploited Vulnerability, Malware, Ransomware, Social Engineering, Targeted Phishing)]
...
![Figure 16. Types of cyber attacks experienced in the last 12 months (Crypto-Currency Miners, Exploited Vulnerability, Malware, Ransomware, Social Engineering, Targeted Phishing, None of the Above)]
...
![Figure 17. Sources of cyber attacks experienced by organization (Other, Individual Hacker, Industry Competitor, Hacker Groups, Malicious Insider, Nation State, Criminal Organization)]
...
![Figure 18. Security program maturity (No Cyber Security Program, Informal, Semi-Formal, Intelligence Driven, Formal)]
...
While only 8% of organizations did not have any cyber attack and breach response plans, the results were higher in Canada (19%) and Japan (15%).
...
![Figure 19. Cyber attack and breach response plans (Untested Plans, Individual Plans, Mature Plans, No plans)]

Organizations universally identified the chief information officer (CIO) as the leading representative involved in the development or review of the cyber attack or breach response plan, followed by the chief compliance officer (CCO), IT security staff and finally IT operations staff (Fig. 20).

![Figure 20. Roles involved in the development and review of cyber attack and breach response plans (Board of Directors, CEO, CCO, CFO, CIO, CMO, COO, CPO, CRO, CSO/CISO, External Legal Counsel, Internal Legal Counsel, External Cyber Security Consultants, IT Operations Staff, IT Security Staff, Line of Business / Business Ops)]
...
![Figure 21. Challenges in maturing cyber security posture (Budget, Senior Leadership Support or Buy In, Lack of Experienced Staff, Visibility Into Threats, IT and Security Process Maturity, IT and Security Technology Maturity)]
...
![Figure 22. Readiness to respond to a cyber attack or breach event (Somewhat Ready: 47%, Fully Ready: 49%, Not Ready: 4%)]
...
![Figure 23. Components that currently had the most positive impact on security (Vulnerability Management, Security Software, Response Plans, People, Employee Training, Consulting, Outsourcing, Security Hardware)]
...
![Figure 24. Components that could most positively impact security, assuming unlimited budget (Vulnerability Management, Threat Intelligence, Response Plans, People, Proactive Threat Hunting, Outsourcing, Hardware, Employee Training, Consulting)]
...
![Figure 25. Status of employee cyber security training program (Semi-Formal: 35%, Informal: 29%, Advanced: 25%, None: 11%)]
...
![Figure 26. Concerns from a cyber attack or breach (Business Operation Disruption, Impact to Our Customers, Loss of Sensitive Data, Partner Relationships, Personal Repercussions, Physical Damage to Real-World Infrastructure, Organizational and Brand Reputation, Organization's Liability and Exposure to Lawsuits, Regulatory Fines)]
...
![Figure 27. Use of automated security posture testing (Yes: 56%, Planning: 37%, No: 7%)]
...
![Figure 28. Drivers for cloud (Broaden enterprise agility, End-of-life hardware, End-of-life software, Reduce datacenter footprint, Reduce IT costs)]
...
![Figure 29. Cloud readiness (None, Initial investigations into cloud, Basic understanding of cloud and security, Moderate understanding with pilot deployments, Strong understanding with formal approaches)]
...
![Figure 30. State of cloud initiatives (None, Some but cautious, Moderate and expanding, Cloud first)]

### Cloud Security
Over 45% of participants agreed with the belief that security for both their cloud and their on-premise environments was about the same, while 33% believed that cloud was more secure. Only 18% of organizations perceived cloud as being less secure.

### Analyst Observation
In the U.S., 51% of organizations perceived cloud as being more secure than their on-premise environment. In Japan and Germany, 24% of organizations perceived that cloud was less secure than their existing on-premise environment—significantly higher than the global average of 18%.

![Figure 31. Perception of overall security of cloud (Don't know, Less secure, About the same, More secure)]
...
The highest rate of fully outsourced SOCs was reported by France (22%).
...
Significant representation of formal proactive SOCs was reported in the U.S. (50%) and China (45%), compared to the global average of 25% (excluding the U.S. and China).

![Figure 32. Maturity of security operations center (SOC) (Informal SOC: 15%, Semi-Fomal SOC: 54%, Formal Proactive SOC: 31%)]
...
![Figure 33. Size of security operations team (internal and outsourced staff) (1-5 people, 6-10 people, 11-30 people, 31-100 people, More than 100 people)]
...
![Figure 34. Security operations team growth (internal and outsourced staff) (Decrease, No change, Increase)]
...
![Figure 35. Number of SIEM solutions in the organization (No SIEM and no plans, No but planning within 18 months, Yes, have a SIEM currently, Yes, have 2 or more SIEMs)]
...
![Figure 36. Planned use of SIEM solutions (Compliance, Discovering lateral movement from compromized trusted resources, Data exfiltration, Insider threat, Log collection and monitoring, Tracking system changes, Threat hunting, SOAR)]
...
![Figure 37. SIEM maturity (Collecting some log data: 20%, Cutomized for event prioritization: 27%, Creation of dashboards and reports: 28%, Customized for threat hunting and remediation: 25%)]
...
![Figure 38. SIEM challenges (No challenges, Costly to acquire, maintain and support, Complex to operate, Requires manual customization to support use cases, Lacks integration with third-party solutions)]
...
![Figure 39. SOAR integration with SIEM solutions (No SOAR integration with our SIEM, SOAR being explored, Basic SOAR deployment, SOAR deployment with policies and manual remediation, Advanced SOAR deployment with automated remediation)]
...
![Figure 40. Intelligence Integration with SIEM solution (No plans to integrate intelligence with our SIEM, Exploring Intelligence feeds, Integrated free Intelligence with our SIEM, Integrated paid intelligence with our SIEM, Integrated more than one free or paid Intelligence feed with our SIEM)]
...
![Figure 41. Number of threat intelligence feed subscriptions (1 through 10 or more)]
...
![Figure 42. Ease of finding providers of intelligence feeds (Free vs Paid on scale from Very Easy to Very Difficult)]
...
![Figure 43. Ease of deriving benefits from intelligence feeds (Free vs Paid on scale from Very Easy to Very Difficult)]

Organizations indicated that free and paid intelligence feeds were overall more actionable than not.

![Figure 44. Feed actionability (Free vs Paid on scale from Very Actionable to Difficult to Action)]
...
![Figure 45. Scope of insights from intelligence feeds (Free vs Paid on scale from Broad Scope to Limited Scope)]
...
![Figure 46. Email deployments (Cloud: 40%, On-Premise: 60%)]
...
![Figure 47. Self-managed or outsourced email management (We manage our email solution: 52%, We outsource the management of our email solution: 48%)]
...
![Figure 48. Security solution for email (We use a third-party email security solution: 51%, We use an integrated email security solution: 49%)]

## Endpoint Security Solutions

Endpoint security solutions are designed to protect systems from the different forms of cyber attacks. Here, organizations described the solutions they deployed to secure their endpoints.

### Endpoint Security Adoption
Globally, the top three endpoint security solutions identified by participant organizations were application privilege control, anti-malware or antivirus prevention and encryption.

![Figure 49. Endpoint security capabilities (Anti-malware or antivirus prevention, Application behavior analytics, Application whitelisting, Application privilege control, Data loss prevention (DLP), Encryption, Endpoint detection and response (EDR), Endpoint firewall, Endpoint hardening, Port and device control, Vulnerability management and remediation)]

### Top Endpoint Security Solution Adoption by Country

Table 1. Top three endpoint security capabilities by region.
| Endpoint Capability | Canada | China | France | Germany | Japan | Korea | UK | US |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Vulnerability management and remediation | 1 | 1 | 3 | | 2 | 2 | | 3 |
| Endpoint firewall | 2 | 2 | | 3 | | 1 | 2 | 1 |
| Endpoint encryption | 3 | | | 2 | 1 | | 1 | |
| Anti-malware or anti-virus prevention | | 3 | 1 | 1 | 3 | | 1 | 2 |
| Port and device control | | | 2 | | | | | |
| Application privilege control | | | | | 3 | | | |
| Application behavior analytics | | | | | | 3 | | |
...
![Figure 50. Use of cyber insurance (Yes: 50%, Planning: 41%, No: 9%)]
...
Participants in Korea reported the most difficulty in finding cyber insurance providers with 12% reporting it as difficult and 12% as very difficult. Japan also found it challenging, with 49% difficult and 7% very difficult.

![Figure 51. Ability to find cyber insurance providers (Scale from Very Simple to Very Difficult)]
...
![Figure 52. Ability to understand the scope of cyber insurance coverage (Scale from Very Simple to Very Difficult)]
...
![Figure 53. Perceived value of cyber insurance coverage (Scale from Excellent Value to Very Poor Value)]
...
![Figure 54. Adoption of AI (Not investigated AI, Begun investigating AI, Preliminary understanding of AI, Understand AI and have deployments, Strong understanding and have a formal approach)]
...
![Figure 55. Adoption of blockchain (Not investigated block chain, Begun investigating block chain, Preliminary understanding of block chain, Understand block chain and have deployments, Strong understanding and have a formal approach)]
...
We expect the Cyber Trendscape report to provide you with valuable data for 2020 planning and we look forward to sharing future editions that include retrospective review.

---

ews and emerging trends.
...
(347.3393) info@FireEye.com FireEye offers a single platform that blends innovative
