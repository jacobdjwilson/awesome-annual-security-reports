...
- [About FireEye, Inc](#about-fireeye-inc)
...
![Participant role in their organization.](Image description)
...
![Department of the participant.](Image description)
...
![Presence of senior roles in organization.](Image description)
...
against cyber threats.](Image description)
...
![Ease of finding a good balance between
cyber security and operational requirements.](Image description)
...
![Current size of security budget as a percentage of the overall IT budget.](Image description)
...
![Planned budget change for 2020.](Image description)
...
![Value of cyber security spend for value provided.](Image description)
...
a good job (42%) or a very good job (11%). A neutral rating was provided by 19%
of global respondents. Of the remaining organizations 23% believed governments
and regulatory agencies were doing a bad job and 4% a very bad job.
...
![Scorecard of vendors, governments and regulatory agencies.](Image description)
...
![Expected change in cyber threats for 2020.](Image description)
...
![Industry sector most likely to be the target of a cyber attack.](Image description)
...
![Components most likely to be a target of or vulnerable to a cyber attack.](Image description)
...
![Types of cyber attacks most likely to be the cause a breach.](Image description)
...
![Types of cyber attacks experienced in the last 12 months.](Image description)
...
![Sources of cyber attacks experienced by organization.](Image description)
...
![Security program maturity.](Image description)
...
![Cyber attack and breach response plans.](Image description)
...
![Roles involved in the development and review of cyber attack and breach response plans.](Image description)
...
![Challenges in maturing cyber security posture.](Image description)
...
![Readiness to respond to a cyber attack or breach event.](Image description)
...
![Components that currently had the most positive impact on security.](Image description)
...
![Components that could most positively impact security, assuming unlimited budget.](Image description)
...
![Status of employee cyber security training program.](Image description)
...
![Concerns from a cyber attack or breach.](Image description)
Figure 26. Concerns from a