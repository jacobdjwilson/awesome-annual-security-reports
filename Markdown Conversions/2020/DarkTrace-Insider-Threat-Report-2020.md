...
**total cost of insider threat attacks in 2020:**
...
Insider attacks are difficult to spot, yet they often have the greatest impact on business operations. Malicious or compromised insiders can be difficult to identify due to their privileged access and knowledge of company workings, enabling them to easily evade detection. Despite the risk posed by malicious insiders, firms struggle to monitor employees and respond to these threats. 72% of organizations reported an increase in insider attacks last year, according to Cybersecurity Insiders’ 2020 Insider Threat Report.
...
*Description: A graphic showing a pie chart with the text "33%" and "of breaches are the result of internal incidents". The pie chart is divided into two sections, one larger section representing 33% and a smaller section representing the remaining percentage.*
...
*Description: A diagram showing the Darktrace Immune System platform. The diagram includes three main components: Self-learning Detection, Automated Investigation, and Autonomous Response. These are labeled as "ENTERPRISE IMMUNE SYSTEM", "CYBER AI ANALYST", and "DARKTRACE ANTIGENA" respectively. The diagram also shows various elements of a digital ecosystem, including Workforce, Infrastructure, Industrial, SaaS, Email, Cloud, Clients, OT, IoT, and Network.*
...
*Description: A simple graphic showing a laptop connecting to a network via a Wi-Fi symbol.*
...
*Description: A graphic showing a laptop connected to a network, with lines extending from the laptop to other devices in the network, indicating scanning activity.*

**Figure 5:** *The anomalous behavior is highlighted*

*Description: A screenshot of the Darktrace user interface, showing a device highlighted in yellow, indicating anomalous behavior.*
...
*Description: A screenshot of the Darktrace user interface, showing a device highlighted in orange, indicating an increased level of threat.*
...
*Description: A screenshot of the Darktrace user interface, showing a device with lines extending to all other devices in the network, indicating an attempt to connect to every device.*
...
*Description: A screenshot of the Darktrace user interface, showing a device with multiple orange lines, indicating unusual activity and model breaches.*
...
*Description: A screenshot of the Darktrace SaaS Console, showing a dashboard with various graphs and charts visualizing SaaS behaviors.*
...
*Description: A world map with multiple points of light, indicating the locations where Darktrace Antigena is responding to cyber threats.*
...
*Description: A screenshot of the Darktrace Threat Visualizer, showing a device with unusual connectivity patterns.*

Threat Landscape Series | 9

**Figure 12:** *Raspberry Pi computer*

*Description: A photograph of a Raspberry Pi computer.*
...
*Description: A screenshot of a Cyber AI Analyst report, showing command and control (C2) communications.*
...
*Description: A screenshot of the Darktrace user interface, showing a list of models breached by a server.*
...
*Description: A photograph of server wires and equipment under a raised floor.*
