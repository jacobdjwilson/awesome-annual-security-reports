...
Threats by Numbers
Insiders dont necessarily have to be 
...
Traditional security tools rely on signatures andpre\-defined lists to keep the bad out. This static idea 
...
with the speed and scalability of AI, delivering a 92%time\-saving in time to triage.
ENTERPRISE
IMMUNE SYSTEM
...
Hydrotech, Inc.: Contractors Laptop Compromised
On a normal Thursday morning, a contracted instructor turned on their computer 
and connected to Hydrotechs Wi\-Fi network, as they had every morning that 
week to prepare for their upcoming class.
Figure 3: Device connects to the network
Case Study: Threats From The Inside
18 seconds later, Darktraces AI detected that the laptop was behaving in an 
...
In under two minutes, the instructors laptop had attempted connections to 
...
The attack managed to bypass the rest of the organizations security stack because 
...
Darktraces Cyber AI Analyst reported on every stage of the attack, including the 
...
Figure 9: Darktraces SaaS Console allows users to visualize and analyze SaaS 
...
to a home server via one of the companys regular data transfer services. 
...
through an internal server they had used regularly at the company and, as alast\-ditch attempt, through a third\-party file transfer service on their endpoint 
device off the VPN. 
...
nature of the compromise, prompting them to revoke the admins credentials 
...
for the names of responsive machines and scanned them for open channelsof communication.
...
companys network following their termination. With this means of entry, the 
former employee was able to connect to a company server and read more 
than 9,000 files. Darktraces Cyber AI detected over 10,000 unauthorized SMB 
actions in total.
...
the user read and deleted, allowing the team to see the extent of the attack andjumpstart remediation.
...
of these devices identified them as Raspberry Pi devices: small, inexpensive,high\-performance computers the size of a credit card that are easy to smuggle 
into a system.
...
Visit darktrace.com
Book a free trialYOUTUBEVisit our YouTube channelTWITTERFollow us on TwitterLinkedin\-In 
