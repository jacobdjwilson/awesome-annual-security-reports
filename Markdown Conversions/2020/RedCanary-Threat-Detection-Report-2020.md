...
Table of contents
| INTRODUCTION   |     |     | TOP TECHNIQUES  |     |   06 |
| -------------- | --- | --- | --------------- | --- | ---- |
What’s new in 2020      03 #1    T1055 Process Injection      07
| Behind the data  |     | 04  | #2    T1053 Scheduled Task  |     |   13 |
| ---------------- | --- | --- | --------------------------- | --- | ---- |
Meet the authors      05  #3    T1077 Windows Admin Shares    20
| Acknowledgements  |     |     | #4    T1086 PowerShell                  |     |   26 |
| ----------------- | --- | --- | --------------------------------------- | --- | ---- |
...
matters most.
6M 15K 1
INVESTIGATIVE CONFIRMED REPORT
LEADS THREATS
...
WHAT’S NEW IN 2020
Year-over-year trending Common co-occurrences
Last year’s inaugural report summarized all such ATT&CK techniques do not occur in isolation, so it is
data available across Red Canary’s entire history. important to understand how adversaries leverage
This year’s report focuses on the more than multiple techniques to accomplish their goals. This
...
Actionable insights Additional research
Each technique section includes detailed guidance Our threat rankings are determined entirely by
on data sources security teams can use to observe detection volume. As a result, a sizable outbreak
related threats. We also provide specific telemetry in one environment can have a disproportionate
patterns that are useful for detecting threats, as well impact on our entire dataset. To combat that, we’ve
as those that are prone to false positives. included analysis on supplemental techniques that
...
2020 Threat Detection Report
MEET THE AUTHORS
Keith McCammon Keith leads Red Canary’s security, open source, and
...
Community.
Brian Donohue Brian has been writing about and researching information
...
Jeff Felling Jeff Felling is a puzzle solver who currently contemplates the
conundrums confounding corporate computer custodians,
DIRECTOR OF aka a threat hunter. After nearly a dozen years analyzing
INTELLIGENCE
...
Tony Lambert Tony is a professional geek who loves to jump into all things
...
1
|     | 17% of total threats | T1055 Process Injection    |
| --- | -------------------- | -------------------------- |
...
| --------- | --- | -------------- | ---- | ---------- | --- |
|           |     |                |      |            |     |
| OVERALL   |     | ORGANIZATIONS  |      | CONFIRMED  |     |
| RANK      |     | AFFECTED       |      | THREATS    |     |
Analysis
| 2018 |     | 2019 |     |     |     |
| ---- | --- | ---- | --- | --- | --- |
...
Jason Killam The detection strategies in this section were
...
your own.
DETECTION STRATEGIST
Michael Haag The detection strategies in this section were
brought to you by Michael Haag! Michael
DIRECTOR, ADVANCED
has more than a decade of experience in
THREAT DETECTION
AND RESEARCH security architecture and operations. His
...
Analysis
2018 2019
10 3 Windows Admin Shares experienced a dramatic
...
of your own.
DETECTION STRATEGIST
Keya Horiuchi The detection strategies in this section were
...
Analysis
2018 2019
4 4 Malicious PowerShell affected a slightly smaller
...
of your own.
DETECTION STRATEGIST
Shane Welcher The detection strategies in this section were brought
...
Analysis
2018 2019
19 5 Climbing from 19th in 2018 to fifth in 2019,
...
Process command line “/transfer qcxjb7”, and the presence of a URL
...
of your own.
DETECTION STRATEGIST
Del Armstrong The detection strategies in this section were brought to you
...
|     | 2018 | 2019 |     |                                                 |     |     |
| --- | ---- | ---- | --- | ----------------------------------------------- | --- | --- |
| 5   |      | 6    |     | The number of customers that received a threat  |     |     |
...
of your own.
DETECTION STRATEGIST
Justin Schoenfeld The detection strategies in this section were brought to
...
of your own.
DETECTION STRATEGIST
Kyle Rainey The detection strategies in this section were brought to
...
of your own.
DETECTION STRATEGIST
Thomas Gardner The detection strategies in this section were brought to
...
|     | 2018 | 2019 |     |     |     |
| --- | ---- | ---- | --- | --- | --- |
10 Disabling Security Tools fell from eight in
8
...
of your own.
DETECTION STRATEGIST
Cathy Cramer The detection strategies in this section were brought to
...
Analysis
2018 2019
12 11 Credential Dumping accounted for a slightly
...
of your own.
DETECTION STRATEGIST
Ricky Espinoza The detection strategies in this section were brought to
...
Analysis
2018 2019
17 13 Jumping from 17th to 13th, WMI saw slight
...
Useful telemetry will include:
DATA SOURCE TELEMETRY
Process monitoring child processes of wmiprivse.exe
...
of your own.
DETECTION STRATEGIST
Jesse Brown The detection strategies in this section were brought to you
...
Analysis
2018 2019
13 20 Falling from 13th in 2018 to 20th in 2019,
...
of your own.
DETECTION STRATEGIST
Ernesto Lleras The detection strategies in this section were brought to
