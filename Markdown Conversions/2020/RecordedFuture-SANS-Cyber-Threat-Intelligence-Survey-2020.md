...
(CTI) Survey
Written by Robert M. Lee Sponsored by:
Recorded Future
February 2020
©2020 SANS™ Institute
...
2020 SANS Cyber Threat Intelligence (CTI) Survey 2
...
Small
Government (Up to 1,000)
Small/Medium
Banking and fi nance (1,001–5,000)
Cybersecurity Medium
service provider (5,001–15,000)
Medium/Large
Technology
(15,001–50,000)
Each gear represents 25 respondents. Large
(More than 50,001)
...
Ops: 303
HQ: 50 Ops: 406
HQ: 70 Security operations/
Ops: 552 Security analyst
HQ: 280
Incident
responder
Security manager
Ops: 656 Ops: 275 or director
HQ: 512 HQ: 34
Ops: 290
Other
Ops: 273 Ops: 214 HQ: 34
HQ: 13
HQ: 13
...
2020 SANS Cyber Threat Intelligence (CTI) Survey 3
...
dedicated team, which is especially from other security groups 26.2%
...
organizations are seeing or trends that may become Standalone team dedicated to CTI 39.2%
significant down the road. Enterprise security team 31.4%
Now that we see the highest reported number of Vulnerability management team 24.9%
...
a mix of security operations center (SOC) and incident Other 4.0%
...
2020 SANS Cyber Threat Intelligence (CTI) Survey 4
...
2020 SANS Cyber Threat Intelligence (CTI) Survey 5
...
that we looked into No, our requirements are ad hoc. 29.7% 37.0% -7.3%
...
(see Table 1). Security operations 74.9%
Also positive news: Those contributing to CTI requirements The CTI team/personnel 71.6%
increased across the board, with respondents reporting Incident response team 65.3%
more input from teams including security operations,
Vulnerability management 42.7%
IR and business units. In fact, security operations had Executives
...
time reported. See Figure 7. Customers 18.8%
Other 2.7%
0% 20% 40% 60% 80%
Figure 7. CTI Requirements Contributors
2020 SANS Cyber Threat Intelligence (CTI) Survey 8
...
all (see Figure 8). While there are some consistent themes in  its CTI requirements?  Select the best answer.
requirements across the board, many are unique to a specific
organization or are based on past incidents or upcoming  Ad hoc 28.4%
| significant events for the organization.  | Unknown |     |     |     |     |
| ----------------------------------------- | ------- | --- | --- | --- | --- |
26.7%
| Examples of requirements from respondents include: |     | Yearly |     |     |     |
| -------------------------------------------------- | --- | ------ | --- | --- | --- |
17.0%
| •   The activity of a specific adversary [with whom] we had  | Weekly |     |     |     |     |
| ------------------------------------------------------------ | ------ | --- | --- | --- | --- |
11.6%
...
organizations be successful  Open source or public CTI feeds
74.3%
...
| a process for evaluating and  |     |     |     |     | 68.2% |
| ----------------------------- | --- | --- | --- | --- | ----- |
Emergency Readiness Teams (CERTs)
prioritizing new requirements can  Security data gathered from our IDS, firewall,
63.4%
...
| next step is to identify how to get  |     |     |     | 57.0% |     |
| ------------------------------------ | --- | --- | --- | ----- | --- |
access to the information that will  Forensics (postmortem) 56.4%
help answer the requirements.
|                              | CTI service provider |     |     | 45.9% |     |
| ---------------------------- | -------------------- | --- | --- | ----- | --- |
| For respondents who consume  | Application logs     |     |     | 44.4% |     |
intelligence, this means evaluating  Other formal and informal groups with a shared
|     | interest |     |     | 43.3% |     |
| --- | -------- | --- | --- | ----- | --- |
...
| information from a commercial        |                    |     | 31.9% |     |     |
| ------------------------------------ | ------------------ | --- | ----- | --- | --- |
| threat feed, from both CTI-specific  | Honey pot data     |     | 29.9% |     |     |
| and general security vendors, with   | User behavior data |     |       |     |     |
29.6%
over 45% consuming non-feed  Shared spreadsheets and/or email 21.0%
| information from a CTI service  |     | Other |     |     |     |
| ------------------------------- | --- | ----- | --- | --- | --- |
1.5%
| provider (see Figure 9). When it  |     | 0   | 20% | 40% 60% | 80% |
| --------------------------------- | --- | --- | --- | ------- | --- |
...
|     |     | 68.2%  63.4%  | 4.7% |
| --- | --- | ------------- | ---- |
from last year, including  centers (ISACs) and Computer Emergency Readiness Teams (CERTs)
Security data gathered from our IDS, firewall, endpoint and
|                        |                         | 63.4%  62.2%  | 1.2% |
| ---------------------- | ----------------------- | ------------- | ---- |
| threat feeds from CTI- | other security systems  |               |      |
specific vendors, open- External sources such as media reports and news  63.1%  63.4%  -0.3%
source threat feeds  Incident response and live forensics  63.1%  55.3%  7.8%
...
information gathering  Forensics (postmortem)  56.4%  48.3%  8.0%
| corresponds to the      | CTI service provider  | 45.9%  42.6%  | 3.3% |
| ----------------------- | --------------------- | ------------- | ---- |
| increase in the number  | Application logs      | 44.4%  43.2%  | 1.2% |
...
Dissemination How is CTI information utilized or disseminated by your organization?
Select all that apply.
In order for intelligence to be effective,
it must get to the right audience in a Email or documents such as spreadsheets
or PowerPoint 66.3%
way they are able to use it. The process
Briefings 53.0%
of getting intelligence to its intended
audience is called dissemination. CTI is Vendor-created threat intelligence platform 40.2%
primarily disseminated in the form of Open source threat intelligence platform 37.0%
reports or briefings that summarize a Homegrown system 35.5%
...
intelligence platform for this purpose. Respondents • Although CTI data can come from a variety of sources, leveraging
...
2020 SANS Cyber Threat Intelligence (CTI) Survey 11
...
1 2 3 4
increasing false positives, consider leveraging 50% 46.6%
TTPs as a primary detection strategy and 42.4%
40%
then running the associated IoCs against the 35.1% 33.2%
subset of detections based off of TTPs. As 30% 29.1% 26.6% 28.2%
an example, running indicators associated 20% 20.5% 18.4% 21.7% 21.4%
with VPNs against all network traffic would 15.4% 13.9% 14.0% 14.0%
9.1%
10%
yield a higher level of false positives than
running those same indicators against only 0%
Strategic analysis Digital footprint Threat behaviors Indicators of
network traffic that alerted against TTP-based of the adversary or attack surface and adversary compromise
identification tactics, tradecraft (IoCs)
...
2020 SANS Cyber Threat Intelligence (CTI) Survey 12
...
When looking at security and response use cases, these 37.8% Y es
measurements can be mapped to overall defender-based metrics
No
instead of simply tracking adversary metrics. 58.0%
Unknown
...
2020 SANS Cyber Threat Intelligence (CTI) Survey 13
...
well, which appears to note that the Lack of trained staff or lack of skills
needed to fully utilize CTI 56.9%
value propositions of CTI are well Lack of time to implement new
processes 51.9%
understood in most organizations at
Lack of funding 48.6%
a variety of levels.
Interoperability issues/Lack of
automation 47.8%
Participants were asked about their
Lack of management buy-in
level of satisfaction with various 30.6%
Lack of technical capability to integrate
aspects of CTI. The highest level of CTI tools into our environment 30.0%
Lack of automation from technical
satisfaction for respondents was identification to reporting to C-suite 25.5%
their ability to have visibility into Lack of confidence in using the
information to make decisions 23.0%
...
44.9%
Information Sharing and Analysis Centers (ISACs) are not available No
to all respondents, although there was great global distribution in
Unknown
the home country of participants in the survey. And yet 45% still 26.2%
...
Rates
2020 SANS Cyber Threat Intelligence (CTI) Survey 14
...
timely and relevant threat information Timely and relevant threat information 73.4%
from ISACs. Based on the data and Points of contact at member organizations 67.6%
comments, it was clear that a major
Advocacy in the community for security 43.7%
value in the ISACs was gaining points of
Member meetups and events 42.7%
contact at member organizations (68%),
Conferences and training 36.2%
advocacy in the community (44%) and
the membership meetups (43%). See Other 2.4%
0% 20% 40% 60% 80%
Figure 16.
...
17.4%
in value over what they were Y es
30% 28.2%
25.1%
...
from the private sector (which 0%
Yes No No opinion
...
2020 SANS Cyber Threat Intelligence (CTI) Survey 15
...
clear that there are numerous positive trends in the community, such as more In the coming year, get more
organizations producing intelligence instead of just consuming it. But there are involved in the community and
...
conduct cyber threat intelligence. Tools and data sources are always going to be around intelligence requirements
vital to the process, but the world of intelligence analysis is inherently analyst- and analyst development. With
...
share include strategies for measuring the effectiveness of a CTI program. These analysts will likely be asked to
...
and with what level of visibility vs. what you can to today based on investments threat data, best practices and
...
developed leveraging shared best practices and ideally can be built into tools to protect critical networks.
in the future, both commercial and open-source, making the process timely,
effective and repeatable.
2020 SANS Cyber Threat Intelligence (CTI) Survey 16
