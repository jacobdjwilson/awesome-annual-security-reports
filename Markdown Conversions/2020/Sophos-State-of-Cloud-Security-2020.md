...
- [Part 1: The prevalence of cloud attacks](#part-1-the-prevalence-of-cloud-attacks)
  ...
  - [Organizations hit by malware in the public cloud in the last year](#organizations-hit-by-malware-in-the-public-cloud-in-the-last-year)
  - [Organizations hit by ransomware in the public cloud in the last year](#organizations-hit-by-ransomware-in-the-public-cloud-in-the-last-year)
  - [Organizations with public cloud data exposed in the last year](#organizations-with-public-cloud-data-exposed-in-the-last-year)
  - [Organizations with cloud account credentials stolen in the last year](#organizations-with-cloud-account-credentials-stolen-in-the-last-year)
  - [Organizations suffering a cryptojacking cyberattack in the public cloud in the last year](#organizations-suffering-a-cryptojacking-cyberattack-in-the-public-cloud-in-the-last-year)
...
![Image description: A bar chart showing that 70% of organizations suffered a public cloud security breach in the last year, and 96% of organizations are concerned about their current level of cloud security.]
...
![Image description: A bar chart showing the types of security incidents organizations suffered in the last year. Malware: 50%, Exposed Data: 34%, Ransomware: 29%, Account Compromise: 28%, Cryptojacking: 25%.]
...
![Image description: A horizontal bar chart showing the percentage of organizations that suffered public cloud security incidents in the last year, broken down by country. India has the highest percentage at 93%, followed by Nigeria at 86%, and Philippines at 82%. Poland and Italy have the lowest percentages at 47% and 45% respectively.]
...
![Image description: A horizontal bar chart showing the percentage of organizations hit by malware in the public cloud in the last year, broken down by country. Turkey has the highest percentage at 63%, followed by Philippines at 58%, and UAE at 54%. Poland has the lowest percentage at 17%.]
...
![Image description: A horizontal bar chart showing the percentage of organizations hit by ransomware in the public cloud in the last year, broken down by country. Malaysia has the highest percentage at 54%, followed by India at 53%, and Australia at 39%. Poland has the lowest percentage at 7%.]
...
![Image description: A horizontal bar chart showing the percentage of organizations with public cloud data exposed in the last year, broken down by country. Nigeria has the highest percentage at 57%, followed by India at 49%, and Philippines at 40%. Turkey has the lowest percentage at 13%.]
...
![Image description: A horizontal bar chart showing the percentage of organizations with cloud account credentials stolen in the last year, broken down by country. India has the highest percentage at 48%, followed by Nigeria at 46%, and Malaysia at 42%. UK has the lowest percentage at 12%.]
...
![Image description: A horizontal bar chart showing the percentage of organizations suffering a cryptojacking cyberattack in the public cloud in the last year, broken down by country. India has the highest percentage at 36%, followed by Nigeria and South Africa at 26%. Poland has the lowest percentage at 4%.]
...
![Image description: A pie chart showing how attackers got into organizations' environments. Breached through a security misconfiguration: 66%, Had cloud account credentials stolen: 33%, Cloud resource misconfiguration: 22%, Misconfigured web application firewall (WAF): 44%.]
...
![Image description: A stacked bar chart showing how organizations were compromised, broken down by country. The chart shows percentages for Misconfiguration, Stolen Credentials, and Other/Don't Know. For example, in South Africa, 39% were compromised by misconfiguration and 59% by stolen credentials.]
...
![Image description: Two pie charts. The first shows that 91% of organizations had overprivileged Identity and Access Management roles. The second shows that 98% of organizations had MFA disabled on their cloud provider accounts.]
...
![Image description: A horizontal bar chart showing the top cloud security concerns among organizations. Data loss/leakage is the highest at 44%, followed by Identifying and responding to security incidents at 41%, and Managing multiple public cloud providers at 28%.]
...
![Image description: A bar chart showing the impact of configurations on data security. Organizations had storage services without encryption turned on: 65%. Organizations had databases without encryption turned on: 13%. Organizations had databases open to the Internet: 18%. Organizations had storage services with public read/list permission enabled: 85%.]
...
![Image description: A pie chart showing where data was encrypted in the most significant ransomware attack. Includes data in the public cloud: 59%. On premises/private cloud data: 41%. Data in the public cloud and on premises/private cloud data: 35%. Data in the public cloud: 24%.]
...
![Image description: A stacked bar chart comparing security incidents in single-cloud and multi-cloud organizations. For each incident type (Malware, Exposed Data, Ransomware, Account Compromise, Cryptojacking), multi-cloud organizations reported higher percentages of incidents than single-cloud organizations.]
