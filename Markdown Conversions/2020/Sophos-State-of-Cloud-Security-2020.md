...
48% of survey respondents using the public cloud were from small organizations (100-1000 employees), and 52% were from larger organizations (1001-5000 employees). Respondents came from 26 countries across six continents:
...
* [Executive summary](#executive-summary)
    * [Use of data and charts in this report](#use-of-data-and-charts-in-this-report)
...
**70%**
of organizations suffered a public cloud security breach in the last year

**96%**
of organizations are concerned about their current level of cloud security
...
**Image Description:** A bar chart showing the percentage of organizations that suffered different types of security incidents in the last year. The categories are Cryptojacking (17%), Exposed Data (34%), Account Compromise (29%), Ransomware (28%), and Malware (50%). The chart is titled "Organizations suffering security incidents in the last year".
...
**Image Description:** A horizontal bar chart showing the percentage of organizations in each country that suffered a public cloud security incident in the last year. The countries are ordered from highest to lowest percentage. India is at the top with 93%, and Italy is at the bottom with 45%. The global average is shown as a vertical line at 70%. The chart is titled "Organizations suffering public cloud security incidents in the last year".
...
**Image Description:** A horizontal bar chart showing the percentage of organizations in each country that were hit by malware in the public cloud in the last year. The countries are ordered from highest to lowest percentage. Turkey is at the top with 63%, and Poland is at the bottom with 17%. The chart is titled "Organizations hit by malware in the public cloud in the last year".

**Image Description:** A horizontal bar chart showing the percentage of organizations in each country that were hit by ransomware in the public cloud in the last year. The countries are ordered from highest to lowest percentage. Malaysia is at the top with 54%, and Turkey is at the bottom with 7%. The chart is titled "Organizations hit by ransomware in the public cloud in the last year".

**Image Description:** A horizontal bar chart showing the percentage of organizations in each country that had public cloud data exposed in the last year. The countries are ordered from highest to lowest percentage. Nigeria is at the top with 57%, and Turkey is at the bottom with 13%. The chart is titled "Organizations with public cloud data exposed in the last year".

**Image Description:** A horizontal bar chart showing the percentage of organizations in each country that had cloud account credentials stolen in the last year. The countries are ordered from highest to lowest percentage. India is at the top with 48%, and UK is at the bottom with 12%. The chart is titled "Organizations with cloud account credentials stolen in the last year".

**Image Description:** A horizontal bar chart showing the percentage of organizations in each country that suffered a cryptojacking cyberattack in the public cloud in the last year. The countries are ordered from highest to lowest percentage. India is at the top with 36%, and Poland is at the bottom with 4%. The chart is titled "Organizations suffering a cryptojacking cyberattack in the public cloud in the last year".
...
**33%**
Had cloud account credentials stolen

**66%**
Breached through a security misconfiguration
...
**Image Description:** A pie chart showing the methods attackers used to get into organizations' environments. The categories are Cloud account credentials stolen (33%), Breached through a security misconfiguration (66%), with a further breakdown of Cloud resource misconfiguration (22%) and Misconfigured web application firewall (WAF) (44%). The chart is titled "How did the attacker get into your organization’s environment?".
...
**Image Description:** A stacked horizontal bar chart showing how organizations were compromised, broken down by Misconfiguration, Stolen Credentials, and Other/Don't Know. The countries are ordered based on the percentage of misconfiguration. South Africa has the highest percentage of stolen credentials (84%), and Turkey has the highest percentage of misconfiguration (59%). The chart is titled "How organizations were compromised".
...
**98%**
Had MFA disabled on their cloud provider accounts
...
**Image Description:** A horizontal bar chart showing the top cloud security concerns among organizations. The categories are ordered from highest to lowest percentage. Data loss/leakage is the highest concern at 44%, and "Don't know" is the lowest at 1%. The chart is titled "Top cloud security concerns among organizations".
...
**Image Description:** A horizontal bar chart showing the percentage of organizations with various misconfigurations. 18% of organizations had storage services with public read/list permission enabled, 13% had databases open to the Internet, 85% had databases without encryption turned on, and 65% had storage services without encryption turned on. The chart is titled "The impact of configurations on data security".
...
**Image Description:** A pie chart showing where data was encrypted in the most significant ransomware attack. 41% of the encrypted data was on premises/private cloud data, and 59% included data in the public cloud. The public cloud data is further broken down into 35% data in the public cloud and 24% data in the public cloud and on premises/private cloud data. The chart is titled "Did the cybercriminals succeed in encrypting your organization’s data in the most significant ransomware attack?".
...
**Image Description:** A stacked bar chart showing the percentage of single and multi-cloud organizations that were hit by different types of cyberattacks in the last year. The categories are Malware, Exposed Data, Ransomware, Account compromise, Cryptojacking, Don't know, and Yes, other. The chart is titled "Single and multi-cloud organizations hit by cyberattacks in the last year".
...
**Image Description:** A diagram showing the various components of Sophos' cloud security solution. The components are labeled as Server with EDR, Cloud Storage and Databases, Virtual Machines, Containers and Serverless, Security Analysis, Identity Security, Workload Protection, and Network Firewalling. The diagram shows how these components are interconnected.
