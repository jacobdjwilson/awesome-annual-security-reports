...
## Table of Contents
- [Compass points and decoder keys](#compass-points-and-decoder-keys)
- [State of Cyber-Espionage](#state-of-cyber-espionage)
  - [Patterns](#patterns)
  - [Timelines](#timelines)
- [Targeted victims](#targeted-victims)
  - [NIST CSF Identify](#nist-csf-identify)
  - [Regions](#regions)
  - [Industries](#industries)
- [Essential Elements of Friendly Information](#essential-elements-of-friendly-information)
...
- [The way forward](#the-way-forward)
  ...
  - [Takeaways](#takeaways)
  - [Mappings](#mappings)
- [Appendix A: Guides](#appendix-a-guides)
...
- [Appendix B: Industry dossiers](#appendix-b-industry-dossiers)
...
### Contact us.
Questions? Comments? Feedback? Drop the VTRAC team a line at [vtrac@verizon.com](mailto:vtrac@verizon.com) or find us on LinkedIn at #cyberespionagereport and #vtrac
...
[^1]: ‘Chancellor’s speech to GCHQ on cybersecurity’: [public-sector.co.uk/article/ff8fa006cdcd35f4cf9ef4e030e08ff1](public-sector.co.uk/article/ff8fa006cdcd35f4cf9ef4e030e08ff1)
...
![Top Action varieties within Cyber-Espionage breaches (2014 DBIR; n=282)](./images/figure1.png)

![Top Action varieties within Cyber-Espionage breaches (2014-2020 DBIR; n=1,465)](./images/figure2.png)

![Top Action varieties within Cyber-Espionage breaches (2020 DBIR; n=114)](./images/figure3.png)
...
It is important to note that these Incident Classification Patterns are just those known, reported and collected. Because Cyber-Espionage attacks are difficult to detect, and the breaches within this pattern are under-reported, the number may be much higher. The kinds of data stolen in Cyber-Espionage breaches (e.g., Secrets, Internal or Classified) may not fall under the data types that trigger reporting requirements under many laws or regulations. Cyber-Espionage threat actors are not typically targeting customer data, or even employee data, but rather the intellectual property (or secret sauce if you will) that would give them a leg up in industrial espionage.

![Breaches by pattern (2014-2020 DBIR; n=16,090)](./images/figure4.png)

![Breaches by pattern (2020 DBIR; n=3,950)](./images/figure5.png)
...
![Time to Compromise within Cyber-Espionage breaches (2014-2020 DBIR; n=47)](./images/figure6.png)

![Time to Compromise within all breaches (2014-2020 DBIR; n=2,658)](./images/figure7.png)

![Time to Exfiltration within Cyber-Espionage breaches (2014-2020 DBIR; n=43)](./images/figure8.png)

![Time to Exfiltration within all breaches (2014-2020 DBIR; n=1,098)](./images/figure9.png)
...
![Time to Discovery within Cyber-Espionage breaches (2014-2020 DBIR; n=125)](./images/figure10.png)

![Time to Discovery within all breaches (2014-2020 DBIR; n=2,918)](./images/figure11.png)

![Time to Containment within Cyber-Espionage breaches (2014-2020 DBIR; n=51)](./images/figure12.png)

![Time to Containment within all breaches (2014-2020 DBIR; n=789)](./images/figure13.png)
...
![Cyber-Espionage breaches by region (2014-2020 DBIR; n=597)](./images/figure14.png)

![All breaches by region (2014-2020 DBIR; n=6,780)](./images/figure15.png)
...
![Cyber-Espionage breaches within select industries (2014-2020 DBIR; n=1,580)](./images/figure16.png)

![Cyber-Espionage breaches within all breaches of select industries (2014-2020 DBIR)](./images/figure17.png)
...
![Compromised Attributes within Cyber-Espionage breaches (2014-2020 DBIR; n=1,580)](./images/figure18.png)

![Compromised Attributes within all breaches (2014-2020 DBIR; 16,090)](./images/figure19.png)
...
![Top compromised Attribute varieties within Cyber-Espionage breaches (2014-2020 DBIR; n=1,571)](./images/figure20.png)

![Top compromised Attribute varieties within all breaches (2014-2020 DBIR; n=14,736)](./images/figure21.png)
...
![Top compromised Asset varieties within Cyber-Espionage breaches (2020 DBIR; n=113)](./images/figure22.png)

![Top compromised Asset varieties within all breaches (2020 DBIR; n=2,667)](./images/figure23.png)
...
![Top compromised Asset varieties within Cyber-Espionage breaches (2014-2020 DBIR; n=1,297)](./images/figure24.png)

![Top compromised Asset varieties within all breaches (2014-2020 DBIR; n=13,217)](./images/figure25.png)
...
![Vulnerability exploitation over time in breaches](./images/figure26.png)
...
### Data
![Top compromised Data varieties within Cyber-Espionage breaches (2020 DBIR; n=110)](./images/figure27.png)

![Top compromised Data varieties within all breaches (2020 DBIR; n=3,373)](./images/figure28.png)
...
![Top compromised Data varieties within Cyber-Espionage breaches (2014-2020 DBIR; n=1,526)](./images/figure29.png)

![Top compromised Data varieties within all breaches (2014-2020 DBIR; n=13,657)](./images/figure30.png)
...
![Top Discovery methods for Cyber-Espionage breaches (2014-2020 DBIR; n=408)](./images/figure31.png)

![Top Discovery methods for all breaches (2014-2020 DBIR; n=7,025)](./images/figure32.png)
...
![Actors over time for all breaches (2014-2020 DBIR)](./images/figure33.png)

![Actor varieties within Cyber-Espionage breaches (2014-2020 DBIR; n=1,435)](./images/figure34.png)

![Actor varieties within all breaches (2014-2020 DBIR; n=9,077)](./images/figure35.png)
...
![Actor motives over time within all breaches (2014-2020 DBIR)](./images/figure36.png)
...
![Actor motives within all breaches (2020 DBIR; n=1,141)](./images/figure37.png)

![Actor motives within all breaches (2014-2020 DBIR; n=9,863)](./images/figure38.png)
...
Investigating Cyber-Espionage breaches differs from researching cybersecurity incidents. Thus, incident responders and forensic investigators may not initially realize that an attack is targeted and the motive is intellectual proper

---

ty theft. It’s only as
