...
- [Finding 1: IGA Investments Are Fueled by Risk Reduction and Compliance Efficiency](#finding-1-iga-investments-are-fueled-by-risk-reduction-and-compliance-efficiency)
- [Finding 2: Confidence Is High, but Based on Perception, Not Measurement](#finding-2-confidence-is-high-but-based-on-perception-not-measurement)
- [Finding 3: Executives See Identity Activity Before Identity Risk](#finding-3-executives-see-identity-activity-before-identity-risk)
- [Finding 4: Zero Trust Is Widely Adopted, but Interoperability Gaps Limit Visibility](#finding-4-zero-trust-is-widely-adopted-but-interoperability-gaps-limit-visibility)
- [Finding 5: Concern About Identity Threats Is High Across All Attack Types](#finding-5-concern-about-identity-threats-is-high-across-all-attack-types)
- [Finding 6: Organizations Use GenAI to Scale Identity Security](#finding-6-organizations-use-genai-to-scale-identity-security)
- [Finding 7: Agentic AI Governance Expectations Outpace Current Controls](#finding-7-agentic-ai-governance-expectations-outpace-current-controls)
- [Finding 8: Non-Human Identities Dominate, but Ownership Is Fragmented](#finding-8-non-human-identities-dominate-but-ownership-is-fragmented)
- [Finding 9: Agentic AI Is Moving Faster Than Governance Models](#finding-9-agentic-ai-is-moving-faster-than-governance-models)
- [What the Data Makes Clear](#what-the-data-makes-clear)
- [About the Research](#about-the-research)

---

**Organization**: Omada  
**Report Title**: State-of-Identity-Governance  
**Year**: 2026  
...
![Bar chart showing key business challenges driving IGA investment, with compliance and audit efficiency leading at over 60%]
...
**Survey Question**  
Indicate your agreement with the following statements related to your organization.

![Horizontal bar chart showing high agreement percentages across statements regarding IGA adaptability, compliance reporting, and risk identification]
...
![Bar chart displaying executive reporting metrics, with provisioning and deprovisioning timeliness at 74%]
...
![Pie or distribution chart showing Zero Trust adoption levels]
...
- Credential Theft & Reuse / Credential Stuffing
- Session Hijacking / Token-based Attacks / Replay Attacks
- Misconfiguration / Orphaned Accounts / Excess Privileged Identities & Access Sprawl

![Bar chart displaying concern levels across multiple identity threat categories]
...
- Enhance threat detection and response through pattern analysis
...
- Automated identity and access decisions powered by GenAI
- Identity analytics for privileged risk remediation
- Real-time, context-aware risk analytics and anomaly detection
- Governance automation for human and non-human identities
...
![Chart displaying unique identity assignment percentages for agentic AI agents]

**Survey Question**  
How does your organization handle credential management for agentic AI agents?

![Chart illustrating credential management practices for agentic AI agents]
...
![Chart detailing team responsibility breakdown for non-human identity management]

**Survey Question**  
What is the approximate ratio of non-human identities to human identities in your organization?

![Chart illustrating ratios of non-human to human identities]
...
![Chart depicting agentic AI deployment, pilot, and planning status]

**Survey Questions**  
What concerns does your organization have related to the deployment of agentic AI? (Select all that apply)

![Chart showing security and other concerns regarding agentic AI deployment]
