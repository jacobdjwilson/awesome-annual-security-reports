...
- **The France-focused spear-phishing wave** used leaked ISP customer data to lure victims into entering their Amazon credentials on a fake login page, enabling immediate account takeover without any technical exploitation.
