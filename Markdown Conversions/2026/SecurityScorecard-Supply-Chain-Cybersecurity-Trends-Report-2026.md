...
- [Section 1: As third-party ecosystems grow, so do the risks](#section-1)
- [Section 2: Leaders express confidence, but new threats are emerging](#section-2)
- [Section 3: Keeping up with regulations is an ongoing challenge](#section-3)
- [Section 4: Yesterday’s supply chain security practices aren’t strong enough](#section-4)
- [Section 5: With incident response, time is not on your side](#section-5)
- [Conclusion: Close the confidence-protection gap with stronger threat intelligence](#conclusion)
...
## Section 1: As third-party ecosystems grow, so do the risks
...
![Chart: How concerned are you about supply chain cybersecurity? (86% expressed some level of concern)]

![Chart: Approximately how many third-party suppliers does your organization have?]

![Chart: Approximately how large is your total vendor ecosystem (up to the fifth party)?]
...
As the number of nth-party vendors has increased, so have the risks. Third-party breaches doubled in 2025, according to Verizon’s latest Data Breach Investigations Report.[^1] Yet internal oversight of supply chain risks remains flat from last year. Just 9% of respondents say over three quarters of their total vendor ecosystem is overseen by an internal supply chain cybersecurity program.

![Chart: What percentage of your total vendor ecosystem is overseen by an internal supply chain cybersecurity program?]

![Chart: What percentage of your vendor ecosystem is complying with your cybersecurity requirements?]

---

## Section 2: Leaders express confidence, but new threats are emerging
...
![Chart: How effective are your organization’s current supply chain cybersecurity measures at mitigating risks?]
...
![Chart: How confident are you that your business could continue operations without disruption if a cybersecurity incident occurred at a critical vendor?]

What could shake leaders’ confidence even further? The rise of AI-driven threats.

![Chart: What types of supply chain risks most concern you?]

---

## Section 3: Keeping up with regulations is an ongoing challenge
...
![Chart: Which areas of third-party or supply chain compliance present the greatest challenges?]

![Chart: Which factors most strongly drive your supply chain cybersecurity or TPRM program?]

A majority (94%) of respondents express certainty that their third-party risk practices can meet emerging regulations. Yet 38% of leaders list regulatory pressures as a greater concern than talent shortages or a lack of supply chain visibility.

![Chart: How confident are you that your third-party risk practices meet emerging supply chain cybersecurity regulations?]

![Chart: What specific events, challenges, or gaps most influence your level of concern?]

---

## Section 4: Yesterday’s supply chain security practices aren’t strong enough

In an environment where bad actors can use AI tools to spin up attacks against third-party vendors at machine speed, relying on outdated practices like point-in-time assessments creates serious vulnerabilities. 
...
![Chart: Does your organization manage supply chain cybersecurity internally or via an external managed service provider?]

Annual audits and penetration testing are the most popular methods respondents use to ensure vendor compliance. Another 46% of leaders rely on periodic assessments, conducted monthly or quarterly.

![Chart: Which methods does your organization use to ensure vendor compliance with cybersecurity requirements?]

![Chart: Which components are part of your supply chain cybersecurity program?]

![Chart: Which best describes your approach to monitoring third-party cyber risk?]

![Chart: Which methods do you use to assess third-party risk?]

![Chart: What level of supply chain risk management does your organization perform?]

![Chart: Which supply chain incident response capabilities does your organization have?]

---

## Section 5: With incident response, time is not on your side

Supply chain incidents differ in size and scope. While organizations may have time to solve a newly discovered vulnerability or adapt to a change in a vendor’s risk profile, critical incidents require fast remediation. 

How quickly can respondents remedy a high-severity issue? While 37% of respondents can do it within 0 - 7 days, 60% need 8 - 60 days. The No. 1 reason for slow response is poor, manual communication methods.

![Chart: How often does your organization conduct third-party risk assessments?]

![Chart: How often is your organization’s risk assessment of its critical Tier 1 vendors updated or re-evaluated?]

![Chart: What is the average time it takes a critical vendor to remediate a high-severity security issue?]

![Chart: What are the biggest barriers to timely vendor remediation?]

![Chart: How does your organization primarily collaborate with vendors during remediation?]
...
![Chart: How long does it typically take your organization to determine whether a newly announced critical vulnerability affects any of your third-party vendors?]

---

## Conclusion: Close the confidence-protection gap with stronger threat intelligence
...
![Chart: Do you plan to develop a dedicated supply chain incident response function?]

### Firmographics
- **Countries represented**: U.S., Canada, UK, South Africa, Singapore/Philippines/Australia/New Zealand, India.
- **Industries represented**: Technology, Manufacturing, Financial services/insurance, Retail/e-commerce, Healthcare.
