...
![Infographic showing 60% are increasing cyber risk investment in response to geopolitical volatility.]
![Infographic showing only 6% have fully implemented all data risk measures surveyed.]
![Infographic showing top 2 challenges to implementing AI for cyber defence are knowledge and skills gaps.]
...
## Table of Contents
- [01 Risk and threat landscape: Geopolitics are reshaping cyber vulnerabilities](#01-risk-and-threat-landscape-geopolitics-are-reshaping-cyber-vulnerabilities)
- [02 Cyber strategy and operations: Where investment meets impact](#02-cyber-strategy-and-operations-where-investment-meets-impact)
- [03 AI in cybersecurity: From promise to priority](#03-ai-in-cybersecurity-from-promise-to-priority)
- [04 Quantum computing readiness: Preparing for next-level threats](#04-quantum-computing-readiness-preparing-for-next-level-threats)
- [05 Cyber talent and skills: Managed services move to the front line](#05-cyber-talent-and-skills-managed-services-move-to-the-front-line)
- [06 C-suite playbook: From uncertainty to action — What leaders can do now](#06-c-suite-playbook-from-uncertainty-to-action-what-leaders-can-do-now)

## 01 Risk and threat landscape: Geopolitics are reshaping cyber vulnerabilities

![Infographic showing 60% are increasing cyber risk investment in response to geopolitical volatility.]
![Infographic showing only 6% are ‘very capable’ of withstanding cyber attacks across all vulnerabilities surveyed given the geopolitical landscape.]
![Infographic showing top 2 cyber threats organisations are least prepared to address: cloud and connected product attacks.]
...
![Bar chart showing cyber strategy changes in response to current geopolitical landscape, with percentages for top 3 areas of change. Increase cyber risk investment: 60%, Change in critical infrastructure location: 41%, Change in trade and operating policies: 39%, Change in cyber insurance policies: 39%, Change where business is conducted: 31%, Change in vendors: 26%.]
...
![Stacked bar chart showing capability to withstand a major cyber attack across various vulnerabilities. Categories include Weak authentication and access controls, Unpatched software updates, Vulnerable connected products/devices, Lack of visibility into end points, Insufficient network architecture, Legacy systems, Supply chain vulnerabilities. Each category shows percentages for Not very capable, Somewhat capable, Very capable, and Unsure/not applicable. Only 6% cite ‘very capable’ across all areas.]
Q3. Given the current geopolitical landscape, how capable is your organisation to withstand a major cyber attack targeting the following vulnerabilities? Base: Security leaders, COOs and Operations Directors=1971
Source: PwC 2026 Global Digital Trust Insights
...
![Bar chart showing cyber threats organisations are least prepared to address, with percentages for top 3 threats. Threats include Cloud-related threats (33%), Attacks on connected products (28%), Third-party breach (27%), Quantum computing threats (26%), Social engineering (25%), Software supply-chain compromise (23%), Hack-and-leak operations (21%), Ransomware (20%), Employment infiltration (20%), Exploits of zero-day vulnerabilities (19%), Business email compromise/account takeovers (17%), Distributed denial-of-service (DDoS) attacks (15%).]
Q1. Over the next 12 months, which of these cyber threats is your organisation least prepared to address? Base: Security leaders=1740
Source: PwC 2026 Global Digital Trust Insights
...
## 02 Cyber strategy and operations: Where investment meets impact

![Infographic showing only 24% are spending significantly more on proactive vs reactive cybersecurity measures.]
![Infographic showing 78% expect their cyber budget to increase over the coming year.]
![Infographic showing only 16% are measuring the financial impact of cyber risks to a significant extent.]
...
![Bar chart showing cyber budget change in 2026. Increase by 15% or more: 7%, Increase by 11-14%: 10%, Increase by 6-10%: 12%, Increase by 5% or less: 32%, Will not change: 29%, Decrease by 5% or less: 2%, Decrease by 6-10%: 2%, Decrease by 11-14%: 1%, Decrease by 15% or more: 1%, Cannot determine at this time: 4%, I don’t know any detail on the cyber budget: 1%. Overall, 78% expect an increase.]
...
![Donut chart showing spending on reactive vs proactive measures. Reactive measures: Significantly more on reactive measures (7%), Slightly more on reactive measures (14%), About the same (21%). Proactive measures: Slightly more on proactive measures (32%), Significantly more on proactive measures (24%). 67% have a roughly equal spending ratio. 2% selected ‘unsure’.]
...
![Bar chart showing investments organisations are prioritising when allocating cyber budgets, with percentages for top 3 priorities. Artificial intelligence (AI): 36%, Cloud security: 34%, Network security and zero trust: 28%, Data protection/data trust: 26%, Threat management: 24%, Cyber managed services: 21%, Security awareness training: 19%, Identity and access management: 18%, Supply chain and third-party risk management: 16%, Endpoint security: 15%, Application security: 15%, Operational technology (OT) security: 10%, Connected products: 10%, Quantum computing: 8%, API security: 7%, Mobile security: 7%.]
...
![Stacked bar chart comparing measurement of financial impact of cyber risks in 2026 vs 2025. Categories include: To a significant extent (e.g., extensive cyber risk quantification with automation and executive reporting) - 16% (2026), 15% (2025); To a large extent (e.g., established use of cyber risk methods) - 34% (2026), 29% (2025); To a moderate extent (e.g., exploring through limited use of cyber risk methods) - 27% (2026), 29% (2025); To a limited extent (e.g., qualitatively through risk assessment and risk prioritisation) - 15% (2026), 17% (2025); Not at all, but planning to in the next two years - 4% (2026), 6% (2025); Not at all and no plans to in the next two years - 2% (2026), 2% (2025). DTI26: 50%, DTI25: 44%.]
...
## 03 AI in cybersecurity: From promise to priority

![Infographic showing #1 cyber investment priority for security leaders is AI.]
![Infographic showing #1 AI security capability prioritised by security leaders is threat hunting.]
![Infographic showing top 3 areas of priority for agentic AI are cloud security, data protection and cyber defence.]
...
![Bar chart showing agentic AI among the top prioritised AI security capabilities, ordered based on those who ranked as their top priority. 1. Threat hunting, 2. Agentic AI, 3. Event detection and behavioural analytics, 4. Identity and access management, 5. Vulnerability scanning, 6. Vulnerability assessments, 7. Penetration testing, 8. Red teaming.]
...
![Bar chart showing agentic AI priorities to increase efficiency and productivity, with percentages for top 3 priorities. Cloud security: 39%, Data protection: 39%, Cyber defence and operations: 38%, Security testing: 31%, Cyber governance, risk and compliance: 30%, Identity and access management: 27%, Security architecture: 23%, DevSecOps: 19%, Strategy and business enablement: 19%.]
...
![Stacked bar chart showing implementation of measures to address data risk. Measures include Data classification policies (50% implemented across the organization), Data loss prevention across key egress channels (48%), Data controls across the entire data life cycle (44%), Data encryption, tokenisation, and/or anonymisation capabilities at scale (44%), Data quality capabilities (41%), Data discovery and cataloguing across structured and unstructured data (40%), Data minimisation approaches (37%). Only 6% have implemented across the organisation in all areas.]
Q5. To what extent has your organisation implemented or is planning to implement any of the following measures to address data risk across the enterprise? Base: Security leaders, CFOs, Finance Directors, CDOs, Chief Counsel/GC/CLO, CROs, Risk Directors, CAEs and Internal Audit Directors=2395
Source: PwC 2026 Global Digital Trust Insights

## 04 Quantum computing readiness: Preparing for next-level threats

![Infographic showing top 4 threats organisations are least prepared to address now include quantum computing.]
![Infographic showing 49% of organisations haven’t considered or started implementing any quantum-resistant security measures.]
![Infographic showing only 8% of security leaders include quantum readiness in their top three budget priorities.]
...
![Donut chart showing quantum-resistant security progress. Not started to consider and no plans to do so: 9%, Unable to confirm at this time: 7%, Exploring: 33%, Implementing: 22%, Piloting and testing: 29%. Overall, 49% are not implementing or have no planned activity.]
...
![Stacked bar chart showing implementation of quantum-resistant security measures. Measures include Data mapping and inventory (24% implemented), Conducting a feasibility analysis (22%), Assessment of third-party cryptologic standards (24%), Implementing ‘trust by design’ principles (26%), Assessment of asset-based quantum risk (24%), Cryptographic discovery (26%), Quantum-resistant encryption (26%). Only 3% have implemented all quantum-resistant security measures.]
...
![Bar chart showing challenges to achieving post-quantum cryptography, with percentages for top 3 challenges. Gaps in technical expertise to adopt industry standards: 37%, Gaps in dedicated quantum computing knowledge and resources: 36%, Gaps in existing systems and/or data integration challenges: 34%, Prioritisation of more near-term cybersecurity initiatives: 33%, Lack of visibility into cryptographic vulnerabilities: 29%, Lack of data encryption, tokenisation and/or anonymisation capabilities: 28%, Lack of data retention policies and defensible disposition: 25%, Lack of strategic direction from leadership: 24%.]
...
## 05 Cyber talent and skills: Managed services move to the front line

![Infographic showing top 2 challenges to implementing AI for cyber defence are knowledge and skills gaps.]
![Infographic showing 53% rank AI and machine learning tools in their top three priorities to address cyber talent gaps over the next 12 months.]
![Infographic showing 48% of organisations that have experienced a major attack are prioritising managed services to address cyber talent gaps.]
...
![Bar chart showing AI implementation challenges for cyber defence, with percentages for top 3 challenges. Lack of knowledge in the application of AI for cyber defence: 50%, Lack of relevant skills: 41%, Risk appetite for usage of AI is unclear: 39%, Our leaders are unclear on the value of AI for cyber defence: 34%, There is no clear executive ownership of AI for cybersecurity: 32%, AI is not a budgetary priority for cybersecurity: 31%.]
...
![Bar chart showing obstacles for securing OT and IIoT systems, with percentages for top 3 obstacles. Gaps in OT skillsets and resources for delivery of OT/IIoT cybersecurity initiatives: 47%, Lack of network segmentation between OT/IIoT and IT environments: 41%, Gaps in understanding the scope of OT/IIoT cyber risk: 40%, Lack of governance and responsibility for OT/IIoT cybersecurity: 39%, Inadequate funding and executive support for delivery of OT/IIoT cybersecurity initiatives: 38%, Lack of visibility of OT/IIoT assets: 35%. No significant OT/IIoT footprint: 6%.]
...
![Bar chart showing cybersecurity priorities for the use of managed services, with percentages for top 3 priorities. Artificial intelligence (AI): 38%, Cloud security: 32%, Threat management: 28%, Data protection/data trust: 27%, Network security and zero trust: 24%, Endpoint security: 19%, Identity and access management: 18%, Supply chain and third-party risk management: 17%, Application security: 16%, Connected products: 13%, Operational technology (OT) security: 12%, Quantum computing: 11%, Mobile security: 9%, Security awareness training: 9%, API security: 8%.]
...
## 06 C-suite playbook: From uncertainty to action — What leaders can do now
