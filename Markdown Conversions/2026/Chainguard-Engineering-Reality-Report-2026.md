...
- [The Developer Experience Dilemma: Where Can Teams Improve?](#the-developer-experience-dilemma-where-can-teams-improve)
- [Innovation Over Maintenance: What Engineers Really Value](#innovation-over-maintenance-what-engineers-really-value)
- [AI and Automation Move Towards Critical Mass](#ai-and-automation-move-towards-critical-mass)
- [Engineering Tool Sprawl Reduces Productivity](#engineering-tool-sprawl-reduces-productivity)
- [Key Takeaways](#key-takeaways)
- [Demographics and Methodology](#demographics-and-methodology)
...
> **72%** of engineers state that there are so many demands on their time it is difficult to find space for building new features
...
- **30%**: Believe their developers spend 25% or more of their time on innovation
- **20%**: Believe their developers spend 25% or less of their time on innovation
...
1. Frequent need for code maintenance (upgrades, breaking changes, patching, vulnerability resolution) distracting from key priorities (38% of respondents)
2. Too many tedious tasks that take them away from meaningful, productive work (38%)
3. Excessive workload or burnout (35%)
4. Limited learning and development opportunities (33%)
5. Frequent switching between coding tasks and non-coding tasks (32%)
6. Lack of recognition and appreciation (28%)
7. Lack of effective tools to allow engineers to do their work (28%)
8. Too many tools, creating integration difficulties (27%)

### Top reasons senior technology leaders don’t feel highly positive about their team’s developer experience

1. Frequent need for code maintenance (upgrades, breaking changes, patching, vulnerability resolution) distracting from key priorities (43% of respondents)
2. Too many tedious tasks that take them away from meaningful, productive work (37%)
3. Frequent switching between coding tasks and non-coding tasks (34%)
4. Excessive workload or burnout (33%)
5. Lack of recognition and appreciation (33%)
6. Lack of effective tools to allow engineers to do their work (32%)
7. Limited learning and development opportunities (29%)
8. Too many tools, creating integration difficulties (25%)
...
- **Writing Dockerfiles and managing container configurations**: 16%
- **Rebuilding or customizing base images for app needs**: 15%
- **Debugging environment-specific issues or build failures**: 15%
- **Updating dependencies and patching vulnerabilities**: 14%
- **Ensuring compliance requirements are met (SBOMs, attestations, etc)**: 13%
- **Chasing down upstream changes that break code**: 9%
- **Waiting on troubleshooting CI/CD pipeline failures**: 9%
- **Reviewing CVE alerts and triaging security scanners**: 8%

### Day-to-day tasks engineers like doing the least

- **Waiting on or troubleshooting CI/CD pipeline failures**: 16%
- **Chasing down upstream changes that break code**: 14%
- **Reviewing CVE alerts and triaging security scanners**: 13%
- **Debugging environment-specific issues or build failures**: 12%
- **Ensuring compliance requirements are met (SBOMs, attestations, etc)**: 12%
- **Updating dependencies and patching vulnerabilities**: 12%
- **Rebuilding or customizing base images for app needs**: 10%
- **Writing Dockerfiles and managing container configurations**: 9%
...
- **94%**: Highly Leveraging Automation
- **67%**: Not Highly Leveraging Automation
...
- **Security patching and vulnerability remediation**: Actively encouraged (54%), Allowed not actively encouraged (32%), Not allowed but do so anyway (6%), Not allowed/do not use (7%)
- **Administrative tasks, meetings and internal communication**: Actively encouraged (55%), Allowed not actively encouraged (34%), Not allowed but do so anyway (5%), Not allowed/do not use (5%)
- **System design and architecture**: Actively encouraged (51%), Allowed not actively encouraged (38%), Not allowed but do so anyway (7%), Not allowed/do not use (4%)
- **Learning and professional development**: Actively encouraged (59%), Allowed not actively encouraged (30%), Not allowed but do so anyway (5%), Not allowed/do not use (4%)
- **Testing, monitoring and quality assurance**: Actively encouraged (58%), Allowed not actively encouraged (31%), Not allowed but do so anyway (8%), Not allowed/do not use (4%)
- **Incident response and trouble shooting**: Actively encouraged (53%), Allowed not actively encouraged (37%), Not allowed but do so anyway (6%), Not allowed/do not use (4%)
- **Writing code, documentation, and building new features**: Actively encouraged (58%), Allowed not actively encouraged (32%), Not allowed but do so anyway (6%), Not allowed/do not use (3%)
- **Code review**: Actively encouraged (56%), Allowed not actively encouraged (33%), Not allowed but do so anyway (7%), Not allowed/do not use (3%)
- **Maintaining code**: Actively encouraged (51%), Allowed not actively encouraged (39%), Not allowed but do so anyway (7%), Not allowed/do not use (3%)

### Use of AI to assist software developers - Software developers/engineers

- **Security patching and vulnerability remediation**: Actively encouraged (42%), Allowed not actively encouraged (35%), Not allowed but do so anyway (10%), Not allowed/do not use (10%)
- **Administrative tasks, meetings and internal communication**: Actively encouraged (49%), Allowed not actively encouraged (37%), Not allowed but do so anyway (5%), Not allowed/do not use (7%)
- **System design and architecture**: Actively encouraged (45%), Allowed not actively encouraged (39%), Not allowed but do so anyway (8%), Not allowed/do not use (6%)
- **Learning and professional development**: Actively encouraged (50%), Allowed not actively encouraged (38%), Not allowed but do so anyway (5%), Not allowed/do not use (5%)
- **Testing, monitoring and quality assurance**: Actively encouraged (48%), Allowed not actively encouraged (29%), Not allowed but do so anyway (17%), Not allowed/do not use (6%)
- **Incident response and trouble shooting**: Actively encouraged (43%), Allowed not actively encouraged (41%), Not allowed but do so anyway (8%), Not allowed/do not use (8%)
- **Writing code, documentation, and building new features**: Actively encouraged (48%), Allowed not actively encouraged (30%), Not allowed but do so anyway (17%), Not allowed/do not use (5%)
- **Code review**: Actively encouraged (46%), Allowed not actively encouraged (29%), Not allowed but do so anyway (16%), Not allowed/do not use (8%)
- **Maintaining code**: Actively encouraged (45%), Allowed not actively encouraged (33%), Not allowed but do so anyway (16%), Not allowed/do not use (6%)

### Respondents’ top concerns about AI in software development and engineering

- **Lack of security/privacy**: 17%
- **Lack of accountability and trust in code development/time required for review**: 15%
- **The use of shadow AI (unauthorized use of AI tools/technologies)**: 14%
- **Costs/Return on investment (ROI)**: 11%
- **Legal and regulatory compliance**: 11%
- **Ownership of AI generated code is unclear**: 10%
- **Changes to organizational structure/job roles**: 7%
- **Ethical Concerns**: 7%
- **Loss of Jobs**: 6%
...
- **62% of engineers** said their organization’s tools are not fully integrated
- **52% of senior technology leaders** said their organization’s tools are not fully integrated
...
### Organization Size
- 100-249 employees: 78
- 250-499 employees: 176
- 500-999 employees: 240
- 1,000-2,999 employees: 321
- 3,000-4,999 employees: 193
- 5,000 or more employees: 192

### Organization Sector
- IT and technology incl. computer services: 193
- Healthcare: 151
- Financial services incl. banking and insurance: 137
- Business and professional services: 124
- Public sectors: 122
- Retail, distribution and transport incl. wholesale: 120
- Manufacturing and production: 100
- Energy, oil/gas and utilities: 76
- Construction and property incl. mining and metals: 51
- Consumer Services: 48
- Telecoms: 39
- Media, leisure and entertainment incl. travel/tourism: 36
...
- Board member; C-level: 106
- Senior management, senior manager of unit, function or department: 494
- Mid-level management; manager of team or silo: 319
- Junior management; supervisory and frontline managers: 86
...
- $500,000 or less: 0
- $500,001 - $1 million: 0
- $1.1 million - $5 million: 2
- $5.1 million - $10 million: 16
- $10.1 million - $25 million: 45
- $25.1 million - $50 million: 52
- $50.1 million - $100 million: 75
- $100.1 million - $250 million: 121
- $250.1 million - $500 million: 206
- $500.1 million - $1 billion: 232
- $1.1 billion - $5 billion: 280
