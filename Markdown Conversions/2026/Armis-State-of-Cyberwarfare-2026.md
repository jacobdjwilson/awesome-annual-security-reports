...
A WORLD UNDER PRESSURE: CYBERWARFARE IN AN AGE OF AI-FUELED ESCALATION
By Armis
...
- [01 Destabilizing Trust Across the Global Landscape](#01-destabilizing-trust-across-the-global-landscape)
- [02 The Readiness Paradox Widens](#02-the-readiness-paradox-widens)
- [03 The Cost of Cyberwarfare Worsens](#03-the-cost-of-cyberwarfare-worsens)
- [04 Who Has It Worse?](#04-who-has-it-worse?)
  - [By Industry](#by-industry)
- [Key Regional Breakdown](#key-regional-breakdown)
  ...
  - [Europe](#europe)
  - [Australia](#australia)
- [05 Emerging Technologies and the Next Phase of Escalation](#05-emerging-technologies-and-the-next-phase-of-escalation)
- [06 Analyzing the Compressed Evolution of Cyberwarfare](#06-analyzing-the-compressed-evolution-of-cyberwarfare)
- [Resilience in an Era of AI-Accelerated Cyberwarfare](#resilience-in-an-era-of-ai-accelerated-cyberwarfare)
...
- **81%** of organizations have evolved their cyberwarfare readiness posture over the past 3 years to strengthen their defenses against nation-states.
...
AI-generated content, deepfakes and coordinated disinformation campaigns are already distorting narratives around real-world events. Manipulated media spreads at speed, eroding confidence and certainty while inciting fear, anger and paranoia.

When asked who they believe is driving this threat, respondents point to familiar geopolitical fault lines. Russia (62%) and China (55%) dominate perceptions of cyber risk, followed by North Korea (37%) and Iran (19%), reinforcing how the erosion of trust is being shaped by the global power competition ([Fig 1](#fig-1)).
...
## 02. THE READINESS PARADOX WIDENS
...
Preparedness, it seems, is not keeping pace with threat evolution.
...
Detection challenges further expose the gap ([Fig 2](#fig-2)), with a significant proportion (43%) of organizations still detecting and responding to a significant attack reactively; only as it occurs (27%) or after the damage has already been done (16%).
...
- **My organization/agency typically detects and responds to a significant cyberattack after it has already occurred.** - 16%
- **My organization/agency typically detects and responds to a significant cyberattack as it occurs.** - 27%
- **My organization/agency typically detects and responds to a significant cyberattack within a few hours before it occurs.** - 19%
- **My organization/agency typically detects and responds to a significant cyberattack within a few days before it occurs.** - 17%
- **My organization/agency typically predicts and proactively mitigates potential cyberattacks weeks or even months in advance.** - 17%
...
## 03. THE COST OF CYBERWARFARE WORSENS
...
Avoiding payment is also becoming increasingly difficult. The proportion of organizations able to say “we have not had to make a ransomware payout” has fallen sharply year-on-year, signaling that payment is becoming the norm rather than the exception. The shift is most noticeable in key markets: in the U.S., this figure drops from 40% to 30% year-on-year, while in Australia, it’s fallen from 44% to 25%. More organizations are simply being forced to pay.

For those that do, the costs are significant. According to the U.S. Department of the Treasury’s Financial Crimes Enforcement Network (FinCEN), ransomware payments surpassed more than $4.5 billion in total reported payments over the past decade, underscoring the sustained economic toll of cyber extortion. At the same time, the average payout of a single ransomware attack continues to climb across regions ([Fig 3](#fig-3)).
...
- **Italy** €8,290,000
- **Germany** €8,700,000
- **Australia** $15,390,000

These figures reflect a broader shift in attacker behavior. Ransomware is no longer deployed in isolation, but as part of multi-stage campaigns designed to maximize disruption and payout. Organizations report a wide range of offensive techniques regularly bypassing security tools ([Fig 4](#fig-4)), from phishing to the exploitation of misconfigured cloud environments.

### Fig 4. Offensive techniques regularly bypassing security tools
- **Phishing and Spear-Phishing Attacks**: 32%
- **Credential Theft and Abuse (e.g., brute force, password spraying)**: 27%
- **Advanced Ransomware Variants**: 27%
- **Exploitation of Misconfigured Cloud or Hybrid Environments**: 24%
- **Use of Encrypted Communication Channels to Evade Eetection**: 24%
- **IoT/OT-Specific Attacks Targeting Nontraditional Endpoints**: 23%
- **Supply Chain Attacks via Third-Party Integrations**: 22%
- **Malicious Insider Actions**: 21%
- **Zero-Day Vulnerabilities**: 21%
- **Remote Desktop Protocol (RDP) Exploitation**: 20%
- **Lateral Movement Within the Network After Initial Compromise**: 20%
- **Adversary-in-The-Middle (AiTM) Techniques**: 15%
- **I Do Not See Any Offensive Techniques Regularly Bypassing Security Tools**: 11%
- **Slopsquatting**: 8%
...
### UNITED STATES
- **92%** of IT decision makers in the U.S. are concerned about the impact of cyberwarfare on their organization as a whole.
- U.S. respondents (**83%**) were most likely to agree with the statement: “My organization has allocated sufficient budget for cybersecurity programs, including people and processes.” Yet, 61% say their organization’s average ransomware payout exceeds its annual cybersecurity budget.
- **61%** of respondents from the U.S. – the most of respondents from any country surveyed for this report – said their organization was previously hacked and they’ve not yet managed to secure their ecosystem adequately.

### UNITED STATES FEDERAL
- **81%** of respondents working for the U.S. Federal government believe their agency is prepared to handle a cyberwarfare attack and respond to related threats.
- Yet over half (**57%**) say their agency was hacked previously and they’ve not managed to secure their ecosystem adequately.
- **77%** agree the misuse of emerging technologies will increase the likelihood of collateral damage to civilian infrastructure in times of cyber conflict.

### UNITED KINGDOM
- **81%** of respondents from the UK are confident in their organizations’ ability to detect and respond to coordinated cyberattacks.
- Yet, **66%** have experienced 1-2 cybersecurity breaches, with 39% saying their organization has not yet managed to secure their ecosystem adequately following these attacks.
- Additionally, IT decison makers in the UK (**54%**) are the second most likely of respondents from any country to say the cyberwarfare threat is imminent, sharing they have already had to report an act of cyberwarfare to authorities.

### FRANCE
- **80%** of respondents from France think geopolitical tensions globally have created a greater threat of cyberwarfare.
- **40%** of French respondents say they experienced more threat activity in the second half of 2025 when compared to the first half of the year. Another 45% say they’ve experienced a consistent level of threat activity.
- **41%** of French organizations respond reactively to a significant cyberattack, either as it occurs (24%) or after it as already occurred (17%).

### GERMANY
- Respondents from Germany (**57%**) are least likely to believe that nation-states would target their organization.
- **68%** of respondents say their organization is prepared to handle a cyberwarfare attack and respond to related threats. However, 44% of German businesses that were hacked previously have still not managed to secure their ecosystem adequately.
- **46%** of IT professionals in Germany said “no” when asked if their own government can defend its citizens and enterprises against an act of cyberwarfare.

### ITALY
- **78%** of Italian IT decision makers are concerned about the impact of cyberwarfare on their organization as a whole.
- **54%** of IT professionals say the complex regulatory ecosystem has overwhelmed their security team.
- Only **38%** of respondents from Italy are confident that their government can defend its citizens and enteprises against an act of cyberwarfare.
...
- **71%** of European IT professionals believe the cyber capabilities of nation-state actors have the potential to instigate a full-scale cyberwar that could cripple critical infrastructure worldwide.

### AUSTRALIA
- **95%** of IT decision makers in Australia are concerned about the impact of cyberwarfare on their organization as a whole, the most of any country surveyed.
- Respondents from Australia (**72%**) are the most likely to say the cyberwarfare threat is imminent; sharing they have already had to report an act of cyberwarfare to authorities.
- Australian respondents (**84%**) were the most likely to say their organization has evolved its cyberwarfare readiness posture over the past three years to strengthen defenses against nation-states.
...
The risks don’t stop with AI. Sixty-nine percent of IT decision makers believe a large-scale quantum computing attack could render their most sensitive encrypted data readable by a hostile state actor within the next decade. A quarter (24%) already fear quantum computing to be the greatest future existential risk if weaponized ([Fig 5](#fig-5)). But waiting for these capabilities to fully mature before acting is a dangerous assumption.
...
- **Autonomous AI-Driven Cyber Agents**: 33%
- **Quantum Computing (breaking encryption)**: 24%
- **Large-Scale Deepfake and Disinformation Campaigns**: 20%
- **Exploitation of 5G/IoT for Cyber-Physical Destruction**: 16%
- **No Emerging Technology in Particular**: 6%
...
- **Using Multi-Factor Authentication**: 54%
- **Enforcing Strong Password Policies**: 50%
- **Implementing Advanced Security Awareness Training**: 50%
- **Deploying AI-Powered Security Tools**: 49%
- **Automating and Centralizing Protection for All Assets, Managed and Unmanaged**: 41%
- **Remediating Vulnerabilities in Advance of an Attack**: 39%
- **Limiting User Privileges**: 37%
- **Retaliating Directly Against Adversaries**: 18%
- **My Organization/Agency Is Not Addressing This**: 2%

A year-on-year comparison shows many challenges have not been resolved, only normalized ([Fig 7](#fig-7)). Issues such as cloud security limitations, threat prioritization and alert overload continue to affect around one in five organizations. More strikingly, one in ten (13%) of organizations still believe they have no security operational gaps at all, a level of confidence that sits uneasily alongside the scale and complexity of emerging threats.

### Fig 7. What gaps do your security operations have, if any?
- **Challenges in Securing Remote or Hybrid Work Environments**: 24%
- **Insufficient Budget to Fully Scale Cybersecurity Operations**: 22%
- **Lack of Full Asset Visibility Across IT, OT, IoT, or IoMT**: 21%
- **Difficulty Identifying and Managing Shadow IT or Ephemeral Assets**: 21%
- **Inadequate Threat Intelligence to Identify and Prioritize Risks Effectively**: 21%
- **Difficulty Supporting End-of-Life/End-of-Support and/or Legacy Technology**: 21%
- **Limited Ability to Secure Cloud Environments**: 20%
- **Struggle with Prioritizing Threats and Vulnerabilities in Our Asset Inventory**: 19%
- **Overwhelmed by the Volume of Alerts**: 19%
- **Inability to Detect and Respond to Insider Threats**: 18%
- **Difficulty in Maintaining Compliance with Industry Regulations**: 18%
- **Lack of Endpoint Detection and Response Capabilities**: 17%
- **Lack of Continuous Vulnerability Assessment and or CTEM**: 17%
- **Unmanaged and/or Rogue Devices**: 16%
- **Our Security Operations Do Not Have Any Gaps**: 13%
...
## 06. ANALYZING THE COMPRESSED EVOLUTION OF CYBERWARFARE
