...
- [The Confidence Gap](#the-confidence-gap)
- [AI Adoption Outpaces Risk Visibility](#ai-adoption-outpaces-risk-visibility)
- [Policy Alone Doesn’t Reduce Risk](#policy-alone-doesnt-reduce-risk)
- [Who Owns AI Governance?](#who-owns-ai-governance)
- [How Executive Alignment Impacts Recovery Success](#how-executive-alignment-impacts-recovery-success)
- [Four Practices Linked to Stronger Recovery](#four-practices-linked-to-stronger-recovery)
- [Investment in Cybersecurity is Increasing but not Universally](#investment-in-cybersecurity-is-increasing-but-not-universally)
- [Where Investment Turns Into Capability](#where-investment-turns-into-capability)
- [Cyber Investment and Recovery Performance](#cyber-investment-and-recovery-performance)
- [Compliance as a Resilience Driver](#compliance-as-a-resilience-driver)
- [Measured Resilience, Trusted Data](#measured-resilience-trusted-data)
...
- **90%** reported being very to extremely confident in meeting RTOs.
- **69%** say their RTOs are fully aligned with business continuity goals.
...
- **42%** reported customer or constituent service disruption.
- **41%** reported financial loss or revenue impact.
- **38%** experienced extended downtime of critical systems.
...
- **43%** of respondents say AI tool adoption is outpacing their ability to secure data and models.
- **42%** say they have limited visibility into all the AI tools or models used across the organization.
- **40%** say security policies haven’t yet been updated to include AI-specific risks, such as the use of generative AI.
...
- **Limited visibility into AI tools and models:** 39% (With DLP) vs 45% (Without DLP)
...
- **38%** said AI and data risk governance was owned by the CISO.
- **27%** said it was owned by the CIO.
- **17%** reported a cross-functional governance structure.
...
The survey suggests that investment aligns with more structured AI governance. Organizations that increased their data resilience budget were more likely to report having a formal AI risk management or data governance policy in place (roughly two-thirds) compared with those that did not increase budget (27%). They were also more likely to report model validation, testing, and drift monitoring (43% vs. 26%).
...
Among respondents who did not experience a cybersecurity incident, 56% reported cyber risk to the board monthly or more frequently, compared with 50% of respondents who experienced an incident.

> "At a recent tabletop exercise, the board was there at the tail end, and they had a lot of questions. One stood out: ‘Wait, we don’t have the ability to recover?’ At the time, we didn’t. We had some archaic backup capabilities. That is why we just recently invested in a very immutable infrastructure that we could recover from." — *Fortune 1,000 Company*

> "We communicate our cybersecurity KPIs to the board of directors in every board meeting, and they are communicated to executives weekly, monthly, and quarterly. It’s part of running our operations. We need to be very clear and concise about what represents a significant risk, though, because we don’t want to steal time or energy from the board of directors and the executives to do their primary jobs." — *Hospitality/FinTech Conglomerate*

### 4) Track KPIs That Matter Most to Insurers and Business Leaders
Cyber insurers and business leaders increasingly ask for evidence of recovery readiness that often goes beyond attestations, using measurable KPIs tied to response and recovery performance.
...
Organizations with budget increases are more likely to track recovery readiness KPIs that make gaps visible and support better prioritization.

**KPIs Used to Measure Recovery Readiness from Cyber Incidents:**
- **Recovery time objectives (RTOs):** 78% (Budget increased) vs 47% (Budget not increased)
- **Time to isolate or contain incidents:** 56% (Budget increased) vs 36% (Budget not increased)
- **Percent of recovery processes fully automated / orchestrated:** 32% (Budget increased) vs 14% (Budget not increased)
...
- **Immutable storage:** 38% (Budget increased) vs 42% (Budget not increased)
- **Automated backup:** 16% (Budget increased) vs 11% (Budget not increased)
- **Integrated cyber resilience and business continuity planning:** 33% (Budget increased) vs 9% (Budget not increased)

## Cyber Investment and Recovery Performance

Budget increases correlate with stronger ransomware recovery outcomes:

- **Lower ransom payments:** Only 33% of organizations with increased budgets paid a ransom, compared with 52% of those without increases.
- **Higher recovery success:** 40% fully recovered affected data, versus 16% among organizations without budget growth.
