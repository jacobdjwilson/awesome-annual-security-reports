...
## Table of Contents
- [Connecting 2025’s Dots to Forecast the Year Ahead](#connecting-2025s-dots-to-forecast-the-year-ahead)
- [The Industrialization of Cybercrime Will Further Commoditize Plug-and-Play Identity Attacks](#the-industrialization-of-cybercrime-will-further-commoditize-plug-and-play-identity-attacks)
- [The Threat Actor Community Will Keep Splitting and Shifting Due to Youth Involvement, Platform Migrations, and Global Threat Expansion](#the-threat-actor-community-will-keep-splitting-and-shifting-due-to-youth-involvement-platform-migrations-and-global-threat-expansion)
- [Identity (And Non-Human Identity) Sprawl Will Be Tough to Wrangle In](#identity-and-non-human-identity-sprawl-will-be-tough-to-wrangle-in)
- [Insider Threats Will Become Mainstream](#insider-threats-will-become-mainstream)
- [AI-Enabled Cybercrime & The AI Arms Race Will Play Out – For Bad or Good](#ai-enabled-cybercrime--the-ai-arms-race-will-play-out--for-bad-or-good)
- [Attackers Will Continue to Innovate to Bypass Defenses](#attackers-will-continue-to-innovate-to-bypass-defenses)
- [Pathways to Supply Chain Compromise Will Multiply](#pathways-to-supply-chain-compromise-will-multiply)
- [Synthetic Identity Fraud Will Gain More Momentum Using Stolen Data and AI](#synthetic-identity-fraud-will-gain-more-momentum-using-stolen-data-and-ai)
...
New capabilities especially in “malware-as-a-service” (MaaS) and “phishing-as-a-service” (PHaaS) kits are making it easy for bad actors to scale, and it’s a complex, crowded space poised to keep growing.

Popular infostealer malware like LummaC2 and its collaboration with the GhostSocks residential proxy led the charge in 2025, and a plethora of other packaged offerings, from crypting services, to install brokers and plug-and-play panels, are fueling criminal operations.
...
AI usage in day-to-day work has also created a unique new vulnerability that will require security teams to keep org-wide AI use under a telescope.
