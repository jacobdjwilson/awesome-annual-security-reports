...
| 1.5   References               |     | 4   |
| 2  NTN Use-cases               |     | 6   |
| 2.1       Satellite to Ground  |     | 7   |
7
2.1.1         Satellite Connections as Transport Network
2.1.2        Satellite Connections as Transport Network for LTE Backhaul  10
| 2.2.1        Direct-to-Phone                            |                      | 10  |
| ------------------------------------------------------- | -------------------- | --- |
| 2.2.2        Satellite IoT Connection                   |                      | 11  |
| 3  System Context                                       |                      | 12  |
| 3.1       Sensitive Data Discovery                      |                      | 14  |
| 3.2       Cryptographic Inventory                       |                      | 15  |
| 3.3       Migration Strategy Analysis and Dependencies  |                      | 16  |
| 3.4       Stakeholders                                  |                      | 16  |
| 3.5       PKI Implications                              |                      | 17  |
| 3.6       Legacy Impact                                 |                      | 18  |
| 3.7       Potential Actions / Dependencies              |                      | 18  |
| 3.8       Dependencies                                  |                      | 19  |
| 3.8.1        Standards                                  |                      | 19  |
| 3.8.2        National Guidelines                        |                      | 19  |
| 3.8.3        Vendors                                    |                      | 19  |
| 3.8.4        3rd-parties                                |                      | 20  |
| 3.8.5        Performance                                |                      | 20  |
| 3.9       Gantt Chart for PQC Migration                 |                      | 22  |
| 3.10    PQC Migration Process Description               |                      | 22  |
| 3.11    Synergy with Internal Programs                  |                      | 23  |
| 3.12    Synergy with External Programs                  |                      | 23  |
...
Official Document Post Quantum Cryptography for Non-Terrestrial Networks
1 Introduction
As the telecommunications landscape expands beyond traditional ground-based
...
ISSLs Inter Satellite Laser Links
LEO Low Earth Orbit
LI Lawful Intercept
...
PQ.01
| 02  |     | Whitepaper, Version 1.0, 17 Feb 2023  |     |     |     |     |
| --- | --- | ------------------------------------- | --- | --- | --- | --- |
GSMA PQ.03 – Post Quantum Cryptography – Guidelines for
|     |  PQ.03  | Telecom Use Cases, Version 2, Sept 2024  |     |     |     |     |
| --- | ------- | ---------------------------------------- | --- | --- | --- | --- |
03
...
|     |     | 2022.  Consultative  |     |     | Committee  | for  | Space  | Data  | Systems,  |     |
| --- | --- | -------------------- | --- | --- | ---------- | ---- | ------ | ----- | --------- | --- |
 350.1-G-3
|  05  |     | Washington DC  |     |     |     |     |     |     |     |     |
| ---- | --- | -------------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | -------------- | ------ | --- | ---------- | ------- | --- | ----- | --------- | --- |
 357.1-O-1  2024. Consultative Committee for Space Data Systems, Washington
|  06  |     | DC  |     |     |     |     |     |     |     |     |
| ---- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
|     |  355.0-B-2  | Committee for Space Data Systems, Washington DC  |     |     |     |     |     |     |     |     |
| --- | ----------- | ------------------------------------------------ | --- | --- | --- | --- | --- | --- | --- | --- |
...
10   Solutions  for  NR  to  support  non-terrestrial  neworks  (NTN),
 TR 38.821
Release 16
|     |  TR 22.865  | Study on satellite access Phase 3, Release 19   |     |     |     |     |     |     |     |     |
| --- | ----------- | ----------------------------------------------- | --- | --- | --- | --- | --- | --- | --- | --- |
11
| 12  | TR 33.938  | 3GPP Cryptographic Inventory  |     |      |                 |     |          |     |     |      |
| --- | ---------- | ----------------------------- | --- | ---- | --------------- | --- | -------- | --- | --- | ---- |
|     |            | Recommendation                |     | for  | Key-Derivation  |     | Methods  |     | in  | Key- |
13
SP800-56C
Establishment Schemes
14  S.  Plastras,  D.  Tsoumatidis,  D.N.  Skoutas,  A.  Rouskas,  G.
...
15  Lee, J. Kim, "Survey on Security for Non-Terrestrial Networks",
...
| 16    |     | GSMA PQC Government Guidelines  |     |     |     |     |     |     |               |     |
| ----- | --- | ------------------------------- | --- | --- | --- | --- | --- | --- | ------------- | --- |
| V1.0  |     |                                 |     |     |     |     |     |     | Page 5 of 24  |     |
...
17 Latency in Communications Networks, EMEA Satellite Operators
...
18 Insights into Low Earth Orbit Satellite Communication Dynamics:
doi.org/10.1109/I Quality of Service Analysis of Connection Behavior, Latency, and
CEIB61477.2024 Doppler Shift,
.10602698 Zoltan Gal et. al.
https://ieeexplore.ieee.org/document/10602698 (Accessed 2025-
09-30)
19 Security Engineering, Third Edition 2020, Ross Anderson.
ISBN: 978-1-119-64278-7
20
3GPP 33.703. Title: Study on transitioning to Post Quantum
33.703 Cryptography (PQC) in 3GPP (draft)
Table 2: References
2 NTN Use-cases
...
Transparent  m ode
|     | U E |           | N TN  gatew ay + gNB |     |      |
| --- | --- | --------- | -------------------- | --- | ---- |
|     |     | Satellite | (ground netw ork)    |     | AM F |
(IoT Device)
N orm al or default
|     | U u interface |     |     | N G | Satellite operation |
| --- | ------------- | --- | --- | --- | ------------------- |
(end to end
connectivity)
...
Satellite operation
(no end to end
|     | Step A: Service Link | W ithout active  |     |     | connectivity) |
| --- | -------------------- | ---------------- | --- | --- | ------------- |
feeder link
|     |     | W ithout active                  |     |     |     |
| --- | --- | -------------------------------- | --- | --- | --- |
|     |     | service link Step B: Feeder Link |     |     |     |
...
|     |              |     |               | Regenerative m | ode          |           |     |      |     |
| --- | ------------ | --- | ------------- | -------------- | ------------ | --------- | --- | ---- | --- |
|     | U            | E   | Satellite  +  |                | N TN         |  gatew ay |     | AM F |     |
|     | (IoT Device) |     |               | gNB            | (ground netw | ork)      |     |      |     |
N orm al or default
Satellite operation
(end to end
|     |     | U u interface |     |             |     | N G |     | connectivity) |            |
| --- | --- | ------------- | --- | ----------- | --- | --- | --- | ------------- | ---------- |
|     |     | Service Link  |     | Feeder Link |     |     |     |               |            |
|     |     |               |     |             |     |     |     | Store &       |  Forw ard  |
Satellite operation
(no end to end
W ithout active
|     |     | Step A: Service Link |                  | feeder link         |     |     |     | connectivity) |     |
| --- | --- | -------------------- | ---------------- | ------------------- | --- | --- | --- | ------------- | --- |
|     |     |                      | W ithout active  | Step B: Feeder Link |     |     |     |               |     |
service link

Figure 3: Non-terrestrial network typical scenario based on regenerative payload

R egen erative m o de
| U E          |     | Satellite A |     | Satellite B |      |     | N TN  gatew ay    |     | A M F |
| ------------ | --- | ----------- | --- | ----------- | ---- | --- | ----------------- | --- | ----- |
| (IoT Device) |     | +  gN       | B   | +           | gN B |     | (grou nd  n etw o | rk) |       |
N o rm al o r default
Satellite o peratio n
(end  to end
|     | U u  interface |     |                      |     |     |               | N G |     | con nectivity) |
| --- | -------------- | --- | -------------------- | --- | --- | ------------- | --- | --- | -------------- |
|     | Service Link   |     | Inter Satellite Link |     |     | Feed er Lin k |     |     |                |
Store &  Fo rw ard
Satellite o peratio n
(no  en d to  end
|     |                      |     | W ith ou t active  |     |     |     |     |     |                |
| --- | -------------------- | --- | ------------------ | --- | --- | --- | --- | --- | -------------- |
|     | Step A : Service Lin | k   |                    |     |     |     |     |     | con nectivity) |
feeder link
W ith ou t active
Step B: Feeder Link
|     |     |     |     | service lin k |     |     |     |     |     |
...
IMSI International Mobile Subscriber Identity; uniquely
identifies a user in the network.
Session Encryption Keys Keys used for air interface encryption and
authentication.
Long Term Keys USIM Key K (for instance)
Location Information Real-time location data of the user or terminal.
User Data User-generated or transmitted data, such as voice,
SMS, or internet packets.
Control Plane/Network Signalling Signalling traffic between UE and Core includes
identity, auth, registration details
Session Metadata Information about session duration, start and end
times, and associated services.
Management Plane Sensitive Data Information about Admin users, passwords, keys, PAM
tokens, remote management protocols traffic.
Telemetry Data Information collected by the sensors
Interconnect & Roaming Sensitive Data Information that exchanged cross trust boundaries such
as IPX/GRX transport security data, 5G Roaming
Interconnect (SEPP / N32 traffic).
Satellite signing keys Firmware signing key(s) for payload updates
V1.0 Page 14 of 24

| GSM Association  |     |     | Non-confidential  |
| ---------------- | --- | --- | ----------------- |
Official Document Post Quantum Cryptography for Non-Terrestrial Networks
Command up-link data  Satellite command and control from Satellite Operatons
Centre
Command up-link keys  Keys for satellite command and control authenticaiton
and encryption
Satellite payload updates  Signed firmware from Satellite Operations Centre
...
Algorithm/Protocol  Usage Context  Security Features  Type of
Cryptography
AES-128  Satellite-to-ground link  Confidentiality and  Symmetric
Integrity Protection
IPSEC ESP  gNB/ng-eNB to MNO  Confidentiality and  Symmetric
|          | Security Gateway    | Integrity Protection   |              |
| -------- | ------------------- | ---------------------- | ------------ |
| IKEv2    | AuthN and IPsec SA  | Confidentiality and    | Symmetric    |
|          | setup               | Integrity Protection   |              |
|          |                     | Digital Signature and  | Asymmetric,  |
|          |                     | Key Agreement          | Symmetric    |
| SHA-256  | Key-Derivation      | Hash/Digest            | Symmetric    |
Computation
| HMAC-SHA-256  | Keyed Hashing     | Key Derivation       | Symmetric    |
| ------------- | ----------------- | -------------------- | ------------ |
| TLS 1.3       | Management plane  | Encryption, session  | Symmetric    |
|               | communication     | security,            |              |
|               |                   | digital signature    | Asymmetric   |
| EAP-TLS       | M-plane           | Key Agreement        | Asymmetric,  |
Symmetric
...
Standardization PQC algorithm standardization (e.g., Migration options include:
Timelines NIST PQC) and protocol
standardization (e.g., IETF) • Interim use of hybrid
cryptographic schemes
• Pure PQC schemes
Hardware Existing satellites lack support for Incremental hardware upgrades or
Compatibility resource-intensive PQC algorithms optimizations
Regulatory Alignment with international and Early engagement with regulatory
Compliance local cryptographic regulations bodies
Supply Chain Lack of PQC modules from OEMs Develop joint roadmaps with suppliers
Readiness
...
PQ
AES/SHA(2/3)
Security PQC Algorithm
hardness
Level
AES-128 (exhaustive ML-KEM-512, FN-DSA-512, SLH-DSA-
1
key recovery) SHA2/SHAKE-128f/s
SHA-256/SHA3-256
2 ML-DSA-44
(collision search)
AES-192 (exhaustive ML-KEM-768, ML-DSA-65, SLH-DSA-
3
key recovery) SHA2/SHAKE-192f/s
V1.0 Page 17 of 24

GSM Association Non-confidential
Official Document Post Quantum Cryptography for Non-Terrestrial Networks
SHA-384/SHA3-384
4 No algorithm tested at this level
(collision search)
AES-256 (exhaustive ML-KEM-1024, FN-DSA-1024, ML-DSA-87, SLH-
5
key recovery) DSA-SHA2/SHAKE-256f/s
...
compatibility and minimizes disruptions during the transition. Additionally, resource
...
Safe Cryptography (QSC) group provides guidelines for the implementation and
...
transition process.
Vendor Role Dependency Proposed Solution
Hardware Availability of PQC-compatible chips Collaborate with chip manufacturers
Development and accelerators. for early development.
Protocol Adapting security protocols (e.g., Develop protocol extensions for
Implementation IPSEC, TLS) to support PQC. seamless integration.
Supply Chain Timely delivery of certified Establish partnerships to secure
cryptographic modules. supply chains.
Certification Alignment with emerging PQC Participate in standardization, testing
and Testing standards from NIST and ETSI. and certification programs.
...
Performance Impact Proposed Solution
Metric
Latency Increased delay in control and user Use latency-efficient PQC algorithms.
plane communications.
Computational Higher processing requirements on Deploy hardware accelerators (e.g.,
Load satellites and ground stations. FPGA, ASIC).
Bandwidth Increased bandwidth usage due to Optimize transmission protocols and
Utilization larger key sizes. compression.
Power Higher energy demands for Optimize power management and
Consumption cryptographic operations. implement efficient hardware.
Memory Larger keys/certificates + crypto Minimize on-space cryptographic
Consumption libraries increase memory use, risky in stack; gateway termination; implement
embedded environments compact certificate chains; remove
unused algorithms.
...
| Version  | Date          | Approval Authority  | Editor / Company  |
| -------- | ------------- | ------------------- | ----------------- |
| 1.0      | 04  February  | PQTN/TF             | PQTN TF           |
2026

Other Information
| Type              |     | Description         |     |
| ----------------- | --- | ------------------- | --- |
| Document Owner    |     | GSMA PQTN           |     |
