...
- **2026 is the Era of Agentic-Based Cyberattacks**: Flashpoint identified a 1,500% rise in AI-related illicit discussions between November and December 2025. These systems scrape data, adjust messaging, rotate infrastructure, and learn from failed attempts without human involvement.
- **Identity is the New Exploit**: Flashpoint observed over 11.1 million machines infected with infostealers in 2025, fueling a massive inventory of 3.3 billion stolen credentials and cloud tokens.
- **The Patching Window is Rapidly Closing**: Vulnerability disclosures surged by 12% in 2025, with 1 in 3 (33%) vulnerabilities having publicly available exploit code.
- **Ransomware is Hacking the Person, Not the Code**: As technical defenses harden, ransomware groups are pivoting to human trust, leading to a 53% increase in ransomware, with RaaS groups responsible for over 87% of all attacks.

---

## 2026 Threat Landscapes: Artificial Intelligence (AI)
![Flashpoint AI collections coverage chart]

## AI Threats Overview: Data and Insights
Artificial Intelligence (AI) is acting as a force multiplier. Flashpoint identified over 1.5 billion illicit discussions and criminal activities centered around AI in 2025.

### Common Threat Actor Use Cases of Malicious AI
- **Jailbreaking**: Bypassing AI safety nets.
- **Vishing**: Impersonating IT/security teams using deepfakes.
- **Slopsquatting**: Creating fake software packages to trick AI coding assistants.
- **AI Sidebar Spoofing**: Tricking users into navigating to malicious sites.
- **Prompt Injection**: Tricking AI assistants into following hidden commands.
- **Steganographic Prompting**: Hiding secret instructions inside an AI model.

---

## The Rising Danger of Agentic AI
AI threats are moving beyond one-off generative tasks toward building systems that automate the entire attack chain. This lowers the cost of experimentation for attackers, allowing them to iterate until they find a successful foothold.
...
2. **Adversaries are weaponizing organizational AI workflows and APIs.**
...
![Infostealer monitoring data visualization]

## Infostealer Overview: Data and Insights
Between January 1 and December 31, 2025, Flashpoint observed over 11.1M machines infected with infostealers, resulting in over 3.3B stolen credentials.
...
1. **Harvesting**: Draining credentials and cookies.
2. **Ingestion**: Feeding logs into agentic AI.
3. **Automated Testing**: Testing credentials against SaaS/VPNs.
4. **Monetization/Escalation**: Identifying successful logins for fraud.

---

## Vidar Takes Center Stage Post-Lumma Takedown
Following the May 2025 takedown of Lumma, Vidar 2.0 has emerged as the most utilized infostealer as of January 2026.

---

## Defending Against Infostealers in 2026
Flashpoint transforms raw logs into actionable intelligence through:
1. **Source Ingestion**
...
3. **Vidar 2.0 rapidly dominates the infostealer market.**

### Threat Posture Assessment
- Am I relying on generic feeds for infostealer intelligence?
- Is my threat intelligence data allowing me to actively monitor for potential compromises?
...
![Vulnerability intelligence coverage chart]

## Vulnerability Overview: Data and Insights
Flashpoint recorded 44,509 vulnerabilities in 2025, with 14,593 having publicly available exploits.

---

## Vulnerability Exploitation: Targeting High-Value Infrastructure
The zero-day to exploit window has effectively vanished. Notable vulnerabilities include:
...
Adversaries are targeting the modern development and AI pipeline. Critical vulnerabilities impacting AI include:
- **Langflow** (CVE-2025-66478)
- **Claude Code Yarn Plugin** (CVE-2025-59828)
- **Kilo Code AI Agent Extension** (CVE-2025-11445)
...
- Is my organization auditing the security of any agentic AI dependencies?
- What is my organization’s response if public vulnerability intelligence remains volatile?

---

## 2025 Threat Landscape: Ransomware
Flashpoint observed a 53% year-over-year increase in ransomware attacks. RaaS groups were responsible for over 87% of all attacks.

---

## Ransomware Overview: Data and Insights
- **Total Ransomware Attacks (2025)**: 8,835
- **Top Targeted Industry**: Manufacturing (1,564)
- **Top Affected Country**: United States

---

## Shift in Ransomware Tactics: The Identity and Human Frontier
Ransomware groups are moving away from technical encryption toward pure-play extortion, targeting human trust and identity via social engineering.

---

## Shift in Ransomware Tactics: Increasing Reliance on Insider Threats
In 2025, Flashpoint observed 91,321 instances of insider recruiting and illicit activity.

---

## Defending Against Ransomware in 2026
Organizations must implement a robust ransomware workflow including continuous monitoring for compromised credentials and potential malicious insiders.
...
### Threat Posture Evaluation
- Have we expanded our defense beyond “encryption protection”?
- How are we monitoring for signs of insider recruiting?
- Is our Help Desk a hardened security gate?

---

## The Flashpoint Advantage: Driving Mission-Critical Outcomes
Flashpoint Ignite provides a holistic view of risk by gathering data from open and difficult-to-access online spaces.

### Core Packages
- **Flashpoint Cyber Threat Intelligence (CTI)**
- **Flashpoint for Vulnerability Management (VulnDB®)**
...
Three key imperatives for 2026:
1. **Prioritize Context Over Volume**
2. **Harden the Human and Machine Identity Layer**
3. **Build Resilience Against Systemic Intelligence Failures**
