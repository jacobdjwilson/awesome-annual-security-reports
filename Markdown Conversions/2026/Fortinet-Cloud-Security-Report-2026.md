...
The survey confirms this reality. Eighty-eight percent of organizations now operate across hybrid or multi-cloud environments (up from 82% last year). Of these, 81% rely on two or more cloud providers to run critical workloads (up from 78% last year), while 29% report using more than three.

![Chart: Hybrid and Multi-Cloud Architectures Are Now the Norm. Shows 88% operate across hybrid/multi-cloud, 81% rely on two or more providers, and breakdown of cloud usage counts.]

As cloud environments grow, the attack surface expands proportionally. Every new provider, service, or identity adds configurations, permissions, and data paths. This multi-cloud reality creates structural complexity across clouds, networks, and applications.

## The Fragmenting Attack Surface
As cloud environments scale, the attack surface does more than expand - it fragments. Fragmentation has become the most significant operational barrier to effective cloud security. Sixty-nine percent of organizations cite tool sprawl and visibility gaps as the top factor limiting cloud security effectiveness.

![Chart: Cloud Complexity Has Outpaced Detection Confidence. Shows top challenges including Tool & Visibility (69%), Governance (64%), Data & Identity (61%), and Runtime & Detection (56%). Also shows confidence levels in real-time detection.]

## The Budget-Maturity Gap
Cloud security investment continues to grow, yet maturity has not advanced at the same pace. The survey shows that 62% of organizations expect their cloud security budgets to increase over the next 12 months; on average, cloud security now accounts for 34% of total IT security spending.

However, 59% of organizations still rate their cloud security posture at initial or developing stages—the two lowest tiers on a five-stage scale. Each new tool adds complexity, including integration work and console management, often absorbing budget into operational tax rather than measurable security outcomes.

## Complexity Outpaces Talent
The effects of operational complexity are compounded by a persistent shortage of skilled cybersecurity professionals. The survey reveals that 74% of organizations report an active shortage of cybersecurity talent, and 77% express high concern about the industry-wide skills gap.

![Chart: Cybersecurity Talent Shortages Are a Persistent Constraint. Shows 74% report a shortage and 77% express high concern regarding the skills gap.]

## Where Cloud Risk Concentrates
Cloud security risk is concentrated in a small number of recurring areas. Identity and access security ranks as the top cloud-native concern (77%), followed closely by misconfigured cloud services (70%) and data exposure risks (66%).

![Chart: Key Cloud Security Concerns. Shows percentages for Identity & Access (77%), Configuration & Posture (70%), Data Exposure & Privacy (66%), Workload & Runtime (59%), Third-Party & Supply-Chain (51%), AI & Emerging Tech (45%), and Insider & Targeted Threats (43%).]

## The Risk Exposure Chain
A breach rarely begins and ends with a single vulnerability—attackers follow paths: a misconfiguration exposes a resource, a compromised or overprivileged identity enables access, and sensitive data becomes the target. Most organizations manage these domains independently, meaning attack paths often become visible only in hindsight.

![Chart: Cloud Security Exposure Patterns. Shows reported incidents in the past 12 months: Identity & Access (69%), Configuration & Posture (65%), Data Exposure & Privacy (54%), Workload & Runtime (42%), Third-Party & Supply-Chain (36%), Insider & Targeted Threats (31%), and AI & Emerging Tech (20%).]

## The Security Automation Gap
Most organizations have introduced automation into their cloud security workflows, but the survey reveals a critical gap between alerting and action. Thirty-seven percent describe their automation as largely alert-focused, while only 11% report autonomous remediation capabilities.

![Chart: Cloud Security Automation Is Mostly Alert-Driven. Shows 42% No automation, 37% Basic AI-assisted, 11% Fully autonomous, and 10% Other.]

## The AI Arms Race: Why Speed is the New Perimeter
The automation gap is widening as adversaries accelerate. Thirty-two percent report that their AI adoption is limited to pilot efforts; only 18% describe AI-driven detection as fully operational. Attackers, however, use AI to scan for misconfigurations and map permission paths at machine speed.

![Chart: AI-Driven Cloud Threat Detection Remains Early-Stage. Shows 15% None, 32% Pilot, 35% Partial, and 18% Fully operational.]

## Platform Shift – the Case for Consolidation
The survey reveals a clear shift away from function-specific point tools toward unified security ecosystems. Nearly two-thirds (64%) of organizations say they would choose a single-vendor platform that unifies network, cloud, and application security if starting fresh today.

![Chart: The Shift to Unified Security Architectures. Shows 64% prefer a single-vendor platform, 27% prefer best-of-breed, and 9% are unsure.]

## Beyond the Silos: The Unified Security Fabric
When evaluating cloud security platforms, buyers prioritize coverage and depth across cloud environments (79%), integration and orchestration across security domains (72%), and automation and compliance capabilities (68%).

![Chart: Unified Security Priorities. Shows importance of Coverage & Depth (79%), Integration & Orchestration (72%), Automation & Compliance (68%), Ease & Agility (60%), and Cost & Vendor Confidence (49%).]

## A Blueprint for Convergence: From Fragmented to Unified
Organizations are defining cloud security success by outcomes: 81% prioritize security outcomes (fewer misconfigurations/reduced permissions), 76% emphasize operational efficiency, 66% highlight integration/automation, and 62% identify continuous compliance as a core requirement.

![Chart: Security Outcomes and Operational Efficiency Define Success. Shows the percentage of organizations prioritizing specific outcomes for CNAPP usage.]
...
The 2026 Cloud Security Report is based on a survey of 1,163 IT and cybersecurity professionals conducted in late 2025. The respondents represent a broad spectrum of industries (Technology, Financial Services, Healthcare, Government, etc.) and organizational sizes, ranging from mid-market to large enterprises.

- **Career Level**: Includes Managers, Directors, Specialists, Consultants, VPs, and C-level executives (CTO, CIO, CISO, etc.).
- **Department**: Primarily IT Security (32%) and IT Operations (29%).
