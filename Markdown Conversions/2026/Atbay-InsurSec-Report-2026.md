# InsurSec-Report 2026

## Table of Contents
- [Introduction](#introduction)
- [Key Findings](#key-findings)
- [Chapter 1: The Cyber Threat Landscape](#chapter-1-the-cyber-threat-landscape)
- [Chapter 2: Ransomware](#chapter-2-ransomware)
- [Chapter 3: Financial Fraud](#chapter-3-financial-fraud)
- [Chapter 4: Third-Party Liability](#chapter-4-third-party-liability)
- [Chapter 5: What the Data Tells Us](#chapter-5-what-the-data-tells-us)
...
## Key Findings
- **Claim frequency increased 7% YoY.** The gains were driven in large part by increases in third-party liability claims, while ransomware and financial fraud remained stable YoY.
...
- **Email continued to be the most popular entry vector for attackers.** 52% of all claims began with an email attack.
- **Remote access continued to be associated with the highest severity ($433K on average).**
...
- **Insureds’ vendors and customers accounted for 14% of all claims.** Severity for these claims was $145K on average, a troubling amount considering that the losses occurred without insureds suffering a security failure in their own environments.
- **Third-party liability saw the highest jump of any incident type**, increasing 70% YoY. This category includes claims related to the California Invasion of Privacy Act (CIPA) and class action lawsuits, driven by an increasingly aggressive plaintiffs’ bar.

---

## Chapter 1: The Cyber Threat Landscape
![Chart showing overall claim frequency increased 7% in 2025]
![Chart showing average severity climbed to all-time high of $221K]
...
![Chart showing ransomware frequency returned to 2021 levels]
![Chart showing average ransomware severity climbed to $508K, a three-year high]

---

## Chapter 3: Financial Fraud
...
![Chart showing financial fraud frequency remained elevated]
![Chart showing 8 in 10 financial fraud incidents began with email]
...
![Chart showing claims related to CIPA are a persistent presence in our dataset]
![Chart showing CIPA claims unrelated to Meta Pixel in 2025]

---

## Chapter 5: What the Data Tells Us
...
[^1]: Access to Stance Fraud Defense is available to insureds with policies placed through At-Bay Insurance Services, LLC that include an Embedded Security Endorsement.
