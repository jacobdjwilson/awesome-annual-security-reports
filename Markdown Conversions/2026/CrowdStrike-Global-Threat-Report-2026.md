...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 2
Foreword
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 3
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 4
Table of
Contents
Introduction 5
Threat Landscape Overview 9
Key Adversary Themes 14
Adversaries Leverage AI to Enhance
and Accelerate Operations 14
Ransomware Adversaries Expand
Cross-Domain Tradecraft 21
China-Nexus Threat Actors Target Network
Perimeter Devices for Initial Intrusions 26
Supply Chain Attacks Enable Evasion of
Traditional Security Controls 31
Adversary Objectives Shape Zero-Day
Exploit Selection 35
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 5
Introduction
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 6
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 7
...
dramatically reducing the time between detection and effective response. 24
The CrowdStrike 2026 Global Threat Report summarizes the analysis the NEW ADVERSARIES NAMED IN 2025,
CrowdStrike Intelligence team performed throughout 2025 and describes INCLUDING BELARUS ADVERSARY
notable themes, trends, and events across the cyber threat landscape. UMBRAL BISON
This report also provides anticipatory threat assessments to help 281
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 8
...
CHOLLIMA SAIGA
DPRK (NORTH KOREA) KAZAKHSTAN
CRANE SPHINX
ROK (REPUBLIC OF KOREA) EGYPT
HAWK SPIDER
SYRIA eCRIME
JACKAL TIGER
HACKTIVIST INDIA
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 9
Threat Landscape
Overview
...
00:27 281
89% increase in attacks by Average eCrime breakout time 82% of detections in 2025 24 new adversaries tracked
AI-enabled adversaries dropped to 29 minutes, a 65% were malware-free, up from by CrowdStrike, raising
increase in speed from 2024, 51% in 2020 the total to 281
and the fastest breakout time
was only 27 seconds
China-nexus activity increased 42% increase in zero-day Valid account abuse 37% rise in cloud-conscious
38% across all sectors, with an vulnerabilities exploited prior to accounted for 35% of intrusions, with 266% increase
85% increase in logistics public disclosure cloud incidents by state-nexus threat actors

CROWDSTRIKE 2026 GLOBAL THREAT REPORT 10
...
23% 15% 12% 11% 10% 9% 7% 6% 4% 3%
TECHNOLOGY MANUFACTURING RETAIL FINANCIAL SERVICES HEALTHCARE TELECOMMUNICATIONS GOVERNMENT INDUSTRIALS AND ACADEMIC MEDIA
ENGINEERING
Figure 2. Top 10 industries targeted by interactive intrusions, January-December 2025

CROWDSTRIKE 2026 GLOBAL THREAT REPORT 11
Breakout Time:
98
...
WinSCP; connection is malware-free
blocked by firewall
00:02:54 detections
CHATTY SPIDER accesses
Google Drive URL since 2020
00:03:16-00:39:56
CHATTY SPIDER accesses files and
folders on compromised workstation
2025: 82%
00:00:00
CHATTY SPIDER convinces 00:04:03-01:25:45
victim to grant the CHATTY SPIDER moves to exfiltrate 2024: 79%
adversary workstation data to Google Drive
access through Quick Assist
2023: 75%
00:00:00 00:01:00 00:02:00 00:03:00 00:04:00 00:30:00 01:00:00 2022: 71%
2021: 62%
Figure 4. CHATTY SPIDER starts to exfiltrate data in four minutes
2020: 51%

CROWDSTRIKE 2026 GLOBAL THREAT REPORT 12
...
1250
KEY Malicious browser update lures Fake CAPTCHA lures
1000
750
500
250
...
| CROWDSTRIKE 2026 GLOBAL THREAT REPORT |     |     |     |     |     |     | 13  |
| ------------------------------------- | --- | --- | --- | --- | --- | --- | --- |
eCrime Landscape
...
+1.5%
Avg Stealer
| JAN FEB | MAR APR | MAY JUN | JUL AUG | SEP OCT | NOV DEC |     | Cost |
| ------- | ------- | ------- | ------- | ------- | ------- | --- | ---- |
+10.8%
Figure 6. ECX values, 2024 vs. 2025

CROWDSTRIKE 2026 GLOBAL THREAT REPORT 14
Key Adversary
Themes
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 15
3000
2000
1000
...
outage
Grok provides
inappropriate Gemini 3 Pro
content with agentic
AI release
Grok 3
release
ChatGPT Gemini Grok DeepSeek Claude Qwen Llama Perplexity Mistral WormGPT
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 16
FAMOUS CHOLLIMA
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 17
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 18
CASE HIGHLIGHT:
...
RECONNAISSANCE LAMEHUG INTELLIGENCE COLLECTION
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 19
...
AND TOOLS
AI
Cerber ransomware operators Threat actors deployed a malicious
exploited CVE-2025-3248 clone of a legitimate MCP server
against Langflow AI to deploy that forwarded emails to
ransomware and distribute attacker-controlled addresses
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 20
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 21
Ransomware Adversaries Expand
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 22
CASE HIGHLIGHT:
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 23
...
01:00:00-01:30:00
SCATTERED SPIDER Authenticates to second compromised
calls help desk account; accesses privileged access
to initiate management application via web browser and
self-service retrieves user's VMware vCenter password
password reset
00:00:00 00:30:00 01:00:00 01:30:00 02:00:00 03:00:00
00:15:00-01:00:00
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 24
CASE HIGHLIGHT:
PUNK SPIDER’s Remote File Encryption
»
The most active BGH adversary in 2025 was PUNK SPIDER. This adversary
conducted 198 intrusions observed across CrowdStrike telemetry, a 134% increase THE MOST ACTIVE BGH
year-over-year. PUNK SPIDER continues to remotely encrypt data via Windows ADVERSARY IN 2025 WAS
Server Message Block (SMB) shares, thereby avoiding the need to execute PUNK SPIDER. THIS ADVERSARY
...
| CROWDSTRIKE 2026 GLOBAL THREAT REPORT |     |     |     | 25  |
| ------------------------------------- | --- | --- | --- | --- |
Virtualization
| Edge Devices | Identity | Cloud |     |     |
| ------------ | -------- | ----- | --- | --- |
Infrastructure
Gains initial access via  � Hijacks AD agent � Registers federated � Maintains persistent
| unmanaged and  |     | identity provider in  | access to VMware  |     |
| -------------- | --- | --------------------- | ----------------- | --- |
unpatched edge devices,  � Modifies Entra ID victim Entra ID tenant vCenter using OrBit
| including firewalls and  | conditional access  |                         | Linux backdoor |     |
| ------------------------ | ------------------- | ----------------------- | -------------- | --- |
|                          | policies            | � Exfiltrates data from |                |     |
VPNs
|     |     | cloud-based SaaS | � Creates unmanaged |     |
| --- | --- | ---------------- | ------------------- | --- |
� Leverages compromised
|     |     | applications | VMs to exfiltrate data  |     |
| --- | --- | ------------ | ----------------------- | --- |
SSO account to access
from key systems
data repositories and  � Creates mail forwarding without security tooling
|     | modify EDR policies | and mail deletion rules  | visibility |     |
| --- | ------------------- | ------------------------ | ---------- | --- |
in Microsoft 365 to
|     |     | prevent legitimate users  | � Encrypts data using |     |
| --- | --- | ------------------------- | --------------------- | --- |
|     |     | from receiving security   | Linux version of      |     |
|     |     | alerts                    | Embargo ransomware    |     |
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 26
China-Nexus Threat Actors Target Network
...
| CROWDSTRIKE 2026 GLOBAL THREAT REPORT |     |     |     |     |     |     | 27  |
| ------------------------------------- | --- | --- | --- | --- | --- | --- | --- |
...
downloader Bottles.
|     | CVE-2025-31324 |     | CVE-2025-25257 | CVE-2025-55182 |             |     |     |
| --- | -------------- | --- | -------------- | -------------- | ----------- | --- | --- |
|     | APR 24-APR 27  |     | JUL 8-JUL 14   |                | DEC 3-DEC 5 |     |     |
|     | 3 DAYS         |     | 6 DAYS         |                | 2 DAYS      |     |     |
VAULT PANDA AND
|     | PHANTOM PANDA |     | OPERATOR PANDA |     |     |     |     |
| --- | ------------- | --- | -------------- | --- | --- | --- | --- |
GENESIS PANDA
(React2Shell)
| APR |     | MAY JUL |     | AUG | DEC |     |     |
...
2025
YEK
|     |     |     | Public Disclosure Exploitation |     |     |     |     |
| --- | --- | --- | ------------------------------ | --- | --- | --- | --- |
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 28
...
OPERATOR PANDA demonstrated versatility in their edge device targeting, PERSISTENT ACCESS FOR
...
the vulnerability was published. COLLECTION OBJECTIVES.
...
CROWDSTRIKE 2026 GLOBAL THREAT REPORT 29
