...
![Figure 1. The CIA triad: Confidentiality, Integrity, Availability](Figure_1_CIA_Triad.png)
...
User Groups            Ground-Station Network
  ...
  └───────────┬────────────┘
           ...
           Internet
```
![Figure 2. Typical LEO network architecture](Figure_2_LEO_Network_Architecture.png)
