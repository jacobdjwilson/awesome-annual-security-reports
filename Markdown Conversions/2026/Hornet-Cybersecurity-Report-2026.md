...
While phishing remains the leading infection vector at 46% of those surveyed, its dominance is slipping. Attackers are diversifying: The data shows a clear pivot toward credential theft and endpoint compromise, particularly in hybrid and remote work environments where BYOD and patch gaps remain widespread. Ransomware is no longer just an email problem; it’s an ecosystem problem.
...
Earlier in 2025, Scattered Spider had been linked to attacks on major British retailers (Marks & Spencer, Co-op, Harrods) and insurance firms like Aflac. In July 2025, the group