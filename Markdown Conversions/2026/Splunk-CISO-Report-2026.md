# From Risk to Resilience in the AI Era: The CISO Report

## Table of Contents
- [Executive foreword](#executive-foreword)
- [The CISO stands resilient](#the-ciso-stands-resilient)
- [Chapter 1: The expanding role of the CISO](#chapter-1-the-expanding-role-of-the-ciso)
- [Chapter 2: Strategies shaped by shared visions](#chapter-2-strategies-shaped-by-shared-visions)
- [Chapter 3: The AI imperative](#chapter-3-the-ai-imperative)
- [Chapter 4: The promise of agentic AI](#chapter-4-the-promise-of-agentic-ai)
- [Chapter 5: CISOs choose talent over tech](#chapter-5-cisos-choose-talent-over-tech)
- [Chapter 6: Measuring security success](#chapter-6-measuring-security-success)
- [The CISO steps forward](#the-ciso-steps-forward)
- [Become a resilience leader with Splunk](#become-a-resilience-leader-with-splunk)
...
## Chapter 1: The expanding role of the CISO
...
![Chart: The CISO's biggest obstacles: Sophistication of threat actor capabilities (95%), Pace of technology advancements (89%), Shifting regulatory requirements (76%), Talent shortages (47%), Budget availability (42%)]
...
## Chapter 2: Strategies shaped by shared visions
...
## Chapter 4: The promise of agentic AI
...
## Chapter 5: CISOs choose talent over tech
...
## Chapter 6: Measuring security success
...
Historically seen as a cost center, CISOs are beginning to reframe security as a business enabler. According to Splunk CISO Michael Fanning, “CISOs shouldn’t expect leadership to inherently understand security’s value. We have to showcase it — proactively.”

> "If you’re doing security for the sake of security, you’re failing as a CISO. You’re becoming a business barrier instead of being a business enabler."
> — Bjoern Watne, Global CISO, Interpol
...
## Become a resilience leader with Splunk
- **State of Security 2025: Perspectives by Splunk — by leaders, for leaders**: Looking for more thought leadership and insights from CISOs? Learn how security leaders address today’s most pressing challenges, including regulatory compliance, AI, and the evolving threat landscape.
- **The Stronger, Smarter SOC of the Future**: Looking to break free from inefficiencies in the SOC? Learn how to eliminate busywork, overcome alert overload, and close critical data gaps.
