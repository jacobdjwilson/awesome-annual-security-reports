...
**Organization:** Dragos
**Report Title:** OT-Cybersecurity-Report-A-Year-in-Review
**Year:** 2026
...
- [01. Dragos Identifies Three New Threat Groups in 2025](#01-dragos-identifies-three-new-threat-groups-in-2025)
...
- [02. Advancing Toward OT: Active Threat Group Operations](#02-advancing-toward-ot-active-threat-group-operations)
...
## 01. Dragos Identifies Three New Threat Groups in 2025
...
![AZURITE: Stage 1 & Stage 2 Attacks Infographic]
![AZURITE Attack Path 1: SOHO Device Compromise to Achieve OT Access]
![AZURITE Attack Paths: VPN Access to OT Environment and Engineer Workstation]

#### Insights From Dragos Intelligence Fabric
- 53 percent of Dragos Services assessments conducted included findings associated with Internet connectivity or externally facing issues. 
- Severity rankings distributed: Critical – 20 percent, High – 31 percent, Medium – 34 percent, Low – 15 percent.
...
![Internet Connectivity or External Facing Issues Infographic]
...
![Hunting for AZURITE Infographic]
...
![PYROXENE: Stage 1 & Stage 2 Attacks Infographic]
![PYROXENE Attack Path Infographic]
...
![Hunting for PYROXENE Infographic]
...
![SYLVANITE: Stage 1 Attacks Infographic]
![SYLVANITE Attack Path Infographic]
...
![Hunting for SYLVANITE & VOLTZITE Infographic]

---

## 02. Advancing Toward OT: Active Threat Group Operations
...
KAMACITE and ELECTRUM, responsible for Ukraine’s 2015 and 2016 power outages, are the most experienced infrastructure-disrupting adversaries in the world. After years focused exclusively on Ukrainian targets, they expanded operations back into Europe and the United States in 2025. VOLTZITE achieved Stage 2 capability by moving beyond data exfiltration to direct manipulation of engineering workstations. BAUXITE escalated from hacktivist defacements to deploying custom wiper malware during regional conflicts.
...
#### Insights From Dragos Intelligence Fabric
- In late December 2025, a coordinated cyberattack against Polish energy infrastructure occurred, which included combined heat and power (CHP) facilities and systems supporting renewable energy generation and management. Public statements from Polish authorities indicated the activity was assessed as originating from actors linked to Russian state services and that defensive sector organizations...

---

[^1]: The Diamond Model of Intrusion Analysis – US Department of Defense: [https://apps.dtic.mil/sti/pdfs/ADA586960.pdf](https://apps.dtic.mil/sti/pdfs/ADA586960.pdf)
[^2]: The Industrial Control System Cyber Kill Chain – SANS: [https://www.sans.org/white-papers/36297](https://www.sans.org/white-papers/36297)
[^3]: Towards Improving CVSS – Carnegie Mellon University: [https://www.sei.cmu.edu/documents/574/2018_019_001_538372.pdf](https://www.sei.cmu.edu/documents/574/2018_019_001_538372.pdf)
[^4]: Risk-Based Vulnerability Management for Operational Technology – Dragos: [https://hub.dragos.com/hubfs/116-Datasheets/Dragos_Risk-Based_Vulnerability_Management_OT_Cybersecurity.pdf?hsLang=en](https://hub.dragos.com/hubfs/116-Datasheets/Dragos_Risk-Based_Vulnerability_Management_OT_Cybersecurity.pdf?hsLang=en)

---

zations to provide restricted
measures prevented any disruption to technical information related to this activity.
national power delivery or grid stability.
• CHP facilities and renewable energy aggregation
• While no customer-facing outages were platforms represent operationally meaningful
reported, the targeting demonstrates continued leverage points within modern energy systems.
adversary focus on operational environments CHP plants provide localized thermal and
that directly support power generation, grid electrical stability for municipal or industrial
coordination, and regional energy stability. customers, while renewable management
systems increasingly coordinate dispatch,
• Dragos has been tracking this activity through curtailment, telemetry, and grid balancing
a combination of incident response, internal functions across geographically distributed
analysis, and sensitive source reporting, assets. Disruption or manipulation of these
though specific technical details cannot be systems, even if localized, can introduce
disclosed at this time due to source handling cascading operational complexity, operator
constraints. Available information indicates workload stress, and recovery challenges,
that the activity included deliberate attempts particularly during seasonal demand peaks.
...
Notable Timing of The attacks occurred approximately six days after the 10th anniversary of the December 2015
Activity cyber-induced power outage in Ukraine, widely regarded as the first publicly confirmed cyber
...
Expansion of Beginning in late 2024 and extending into early 2025, Dragos observed a significant escalation
KAMACITE Targeting in KAMACITE activity targeting organizations across the European OT/ICS supply chain, a
Across the ICS departure from prior years, when the group largely focused on Ukrainian critical infrastructure
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Consistent Tactics, Starting in late 2024 and extending through early 2025, the scope and ambition of KAMACITE’s
But Expanded access-building efforts changed. Rather than focusing only on direct critical-infrastructure
Operational Scale operators, the group expanded upstream, attempting to compromise suppliers, integrators,
...
Why This Campaign KAMACITE’s upstream supply chain focus represents a meaningful risk to industrial defenders.
Matters By compromising vendors and integrators rather than only operators, the group increases:
...
U.S. Reconnaissance Shortly after concluding its 2024–2025 supply-chain campaign in Europe, KAMACITE shifted
Campaign (March– to a new phase of activity: sustained, infrastructure-linked reconnaissance against internet-
July 2025): exposed industrial devices located exclusively within the United States. Dragos analysis of
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
From Access- The key development is not the act of scanning itself; multiple adversaries routinely search for
Building to Control- exposed ICS equipment, but the specific selection of components and the sequencing of the
Loop Mapping reconnaissance.
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
What Defenders The scanning activity demonstrates that KAMACITE is now willing to:
Should Infer
...
ELECTRUM Activity In late May 2025, ELECTRUM conducted a coordinated destructive operation targeting eight
in 2025: Destructive Ukrainian ISPs. As in previous incidents, ELECTRUM obfuscated its involvement by operating
Operations through the hacktivist persona Solntsepek (tracked by Dragos as TAT25-41), a pro-Russian
...
June 2025: In parallel with the ISP attacks, Cisco Talos identified PathWiper, which Dragos has previously
Identification of New linked to ELECTRUM with moderate confidence. PathWiper appeared in the wild beginning
Destructive Malware March 2025 and submitted independently by several Ukrainian entities to online malware
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Defensive Control 01: ICS Incident Response Plan
Recommendations
and Mitigations • ELECTRUM’s activity targeting Polish energy infrastructure again demonstrated
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Sierra Wireless In 2025, VOLTZITE continued its operations against critical infrastructure targets. The most
Airlink Targeting impactful campaign involved compromising Sierra Wireless Airlink RV50 and RV55 cellular
...
JDY Botnet Activity Additionally, Dragos observed VOLTZITE-linked activity leveraging the JDY botnet to conduct
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Exploited Trimble In early 2025, TAT25-09 exploited a RCE vulnerability (CVE-2025-0994) in Trimble Cityworks
Cityworks GIS (Cityworks) GIS asset management software via Microsoft Internet Information Services (IIS)
Software servers. Dragos identified low confidence operational overlap between VOLTZITE and this
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Insights From Dragos Intelligence Fabric
• 32 percent of Dragos Network • 95 percent of Services customers
Penetration Tests included successful employed MFA for remote access.
password spraying over SSH or SMB, VOLTZITE commonly leverages
techniques favored by VOLTZITE. insecure remote access to gain
...
Defensive Control 01: ICS Incident Response Plan
Recommendations
and Mitigations • VOLTZITE gains initial access via the exploitation of network edge devices or footholds
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Threatening Email In May 2025, the CyberAv3ngers hacktivist persona distributed politically charged threatening
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Insights From Dragos Intelligence Fabric
• Service accounts with SSH access • Restricting service accounts from
often rely on shared keys, a interactive logon and monitoring
condition frequently observed by for interactive SSH use can
Dragos Red Team, while Bauxite has significantly reduce this risk.
independently leveraged shared SSH
keys to access exposed devices.
16% 10%
In 16 percent of service engagements, 10 percent of Architecture Reviews and Network
significant backup deficiencies were Penetration Tests identified Service Account
identified, a critical concern for restoring and SSH Security issues such as excessive
systems following wiper malware attacks. privileges, interactive access, and weak
...
Defensive Control 01: ICS Incident Response Plan
Recommendations
and Mitigations • BAUXITE activity affecting OT has included unauthorized modification of controller
...
Capabilities
Research & Trends
The threat groups covered in this report represent What connects these discoveries is a common
the adversaries Dragos tracks with enough analytical theme: the tools are not sophisticated. ICS protocols
confidence to name and characterize. But the were designed for reliability in environments that
broader ecosystem of ICS-relevant capability were never expected to be connected to outside
development extends well beyond those groups. networks, and they carried that design forward
Throughout 2025, Dragos identified new tools, today. They lack authentication, they are well
scripts, and operational activity that demonstrate documented, and their protocol libraries are publicly
a widening pool of actors acquiring the ability to available. Building a tool that can send a command
interact with and disrupt industrial control systems. to a PLC or write to a Modbus register does not
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
PLC_Controller.exe In July 2025, Dragos discovered an attack tool named PLC_Controller.exe, a compiled Python-
...
PLC_Controller.exe
Attack Path
Suspicious In November 2025, Dragos discovered and analyzed a PowerShell script named exploit.ps1 that
PowerShell Modbus scans for Modbus servers on a given subnet, identifies holding registers with values greater than
Tool 400, and repeatedly writes 1,000 to the holding register. The script was discovered alongside
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Adversaries Stealing Several TATs in 2025 have been observed stealing ICS data, which is useful for mapping
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Hacktivists and In 2025, Dragos observed hacktivism continue to evolve from symbolic website defacements
Proven Claims and surface-level DDoS attacks into a more sophisticated, geopolitically influenced threat
...
Ransomware Ransomware groups and affiliates in 2025 continued to rely on remote-access and virtualization
Targeting abuse. Dragos consistently observed affiliates using valid credentials, commodity infostealers,
Virtualization and OT or initial access broker (IAB)-provided access to authenticate into VPN portals, firewall
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Expansion and Dragos observed a more fragmented ecosystem in which affiliates frequently moved between
Fragmentation of RaaS programs and used the same intrusion playbooks regardless of RaaS group association.
the RaaS Ecosystem This fragmentation, combined with increased availability of stolen credentials and ready-made
...
Increased Targeting Throughout 2025, ransomware affiliates continued to compromise engineering firms (148
of OT-Adjacent compromises), OT managed-service providers, ICS equipment vendors (124 compromises), and
and Supply-Chain system integrators. These are all organizations whose environments often contain engineering
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
False ICS Claims and A growing trend in 2025 was the use of false ICS claims in ransomware extortion. Dragos
Narrative-Driven observed multiple ransomware operators and hybrid hacktivist personas attempting to inflate
Extortion their perceived capabilities by misrepresenting access to industrial systems. In one example,
...
Identity-Centric During 2025, affiliates increasingly relied on credential logs sourced from infostealers,
Intrusions Enabling password reuse across OT and IT systems, cloud-synchronized identities, and compromised
IT-to-OT Operational vendor accounts sold through IAB marketplaces. This approach allowed adversaries to bypass
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Insights From Dragos Intelligence Fabric
• Dragos incident response teams observed • 88 percent of Dragos TTXs reported degraded
an increase in cases involving compromised detection capabilities.
credentials and unauthorized access to VMware
ESXi during ransomware events. • 3 percent of Network Penetration Tests reported
lack of monitoring - customer’s do not often
• Exploitation of trusted third-party relationships is request a Network Penetration Tests if they lack
frequently observed in incidents involving leaked monitoring. They are almost certainly past the
credentials from external partners. initial implementation stages of monitoring and
are now progressing towards operationalizing or
• 5 days is the average dwell time for Dragos OT optimizing their visibility.
Ransomware Cases in 2025, all time is 42 days
for Ransomware. • 56 percent of Dragos Network Penetration Tests
included findings related to LOTL activity.
• Dragos Incident Response observed significant
operational disruption in all OT ransomware • 3 percent of services engagements identified use
cases in 2025. of default credentials.
• 54 percent of Dragos Services Architecture • 53 percent of services reports identified public or
Reviews conducted revealed appropriate levels internet facing assets.
of ICS network monitoring deployed.
• 49 percent of services engagements revealed
remote access weaknesses.
54% 88%
of Dragos Services Architecture Reviews of Dragos TTXs reported degraded
conducted revealed appropriate levels of detection capabilities
...
05.
Vulnerabilities
The threat groups documented earlier in this report runs on decades-long life cycles where patching may
are getting into OT environments through a relatively be impractical, risky, or irrelevant to the actual threat.
consistent set of paths: exposed VPNs, unpatched And the conventional wisdom of prioritizing by CVSS
edge devices, remote access infrastructure, and score breaks down in environments where a medium-
credential reuse. These are not exotic attack surfaces. severity flaw on an internet-exposed gateway poses far
They are known weaknesses in known products, and more real-world risk than a critical-rated vulnerability
in many cases the vulnerabilities being exploited have buried deep in an air-gapped process network.
public proof-of-concept code available. The gap is not
awareness that these vulnerabilities exist. The gap is This section examines the vulnerability landscape as
that the OT vulnerability ecosystem does not always it actually affects OT defenders: where the advisory
give defenders what they need to act on them. ecosystem falls short, how adversaries are exploiting
what is available, where emerging technologies like
Industrial vulnerability management is fundamentally battery energy storage systems are introducing risk
different from its IT counterpart. Advisories are faster than security practices can account for, and what
frequently published with no patch, no workaround, the data says about where to focus limited resources.
...
Product-Specific The Nuvation BMS is a typical field device with no meaningful security. Direct network access
Vulnerabilities to the BMS allows disconnecting batteries, changing battery chemistry, capacity, reserve
...
Wider Industry One item Dragos evaluated with Nuvation products was the support for an industry-standard
Issues communications overlay called SunSpec. This is a data model which can be implemented on
...
Exploitation of In 2025, Dragos determined that most ICS-specific vulnerabilities exploited were used to gain
Vulnerabilities in ICS initial access or facilitate reconnaissance in OT. Only ~4 percent of ICS-relevant vulnerabilities
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Ransomware Groups In 2025, Dragos observed widespread exploitation of vulnerabilities in file transfer solutions,
Continue to Target including Cleo MFT, CrushFTP, and Wing FTP. These flaws allow adversaries to gain
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Adversaries Throughout 2024 and 2025, adversaries actively exploited multiple vulnerabilities in perimeter-
Exploiting Exposed facing technologies. These include flaws in Ivanti Connect Secure VPN, Palo Alto Networks
Perimeter Devices PAN-OS and Expedition, Fortinet FortiOS/FortiProxy, F5 BIG-IP, and Cisco ASA/FTD appliances.
...
2025 Vulnerability Industrial control systems (ICS) underpin critical infrastructure, yet vulnerability
Trends management remains fragmented and unreliable. Dragos analyzes ICS-relevant vulnerabilities
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Moreover, CVSS scores often fail to reflect ICS-specific realities. For example, a system
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Insights From Dragos Intelligence Fabric
80 percent of service engagements Only 5 percent of reports identified EOL
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Overview Throughout 2025, incident response cases were consistently initiated after the identification
...
accounts.
Call to Action The activity observed throughout the last few years reinforces a clear and urgent reality:
...
IR Cases A common theme among confirmed OT incidents with a cyber dimension was the presence of
...
Incident Response Asset owners and operators must develop and maintain an OT/ICS-specific Incident Response
Plans Plan (IRP) addressing the unique requirements and risks of their OT/ICS environments. This plan
...
2025 TTX Scores –
Core Average Average Average
Industry Breakdown Capability All Industries Oil & Gas Manufacturing Average Electric
...
percent.
Network Poor IT and OT segmentation remains the most common architectural weakness, appearing in 81
Segmentation percent of reports, with representation across all sectors, including 29 percent in oil and gas, 24
...
9TH ANNUAL YEAR IN REVIEW | OT/ICS CYBERSECURITY REPORT UPDATED FEBRUARY 2026
Default or Weak The use of default or vendor-supplied credentials was once prevalent in OT/ICS environments.
Credentials These credentials are widely known and easily exploited, giving attackers a low-effort path
...
Endpoint Protection Traditional antivirus (AV) and endpoint detection and response (EDR) solutions are less
...
07.
Call to Action
The activity observed throughout 2025 reinforces complexity as AI technologies move into operational
an urgent reality: adversaries are already targeting environments. Organizations that cannot monitor
infrastructure as it evolves. ELECTRUM’s focus today’s OT networks will find that AI adoption creates
on distributed energy resources in Poland and the exponentially greater blind spots, making root cause
security gaps identified in battery energy storage analysis and incident response increasingly difficult.
systems demonstrate that new infrastructure is Establishing comprehensive OT visibility now, before
being deployed faster than security can keep pace. AI and renewable energy adoption further accelerate,
Looking ahead, organizations face compounding is critical for maintaining operational resilience.
90 © Dragos, Inc. All Rights Reserved. Proprietary & Confidential.

99TTHH AANNNNUUAALL YYEEAARR IINN RREEVVIIEEWW || OOTT//IICCSS CCYYBBEERRSSEECCUURRIITTYY RREEPPOORRTT UUPPDDAATTEEDD FFEEBBRRUUAARRYY 22002266
About Dragos Dragos is the world’s leading OT cybersecurity firm headquartered in Washington DC, USA
