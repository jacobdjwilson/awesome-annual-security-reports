...
![Infographic showing 65% of organizations reported a supply chain attack and 76% of companies report unauthorized AI coding assistant usage]
...
| Metric | OSSRA 2025 | OSSRA 2026 | YoY Change |
| :--- | :--- | :--- | :--- |
| Codebases containing at least one vulnerability | 86% | 87% | 1 pt |
...
1. **Component growth**: 30% more components per codebase year-over-year.
2. **Component selection patterns**: AI coding assistants tend to suggest popular, well-established libraries that often have longer vulnerability histories.
...
| Metric | OSSRA 2025 | OSSRA 2026 | YoY Change |
| :--- | :--- | :--- | :--- |
| Codebases with high-risk vulnerabilities | 81% | 78% | 3 pts |
| Codebases with critical-risk vulnerabilities | 48% | 44% | 4 pts |
...
- **34%** were hijacked—legitimate packages compromised after gaining community trust.
...
- **Licensing**: Models often carry unclear or custom terms that restrict use cases.
- **Regulatory Pressure**: The EU AI Act and similar regulations require accountability for model provenance and training data.
...
| Metric | OSSRA 2025 | OSSRA 2026 | YoY Change |
| :--- | :--- | :--- | :--- |
| Codebases with license conflicts | 56% | 68% | 12 pts |
| Mean license conflicts per codebase | 104 | 69 | - |
| Median license conflicts per codebase | 8 | 5 | - |
| Maximum license conflicts in a single codebase | 1,109 | 2,675 | 141% |

*Table 10. License conflict metrics: Year-over-year comparison*

## Understanding License Conflicts

A license conflict occurs when the terms of one license are incompatible with another, or with the intended distribution model. Common patterns include:
- **Copyleft vs. Proprietary**: Including GPL-licensed code in proprietary software.
- **Version Incompatibilities**: Combining "GPL v2 only" with "GPL v3 or later."
- **Attribution Requirements**: Conflicting requirements for how to display credits.

## Why License Conflicts Are Accelerating

64% of open source components in a typical codebase are transitive dependencies. Developers never explicitly chose these components, yet their code is bound by the components’ license terms.

## The 2,675 Conflicts Finding

One codebase in our audit contained 2,675 distinct license conflicts. This was a large Gradle project consisting of many JAR files mapped to components often licensed under the Apache License 2.0, which has known compatibility issues with several other licenses.

## Top 10 Open Source Licenses

| Rank | License | % of Codebases |
| :--- | :--- | :--- |
| 1 | MIT License | 92% |
...
AI coding assistants trained on vast public codebases can inadvertently introduce code from projects with restrictive licenses. Only 54% of organizations evaluate AI-generated code for IP and license risks, and just 24% perform comprehensive IP, license, security, and quality evaluations.
...
Industries with the highest conflict rates include Big Data/AI (78%), EdTech (74%), and Financial Services (72%). Industries with the lowest rates include Aerospace (52%) and Computer Hardware (54%), where rigorous component vetting is standard.

## Practical License Governance

- **Track AI-generated code**: Maintain records of which code sections were AI-generated.
- **Review AI suggestions**: Review for potential similarity to known open source patterns.
- **Configure AI tool settings**: Filter suggestions that match public code.
- **Include AI code in audits**: Specifically examine AI-generated sections.
...
| Metric | OSSRA 2025 | OSSRA 2026 | YoY Change |
| :--- | :--- | :--- | :--- |
| Codebases with components 4+ years out-of-date | 90% | 92% | 2 pts |
| Codebases with components showing no development in 2+ years | 91% | 93% | 2 pts |
| Codebases with components not using latest version | 91% | 93% | 2 pts |
| Codebases with components 10+ versions behind current | 90% | 92% | 2 pts |
| Median component age (months) | 42 | 45 | 7% |

*Table 16. Component maintenance and operational risk metrics*

## The Zombie Component Problem

Ninety-three percent of the codebases we audited contain components with no development activity in over two years. When a vulnerability is discovered in one of these abandoned projects, there may be no one able to fix it.

## Version Currency

Only 7% of components in the audited codebases are running the latest available version. The majority—41%—are 10 or more versions behind.

## The Update Question

Organizations struggle to update components due to:
- **Breaking changes**: API changes requiring refactoring.
- **Transitive conflicts**: Dependency resolution puzzles.
- **Testing burden**: Validation cycles competing with feature development.

## The EU Cyber Resilience Act

The CRA, which took effect in December 2024, introduces mandatory cybersecurity requirements for products with digital elements sold in the EU. By September 2026, vulnerability reporting requirements become mandatory. Organizations must be able to resolve potential exploit paths in a timely and transparent manner.

## Conclusion and Recommendations: Addressing Open Source Risk

### What the Data Tells Us
- Open source is universal.
- Vulnerability counts are exploding.
- License conflicts are at historic highs.
- Maintenance debt is a silent, systemic risk.
- AI is accelerating both development and risk.

### What Organizations Need
- **Visibility**: You cannot secure what you cannot see.
- **Context**: Distinguish between reachable, exploitable vulnerabilities and background noise.
- **Automation**: Integrate security into the CI/CD pipeline.
- **Governance**: Establish clear policies for open source and AI usage.

### The Black Duck Application Security Portfolio
Black Duck provides a comprehensive suite of tools for:
...
Signal provides advanced intelligence to help security teams prioritize remediation by focusing on the vulnerabilities that pose the greatest real-world risk.

### Getting Started
Visit [blackduck.com](https://blackduck.com) to learn more about our solutions and how we can help you secure your software supply chain.

### About Black Duck
Black Duck is the leader in software supply chain security, providing the intelligence and tools organizations need to build, manage, and secure their software.
