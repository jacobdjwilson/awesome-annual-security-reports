...
from known, preventable conditions: exposed defenders were slow.
services, weak identity controls, and unpatched
It failed because speed
edge infrastructure. What has changed is how
quickly those conditions are discovered and was no longer the
weaponized.
advantage.”
...
KEY FINDING #2: ATTACKERS ARE MONETIZING UNMANAGED
EXPOSURE
...
platforms.
KEY FINDING #4: RANSOMWARE HAS MATURED INTO A
SPEED-OPTIMIZED ACCESS ECONOMY
...
KEY FINDING #5: EMBEDDED ACCESS, NOT PERIMETER BREACH,
DEFINES STRATEGIC RISK
...
the broader top-five composition shifted meaningfully from 2024. Memory handling issues such as CWE-
119, filename control problems like CWE-98, and CWE-352 (Cross-Site Request Forgery) re-emerged
...
confirms ransomware focusing on CVEs such as CVE-2025-10035 in Fortra GoAnywhere MFT and CVE-
2025-49704 in Microsoft SharePoint, both of which allowed attackers to bypass defenses and exfiltrate
...
(CVE-2025-49706, CVE-2025-49704, and CVE-
2025-53770).
...
could bypass query complexity limits within the GraphQL API. By submitting deeply nested or resource-
intensive queries that the system failed to properly throttle, attackers could trigger massive resource
...
against district heating companies in Ukraine, cutting off essential heating services for civilians during sub-
zero temperatures. Unlike traditional exploits that target software bugs, FrostyGoop targets the industrial
...
became core detective controls in 2025, not “nice-
to-haves.” As adversaries began experimenting with adaptive and AI-assisted malware, SOCs increasingly
...
380 SafePay
369 INC Ransom
by Number of Extortion Attempts 293 KillSec
271 Lynx
236 RansomHub
JAN 1 - DEC 31, 2025 222 DragonForce
Figure 10
2255
...
of the cybercrime ecosystem. Nowhere has this progression been more pronounced than in ransomware-
as-a-service (RaaS). This trend is characterized by a professionalized supply chain, increasing tactical
...
here is SafePay, a group originating in 2024 which avoids RaaS entirely in favor of running its own self-
contained operation.
...
in September, creating new users and escalating privileges once inside the network. ESXi, VMware’s bare-
metal hypervisor software, also became a popular target.
...
platforms that lower the technical barrier to entry. A prominent example is "Olymp Loader," an assembly-
based malware that surfaced in mid-2025 and is marketed for its anti-analysis and anti-detection
