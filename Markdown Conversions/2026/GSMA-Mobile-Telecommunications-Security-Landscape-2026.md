...
**Organization:** GSMA  
**Report Title:** Mobile-Telecommunications-Security-Landscape  
**Year:** 2026  
**Copyright:** © 2026 GSMA February 2026

## Table of Contents
- [Executive Summary](#1-executive-summary)
- [Mobile networks, devices and consumers are under attack](#2-mobile-networks-devices-and-consumers-are-under-attack)
...
![Figure 1: An Overview of topics, showing the spectrum of attacks including software, democratisation, pre-positioning, cyber hygiene, supply chain, and scams, alongside risk management, threat actors, AI, and regulatory landscapes.]

New for this year, the report includes approaches to vulnerability disclosure alongside a set of migration and other practical factors to consider for PQC transition. The landscape is completed by examining the fast-moving and often fragmented topic of global cybersecurity regulations. To address the evolving threat landscape, national and international policy must adapt. Based on the synthesis of threat and intelligence and strategic mapping, a range of recommendations emerge and are described. Finally, the report identifies ten key security protection priority areas derived from the report content.
...
In mobile networks, a single breach can disrupt infrastructure, customers, and supply chains. There is a commonality of attack tactics such as credential theft, token abuse, Software-as-a-Service (SaaS) exploitation, and living-off-the-land methods.

![Figure 2: A spectrum of attacks, illustrating the relationship between mobile networks, mobile devices, and mobile consumers.]
...
The widespread and relatively low-barrier use of security attack tools.

**Indicators of Compromise:**
- Increased use of common security tools
- Rise in attacks using off-the-shelf malware
- More breaches by less sophisticated actors
- Increasing bypass of SMS firewalls
- Customers clicking on known scam links

**Mitigations:**
- Patching
- GSMA FS.31 Baseline controls and MCKB
- Threat hunting
- SMS Blaster guidance FS.67
- A ‘top 20’ strategic security approaches including know your attack surface, defensive force multipliers, layered defences, supply chain security, resilience-by-design, risk management.

### 2.3 Successful Pre-Positioning Attacks

An adversary compromises systems now and persists there to prepare for a later escalation or low-level data exfiltration and ‘beaconing’ to C2 servers.

**Indicators of Compromise:**
- Unusual traffic flows and account usage
- Unusual persistent accounts or tasks
- Unexplained network traffic such as low-level outgoing beaconing, sometimes over a protracted period
- Unexplained changes in software

**Mitigations:**
- Threat hunting
- Secure roots of trust with periodic rebooting of systems
...
A practice of taking steps to protect devices, networks, and data from cyber threats.
...
**Mitigations:**
- Patching or adding additional security controls
- Improving user and administrator account security
- Monitoring and analysis of logging data and data flows
- Improving network and system segmentation
- Encrypting key data
- GSMA FS.31 Baseline controls and GSMA MCKB
- Multilayer defences

### 2.5 Supply Chain Attacks

A type of cyber or operational attack where an attacker compromises telecommunications systems or services by exploiting weaknesses in the suppliers, vendors, or partners involved in building, maintaining, or operating telecom networks.

**Indicators of Compromise:**
- Disguised C2 traffic
- Abnormal Routing Protocol Changes
- Spikes in DNS Query Volume
- Privilege Escalation in Active Directory
- Abnormal Login Times
- Unplanned software/ firmware updates
- Unauthorised Management Software
- Unexplained increases in database read volumes
...
- Use industry security assurance schemes to provide a security underpinning
- Fully understand the depth of the supply chain and the security processes of each vendor
...
The scam economy has grown rapidly over the last five years, surpassing the illegal drug trade and costing victims $1 trillion worldwide. The mobile industry is taking comprehensive steps to combat the rising number of scams that affect individuals and society, and to improve trust in global mobile networking.

---

## 3 Threat Actors

In today’s digital landscape, organisations and individuals encounter ongoing risks from threat actors. Gaining a comprehensive understanding of these actors, the specific threats they present, and identifying which threat actors are most relevant to the mobile industry is crucial for enhancing cybersecurity defences.

- **Salt Typhoon (UNC2286):** Active since at least 2019, targeting telecommunications infrastructure, energy networks, and government systems.
- **LightBasin (UNC1945 + UNC281):** Focuses on targeting Linux and Solaris based systems in telecommunications, finance, retail, and hospitality.
- **Scattered Spider (UNC3944 & Octo Tempest):** Financially motivated group using social engineering, vishing, and SIM swapping.
- **ShinyHunters:** Specialises in data theft, extortion, and leaking sensitive information via credential theft and misconfigured cloud services.

![Figure 3: Tactics used by the Threat Actors using the MITRE ATT&CK® adversary tactics framework.]

---

## 4 Risk Management

A powerful strategic security response to a range of the attack types identified earlier is to utilise risk and threat management to fully design and leverage security investments.
