...
- **61% of incidents had the potential to impact thousands to millions of mobility assets; 20% of which classified as massive-scale events.**
...
![Image description: A conceptual diagram showing the flow of data between vehicle edge systems, cloud backend, and third-party AI services.]
...
### Review of incidents
Cybersecurity attacks grew in both scale and severity in 2025, intensifying the pressure on the Automotive and Smart Mobility industries. During 2025, Upstream’s AutoThreat® researchers analyzed 494 Automotive and Smart Mobility cybersecurity incidents, an average of 41 incidents per month. This marks a 21% increase over 2024, signaling a continued expansion of the threat landscape.

---

## References

[^1]: Industry report on IAA Mobility 2025 software strategy shifts.
[^2]: Volkswagen Group AI investment announcement, September 2025.
[^3]: Volvo and Google Gemini partnership announcement, May 2025.
[^4]: Nissan and Wayve partnership announcement, April 2025.
[^5]: IBM Institute for Business Value, "Automotive AI Revenue Growth Report," October 2025.
[^6]: Research study on LLM-driven autonomous planning vulnerabilities, August 2025.
[^7]: CVE-2025-6514 disclosure, September 2025.
[^8]: Technical analysis of MCP deserialization exploit, September 2025.
[^9]: Report on CRM platform AI-module exploitation, mid-2025.
[^10]: Research on prompt injection in in-vehicle LLMs, 2025.
[^11]: "AutoDoS: Black-box Denial-of-Service against LLMs," July 2025.
[^12]: Model Context Protocol (MCP) architectural overview.
[^13]: Security advisory regarding CVE-2025-6514.
[^14]: Analysis of cloud-to-car persistent link risks.
[^15]: OWASP Top 10 for LLM Applications.
[^16]: Research on MCP-based automated action risks.
[^17]: Study on PII leakage in LLM-enabled vehicle assistants.
[^18]: Analysis of adversarial cues in sensor data streams.
[^19]: Research on systemic cyber-safety hazards in AI-based planning.
[^20]: Report on global automotive OEM breach via CRM supply chain, late 2025.
[^21]: Security research on German OEM infotainment platform, January 2025.
[^22]: Analysis of distributed ecosystem attack surfaces.
[^23]: Upstream 2025 Global Automotive Cybersecurity Report.
[^24]: AI developer report on state-linked AI-powered intrusion, November 2025.
[^25]: Study on AI-accelerated reverse engineering of infotainment OS.
[^26]: Research on AI-assisted API authorization analysis.
[^27]: Analysis of AI-generated fuzzing scripts for VIN enumeration.
[^28]: Research on side-channel attacks against LLM interfaces.
[^29]: Threat intelligence report on weaponization of frontier AI models.
[^30]: 2025 study on AI-created automotive diagnostic protocol fuzzers.
[^31]: Analysis of "Billion-Dollar Automotive Cyber Club" incidents.
[^32]: Report on European OEM cyber attack and government loan guarantee, September 2025.
[^33]: Economic impact analysis of the 2025 OEM cyber attack.
[^34]: Bank of England Monetary Policy Report, November 2025.
[^35]: Disclosure of telematics infrastructure zero-day, October 2025.
[^36]: UNECE WP.29 R155 compliance requirements.
[^37]: Incident report: German OEM infotainment vulnerabilities, January 2025.
[^38]: Incident report: US motorcycle OEM data breach, January 2025.
[^39]: Incident report: ECU firmware vulnerability, January 2025.
[^40]: Incident report: US dealership transport system hack, February 2025.
[^41]: Incident report: US automotive tech company ransomware, February 2025.
[^42]: Incident report: Chinese OEM man-in-the-middle, March 2025.
[^43]: Incident report: Indian Tier-1 supplier ransomware, March 2025.
[^44]: Incident report: Japanese OEM infotainment API, April 2025.
[^45]: Incident report: Global car rental data breach, April 2025.
[^46]: Incident report: Infotainment software vulnerabilities (800+ models), April 2025.
[^47]: Incident report: US EV OEM TPMS vulnerabilities, May 2025.
[^48]: Incident report: German OEM mobile app flaw, May 2025.
[^49]: Incident report: German OEM authentication token breach, June 2025.
[^50]: Incident report: EV charger firmware vulnerability, June 2025.
[^51]: Incident report: German EV charger API bypass, July 2025.
[^52]: Incident report: Bluetooth vulnerability disclosure, July 2025.
[^53]: Incident report: Chinese OEM infotainment encryption bypass, August 2025.
[^54]: Incident report: Online dealership portal flaws, August 2025.
[^55]: Incident report: UK OEM cyber attack, September 2025.
[^56]: Incident report: US EV CAN bus injection, September 2025.
[^57]: Incident report: Global agricultural equipment OEM ransomware, September 2025.
[^58]: Incident report: OEM telematics zero-day, October 2025.
[^59]: Incident report: Italian EV charger ransomware, October 2025.
[^60]: Incident report: South American API authorization flaw, October 2025.
[^61]: Incident report: US commercial OEM ransomware, November 2025.
[^62]: Incident report: Chinese motorcycle OEM app flaw, November 2025.
[^63]: Incident report: German OEM infotainment vulnerabilities, December 2025.
[^64]: Incident report: Chinese OEM infotainment vulnerabilities, December 2025.
...
| Cybersecurity testing of  | vehicles and remotely control  |     |
| ------------------------- | ------------------------------ | --- |
| electric buses in Norway  | critical functions.63          |     |
...
Black hat actors attack In contrast, white hat actors Gray hat actors operate in
systems for personal or are security researchers the blurred space between
financial gain, or for purely who penetrate systems to ethical and malicious activity,
malicious purposes. Today’s validate controls and identify often discovering or exploiting
black hats are not lone wolves new, and often disturbing, vulnerabilities without explicit
but part of organized, well- vulnerabilities. They operate permission. Their motivations
funded global operations independently or via bug range from responsible
capable of simultaneous bounty programs, responsibly disclosure to financial reward,
strikes against multiple disclosing findings to improve frequently raising ethical and
organizations worldwide. cybersecurity posture. legal concerns regarding their
unauthorized work.
...
infotainment interfaces.66 of all incidents
In November 2025, a US-based Tier-1 supplier was hit by a were related to
ransomware attack. Attackers claimed to have stolen and leaked ransom activities
...
Data / sensitive data such as intellectual property (IP), trade secrets, financial
...
Business disruption disrupt fleet operations).
...
Service / Business 34%
disruption
Car system manipulation / 22%
Vehicle control
Fraud 12%
Car theft / Break-ins 3%
Location tracking 2%
2%
Malware
1%
...
Number of 42.5% 40.4% 14.6% 7.5% 4.3%
Mobility Assets
Potentially 32.5% 34.4%
Impacted
35.9%
Low
Up to 10
...
with threat actors doubling down on high-value targets across vehicles, 67
...
application servers, turning backend infrastructures into the rise in attacks
central battlefield of 2025.
against EV
API-based attacks remained consistently high (18% in 2025 compared charging
...
Security
4499
This shift signals that AI must now be treated not only
...
01
Relay attacks Attackers intercept and extend the communication between the
using a “live” key fob and the vehicle, even when the fob is out of range. Radio
signal amplifiers placed near the victim's home or vehicle bridge the
signal, tricking the car into unlocking and starting.
02
Replay attacks Attackers can capture messages exchanged between the key fob
using a stored and the vehicle and store them for later use. With the captured
signal signal, they can unlock or start the vehicle at any time.
03
Reprogramming Sophisticated tools can reprogram key fob systems through the
key fobs OBD port. These tools, often legitimate devices sold online to
mechanics, can be misused to render the original key useless and
grant full vehicle control.
04
Jamming Attackers use radio jammers to block communication between the
communication key fob and the vehicle. When a driver attempts to lock their vehicle,
the jammer silently prevents the command from reaching the
receiver, leaving the vehicle unlocked.
05
Impersonating A common attack method involves CAN injection. By accessing
the wireless key exposed CAN wiring (e.g., via headlights) and impersonating the
fob ECU with CAN wireless key fob electronic control unit, attackers can inject unlock
injection or start commands, bypassing both the key fob and the immobilizer.
06
Phone-as-a-Key Smartphone-based digital key systems rely on BLE, NFC, and UWB.
(PaaK) While these technologies enhance convenience, they introduce new
...
The clear web is the smallest and most Public automotive, mobility,
and cyber media coverage
familiar part of the internet.132 It requires
only a standard browser to access, and its Verified researchers’ public
content is fully indexed by popular search blogs and reports
...
paywalls, or restricted portals that block Private messaging apps
web crawlers. For most people, it includes Paste sites
...
The dark web is a hidden layer of the Malicious paste sites
...
the Tor browser and unique .onion URLs Closed hacking forums
...
Smart Mobility
Exploit remote-access vectors to move laterally within shared ransom attacks
IT/OT ecosystems.
more than
...
8.1% toolkits
Intellectual
property Car hacking
41.2%
manuals
Fraud operators and black hats maintained an even more severe Black hat and
fraud operator
...
High
activities accounted for 41.2%, while low-impact activities remained Massive
minimal at 6.3%.
...
Vehicle Applicable
Definition 2025 Status
Category Regulation(s)
L (all) Vehicles with fewer R155 Amendment 01 was adopted in
than four wheels (e.g., June 2024 and will be mandatory
motorcycles, scooters, starting July 2029 for CSMS
quadricycles). certification.
M Passenger vehicles R155 & R156 Fully enforced from July 2024 for
(≥ 4 wheels – carrying all new vehicles.
passengers).
N Goods vehicles (≥ 4 wheels). R155 & R156 Fully enforced since July 2024.
O Trailers with electronic R155 & R156 Compliance required for new
control units (ECUs). approvals from July 2024.
R Agricultural trailers. R156 Guidance in preparation for 2026
implementation.
S Interchangeable towed R156 Covered by national type approval
agricultural/forestry schemes aligned with the UNECE
equipment. framework.
T Any motorized, wheeled, R156 Optional applicability under R156
or tracked agricultural when software-update ECUs are
equipment that has two present.168
...
|     | Primary   | Lifecycle   | Recent Updates  |
| --- | --------- | ----------- | --------------- |
Standard
|     | Focus | Coverage | and Implementation |
| --- | ----- | -------- | ------------------ |
ISO/ Engineering cybersecurity  Full vehicle  •  Lifecycle cybersecurity
SAE  framework covering full  lifecycle obligations remain central to
| 21434 | vehicle lifecycle, including  |     | CSMS audits. |
| ----- | ----------------------------- | --- | ------------ |
...
decommissioning.
R155  Organizational governance  Full vehicle  R155 guidance reaffirmed
(CSMS) and regulatory oversight for  lifecycle continuous fleet-monitoring
|     | type approvals, including  |     | requirements, mandatory               |
| --- | -------------------------- | --- | ------------------------------------- |
|     | competence, supplier       |     | event-logging, and long-term          |
|     | management, post-          |     | cybersecurity-evidence retention for  |
|     | market surveillance, and   |     | CSMS audits.176                       |
auditability.
R156  Secure, auditable software  Operations  OEMs advanced SUMS alignment
(SUMS) update management  and  and adopted automated integrity-
framework ensuring safety,  maintenance verification and validation measures
|     | authenticity, rollback, and  |     | for OTA and workshop update  |
| --- | ---------------------------- | --- | ---------------------------- |
|     | documentation controls for   |     | packages.177                 |
...
Relevance to
ISO/SAE Requires detailed TARA coverage of wireless threats
...
Regulation /
Effective / Reference Date Key Relevance to Automotive Cybersecurity
Standard
ITU Radio In force from January Provides the global spectrum framework for ITS,
Regulations 2025 V2X, and eCall frequencies. Defines coexistence
(WRC-23 Edition) rules relevant to RF risk modeling and regulatory
conformity.181
FCC Part 15 (US) Updates referenced in Regulates unlicensed RF devices in vehicles
January 2025 FCC policy (key fobs, Wi-Fi, BLE, UWB). Aligns with current
brief US C-V2X and 5.9 GHz allocation policy.182
ETSI EN 302 571 Amended in 2025 to Specifies technical parameters for ITS radios
(European Union) align with EN 303 613 (5.855-5.925 GHz) used in secure V2X
coexistence criteria communications.183
ISO 15118 (V2G) Second edition Defines secure authentication and encrypted
reaffirmed 2025 communication between EVs and chargers.
Complements ISO 24089 and R156 update-
security requirements.184
SAE J2945/1 (V2V 2025 review cycle open Specifies secure on-board V2V safety
Safety Comms) (SAE ITC notice May 2025) communication requirements, integrated into RF
TARA work under 21434.185
ETSI EN 303 645 Confirmed 2025 Provides baseline IoT security provisions
(IoT Baseline) applicable to automotive IoT peripherals and
infotainment subsystems.186
Directive 2014/53/ In force since June 2016, Sets EU wide security obligations for radio-
EU RED - Radio cybersecurity requirements equipped automotive devices (Wi-Fi, BLE, UWB,
Equipment Directive become mandatory from keyless entry, V2X), requiring protection of
(EU) August 2024 networks and personal data.187
IEEE 802.11p, Approved July 2010 A standard tailored for V2X communication.
known as Wireless It enables real-time wireless communication
Access in Vehicular between vehicles (V2V) and between vehicles and
Environments infrastructure (V2I).188
(WAVE)
SAE J3105 First published in Defines requirements for automated conductive
January 2020 DC charging of heavy duty EVs, including secure
...
| -------- | --- | ----- | --- |
& Dates
00-series entry   22.09.2025 Regulation  R171 formally enters into force, enabling
into force becomes active DCAS type approvals under the 00-series.204
Initial implementation  To be defined by approval  UNECE has not established mandatory “new
| window |     | model” or “all production” dates.205 |     |
| ------ | --- | ------------------------------------ | --- |
authorities
01-series  March 2025 (adopted) WP.29 adopts 01-series amendments refining
amendments adopted DCAS definitions, test procedures, and HMI
requirements.206
...
|          |                  | All New  | Notes / Small-Volume   |
| -------- | ---------------- | -------- | ---------------------- |
| Category | New Type Vehicle |          |                        |
|          |                  | Vehicles | Manufacturer Delay     |
Light-duty vehicles  November 2026 November  Starting July 2030 for
| (Categories   |     | 2027 | vehicles constructed by  |
| ------------- | --- | ---- | ------------------------ |
M1 & N1)
small-volume manufacturers.
Heavy-duty vehicles  May 2028 May 2029 209 Starting July 2031 for small-
| (Categories          |     |     | volume manufacturers in  |
| -------------------- | --- | --- | ------------------------ |
| M2, M3, N2, N3, O3,  |     |     | these categories.        |
O4)
| Tires             | Class C1 tires: new types  | Class C1    |     |
| ----------------- | -------------------------- | ----------- | --- |
| (abrasion / wear) | from July 2028             | tires (all  |     |
new): from
Class C2 tires: new types
|     | from April 2030  | July 2030  |     |
| --- | ---------------- | ---------- | --- |
...
Next Steps / Notes & Cybersecurity
Category 2025 Status
Forthcoming Deadlines Relevance
Road vehicles GSR fully in force Full application to all OEMs must demonstrate
(M and N as of July 2024. All new vehicles from July integration of GSR safety
categories) new vehicle types 2026. features and maintain an
certified under the new approved CSMS for type
framework. approval.
Intelligent and Lane-keeping, intelligent Expansion of mandatory These systems increasingly
active safety speed assistance, and driver-distraction and depend on connected
systems advanced emergency fatigue monitoring sensors and HMI interfaces,
braking are now systems between 2026– raising data-security and
standard on new 2027. privacy requirements.
models.
Data and Basic event data Enhanced EDRs with EDR and eCall data handling
event- recorders (EDRs) and extended retention and must comply with GDPR and
recording emergency call (eCall) cyber-tamper protection secure-by-design principles
functions modules operational. required by 2027–2028. to prevent manipulation or
unauthorized access.
© 2026 Upstream Security Ltd. All Rights Reserved
...
Regulation / Lead Key Provisions / Upcoming
Initiative Agency Impact Milestones
Connected Department The final rule was published in January Bans expected to impact
Vehicle Supply of 2025, addressing national security risks 2027 year models for
Chain Rule Commerce in connected vehicle hardware and software components,
(15 CFR Part 791 software linked to China or Russia. and 2030 year models for
Subpart D)230 hardware components.232
Applies to Vehicle Connectivity System
(VCS) and ADS components.231
Cyber Risk TSA / CISA Requires cybersecurity risk-management First enforcement cycle
Management programs for US transport operators will begin in 2026,
Programs for that manage vehicle fleets (buses, trains, establishing unified
Transport233 logistics), including NIST CSF alignment transport sector reporting.
and cyber incident reporting to CISA.
Indirectly impacts connected and fleet-
operated vehicles rather than vehicle
manufacturers.
FCC “Cyber FCC The national labeling program was Program evaluation and
Trust Mark” launched in January 2025, focusing on potential refinement
Certification234 certifying IoT and connected vehicle following initial rollout
devices that meet baseline cybersecurity of the Cyber Trust Mark,
and privacy standards. subject to further FCC
action.
NHTSA NHTSA April 2025 announcement to update 2022 Revised draft expected
Cybersecurity guidelines for software-defined vehicles, 2026, including AI-safety
Best Practices OTA updates, and AI-driven ADAS assurance and data
Update235 systems. logging integrity.
AI White Published in June 2025, it sets the Implementation guidance
Accountability House baseline expectations for AI safety, and test programs under
Policy transparency, and cybersecurity in critical development for 2026.
Framework systems, including automotive AI.
...
GB 44495, The three mandatory OEMs operating in China must prepare
44496, 44497 national standards will CSMS- and SUMS-equivalent documentation,
take effect for new vehicle perform required test validations, and ensure
Implementation
types in January 2026. For data recorders comply with new technical
previously certified models, requirements.
the transition extends to
January 2028.
ADAS OTA and The MIIT/SAMR Notice This closes regulatory loopholes that
Recall Regulation (February 2025) entered previously allowed unapproved software
into force immediately. modifications and strengthens post-market
Any autonomous or ADAS- accountability for safety and cybersecurity in
related OTA update must be ICVs.
...
| Region /   |     | Implementation  | Enforcement  |
| ---------- | --- | --------------- | ------------ |
Regulation  Focus
| Country |     | Date | Status |
| ------- | --- | ---- | ------ |
ETSI EN 303 645 IoT / EVCS  August 2025 Mandatory from August 2025,
for RED-scoped radio/IoT
| EU              |           |              | devices.255   |
| --------------- | --------- | ------------ | ------------- |
| NIS2 Directive  | Critical  | October 2024 | Mandatory 256 |
infrastructure
EU Cyber Resilience Act  IoT, connected  October 2024 Mandatory from May 2027
| (CRA) | devices, EVCS |     | (with early reporting rules  |
| ----- | ------------- | --- | ---------------------------- |
2026).257
Alternative Fuels  EVCS April 2025 Mandatory for all new public
Infrastructure Regulation  charging stations.
(AFIR, (EU) 2023/1804)
| NIST IR 8473 | EVCS | October 2023 | Voluntary 258 |
| ------------ | ---- | ------------ | ------------- |
CISA EV Charging  EVCS  July 2025 Advisory; used by NEVI and
US
Infrastructure Cybersecurity  DOE grant programs.259
Guidelines (2025)
| National Electric Vehicle  | EVCS | April 2023 | Mandatory260 |
| -------------------------- | ---- | ---------- | ------------ |
Infrastructure (NEVI)
Standards
...
| GB/T 34658-2017   | EVCS information  | December   | Voluntary |
|                   | systems           | 2017       |           |
MIIT Draft Guideline for  EVCS  August 2025 Expected finalization in
| Electric-Vehicle Charging  | cybersecurity  |     | 2026.261 |
| -------------------------- | -------------- | --- | -------- |
Cybersecurity Management governance
| BSI PAS 1878:2021 /    | Smart      | December  | Voluntary |
| ---------------------- | ---------- | --------- | --------- |
| PAS 1879:2021 – Smart  | appliances | 2021      |           |
UK Appliances and Energy
Smart Appliance (ESAs)
Interoperability Code of
Practice (BSI)
The Electric Vehicles (Smart  EVCS December  Mandatory; strengthened
| Charge Points) Regulations  |     | 2022 | by Ofgem 2025 update  |
| --------------------------- | --- | ---- | --------------------- |
2021 (SI 2021/1467) (encryption & logging).
MIC IoT 5G Comprehensive  IoT June 2019 Mandatory; ongoing updates
Security Measures in 2025 for 6G transition.262
Japan
METI IoT Security and Safety  IoT November  Mandatory. Updated in 2025
| Framework |     | 2020 | to align with ISO/IEC 27400. |
| --------- | --- | ---- | ---------------------------- |
© 2026 Upstream Security Ltd. All Rights Reserved
...
The Fusion codes (DTCs) analytics, fleet operations telemetry, and cyber threat
vSOC detection. Fusion vSOCs rely on close collaboration with enterprise IT
...
The IT-OT
vSOC include monitoring of production environments, factory OT networks,
...
The Product within a larger, continuously operating product system. This includes
SOC vehicles, embedded software, backend platforms, mobile applications,
...
119
AI and ML models are foundational to this transformation. When implemented
...
Continuous 24/7 monitoring across Near real-time detection of threats,
vehicles, cloud backend systems, APIs anomalies and misuse using automotive
and other connected services and product-specific analytics
Ingestion and correlation of high- Intelligent alert triage, investigation and
volume and multi-domain telemetry at analyst augmentation
fleet scale
Predictive threat identification through
Continuous vehicle, software, and threat modeling, intelligence fusion, and
service risk posture assessment adversarial testing inputs
throughout the entire lifecycle
Proactive threat hunting across vehicle
Standardized governance, policies, and product domains, including internal,
procedures, and operating processes, external and third-party API traffic
aligned with automotive regulations
Governance of SDV change events,
Deep integration with SIEM and including OTAs, configurations, feature
SOAR platforms to enable evidence activations, and more
...
Vehicle, user, and device location Authentication, billing, and entitlement history
Vehicle identity and user identity attributes EV charging protocols and infrastructure telemetry
Real-time and historical vehicle telematics OTA activity and configuration state
©© 22002266 UUppssttrreeaamm SSeeccuurriittyy LLttdd.. AAllll RRiigghhttss RReesseerrvveedd
...
Product SOC API-related threats. This correlation extends beyond OWASP Top 10 coverage
(PSIRT to include complex multi-step attacks and operational or misuse use cases.
integration) Resulting insights can directly augment PSIRT workflows, bug bounty programs,
...
IT Security & API security posture. These insights enhance existing SOC processes,
Operations inform incident response playbooks, and enrich cyber threat intelligence with
