...
![Chart 1: Breakdown of incidents detected by the Expel SOC in 2022 and 2023](placeholder_for_chart_1.png)
...
![Chart 2: Initial alert source](placeholder_for_chart_2.png)
...
![Chart 3: BEC (email compromise) vs. BAC (application compromise) in 2023](placeholder_for_chart_3.png)
...
![Chart 4: The increase in identity incidents throughout 2023](placeholder_for_chart_4.png)
...
![Chart 5: Identity incidents by vertical industry](placeholder_for_chart_5.png)
...
![Chart 6: Breakdown of malicious login sources](placeholder_for_chart_6.png)
...
![Image 1: Expel Workbench™ IP lookup results for an anomalous login](placeholder_for_image_1.png)

![Image 2: Results from automated review of user behavior](placeholder_for_image_2.png)
...
![An employee receives a phishing email leading to an attacker-controlled website](placeholder_for_image_3.png)
![The attacker intercepts the traffic and leverages the user’s session cookie](placeholder_for_image_4.png)
