...
The official report URL is: https://checkmarx.com/product/application-security-platform/
...
![Figure 1: What is your level of knowledge on software supply chain security? (SSCS)](Image description)
...
![Figure 2: How much are you concerned about SSCS in your organization?](Image description)

![Figure 3: What is the primary reason you care about or are searching for SSCS?](Image description)
...
- 41% are aware of EO 14028
- 57% are aware of EO 14028 but not following it

![Figure 4: If you are requesting SBOMs from your third-party software providers, how well do you think your organization uses them?](Image description)
...
![Figure 5: How much of your AppSec focus and resources are dedicated towards each step of the SDLC?](Image description)
...
Checkmarx Expert Insight: Tzachi Zornstein explains why an SBOM wouldn’t help identify the Ledger Connect Kit attack:
...
![Figure 6: Which of the following SSCS technologies/approaches do you use or plan to use?](Image description)
...
![Figure 7: Who has the primary responsibility for SSCS in your organization?](Image description)
