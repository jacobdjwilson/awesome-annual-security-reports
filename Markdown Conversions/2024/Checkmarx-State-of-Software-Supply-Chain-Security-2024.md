...
With much of the recent focus on SSCS being on vulnerabilities or malicious code in open source software, respondents estimated that, on average, about 56% of their applications contained open source software.
...
---
*Image Description: A pie chart titled "What is your level of knowledge on software supply chain security? (SSCS)". The chart is divided into five sections, each representing a different level of knowledge. The sections are labeled as follows: "Actively using a product" (2%), "Actively purchasing and implementing a product" (5%), "Planning to use, already researched products" (15%), "Planning to use, already investigated concepts or requirements" (54%), and "Not using/no plans to use but aware of attacks from the news of other sources" (24%).*
...
---
*Image Description: A pie chart titled "How much are you concerned about SSCS in your organization?". The chart is divided into four sections, each representing a different level of concern. The sections are labeled as follows: "Very concerned" (39%), "Concerned" (36%), "Neutral" (20%), and "Unconcerned" (4%).*
...
---
*Image Description: A horizontal bar chart titled "What is the primary reason you care about or are searching for SSCS?". The chart displays the percentage of respondents who selected each reason. The reasons are listed vertically on the left and the bars extend horizontally to the right, representing the percentage. The reasons are: "It's necessary to maintain competitiveness in our market" (24%), "It's a board-level directive" (16%), "It's required for compliance" (16%), "I see a lot of news about attacks" (17%), and "I'm investigating additional risks beyond what we consider today" (27%).*
...
Checkmarx scans millions of OSS packages every month and has detected more than 200,000 malicious packages to date. A robust SCA solution, featuring what was described above, is a good start to an SSCS program.
...
---
*Image Description: A pie chart titled "If you are requesting SBOMs from your third-party software providers, how well do you think your organization uses them?". The chart is divided into two sections, each representing a different level of usage. The sections are labeled as follows: "Deployed but not using effectively" (53%), and "Deployed and using effectively" (47%).*
...
are aware of EO 14028 but not following it
...
---
*Image Description: A horizontal bar chart titled "How much of your AppSec focus and resources are dedicated towards each step of the SDLC?". The chart displays the percentage of resources dedicated to each stage of the Software Development Life Cycle (SDLC). The stages are listed vertically on the left, and the bars extend horizontally to the right, representing the percentage. The stages are: "Design" (68%), "Develop" (15%), "Test" (9%), "Deploy" (5%), and "Maintain" (3%).*
...
SCA and SBOMs are common entry points to SSCS, but we know that organizations are ready to put a lot of effort into building it out further, so where’s a good place to start?
...
---
*Image Description: A horizontal bar chart titled "Which of the following SSCS technologies/approaches do you use or plan to use?". The chart displays the percentage of respondents who use or plan to use various SSCS technologies. The technologies are listed vertically on the left, and the bars extend horizontally to the right, representing the percentage. Each technology has three bars: "Deployed and using effectively" (darker), "Deployed but not using effectively" (lighter), and "Not using but plan to" (lightest). The technologies are: "Govern access to software development", "Scan IaC templates", "Detect leakage of secrets or sensitive data", "Establish artifact repositories for trusted content", "Request SBOMs of third-party software", "Detect malicious code in open source software", and "Identify vulnerabilities in open source software".*
...
---
*Image Description: A pie chart titled "Who has the primary responsibility for SSCS in your organization?". The chart is divided into four sections, each representing a different department or role. The sections are labeled as follows: "Development" (23%), "AppSec" (19%), "Security champion" (28%), and "DevOps/DevSecOps" (29%).*

**FIGURE 07**

Who has the primary responsibility for SSCS in your organization?

Our research shows that no single department has full responsibility for SSCS (Figure 7), and we’d argue that is just how it should be. It needs to be a shared, interdisciplinary process with good awareness among all stakeholders. Where organizations have a security champion, they can play a bridging role to get different stakeholders across security and development aligned.
...
* [2024 State of Software Supply Chain Security](#2024-state-of-software-supply-chain-security)
    ...
    * [Beyond SBOMs: Building an Interdisciplinary SSCS Program](#beyond-sboms-building-an-interdisciplinary-sscs-program)
        * [Checkmarx Expert Insight:](#checkmarx-expert-insight)
    ...
    * [Get Moving: The Next Steps in Your SSCS Journey](#get-moving-the-next-steps-in-your-sscs-journey)
        ...
        * [Expand existing SCA coverage](#expand-existing-sca-coverage)
        * [Integrate SBOMs into SCA](#integrate-sboms-into-sca)
        * [Build on Your SCA Investment](#build-on-your-sca-investment)
        * [Explore a platform approach](#explore-a-platform-approach)
