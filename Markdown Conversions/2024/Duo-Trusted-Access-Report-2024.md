...
## Table of contents
* [The New Frontier of Access Management and Identity Security](#the-new-frontier-of-access-management-and-identity-security)
* [Methodology](#methodology)
* [Key Findings](#key-findings)
    * [Billions of Authentications](#billions-of-authentications)
    ...
    * [Attack Surface Increase](#attack-surface-increase)
    ...
    * [Establishing Device Trust](#establishing-device-trust)
    ...
    * [Powerful Policy Controls](#powerful-policy-controls)
...
* [Closing Words](#closing-words)
    ...
    * [Context is the New MFA](#context-is-the-new-mfa)
...
Contextual factors such as location or device details 
...
IR, attackers were able to abuse compromised credentials to access valid accounts<sup>1</sup>. The 
average company has 40.26% of accounts with either no MFA or a weak MFA<sup>2</sup>.
...
*A line graph shows the monthly successful authentications in billions from September 2019 to May 2023. The graph shows a general upward trend with some seasonal variations. The lowest point is around 200 million in late 2019 and the highest point is around 1.4 billion in early 2023.*
...
*A stacked area chart shows the percentage of authentications over time from June 2019 to June 2023, broken down by authentication factor. The chart shows that "Push" is the largest factor, followed by "Policy-enabled 2FA", with "Phone & SMS" being the smallest and decreasing over time. "WebAuthn/U2F" is a small but growing factor.*
...
*A line graph shows the percentage of accounts using WebAuthn for authentication from May 2019 to May 2023. The graph shows a steady increase in WebAuthn adoption over time.*

Figure 04 WebAuthn adoption by market segment
*A series of bar charts show the percentage of organizations enabling WebAuthN across different market segments (Very Small Business, Small & Medium Business, Mid-Market, Enterprise) for the years 2020, 2021, 2022, and 2023. The charts show that Enterprise has the highest adoption rate, followed by Mid-Market, Small & Medium Business, and Very Small Business.*
...
*A line graph shows the percentage of authentications for remote access applications from September 2019 to March 2023. The graph shows a peak in authentications around 2020 and a gradual decline since then.*
...
the Cisco Secure Readiness Index study<sup>3</sup>.
...
the average company has 40% of accounts with either no MFA or weak MFA<sup>4</sup>. Especially 
...
a zero trust strategy<sup>5</sup>.
...
Report<sup>6</sup>. On the reactive side, the tool equips IT teams to respond to suspicious activities such as 
...
*A horizontal bar chart shows the percentage increase and decrease in authentications for the top 10 countries. The chart shows that Germany has the highest increase and China has the highest decrease.*
...
*A horizontal bar chart shows the average number of different countries accessed by organizations of a particular country. The chart shows that Hong Kong has the highest average number of different countries accessed.*
...
observed<sup>7</sup>. While one major vulnerability is improperly implemented MFA 
...
Hotmail, iCloud, etc.) with access to company data<sup>8</sup>. With the BYOD and 
