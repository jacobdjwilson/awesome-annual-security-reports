...
On one hand, these identities can enable more seamless collaboration and access to necessary resources, improving efficiency. On the other hand, managing these numerous identities and ensuring they are properly secured becomes a complex task.
...
![Figure 05 Authentications for Remote Access Applications](Image description: A line graph showing the percentage of authentications for remote access applications from September 2019 to March 2023. The graph shows a peak in 2020 and a subsequent decline.)
...
---
**Footnotes:**
3. See “Cisco Cybersecurity Readiness Index,” which categorizes companies into four stages of readiness: from Beginner, to Formative, Progressive, and finally Mature, based on their preparedness across five key pillars and the state of deployment of 19 security solutions within those.
...
![Figure 06 The top 10 countries that experienced an increase or decrease by authentication volume based on access device IP address](Image description: A bar chart showing the percentage increase or decrease in MFA authentications using Duo in various countries over the past year. Positive bars indicate an increase, and negative bars indicate a decrease.)

![Figure 7 Average number of different countries accessed by organizations of a particular country](Image description: A bar chart showing the average number of different countries from which users authenticate for organizations in various countries. The chart highlights a 72% increase in geographic diversity for organizations in the US, UK, and Canada.)
...
*   Firefox: 13%
*   Mobile Safari: 17%
*   Mobile Safari WebView: 4.7%
*   Chrome Mobile iOS: 4.6%
*   Edge Chromium: 12.6%
*   Safari: 6.7%
*   Edge: 5.2%

![Figure 8 Different browsers used for authentication](Image description: Two sets of bar charts showing the percentage of desktop and mobile authentications by browser. The desktop charts compare Chrome, Edge Chromium, Safari, Firefox, DuoWinLogon, IE, and AnyConnect. The mobile charts compare Mobile Safari, Chrome Mobile, Mobile Safari WebView, Chrome Mobile iOS, Edge Chromium Mobile, Firefox Mobile, Opera Mobile, and OktaMobile.)

![Figure 9 Percentage of mobile browsers used](Image description: A stacked area chart showing the percentage of mobile browsers used from 2020 to 2023, with Mobile Safari, Chrome Mobile, Mobile Safari WebView, Edge Chromium Mobile, Firefox Mobile, Opera Mobile, and OktaMobile as categories.)
...
![Figure 10 Typical (geometric mean) percentage of successful authentications using out-of-date browsers](Image description: A bar chart showing the typical percentage of successful authentications using out-of-date browsers across different regions: APAC, AMER, EMEA, and LATAM.)
...
![Figure 11 OS diversity and percentage of authentications that use an out-of-date operating system](Image description: A scatter plot showing OS diversity on the x-axis and the proportion of successful authentications with an out-of-date operating system on the y-axis. The plot illustrates a correlation between OS diversity and the likelihood of using out-of-date OSes.)
...
69.2% of global policies included WebAuthn, a promising move towards stronger methods of authentication
...
*   **Automation**: These policies can often be enforced automatically, reducing the need for manual intervention