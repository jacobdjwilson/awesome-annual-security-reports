...
*   **Over 66 million** BEC attacks were detected and blocked on average per month by Proofpoint.
...
*   **Image Description:** A vertical bar chart titled "Risky Actions Taken" shows the percentage of users who engaged in various risky behaviors. The behaviors and their corresponding percentages are:
...
*   **Image Description:** A horizontal bar chart titled "Why Risky Action is Taken" shows the percentage of users who cited various reasons for taking risky actions. The reasons and their corresponding percentages are:
    *   It is convenient (44%)
    *   To save time (39%)
    *   To meet an urgent deadline (24%)
    *   To meet other performance objectives (19%)
    *   To save money (11%)
    *   To achieve a revenue target (10%)
...
*   **Image Description:** A pie chart titled "Perception on Security Responsibility" compares the responses of security professionals and employees regarding their perception of security responsibility. The chart shows the following:
    *   **Security Professionals:**
        *   Yes – Employees think they are responsible for security (85%)
        *   No – Employees believe security is not their responsibility (13%)
        *   Not sure (2%)
    *   **Employees:**
        *   Yes – Employees think they are responsible for security (41%)
        *   No – Employees believe security is not their responsibility (7%)
        *   Not sure (52%)
...
*   **Image Description:** A horizontal bar chart titled "Users Who Represent Risk" shows the percentage of security professionals who consider various user groups as a security risk. The user groups and their corresponding percentages are:
    *   Users who have business privilege and access to critical data (63%)
...
*   **Image Description:** A table titled "Top Risks Considered by Infosec vs. Top Risky Actions Taken by Users" compares the top risks considered by security professionals with the top risky actions taken by users. The table shows the following:
    ...
    *   2 | Connect without using VPN at a public place | Access inappropriate website
    *   3 | Respond to a message (email or SMS text) from someone I don’t know | Use work device for personal activities
...
*   **Image Description:** A bar chart titled "Security Awareness Activities Assignment" compares the percentage of organizations that train different groups of people in 2022 and 2023. The chart shows the following:
    *   **Group** | **2022** | **2023**
    *   Everyone in the organization | 56% | 53%
    *   Only specific departments and roles | 28% | 41%
    *   Only specific individuals | 15% | 6%
    *   Not sure | 1% | 1%
...
*   **Image Description:** A horizontal bar chart titled "Time Allocated for Security Awareness Activities" shows the percentage of organizations that allocate different amounts of time for security awareness activities. The time allocations and their corresponding percentages are:
...
*   **Image Description:** A horizontal bar chart shows the percentage of organizations using various security awareness tactics. The tactics and their corresponding percentages are:
    *   Computer-based training (45%)
    *   In-person training sessions (38%)
    *   Simulated phishing attacks (34%)
    *   Cybersecurity-based contests and prizes (33%)
    *   Internal cybersecurity chat channel (31%)
    *   Awareness posters and videos (30%)
    *   Virtual, instructor-led training (23%)
    *   Simulated USB drops (23%)
    *   Newsletters and emails (23%)
    *   Smishing and vishing simulations (1%)
    *   Internal wiki (1%)
...
*   **Image Description:** A table titled "Actions Taken by Security Pros vs. User Motivation" compares the actions taken by security professionals to drive behavior change with the user motivations to prioritize cybersecurity. The table shows the following:
    *   **Rank** | **Actions Taken by Security Pros** | **User Motivation**
    *   1 | Provide more training | Making security easier for me
    *   2 | Increased engagement with leadership and security teams |
    *   3 | Implement more security controls or restrictions |
...
*   **Image Description:** A horizontal bar chart titled "What Policies Motivate Users to Prioritize Cybersecurity" shows the percentage of users who are motivated or not motivated by various policies. The policies and their corresponding percentages are:
    *   Making security easier for me (94% Motivating, 6% Not Motivating)
    *   Using rewards or recognition (89% Motivating, 11% Not Motivating)
    *   Increased engagement from leadership or security team (87% Motivating, 13% Not Motivating)
    *   More training or different styles of training (85% Motivating, 15% Not Motivating)
    *   Punishment, such as reduction in pay, bonus removal, job termination (71% Motivating, 29% Not Motivating)
...
*   **Image Description:** A bar chart titled "Prevalence of Attacks" compares the percentage of organizations that experienced various types of attacks in 2022 and 2023. The chart shows the following:
    *   **Attack Type** | **2022** | **2023**
    *   Bulk Phishing | 76% | 85%
    ...
    *   Smishing | 75% | 76%
    *   Vishing | 67% | 71%
    *   TOAD (Callback Phishing) | 66% | 67%
    *   Data Loss via Insider | 66% | 68%
    *   Data Loss via External Attacker | 69% | 64%
    *   Supply Chain Risk | 69% | 74%
    *   Socia Media | 65% | 66%
    *   USB Drop | 60% | 66%
...
*   **Image Description:** A pie chart titled "Does MFA Provide Complete Protection Against Account Takeover?" shows the percentage of security professionals who agree or disagree with the statement. The chart shows the following:
    *   Completely agree (9%)
    *   Somewhat agree (42%)
...
*   **Image Description:** A horizontal bar chart titled "Brand Abuse Threats (Millions)" shows the number of malicious messages associated with various brands. The brands and their corresponding number of messages (in millions) are:
    *   Microsoft (68)
    *   Adobe (9.4)
    *   DHL (8.8)
    *   Google (6.1)
...
*   **Image Description:** A pie chart titled "Ransomware by the Numbers" shows the distribution of ransomware incidents experienced by organizations. The chart shows the following:
    *   1–3 separate incidents (39%)
    *   4–6 separate incidents (15%)
    *   7–9 separate incidents (5%)
    *   10 or more separate incidents (3%)
    *   Unsure (38%)
...
*   **Image Description:** A bar chart titled "Infected Organizations That Agreed to Pay Ransom" compares the percentage of organizations that paid ransom after a ransomware attack in 2021, 2022, and 2023. The chart shows the following:
    *   2021 (58%)
    *   2022 (64%)
    *   2023 (54%)
...
*   **Image Description:** A table titled "Ransomware Infections: What Happens After Payment" compares the outcomes after paying a ransom in 2022 and 2023. The table shows the following:
    *   **Outcome** | **2022** | **2023**
    *   Regained access to data after first payment | 52% | 41%
    *   Paid additional ransom demand(s) and eventually | 43% | 41%
    *   Refused to pay addtional ransom demand(s) and walked | 6% | 15%
    *   Never got access to data even after paying ransoms | 1% | 1%
...
*   **Image Description:** A bar chart titled "Results of Successful Phishing Attacks" compares the percentage of organizations that experienced various consequences of successful phishing attacks in 2022 and 2023. The chart shows the following:
    *   **Consequence** | **2022** | **2023**
    *   Credential / account compromise | 67% | 71%
    *   Loss of data / intellectual property | 32% | 33%
    *   Ransomware infection * | 29% | 44%
    *   Breach of customer / client data | 27% | 43%
    *   Reputational damage | 25% | 18%
    *   Widespread network outage / downtime | 27% | 26%
    *   Advanced persistent threat | 23% | 22%
    *   Direct financial loss ** | 21% | 36%
    *   Financial penalty *** | 22% | 76%
    *   Other malware infection(s) | 22% | 20%
    *   Zero-day exploit | 9% | 2%
    *   I’m not sure | 20% | 30%
...
*   **Image Description:** A table titled "Simulation Type and Failure Rate" compares the failure rate and frequency of use for different types of phishing simulations in 2022 and 2023. The table shows the following:
    *   **Simulation Type** | **2022 failure rate** | **2023 failure rate** | **2022 frequency of use** | **2023 frequency of use**
    *   Link-based | 11% | 12% | 66% | 59%
    *   Data Entry | 3% | 4% | 27% | 30%
    *   Attachment | 16% | 17% | 8% | 10%
...
*   **Image Description:** A table titled "Current Industry Failure Rate" shows the failure rate of phishing simulations for various industries in 2022 and 2023, along with the change in percentage points. The industries and their corresponding data are:
    *   **Industry** | **2022** | **2023** | **Change (% points)**
    *   Marketing/Advertising | 11% | 10% | -1%
    *   Retail | 11% | 11% | 0%
    *   Aerospace | 10% | 12% | 2%
    *   Hospitality/Leisure | 10% | 11% | 1%
    *   Legal | 12% | 11% | -1%
    *   Insurance | 12% | 10% | -2%
    *   Financial Services | 16% | 9% | -7%
    *   Engineering | 10% | 11% | 1%
    *   Agriculture | 8% | 11% | 3%
    *   Real Estate | 10% | 10% | 0%
    *   Energy/Utilities | 12% | 12% | 0%
    *   Non-profit | 10% | 11% | 1%
    *   Entertainment/Media | 11% | 11% | 0%
    *   Technology | 8% | 10% | 2%
    *   Automotive | 11% | 11% | 0%
    *   Consulting | 13% | 10% | -3%
    *   Electronics | 10% | 12% | 2%
    *   Healthcare | 12% | 13% | 1%
    *   Manufacturing | 10% | 12% | 2%
    *   Finance | 16%