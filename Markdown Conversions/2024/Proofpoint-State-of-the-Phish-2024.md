...
![Chart showing Risky Actions Taken: Use work device for personal activities, Reuse or share password, Connect without using VPN at a public place, etc.]

Users took risky actions for a variety of reasons: convenience, time saving and urgency being the most common answers. But a small cohort of 2.5% took risky actions purely out of curiosity.

![Chart showing Why Risky Action is Taken: Convenience, Urgency, Time saving, etc.]
...
![Chart comparing perception of security responsibility between employees and security professionals]

## Security Awareness Trends

While training alone isn’t enough to change unsafe behavior, teams that lack basic security awareness tools and knowledge are still much more likely to fall prey to cybercriminals.

### Current state of security awareness

First some positive news: 99% of respondents said they have a security awareness program of some sort up and running. But while the basics may already be in place, many are struggling to drive real behavioral change. A possible reason for this is that only 53% say they train everyone in the organization (down from 56% last year).

![Chart showing Security Awareness Activities Assignment]

### Areas for improvement

Security is not only a technical issue, but also a cultural and organizational one. It requires the collaboration and commitment of all stakeholders.

According to our survey, security professionals believe that more training, tighter controls, closer business alignment, better rewards and stronger championing of security initiatives would all be effective in improving security. However, fewer than a third of organizations reward positive user behaviors or champion security initiatives.

![Chart showing What Policies Motivate Users to Prioritize Cybersecurity]
...
![Chart showing Prevalence of Attacks: Bulk Phishing, USB Drop, Spear Phishing, etc.]

### Growing threats: TOAD, MFA-Bypass, QR codes and generative AI

In telephone-oriented attack delivery (TOAD), the malicious message often appears to be completely benign, containing nothing more than a phone number and some erroneous information. Our data reveals that an average of 10 million TOAD messages are sent every month.

Another increasingly popular attack method involves using advanced techniques to bypass multifactor authentication (MFA). We see around 1 million phishing threats using the popular EvilProxy framework every month.

### BEC attacks benefit from AI

BEC attacks also continue to pose a serious threat, especially in non-English-speaking countries. Our own data shows an average of 66 million targeted BEC attacks every month.

### Microsoft remains most-abused brand

Brand abuse is a favorite tactic for phishing and malware delivery. More than 68 million messages were associated with Microsoft products and brand in 2023, making it the most abused brand by cybercriminals.

![Chart showing Brand Abuse Threats (Millions)]

### Ransomware still a major concern

The percentage of organizations that faced a ransomware attack rose 5 percentage points to 69%. Almost 60% of organizations reported four or more separate ransomware incidents in a year.

![Chart showing Ransomware by the Numbers]

### Attack consequences

The impact of phishing attacks on organizations can be devastating. 71% of organizations experienced at least one successful phishing attack in 2023. Year on year, we saw a 144% increase in reports of financial penalties, such as regulatory fines, and a 50% increase in reports of reputational damage due to phishing incidents.

![Chart showing Results of Successful Phishing Attacks]

## Organizational Benchmarks

One of the ways that organizations can measure and improve their cybersecurity awareness and resilience is by conducting phishing simulations. Our customers conducted 183 million phishing simulations over a 12-month period.

![Chart showing Simulation Type and Failure Rate]

We also analyzed failure rates by industry and found some interesting patterns. The finance industry saw the most improvement, with failure rates decreasing by 7 percentage points.

![Table showing Current Industry Failure Rate by sector]

Overall failure rates for simulated phishing dropped to 9.3%, from 10% in 2022. Based on these reporting and failure rates, we calculate a Resilience Factor for each organization. The average Resilience Factor increased to 2.0 in 2023, from 1.7 in 2022.

## Conclusion

A security awareness program should be an essential component of any organization’s security strategy, but by itself it isn’t enough. The challenge is now not just awareness, but behavior change.

To lead this change, organizations should:
1. **Use threat intelligence to inform your behavior change program.**
2. **Reduce security friction:** Track where security controls create bottlenecks and work to alleviate them.
3. **Go beyond training:** Build a strong security culture with better communication and engagement.
