...
Organization: Howden  
Report Title: Cyber-Report  
Year: 2024  

## Table of Contents
- [Key takeaways](#key-takeaways)
- [Executive summary](#executive-summary)
- [01 A pervasive threat](#01-a-pervasive-threat)
- [02 Systemic cyber: the known unknown](#02-systemic-cyber-the-known-unknown)
- [03 Gen AI: a double-edged sword](#03-gen-ai-a-double-edged-sword)
- [04 The path to maturity](#04-the-path-to-maturity)

---

## Key takeaways

Cyber continues to live up to its dynamic reputation. With no sign of the risk landscape abating – as demonstrated by ransomware, geopolitical instability and the proliferation of Gen AI – market conditions offer businesses an opportunity to secure insurance cover at favourable terms. The foundations are now in place for the next phase of development, with opportunities in international geographies and other underserved areas poised to drive growth. Increased insurance penetration is the path to resilience and relevance.

### Fluid threat environment
- **Ransomware frequency and severity: a mixed picture** *(Source: Howden, NCC Group)*
- **Mean ransom payment**: % of incidents where ransom is paid.
- **Cyber insurance pricing down 15% from peak** *(Source: Howden)*

### Untapped potential
- **Share of projected premium growth up to 2030** *(Source: Howden)*: Major economies in Europe, Asia and LatAm have considerable growth potential given current penetration levels (54% U.S., 46% RoW).
- **Existing share of organisations with cyber insurance globally; SMEs underserved** *(Source: WEF)*: SMEs are the backbone of economic activity in advanced economies and rely heavily on technology. (Large organisations: 75%, SMEs: 21%).
...
Against this backdrop, the market has two standout opportunities to preserve market leading annual growth and secure long-term relevance: expansion beyond the U.S. and serving a broader client base amongst small and medium-sized enterprises (SMEs) across all regions.
...
## 01 A pervasive threat

After a prolonged run of market leading growth, cyber insurance is entering a new phase in its journey to maturity. Having navigated the early stages of development that often come with new, fast growing lines of business, competition is now increasing as insurers look to grow in a space that has huge potential and is relevant to businesses worldwide. With little sign of the threat environment abating any time soon – the last 12 months have brought resurgent ransomware activity (including a number of high-profile attacks on healthcare entities), persistent geopolitical instability and the proliferation of generative artificial intelligence (Gen AI) – current market conditions offer clients and prospects an opportunity to secure protection at favourable terms.

![Figure 1: Cyber threat landscape in 2024](Figure_1_Cyber_threat_landscape.png)
...
![Figure 2: Allianz Risk Barometer 2024](Figure_2_Allianz_Risk_Barometer.png)

![Figure 3: Growing profile of cyber risk amongst corporations and policymakers](Figure_3_Growing_profile.png)
...
![Figure 4: Frequency index for ransomware – 1Q21 to 1Q24](Figure_4_Frequency_index.png)
...
![Figure 5: Cumulative global ransomware activity by month – 2022 to 2Q24](Figure_5_Cumulative_global.png)
...
![Figure 6: Distribution of ransomware attacks by companies’ annual revenue in 2023/24](Figure_6_Distribution.png)
...
Available data presents a nuanced picture, with recent large-scale attacks underlining how the ransom payment (if there is one) can be only the tip of the iceberg.
...
![Figure 7: Revenue received by ransomware attacks – 2019 to 2023](Figure_7_Revenue_received.png)

![Figure 8: Distribution of ransom payment amounts – 2022 to 2024](Figure_8_Distribution_ransom.png)

![Figure 9: Proportion of ransomware victims paying a ransom – 1Q19 to 1Q24](Figure_9_Proportion.png)
...
![Figure 10: Mean ransom payments and recovery costs from ransomware attacks – 2021 to 2024](Figure_10_Mean_ransom.png)
...
![Figure 11: Ransomware claims frequency and severity for Coalition policyholders – 2020 to 2023](Figure_11_Ransomware_claims.png)
...
## 02 Systemic cyber: the known unknown
...
Hostile governments nevertheless continue to shield criminal actors in their respective countries, allowing them to operate with near impunity when attacking Western companies and critical infrastructure. Healthcare has been a prime target for a number of years now, likely reflecting the prevalence of legacy (and interconnected) systems, large volumes of sensitive data and a relatively high willingness to pay ransoms to restore operations quickly and protect life.

Figure 12 shows that the number of ransomware attacks on U.S. critical infrastructure increased by a CAGR of 35% between 2021 and 2023.

![Figure 12: Reported ransomware attacks on U.S. critical infrastructure – 2021 to 2023](Figure_12_Reported_ransomware.png)
...
![Figure 13: Insured loss estimates for high-profile cyber events vs GWP for global cyber market](Figure_13_Insured_loss.png)
...
None of which is intended to minimise the potential for risk aggregation. A large-scale event that resulted in a widespread cloud outage, disrupted global payment platforms or compromised software that underpins global digital systems would pose a serious risk to the market and broader economies, although this is true of tail events in several other lines of business.
...
![Figure 14: Estimated economic distribution from major ransomware attacks in 2023/24](Figure_14_Estimated_economic.png)
...
> 
> An incident earlier this year underscores this systemic risk after a Microsoft engineer identified a malicious backdoor in an open-source library called XZ Utils, which is built into most Linux operating systems. This had been implanted into the code by one of its contributors, in what appears to be a meticulously planned operation over several years.
> 
> Had the compromise not been identified, the unknown actor behind the operation would have had backdoor access to almost every organisation, as Linux servers are often used to host backup systems, databases, virtualisation hosts, cloud services, web servers and enterprise resource planning systems.
> 
...
![Figure 15: Number of major state-affiliated cyber attacks – 2007 to 2023](Figure_15_Number_of_major.png)
...
![Figure 16: Major state-affiliated cyber attacks by type - April 2023 to March 2024](Figure_16_Major_state.png)
...
> **Milo Wilson**, Lead Intelligence Analyst at XCyber  
> **Bill Jarvis**, Head of Intelligence at XCyber  
> 
...
> 
> Future conflicts could differ though, with concerns centred on a war involving aggressive and competent cyber attackers that reveal highly destructive malware or other techniques to the wider world. China is amongst the most aggressive exploiters of zero-day vulnerabilities. In 2021, the Chinese government passed a law that made the reporting of vulnerabilities to authorities before public release compulsory.
> 
...
## 03 Gen AI: a double-edged sword
...
![Figure 17: Gen AI uplift to threat actor capabilities – 2024 to 2026](Figure_17_Gen_AI.png)
...
The main implication of AI-driven democratisation of hacking will be a rise in the frequency of low-level claims. Novice threat actors will find it easier to carry out phishing, which was the vector used in 84% of UK business attacks in 2023[^2]. They will have also access to chatbots to help draft high quality phishing content, akin to ChatGPT without guardrails, AI-generated reconnaissance on which businesses to target (e.g. from machine leaning trained to spot patterns in vulnerability) and even AI-generated ransomware code.
...
- **Pre-release software scanning**: Software developers can use AI to scan code for errors and vulnerabilities prior to release. This would mean that they would no longer need to scramble to address vulnerabilities once published, a critical lag that hackers exploit.
- **Maintaining open-source software**: LLMs can be used to update open-source software by, for example, translating obsolete code into a more secure language. This is important because open-source software is an underappreciated backdoor to many networks, as it can be both widely used and relatively insecure due to its maintenance by the crowd rather than vendors.
- **Data classification**: AI can be used to automate the process of data classification according to its sensitivity. This is an important use case because current data classification approaches often rely on employees, who are error prone, to do it manually. In addition, this would help to defend against the emerging threat of hackers using LLMs to spot high-value data at pace.
- **Threat hunting**: Analysts can use AI to assist with scouring the network faster and more accurately for threat actors who have slipped in under the radar. For example, an LLM could be trained to spot suspicious activity such as spikes in network traffic volumes. Over a fifth (22%) of CISOs have reportedly begun to do this[^3].

> ## Gen AI’s impact on the cyber threat landscape
> **Matt Hull**, Director Global Threat Intelligence at NCC Group  
> **Jon Renshaw**, Deputy Director of Commercial Research at NCC Group  
> 
> *AIdgmenid AstI brirsiinnggs toepnpsioorntsu naintdie ssh fiofrt ibnog th cpyriboerrit aietst abcektewrse eann dg ldoebfaeln pdoewrse arsn d looks sine tc tyob esrig snpifaiccea,n tthlye i mmopsatc tim thpeo rttharneta t tlahnredastc atop eb buysi nenesasbels ims thgeor greadwvianngc ed aptrotafecskssi ofrnoamsi otficiohns otfi ccyatbeedr carcitmoirnsa alsn d alosw theeryin gc abraryr oieurts stoop ehnitsrtyic faotre ndo avtitcaec ks whaitchk eimrsp. Tunheit yt gofroodm n hewost iilse t choaut nnterwys.*
> 
> AI-driven defences are developing at pace and effective use of more traditional risk controls can shore up resilience.
> 
...
> 
> 1. **Enabling social engineering**: LLMs are already enabling criminals to create plausible content quickly and easily. This is being used for simple, yet important tasks like correcting the language, tone, spelling and grammar of phishing emails, which means they are more targeted and credible.
> 2. **Deep fakes and voice cloning**: Criminals and hacktivist groups are already cloning a genuine person’s voice and images for online fraud, social engineering and, in some more recent cases, to spread disinformation across social media. High-profile cases where deep fake videos have been deployed to deceive targets and extract large payments reveal a step change in sophistication for capable threat actors.
...
> 
> ### Attacking AI
> NCC Group research[^4] has previously highlighted the potential of threat actors attacking AI systems to deny service or incur heavy costs for victims. These sorts of attacks are unlikely to be motivated by financial gain for the attacker, but instead to gain notoriety or for ideological motivations.
> 
...
> 
> Using AI to detect and defend against AI attacks is relatively nascent, but it is certainly an area that is developing at pace. For example, the UK Home Office Accelerated Capability Environment recently launched a deepfake detection competition[^5]. Large technology organisations and AI developers are also exploring watermarking[^6] and provenance[^7] techniques to detect when media has been generated by AI or to prove that it has not.
> 
...
## 04 The path to maturity

Despite the highly fluid threat environment, the foundations for a mature cyber (re)insurance market are now in place with the prospect of steady exposure-led growth, ongoing profitability and innovation. Competition is returning to the market as improved cyber hygiene has mitigated losses and delivered strong underwriting performance.
...
![Figure 18: Howden’s Global Cyber Insurance Pricing Index – 2014 to 2Q24](Figure_18_Howden_Global.png)
...
The post-hard market performance of cyber insurance, along with underwriting targets for 2024/25, points to satisfaction on the part of carriers that the cost of cost is commensurate with attritional loss costs.
...
![Figure 19: Cyber global gross written premium – 2012 to 2023](Figure_19_Cyber_global.png)
...
Improved market conditions reflect underwriting actions taken by carriers during the hard market.

[^1]: Figures represent how often a risk was selected as a percentage of all survey responses. Figures do not add up to 100%, as respondents were asked to name up to three risks they saw as most important.
[^2]: Department for Science, Innovation and Technology, Cyber security breaches survey, 2024.
[^3]: Splunk, The CISO report, October 2023.
[^4]: [research.nccgroup.com/2022/07/06/whitepaper-practical-attacks-on-machine-learning-systems](https://research.nccgroup.com/2022/07/06/whitepaper-practical-attacks-on-machine-learning-systems)
[^5]: [ace.blog.gov.uk/2024/04/16/unmasking-deception-join-the-deepfake-detection-challenge](https://ace.blog.gov.uk/2024/04/16/unmasking-deception-join-the-deepfake-detection-challenge)
[^6]: [deepmind.google/technologies/synthid](https://deepmind.google/technologies/synthid)
[^7]: [c2pa.org](https://c2pa.org)

---

going investments made by businesses in strengthening their risk
...
market conditions.
Risk, resilience and relevance 47
...
events are being
intercepted early.
Risk, resilience and relevance 49
...
|           | Direct written premium | Earned loss ratio |           |      |
50 Howden
...
Risk, resilience and relevance 51

The path to maturity
S-RM on
containing
costs
Roddy Priestley Martijn Hoogesteger
Director, Cyber Security at S-RM Head of Cyber Security, Benelux
at S-RM
...
ransomware groups.
Risk, resilience and relevance 53
...
| ----- | ----- | ------------- | ------ | ------------------------------ | ------ | ----- |
|       |       | United States | Europe | UK                             | APAC   |       |
|       |       | Oceana        | Canada | LatAm                          | Africa |       |
|       |       |               |        | Risk, resilience and relevance |        | 55    |
...
~330m ~210m ~100m ~50m
Total ~700m
Cyber GWP Cyber penetration
Risk, resilience and relevance 57
...
| Large (>€1.5bn) | Mid-sized (€50m-€1.5bn) |      | Micro to Medium (<€50m) |      |
...
|     |     |     | Risk, resilience and relevance | 59  |
| --- | --- | --- | ------------------------------ | --- |
...
This will be crucial as the market There have been a number of
moves beyond existing premium positive developments on the
pools to meet the demands capital front over the last 12
of businesses worldwide. months. Beyond plentiful supply
...
10
6
Property-catastrophe bonds Cyber bonds
Risk, resilience and relevance 61
...
<!-- CONVERSION_METADATA: {"source": "https://github.com/jacobdjwilson/awesome-annual-security-reports", "date": "2026-09-24", "model": "gemini-3.5-flash-lite"} -->
