...
| GOVERNMENT                      | 93%                | 94%    |
| INDUSTRIALS AND ENGINEERING     | 2%                 | 51%    |
| ACADEMIC                        | 44%                | 41%    |
| REAL ESTATE                     | 7%                 | 75%    |
| MEDIA                           | 43%                | 36%    |
| ENERGY                          | 41%                | 43%    |
...
made to enabled DCs, so the CrowdStrike
OverWatch team often identifies compromises before the adversary
pivots internally. For example, when an adversary is detected obtaining a foothold on an unmanaged internet-facing
host (such as a network appliance), the early warning gives defenders more time
to identify and contain attackers
