...
Alongside this report, ONCD has published NCSIP Version 2, which builds on successes achieved in the first year of implementation, responds to evolving challenges, and outlines 31 new initiatives to implement the 2023 NCS. Twenty-four agencies are leading initiatives in NCSIP Version 2, with six new agencies joining the implementation effort to achieve the vision of the NCS. Further details on progress made on initiatives in NCSIP Version 1 and ongoing and new initiatives in NCSIP Version 2 can be found online at [www.whitehouse.gov/oncd](www.whitehouse.gov/oncd).
...
| 5.5.2            | Promote a more diverse and resilient supply chain of ICT vendors                                                                                                                                           | State              |
| 5.5.3            | Begin administering the Public Wireless Supply Chain Innovation Fund                                                                                                                                      | Commerce           |
...
The NCS calls for the use of incentives and requirements to