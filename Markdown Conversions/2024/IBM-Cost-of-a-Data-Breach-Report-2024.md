...
- [Key findings](#key-findings)
  - [Average total cost of a breach](#average-total-cost-of-a-breach)
  - [Cost savings from extensive use of AI in prevention](#cost-savings-from-extensive-use-of-ai-in-prevention)
  - [Growth of the cyber skills shortage](#growth-of-the-cyber-skills-shortage)
  - [Share of breaches involving shadow data](#share-of-breaches-involving-shadow-data)
  - [Average cost of a malicious insider attack](#average-cost-of-a-malicious-insider-attack)
  - [Share of breaches involving customer personal data](#share-of-breaches-involving-customer-personal-data)
  - [Cost savings when law enforcement is involved in ransomware attacks](#cost-savings-when-law-enforcement-is-involved-in-ransomware-attacks)
  - [Days to identify and contain breaches involving stolen credentials](#days-to-identify-and-contain-breaches-involving-stolen-credentials)
  - [Largest average cost increase among all industries](#largest-average-cost-increase-among-all-industries)
- [Complete findings](#complete-findings)
  - [Global highlights](#global-highlights)
    - [The global average cost of a data breach spikes](#the-global-average-cost-of-a-data-breach-spikes)
    - [The United States led the world in average breach cost](#the-united-states-led-the-world-in-average-breach-cost)
    - [Healthcare topped industry costs, again](#healthcare-topped-industry-costs-again)
    - [Average time to identify and contain a breach fell](#average-time-to-identify-and-contain-a-breach-fell)
    - [Lost business costs and post-breach response costs soared](#lost-business-costs-and-post-breach-response-costs-soared)
    - [Most breaches involved customer PII](#most-breaches-involved-customer-pii)
  - [Initial attack vectors and root causes](#initial-attack-vectors-and-root-causes)
    - [Compromised credentials topped initial attack vectors](#compromised-credentials-topped-initial-attack-vectors)
    - [Credential-based attacks took longer to identify and contain](#credential-based-attacks-took-longer-to-identify-and-contain)
    - [Root cause of the data breach between 3 categories](#root-cause-of-the-data-breach-between-3-categories)
  - [Data breach lifecycle](#data-breach-lifecycle)
    - [Longer breach lifecycles led to higher costs](#longer-breach-lifecycles-led-to-higher-costs)
  - [Identifying the breach](#identifying-the-breach)
    - [Security teams identified most breaches](#security-teams-identified-most-breaches)
    - [Breaches disclosed by attackers cost more](#breaches-disclosed-by-attackers-cost-more)
    - [Faster breach identification and containment](#faster-breach-identification-and-containment)
  - [Security AI and automation](#security-ai-and-automation)
    - [AI and automation use grew](#ai-and-automation-use-grew)
    - [More AI and automation meant lower breach costs](#more-ai-and-automation-meant-lower-breach-costs)
    - [More AI equaled faster identification and containment](#more-ai-equaled-faster-identification-and-containment)
    - [Security teams applied AI and automation evenly across functions](#security-teams-applied-ai-and-automation-evenly-across-functions)
    - [Extensive use of AI and automation lowered costs](#extensive-use-of-ai-and-automation-lowered-costs)
    - [AI and automation accelerated the time to identify and contain a breach](#ai-and-automation-accelerated-the-time-to-identify-and-contain-a-breach)
  - [Raising prices post-breach](#raising-prices-post-breach)
    - [Organizations passed breach costs to customers](#organizations-passed-breach-costs-to-customers)
  - [Business disruption](#business-disruption)
    - [Business disruption was substantial](#business-disruption-was-substantial)
    - [Average cost of a breach increased with disruption](#average-cost-of-a-breach-increased-with-disruption)
  - [Recovery time](#recovery-time)
    - [Breach recovery rates were low](#breach-recovery-rates-were-low)
    - [Full recovery took longer than 100 days](#full-recovery-took-longer-than-100-days)
  - [Factors that decreased or increased the average breach cost](#factors-that-decreased-or-increased-the-average-breach-cost)
    - [Key factors that reduced costs](#key-factors-that-reduced-costs)
    - [Key factors that increased costs](#key-factors-that-increased-costs)
    - [High versus low levels of key cost amplifying factors](#high-versus-low-levels-of-key-cost-amplifying-factors)
    - [High versus low levels of key cost mitigating factors](#high-versus-low-levels-of-key-cost-mitigating-factors)
  - [Security skills shortage](#security-skills-shortage)
    - [Skills shortage equated to higher breach costs](#skills-shortage-equated-to-higher-breach-costs)
  - [The cost of extortion attacks](#the-cost-of-extortion-attacks)
    - [Cost of destructive attacks outpaced other extortion](#cost-of-destructive-attacks-outpaced-other-extortion)
    - [Time to identify and contain 3 types of extortion attacks](#time-to-identify-and-contain-3-types-of-extortion-attacks)
    - [Paying the ransom](#paying-the-ransom)
    - [Law enforcement involvement lowered breach costs](#law-enforcement-involvement-lowered-breach-costs)
  - [Reporting the breach and regulatory fines](#reporting-the-breach-and-regulatory-fines)
    - [Average breach reporting times](#average-breach-reporting-times)
    - [Amount of regulatory fines are rising](#amount-of-regulatory-fines-are-rising)
  - [Data security](#data-security)
    - [Cloud breaches](#cloud-breaches)
      - [Breaches by data location](#breaches-by-data-location)
      - [Breaches by location and cost](#breaches-by-location-and-cost)
    - [Centralized control related to faster remediation](#centralized-control-related-to-faster-remediation)
    - [Shadow data](#shadow-data)
      - [Breach costs for shadow data](#breach-costs-for-shadow-data)
      - [Breach lifecycles for shadow data](#breach-lifecycles-for-shadow-data)
      - [Shadow data across environments](#shadow-data-across-environments)
  - [Mega breaches](#mega-breaches)
    - [Mega breach costs rose](#mega-breach-costs-rose)
  - [Security investments](#security-investments)
    - [Share of organizations making security investments rose](#share-of-organizations-making-security-investments-rose)
    - [Popular areas of security investment](#popular-areas-of-security-investment)
- [Recommendations to help reduce the cost of a data breach](#recommendations-to-help-reduce-the-cost-of-a-data-breach)
  - [Know your information landscape](#know-your-information-landscape)
  - [Take a security-first approach to gen AI adoption](#take-a-security-first-approach-to-gen-ai-adoption)
  - [Strengthen prevention strategies with AI and automation](#strengthen-prevention-strategies-with-ai-and-automation)
  - [Level up your cyber response training](#level-up-your-cyber-response-training)
...
- [Research methodology](#research-methodology)
  - [How we calculate the cost of a data breach](#how-we-calculate-the-cost-of-a-data-breach)
    - [Detection and escalation](#detection-and-escalation)
    - [Notification](#notification)
    - [Post-breach response](#post-breach-response)
    - [Lost business](#lost-business)
  - [Data breach FAQs](#data-breach-faqs)
  - [Research limitations](#research-limitations)
    - [Nonstatistical results](#nonstatistical-results)
...
![Global average total cost of a data breach. Measured in USD millions.]
...
![Cost of a data breach by country or region. Measured in USD millions.]

![Top 5 countries and regions 2024 vs 2023. Measured in USD millions.]
...
![Average cost of a data breach in 4 components. Measured in USD millions.]
...
![Type of data compromised by percentage. More than 1 response permitted.]

![Per-record cost of a data breach by type of record compromised. Measured in USD millions.]
...
![Cost and frequency of a data breach by initial attack vector. Measured in USD millions; percentage of all breaches.]
...
![Top 5 categories in response time. Measured in days.]
...
![Cost of a data breach based on the breach lifecycle. Measured in USD millions.]
...
![How was the breach identified? Only 1 response permitted.]
...
![Cost of a data breach by how the breach was identified. Measured in USD millions.]
...
![Time to identify and contain a breach by how the breach was identified. Measured in days.]
...
![State of security AI and automation comparing 3 usage levels. Percentage of organizations per usage level.]
...
![Cost of a data breach by AI and automation usage level. Measured in USD millions.]
...
![Time to identify and contain a data breach by AI and automation usage level. Measured in days.]
...
![How much AI and automation did you use in 4 security categories? From the respondents that reported extensive use of AI and automation; reference chart 14.]
...
![Cost of a data breach based on where AI and automation are deployed in security operations. From the organizations that reported extensive use of AI and automation, measured in USD millions; reference chart 14.]
...
![Time to identify and contain a data breach based on where AI and automation are deployed in security operations. From the organizations that reported extensive use of AI and automation, measured in days; reference chart 14.]
...
![Did the data breach result in your organization increasing the cost of its products and services? Share of all organizations.]
...
![What level of business disruption did you experience because of the data breach? Only 1 response permitted.]
...
![Cost of a data breach based on the level of business disruption. Measured in USD millions.]
...
![Has your organization recovered from the data breach? Share of all breached organizations.]
...
![Average time to recover from a data breach. From the organizations that reported they had recovered fully from the incident, measured in days (reference chart 23).]
...
![Factors that reduced the average breach cost. Cost difference from USD 4.88M breach average; measured in USD.]
...
![Factors that increased the average breach cost. Cost difference from USD 4.88M breach average; measured in USD.]
...
![Cost of a data breach for organizations with a high level versus low level of 3 cost amplifying factors. Measured in USD millions.]
...
![Cost of a data breach for organizations with a high level versus low level of 3 cost mitigating factors. Measured in USD millions.]
...
![Cost of a data breach based on the level of security skills shortage. Measured in USD millions.]
...
![Cost of a data breach for 3 types of extortion attacks. Measured in USD millions.]
...
![Time to identify and contain a data breach based on the occurrence of 3 types of extortion attack. Measured in days.]
...
![Share of ransomware victims with law enforcement involved that paid a ransom.]
...
![Cost of a ransomware attack by law enforcement involvement. Measured in USD millions.]

![Time to identify and contain a ransomware attack by law enforcement involvement. Measured in days.]
...
![Did you have to report the breach due to regulatory mandates and if so, how long did it take you to report after discovery? Share of all breaches, only 1 response permitted.]
...
![Distribution of cost of fines incurred from a data breach. Among those that experienced fines, measured in USD.]
...
![Where was the breached data stored? Share of all organizations; 1 response permitted.]
...
![Cost of a data breach by storage location. Measured in USD millions.]
...
![Time to identify and contain a data breach by storage location. Measured in days.]
...
![Cost of a data breach including shadow data. Measured in USD millions.]
...
![Time to identify and contain a data breach including shadow data. Measured in days.]
...
![Where was the shadow data included in the breach stored? Percentage of breaches involving shadow data; 1 response permitted.]
...
![Cost of a mega breach by number of records lost. Measured in USD millions.]
...
![Following the data breach, will your organization increase its security investment? Percentage of all organizations.]
...
![Most common investment types among those increasing security investment after a data breach. Share among organizations that are increasing security investment; more than 1 response permitted.]
...
![Global study at a glance. Share of all organizations in the study.]
...
![Distribution of the sample by industry. Share of all organizations in the study.]
...
#### Nonresponse
Nonresponse bias wasn’t tested, so it’s possible that organizations that didn’t participate are substantially
