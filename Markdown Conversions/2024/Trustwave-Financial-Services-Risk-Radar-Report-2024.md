...
- [Financial Services’ Unique Threat Landscape](#financial-services-unique-threat-landscape)
  - [Expanded Regulatory Requirements](#expanded-regulatory-requirements)
  - [Cryptocurrency Evolution](#cryptocurrency-evolution)
  - [Consumer Protection Considerations](#consumer-protection-considerations)
...
- [Notable & Prominent Trends in Financial Services](#notable--prominent-trends-in-financial-services)
  ...
  - [Evolution of Emerging Technology: Cryptocurrency and Deepfakes](#evolution-of-emerging-technology-cryptocurrency-and-deepfakes)
    ...
    - [Mitigations to Reduce Risk](#mitigations-to-reduce-risk-3)
...
![Figure 1: Cost and frequency of a data breach by initial attack vector; measured in USD millions; percentage of all breaches. Source: Ponemon Institute.](Figure 1: Cost and frequency of a data breach by initial attack vector; measured in USD millions; percentage of all breaches. Source: Ponemon Institute.)
...
![Jersey Financial Regulator Leaks Private Documents in Second Data Breach of 2024](Jersey Financial Regulator Leaks Private Documents in Second Data Breach of 2024)
...
This report examines the myriad of threats facing the financial services industry. In addition to supplemental reports focused on insider threats and phishing-as-a-service, Trustwave SpiderLabs will offer recommendations to help financial institutions mitigate risks and safeguard their customers and data.
...
![Figure 2: Threat actor offers a high salary for PayPal’s insider services](Figure 2: Threat actor offers a high salary for PayPal’s insider services)
...
![More Than 450K hit by JPMorgan Breach](More Than 450K hit by JPMorgan Breach)
*May 2024, SC Media*
...
![Figure 3: Malicious email attachment types; June 2024](Figure 3: Malicious email attachment types; June 2024)
...
![Figure 4: Top ransomware groups targeting financial services](Figure 4: Top ransomware groups targeting financial services)

![Figure 5: Financial services organizations affected by ransomware by country](Figure 5: Financial services organizations affected by ransomware by country)
...
![Figure 6: Ransomware attacks by financial services type](Figure 6: Ransomware attacks by financial services type)

![Data Breach Affects 57,000 Bank of America Accounts](Data Breach Affects 57,000 Bank of America Accounts)
...
![Prudential Financial Data Breach Impacts 2.5 Million](Prudential Financial Data Breach Impacts 2.5 Million)
...
![Figure 7: Types of cryptowallets the Ov3r_Stealer malware is designed to exfiltrate](Figure 7: Types of cryptowallets the Ov3r_Stealer malware is designed to exfiltrate)
...
![Data Breach Confirmed by Toyota Financial Services](Data Breach Confirmed by Toyota Financial Services)
*December 2023, SC Media*

![China’s ICBC, the World’s Biggest Bank, Hit by Ransomware Attack that Reportedly Disrupted Treasury Markets](China’s ICBC, the World’s Biggest Bank, Hit by Ransomware Attack that Reportedly Disrupted Treasury Markets)
*November 2023, CNBC*
...
![Figure 8: Initial access techniques used by attackers of financial services](Figure 8: Initial access techniques used by attackers of financial services)
...
![Figure 9: Execution techniques used by attackers of financial services](Figure 9: Execution techniques used by attackers of financial services)
...
![Figure 10: Credential access techniques used by attackers of financial services](Figure 10: Credential access techniques used by attackers of financial services)
...
![Figure 11: Lateral movement techniques used by attackers of financial services](Figure 11: Lateral movement techniques used by attackers of financial services)
...
![Fidelity National Financial Subsidiary Says 1.3M Affected by November Cyberattack](Fidelity National Financial Subsidiary Says 1.3M Affected by November Cyberattack)
*November 2023, Cybersecurity Dive*

### Persistence Techniques

![Figure 12: Persistence techniques used by attackers of financial services](Figure 12: Persistence techniques used by attackers of financial services)
...
2.  **Costly Malicious Insider Threats:** Malicious insiders pose a significant risk, being the most expensive type of data breach according to recent research. Both unintentional and intentional insider threats require targeted mitigation strategies.
