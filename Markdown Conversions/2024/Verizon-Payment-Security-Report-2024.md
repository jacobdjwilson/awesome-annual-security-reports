...
- [Verizon Payment Security Report history](#verizon-payment-security-report-history)
- [Executive summary](#executive-summary)
- [The compliance landscape](#the-compliance-landscape)
- [Commentary](#commentary)
- [Evaluating PCI security program success](#evaluating-pci-security-program-success)
- [Evaluation of a corporate compliance program](#evaluation-of-a-corporate-compliance-program)
- [Effective security program evaluation](#effective-security-program-evaluation)
- [Integrating PCI security program evaluation frameworks](#integrating-pci-security-program-evaluation-frameworks)
- [The 4 Lines of Assurance](#the-4-lines-of-assurance)
- [The 7 Constraints of Organizational Proficiency](#the-7-constraints-of-organizational-proficiency)
- [Integrated program performance evaluation](#integrated-program-performance-evaluation)
- [An overview of the 9 Factors of Control Effectiveness and Sustainability](#an-overview-of-the-9-factors-of-control-effectiveness-and-sustainability)
- [Evaluating control effectiveness](#evaluating-control-effectiveness)
- [Evaluating program maturity](#evaluating-program-maturity)
- [On measurement and maturity models](#on-measurement-and-maturity-models)
- [State of compliance](#state-of-compliance)
- [The state of PCI DSS compliance](#the-state-of-pci-dss-compliance)
- [Key requirements 1 through 12](#key-requirements-1-through-12)
- [Bottom-20 list](#bottom-20-list)
- [Methodology](#methodology)
- [Appendices](#appendices)
- [Appendix A: The rise and risk of third-party scripts in modern websites](#appendix-a-the-rise-and-risk-of-third-party-scripts-in-modern-websites)
- [Appendix B: A deeper dive into PCI security performance measurement and evaluation](#appendix-b-a-deeper-dive-into-pci-security-performance-measurement-and-evaluation)
- [Appendix C: PCI DSS compliance schedule](#appendix-c-pci-dss-compliance-schedule)
...
![A visual representation of program evaluation architecture with dimensions, specifications, and boundaries for the structured measurement of program performance, featuring a partial cube.]
...
The Verizon 2024 Payment Security Report cover is meant to convey the critical next moves—Payment Card Industry Data Security Standard (PCI DSS) post-implementation performance evaluation.
...
Each year, Verizon Cyber Security Consulting publishes the Payment Security Report or a white paper to highlight Verizon’s approach to some of the most pressing payment security concerns in the industry. Our deep thought leadership keeps you educated on how to problem solve challenges and navigate trends and developments in the increasingly complex, evolving landscape of payment security.

## Verizon Payment Security Report history

![Timeline graphic showing the evolution of Verizon Payment Security Reports from 2010 to 2024, highlighting key versions like v2.0, v3.0, v3.1, v3.2, v4.0, and v4.0.1.]

## Executive summary

### PCI DSS v4.0x post-implementation measurement and evaluation

Compliance management requires an investment of resources. More than ever before, organizations need to apply management methods that offer clear visibility and perspective to deliver necessary work as economically as possible—with the least amount of waste.

> "Success is the product of daily habits—not once-in-a-lifetime transformations. … You should be far more concerned with your current trajectory than with your current results."[^1]

[^1]: Excerpt from ATOMIC HABITS: AN EASY & PROVEN WAY TO BUILD GOOD HABITS & BREAK BAD ONES by James Clear, copyright © 2018 by James Clear. Used by permission of Avery, an imprint of Penguin Publishing Group, a division of Penguin Random House LLC. All rights reserved.

## The compliance landscape

### PCI DSS v4.0x post-implementation performance measurement and evaluation

PCI DSS v4.0 is arguably the most significant update since the initial release of the PCI DSS in December 2004. The latest version is aimed at improving the requirements and how compliance is measured to meet the intent of the standard—an ongoing, effective security guide for payment card data.

## Commentary

### Evaluating PCI security program success

A data security compliance program can be considered successful when it delivers a mature control environment with the ability to improve continually in a structured, controlled, cost-effective and predictable manner.
...
> Control effectiveness: The degree to which a control is successful at meeting the intent of its control objectives and sustaining the intended vulnerability or threat risk mitigation throughout the life cycle of the control.
...
2024 Payment Security ReportAs Albert Einstein purportedly pointed
...
“Understanding the Pareto Principle (The 80/20 Rule),” Better Explained. https://betterexplained.com/articles/understanding-the-pareto-principle-the-
8020-rule
...
“2018 Payment Security Report,” Verizon, 2018. https://www.verizon.com/business/resources/reports/payment-security/2018

26

2024 Payment Security ReportThe 4 Lines
of Assurance
...
be held individually responsible as the first line of assurance. These individuals are
...
“The Three Lines of Defense in Effective Risk Management and Control,” Institute of Internal Auditors, January 2013. https://theiia.fi/wp-content/
uploads/2017/01/pp-the-three-lines-of-defense-in-effective-risk-management-and-control.pdf
“The Handbook of Board Governance: A Comprehensive Guide for Public, Private, and Not-for-Profit Board Members,” Chapter 17: “Three Lines of
...
The ongoing identification and management of constraints—factors standing in
...
more mature capabilities, all lines of
...
2024 Payment Security ReportAn overview of the 9 Factors
...
2024 Payment Security ReportEvaluating control
effectiveness
...
2024 Payment Security Report4.0
...
To properly answer the question of
...
(withstands unwanted change) and
resilience (recovers from unwanted
influence/change)
...
17  Excerpt from ATOMIC HABITS: AN EASY & PROVEN WAY TO BUILD GOOD HABITS & BREAK BAD ONES by James Clear, copyright © 2018 by James

Clear. Used by permission of Avery, an imprint of Penguin Publishing Group, a division of Penguin Random House LLC. All rights reserved.

36

2024 Payment Security ReportPCI DSS control
systems
...
18  Verizon published guidance on control effectiveness in the Verizon 2018 Payment Security Report, page 42, which referenced the DIME model.
...
2024 Payment Security ReportEvaluating
program maturity
...
“Management Cases, revised edition,” Peter F. Drucker, 2009, reproduced with permission from the Drucker 1996 Literary Works Trust.

21
22  Excerpt from ATOMIC HABITS: AN EASY & PROVEN WAY TO BUILD GOOD HABITS & BREAK BAD ONES by James Clear, copyright © 2018 by James
...
On the other hand, an organization with low maturity won’t have these
processes in place. There is likely to be poor communication between team
members and departments, and management will emphasize immediate results
...
23  Adapted from Project Management Institute Inc., Rosenstock, C., Johnston, R. S., & Anderson, L. M. (2000). “Maturity model implementation and use:

a case study.” Seminars & Symposium. https://www.pmi.org/learning/library/maturity-model-implementation-case-study-8882. Copyright and all rights
...
2024 Payment Security ReportThe origin
of capability
maturity models

The quality and process
models of the 1970s and
1980s evolved into today’s
...
constraints, see page 68 in the 2022
...
2024 Payment Security ReportControl gap trends
...
compliance validation assessment is
called the control gap. In other words,
the number of failed requirements
divided by the total number of
requirements expected.

This is an average figure that gives
...
2024 Payment Security ReportLong-term key
requirement trend
analysis

These trend graphs present
...
the bottom). Following Requirement 11,
Requirements 6 and 12 are among the
lowest-performing (least sustainable)
key requirements.
...
calculating the failed controls and
failed test procedures divided by the
total number of controls assessed for
all the related test procedures under a
particular control.
...
2024 Payment Security ReportA note about compliance and
control sustainability

Compliance sustainability is
...
2024 Payment Security ReportThe release of PCI DSS v4.0
...
This requirement covers the correct use of security controls, such
...
2024 Payment Security ReportRequirement 1
...
Full compliance improved from 61.8% in
2022 to 74.6% in 2023—ranking fifth in
...
Only 1.6% of organizations applied
one or more compensating controls
under Requirement 1 in 2023. Only
Requirement 1.1 was compensated.

Figure 9. Global state of PCI DSS compliance 2022 to 2023: Requirement 1

PCI DSS v3.2.1 Requirement 1 controls
...
2022 Change 2023 Rank 2022 Change 2023 Rank
...
Restrict connections between CDE and untrusted
networks.

Prohibit direct public access between internet and
CDE.
...
Document policies and procedures for managing
firewalls.
...
2024 Payment Security ReportRequirement 2
...
Full compliance declined from 64.7% in
...
Change vendor defaults, disable unnecessary
accounts.
...
2.3 Encrypt nonconsole administrative access.
...
Maintain an inventory of in-scope system
components.

82.9% -10.5pp 72.3%

Maintain policies and procedures for managing
vendor defaults.
...
2024 Payment Security ReportRequirement 3
...
Full compliance increased slightly from
...
PCI DSS v3.2.1 Requirement 3 controls
...
Render PANs unreadable anywhere they are
stored.

Protect keys used to secure stored CHD against
disclosure.
...
3.7 Document policies for protecting stored CHD.
...
2024 Payment Security ReportRequirement 4
...
Full compliance improved significantly
...
PCI DSS v3.2.1 Requirement 4 controls
...
Maintain procedures for encrypting transmissions
of CHD.
...
2024 Payment Security ReportRequirement 5
...
Full compliance reduced significantly
...
2.9% of organizations applied
compensating controls under
Requirement 5 in 2022, with 1.6% doing
so in 2023 for Requirement 5.2 only.

Figure 17. Global state of PCI DSS compliance 2022 to 2023: Requirement 5

PCI DSS v3.2.1 Requirement 5 controls
...
Ensure that antivirus mechanisms are actively
...
2024 Payment Security ReportRequirement 6
...
Full compliance declined from 58.8% in
...
Figure 19. Global state of PCI DSS compliance 2022 to 2023: Requirement 6

PCI DSS v3.2.1 Requirement 6 controls
...
Use reputable outside sources for vulnerability
information.

Protect components and software from known
vulnerabilities.
...
Protect public-facing web applications against
known attacks.

Document policies and procedures for secure
systems.
...
“Just Published: PCI DSS v4.0.1,” PCI Security Standards Council, June 11, 2024. https://blog.pcisecuritystandards.org/just-published-pci-dss-v4-0-1

64

2024 Payment Security ReportFACTOR 1: Commitment
...
26  Basic examples of exceeding baseline PCI DSS requirements include conducting vulnerability testing every month instead of every quarter and
...
2024 Payment Security ReportAssessing your current data
...
When organizations do not assess the reality of their
...
value and return on their PCI security
...
2024 Payment Security ReportRequirement 7
...
Full compliance declined slightly from
...
PCI DSS v3.2.1 Requirement 7 controls
...
Establish access control based on need to know;
set to deny all.
...
Maintain policies and procedures for restricting
access to CHD.
...
2024 Payment Security ReportRequirement 8
...
Full compliance improved somewhat
...
seventh overall across the PCI DSS.
...
PCI DSS v3.2.1 Requirement 8 controls
...
Define policies and procedures for user
identification.
...
8.3 Use MFA for all remote access to the CDE.
...
Uniquely identify and secure authentication
mechanisms.
...
Restrict all access to any database containing
CHD.
...
8.8 Maintain policies and procedures for identification.
...
2024 Payment Security ReportRequirement 9
...
Key Requirement 9 experienced a
...
PCI DSS v3.2.1 Requirement 9 controls
...
Use appropriate facility entry controls to monitor
access of CDE.
...
9.2 Distinguish between on-site personnel and visitors.
...
Control physical access for on-site personnel to
sensitive areas.
...
Protect data capture devices from tampering/
substitution.

9.10

Document policies restricting physical access
to CHD.
...
2024 Payment Security ReportRequirement 10
...
Requirement 10 saw a 10.3pp decline
...
PCI DSS v3.2.1 Requirement 10 controls
...
Implement audit trails linking access to individual
users.

10.2

Implement automated audit trails to reconstruct
events.
...
Review logs to identify anomalies or suspicious
activity.
...
10.8 Report failures of critical security control systems.
...
Maintain policies and procedures for monitoring
all access.
...
2024 Payment Security ReportRequirement 11
...
Full compliance declined slightly
...
7.9% of organizations applied one or
more compensating controls under
Requirement 11 in 2023. They applied
...
PCI DSS v3.2.1 Requirement 11 controls
...
11.6 Document procedures for monitoring and testing.
...
6.  PCI DSS requirement performance
...
Figure 31 on pages 80 and 81 outlines
a capability maturity matrix for PCI
DSS requirement measurement and
evaluation. The maturity levels classify
organizations’ capabilities according
to their performance and the quality of
their management systems. It presents
...
2024 Payment Security ReportProcess capability and
maturity definitions

These basic definitions of
...
2024 Payment Security ReportPCI DSS process capability maturity matrix (continued)
...
2024 Payment Security ReportRequirement 12
...
PCI DSS v3.2.1 Requirement 12 controls
...
12.1 Publish, maintain and disseminate a security policy. 88.6% -7.0pp
...
Define information security responsibilities for all
personnel.
...
Manage service providers with policies and
procedures.

Ensure that service providers acknowledge
responsibility.
...
Additional requirements for service providers on
...
PCI DSS control and testing procedures descriptions

38.5%

11.2

Examine scan reports and supporting documentation to verify that internal and external vulnerability scans are performed.
...
Interview personnel to verify that the documented inventory is kept current.
...
Verify that a list of service providers is maintained and includes a description of the service provided.
...
Interview personnel and examine audit logs to verify that audit logs are available for at least one year.

13.8%

11.3.2.a

Examine the scope of work and results from the most recent internal penetration test.
...
2024 Payment Security ReportMethodology
...
28  Douglas W. Hubbard, “How to Measure Anything,” Third ed., Wiley, 2014.
...
2024 Payment Security Report4
...
2024 Payment Security Report0.3
...
New updates to PCI DSS include a
...
report.pdf
“Annual Payment Fraud Intelligence Report: 2022,” Recorded Future, January 17, 2023. https://www.recordedfuture.com/annual-payment-fraud-
...
2024 Payment Security ReportData findings
summary report
...
2024 Payment Security ReportSource Defense data
analysis findings
...
•  Scripts accessing credentials data:
...
2024 Payment Security ReportBehaviors
...
These behaviors range from common
...
2024 Payment Security ReportAppendix B:
...
2024 Payment Security ReportPerformance
measurement vs.
evaluation
...
The 2019 Payment Security Report,
pages 21 through 25, briefly explains
...
2024 Payment Security ReportWhat else should be
measured, reported
and improved?
...
2024 Payment Security Report•  Improvement in cycle time:
...
The maturity of a compliance program36 provides
...
2024 Payment Security ReportAppendix C:
PCI DSS compliance
schedule
...
“Payment Card Industry Data Security Standard: Requirements and testing procedures Version 4.0,” PCI Security Standards Council, March 2022.
...
Every day of the year (not only on business days)

At least once every 7 days

At least once every 30 to 31 days, or on the nth day of the month
...
At least once every 180 to 184 days, or on the nth day of each sixth month

Every 12 months (annually)

At least once every 365 (or 366 for leap years) days or on the same date every year
...
Figure 39. As appears on page 25 of the PCI DSS v4.0

106

2024 Payment Security ReportFrequency/
Requirement
...
longer need access are revoked.
...
prior to the completion of the authorization
process is kept to a minimum and is only
retained for a defined amount of time.
...
Systems that don’t traditionally have
antimalware installed need periodic
evaluation to identify potential security
gaps and mitigate the risk of malware
infiltration.
...
daily or weekly—less often might delay incident
response efforts.
...
2024 Payment Security ReportVerizon 2024 Payment
Security Report
...
anonymized PCI DSS ROC data:

Control Gap: Laura McAllister
GM Sectec: Carlos Convit, Russell
Latimer, Héctor G. Martinez,
Oswaldo Silva
Integrity360: Marco Borza,
Martin Petrov
MegaplanIT: Jennifer Boyd,
Caleb Coggins, Anthony Petruso,
Michael Vitolo
Online Business Systems: Sherri
Collis, Rob Harvey, Steve Levinson

The Verizon Payment Security Report
author team extends an open invitation
to any Qualified Security Assessor
organization to join our research team
and contribute compliance data to
the publication.
...
This research publication is a product of Verizon Cyber Security Consulting, a
global leader in the payment security practice with a security team of more than
600 consultants in 30 countries. Verizon has one of the largest teams of PCI
Qualified Security Assessors.

Verizon is the longest-running global PCI security consulting and assessment
services provider in the world, offering services since 2002. Our payment
security practice provides PCI and Society for Worldwide Interbank Financial
Telecommunication (SWIFT) consulting, assessments and program maturity
improvement services. Across its Cyber Security Consulting portfolio, Verizon
offers services that help clients identify, protect against, detect, respond to and
recover from cyberthreats while helping to comply with applicable regulations
and standards.

This publication is available online at:
verizon.com/paymentsecurityreport

General disclaimer: The information presented in this document is for general information purposes
only and is not intended to provide—and should not be relied on as providing—specific, professional
security services advice. Please reach out to your Verizon representative (if applicable) or information
security personnel for any specific guidance.

Verizon makes no claims, promises or guarantees about the accuracy, completeness or adequacy
of the contents of this publication, and expressly disclaims liability for errors and omissions in
the contents.

References to any specific commercial product, process or service, or the use of any trade, firm
or corporation name is for the information and convenience of the public, and does not constitute
endorsement, recommendation or favoring by Verizon.

© 2024 Verizon. All rights reserved. The Verizon name and logo and all other names, logos and
