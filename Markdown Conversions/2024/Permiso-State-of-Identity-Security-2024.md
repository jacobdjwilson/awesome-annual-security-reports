...
Organization: Permiso  
Report Title: State of Identity Security  
Year: 2024  

## Table of Contents
- [Executive Summary](#executive-summary)
- [The Multi-Cloud Reality Reshaping Identity Security](#the-multi-cloud-reality-reshaping-identity-security)
- [Identity Management Evolves As Organizations Scale And Tighten Control](#identity-management-evolves-as-organizations-scale-and-tighten-control)
- [Non-Human Identities Take Center Stage In Cloud Environments](#non-human-identities-take-center-stage-in-cloud-environments)
- [The Elusive Quest For Comprehensive Identity Management](#the-elusive-quest-for-comprehensive-identity-management)
- [Bridging The Chasm Between Perceived And Actual Identity Risks](#bridging-the-chasm-between-perceived-and-actual-identity-risks)
- [The Illusion Of Comprehensive Identity Monitoring](#the-illusion-of-comprehensive-identity-monitoring)
- [The Identity Security Responsibility Falls Through The Cracks](#the-identity-security-responsibility-falls-through-the-cracks)
- [Unauthorized Access Remains A Stubborn Threat In Cloud Environments](#unauthorized-access-remains-a-stubborn-threat-in-cloud-environments)
- [Unraveling The Complex Web Of Cloud Security Breaches](#unraveling-the-complex-web-of-cloud-security-breaches)
- [Threat Detection Timelines Reveal Shifting Capabilities](#threat-detection-timelines-reveal-shifting-capabilities)
- [Cloud Security Tools Adapt To A Changing Threat Landscape](#cloud-security-tools-adapt-to-a-changing-threat-landscape)
- [Identity Security Budgets Reveal Organizational Priorities And Challenges](#identity-security-budgets-reveal-organizational-priorities-and-challenges)
- [Identifying High-Risk Identities Becomes A Critical Security Capability](#identifying-high-risk-identities-becomes-a-critical-security-capability)
- [The “Who” And “What” Across Complex Authentication Boundaries](#the-who-and-what-across-complex-authentication-boundaries)
- [Unpacking The Spectrum Of Organizational Security Confidence](#unpacking-the-spectrum-of-organizational-security-confidence)
- [Cloud Security Concerns Exposing A Hierarchy Of Risks](#cloud-security-concerns-exposing-a-hierarchy-of-risks)
...
Question asked, “How many non-human identities (service accounts, keys/tokens or secrets) do you manage across your cloud environment?”
...
`NON-HUMAN IDENTITIES` -> `VENDORS` -> `GUESTS` -> `EMPLOYEES`  
...
`SaaS` (HIGHEST RISK) -> `IaaS` -> `IdP (Identity Provider)` -> `PaaS` -> `On-Prem` (LOWEST RISK)
...
SaaS environments emerge as the most vulnerable, with 76% of affected organizations reporting breaches in these platforms. This is followed by IaaS (58%), PaaS (48%), and Identity Providers (43%). On-premises systems, while still vulnerable (39%), appear relatively more secure.
...
While 2023 saw 90% of organizations claiming detection within 24 hours (20% within 1 hour, 47% within 12 hours, and 23% within 24 hours), 2024 shows a more conservative but still high 61% for within 24 hours. This doesn't necessarily indicate a decline in capabilities, but potentially a more over-optimistic assessment of detection timelines.
...
| :--- | :--- | :--- |
| **THE SAAS-FIRST MENTALITY** | SaaS leads with 87% budget allocation, surpassing IaaS (81%). | - A shift towards decentralized IT<br>- Potential security gaps as traditional perimeter-based security becomes obsolete<br>- Dedicated security focus for SaaS as a major attack vector |
| **THE HYBRID REALITY** | 65% still allocating budget to on-premises security alongside cloud investments | - Persistence of legacy systems in most enterprises<br>- Challenges in maintaining consistent security posture across hybrid environments<br>- Potential for security silos and blind spots between on-prem and cloud systems |
| **THE PAAS PUZZLE** | 71% budgeting for PaaS security | - Increasing adoption of container and serverless technologies<br>- Potential security risks as traditional IaaS and SaaS security tools may not suffice |
| **THE HOLISTIC MINORITY** | Only 46% report budgeting for "All environments" | - A concerning lack of comprehensive security strategy in over half of organizations<br>- An opportunity for security vendors to offer more integrated, cross-environment solutions |

### Budget Allocation Patterns

The descending order of budget allocation (SaaS > IaaS > PaaS > On-Prem) mirrors the typical cloud adoption journey, suggesting:
...
High percentages across IaaS, SaaS, and PaaS indicate widespread multi-cloud strategies, implying:
...
2. **Potential underestimation of the true complexity of environments** - This could reflect a focus on surface-level tracking without fully grasping the deeper complexities of identity propagation and transformation across disparate systems, potentially leaving blind spots in security coverage.
...
These findings could point to a belief that existing cloud security investments translate into improvements in cloud security maturity. Although this may be valid, it could also infer that majority of organizations are fixating security efforts on tackling known risks. Given that for most organizations cloud majority is still in its developmental phase, these results must be viewed with some degree of caution.
...
As we move forward, the ability to adapt to this changing landscape will be crucial. Organizations must strive for a balance between leveraging the benefits of cloud technologies and maintaining robust identity security postures. This will require not just technological solutions, but also a fundamental shift in how we approach identity and access management in the cloud era.
