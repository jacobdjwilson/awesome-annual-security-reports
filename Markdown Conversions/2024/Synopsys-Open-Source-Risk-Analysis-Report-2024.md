...
For nearly a decade, the major theme of the “Open Source Security and Risk Analysis” (OSSRA) report has been _Do you know what’s in your code?_ In 2024, it’s a question more important than ever before. With the prevalence of open source and the rise in AI-generated code, more and more applications are now built with third-party code.
...
In 2023, 1,067 codebases were scanned, and 936 codebases underwent risk assessments. Key findings include:
...
- **91%** of codebases assessed for risk contained high-risk vulnerabilities.
...
![Figure 1: 1,067 Codebases Scanned by Industry](Figure 1 is a bar chart showing the percentage of codebases containing open source and the percentage of code originating from open source across 17 industries.
- **Telecommunications and Wireless**: 100% open source codebases, 85% code from open source.
- **Aerospace, Aviation, Automotive, Transportation, Logistics**: 100% open source codebases, 69% code from open source.
- **Computer Hardware and Semiconductors**: 100% open source codebases, 74% code from open source.
- **Internet and Mobile Apps**: 100% open source codebases, 64% code from open source.
- **Internet and Software Infrastructure**: 100% open source codebases, 75% code from open source.
- **Internet of Things**: 100% open source codebases, 50% code from open source.
- **Manufacturing, Industrials, Robotics**: 100% open source codebases, 88% code from open source.
- **Marketing Tech**: 100% open source codebases, 87% code from open source.
- **Retail and eCommerce**: 100% open source codebases, 84% code from open source.
- **Enterprise Software/SaaS**: 99% open source codebases, 79% code from open source.
- **Financial Services and FinTech**: 99% open source codebases, 74% code from open source.
- **Virtual Reality, Gaming, Entertainment, Media**: 97% open source codebases, 53% code from open source.
- **Big Data, AI, BI, Machine Learning**: 96% open source codebases, 70% code from open source.
- **Cybersecurity**: 95% open source codebases, 78% code from open source.
- **EdTech**: 95% open source codebases, 87% code from open source.
- **Energy and Clean Tech**: 91% open source codebases, 83% code from open source.
- **Healthcare, Health Tech, Life Sciences**: 88% open source codebases, 85% code from open source.)
...
**84% of codebases** that included a risk assessment contained at least one known open source vulnerability. **Seventy-four percent** of those codebases contained high-risk vulnerabilities, a significant increase from 2022, when only **48%** of the codebases were found to contain high-risk vulnerabilities. This represents a **54% increase** in codebases containing high-risk vulnerabilities in the past year. High-risk vulnerabilities are those that have been actively exploited, already have documented proof-of-concept exploits, or are classified as remote code execution vulnerabilities.
...
_Mitigating Risk: Tips for Using jQuery and Other Popular Open Source Securely_
...
![Figure 2: Top 10 CVEs/BDSAs](Figure 2 is a diagram illustrating the top 10 CVEs/BDSAs found in the audits and their mapping to CWE-707 and other related CWEs (CWE-20, CWE-79, CWE-80, CWE-97, CWE-937). The diagram shows that CWE-707 acts as a pillar weakness for many of the top vulnerabilities, which include various cross-site scripting (XSS) and input neutralization issues.)
...
![Figure 3: Percentage of Codebases Containing High-Risk Vulnerabilities](Figure 3 is a bar chart showing the percentage of codebases containing high-risk vulnerabilities across various industries.
- **Computer Hardware and Semiconductors**: 88%
- **Manufacturing, Industrials, Robotics**: 87%
- **Retail and eCommerce**: 84%
- **Marketing Tech**: 81%
- **Enterprise Software/SaaS**: 80%
- **EdTech**: 75%
- **Energy and Clean Tech**: 75%
- **Financial Services and FinTech**: 73%
- **Healthcare, Health Tech, Life Sciences**: 73%
- **Cybersecurity**: 73%
- **Internet and Mobile Apps**: 72%
- **Internet and Software Infrastructure**: 67%
- **Big Data, AI, BI, Machine Learning**: 66%
- **Telecommunications and Wireless**: 63%
- **Internet of Things**: 50%
- **Virtual Reality, Gaming, Entertainment, Media**: 49%
- **Aerospace, Aviation, Automotive, Transportation, Logistics**: 33%)
...
![Figure 4: Percentage of Top 10 Licenses Found in Codebases](Figure 4 is a bar chart showing the percentage of top 10 licenses found in codebases.
- **MIT License**: 92%
- **ISC License**: 89%
- **Apache License 2.0**: 81%
- **BSD 3-Clause “New” or “Revised” License**: 69%
- **GNU Lesser General Public License v2.1 or Later**: 56%
- **Public Domain***: 55%
- **Creative Commons Zero v1.0 Universal**: 43%
- **BSD 2-Clause “Simplified” License**: 42%
- **Mozilla Public License 2.0**: 39%
- **The Unlicense**: 36%
...
![Figure 5: Percentage of Top 10 Licenses with Conflicts](Figure 5 is a bar chart showing the percentage of top 10 licenses that were found to have conflicts.
- **Creative Commons Attribution Share Alike 3.0**: 17%
- **Creative Commons Attribution Share Alike 4.0**: 16%
- **GNU General Public License v3.0 or Later**: 15%
- **GNU General Public License v2.0 or Later**: 13%
- **GNU Lesser General Public License v2.1 or Later**: 8%
- **Creative Commons Attribution 3.0**: 8%
- **GNU Library General Public License v2 or Later**: 8%
- **GNU Lesser General Public License v3.0 or Later**: 6%
...
![Figure 6: Percentage of Codebases Containing License Conflicts](Figure 6 is a bar chart showing the percentage of codebases containing license conflicts across various industries.
- **Computer Hardware and Semiconductors**: 92%
- **Manufacturing, Industrials, Robotics**: 81%
- **Big Data, AI, BI, Machine Learning**: 64%
- **Telecommunications and Wireless**: 62%
- **Internet of Things**: 60%
- **Enterprise Software/SaaS**: 54%
- **Energy and Clean Tech**: 53%
- **Cybersecurity**: 52%
- **Internet and Software Infrastructure**: 50%
- **Retail and eCommerce**: 50%
- **Virtual Reality, Gaming, Entertainment, Media**: 49%
- **EdTech**: 45%
- **Financial Services and FinTech**: 42%
- **Internet and Mobile Apps**: 41%
- **Aerospace, Aviation, Automotive, Transportation, Logistics**: 40%
- **Healthcare, Health Tech, Life Sciences**: 36%
- **Marketing Tech**: 19%)
...
_Best Practices for Open Source License Management in Software Supply Chain Governance_
...
Of the **936 codebases analyzed in 2023** that underwent risk assessments:
- **49%** contained open source that had no new development in the last two years.
...
_Recapping the report’s findings_
...
Begin by using automated SCA tools to find security, code quality, and licensing issues early in the SDLC—because you need to know without question what’s in your code.

_The Synopsys difference_
...
For more information about the Synopsys Software Integrity Group, visit us online at [www.synopsys.com/software](www.synopsys.com/software).

©2024 Synopsys, Inc. All rights reserved. Synopsys is a trademark of Synopsys, Inc. in the United States and other countries. A list of Synopsys trademarks is available at [www.synopsys.com/copyright.html](www.synopsys.com/copyright.html). All other names mentioned herein are trademarks or registered trademarks of their respective owners. February 2024

## Terminology

- **Codebase**: The code and associated libraries that make up an application or service.
- **Open source license**: A set of terms and conditions stating end-user obligations, including how the component may be used and redistributed, when an open source component (or a snippet of a component’s code) is used in software. Most open source licenses fall into one of two categories.
...
- **CWE**: Common Weakness Enumeration (CWE) is a community-developed list of software and hardware weakness types assembled in three tiers. CWE has over 600 categories, including classes for buffer overflows, path/directory tree traversal errors, race conditions, cross-site scripting, hard-coded passwords, and insecure random numbers.
- **CVE**: Common Vulnerabilities and Exposures (CVE) is a list of publicly disclosed information security flaws.
...
- **Snippet**: Snippets are small, reusable pieces of code that developers cut and paste into their own code. Although software may include only a snippet of open source, users of the software must still comply with any license associated with that snippet.
- **Copyleft license**: A copyleft license generally includes a reciprocity obligation stating that modified and extended versions are released under the same terms and conditions as the original code, and that the source code containing changes must be provided upon request. Commercial entities are wary of including open source with copyleft licenses in their software, as its use can call the overall codebase’s intellectual property in question.
- **Software composition analysis (SCA)**: A type of application security tool used to automate the process of open source software management. SCA tools integrate within the software development life cycle to identify the open source in a codebase, provide risk management and mitigation recommendations, and perform license compliance verification.
