...
- **Email spoofing**: a deceptive tactic used by cybercriminals to forge the sender’s email address, making it appear as if the message originated from a trusted source within the recipient’s organization.
- **Domain impersonation**: involves the creation of fraudulent email domains or the compromise of legitimate domains to lend credibility to BEC wire fraud schemes.
- **Malware-enabled attacks**: a sophisticated variant of BEC wire fraud in which attackers leverage malicious software to compromise email accounts, exfiltrate sensitive information or facilitate fraudulent transactions.

## Cyber Model Vendors’ View of BEC Risk
Even though BEC has proven to be a considerable financial threat to the economy, commercially available cyber vendor models have mixed reception as to whether it should be accounted for in their catastrophe event catalogue because its impact is perceived to be more attritional and frequency-driven.

## Financial Impact of BEC
### Frequency of BEC Events
![Figure 1: BEC Incidents Each Year - A bar chart showing an upward trend in BEC incidents from 2019 to 2023.]

Figure 1 shows that 2019 had the fewest, with a peak of incidents in 2022, and an overall pattern of an increasing number of BEC events.

### Which Businesses Are Most at Risk?
![Figure 2: Percent of Companies in Revenue Group with BEC Event - A bar chart comparing high-revenue vs low-revenue companies.]
![Figure 3: Percent of Companies in Industry Group with BEC Event - A bar chart showing variation in BEC prevalence across different industry sectors.]

### Severity of Business Email Compromise Events
![Figure 4: Distribution of Initial Loss Severity - A histogram showing the distribution of initial losses as a percentage of revenue.]
![Figure 5: Initial Loss versus Revenue - A scatter plot demonstrating a correlation between initial loss percentage and company revenue.]

Figure 5 demonstrates a strong correlation between the initial loss percentage and the revenue of the company. Smaller-revenue companies are far more likely to lose a greater percentage of their revenue in a BEC event than a large-revenue company.

![Figure 6: Distribution of Amount Recovered - A bar chart showing the percentage of funds recovered in successful BEC events.]

## Preventing Business Email Compromise Events
A successful BEC event depends on the threat actor convincing an employee to transfer money to a fraudulent account. There are 3 main tactics to averting a successful BEC attack:
...
| :--- | :--- | :--- |
| Preventing threat actors from gaining access to organization email accounts. | Our organization uses an authenticator application as a secondary method for MFA. | 2.85 |
...
| Preventing threat actors from gaining access to organization email accounts. | Our organization's technical controls detect known compromised/breached passwords on the darkweb or other sources and enforces a password reset. | 2.29 |

## Conclusions
Business Email Compromise (BEC) may not always capture sensational headlines like ransomware attacks or cloud outages, but it undeniably poses a significant cyber threat to companies worldwide. By implementing controls that help prevent threat actors from gaining access to organization email accounts, prevent fraudulent emails from reaching employees, and help employees recognize fraudulent emails when they do receive them, organizations can significantly reduce their susceptibility to BEC.
