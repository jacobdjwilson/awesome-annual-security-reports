...
![Figure 1. Totals by month for ransomware leak site listings. (Source: Secureworks)](Image description)
...
operators. GOLD BLAZER¹ pulled an exit scam by failing to pay one
...
GOLD MYSTIC² persists, despite appearing to have taken the LockBit
...
![Figure 2. Name and shame group leak site lists July 23 – June 24. (Source: Secureworks)](Image description)
...
GOLD TAHOE³ had a quiet year after extorting
...
REBELLION⁴ threat group entered the victim’s network via the
...
per month. (Source: Secureworks)](Image description)
...
One scheme, called Dispossessor (since disrupted⁶ by law
...
![Figure 4. Number of new ransomware schemes vs. total number of schemes. (Source: Secureworks)](Image description)
...
is GOLD FEATHER’s⁷ Qilin (also known as Agenda)
...
![Figure 5. Growth in Qilin listings mapped against ransomware landscape developments. (Source: Secureworks)](Image description)

Qilin’s expanded operations have facilitated high-profile attacks. A
June 3 ransomware attack⁸ on Synnovis, which supplies pathology
...
in the NHS issuing⁹ an urgent call for blood donors, highlighting
...
with GOLD WATERFALL’s¹⁰ Darkside ransomware attack on Colonial
...
by Emsisoft¹¹. It is possible that this historical link with Darkside was
...
BLAZER perpetrated its alleged exit scam¹², by apparently failing to
pay an affiliate known as Notchy¹³ a commission of $22 million for an
attack. Notchy then attempted to re-extort the victim of that attack
via another ransomware group, RansomHub.

![Figure 6. How Darkside became ALPHV/BlackCat. (Source: Secureworks)](Image description)
...
under that name now that financial sanctions¹⁷ are in
...
scheme rebrands: GOLD VICTOR’s¹⁴ Vice Society rebranded to
Rhysida and GOLD SOUVENIR’s¹⁵ Royal Ransomware rebranded to
...
operators (GOLD SOUTHFIELD¹⁶) were former affiliates of the
...
tactics normally associated with the GOLD HARVEST¹⁸ (also known
...
FBI resulted in the takedown¹⁹ of the QakBot botnet. At 23:27 UTC
on August 25, 2023, CTU researchers detected²⁰ the QakBot botnet
...
QakBot operator GOLD LAGOON²¹ to reconstitute the botnet
...
December 2023, Microsoft observed²² a low-level phishing campaign
...
spun up for use in specific campaigns. Use of