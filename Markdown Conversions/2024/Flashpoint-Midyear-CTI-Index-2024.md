...
Data, insights, and key takeaways on the most impactful, persistent, and emerging cyber threats of 2024—from vulnerabilities and ransomware to infostealers and insider threats.
...
Vulnerabilities continue to be a rising threat vector as 2024 unfolds, as witnessed in the headlines and reflected in Flashpoint’s data. So far this year, vulnerabilities have risen by 11% and the availability of publicly known exploits has increased by 6%. To mitigate the risk of exploitation, organizations must continue to harden exposure management programs that prevent unauthorized access and the installation of malicious software such as infostealers and ransomware.

![Vulnerability Quickview 2024 Midyear showing 17,518 vulnerabilities disclosed, 936 without CVE ID, 22,032 YTD, and 7,993 high or critical (CVSSv2). Also, a breakdown of 10,591 remotely exploitable, 6,489 with public exploit, 2,863 with all three, and 12,680 with a solution. The image also includes bar charts for Vulnerabilities by Vendor (Canonical, Linux Kernel Organization, SUSE, Microsoft Corporation, Software in the Public Interest) and Vulnerabilities by Product (Ubuntu, Linux Kernel, Debian Linux, openSUSE Leap, SUSE Linux Enterprise Server (SLES)).]
...
![Infostealer Quickview Midyear 2024 showing 4.8 million total infected hosts, 13 million total infected hosts YTD, 25 million unique stolen credentials, and 53 million total stolen credentials. The image also includes a chart on the rise of infostealers by unique threads on illicit marketplaces by quarter. A breakdown of stolen credentials by infostealer family shows Redline (10,938,947), Stealc (4,963,261), Vidar Stealer (2,149,691), Risepro (1,819,684), and Lumma Stealer (1,622,627). Top 5 affected countries by number of infected hosts are Brazil (206,212), Pakistan (189,637), Egypt (176,701), Turkey (170,057), and India (163,824). Top 5 most prolific infostealers by number of infected hosts are Redline (3,009,051), Risepro (879,856), Stealc (289,395), Meta stealer (278,830), and Lumma stealer (192,303). ]
...
![Ransomware Quickview Midyear 2024. The image displays the Top 10 Targeted Countries by number of attacks: United States (1,271), United Kingdom (142), Canada (120), Germany (79), Italy (76), France (67), Spain (64), Brazil (62), India (38), and Australia (38). It also shows the Top 10 Targeted Industries: Technology (25.12%), Manufacturing (17.53%), Retail (13.75%), Healthcare (10.89%), Financial Services (6.96%), Business Services & Consulting (6.59%), Transportation (6.16%), Education (5.15%), Legal (4.41%), and Media (3.45%). Additionally, the Top 10 Ransomware Groups by victim posts are listed: LockBit (428), Play (175), RansomHub (169), Akira (136), Black Basta (133), 8Base (122), Cactus (117), Medusa (114), Hunters International (110), and BianLian (88).]
...
Insider threats encompass a spectrum from accidental data breaches to calculated infiltrations. Recognizing and mitigating insider threats demands a comprehensive source of threat intelligence that can monitor activity on the deep and dark web—in addition to illicit marketplaces and forums.

![Insider Threat Quickview Midyear 2024 showing 8,497 unique posts and 43,749 total posts. The image also includes a comparison of Recruiting vs. Advertising Insiders, and a chart detailing Insider Posts by Industry: Telecom (42.90%), Finance (21.48%), Retail (15.65%), Technology (13.96%), Public Sector (3.46%), Other (2.31%), and Healthcare (0.24%).]
