...
- [1 The evolving cyber threat landscape](#1-the-evolving-cyber-threat-landscape)
  ...
  - [Cyber Point of View: Japan](#cyber-point-of-view-japan)
...
The depth and breadth of Microsoft’s presence in the digital ecosystem offers a unique perspective that we share in this report. We process more than 78 trillion security signals per day, from billions of Windows endpoints, the cloud, and a broad spectrum of products and services.

![Infographic showing Microsoft's security ecosystem, including 78 trillion security signals per day, 34,000 security engineers, and 1,500 tracked threat groups.]

---

## Cybersecurity at Microsoft: the CISO’s perspective

In January 2024 I took on the role of Microsoft Chief Information Security Officer (CISO). Immediately thereafter, we discovered we were under a massive cyberattack by the threat actor we refer to as Midnight Blizzard. The cornerstone of our work to protect Microsoft, our partners, and customers is the Secure Future Initiative (SFI)[^1], which dedicates the entire company to putting security above all other considerations.

[^1]: Secure Future Initiative (SFI) is Microsoft's company-wide initiative to prioritize security above all other considerations.
...
### Key developments
- **Blurred lines between nation-state threat actor activity and cybercrime**: Nation-state threat actors are conducting operations for financial gain and enlisting the aid of cybercriminals and commodity malware to collect intelligence.
- **The many faces of hybrid war**: Threat actors serving Russia and Iran are leaning into cyber and influence operations as tools to advance political and military objectives in wartime.
- **The need to impose deterrent consequences for cyber aggression**: The pace of nation-state sponsored cyberattacks has escalated to the point that there is now effectively constant combat in cyberspace without any meaningful consequences to the attacker.
...
In this report, we discuss 30 different threat actors to provide examples of activity for a better understanding of attack targets, techniques, and motivations. Microsoft categorizes these actors using a weather-related naming system.

![Table mapping threat actors by region (Russia, China, North Korea, Iran) and their primary motivations such as Espionage (E), Ransomware (R), and Influence Operations (I).]

### Nation-state threats
The United States is consistently among the countries most impacted by the nation-state cyber threat activity that Microsoft observes. Aside from the United States and the United Kingdom, most of the nation-state affiliated cyber threat activity we observed was concentrated in sites of active military conflict or heightened regional tension: Israel, Ukraine, the United Arab Emirates, and Taiwan.

### Blurring lines between nation-state threat actors and cybercriminals
This year, state-affiliated threat actors increasingly used criminal tools and tactics—and even criminals themselves—to advance their interests. Microsoft observed nation-state threat actors conduct operations for financial gain, enlist cybercriminals to collect intelligence on the Ukrainian military, and make use of the same infostealers, command and control frameworks, and other tools favored by the cybercriminal community.
...
Japan is surrounded by three nation states backing threat actors who conduct extensive cyberattacks: Russia, China, and North Korea. In recent years, Japanese entities from large organizations to small companies downstream in the supply chain, have experienced large-scale cyberattacks. Against this backdrop, its government revised its National Security Strategy in December 2022 to identify cybersecurity as a national security matter for the first time.
...
24.  https://www.ic3.gov/Media/PDF/AnnualReport/2023_
