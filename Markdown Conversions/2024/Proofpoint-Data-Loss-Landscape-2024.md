...
[Looking Ahead: Better Visability, More Expertise](#looking-ahead-better-visability-more-expertise)
[Conclusion](#conclusion)
[Methodology](#methodology)
[Proofpoint internal data](#proofpoint-internal-data)
[Survey](#survey)
...
*   84.7% Organizations experiencing data loss incidents in the past 12 months
*   15.3% No data loss incidents in the past 12 months
...
*   70.6% Careless Users
*   48.1% Compromised Systems
*   45.3% Misconfigured Systems
...
*   8.8% No consequences — not reported externally
*   28% Litigation expenses
*   35.8% Weakened competitive positioning
*   34.8% Regulatory violation/fine
*   56.6% Business disruption/revenue loss
*   38.9% Damaged reputation
...
*   62.8% Employees with access to sensitive data (accounting, sales and others)
*   50.6% IT users with priviledged access credentials
*   28.7% Departing employees
*   25.0% Partners/suppliers
*   23.4% Contractors
*   23.1% Executive employees
*   18.7% Researchers/developers
...
*   *A line graph showing the percentage of targeted tenants and impacted tenants over time for both precision and brute force attacks. The precision attack lines are consistently higher than the brute force attack lines.*
...
**Figure 4. Primary motivational drivers for DLP programs**

*   50.3% Protecting the privacy of employees and customers
*   40.6% Minimizing costs associated with data loss
*   39.3% Protecting our company’s reputation
*   38.8% Protecting intellectual property
*   38.3% Meeting regulatory compliance standards
*   32.0% Meeting internal compliance standards
*   29.9% Ensuring the competitiveness of my company
...
*   58.4% Valuable corporate data (M&A documents, legal contracts, supplier contracts, pricing lists)
*   53.0% Customer PII
*   46.5% Employee PII
*   36.4% Credit/debit information
*   35.7% Protected health information (PHI)
*   24.4% Intellectual property (product designs, product roadmaps, source code, patient applications)
