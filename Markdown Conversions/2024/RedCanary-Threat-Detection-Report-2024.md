...
The official report URL is: https://redcanary.com/threat-detection-report/
...
- [Techniques](#techniques)
  ...
  - [Installer Packages (T1546.016)](#installer-packages-t1546016)
  - [Kernel Modules and Extensions (T1547.006)](#kernel-modules-and-extensions-t1547006)
  - [Escape to Host (T1611)](#escape-to-host-t1611)
  - [Reflective Code Loading (T1620)](#reflective-code-loading-t1620)
  - [AppleScript (T1509.002)](#applescript-t1509002)
...
01 Explore the most prevalent and impactful threats, techniques, and trends that we’ve observed.
02 Note how adversaries are evolving their tradecraft as organizations continue their shift to cloud-based identity, infrastructure, and applications.
03 Shape and inform your readiness, detection, and response to critical threats.
04 Learn how to emulate, mitigate, and detect specific threats and techniques.
...
*   2.5M+ endpoints, identities, and cloud resources protected
*   4,000 detection analytics applied
*   10M false positives identified by the platform and pared down
*   500k events analyzed by humans
*   216 petabytes of security telemetry
*   37M potentially malicious events generated
*   9.5M events resolved by automation
*   58,000 threats detected
...
As adversaries landed on new systems, we regularly observed them conducting reconnaissance with the usual built-in commands: `whoami`, `ipconfig`, `net`, and `nltest`. Additionally, we observed adversaries using tools like SoftPerfect Network Scanner and ADrecon to assist.
