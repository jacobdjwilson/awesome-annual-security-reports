...
- **Australian Security Intelligence Organisation**: Protects Australia from threats including terrorism, espionage, sabotage, and foreign interference.
- **Department of Foreign Affairs and Trade**: Leads Australia’s international engagement on cyber and critical technology.
- **Department of Home Affairs**: Responsible for central coordination, strategy and policy leadership of cyber and critical infrastructure resilience.
...
- **Defence Intelligence Organisation**: Co-leads the Cyber Threat Assessment team in partnership with ASD.
...
- **Reserve Bank of Australia**: Australia’s central bank, responsible for the core of the payments system.

---

## Executive summary

Australia faces the most complex and challenging strategic environment since the Second World War. In FY2023–24, ASD received over 36,700 calls to its Australian Cyber Security Hotline, an increase of 12% from the previous financial year. ASD also responded to over 1,100 cyber security incidents.

State-sponsored cyber actors persistently target Australian governments, critical infrastructure and businesses. In February 2024, ASD joined international partners in highlighting that the People’s Republic of China (PRC) is leveraging "living off the land" techniques to pre-position for disruptive effects.

Critical infrastructure networks are an attractive target; over 11% of cyber security incidents ASD responded to related to this sector. Cybercrime remains a persistent threat, with business email compromise and fraud being top self-reported issues.

ASD encourages all organisations and individuals to report suspicious activity to ReportCyber at [cyber.gov.au](https://www.cyber.gov.au).

---

## Year in review

![Infographic showing 36,700+ hotline calls, 87,400+ cybercrime reports, and incident statistics]

- **Hotline**: Answered over 36,700 calls (up 12%).
- **Cybercrime Reports**: Received over 87,400 reports (down 7%).
- **Incidents**: Responded to over 1,100 cyber security incidents.
- **Ransomware**: 11% of all incidents involved ransomware (a 3% increase).
- **Vulnerabilities**: Publicly reported common vulnerabilities and exposures increased 31%.

---

## State actors

The threat of state-sponsored cyber operations is persistent and will likely grow as strategic competition in the Indo-Pacific increases. State actors use both bespoke and common tools to achieve espionage and pre-positioning objectives.

- **Living off the Land (LOTL)**: Actors use native system tools to evade detection.
- **Cloud Techniques**: Increased exploitation of cloud environments via brute-force and password spraying.

---

## Critical infrastructure

Critical infrastructure made up 11% of all cyber security incidents. The most common sectors affected were electricity, gas, water and waste services (30%), education and training (17%), and transport, postal and warehousing (15%).

- **OT Vulnerability**: Operational Technology (OT) systems are increasingly interconnected with ICT, creating new attack surfaces.
- **Mitigation**: Organisations should adopt a "when, not if" stance, implement event logging, and maintain asset registries.

---

## Cybercrime

Cybercrime remains a high-volume threat. 

- **Individuals**: Top threats are identity fraud (26%), online shopping fraud (15%), and online banking fraud (12%).
- **Business**: Top threats are email compromise (20%), online banking fraud (13%), and business email compromise (13%).

---

## Hacktivism

Hacktivism continues to manifest through low-capability attacks such as website defacement and Distributed Denial of Service (DDoS) attacks, often aimed at elevating political messaging.

---

## Resilience

Building resilience requires a "secure-by-design" approach. ASD’s programs, such as the **Essential Eight**, provide a baseline for organisations to defend against common cyber threats.

---

## ASD programs

- **Cyber Threat Intelligence Sharing (CTIS)**: Partner network grew by 66% to over 400 partners.
- **Cyber Hygiene Improvement Program**: Performed 365 high-priority operational taskings.
- **Critical Infrastructure Uplift Program**: Completed 10 uplifts covering 15 assets.
