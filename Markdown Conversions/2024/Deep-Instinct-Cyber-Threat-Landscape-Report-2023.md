...
### Ransomware Trends
![RANSOMWARE VICTIMS DURING 2022 AND 2023 graph]
...
![NUMBER OF RANSOMWARE VICTIMS IN 2022 VS 2023 graph]

![RANSOMWARE VICTIMS BY THREAT GROUP DURING 2023 graph]
...
![CLOP RANSOMWARE MEMBER TWEETED “LET’S GO!” AFTER THE FBI IDENTIFIED HIM AS WANTED FOLLOWING SEVERAL MAJOR CAMPAIGNS IN THE US. image]
![CLOP USING TORRENTS TO LEAK DATA image]
...
### PLAY
The Play ransomware, also known as PlayCrypt, often uses techniques to neutralize anti-malware and monitoring systems before performing the ransomware execution by employing tools such as Process Hacker, GMER, IOBit, and PowerTool. In 2023, this group was identified exploiting two specific vulnerabilities in Microsoft Exchange.
Interestingly, there are distinct similarities between Play ransomware and two other strains: Hive and Nokoyawa.
...
![TOP THREAT GROUPS IN 2022 H2 graph]
...
![BANKING TROJANS/STEALERS/SPYWARE graph]
...
![THREAT ACTORS 2022 H2/2023 H1 graph]
...
![ARTIFICIAL INFLATED FILES IN ZIP TRENDS 2022 H2/2023 H1 graph]
...
![VULNERABILITIES EXPLOITED IN THE WILD graph]
