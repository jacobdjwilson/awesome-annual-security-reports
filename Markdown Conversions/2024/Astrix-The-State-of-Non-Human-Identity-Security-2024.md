...
- [Key Findings](#key-findings)
  ...
  - [Key Finding 4: Fragmented Approaches Lead to Security Incidents](#key-finding-4-fragmented-approaches-lead-to-security-incidents)
    ...
    - [NHI security incidents and causes](#nhi-security-incidents-and-causes)
...
![Chart showing confidence levels in human identity vs NHI attack prevention. Human identity has higher confidence across all levels except 'Not at all confident'.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image1.png)
...
![Chart showing concern levels about NHI as an attack vector. 'Very concerned' has the highest percentage.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image2.png)
...
![Pie chart showing users in Snowflake environments, with 'Service Accounts' being 77% and 'Other Users' being 23%.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image3.png)
...
![Bar chart showing the most challenging aspects of NHI management, with 'Service accounts' at 32% and 'Auditing and Monitoring' and 'Access and privileges' tied at 25%.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image4.png)
...
![Chart showing visibility levels into third-party vendors connected by OAuth apps. 'No visibility' and 'Limited visibility' combined make up the majority.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image5.png)

![Bar chart showing percentages of untrusted third-party vendors by marketplace (Chrome, Slack, Google Workspace, MS365). Chrome has the highest percentage.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image6.png)
...
![Chart showing frequency of review for service account permissions. 'Yearly' and 'Randomly - when needed' are the most frequent responses.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image7.png)
...
![Chart showing difficulty levels of managing permissions for new versus existing service accounts. 'Existing' accounts are generally perceived as more difficult to manage.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image8.png)
...
![Chart showing the type of process for API key offboarding/revoking versus rotating/rolling back. 'No process' is a significant category for both.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image9.png)
...
![Chart showing the timeline for API key offboarding versus rotating/rolling back. 'Weeks' and 'Days' are the most common responses for both.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image10.png)
...
![Bar chart showing solutions and strategies currently used to manage NHIs. IAM and PAM are the most common.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image11.png)
...
Key security tool capabilities being sought include visibility into third-party vendors connected through OAuth apps (26%), management of the secrets lifecycle (26%), identity discovery (25%), management of API keys (23%), managing permissions (22%), tracking access behavior/anomaly detection (22%), and automating third-party connectivity (21%). These mirror many of the challenges that were previously identified. This broad range of capability needs further suggests that current strategies and tools are insufficient for their security needs.

![Bar chart showing most important security tool capabilities for NHI security. Visibility into third-party vendors and Management of the secrets lifecycle are tied at the top.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image12.png)
...
![Chart showing whether organizations experienced security incidents related to NHI. 'No' has the highest percentage, but 'Unsure' is also significant.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image13.png)
...
Common causes of NHI security incidents include a lack of credential rotation (45%), inadequate monitoring and logging (37%), and overprivileged accounts/identities (37%). These issues mirror the challenges identified in the previous key finding and are exacerbated by the fragmented approach to NHI security. For example, 68% of tokens in GitHub environments have no expiry, and 64% of webhooks in GitHub are misconfigured, leaving significant vulnerabilities unaddressed.

![Bar chart showing causes of NHI security incidents. 'Lack of credential rotation' is the most common cause.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image14.png)

![Two bar charts showing 'Tokens with vs without Expiry in GitHub Environments' and 'Misconfigured vs Properly Configured Webhooks in GitHub'.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image15.png)
...
The implications of these findings are clear: organizations need to unify their NHI security strategies and invest in tools specifically designed for managing NHIs. The current piecemeal approach leaves significant gaps in security coverage, making it difficult to address even the basics of NHI security. By adopting a more cohesive and targeted strategy, organizations can improve their visibility, reduce the risk of security incidents, and better manage their NHIs.
...
![Chart showing plans to invest in NHI security capabilities. 'Plan to within 12 months' has the highest percentage, followed by 'Plan to within 6 months'.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image16.png)
...
![Chart showing confidence levels in human identity vs NHI attack prevention.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image17.png)

### Concern levels about NHI as an attack vector

![Chart showing concern levels about NHI as an attack vector.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image18.png)

### Most challenging aspects of NHI management

![Bar chart showing the most challenging aspects of NHI management.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image19.png)

16

© Copyright 2024, Cloud Security Alliance. All rights reserved.

![Chart showing concern levels about NHI access levels.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image20.png)

### Most concerning NHI threats, risk, and vulnerabilities

![Bar chart showing most concerning NHI threats, risk, and vulnerabilities.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image21.png)
...
![Chart showing confidence levels in responding effectively to NHI security incidents.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image22.png)

### Experienced security incidents related to NHI

![Chart showing whether organizations experienced security incidents related to NHI.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image23.png)

### Causes of NHI security incidents

![Bar chart showing causes of NHI security incidents.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image24.png)
...
![Bar chart showing solutions and strategies currently used to manage NHIs.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image25.png)

### Most important security tool capabilities for NHI security

![Bar chart showing most important security tool capabilities for NHI security.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image26.png)

![Chart showing plans to invest in NHI security capabilities.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image27.png)
...
![Chart showing visibility levels into third-party vendors connected by OAuth apps.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image28.png)

![Bar chart showing challenges with maintaining or improving visibility into third-party vendors connected by OAuth apps.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image29.png)

![Chart showing difficulty levels for managing requests to add third-party tools and services.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image30.png)

20

© Copyright 2024, Cloud Security Alliance. All rights reserved.

![Chart showing balancing user freedom and security for business integrations.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image31.png)

![Bar chart showing challenges for implementing secure automation and connectivity.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image32.png)
...
![Chart showing estimated percentage of over-permissive accounts in organizations.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image33.png)

### Frequency of review for service account permissions

![Chart showing frequency of review for service account permissions.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image34.png)

### Difficulty levels of managing permissions for new versus existing service accounts

![Chart showing difficulty levels of managing permissions for new versus existing service accounts.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image35.png)
...
![Chart showing the type of process for API key offboarding/revoking versus rotating/rolling back.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image36.png)

### Timeline for API key offboarding versus rotating/rolling back

![Chart showing the timeline for API key offboarding versus rotating/rolling back.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image37.png)
...
![Bar chart showing methods for storing and managing secrets.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image38.png)

### Confidence levels in storing and managing secrets

![Chart showing confidence levels in storing and managing secrets.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image39.png)

### Capabilities used for secrets management in application development

![Bar chart showing capabilities used for secrets management in application development.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image40.png)
...
*   Asia-Pacific (APAC): 23%

### What is the size of your organization?

![Bar chart showing the size of organizations surveyed.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image41.png)

### What best describes your job level?

![Bar chart showing job levels of survey respondents.](https://raw.githubusercontent.com/jason-d-smith/pdf-to-markdown/main/images/image42.png)

### Which of the following best describes the principal industry of your organization?

*   Telecommunications, Technology, Internet & Electronics: 33%
*   Finance & Financial Services: 18%
*   Manufacturing: 4%
*   Insurance: 3%
*   Retail & Consumer Durables: 3%
*   Business Support & Logistics: 3%
*   Healthcare & Pharmaceuticals: 5%
*   Construction, Machinery, and Homes: 2%
*   Automotive: 2%
*   Government: 4%
*   Nonprofit: 2%
...
The Cloud Security Alliance (CSA) is a not-for-profit organization with a mission to widely promote best practices and ensure cybersecurity in cloud computing and IT technologies. CSA also educates various stakeholders within these industries about security concerns in all other forms of computing. CSA’s membership is a