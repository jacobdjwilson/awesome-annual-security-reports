...
Organization: Cisco  
Report Title: Privacy-Benchmark-Study  
Year: 2024  
...
![Figure 1. Privacy’s importance to customer trust chart](Figure 1: Bar chart comparing 2021, 2022, and 2023 data showing that roughly 94% agree customers won't buy if data is unprotected, 98% agree external certifications are important, and 97% agree on the responsibility to use data ethically.)
...
![Figure 2. Privacy investment’s impact on loyalty and trust chart](Figure 2: Horizontal bar charts illustrating the percentage of respondents getting significant benefits from privacy investment across 6 categories, led by Loyalty and Trust at 80%.)
...
![Figure 3. Privacy maturity’s correlation with loyalty and trust chart](Figure 3: Line/Bar chart mapping privacy maturity relative to peers against the percentage getting benefits in loyalty and trust, showing an increase from 71% for those behind peers up to 92% for those significantly ahead.)

> _“Privacy has become inextricably tied to customer trust and loyalty.”_  
...
![Figure 4. Number and type of privacy metrics reported to the Board chart](Figure 4: Charts displaying the number of metrics reported (average 2.9) and the breakdown of types of privacy metrics like audit results and data breaches.)
...
![Figure 5. Impact of privacy laws on organizations map/chart](Figure 5: Global breakdown showing positive and negative impacts of privacy laws by country, averaging 80% positive impact globally.)
...
![Figure 6. Data localization chart](Figure 6: Bar charts displaying responses regarding data localization safety (91% yes), significant costs (85% yes), and trust in global providers over local providers (86% yes).)
...
![Figure 7. Percentage agreeing that a global provider can protect data better than a local provider, by country map/chart](Figure 7: Country-by-country breakdown demonstrating high agreement (78%+) that global providers protect data better.)
...
![Figure 8. Business benefits of privacy investment chart](Figure 8: Side-by-side metric callouts showing 96% view privacy as a business imperative and 95% view benefits as greater than costs.)
...
![Figure 9. Privacy spending, 2019-2023 chart](Figure 9: Line graph tracking privacy spending from 2019 to 2023 across various company sizes, showing an overall average of $2.7 million.)
...
![Figure 10. Estimated financial benefits, 2019-2023 chart](Figure 10: Line graph illustrating estimated financial benefits from 2019 to 2023, showing an overall average of $2.9 million.)
...
![Figure 11. Estimated ROI ranges for respondents, 2023 chart](Figure 11: Pie/donut chart breaking down ROI ranges, showing 49% between 1x to <2x, 18% between 2x to <3x, 8% between 3x to <5x, and 4% at 5x and above.)
...
![Figure 12. Organizations who say they need to do more to reassure customers about their data use with AI chart](Figure 12: Donut/metric chart showing 91% agreement that organizations need to do more.)
...
![Figure 13. What organizations can do to build and maintain trust when it comes to customer data chart](Figure 13: Comparative bar charts illustrating differences between consumer priorities (clear information on data use) and organizational priorities (complying with privacy laws).)
...
![Figure 14. Steps taken by organizations regarding their use of AI chart](Figure 14: Bar chart showing organizational steps taken regarding AI use, such as explaining how apps work (50%) and ensuring human involvement (50%).)

> _“The risks of AI are real, but they are manageable when thoughtful governance practices are in place as enablers, not obstacles, to responsible innovation.”_  
...
![Figure 15. Cisco AI Readiness Index chart](Figure 15: Grid chart outlining organization readiness levels (Pacesetters, Chasers, Followers, Laggards) across strategy, infrastructure, data, governance, talent, and culture domains.)
...
![Figure 16. Familiarity and value from GenAI chart](Figure 16: Charts detailing organizational familiarity levels (55% very familiar) and current value derived from GenAI (79% significant/very significant).)
...
![Figure 17. Concerns with GenAI chart](Figure 17: Bar charts displaying user concerns with GenAI, including legal/IP risks (69%) and public/competitor data leakage (68%).)
...
![Figure 18. Types of information entered into GenAI applications chart](Figure 18: Bar chart breaking down types of sensitive data entered into GenAI, led by internal processes (62%) and non-public company info (48%).)
...
![Figure 19. GenAI controls chart](Figure 19: Bar chart depicting adopted GenAI controls, including data limitations (63%) and tool restrictions (61%).)
...
![Appendix A chart](Appendix A: Horizontal bar chart showing equal 8% distribution across countries like Australia, Brazil, China, France, Germany, India, Italy, Japan, Spain, and United Kingdom, with 15% for the United States.)

### Appendix B. Demographics of survey respondents, by industry and size

![Appendix B chart](Appendix B: Charts breaking down respondents by industry (Technology 14%, Manufacturing 13%, Retail 10%, etc.) and company size (ranging from 50 to 10,000+ employees).)
