...
**Image Description:** A pie chart titled "Within which sector is your organization?" is shown. The chart depicts the distribution of respondents across various sectors. The largest segments are "Technology" and "Financial Services".

Nearly half of respondents (47%) are senior leaders or executives.

**Image Description:** A pie chart titled "Which of these best describes your position in the organization?" is shown. The chart depicts the distribution of respondents across various job levels. The largest segment is "Senior Leader/Executive".
...
**Image Description:** A bar chart titled "Who manages each of the following at your organization?" is shown. The chart displays the percentage of respondents who indicated various roles as being responsible for different aspects of data management, such as data security, data platforms, and legal/compliance.
...
**Image Description:** A bar chart titled "What is the biggest data security challenge within your organization?" is shown. The chart displays the percentage of respondents who selected various challenges, with "Lack of visibility into data sharing and usage" being the most significant.
...
**Image Description:** A bar chart titled "How long does it take to get access to a new data set once requested?" is shown. The chart displays the distribution of time taken to access a new dataset, with a significant portion indicating it takes a week or more.
...
**Image Description:** A bar chart titled "Planned Adoption vs. Most Commonly Used Platforms" is shown. The chart compares the planned adoption of various data platforms with their current usage, highlighting the most commonly used platforms.
...
**Image Description:** A bar chart titled "What significant initiatives is your organization taking on in the next 12 months?" is shown. The chart displays the percentage of respondents who selected various initiatives, with "Implementing stronger data governance and security controls" being the most significant.
...
**Image Description:** A bar chart titled "Over the next 12 months, how do you expect your organizations to benefit by improving data security?" is shown. The chart displays the percentage of respondents who selected various benefits, with "Improved compliance" and "Faster access to data" being the most significant.
