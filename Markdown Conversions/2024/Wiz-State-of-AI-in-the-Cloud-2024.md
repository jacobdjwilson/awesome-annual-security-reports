...
- [Key Findings](#key-findings)
  - [1 AI has taken over the cloud: Cloud-based managed AI services can already be found in over 70% of environments](#1-ai-has-taken-over-the-cloud-cloud-based-managed-ai-services-can-already-be-found-in-over-70-of-environments)
  - [2 Azure OpenAI is seeing explosive growth; organizations have recently more than tripled their use of Azure OpenAI instances](#2-azure-openai-is-seeing-explosive-growth-organizations-have-recently-more-than-tripled-their-use-of-azure-openai-instances)
  - [3 While most companies are indeed using AI services, many still appear to be in the experimentation phase](#3-while-most-companies-are-indeed-using-ai-services-many-still-appear-to-be-in-the-experimentation-phase)
  - [4 When it comes to the use of CSP-managed AI services in the cloud, Azure leads the pack](#4-when-it-comes-to-the-use-of-csp-managed-ai-services-in-the-cloud-azure-leads-the-pack)
  - [5 OpenAI for the win: More than half of cloud environments are using OpenAI or Azure OpenAI SDKs](#5-openai-for-the-win-more-than-half-of-cloud-environments-are-using-openai-or-azure-openai-sdks)
...
The trend began in July 2022 with the beta releases of image generation services including OpenAI’s DALL-E 2 and Stability.ai’s Stable Diffusion in August 2022. The trend became undeniable with the release of text generation services, namely OpenAI’s ChatGPT, with other open-source models soon to follow, chiefly Midjourney in November 2022.
...
Cloud service providers have stepped up to meet customer demand by offering both revamped versions of their existing AI and ML services as well as entirely new solutions for building with generative AI in the cloud. Microsoft continues to invest in developing its AI Services (AKA Cognitive Services), a set of tools which among other things also houses Azure’s integrated OpenAI offering, and Azure recently released AI Studio in public preview in September 2023. GCP added generative AI capabilities to Vertex AI in March 2023, while continuing to maintain its more ML-focused AI Platform as well; and AWS has been building new features into SageMaker while making Bedrock generally available in January 2023.

As with any technology that is so rapidly adopted, potential security drawbacks are beginning to show themselves, as Microsoft. Having said that, we’re excited to see how cloud customers will leverage generative AI, and we’re committed to helping them do so while introducing the correct security guardrails. Our research shows that as of the beginning of 2024, the adoption of both traditional and generative AI by cloud customers has reached unprecedented heights and shows no signs of slowing.
...
### Experimentation
- Sporadic, ad-hoc deployment of managed AI workloads and self-hosted tools by enthusiasts in various departments
- "Shadow AI", no central visibility into AI cloud usage
- Further experimentation as part of additional R&D efforts.

### Active Development
- Budding proof of concept R&D efforts for exploring potential AI product ideas.
- Dedicated teams of developers regularly deploying and updating AI workload
- Some observability into both managed AI workloads and self-hosted tool
- Small fleet of instances spread across multiple services and vendors (for benchmarking)

### Use in Production
- Large fleet of AI workloads, most procured via the same service or vendor
- Cost optimization and advanced monitoring capabilities for AI workloads
- Security controls in place to prevent and detect AI risks (e.g., training data poisoning)
