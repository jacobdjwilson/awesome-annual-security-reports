Organization: Google
Report Title: Organizing-Security-Digital-Transformation
Year: 2024
...
- [02 Mindshift: Security goes cloud first](#02-mindshift-security-goes-cloud-first)
- [03 Why it’s OOT, not TOO, in the cloud](#03-why-its-oot-not-too-in-the-cloud)
- [04 Choreographing change](#04-choreographing-change)
  - [Organization transformation defined](#organization-transformation-defined)
  - [The four stages of organization transformation](#the-four-stages-of-organization-transformation)
- [05 How security is organized during transformation](#05-how-security-is-organized-during-transformation)
  - [How to use this guide](#how-to-use-this-guide)
- [06 Modern security organization models](#06-modern-security-organization-models)
  - [Post-transformation security team models](#post-transformation-security-team-models)
    - [Detection and response](#detection-and-response)
    - [Security engineering and automation](#security-engineering-and-automation)
    - [Infrastructure engineering and automation](#infrastructure-engineering-and-automation)
    - [Product teams](#product-teams)
    - [Site reliability engineering](#site-reliability-engineering)
    - [Cloud strategy and governance](#cloud-strategy-and-governance)
    - [Integrated risk, compliance, audit](#integrated-risk-compliance-audit)
- [07 Summary](#07-summary)
- [Contributors](#contributors)
- [Appendix A: Organization descriptions before transformation](#appendix-a-organization-descriptions-before-transformation)
  - [Profiles of existing teams and their roles](#profiles-of-existing-teams-and-their-roles)
    ...
    - [Application management and support](#application-management-and-support)
    ...
    - [Audit and advisory](#audit-and-advisory)
- [Appendix B: The relationship between organizational culture and transformation](#appendix-b-the-relationship-between-organizational-culture-and-transformation)
  - [01 Going beyond organizational transformation](#01-going-beyond-organizational-transformation)
    - [Value stream mapping: learning more about how teams perform and interact](#value-stream-mapping-learning-more-about-how-teams-perform-and-interact)
  - [02 Why culture is key to successful transformation](#02-why-culture-is-key-to-successful-transformation)
    - [Applying Westrum’s model to organizational transformation](#applying-westrums-model-to-organizational-transformation)
    - [The importance of building a generative culture](#the-importance-of-building-a-generative-culture)
    - [Nurturing generative culture traits](#nurturing-generative-culture-traits)
  - [03 Strategies for setting and obtaining shared goals](#03-strategies-for-setting-and-obtaining-shared-goals)
    - [Focused training empowers team members](#focused-training-empowers-team-members)
    - [Measure established goals](#measure-established-goals)
  - [04 Big picture: focus shared goals on improving security and speed](#04-big-picture-focus-shared-goals-on-improving-security-and-speed)
- [Appendix C: The four stages of digital transformation](#the-four-stages-of-organization-transformation)
...
## 02 Mindshift: Security goes cloud first
...
## 03 Why it’s OOT, not TOO, in the cloud
...
![Diagram showing how organizations think digital transformation goes (smooth progression through stages: Experimentation and Disintegration, Dissolution, Transformation, Integration) versus how it actually goes (progress isn't always smooth, with back and forth between stages).](https://example.com/image1.png)
...
![Description of the four stages of organization transformation: Stage 1 Experimentation and Disintegration, Stage 2 Dissolution, Stage 3 Transformation, Stage 4 Integration.](https://example.com/image2.png)

**Stage 1 Experimentation and Disintegration**
Teams are encouraged and enabled to experiment with new technology and will be able to find and demonstrate its value. Teams given autonomy to build without rules find ways to reinvent their work. The value and benefit of cloud is teased through these simple examples. Excitement about what’s now possible and what could be done on larger scales creates the need to disintegrate.

**Stage 2 Dissolution**
Teams begin to sense that disintegration of the “old way” of doing work (without automation, following manual processes, according to traditional ways of organizing processes to do work) seem to inhibit the speed that’s possible using cloud. Team norms and structures begin to be challenged as organizations start to establish new ways of working, new shared goals and outcomes.

**Stage 3 Transformation**
Now begins the stage of implementing new capabilities that change and eliminate steps or entire ways that work was done previously. This move entails significant investment in new technologies and systems. This stage can be a long and complex one, as organizations need to carefully plan and execute the transformation across entire functions, business units, divisions, and the company itself.

**Stage 4 Integration**
Next comes the stage of integrating the new digital business model fully into how the organization's day-to-day operations run. Volumes of work go down as the use of automation and technologies like artificial intelligence (AI) become more rapidly deployed and improved. Organizations shift from building, to maintaining, and finally optimizing continuously.

## 05 How security is organized during transformation
...
## 06 Modern security organization models
...
![Diagram illustrating the evolution of security team organizations from pre-transformation (listing 16 functions like Security operations, Threat intelligence, Cloud security, etc.) through four stages (Experimentation and Disintegration, Dissolution, Transformation, Integration) to future post-transformation models (Detection and response, Security engineering and automation, Infrastructure engineering and automation, Product teams, Site reliability engineering, Cloud strategy and governance, Integrated risk, compliance, audit).](https://example.com/image3.png)
...
## Appendix A: Organization descriptions before transformation
...
### 01 Going beyond organizational transformation
...
### 02 Why culture is key to successful transformation
...
![Table illustrating Westrum's three types of organizational cultures: Pathological (Power-Oriented) with low cooperation, messengers "shot", responsibilities shirked; Bureaucratic (Rule-Oriented) with modest cooperation, messengers neglected, narrow responsibilities; and Generative (Performance-Oriented) with high cooperation, messengers trained, risks shared.](https://example.com/image4.png)
...
![Diagram showing five characteristics of an effective team: Dependability of teammates, Personal meaning derived from team’s work, Structure and clarity on team and roles, Impact of team’s work, Psychological safety of the team.](https://example.com/image5.png)

- Dependability of teammates
- Personal meaning derived from team’s work
- Structure and clarity on team and roles
- Impact of team’s work
- Psychological safety of the team

### 03 Strategies for setting and obtaining shared goals
...
![Diagram illustrating three methods for measuring established goals: Standard objectives and key results (OKRs), Key performance indicators (KPIs), and Key risk indicators (KRIs).](https://example.com/image6.png)
...
### 04 Big picture: focus shared goals on improving security and speed
...
01. Version control – for all instructions, especially code. Building
