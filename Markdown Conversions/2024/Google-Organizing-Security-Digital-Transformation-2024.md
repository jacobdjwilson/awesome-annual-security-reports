...
- [Mindshift: Security goes cloud first](#mindshift-security-goes-cloud-first)
- [OOT, not TOO](#oot-not-too)
- [Choreographing change](#choreographing-change)
- [How security is organized during transformation](#how-security-is-organized-during-transformation)
- [Modern security organization models](#modern-security-organization-models)
- [Summary](#summary)
...
controls – following the definition of identity and
access management policies and procedures,
implementing controls to enforce the policies such
as implementing access control lists, multi-factor
