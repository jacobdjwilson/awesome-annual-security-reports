# Guidepoint: Ransomware Annual Report 2024

## Table of Contents
- [Methodology](#methodology)
- [Quarterly Ransomware Summary](#quarterly-ransomware-summary)
- [Q1 2024 in Review](#q1-2024-in-review)
- [Geographic Breakdown of Ransomware Victims (Q1 2024)](#geographic-breakdown-of-ransomware-victims-q1-2024)
...
- [Other Notable Ransomware Events](#other-notable-ransomware-events)
...
![Rate of Publicly Posted Ransomware Victims chart]
...
![Most Impacted Industries – Q1 2024 chart]
...
![Overall Activity by Taxonomy Classification chart]
...
![Cumulative Victims by Threat Group chart]
...
The group claims to have been created "to establish better unity and connections for everyone in the underground world of the internet, to expand and grow our work and operations." Recent security reporting on collaboration between Stormous, an extortion or ransomware group, and GhostSec, a nominal hacktivist organization, has brought the group, which primarily communicates to the public via Telegram, to wider attention.
