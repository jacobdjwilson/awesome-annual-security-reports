# GRIT Ransomware Report - January – March, 2024

The official report URL is: https://www.guidepointsecurity.com/resources/grit-ransomware-annual-report-2023/

# GRIT Ransomware Report
...
![Most Impacted Industries – Q1 2024](Most Impacted Industries – Q1 2024)
...
![Overall Activity by Taxonomy Classification](Overall Activity by Taxonomy Classification)
...
In fact, GRIT observed a decrease among all group taxonomies except Rebrand throughout Q1 2024 compared to Q4 2023, with an average decrease of 11.6%. Blacksuit, the only confirmed active Rebrand group operating in both Q4 2023 and Q1 2024, increased its number of posted victims from 11 to 17, resulting in a higher rate of activity in the Rebrand classification.
...
![Industry Impacts by Taxonomy Classification](Industry Impacts by Taxonomy Classification)
...
QILIN, formerly known as Agenda, is an Established, double-extortion ransomware group that has been active since at least mid-2022. Ransomware variants associated with the group have been observed "in the wild" as programmed in Rust or GoLang, with Rust variants applying intermittent encryption as a means of defense evasion and increasing the speed of encryption.
...
"The Five Families" is a cybercrime collective that announced its establishment in August 2023 and has attracted renewed attention in recent weeks based on widespread security reporting of collaboration between two of the component groups. In totality, "The Five Families" was allegedly formed with leadership representing five distinct cybercrime and hacktivist groups:
...
While "hacktivist" groups and other "hacker" groups do not represent a sophisticated or well-funded threat to most organizations, their operations can be disruptive or extortive to victims.
...
*   We are not aware of posts, claims, or operations attributable to ThreatSec since January 2024, following the alleged "doxxing"—or public identification—of ThreatSec's leader. Subsequent hearsay indicates that the community believes ThreatSec has, for all intents and purposes, disbanded.
