...
- [Contributing Experts](#contributing-experts)
...
> — **Sean Deuby**, Principal Technologist (North America), Semperis

---

## Key Findings

*   **Ransomware attackers strike when security coverage is lighter or when companies are distracted.** 72% of survey respondents (86% of those targeted by ransomware) were attacked on a holiday or weekend, and 63% of respondents (76% of targeted organizations) suffered a ransomware attack during a major corporate event, such as a merger, acquisition, or IPO.
...
![Chart showing 86% of organizations that experienced ransomware attacks were targeted on a holiday or weekend, with regional breakdowns: US 85%, UK 85%, France 77%, Germany 82%]
...
> — **Simon Hodgkinson**, Semperis Strategic Advisor, Semperis
...
“Every company’s leadership should want to understand the exposure of their IT infrastructure,” he says. “Every corporate board should be asking their CISO two questions. One: What is our level of risk? And two: What are the systems that would completely cripple our organization if they were taken out?”
...
Organizations with an outsourced SOC should ensure that the provider has dedicated backup systems for Active Directory and a documented identity recovery plan. Organizations that maintain in-house security should also have such resources. Those that do not or that are unsure of the efficacy of their disaster recovery plan should consult with a trusted ITDR expert with experience defending, detecting, and recovering from ransomware.

### STEP 3: Security should be a core aspect of every merger or acquisition.
