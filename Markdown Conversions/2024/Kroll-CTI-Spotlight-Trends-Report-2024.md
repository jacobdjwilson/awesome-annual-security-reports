...
- [Incidents by Sector](#incidents-by-sector)
- [Professional Services Breakdown](#professional-services-breakdown)
- [Most Impacted Sectors (Previous 6 Months)](#most-impacted-sectors-previous-6-months)
- [Ransomware – Top Impacted Sectors](#ransomware--top-impacted-sectors)
- [Top Ransomware Variants](#top-ransomware-variants)
- [Ransomware – Actor-Controlled Site Listings](#ransomware--actor-controlled-site-listings)
- [Incidents by Threat Type](#incidents-by-threat-type)
- [Threat Type Trends](#threat-type-trends)
- [Initial Access Methods](#initial-access-methods)
- [Trending Vulnerabilities](#trending-vulnerabilities)
- [Definitions: Threat Incident Types](#definitions-threat-incident-types)
- [Definitions: Initial Access Methods](#definitions-initial-access-methods)
- [Additional Resources](#additional-resources)
- [Definitions: Traffic Light Protocol (TLP)](#definitions-traffic-light-protocol-tlp)
- [About Kroll](#about-kroll)
...
## Key Takeaways
| Initial Access Methods | Most Impacted Sectors |
| :--- | :--- |
| • Phishing – Link (27%) | • Professional Services (21%) |
| • Valid Accounts – Insider (24%) | • Healthcare (14%) |
| • Social Engineering (19%) | • Retail/Restaurant (12%) |
| | • Manufacturing (12%) |

| Top Ransomware Variants | Top Threat Incident Types |
| :--- | :--- |
| • FOG (20%) | • Email Compromise (47%) |
| • LOCKBIT (10%) | • Ransomware (16%) |
| • AKIRA (10%) | • Insider Threat (10%) |
TLP: AMBER

## Sector Analysis
**May 2024**

**PROFESSIONAL SERVICES IS THE MOST IMPACTED SECTOR THROUGHOUT MAY 2024**
- Email Compromise was the top threat incident type impacting the professional services sector.
- In May, threats against the professional services sector most often involved Phishing – Link and Social Engineering as the initial access method.

**HEALTHCARE AND RETAIL/RESTAURANT WERE THE 2nd and 3rd MOST IMPACTED SECTORS IN MAY 2024**
- Email Compromise was the top reported threat incident type impacting both sectors.
TLP: AMBER

## Ransomware Analysis
**May 2024**

**CVE/ZERO-DAY EXPLOIT WAS THE MOST COMMON INITIAL ACCESS METHOD FOR RANSOMWARE OPERATORS IN MAY 2024**
- CVE-2024-3400 and CVE-2024-24919 were the top vulnerabilities exploited.
- MEDUSA was observed exploiting CVE-2024-24919.
- ROBINHOOD was observed exploiting CVE-2024-3400.
- FOG was observed most frequently to target the healthcare and education sectors.
- Drive-By Compromise, External Remote Services, and Social Engineering were the second most observed initial access method in ransomware engagements.
TLP: AMBER
...
- Law Firms & Legal Services: 17%
- Insurance: 13%
- Real Estate: 8%
TLP: AMBER

## Most Impacted Sectors (Previous 6 Months)
![Chart showing sector trends for Professional Services, Healthcare, Retail/Restaurant, Manufacturing, Financial Services, and Education from Dec-23 to May-24]
TLP: AMBER

## Ransomware – Top Impacted Sectors
**May 2024**
- Manufacturing: 22%
- Retail/Restaurant: 17%
...
**May 2024**
![Bar chart showing top ransomware variants with FOG at 20% and others at 10%]
TLP: AMBER
...
- Exposed Database: 4%
- Web compromise: 2%
- Remaining 11% consists of Malware and Other Threat Incident Type
TLP: AMBER

## Threat Type Trends
![Charts showing trends for Email Compromise, Insider Threat, Ransomware, Unauthorized Access, Malware-Other, and Web Compromise from Dec-23 to May-24]
TLP: AMBER
...
- CVE / Zero-Day Exploit: 11%
- Phishing - Attachment: 8%
...
| :--- | :--- | :--- |
| CVE-2024-3400 | Palo Alto Networks | [Link](https://nvd.nist.gov/vuln/detail/CVE-2024-3400) |
| CVE-2024-24919 | Check Point Software | [Link](https://nvd.nist.gov/vuln/detail/CVE-2024-24919) |
| CVE-2024-27348 | Apache HugeGraph-Server | [Link](https://nvd.nist.gov/vuln/detail/CVE-2024-27348) |
| CVE-2024-4835 | GitHub | [Link](https://nvd.nist.gov/vuln/detail/CVE-2024-4835) |
| CVE-2024-27130 | QNAP | [Link](https://nvd.nist.gov/vuln/detail/CVE-2024-27130) |
TLP: AMBER

## Definitions: Threat Incident Types
...
## Definitions: Initial Access Methods
...
- **Upcoming Webinar**: Fighting Advanced Malware Threats: Kimsuky and the ScreenConnect Vulnerability (Wednesday, June 26; 11:00 AM – 11:45 AM EDT). [Register here](URL).

## Definitions: Traffic Light Protocol (TLP)
- **TLP:RED**: Not for disclosure, restricted to participants only.
- **TLP:AMBER+STRICT**: Limited disclosure, restricted to participants’ organization only.
- **TLP:AMBER**: Limited disclosure, restricted to participants’ organizations and clients.
