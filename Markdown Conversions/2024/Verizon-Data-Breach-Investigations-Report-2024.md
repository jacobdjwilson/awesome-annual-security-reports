...
- [Appendices](#appendices)
  ...
  - [Appendix C: U.S. Secret Service](#appendix-c-u.s.-secret-service)
...
relevant trends in cybercrime that play out on a global stage across organizations
...
![Figure 1. Select ways-in enumerations in non-Error, non-Misuse breaches (n=6,963)](placeholder_for_figure_1.png)

![Figure 2. Ransomware and Extortion breaches over time](placeholder_for_figure_2.png)
...
![Figure 3. Select key enumerations in breaches](placeholder_for_figure_3.png)

![Figure 4. Phishing email report rate by click status](placeholder_for_figure_4.png)

![Figure 5. Select action varieties in Financial motive over time](placeholder_for_figure_5.png)
...
exciting milestone of more than 10,000 breaches analyzed in a single edition.²
...
![Figure 6. Select ways-in enumerations in non-Error, non-Misuse breaches over time](placeholder_for_figure_6.png)
...
³ We’re not throwing shade—different types of contributing organizations focus on what is most
...
Email vector is rather self-explanatory,⁴
...
non-Misuse breaches (n=2,770)](placeholder_for_figure_7.png)
...
an organization’s day,⁶ but it is often
...
![Figure 8. Human element enumeration in breaches over time](placeholder_for_figure_8.png)
...
year,⁸ we would like to introduce a new
...
![Figure 9. Supply chain interconnection in breaches over time](placeholder_for_figure_9.png)

embrace the broadest possible
interpretation of the term.⁹ Have a peek
...
entry to an organization’s facilities.¹⁰
...
(n=1,075)](placeholder_for_figure_10.png)

¹⁰ We should stop watching those “Mission: Impossible” movies during DBIR writing season.

## VERIS Actors

Hey, you, don’t skip this section
this year! We know we keep repeating,
...
breach collection processes¹¹ and the
...
holding their feet to the fire.¹² We will
be discussing more about this Error
renaissance¹³ in the respective pattern
...
![Figure 11. Threat actors in breaches over time](placeholder_for_figure_11.png)
...
breaches (n=5,632)](placeholder_for_figure_12.png)
...
are less likely to target run-of-
the-mill enterprises as often as your
...
breaches (n=7,921)](placeholder_for_figure_13.png)
...
above.²³ It made it seem like it already
...
of GenAI-driven threats.”²⁴ This little
...
in criminal forums](placeholder_for_figure_14.png)
...
community,¹⁷ it seems that the DBIR
team will not be adding “Evil AGI”¹⁸ to
...
two years. Most of the mentions²¹
...
being published²² of leveraging such
...
²⁰ But if we had been taken over by an evil AI technology, that is what we would say. Makes
you think.
...
the-age-of-ai
²³ And when we asked it to do it again but in the voice of the DBIR, it seemed unhealthily fixated in
circus and theater jokes and puns. Is that what we sound like?
²⁴ We certainly know where we’re getting marketing copy for our next cybersecurity startup.

## VERIS Actions

A wise person²⁵ once said, “We are
...
sides of the same coin,²⁶ we show a
