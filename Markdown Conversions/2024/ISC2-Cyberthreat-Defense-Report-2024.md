ob much faster and more effective, allowing them to scan vast networks in seconds to find the "low-hanging fruit."

The second most-cited concern is the “Increased sophistication of cyberthreats” (41 7%)  This is a broad category, but it speaks to the fear that AI will allow attackers to create more complex, multi-stage, and adaptive attacks that are harder to detect and block than the static, signature-based attacks of the past

Close behind, at 40 7%, is “More-effective, well-written phishing/spear-phishing emails ” This is a major concern for many security leaders  Generative AI can be used to create highly personalized, grammatically perfect, and contextually relevant phishing emails that are much more likely to trick even savvy employees than the poorly written, generic phishing emails of the past

Rounding out the top four is the “Increased volume of cyberthreats” (37 4%)  AI can be used to automate the creation and distribution of attacks, allowing threat actors to launch massive, coordinated campaigns with minimal effort

The remaining two options, “Potential fraud associated with deepfake photos, videos, or audio” (36 9%) and “Improved ability to uncover zero-day vulnerabilities” (30 9%), were also selected by a significant number of respondents  Deepfakes are a growing concern for organizations that rely on video or audio for authentication or communication, while the ability to uncover zero-day vulnerabilities could give attackers a significant advantage by allowing them to exploit systems before patches are available

The fact that all six of these negative outcomes were selected by at least 30% of respondents shows that security professionals are deeply concerned about the potential for AI to be used by threat actors to enhance their capabilities across the board

“The fact that all six of these negative outcomes

were selected by at least 30% of respondents

shows that security professionals are deeply

concerned about the potential for AI to be used

by threat actors to enhance their capabilities
