...
![Figure 1. Demographics of Survey Respondents](Image description: A composite image showing demographic data for the 2024 SANS Threat Hunting Survey respondents. It includes bar charts for "Top 4 Industries Represented," "Organizational Size," and "Top 4 Roles Represented," along with a breakdown of "Operations and Headquarters" numbers. Each gear icon represents 10 respondents for industry, and each building icon represents 10 respondents for organization size. Each person icon represents 10 respondents for roles.)
...
![Figure 2. Respondents’ Primary Industry](Image description: A horizontal bar chart showing the primary industries of survey respondents. Cybersecurity is at 14.7%, followed by Technology at 13.1%, Banking and finance at 12.8%, Manufacturing at 9.7%, Government at 9.2%, Retail at 8.6%, Healthcare at 8.4%, Media at 5.2%, Telecommunications/ISP at 4.2%, Utilities at 3.7%, Insurance at 3.4%, Transportation at 2.6%, Nonprofit/Association at 1.8%, Hospitality at 1.6%, and Other at 0.8%. The x-axis ranges from 0% to 16%.)

### How large is your organization’s workforce, including both employee and contractor staff?

![Figure 3. Respondents’ Organization Size](Image description: A horizontal bar chart illustrating the size of survey respondents' organizations by workforce. "Fewer than 100" employees is 23.6%, "101–500" is 14.7%, "501–1,000" is 9.7%, "1,001–2,000" is 9.2%, "2,001–5,000" is 9.4%, "5,001–10,000" is 7.3%, "10,001–15,000" is 6.8%, "15,001–50,000" is 5.5%, "50,001–100,000" is 5.0%, and "More than 100,000" is 8.9%. The x-axis ranges from 0% to 25%.)
...
![Figure 4. Respondents’ Corporate Headquarters](Image description: A pie chart displaying the primary corporate headquarters locations of survey respondents. The United States accounts for 65.4%, followed by Europe at 14.7%, Canada at 6.5%, Asia at 5.2%, Australia/New Zealand at 2.9%, Africa at 1.8%, Latin America at 1.8%, and Middle East at 1.6%.)
...
![Figure 5. Most Common Types of Attackers](Image description: A bar chart illustrating the most common types of attackers faced by respondents during threat hunting. Business email compromise is at 67.9%, followed by Ransomware at 63.5%, Nation-states at 38.0%, Criminal industrial espionage (competition) at 28.8%, and Other at 8.1%. The x-axis ranges from 0% to 80%.)

SANS 2024 Threat Hunting Survey: Hunting for Normal Within Chaos

6

Although ransomware attacks are similar across the board, BEC comes in various forms and has been on the rise in the past few years. Attackers take over email accounts of legitimate employees within target companies and use a variety of social engineering tactics to get victims to transfer money to the attackers’ accounts. One common tactic is to mimic an executive of the target company and pressure an employee with access to company bank accounts to transfer money for a super-secret and urgent project. Another common approach is for the attacker to intercept emails between the target company and its business customers. The attackers convince the target’s customers to transfer money owed to the attacker’s account rather than to the target’s account. Usually, they give reasons like an ongoing audit in one country that would prevent them from receiving the amount due to that country’s bank account.
...
![Figure 6. Ransomware Techniques](Image description: A bar chart detailing the techniques used for ransomware attacks as reported by respondents. Custom malware is at 60.8%, Targeted exfiltration at 56.2%, Off-the-shelf tools (CobaltStrike, Brute Ratel, etc.) at 53.6%, Targeted manipulation at 47.7%, Living off the land at 42.5%, Supply chain attacks at 34.0%, Deleting traces at 26.8%, Physical access (e.g., planted mole) at 18.3%, and Other at 1.3%. The x-axis ranges from 0% to 80%.)
...
The number three TTP, according to 54% of our respondents, is off-the-shelf tools like Cobalt Strike or Brute Ratel. This also includes legitimate remote access solutions like Anydesk. To 27%, “deleting traces” is nothing that most ransomware actors do very successfully. We do see them trying to purge their traces, however, which quite frequently results in their leaving even more traces or tipping off the SOC that an attack is ongoing.
...
Next, we investigated the TTPs our respondents saw in nation-state cases.

![Figure 7. Nation-State Attacker Techniques](Image description: A bar chart illustrating the techniques used in nation-state attacks as reported by respondents. Living off the land is at 75.8%, Custom malware at 63.7%, Off-the-shelf tools (CobaltStrike, Brute Ratel, etc.) at 62.6%, Supply chain attacks at 54.9%, Targeted exfiltration at 53.8%, Targeted manipulation at 51.6%, Physical access (e.g., planted mole) at 40.7%, Deleting traces at 31.9%, and Other at 2.2%. The x-axis ranges from 0% to 80%.)

Clearly, the leading TTP is “living off the land” at 76% (Figure 7). Whenever an attacker plants malware on a device or pivots to a device using malware, there is a very real chance of their being detected. Using legitimate tools that already exist in a company is a good way to remain undetected, but there are still several methods to detect an attack.
...
![Figure 8. Sources for the Latest Attack Techniques](Image description: A bar chart showing how respondents stay up to date with the newest attacker techniques. Vendor blogs/papers are at 59.4%, Independent blogs/papers at 58.6%, Commercial intelligence providers at 55.4%, Our own research at 50.2%, OSINT providers at 47.8%, Governmental organizations (e.g., bulletins) at 44.6%, Industry peers at 44.2%, and Other at 1.6%. The x-axis ranges from 0% to 60%.)
...
![Figure 9. Use of Threat Hunting Methodologies](Image description: A stacked bar chart comparing the use of threat hunting methodologies in 2023 and 2024. In 2024, 50.8% use formally defined methodologies, 35.3% use ad hoc methodologies, 12.6% plan to define methodologies, and 2.0% have no plans to formalize. In 2023, 34.6% use formally defined methodologies, 37.7% use ad hoc methodologies, 20.2% plan to define methodologies, and 6.8% have no plans to formalize. The x-axis ranges from 0% to 50%.)

SANS 2024 Threat Hunting Survey: Hunting for Normal Within Chaos

12

The responses from the last three years provide an insightful look into how organizations adapt their threat hunting methodologies over time. This year, the percentage of organizations that revise their threat hunting methodologies “whenever needed” has decreased to 35% from 45% in 2023 and 48% in 2022 (Figure 10). This positive trend might suggest that organizations are moving toward more regular and scheduled reviews of their practices rather than ad hoc changes, which can help ensure a more disciplined and consistent approach to threat hunting. The increased frequency of reviews can be critical for keeping pace with the rapidly evolving nature of cyber threats, where new vulnerabilities and attack strategies emerge at a continually increasing pace.
...
![Figure 10. Frequency of Reviewing/Changing Methodologies](Image description: A stacked bar chart showing the frequency of reviewing/changing threat hunting methodologies across 2022, 2023, and 2024. In 2024, "Whenever needed" is 35.3%, "Monthly" is 26%, "Quarterly" is 20.1%, "Annually" is 11.3%, "Never" is 1.0%, and "Unknown/Unsure" is 7.4%. In 2023, "Whenever needed" is 45.2%, "Monthly" is 6.1%, "Quarterly" is 15.8%, "Annually" is 12.1%, "Never" is 3.5%, and "Unknown/Unsure" is 18.4%. In 2022, "Whenever needed" is 47.5%, "Monthly" is 9.9%, "Quarterly" is 20.1%, "Annually" is 10.8%, "Never" is 1.8%, and "Unknown/Unsure" is 7.4%. The x-axis ranges from 0% to 50%.)
...
![Figure 11. The Relationship Between Methodologies and Staffing](Image description: A stacked bar chart comparing the influence of methodologies on staffing strategy versus staffing influencing methodologies from 2022 to 2024. In 2024, "Available human resources influence the selection of methodologies" is 47.3%, "It's a combination of both" is 32.0%, "Methodologies affect the staffing strategy" is 13.8%, and "Unknown" is 6.9%. In 2023, these percentages were 49.3%, 21