Organization: Censys
# 2024 State of the Internet Report: Internet-Connected Industrial Control Systems
...
![Bar chart showing Countries with Greatest Exposed HMIs, with the United States leading at nearly 5,000, followed by Germany, Canada, France, Austria, Italy, United Kingdom, Australia, Spain, and Poland.]

### Networks

**Top 20 Autonomous Systems Running HMIs**

![Bar chart showing Top 20 Autonomous Systems Running HMIs. Top providers include CELLCO-PART (Verizon), DTAG, ATT-MOBILITY, TMA Magenta Telekom, and COMCAST.]
...
![Bar chart visualizing the Global C-More HMI Industry Composition as listed above.]
...
![Bar chart showing Globally Observed ICS Protocols. MODBUS leads with over 40,000 services, followed by FOX, BACNET, WDBRPC, EIP, S7, IEC60870_5_104, ATG, DIGI, CODESYS, CMORE, FINS, OPC_UA, and others.]
...
![Comparison charts for North America and Europe. North America shows high concentrations of FOX, MODBUS, EIP, and BACNET. Europe shows high concentrations of MODBUS, FOX, S7, and EIP.]

**Countries with Greatest ICS Service Exposure**

![Bar chart showing Countries with Greatest ICS Service Exposure. The United States leads at over 30%, followed by Turkey, South Korea, Italy, Canada, Spain, China, Germany, France, and the UK.]
...
To account for each country’s Internet footprint, we examined the ratio of ICS services to all services in that country, and different patterns emerged. Lithuania, Belarus, and Turkey top this list, and the U.S. falls out of the top twenty. Compared with raw numbers, we observe a greater number of eastern European countries among the top twenty using this metric.
...
![Bar chart showing the ratio of ICS services. Lithuania, Belarus, and Turkey have the highest ratios, followed by Puerto Rico, Georgia, and Slovenia.]

### Networks

**Top 20 Autonomous Systems Running ICS Services**

![Bar chart showing Top 20 Autonomous Systems Running ICS Services. CELLCO-PART (Verizon) leads significantly, followed by TURKCELL-AS, COMCAST, KIXS-AS-KR, and TELEFONICA_DE_ESPANA.]
...
Similar to HMIs, ICS protocols typically reside on 5G or LTE networks that provide little useful metadata about who is responsible for the system. HMIs often contain company logos or plant names that can aid in identification of the owner and sector. ICS protocols rarely offer this same information, making it nearly impossible to identify and notify owners of exposures.

Cooperation from major telcos hosting these services is likely necessary to solve this problem. While the ICS security landscape continues to evolve, Censys remains committed to providing the best visibility to help operators and defenders protect the world’s most critical infrastructure.
