...
3. [HIGHLIGHTS OF 2024 Survey Findings](#highlights-of-2024-survey-findings)
4. [THE CLOUD ECONOMY: A Global Perspective](#the-cloud-economy-a-global-perspective)
5. [From Exploration to Cloud-Native Innovation](#from-exploration-to-cloud-native-innovation)
6. [Plan for Cost Optimization of Legacy Apps](#plan-for-cost-optimization-of-legacy-apps)
7. [Balancing Tools, Vendors, and Organizational Needs](#balancing-tools-vendors-and-organizational-needs)
8. [Top Concerns in Cloud Security](#top-concerns-in-cloud-security)
9. [Incident Response: The Race Against Time](#incident-response-the-race-against-time)
10. [Securing Sensitive Data in the Cloud](#securing-sensitive-data-in-the-cloud)
11. [What Would You Do Differently?](#what-would-you-do-differently)
12. [The Human Factor](#the-human-factor)
13. [Risks, Realities, and Cloud Security Strategies](#risks-realities-and-cloud-security-strategies)
14. [Embracing the Unknown: The Impact of AI on the Application Lifecycle](#embracing-the-unknown-the-impact-of-ai-on-the-application-lifecycle)
15. [Recommendations for Securing the Cloud](#recommendations-for-securing-the-cloud)
16. [How Palo Alto Networks Helps](#how-palo-alto-networks-helps)
...
*   Almost half of respondents experience major release delays all or most of the time **48%**
...
**Figure 1.** Regional investment patterns. The image is a bar chart comparing cloud spending across different regions. The x-axis lists regions (US, UK, Singapore, Australia, Brazil, France, Germany, India, Japan, Mexico). The y-axis shows percentages from 0% to 80%. Each region has two bars: one for "Less than $10 million" and one for "$10 million or more". The bars show the percentage of organizations in each region that fall into these spending categories. For example, the US has approximately 30% of organizations spending less than $10 million and 70% spending $10 million or more.

From Global Cloud Economy
| Region | Less than $10 million | $10 million or more |
|---|---|---|
| US | 30% | 70% |
| UK | 32% | 69% |
| Singapore | 27% | 73% |
...
**Figure 2.** Primary method of application deployment to the cloud. The image is a pair of pie charts showing the distribution of application deployment methods. The left pie chart represents the "Total Average" and shows 33% cloud-native, 35% lift and shift, and 31% refactor. The right pie chart represents the "Average 3+ Years" and shows 36% cloud-native, 33% lift and shift, and 31% refactor. An arrow points from "Quick wins" to "Performance, scalability, cost-efficiency" to indicate the progression from lift and shift to cloud-native.

| Deployment Method | Total Average | Average 3+ Years |
|---|---|---|
| Cloud-Native | 33% | 36% |
| Lift and Shift | 35% | 33% |
| Refactor | 31% | 31% |
...
**Figure 3.** Countries with the most all cloud-native environments. The image is a list of countries and their percentage of cloud-native environments. Australia and Singapore are at 26%, United States at 24%, France at 17%, and Germany at 14%.
...
**Figure 4.** Cloud architecture usage. The image is a pie chart showing the distribution of cloud architecture usage. The categories are 21% Self-hosted Containers, 19% CaaS, 19% PaaS, 20% Serverless, and 21% VM.

| Architecture | Percentage |
|---|---|
| Self-hosted Containers | 21% |
| CaaS | 19% |
| PaaS | 19% |
| Serverless | 20% |
| VM | 21% |
...
**Figure 5.** Increases in security incidents over the last 12 months. The image is a bar chart showing the percentage increase in various security incidents. The incidents listed are data breaches (64%), significant compliance violations (48%), insecure APIs (46%), downtime due to misconfigurations (45%), advanced persistent threats (45%), secret exposures (43%), identities with overly permissive access (42%), vulnerable or poisoned workload images (42%), unrestricted network access between workloads (41%), and data leaks (34%).

| Incident | Percentage Increase |
|---|---|
| Data breaches | 64% |
...
| Secret exposures | 43% |
| Identities with overly permissive access | 42% |
| Vulnerable or poisoned workload images | 42% |
| Unrestricted network access between workloads | 41% |
| Data leaks | 34% |
...
**Figure 6.** Data storage distribution. The image is a pie chart showing the distribution of data storage locations. The categories are Endpoint (17%), On-prem (23%), SaaS (19%), Private Cloud (19%), and Public Cloud (22%).

| Storage Location | Percentage |
|---|---|
| Endpoint | 17% |
| On-prem | 23% |
| SaaS | 19% |
...
### Data Security Foes
**Figure 7.** Top challenges in data security. The image is a bar chart showing the percentage of organizations facing various data security challenges. The challenges listed are complexity and fragmentation of cloud environments (54%), lenient IAM practices or lack of granularity with permissions (50%), inadequate monitoring of sensitive data (48%), and poor secret management practices (38%).

| Challenge | Percentage |
|---|---|
| Complexity and fragmentation of cloud environments | 54% |
| Lenient IAM practices or lack of granularity with permissions | 50% |
| Inadequate monitoring of sensitive data | 48% |
| Poor secret management practices | 38% |
...
**Figure 8:** Sources of stress among DevOps and cloud SecOps professionals. The image is a bar chart showing the percentage of respondents who cite various sources of stress. The sources listed are being responsible for getting hacked (46%), conflict between DevOps and SecOps (52%), rapid pace of change and tight deadlines (48%), and employee turnover (43%).

| Source of Stress | Percentage |
|---|---|
| Being responsible for getting hacked | 46% |
| Conflict between DevOps and SecOps | 52% |
| Rapid pace of change and tight deadlines | 48% |
