...
[Train your team on cybersecurity and business best practices for free, today.](https://www.blackpointcyber.com/)
...
The following is a list of the top 10 ransomware threat actors in 2023, with the number of records associated with each:
...
[The EDR Gap: Hear about real cases of EDR blind spots, and how MDR stepped in for the save.](https://www.blackpointcyber.com/)
...
The following is a breakdown of the percentage of cloud incidents encountered each month from December 2022 to November 2023:
*   Dec. 2022: 56.91%
*   Jan. 2023: 60.00%
*   Feb. 2023: 65.47%
*   Mar. 2023: 48.41%
...
The following is a breakdown of the number of Business Email Compromise attempts from December 2022 to November 2023:
*   Dec. 2022: 1,059
*   Jan. 2023: 1,437
*   Feb. 2023: 1,879
*   Mar. 2023: 2,744
...
### BlackCat TTPs
The following is a list of BlackCat's TTPs, categorized by MITRE ATT&CK framework:
...
### LockBit TTPs
The following is a list of LockBit's TTPs, categorized by MITRE ATT&CK framework:
