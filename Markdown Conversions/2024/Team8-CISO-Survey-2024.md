...
- [01 Security Budgets](#01-security-budgets)
  - [Benchmark: Budget ranges](#benchmark-budget-ranges)
  - [Most CISOs report budget growth](#most-cisos-report-budget-growth)
  - [Smaller organizations saw budget decreases](#smaller-organizations-saw-budget-decreases)
- [02 Compliance and Liability](#02-compliance-and-liability)
  - [2024: More regulation is introduced](#2024-more-regulation-is-introduced)
  - [CISOs are under increased scrutiny by boards](#cisos-are-under-increased-scrutiny-by-boards)
  - [More CISOs feel personally impacted](#more-cisos-feel-personally-impacted)
- [03 AI](#03-ai)
  - [Top risks from attackers leveraging AI](#top-risks-from-attackers-leveraging-ai)
  - [Challenges for defending AI](#challenges-for-defending-ai)
- [04 2024 Top CISO Pain Points](#04-2024-top-ciso-pain-points)
  - [Data Security is the main pain point](#data-security-is-the-main-pain-point)
  - [TPRM: A pain point for nearly 1 in every 2 CISOs](#tprm-a-pain-point-for-nearly-1-in-every-2-cisos)
...
- [05 Methodology & Survey Respondents](#05-methodology--survey-respondents)
  - [Cybersecurity Department Size](#cybersecurity-department-size)
  - [Industry](#industry)
  - [Scrutiny](#scrutiny)
    - [Scrutiny vs. Industry](#scrutiny-vs-industry)
    - [Scrutiny vs. Budget](#scrutiny-vs-budget)
- [Appendix](#appendix)
  - [A. Department Size vs. Budget](#a-department-size-vs-budget)
  - [B. Department Size vs. Budget Change](#b-department-size-vs-budget-change)
  - [C. Budget Change by Industry](#c-budget-change-by-industry)
  - [D. Pain Points by Industry](#d-pain-points-by-industry)
  - [E. Pain Points by Department Size](#e-pain-points-by-department-size)
- [Endnotes](#endnotes)
...
![Bar chart showing the distribution of annual cybersecurity budgets. 35% are $5M-$20M, 17.5% are $3M-$5M, 15% are <$3M, 12.5% are $20M-$50M, 11.2% are $50M-$100M, and 8.8% are $100M+.](image-1.png)
...
![Bar chart showing cybersecurity budget changes. 70% Increased (vs. 53% last year), 15% No Change (vs. 24% last year), 15% Decreased (vs. 22% last year).](image-2.png)
...
![Bar chart showing the types of AI-powered attacks posing the biggest threat. Phishing campaigns are at 75%, Deep-fake enhanced fraud (voice or video) at 56.2%, Network infiltration at 20%, Endpoint exploitation at 17.5%, and Hallucinations, bias, copyright and other content liability issues at 16.2%.](image-3.png)
...
![Bar chart showing expected AI security solution purchases in the next 1-2 years. Vulnerability management in AI development lifecycles is 41.2%, Data privacy for 3rd party AI applications is 36.2%, Shadow AI (discovery and mapping of AI usage) is 32.5%, Only a platform combining several use-cases of the above is 28.8%, and Adversarial attacks against enterprise-owned AI applications is 22.5%.](image-4.png)
...
![Bar chart showing the biggest challenges organizations face in defending AI systems. Lack of expertise is 57.5%, Balancing security with usability is 56.2%, and Regulatory uncertainty is 31.2%.](image-5.png)

## 04 2024 Top CISO Pain Points
...
![Bar chart showing the most acute problems CISOs face where existing solutions are not meeting needs. Data Security (DLP, Insider Threat) is 65%, Third-party Risk Management (TPRM) is 47%, AI Application Security is 42%, Security Executive Dashboard is 41%, Human Identity is 41%, Non-Human Identity Management is 37%, SOC Automation is 32%, Security Data Lake is 25%, Business Email Compromise is 21%, and Deep Fake Detection is 22.5%.](image-6.png)
...
![Bar chart showing what would make CISOs purchase or replace their Third-Party Risk Management (TPRM) product. Validating and monitoring vendor risk directly through integrations into their security controls is 37.5%, Continuously assessing vendors' risk footprint in the organization is 32.5%, and A trusted exchange for vendors and enterprises (including peer group benchmark on vendors, policies & procedures) is 31.2%.](image-7.png)
