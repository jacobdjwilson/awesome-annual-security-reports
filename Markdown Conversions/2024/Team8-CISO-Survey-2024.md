...
![Chart showing budget ranges: 35% $5M-$20M, 17.5% $3M-$5M, 15% <$3M, 12.5% $20M-$50M, 11.2% $50M-$100M, 8.8% $100M+]

2024 CISO Village Survey 5
...
![Chart showing 70% Increased (vs 53% last year), 15% No Change (vs 24% last year), 15% Decreased (vs 22% last year)]
...
*   **32%** of CISOs have taken action to mitigate their legal risk, such as legal counseling, insurance or adjusting their personal contracts.

2024 CISO Village Survey 8
...
These statistics emphasize the critical need for robust cybersecurity measures to counter AI-driven attacks and ensure resilience against emerging digital threats. CISOs are increasingly pushed to adopt AI-powered tools to stay ahead of evolving threats, impacting all existing cybersecurity categories, including endpoint, cloud, network, and application security. The promise of GenAI-based automation in cybersecurity is especially potent given the immense skill shortage the industry is facing. AI is already beginning to augment human teams, aiming to accelerate detection, response and remediation efforts.

**Which type of AI-powered attacks poses the biggest threat to your organization?**
*   Phishing campaigns: 75%
*   Deep-fake enhanced fraud (voice or video): 56.2%
*   Network infiltration: 16.2%
*   Endpoint exploitation: 20%
*   Hallucinations, bias, copyright and other content liability issues: 22.5%
...
*   Vulnerability management in AI development lifecycles: 41.2%
*   Data privacy for 3rd party AI applications: 36.2%
*   Shadow AI (discovery and mapping of AI usage): 32.5%
*   Only a platform combining several use-cases of the above: 28.8%
*   Adversarial attacks against enterprise-owned AI applications: 17.5%

2024 CISO Village Survey 10
...
*   Lack of expertise: 57.5%
*   Balancing security with usability: 56.2%
*   Regulatory uncertainty: 31.2%

2024 CISO Village Survey 11
...
*   Data Security (DLP, Insider Threat): 65%
*   Third-party Risk Management (TPRM): 47%
*   AI Application Security: 42%
*   Human Identity Security: 41%
*   SOC Automation: 41%
*   Executive Dashboard: 37%
*   Non-Human Identity Management: 25%
*   Deep Fake Detection: 22.5%
*   Business Email Compromise: 21%
*   Data Lake Security: 21%

2024 CISO Village Survey 12
...
2024 CISO Village Survey 13

**What would make you purchase or replace your Third-Party Risk Management (TPRM) product?**
*   A trusted exchange for vendors and enterprises (including peer group benchmark on vendors, policies & procedures): 37.5%
*   Validating and monitoring vendor risk directly through integrations into their security controls: 32.5%
*   Continuously assessing vendors' risk footprint in the organization: 31.2%
...
| Industry | Increased | No Change | Decreased |
| :--- | :--- | :--- | :--- |
| Financial Services | 58% | 15% | 27% |
| Technology | 79% | 13% | 8% |
| Manufacturing | 91% | 9% | - |
