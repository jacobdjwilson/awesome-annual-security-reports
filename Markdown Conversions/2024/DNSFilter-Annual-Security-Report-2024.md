# DNSFilter 2025 Annual Security Report
...
- [Glossary](#glossary)
- [Citations/Sources](#citationssources)
...
## HOW I LEARNED TO
STOP WORRYING AND LOVE ENCRYPTION
...
![Figure 1. Percent of threat queries out of total queries on the DNSFilter network October 2022 - September 2023](placeholder_for_figure_1.png)
...
![Figure 2. Percent of threat domains out of total domains on the DNSFilter network October 2022 - September 2023](placeholder_for_figure_2.png)
...
![Figure 3. GRAND TOTAL OF THREAT QUERIES (INCLUDING PROXY CATEGORY)](placeholder_for_figure_3.png)
...
![Figure 4. GRAND TOTAL OF THREAT QUERIES (EXCLUDING PROXY CATEGORY)](placeholder_for_figure_4.png)
...
![Figure 5. GRAND TOTAL OF DISTINCT DOMAINS (INCLUDING PROXY CATEGORY)](placeholder_for_figure_5.png)

Without it:

![Figure 6. GRAND TOTAL OF DISTINCT DOMAINS (EXCLUDING PROXY CATEGORY)](placeholder_for_figure_6.png)
...
![Figure 7. Side-by-Side Comparison of Total Blocks in 2023 Per Security Category Versus the Same Categories in 2022. Vertical Scale Is Divided by 1000 For Readability.](placeholder_for_figure_7.png)
...
![Figure 8. The Breakdown of Total DNS Requests for GenAI Domains for One Year](placeholder_for_figure_8.png)

![Figure 9. Total DNS Requests for GenAI Domains Excluding OpenAI](placeholder_for_figure_9.png)
...
TThe news around cryptocurrencies in 2023 has been anything but comforting. By January, the flagship token, Bitcoin, had lost almost three quarters of its high-water-mark value in a matter of months, tumbling from $67,617.02 per coin on November 16th to $16,540.69 on January 1st. While some of that value has been recovered over the span of the year ($27,967.51/BTC as of this writing), it’s still a bitter position, and the year has been fraught with setbacks and challenges along the way.
...
![Figure 10. Total Cryptocurrency Domain Requests v. Cryptocurrency Domain Requests with Malware and Botnet Classifications (May - Sept 2023, Source: DNSFilter Labs Research)](placeholder_for_figure_10.png)
...
| Region           | Total Malicious Queries | Top Threat Category        |
| :--------------- | :---------------------- | :------------------------- |
...
This year, in an effort to better refine the analysis of the threat landscape, we also examined the percentage of blocked requests with respect to the total number of requests for that TLD. For the purposes of this report, we are combining the blocks that are a result of a reported security threat with the blocks that are part of the local policy. For our internal analysis, we did review the types of block separately, but we don’t have room to print them all here. If you would like to review that data as well, please submit your request to help@dnsfilter.com.

![Figure 11. Histogram of the Average Number of DNS Requests Blocked by Major Country Code Top-Level Domains Per Day](placeholder_for_figure_11.png)

![Figure 12. Histogram of the Average Percentage of DNS Requests Blocked by Major Country Code Top-Level Domains Per Day](placeholder_for_figure_12.png)

![Figure 13. Histogram of the Average Number of DNS Requests Blocked by Major Generic Top-Level Domains Per Day (Excluding .com, .org, .net, and .gov)](placeholder_for_figure_13.png)

![Figure 14. Histogram of the Average Percentage of DNS Requests Blocked by Major Generic Top-Level Domains Per Day (Excluding .com, .org, .net, and .gov)](placeholder_for_figure_14.png)
