...
![Percent of threat queries out of total queries on the DNSFilter network October 2022 - September 2023](Image description)
...
![Percent of threat domains out of total domains on the DNSFilter network October 2022 - September 2023](Image description)
...
![GRAND TOTAL OF THREAT QUERIES (INCLUDING PROXY CATEGORY)](Image description)
...
![GRAND TOTAL OF THREAT QUERIES (EXCLUDING PROXY CATEGORY)](Image description)

But what if we just look at the unique domain count?

![GRAND TOTAL OF DISTINCT DOMAINS (INCLUDING PROXY CATEGORY)](Image description)

Without it:

![GRAND TOTAL OF DISTINCT DOMAINS (EXCLUDING PROXY CATEGORY)](Image description)
...
![Side-by-Side Comparison of Total Blocks in 2023 Per Security Category Versus the Same Categories in 2022. Vertical Scale Is Divided by 1000 For Readability.](Image description)
...
![The Breakdown of Total DNS Requests for GenAI Domains for One Year](Image description)

![Total DNS Requests for GenAI Domains Excluding OpenAI](Image description)
...
![Total Cryptocurrency Domain Requests v. Cryptocurrency Domain Requests with Malware and Botnet Classifications (May - Sept 2023, Source: DNSFilter Labs Research)](Image description)
...
| :--------------- | :---------------------- | :--------------------------- |
| Santiago, Chile  | 4.23%                   | Phishing & Deception (99.24%) |
| Singapore        | .51%                    | Malware (74%)                |
| Frankfurt, Germany | .25%                    | Malware (85%)                |
| Vienna, Austria  | .17%                    | Phishing & Deception (72%)   |

Top region for each threat category:

| Threat Category  | Region           | Percentage of Threats |
| :--------------- | :--------------- | :-------------------- |
| Botnet           | Copenhagen, Denmark* | 8%                    |
| Cryptomining     | Milan, Italy*    | 5%                    |
| Malware          | Frankfurt, Germany | 85%                   |
| Phishing & Deception | Santiago, Chile  | 99%                   |
...
![Histogram of the Average Number of DNS Requests Blocked by Major Country Code Top-Level Domains Per Day](Image description)

![Histogram of the Average Percentage of DNS Requests Blocked by Major Country Code Top-Level Domains Per Day](Image description)

![Histogram of the Average Number of DNS Requests Blocked by Major Generic Top-Level Domains Per Day (Excluding .com, .org, .net, and .gov)](Image description)

![Histogram of the Average Percentage of DNS Requests Blocked by Major Generic Top-Level Domains Per Day (Excluding .com, .org, .net, and .gov)](Image description)
...
https://www.bleepingcomputer.com/news/security/march-202