...
![Chart showing the distribution of survey respondents by continent: Europe (79%), North America (11%), Africa (4%), South America (3%), Asia (2%), Oceania (2%).](Image description: Pie chart illustrating the geographical distribution of survey respondents, with Europe being the largest segment.)
...
![Bar chart showing the percentage of Risk Managers involved in various ERM activities, including development of risk maps, ERM training and culture, definition of ERM governance, risk quantification, alignment and integration of risk management with strategy, and definition of risk appetite.](Image description: Bar chart detailing Risk Manager responsibilities in ERM activities.)
...
![Stacked bar chart showing the percentage of Risk Managers using various technologies for different risk management activities, including risk analysis and assessment, interactive visualisation of risk mapping, risk reporting process, action plan monitoring, quantification of risk impact, risk mitigation, KRI monitoring, scenario analysis, predictive risk analysis, claims process, and alert feedback.](Image description: Chart illustrating the adoption of technology in risk management activities.)
...
account accounted for only 14% of Risk Managers and in South America 25%. Other continents are
...
•  North America, however, shows 43% of respondents earning more than € 151k