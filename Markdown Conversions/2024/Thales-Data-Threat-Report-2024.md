...
- [Developer Benefits and Concerns – GenAI](#developer-benefits-and-concerns--genai)
...
The official report URL is: https://cpl.thalesgroup.com/data-threat-report
...
![Chart showing classification issues persist from 2021 to 2024, with a slight increase in the percentage of organizations that can classify at least half of their data.](placeholder_image_1)
...
- 49% of organizations reported being breached sometime in their history, but recent breach history has
  decreased from 24% in 2021 to 15% in 2024.
- Human factors are still a major cause of cloud data breaches; human error was the leading cause with 31%,
  and failure to apply MFA to privileged accounts constituted another 17%.
- Ransomware attacks are more common, with 28% experiencing an attack (up from 22% last year),
  but planning is still poor, with only 21% saying they would follow a formal plan in the event of an attack.
- Multicloud growth is flattening, but financial services
  firms are now slightly more
...
![Chart showing the correlation between compliance audit outcomes and breach history from 2021 to 2024.](placeholder_image_2)
...
![Chart showing the top threat actors from 2021 to 2024, with human error and external attackers consistently ranking high.](placeholder_image_3)

## Increasing Attack Types

![Chart showing the increasing attack types from 2021 to 2024, with malware, ransomware, and phishing as the top categories.](placeholder_image_4)
...
![Chart showing overall breach history and recent breach history from 2021 to 2024.](placeholder_image_5)
...
![Chart showing the number of enterprise SaaS apps used from 2021 to 2024.](placeholder_image_6)
...
![Bar chart showing the greatest sources of concern for security programs.](placeholder_image_7)
...
![Pie chart showing the broad array of personas accessing resources.](placeholder_image_8)
...
![Bar chart showing challenges with securely onboarding customer identities.](placeholder_image_9)
...
![Bar chart showing top-cited security challenges in DevOps.](placeholder_image_10)
...
![Bar chart showing DevSecOps organization maturity.](placeholder_image_11)
...
![Bar chart showing AI security risks of greatest concern.](placeholder_image_12)
...
![Donut chart showing the characterization of the AI journey for the next 12 months.](placeholder_image_13)
...
![Likert scale chart showing challenges with Workforce IAM.](placeholder_image_14)
...
![Stacked bar chart showing Workforce IAM attitudes.](placeholder_image_15)
...
These proactive security approaches in security operations, patching, authentication and zero-trust principles will
be essential as 5G and IoT initiatives converge. Enterprises continue to look to 5G as a primary IoT connectivity
...
![Bar chart showing quantum computing threats of greatest concern.](placeholder_image_16)
...
![Bar chart showing PQC security approaches.](placeholder_image_17)
...
reduce PQC attacks, it remains up to the enterprises to have sovereignty over their security controls, regardless
