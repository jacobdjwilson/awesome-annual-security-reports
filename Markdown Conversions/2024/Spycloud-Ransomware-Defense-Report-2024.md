...
[THE MALWARE & RANSOMWARE RESURGENCE](#the-malware-and-ransomware-resurgence)
...
affected¹ by ransomware more than once in the past 12 months – a jump from 61% last year. 
...
solution installed at the time of successful malware infection.²
...
² 54% is likely low, as not all infostealers collect sufﬁcient data to determine whether an antivirus/endpoint
...
**FIGURE 1.**
*Image description: A pie chart showing the distribution of survey participants by role. The largest segment is "CIO, CISO, OR IT SECURITY EXECUTIVE" at 38%, followed by "SECURITY DIRECTOR, MANAGER, OR TEAM LEAD" at 29%, "IDENTITY AND ACCESS MANAGEMENT (IAM) DIRECTOR, MANAGER, OR SPECIALIST" at 16%, "SECURITY ARCHITECT OR ENGINEER" at 6%, "SECURITY OPERATOR, ANALYST, OR INCIDENT RESPONDER" at 5%, "SECURITY ADMINISTRATOR" at 5%, and "OTHER ROLE IN IT SECURITY" at 1%.*

### SURVEY PARTICIPANTS BY ROLE
*   CIO, CISO, OR IT SECURITY EXECUTIVE - 38%
*   SECURITY DIRECTOR, MANAGER, OR TEAM LEAD - 29%
*   IDENTITY AND ACCESS MANAGEMENT (IAM) DIRECTOR, MANAGER, OR SPECIALIST - 16%
*   SECURITY ARCHITECT OR ENGINEER - 6%
*   SECURITY OPERATOR, ANALYST, OR INCIDENT RESPONDER - 5%
*   SECURITY ADMINISTRATOR - 5%
*   OTHER ROLE IN IT SECURITY - 1%
...
**FIGURE 2.**
*Image description: A bar chart showing the distribution of survey participants by the size of their organization. The largest bar is "1,000 - 4,999 EMPLOYEES" at 43%, followed by "5,000 - 9,999 EMPLOYEES" at 26%, "500 - 999 EMPLOYEES" at 16%, "10,000 - 25,000 EMPLOYEES" at 8%, and "MORE THAN 25,000 EMPLOYEES" at 7%.*

### SURVEY PARTICIPANTS BY SIZE OF ORGANIZATION
*   500 - 999 EMPLOYEES - 16%
*   1,000 - 4,999 EMPLOYEES - 43%
*   5,000 - 9,999 EMPLOYEES - 26%
*   10,000 - 25,000 EMPLOYEES - 8%
*   MORE THAN 25,000 EMPLOYEES - 7%
...
**FIGURE 3.**
*Image description: A bar chart showing the top threats/risks reported by security teams. The threats are listed in descending order of concern, with ransomware being the highest at 4.04, followed by phishing/spear-phishing at 3.94, infostealer malware at 3.90, third-party users/devices at 3.85, shadow IT at 3.72, account takeover (ATO) at 3.64, malicious insiders at 3.64, and unmanaged devices at 3.58.*
...
**FIGURE 4.**
*Image description: A bar chart showing the level of concern for malware-siphoned data leading to future attacks. The majority of respondents are either "EXTREMELY CONCERNED" at 41.6% or "SIGNIFICANTLY CONCERNED" at 44.1%, with a smaller portion being "SOMEWHAT CONCERNED" at 14.1% and a very small fraction being "NOT CONCERNED AT ALL" at 0.2%.*

### CONCERN FOR MALWARE-SIPHONED DATA LEADING TO FUTURE ATTACKS
*   EXTREMELY CONCERNED - 41.6%
*   SIGNIFICANTLY CONCERNED - 44.1%
*   SOMEWHAT CONCERNED - 14.1%
...
**Image description:** A graphic displaying the infostealer infections present in the 3 months prior to reported ransomware attacks in 2024. The graphic shows a series of infostealer names and their corresponding percentages. The highest percentages are for LummaC2 at 57.69% and RedLine at 40.60%. Other notable percentages include StealC at 20.51%, MetaStealer at 19.66%, and RisePro at 17.52%. The graphic also includes a disclaimer that domains may have been infected by multiple stealers, so percentage totals do not sum to 100%.
...
**FIGURE 5.**
*Image description: A bar chart showing malware detection and response capabilities. The capabilities are listed in descending order of effectiveness, with "DETECT / ISOLATE A MANAGED DEVICE THAT HAS BECOME INFECTED WITH MALWARE" being the highest at 4.09, followed by "RESET CREDENTIALS EXPOSED BY A MALWARE INFECTION" at 4.08, "REMEDIATE A MALWARE-INFECTED DEVICE" at 4.07, "IDENTIFY BUSINESS APPS EXPOSED BY A MALWARE INFECTION" at 4.05, "INVALIDATE COMPROMISED WEB SESSIONS ASSOCIATED WITH A MALWARE INFECTION" at 3.96, and "DETECT THIRD-PARTY OR UNMANAGED DEVICES INFECTED WITH MALWARE" at 3.83.*
...
**FIGURE 6.**
*Image description: A bar chart showing the level of agreement with the statement that "BETTER VISIBILITY & REMEDIATION OF MALWARE-EXFILTRATED DATA IS NEEDED". The majority of respondents either "STRONGLY AGREE" at 50.6% or "SOMEWHAT AGREE" at 46.8%, with a very small portion "SOMEWHAT DISAGREE" at 1.3% and "STRONGLY DISAGREE" at 1.3%.*
...
**FIGURE 7.**
*Image description: A bar chart comparing routine responses to malware infections in 2023 and 2024. The chart shows the percentage of organizations that take each action, with the 2024 percentages generally lower than the 2023 percentages. The actions are "INVESTIGATE THE DETAILS OF THE INFECTION (E.G., TYPE, TIMELINE, SCOPE)", "RESET PASSWORDS FOR POTENTIALLY EXPOSED APPS", "ATTEMPT TO REMOVE THE MALWARE", "ISOLATE THE DEVICE", "INVALIDATE / TERMINATE OPEN SESSIONS FOR APPS", "REVIEW LOGS OF POTENTIALLY EXPOSED APPS (FOR SIGNS OF COMPROMISE)", "CREATE AN IMAGE OF THE DEVICE (FOR FORENSIC INVESTIGATION AND / OR EVIDENCE)", and "RE-IMAGE THE DEVICE".*

### ROUTINE RESPONSES TO MALWARE INFECTIONS
*   INVESTIGATE THE DETAILS OF THE INFECTION (E.G., TYPE, TIMELINE, SCOPE)
    *   2023: 88.0%
    *   2024: 79.4%
*   RESET PASSWORDS FOR POTENTIALLY EXPOSED APPS
    *   2023: 63.8%
    *   2024: 76.5%
...
*   ISOLATE THE DEVICE
    *   2023: 80.8%
    *   2024: 58.8%
*   INVALIDATE / TERMINATE OPEN SESSIONS FOR APPS
    *   2023: 60.7%
    *   2024: 57.5%
*   REVIEW LOGS OF POTENTIALLY EXPOSED APPS (FOR SIGNS OF COMPROMISE)
    *   2023: 72.8%
    *   2024: 55.1%
*   CREATE AN IMAGE OF THE DEVICE (FOR FORENSIC INVESTIGATION AND / OR EVIDENCE)
    *   2023: 43.6%
    *   2024: 49.4%
*   RE-IMAGE THE DEVICE
    *   2023: 54.8%
