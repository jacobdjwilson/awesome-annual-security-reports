...
- [Into the Light: The Hero’s Journey](#into-the-light-the-hero’s-journey)
...
The average cost of a ransomware attack is now $4.91 million. Cybercriminals have pivoted to next-generation tactics, using information-stealing malware (or “infostealers”) to siphon credentials, session cookies, and identity data from infected users and selling this information to ransomware operators.

![Player Tip: IBM security researchers reported a 266% upsurge in the use of infostealers by groups that specialize in ransomware.]
...
![Figure 1: Survey Participants by Role]
![Figure 2: Survey Participants by Size of Organization]

## The Dark Beginnings of the Ransomware Journey

Research suggests that ransom payments surged last year, with a 2.6x increase in the average payment and 5x in the median. Recovery costs have climbed to an average of $2.73 million in 2024. Insurance claims data shows a 64% increase in 2023 compared to the prior year.
...
![Figure 3: Top Threats / Risks Reported by Security Teams]
...
![Figure 4: Concern for Malware-Siphoned Data Leading to Future Attacks]

### Stealthy Stealers at Play

Because infostealers are designed to steal information from an infected host, they make great accomplices to ransomware actors attempting to gain credentials before moving laterally in an environment. Many infostealers also double as malware loaders, allowing the stealers to load secondary payloads such as persistent malware or ransomware.
...
Identifying business applications exposed by malware and invalidating compromised web sessions are two of the most critical steps that address the long-term risks of malware – yet they rank at the bottom of malware detection and response capabilities.

![Figure 5: Malware Detection and Response Capabilities]
![Figure 6: Better Visibility & Remediation of Malware-Exfiltrated Data is Needed]

## Risk from Third-Party Exposure: Adversaries’ Extra Advantage

Threat actors leverage plenty of strategies to gain an upper hand in the malware landscape, but nothing presents as big an opportunity as infected third-party and unmanaged devices.

![Figure 7: Routine Responses to Malware Infections]

## The Ransomware Landscape: Land of Infinite Gameplay

The number of organizations affected by ransomware at least once rose from 81% to 92% – and those affected more than once grew from 61% last year to 75% this year.

![Figure 8: Frequency of Ransomware Incidents in the Past Year]

## Data, Financial Knockouts

Significantly more organizations paid a ransom in the past 12 months: 62% this year vs. 48% in last year’s report. Only about a third of those organizations fully recovered their data.

![Figure 9: Response and Outcome to Ransomware Attack]
![Figure 10: Cumulative Cost of Ransomware Attacks in the Last 12 Months]

## Cracks in Your Defenses: Common Attack Entry Points

For the first time, we asked survey participants who were affected by ransomware to share the entry points used by attackers to gain initial access.

![Figure 11: Most Common Entry Points for Ransomware]

## Next-Gen Showdown: The State of Ransomware Defense

Traditional malware mitigation, which is only focused on the infected device, is akin to a stun. To negate the opportunities created by infostealer-exfiltrated data and to disrupt ransomware attacks, security teams and their counterparts in fraud prevention need to shift their focus to the digital identity.

![Figure 12: Most Important Ransomware Countermeasures]

## Into the Light: The Hero’s Journey

There’s an uptick in the number of respondents expressing general confidence in their organization’s ability to prevent a full-blown ransomware attack – from 79% last year to 81% this year.

![Figure 13: Confidence About Preventing a Ransomware Attack]
![Figure 14: Confidence in Ability to Prevent Ransomware Attacks by Role]

## Reevaluating Priorities for the Battle Ahead

Looking ahead at the next 12 to 18 months, the top five priorities for organizations are:
1. Improving ransomware prevention capabilities
2. Improving visibility and remediation for compromised credentials and malware-exfiltrated data
3. Automating security processes and controls
4. Better addressing risk tied to third-party exposures
5. Improving ransomware response plans and procedures

![Figure 15: Top Future Security Priorities]

## Looking to the Horizon: How to Defeat Cybercriminals in the Long Game

Strategies recommended:
- **Adopt an identity-centric security approach**: Relying on old defense tactics like device-centric remediation is bound to fail.
- **Illuminate your full attack surface**: Improve visibility into malware-exfiltrated data, including unmanaged and third-party devices.
- **Use automation to speed up detection and mitigation**: Leverage automated alerts and incident notifications.
- **Expand ATO prevention**: Monitor for stolen web sessions programmatically and implement processes for invalidating them.
