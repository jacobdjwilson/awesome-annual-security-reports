...
- [Dark Web Intelligence Sources Explained](#dark-web-intelligence-sources-explained)
- [How Each Dark Web Source Individually Impacts Cyber Risk](#how-each-dark-web-source-individually-impacts-cyber-risk)
- [The Combined Risk of Multiple Dark Web Sources](#the-combined-risk-of-multiple-dark-web-sources)
- [Recommendations](#recommendations)
- [Appendix 1: Single-Variable Analysis](#appendix-1-single-variable-analysis)
- [Appendix 2: Multi-Variable Analysis](#appendix-2-multi-variable-analysis)
...
**Ben Jones**
Co-Founder and CEO, Searchlight Cyber
...
- **Dark Web Market Listings**: The mention of the organization or data related to the organization on a dark web market.
- **Forum Posts**: The mention of the organization or data related to the organization on a dark web forum.
- **Compromised Users**: Compromised accounts on the dark web related to an organization.
- **Telegram Chats**: The mention of the organization or data related to the organization on Telegram.
- **Incoming Dark Web Traffic**: Traffic originating from the dark web and connecting to an organization’s infrastructure.
- **Outgoing Dark Web Traffic**: Traffic originating from the organization’s network and connecting to the dark web.
- **Dark Web Pages**: The mention of an organization or data related to an organization on a dark web site.
- **Paste Results**: The mention of an organization or data related to an organization on plain-text repositories.
- **OSINT Results**: Open Source Intelligence (OSINT) results extracted from all Searchlight Cyber data feeds.

---

## How Each Dark Web Source Individually Impacts Cyber Risk

Marsh McLennan examined the impact of findings in each of the dark web fields individually in a single-variable analysis.
...
| Intelligence Sources Identified | Incident Rate Without Findings | Incident Rate With Findings | Cyber Incident Likelihood |
| :--- | :--- | :--- | :--- |
...
*Figure 3: The results of the single-variable analysis.*

---

## The Combined Risk of Multiple Dark Web Sources

Marsh McLennan then undertook a multi-variable analysis to establish the importance of an intelligence source if an organization has results in more than one category.

![Figure 4: The increased likelihood of a cyber incident based on a multi-variable analysis.]
...
1. **Gain Visibility into Your Dark Web Exposure**: The first step is to collect dark web intelligence to identify where you are being targeted.
2. **Pursue Comprehensive Coverage of Dark Web Intelligence Sources**: Ensure coverage of all areas: marketplaces, forums, paste sites, Telegram channels, and dark web sites.
3. **Focus on Actionable Intelligence**: Move beyond high-level alerts to granular intelligence on specific threats.
4. **Use Exposure and Risk Data to Inform Defensive Strategies**: Prioritize resources based on the most likely paths to a cyberattack.
5. **Undertake Continuous Monitoring**: The threat landscape is dynamic; continuous monitoring is required to identify new threats quickly.
...
Multi-variable analysis uses a classification model to measure the combined effect of multiple fields and for hidden factors like revenue and industry.
...
**UK Headquarters**
Suite 63, Pure Offices, 1 Port Way, Port Solent, Portsmouth PO6 4TY, United Kingdom
