...
| Variant | Description |
| :--- | :--- |
| UBI Micro | Minimal, for small footprint. |
| UBI Minimal | Optimized for size and security. |
| UBI Standard | Full-featured, for general use. |
| UBI Init | Includes systemd for init processes. |
...
*(Table content omitted for brevity in this text representation, but represents the data comparing UBI variants to Chainguard equivalents)*

*Notes: Measured on Jan 18, 2024. “+WNF” indicates the count included CVEs labeled “will not fix”.*
...
| Image Set | Total CVEs | Count of Critical and High Severity CVEs |
| :--- | :--- | :--- |
| Iron Bank Big Bang | 1,000+ | 31 |
