...
![Allianz Commercial logo and cover art featuring abstract digital imagery]

## Table of Contents
- [Overview](#overview)
- [1. Claims trends](#1-claims-trends)
  - [Ransomware: Slaying the Hydra](#ransomware-slaying-the-hydra)
  - [Data exfiltration drives data breach claims](#data-exfiltration-drives-data-breach-claims)
  - [‘Non-attack’ claims increase – privacy litigation ramps up](#non-attack-claims-increase--privacy-litigation-ramps-up)
- [2. Emerging trends and loss drivers](#2-emerging-trends-and-loss-drivers)
  - [Evolving regulation and cyber disclosure rules](#evolving-regulation-and-cyber-disclosure-rules)
  - [A wave of class action litigation](#a-wave-of-class-action-litigation)
  - [Connectivity fuels mass data breaches](#connectivity-fuels-mass-data-breaches)
  - [AI to power future data privacy breaches](#ai-to-power-future-data-privacy-breaches)
  - [AI: harness the benefits, mitigate the breaches](#ai-harness-the-benefits-mitigate-the-breaches)
- [3. Cyber hygiene](#3-cyber-hygiene)
  - [Common mistakes](#common-mistakes)
  - [Doubling down on cyber security](#doubling-down-on-cyber-security)
  - [Data privacy resilience](#data-privacy-resilience)
...
- **AI, digital interconnectivity, and the growing commercial value of data** are main factors shaping the future risk landscape.
...
The growing significance of data breach losses among cyber insurance claims is down to two notable trends: the shift by cyber criminals targeting personal data, and a jump in ‘non-attack’ data privacy related class action litigation. These two trends have been particularly evident in the US, which now accounts for 72% of large (>€1mn) cyber claims overall (in the first six months of 2024), up from 41% in 2023. The share of ‘non-attack’ (privacy) data breaches tripled in value from 7% in 2022 to 21% during the first half of 2024.
...
"Ransomware is like the proverbial Hydra. Each time you cut off its head, another one grows back in its place," says Michael Daum, Global Head of Cyber Claims, Allianz Commercial.

While law enforcement has had successes, the threat persists. The number of ransomware attacks increased by an average of 75% in 2023, and total ransomware payments exceeded $1bn in 2023[^5]. Allianz Commercial has observed a stabilization of ransomware claims in 2024, reflecting investments in cyber security and risk assessments.
...
"Data exfiltration is now a well-established method of cyber extortion. Even if you have a backup, your data is effectively lost as the attackers have a copy and will threaten to publish on the dark web," says Michael Daum.

In around a third of ransomware-related claims, data exfiltration is now the key loss driver. Companies are two-and-a-half times more likely to pay a ransom if data is exfiltrated.

### ‘Non-attack’ claims increase – privacy litigation ramps up

Breaches of data privacy regulation have emerged as a major driver for cyber insurance claims. The share of ‘non-attack’ (privacy) data breaches increased from 7% in 2022 to 21% in the first half of 2024.
...
Businesses are operating in an environment where regulation often lags behind technology. In the US, the number of states with comprehensive data privacy laws doubled in 2023. Meanwhile, the US Securities and Exchange Commission (SEC) has introduced new rules requiring public companies to disclose material cyber security incidents within four business days.

### A wave of class action litigation

Data breach class actions have surged in the US, with 1,320 filed in 2023, more than double the 604 filed in 2022[^19]. The risk is also growing in Europe, where the EU’s Collective Redress Directive provides mechanisms for collective damage claims.

### Connectivity fuels mass data breaches

The growing commercial value of personal data and the exchange of data between organizations create opportunities for criminals. Incidents like the MOVEit and Change Healthcare breaches highlight the risks of digital interdependency.

### AI to power future data privacy breaches

Artificial intelligence has the potential to turbocharge data breach exposures. AI relies on vast amounts of data, and its "black-box" nature creates potential privacy and security risks.

### AI: harness the benefits, mitigate the breaches

Rishi Baviskar, Global Head of Cyber Risk Consulting, Allianz Commercial, recommends:
- **Data governance**: Robust practices for collection and storage.
- **Ethical AI practices**: Addressing bias and transparency.
- **Privacy-preserving techniques**: Using federated learning and differential privacy.
- **Security measures**: Strong encryption and regular audits.
- **Regulatory compliance**: Aligning with GDPR and CCPA.
...
Despite increased investment, many breaches result from weak cyber security. Phishing and stolen credentials remain the most common attack vectors. Cloud misconfiguration is another frequent cause, often due to a lack of visibility into the IT perimeter.

### Doubling down on cyber security

"The quicker you detect and react to an incident, the less the economic and reputational impact," says Marek Stanislawski. Early detection and response tools, often powered by AI, can significantly reduce the cost and lifecycle of a data breach claim.

### Data privacy resilience

Organizations must focus on data governance and "housekeeping." Marisa Anthony advises: "Be mindful of what data you are collecting. Only collect and store personal data that is needed for business purposes."
...
[^12]: Identity Theft Resource Center, Identity Theft Resource Center 2023 Annual Data Breach Report, January 25, 2024.
...
[^19]: Duane Morris, Duane Morris Data Breach Class Action Review - 2024, February 22, 2024.
[^20]: Clyde & Co, Understanding the MOVEit data breach, April 30, 2024.
...
[^24]: The Register, Snowflake customers not using MFA are not unique, June 11, 2024.
[^25]: Identity Theft Resource Center, Q1 2024 Data Breach Analysis, April 10, 2024.
...
[^28]: McKinsey, The state of AI in early 2024, May 30, 2024.
[^29]: BBC, Airline held liable for its chatbot giving passenger bad advice, February 23, 2024.
[^30]: CNBC, AT&T’s massive data breach deepens crisis for Snowflake, July 12, 2024.
[^31]: Mandiant, UNC5537 Targets Snowflake Customer Instances for Data Theft and Extortion, June 10, 2024.
[^32]: IBM, Cost of a Data Breach Report 2023.
