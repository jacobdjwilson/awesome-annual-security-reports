...
- [Survey Observations](#survey-observations)
  ...
  - [Remote works continues to grow](#remote-works-continues-to-grow)
...
![Chart showing concern levels: Very concerned (61%), Somewhat concerned (29%), Not very concerned (7%), Not at all concerned (3%)]
...
But what is quite telling is how those organizations using a modern IGA solution differed in their concern level. Depending on the specific threat, there is a range of 9% to 21% difference in how organizations respond.

![Table comparing legacy vs modern IGA user concerns]
...
![Chart showing agreement levels: Strongly Agree (35%), Somewhat Agree (36%), Somewhat Disagree (19%), Strongly Disagree (10%)]
...
![Table showing changes in remote identities for Employees, Consultants, Partners, Contractors, and Temporary/Seasonal Help]
...
![Chart showing preference for best-of-breed solutions: Strongly agree (42.15%), Somewhat agree (34.39%), Not sure (11.11%), Somewhat disagree (8.64%), Strongly disagree (3.70%)]
...
![Table showing importance of various IGA characteristics]
...
![Charts showing industry distribution, organization size, and respondent roles]
