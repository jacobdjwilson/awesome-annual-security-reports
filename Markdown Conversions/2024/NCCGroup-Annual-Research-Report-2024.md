...
- [Section 01: 25 Years of Research at NCC Group](#section-01-25-years-of-research-at-ncc-group)
- [Section 02: Cryptography Services](#section-02-cryptography-services)
- [Section 03: Hardware and Embedded Systems](#section-03-hardware-and-embedded-systems)
- [Section 04: Security Research Team, Fox-IT](#section-04-security-research-team-fox-it)
- [Section 05: Security Research Services](#section-05-security-research-services)
- [Section 06: Future Research](#section-06-future-research)
- [Section 07: Our Research in 2024](#section-07-our-research-in-2024)
  - [Vulnerability Research and Exploitation Techniques](#vulnerability-research-and-exploitation-techniques)
  - [Network and System Security](#network-and-system-security)
  - [Malware, Ransomware and Digital Forensics](#malware-ransomware-and-digital-forensics)
  - [Telecommunications Security](#telecommunications-security)
  - [Software Development and AI in Security](#software-development-and-ai-in-security)
- [Section 08: Acknowledgements](#section-08-acknowledgements)
- [Section 09: About Research at NCC Group](#section-09-about-research-at-ncc-group)
...
*   **48** Common Vulnerabilities and Exposures (CVEs), showcasing our commitment to identifying and addressing software and hardware vulnerabilities.
*   **52** Blog Posts, offering in-depth insights, technical guidance, and thought leadership across various domains of cybersecurity.
*   **10** Open-Source Tools, empowering the global cybersecurity community with resources to enhance security capabilities.
*   **17** Public Reports, reinforcing transparency and collaboration by sharing findings from critical assessments and research initiatives.
...
*   In this paper Gerald Doussot explained how to implement the Secure Hash Algorithm3 (SHA-3) family of functions in Lean 4, a functional programming language and theorem prover.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/sha-3-in-lean-4/)

*   Thomas Pornin published A Prime-Order Group with Complete Formulas from Even-Order Elliptic Curves.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/a-prime-order-group-with-complete-formulas-from-even-order-elliptic-curves/)

*   Giacomo Pope has been working with the SQIsign team, who are working on both an optimized and portable reference C-implementation of the signature scheme for the second round of the PQ-DSA call for NIST.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/sqisign-reference-c-implementation/)
...
*   Thomas Pornin and others worked on Efficient Proofs of Possession for Legacy Signatures to be presented at 2025 IEEE Symposium on Security and Privacy (SP).
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/efficient-proofs-of-possession-for-legacy-signatures/)
...
*   Eli Sohl had multiple new Cryptopals videos covering CTR mode, padding oracles and cryptography visualization.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/cryptopals-guided-tour-video-17-padding-oracles/)
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/cryptopals-guided-tour-video-18-implement-ctr/)
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/cryptopals-guided-tour-video-16-cryptography-visualization/)

*   Several members of the team attended Real World Cryptography (RWC) in Toronto.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/real-world-cryptography-2024/)
...
*   Thomas Pornin completed Rust, C and Go implementations of Post Quantum Cryptography algorithm Falcon/FN-DSA, with same performance and features.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/falcon-fn-dsa-implementations/)
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/falcon-fn-dsa-implementations-rust/)
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/falcon-fn-dsa-implementations-go/)

*   Eric Schorn completed Post Quantum Cryptography Implementation of recently published FIPS 203, 204 and 205.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/fips-203-204-205-implementations/)
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/fips-203-204-205-implementations-rust/)
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/fips-203-204-205-implementations-c/)
...
*   Javed Samuel presented on Open Source Cryptography at International Cryptography Module Conference in September.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/open-source-cryptography-presentation/)
...
*   Paul Bottinelli presented on Cryptography Vulnerabilities in the context of Modern Programming Languages International Cryptography Module Conference in September.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/cryptography-vulnerabilities-presentation/)
...
*   Kevin Henry and Elena Bakos Lang presented on Lessons on secure deployment of cryptographic primitives at the University of Waterloo in July.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/secure-deployment-of-cryptographic-primitives-presentation/)
...
*   Kevin Henry, Marie-Sarah Lacharite, and Eli Sohl completed an assessment of libxmtp, which is a Rust implementation of the Extensible Message Transport Protocol (XMTP), built upon Messaging Layer Security (MLS) in a Web3 environment.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/libxmtp-assessment/)
...
*   Gerald Doussot, Parnian Alimi, Marie-Sarah Lacharite, Thomas Pornin, Eli Sohl, and Javed Samuel completed a cryptography security assessment of selected aspects of the WhatsApp Identity Proof Linked Storage (IPLS) protocol implementation.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/whatsapp-ipls-protocol-assessment/)
...
*   Kevin Henry, Parnian Alimi, and Elena Bakos Lang completed a cryptographic security assessment of keyfork, described as an opinionated and modular toolchain for generating and managing a wide range of cryptographic keys offline and on smartcards from a shared mnemonic phrase.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/keyfork-assessment/)
...
*   Paul Bottinelli, Kevin Henry, Elena Bakos Lang, and Eric Schorn reviewed the consensus mechanism implemented by snarkOS: a decentralized operating system for zero-knowledge applications that forms the backbone of Aleo network, which verifies transactions and stores the encrypted state applications in a publicly verifiable manner.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-02-cryptography-services/snarkos-consensus-mechanism-review/)
...
*   **Development of tooling to reverse engineer binaries for the NanoMIPS ISA**: James Chambers and Robert Herrera developed and released the first public tooling for reverse engineering of binaries targeting the NanoMIPS ISA, which is gaining prominence for its use in MediaTek 5G basebands.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-03-hardware-and-embedded-systems/nanomips-reverse-engineering-tooling/)
...
*   **Reverse engineering and identifying vulnerabilities in the PowerG radio protocol**: James Chambers and Sultan Qasim Khan reverse engineered the proprietary PowerG radio protocol used by Johnson Controls alarm systems and identified exploitable weaknesses in the protocol and popular devices using it. Findings were presented at the Recon 2024 conference.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-03-hardware-and-embedded-systems/powerg-radio-protocol-vulnerabilities/)
...
*   **Public report analyzing the eBPF verifier**: Nathaniel Theis and Chris Anley conducted an in-depth security assessment of the eBPF verifier that validates the safety of eBPF programs for the Linux kernel. The assessment uncovered and led to the fixing of a significant bug, and the full assessment report has been made public.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-03-hardware-and-embedded-systems/ebpf-verifier-security-assessment/)
...
*   **Over-the-air exploitation of Sonos devices**: Robert Herrera, together with Alex Plaskett of the Exploit Development Group (EDG), identified a vulnerability in the Wi-Fi stack of a Sonos device and developed an over-the-air exploit that enabled covert listening. This research was presented at Black Hat USA 2024. Details of this project are discussed further in this report among other projects by the EDG.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-03-hardware-and-embedded-systems/sonos-ota-exploitation/)
...
*   **Public report on Confidential Mode for Google Cloud Hyperdisk**: Catalin Visinescu conducted a security design analysis of Data Encryption Key (DEK) handling in the Confidential Mode of Google Cloud Hyperdisk. An overview of the analysis was made available in a public report.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-03-hardware-and-embedded-systems/google-cloud-hyperdisk-confidential-mode-analysis/)
...
*   **Improvements to Sniffle**: Over the course of 2024, Sultan Qasim Khan implemented numerous enhancements to Sniffle, NCC Group’s open-source Bluetooth Low Energy sniffer and testing tool. Highlights from Sniffle releases 1.8 to 1.10 include decoding of advertising data, improved support for extended advertising, support for additional hardware including low-cost Sonoff CC2652P dongles, support for receiving packets with invalid CRCs, and improved performance and reliability.
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-03-hardware-and-embedded-systems/sniffle-enhancements/)
...
[^1]: [UK Government Deepfake Research](https://www.gov.uk/government/news/government-invests-in-new-technology-to-tackle-deepfakes)
[^2]: [US Government Deepfake Research](https://www.nist.gov/news-events/news/2023/07/nist-announces-funding-research-deepfake-detection-technologies)
[^3]: [Coalition for Content Provenance and Authenticity (C2PA)](https://c2pa.org/)
[^4]: [Google Research on AI Models at the Edge](https://ai.googleblog.com/2024/01/secure-ai-at-the-edge-new-research.html)
[^5]: [DSIT 5GTT Research Publication](https://www.gov.uk/government/publications/5g-testbeds-and-trials-programme-cyber-security-research-report)
...
*   **4 Dec 23**: Shooting Yourself in the .flags – Jailbreaking the Sonos Era 100
    Alex Plaskett
    ...
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-07-our-research-in-2024/vulnerability-research-and-exploitation-techniques/jailbreaking-sonos-era-100/)

*   **2 Jan 24**: Technical Advisory – Multiple Vulnerabilities in PandoraFMS Enterprise
    Oliver Brooks
    ...
    [Read Here](https://www.nccgroup.com/newsroom/ncc-group-2024-annual-research-report/section-07-our-research-in-2024/v