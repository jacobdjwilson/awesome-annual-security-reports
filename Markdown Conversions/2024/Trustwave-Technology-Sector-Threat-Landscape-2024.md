...
- [Initial Foothold](#initial-foothold-1)
...
- [Initial Payload](#initial-payload-1)
- [Expansion / Pivoting](#expansion--pivoting-1)
- [Malware](#malware-1)
  - [Malware: Loaders, Infostealers and RATs](#malware-loaders-infostealers-and-rats)
  - [Malware: Ransomware](#malware-ransomware)
- [Exfiltration / Post Compromise/Impact](#exfiltration--post-compromiseimpact-1)
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies## Emerging and Prominent Trends
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies### Speed vs. Security
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies### Rise of Ransomware
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies**Mitigations to Reduce Risk**
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies## Dissecting the Attack Flow
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies#### Expansion / Pivoting
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation StrategiesFig 4: Highlighted in yellow is ZeroGPT’s prediction of what were the AI-generated text from the message body of the BEC email
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation StrategiesLastly, our researchers also noted the increasing use of AI-Powered SaaS Marketing Platforms for sending unsolicited marketing emails. One example that our team has observed lately is Kalendar AI, a Software-as-a-Service (SaaS) platform that automates sales outreach on behalf of companies. Their AI technology can write personalized invitations (Fig 9) to prospective customers as seen in this example:
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies**SOFTWARE DEVELOPMENT AND CODING PLATFORMS AS PHISHING URLS**
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation StrategiesFig 11: Phishing attack leveraging Github URL
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation StrategiesFig 13: A legitimate Google Groups notification for a purported client support service for Geek Squad
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies**SINGLE EURO PAYMENTS AREA (SEPA) TRANSFER THEMED BEC**
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies**QUISHING - PHISHING WITH QR CODES**
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation StrategiesFig 18: Cryptocurrency phishing example targeting Coinbase users' recovery phrases
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation StrategiesFig 20: Phishing sample mimicking a Ring email notification

Fig 21: Malicious HTML attachment included in the ring notification

2024 Technology Threat Intelligence Briefing and Mitigation Strategies**CREDENTIAL PHISHING UTILIZING FORM SERVICES**
Trustwave SpiderLabs researchers have observed threat actors using online form services for credential phishing in our technology sector clients. These threat actors craft phishing pages and direct form submissions to services like ActionForms, FormBackend, Formspark, Formspree, and Formester (Fig 22).

Fig 22: Credential phishing example using Formester
...
*   Restrict the access of assets and sensitive data with the principle of least privilege.
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation Strategies### Initial Foothold: Logging in
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation StrategiesAnother post from a threat actor (Fig 25) in an underground forum shows access being sold to an ISP in Brazil. The threat actor claims that they have access to the backup infrastructure of the organization.
...
2024 Technology Threat Landscape: Trustwave Threat Intelligence Briefing and Mitigation StrategiesFig 26: Publicly accessible devices in the technology sector
