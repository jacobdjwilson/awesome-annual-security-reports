...
- **5 working weeks** a year could be saved by automating security and compliance tasks.
- **46%** of organizations say that a vendor of theirs has experienced a data breach since they started working together.
- **48%** (up from 41% in 2023) believe good security practices drive customer trust for their business.
- **6.5 hours** IT decision makers spend an average of 6.5 hours per week assessing and reviewing vendor risk.
...
![Chart showing frequency of detecting and responding to cybersecurity threats: Daily 23%, Weekly 27%, Monthly 22%, At least once a week 50%]
...
> “Security doesn’t need to be complex. It needs to scale the business, be a business enabler, and it needs to be there at the very beginning. Without it, it’s only a matter of time before there’s a serious issue.” — Leo Cunningham, Former CISO, Flo Health

### As AI adoption accelerates, governance and risk management stall

At the same time that AI is becoming increasingly common in the tech stack, security concerns are also on the rise. A majority (62%) of businesses plan to invest more in security around the use of AI within their organization in the next year.
...
### Protecting customer trust in an AI world
...
> “Being an AI company requires us to build an even deeper level of trust because this technology is largely unknown. We need our customers to see us as a trusted partner to help them implement this.” — Peadar Coyle, CTO and Co-Founder, AudioStack

---

## 2. Easing the compliance burden

The compliance burden has never been higher. Time spent on compliance tasks increased to 11 working weeks in 2024—up from 10 working weeks in 2023. And 1 in 10 (9%) respondents are spending over 21 hours each week—25 working weeks a year—on security compliance.
...
> “We don’t have time for manual work such as tracking in spreadsheets, sending emails, creating documentation for auditors and vendor management. In order for us to successfully mitigate risk and focus on what’s important for the business, these tasks need to take up less than 10% of my team’s time.” — Michael Hensley, Head of Information Security and HIPAA Security Officer, Modern Health
...
Less than a quarter (24%) of organizations rate their visibility into vendor risk as “very strong.” With almost half (48%) of organizations saying that a vendor they work with has previously experienced a breach, businesses need to implement a proactive approach that reduces risk and enables continuous visibility into their third-party landscape.

> “We have an ever-growing and ever-changing list of vendors, and we need to stay on top of them while having finite resources. Vanta’s Vendor Risk Management helps me stay on top of all of our vendors and see at a glance which ones need an updated review.” — Quentin Berdugo, Chief Information Security Officer, Pigment

### AI can transform vendor risk management and security reviews

Organizations now see even more potential in AI to streamline vendor risk reviews and onboarding than they did last year—up from 35% in 2023 to 42% in 2024.
...
> “Our big opportunity as a compliance team is looking at every compliance activity as a sales activity.” — Leah Bosé, Senior Privacy Compliance Manager, ZoomInfo

### Confidence in reporting on security program outcomes is high, but measuring the ROI of trust is more challenging

An overwhelming 85% of organizations are confident in their team’s ability to show the impact of their security program on the business. Further, 9 in 10 (89%) quantify and measure the impact of their program in some capacity. However, only 36% are measuring actual ROI.

---

## Conclusion: Go beyond the standard with trust management

To keep pace with where the future of trust is headed, security leaders need to go beyond the standard way of doing things. They need to make trust continuous, collaborative, and automated across every part of their business.

1. **Build a trust program powered by automation**: Implement trust management platforms that automate key workflows.
2. **Demonstrate trust in real time**: Go beyond point-in-time compliance certifications and showcase security controls through a public Trust Center.
3. **Strengthen your entire trust network**: Raise the bar by establishing your own standard for trust and creating custom controls for vendors.
