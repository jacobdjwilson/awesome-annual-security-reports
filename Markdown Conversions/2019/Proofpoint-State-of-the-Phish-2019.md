...
significant drop off in activity levels of programs that are more than 24 months old compared
to use personalized fields within these tests. They can add first names and/or last names, as
to programs that are 12 to 24 months old (which have the highest campaign frequency).
well as redisplay the recipient’s email address within the body of the message.
Those who reduce the number of phishing tests as their programs mature are likely to see
We found that all types of personalization led to higher failure rates than the 9% average.
a plateau or even a regression in failure rates. The threat landscape is continually changing,
In particular, redisplaying email addresses inside of phishing tests seemed to lend a greater
and new scams appear weekly (if not daily). Instead of backing off once you reach an
credibility to messages, subsequently elevating the likelihood of end-user interactions.
“acceptable” failure rate, continue to challenge end users with more difficult tests to keep
AVERAGE FAILURE RATES WITH PERSONALIZED FIELDS them thinking and learning. And be sure to keep an eye to emerging threats and work those
themes into your campaign cadence, regardless of how long you’ve been testing users.
10% 11% 13%
RECOMMENDED: DON’T STOP WITH EMAIL
Email remains the easiest and most frequent attack vector … but social engineering
Custom First Name Custom Last Name Email Address Redisplay techniques are also used outside of email to gather data and infiltrate your
organization. Cybercriminals regularly use pretexting, vishing, and smishing attacks
to try to penetrate your defenses.
How Program Maturity Influences Failure Rates
Smishing should be of particular concern given the wide use of smart devices and
Our data shows a terrific trend for organizations that are committed to longer-term security
the increased adoption of BYOD policies. In our 2018 User Risk Report, more than
awareness and training initiatives: Average failure rates fall steadily as programs
90% of the 6,000 working adults we surveyed have a smartphone, and 39% use
continue, with the biggest gains happening in programs that have been running for at
these devices for a blend of work and personal activities.
least a year. Even better, personalization factors have less impact over time (though they
have a big impact in less-mature programs).
Simulated smishing campaigns are not commonly used by our customers; the
Failure Rates by Template Theme counts are in the tens of thousands, compared to the tens of millions of email
Average Custom Custom Email Address phishing tests sent. But average failure rates on these assessments are similar
Failure Rate First Name Last Name Redisplay to those for phishing: 7% of users clicked links sent to them via text message
during our measurement period.
<6 months 12% 12% 15% 15%
6-12 months 11% 12% 15% 16% With vishing and smishing attacks on the rise — and many organizations dealing
with more than 25 of these types of attacks each quarter — now is the ideal time
12-24 months 9% 9% 12% 13%
to consider how you are assessing your organization’s susceptibility to these
>24 months 8% 9% 9% 9% threats and how you are educating users to spot and avoid them.
SSEECCTTIIOONN 33::
SECTION 1: SECTION 2:
...
STATE OF THE PHISH | 2019 22
A Look at End-User Email Reporting
Conclusion: Focus on the Battles and the War
We strongly believe that end-user email reporting is one of the best metrics for gauging
We’ve all likely heard the phrase, “You won the battle but you lost the war.” But the
the effectiveness of security awareness training activities. An increase in reporting
reality is that organizations must consistently win daily battles in order to have a
indicates that employees are being more diligent and thoughtful about the emails they
shot at being victorious in the war against cybercrime.
receive. Their reporting also gives organizations an opportunity to capitalize on increased
awareness to quickly identify and remediate malicious messages that slip through
Like it or not, end users play a significant role in those battles. When phishing
perimeter defenses.
attacks slip through network perimeters, people become the last line of defense.
End users reported nearly
End users should not be left unarmed when they find themselves at these binary
5.5 59%
million decision points: Should I or shouldn’t I click this link … download this attachment …
respond to this request for sensitive information? Those moments count.
suspicious emails during our of end-user reported emails
Security awareness training provides an opportunity for organizations to be present
measurement period. were classified as potential
in those moments. Effective education and learned skills can become the “whispers”
phishing emails.
in your end users’ ears, guiding them to make the right choices.
A 180% year-over-year increase
RECOMMENDED: SIMPLIFY REPORTING AND REMEDIATION
To best take advantage of increasing phishing awareness, organizations should make it
easy for end users to report suspicious messages and make it easy for response teams
to take action.
An email client add-in — like our PhishAlarm® button — gives users a quick, simple way
to forward messages to designated inboxes (with headers intact). In addition, automated
analysis of reported messages — like that afforded by PhishAlarm Analyzer — filters
whitelisted email addresses, system notifications, and simulated phishing attacks to allow
infosec teams to focus on emails that are most likely to be phishing attempts.
To streamline even further, we recommend incorporating a solution like CLEAR. Closed-
Loop Email Analysis and Response integrates email reporting and remediation,
reducing the time it takes to neutralize an active threat from days to minutes. Once
reported messages are analyzed against multiple intelligence and reputation systems,
malicious emails can be deleted or quarantined with a single click.
SSEECCTTIIOONN 33::
SECTION 1: SECTION 2:
INTRODUCTION THREE PILLARS OF CONTENT SSEECCUURRIITTYY AAWWAARREENNEESSSS TTRRAAIINNIINNGG::
THE EXTENT OF END-USER RISK WHAT INFOSEC PROS ARE EXPERIENCING
...
Single Point of Contact stays on top of everything related to cyber security and data protection. We are more than just a Managed Security Service Provider. We
take swift and thorough action to ensure your business is protected around the clock and to remediate any security threats when they occur. Constant monitoring
