...
Contents
Victories against cybercrime demand radical change to defense 3
Joe Levy, Sophos CTO
Targeted attacks gain popularity, reap deep rewards 5
What’s old is new again
Transitioning to manual attack mode
SamSam ransom payments - Total: $6.5 million USD
Targeted Ransomware vs. RaaS Playbook 8
Attacker techniques evolve to use what’s already there 10
...
We’ve lost a few battles, but we’re winning the war 18
Chester Wisniewski, Principal Research Scientist
Mobile and IoT: Malware is not slowing down 20
...
Victories against cybercrime demand
...
informed and risk-aware) caution around information The threat landscape is
systems threats, it’s also important to take inventory undoubtedly evolving; less
...
We as an industry are obsessed with measurements, among them step up their game
...
consistent, and transparent. After all, if you measure and stronger, adversaries.
every dropped ping packet as a crisis averted (as some These new cybercriminals are
...
our disclosures, and in the open manner in which we and the pedestrian purveyor of
participate in industry third-party testing. off-the-shelf malware, using
manual hacking techniques not
Measurements become a more meaningful indication
of success when they become observable trends. And for espionage or sabotage, but
one of the most encouraging trends we see is how to maintain their dishonorable
...
SophosLabs 2019 Threat Report
These technologies materially hinder the effectiveness of commodity malware. The
...
SophosLabs 2019 Threat Report
Targeted attacks gain popularity,
reap deep rewards
What’s old is new again
...
SophosLabs 2019 Threat Report
But automation has an Achilles’ heel in its predictability. Once you realize that an
...
long.
Transitioning to manual attack mode
For nearly three years, a small but dedicated group of criminals the attacker waits for
...
reused anywhere else, are more resilient to this kind of attack, but the of a holiday weekend, for
SamSam attacker managed a high degree of success by choosing
the low-hanging fruit – machines with relatively weak passwords, example – to strike.
...
$0
7
61-naJ 61-beF 61-raM 61-rpA 61-yaM 61-nuJ 61-luJ 61-guA 61-peS 61-tcO 61-voN 61-ceD 71-naJ 71-beF 71-raM 71-rpA 71-yaM 71-nuJ 71-luJ 71-guA 71-peS 71-tcO 71-voN 71-ceD 81-naJ 81-beF 81-raM 81-rpA 81-yaM 81-nuJ 81-luJ 81-guA 81-peS 81-tcO 21-voN
SamSam ransom payments - Total: $6.5 million USD
$505,000
$458,000
$365,000
...
$89,000 $108,000
$26,000$32,000
$135,000 $0 $152,000 $117,000
$5,000 $87,000
$93,000
$63,000
$75,000 $36,000
January 12th 2016 - November 12th 2018
Figure 2: SamSam’s revenue has surpassed $6 million since this chart was first published in
...
SophosLabs 2019 Threat Report
Figure 3: The SamSam attacker communicated directly with victims, and offered technical
...
|            | Medium/large  | Medium/large  | Medium/large  | Small         |                        |
|            | Targets       |               |               |               | Any                    |
|            | organizations | organizations | organizations | organizations |                        |
Typical ransom
|     | $50,000-$1M+ | $40,000 | $100,000  | $5,000  | $1,000-$8,000+ |
| --- | ------------ | ------- | --------- | ------- | -------------- |
demand
Frequency is unknown
| Frequency of  |                 |          | Multiple a  |                | due to anyone being able    |
| ------------- | --------------- | -------- | ----------- | -------------- | --------------------------- |
|               | Multiple a week | 1+ a day |             | Multiple a day |                             |
|               | attacks         |          | week        |                | to use the kit, however it  |
is very popular
All servers
| Desired damage | All servers |     | All servers | Critical servers | Any |
| -------------- | ----------- | --- | ----------- | ---------------- | --- |
and endpoints
Global with
| Regions affected | Global | highest % in  | Global | Global | Global |
| ---------------- | ------ | ------------- | ------ | ------ | ------ |
US
| Can be decrypted  |     |     |     |     | Some variants but mostly  |
| ----------------- | --- | --- | --- | --- | ------------------------- |
|                   | No  | No  | No  | No  |                           |
| without paying    |     |     |     |     | not                       |
Bitcoin
...
| -------------- | --------------- | ------------- | ------------- | ------------- | -------------------------- |
|                |                 |               | Bitcoin       | Bitcoin       |                            |
|                | via email,      | arranged via  |               |               | Bitcoin arranged via dark  |
| Payment method |                 |               | arranged via  | arranged via  |                            |
|                | sometimes       | dark web      |               |               | web onion site             |
|                |                 |               | email         | email         |                            |
|                | dark web onion  | onion site    |               |               |                            |
site
Spends time  Has a history  Spends time  Manually  Regular updates
to ensure all  of targeting  to ensure all  attempts  and support from
backups are  healthcare backups are  to disable  the developers;
deleted before  deleted before  antivirus   recently released all
Additional insights the attack the attack;  before  the encryption keys
|     |     |     | attempts    | attacking | for Syrian victims of    |
| --- | --- | --- | ----------- | --------- | ------------------------ |
|     |     |     | to disable  |           | GandCrab and said Syria  |
|     |     |     | antivirus   |           | would not be targeted    |
anymore
9

SophosLabs 2019 Threat Report
Attacker techniques evolve to use what’s
already there
“Living off the land” is the new law of the land
...
SophosLabs 2019 Threat Report
Today, a malware attack is as likely to start with a PowerShell .ps1 or a Windows Scripting
...
SophosLabs 2019 Threat Report
More often than not, attackers will employ one command or administrative system to
...
How “LoL” changes malware detection and prevention
The rules for defenders used to be simple: Prevent the malicious defenders need to think
or unknown executable from running, or, failing that, try to limit the
damage it could do by quarantining the executables that engage in outside the box to stop
...
SophosLabs 2019 Threat Report
Figure 8: A malicious Word document spawns an instance of cmd.exe, which in turn invokes
powershell.exe
...
SophosLabs 2019 Threat Report
A class of vulnerabilities in the Equation Editor, a component of Excel installed by default,
...
SophosLabs 2019 Threat Report
Only three Builder tools account for three-quarters of the malicious documents
...
SophosLabs 2019 Threat Report
The WannaCry ransomware payload was the first known widespread use of EternalBlue
...
SophosLabs 2019 Threat Report
Only five years later, more than 50% of the entire web is now encrypted, and nearly 80%
...
anymore. Now they prefer to use deception to we pay attention to
convince people into running malicious email
attachments, exploiting human vulnerabilities security and recognize a
...
SophosLabs 2019 Threat Report
Supply chain compromise: Following a lead from an online message board, we
...
SophosLabs 2019 Threat Report
Cryptominer code in games or utilities: The SophosLabs team have, in the normal
...
SophosLabs 2019 Threat Report
Mirai and its successors: The Mirai botnet, the source code for which had been publicly disclosed
...
Timothy Easton
Learn More
Read our threat research at our SophosLabs
Uncut blog: j.mp/sophoslabs
