...
2021 increasing from $3.86 million to $4.24 million.4
...
One day, our mobile devices will go to the moon and far beyond, communication devices untethered
from the walls but connecting future
...
10% reported unsecured applications due to the lack of authentication or encryption.  7
...
specific apps on their mobile device.8   Although these applications vary between vendor-
...
Before the COVID-19 pandemic arose, 60% of organizations had no BYOD policies in place. 9 Over the last two years, many teams
...
that just like consumers, employees are concerned about their privacy. In fact, trust and privacy concerns among employees continue
to slow the adoption of device management policies in enterprises.
...
![Image description: A bar chart showing the distribution of apps with unsecured cloud storage by category. Categories include Travel & Local, Health & Fitness, News & Magazines, Business, Lifestyle, Education, Sports, Finance, Tools, Social, Casual, Music & Audio, Shopping, Game, and Communication. The percentages for each category are displayed.]
...
4.  **Android: GriftHorse (Zimperium Disclosed)**
...
![Image description: A line graph showing the total mentions of mobile security news over time, with spikes indicating significant events.]
...
The US smartphone market is projected to reach $73 billion, which is a significant increase from 2