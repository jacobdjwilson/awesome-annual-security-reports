...
The last few years have fundamentally changed the modern workforce. With distributed and hybrid forces, 5G connectivity, and increased critical data access from remote locations, enterprises have spread worldwide. 

For decades, IT and security teams built on-premise infrastructure to support on-site employees. Legacy services like VPNs were not designed to handle the influx of external connections. Once employees moved beyond physical and digital protections, security organizations began investing in advanced security controls for endpoints.

> 66% of organizations surveyed recently have active BYOD programs in place, with 11% looking to implement the policy over the next year.[^1]

Now more than ever, both managed and unmanaged devices connect to corporate data through unknown networks. Security teams need visibility into all devices connected to corporate systems.

> 10% of the applications installed on the average BYO mobile endpoint are enterprise-focused, from multi-factor authentication (MFA), data access tools, and communications.[^2]

### 1.2: Mobile Security and the Broader Enterprise Security Strategy
*Jon Paterson, CTO, Zimperium*

Security toolsets surrounding XDR and SOAR have risen to drive the traditional security evolution. Identity and access management tools have expanded to support remote access at scale, and 36% of enterprises surveyed are prioritizing the investment of zero trust architectures over the next year.[^3]

The integration of devices into our everyday life is paving the way for the convergence of the modern endpoint. As enterprises evolve, they introduce more applications connected to critical data systems. Security by design allows for foundational decisions around code, data, and cryptographic key protection.

### 1.3: The Continued Role for AI and Machine Learning in Mobile Security
*Esteban Pellegrino, Chief Scientist, Zimperium*

Mobile devices are more computer than phone, connected to critical data systems and packed with private information. In 2012, Zimperium invented and patented Zimperium z9, the dynamically updatable machine learning framework that transformed Zimperium into the first mobile threat defense (MTD) vendor fully powered by on-device artificial intelligence.[^5][^6]

Today, our advanced AI provides on-device protection from malware, network reconnaissance, interception attacks, phishing, hooking, tampering, debugging, and exploiting mobile devices and applications.
...
It is clear that we have collectively underestimated the mobile risks we have and the exposure that has been created. We can fix the mobility security mistakes of the past and better position ourselves to avoid risk mistakes in the future.
...
- **42%** reported mobile devices & web applications led to a security incident.
- **42%** reported unauthorized apps & resources accessing enterprise data.
- **10%** reported unsecured applications due to lack of authentication or encryption.[^7]

In 2021, the Pegasus spyware program reappeared, targeting journalists and political leaders. Additionally, the Joker Trojan targeted Android devices with updated capabilities for financial gain. Over 1,000 samples of the Joker malware were discovered in mid-2021.

**2022 Zimperium zLabs Research Highlights:**
- **GriftHorse**: An active Android Trojan campaign infecting over 10 million devices.
- **PhoneSpy**: Spyware targeting South Korean citizens to gather personal and corporate information.
- **FlyTrap**: A hijacking campaign harvesting social media session data from users in 144 countries.
- **Android System Update**: A sophisticated remote access trojan (RAT).
- **Unsecured & Misconfigured Cloud Storage**: 14% of iOS and Android apps distributed globally revealed significant configuration issues.

![Figure 1: Apps with unsecured cloud storage, by category.]

### 2.2: State of Mobile Endpoint Security in 2022

In 2020, nearly 1.38 billion smartphones were sold worldwide.[^10] In the US, the penetration rate reached 85% in 2021.[^11] Apple and Samsung account for 82% of sales in the US market.[^12]

**Endpoint Security Worries:**
- 35% Remote office/users
- 30% BYOD
- 11% Mobile phones/devices
...
There were over 218 billion app downloads in 2020.[^31] By 2023, annual revenue from mobile apps is predicted to reach $935 billion.[^32]

**Key Trends:**
- **Cross-platform App Development**: Popularity of frameworks like React, Flutter, and Kotlin has grown.
- **Low-Code/No-Code**: Accelerated by the talent shortage.
- **5G**: Predicted 1.5 billion 5G mobile subscriptions by 2024.[^35]
- **QR Codes**: Used as an attack vector to steal financial information or compromise devices.
...
Mobile malware is prolific, with a global average of 23% of endpoints encountering malicious applications in 2021.

- **APAC**: 25% of mobile enterprise devices encountered phishing.
- **Africa**: 30% of mobile endpoints encountered malware.
- **Europe**: 24% of mobile users encountered malware; 19% encountered network reconnaissance.
- **North America**: 22% of enterprise mobile devices encountered malware.
- **South America**: 24% of mobile endpoints encountered mobile malware.

---

[^1]: Zimperium Survey Data.
[^2]: Zimperium Survey Data.
[^3]: Zimperium Survey Data.
[^4]: Cost of a Data Breach Report 2021.
[^5]: Zimperium Patent Documentation.
[^6]: Zimperium z9 Framework Overview.
[^7]: Industry Survey Data.
[^8]: Industry Survey Data.
[^9]: Industry Survey Data.
[^10]: Global Smartphone Sales Data.
[^11]: US Smartphone Market Report.
[^12]: US Market Share Analysis.
[^13]: US Market Share Analysis.
[^14]: Industry Survey Data.
[^15]: Industry Survey Data.
[^16]: Industry Survey Data.
[^17]: Industry Survey Data.
[^18]: Microsoft Security Report.
[^19]: Industry Survey Data.
[^20]: Industry Survey Data.
[^21]: Industry Survey Data.
[^22]: Industry Survey Data.
[^23]: Industry Survey Data.
[^24]: Enterprise Device Distribution Data.
[^25]: Enterprise Device Distribution Data.
[^26]: Internal Threat Analysis.
[^27]: Cybersecurity Funding Report.
[^28]: Technology Leader Survey.
[^29]: Threat Landscape Survey.
[^30]: Global Security Market Analysis.
[^31]: App Download Statistics.
[^32]: Mobile App Revenue Forecast.
[^33]: Global Payment Statistics.
[^34]: Biometric Market Report.
[^35]: 5G Subscription Forecast.
[^36]: Mobile Payment Revenue Data.
[^37]: FBI Public Service Announcement.
[^38]: Mobile Cloud Market Value.
[^39]: Ring Security Disclosure.
[^40]: Slack Security Disclosure.
[^41]: Klarna Security Disclosure.
[^42]: Cloud Misconfiguration Investigation.
[^43]: Zimperium App Analysis.
...
prepare and secure against an ever-
...
years saw zero-day vulnerabilities that target mobile endpoints - like phones and tablets -
becoming	a	more	significant challenge	than	ever	before.

In	2021,	iOS	vulnerabilities	accounted	for	64%	of	mobile-specific  exploited	zero-days
attacks.

Individual Exploits0510152020152016201720182019202020213.3
...
• Whaling. Attacks targeting senior high-level executives and other high-
...
Phishing Prevalence
One report found that phishing was present in 36% of breaches, and that the practice grew
10% between 2020 and 2021.50 Additional research found phishing emails were the leading
point of entry for ransomware, constituting around 54% of these attacks.51

In our research, when asked about risks that most concerned them, “exploitation via phishing"
was the top-rated response (55%). In addition, 61% of respondents said they’d seen a
spike in phishing attacks during the COVID-19 pandemic. Further, crafting phishing attacks
continues to get easier: tools and phishing kits now enable even novice users to deploy
deceptive sites with just a few clicks.

Over the years, we’ve continued to grow increasingly reliant upon our mobile phones, both
in our personal and professional lives. While that was the trend for some time, the COVID-19
pandemic served to turbo-charge the transition. This increased reliance on smartphones for
work means users are routinely accessing corporate assets and apps. This, combined with
the fact that these devices don’t have the same level of security typically found on traditional
laptops and desktops, is encouraging would-be attackers to focus on mobile devices.
...
Figure 14: The percentage of businesses mimicked by phishing sites targeting users in the Asia-
...
In 2020, attackers took advantage of the pandemic lockdowns that forced companies world-
wide	to	adopt	a	distributed	workforce.	These	novel	situations	accounted	for	a	significantly
...
to their business.59 That same proportion of employees are using their personally-owned mobile
...
times.   60  Users jailbreak their devices and sideload apps. Rogue access points positioned in high-traffic
...
Mobile devices are just one of many attack surfaces - user endpoints, cloud workloads, IoT, email, identity, and so on. The nature of XDR is
...
security risk may require employing different levels of multi-
...
annual growth rate of 23 years. 61    It would have been even higher had semiconductor supply chains not been adversely affected by the
pandemic.
...
To better understand the cybersecurity threats to these ubiquitous devices, the U.S. National Institute of Standards and Technology (NIST)
offers a mobile threat catalog. 63 It’s a useful framework to enumerate the growth of the attack surface of these systems, especially when
considered through the lens of enterprise cyber risk identification and mitigation. As we shall see, the attack surface has been growing non-
linearly, perhaps even exponentially, as each element of complexity, the number of connections, and the centrality of these devices to our
...
The technology stack of a smartphone today starts with the chips providing application and communication performance. For example,
...
modules and the latest Wi-Fi, Bluetooth, NFC modems all packed into an 4 nm process node. 64
...
Updating a smartphone requires a download of approximately 2 GB.65   That is a lot of
...
Intertrust offers a ZTNA based solution that brings an end-
to-end, mobile device to cloud architecture that enterprises
...
This is how malware that propagated the Mozi botnet spread so rapidly around the world. 6 6

Malware like Mozi can lay in wait. When a smartphone with a vulnerability connects to a compromised IoT hub, it will attack. If the
...
to a recent Zimperium poll said they had enabled Microsoft Office 365 on mobile devices. 67
...
36% of Zimperium’s survey respondents said they had finished
implementing security solutions to protect Office 365 on mobile
devices, while 38% are still in the process.68  Commenting on the
...
In today’s threat environment, mobile devices must be
...
34. ReportLinker. (2021). Biometric Authentication and Identification Market - A Global and Regional Analysis: Focus on End User, Function, Product Type, Deployment Model and Country - Analysis and Forecast, 2021–2026. https://

www.reportlinker.com/p06178590/Biometric-Authentication-and-Identification-Market-A-Global-and-Regional-Analysis-Focus-on-End-User-Function-Product-Type-Deployment-Model-and-Country-Analysis-and-Forecast.html?utm_source=GNW

35. Ericsson. (2018). 5G estimated to reach 1.5 billion subscriptions in 2024 – Ericsson Mobility Report. Telefonaktiebolaget LM Ericsson. https://www.ericsson.com/en/press-releases/2018/11/5g-estimated-to-reach-1.5-billion-subscriptions-

in-2024--ericsson-mobility-report
...
40. Page, C. (2021, February 11). Slack Urges Users To Reset Passwords After Android Bug Potentially Exposed Credentials. Forbes. https://www.forbes.com/sites/carlypage/2021/02/11/slack-urges-users-to-reset-passwords-after-android-bug-

potentially-exposed-credentials/?sh=64d367cf683c
...
44, 49, 53.  Google Project Zero. (2021). 0day “In the Wild.” Google Docs. https://docs.google.com/spreadsheets/u/1/d/1lkNJ0uQwbeC1ZTRrxdtuPLCIl7mlUreoKfSIgajnSyY/edit#gid=2129022708
...
58. Woollacott, E. (2021, January 4). Fines against banks for data breaches and noncompliance more than doubled in 2020. The Daily Swig | Cybersecurity News and Views. https://portswigger.net/daily-swig/fines-against-banks-for-data-breaches-

and-noncompliance-more-than-doubled-in-2020
...
66. Durand, J. (2021, October 26). The IoT is Breeding Killer Botnets. Device Authenticity and Data Integrity Can Save It | IOT. MyTechMag. https://iot.mytechmag.com/the-iot-is-breeding-killer-botnets-device-authenticity-and-data-integrity-can-
...
personal information, like login credentials 71
...
Founded upon the premise that mobile security requires an entirely novel
approach, Zimperium secures both mobile devices and applications so they
can safely and securely access data. A single unified platform protects the
endpoint and secures the entire application development cycle with the only
on-device, machine learning-based engine. Zimperium provides visibility and
protection against known and zero-day threats and attacks across device,
network, phishing, and application threat vectors against Android, iOS, and
ChromeOS devices. Headquartered in Dallas, Texas, Zimperium is backed by
Warburg Pincus, SoftBank, Samsung, Sierra Ventures, and Telstra Ventures.
