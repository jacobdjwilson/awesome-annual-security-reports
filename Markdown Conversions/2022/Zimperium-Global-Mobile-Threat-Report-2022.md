...
*   **Unsecured & Misconfigured Cloud Storage**
    ...
    ![Image description: A bar chart showing the distribution of apps with unsecured cloud storage across various categories. The categories include Travel & Local, Health & Fitness, News & Magazines, Business, Lifestyle, Education, Sports, Finance, Tools, Social, Casual, Music & Audio, Shopping, Game, and Communication. The percentages for each category are displayed.]
...
2.  **Apple iOS: iOS 14.8 - Spyware Flaw (Pegasus)**
...
3.  **Android: FlyTrap (Zimperium Disclosed)**
...
6.  **Android: GriftHorse (Zimperium Disclosed)**
...
7.  **Android: PhoneSpy (Zimperium Disclosed)**
...
![Image description: A line graph showing the total number of mentions of mobile security threats over time, with peaks in certain periods.]
Credit: Cision
...
![Image description: A graphic displaying key statistics for the US smartphone market in 2021: 294.15M U.S. Smartphone Users, 147.48M U.S. Smartphone Shipments, $73B USD U.S. Smartphone Sales Value.]
...
![Image description: A bar chart showing endpoint security worries, with "REMOTE OFFICE / USERS" at 35%, "BYOD" at 30%, and "MOBILE PHONES / DEVICES" at 11%.]
...
![Image description: A pie chart showing the breakdown of enterprise cybersecurity strategy. 48% is "review regularly and adjust," 26% is "develop in real-time or as needed," and 23% is "formal policy but barely review, or no strategy."]
...
![Image description: A stacked bar chart showing the breakdown of mobile devices in enterprises. For smartphones: 66% employee-owned, 29% company-purchased. For tablets: 55% employee-owned, 39% company-purchased.]
Figure 3: The breakdown of mobile devices in enterpprises
...
![Image description: A bar chart showing the percentage of threats affecting the enterprise in the past 12 months. Malware (Virus, Phishing, Ransomware) is at 54%, Identity or Account Theft is at 46%, Mobile or Web Application Security Exposure is at 42%, and Unauthorized App or Resources Access is at 42%.]
...
Mobile threat defense (MTD) is a distinct