...
In this, our eighth annual State of the Phish report, we explore user vulnerabilities from multiple angles. We look at issues driven by poor cyber hygiene and those that could result from a lack of knowledge and clear communication.

### Cashing in on COVID
Not surprisingly, COVID-themed campaigns continued, mimicking the opportunistic attacks that piggybacked pandemic developments throughout 2020. As public concerns ebbed and flowed, so did COVID-themed phishing attacks.

### Dialing to defraud
Another trend involved telephone-oriented attack delivery (TOAD). These schemes are nothing new—we detect and block tens of thousands of TOAD-related emails every day.[^4] But we saw an uptick in 2021, many of them part of a robust and complex attack chain.

### Making it personal
TOAD threats and other attacks in 2021 targeted both personal and organizational email addresses. Amid the shift to remote work, targeting personal addresses can have a bigger impact on organizations than in years past.
...
This year’s State of the Phish again presents the results of a Proofpoint-designed study of the threat landscape.

### Phishing attacks on the rise
According to respondents, the 2021 threat landscape was more active than 2020’s. Reports of phishing attacks were up across the board. Indiscriminate “bulk” phishing attacks rose 12% year over year.

![Figure 2: Volume of Bulk Phishing, Spear Phishing, BEC, and Email-Based Ransomware Attacks]

### Ransomware: nearly 60% of infected orgs paid up—many more than once
Ransomware made headlines throughout 2021, with government and critical infrastructure sectors particularly hard hit.

![Figure 5: Ransomware by the Numbers and What Happened After Payment]

---

## Working Adults: Cybersecurity Habits and Knowledge Gaps

As in the past, this year’s State of the Phish dedicates significant real estate to exploring the greatest source of organizational security risk: people.

### Overview: more devices, more issues
All survey respondents said they use one or more electronic devices for their job.
...
- **Phishing**: 53% Correct, 27% Incorrect, 20% I Don’t Know.
- **Ransomware**: 36% Correct, 33% Incorrect, 31% I Don’t Know.

---

## Benchmarking: Failure Rates and Comparison Data

Our customers actively tested their end users’ response to phishing emails over the course of our 12-month measurement period. They sent nearly 100 million simulated attacks, an increase of more than 50% over 2020.

### Failure rates by template type
![Figure 14: Phishing Template Types: Frequency of Use and Average Failure Rates]

### Industry failure rates
Overall, we saw some great year-over-year improvements on both ends of the spectrum. Last year, the lowest average failure rate was 9%; this year, it’s 8%.

![Figure 15: Average Failure Rate by Industry]
...
[Detailed data tables omitted for brevity in this conversion]
...
[^2]: We define a “campaign” as a group of related threats and activities.
...
[^5]: Unless otherwise indicated, survey results represent global averages.
[^6]: New figures for this year’s report.
