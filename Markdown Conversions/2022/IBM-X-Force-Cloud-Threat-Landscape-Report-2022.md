...
![Image description: A graphic showing 99% of cases analyzed had excessively privileged cloud identities.](Image description: A graphic highlighting that 99% of analyzed cases revealed excessively privileged cloud identities.)

![Image description: A graphic showing a 28% increase in new vulnerabilities compared to last year.](Image description: A graphic indicating a 28% year-over-year increase in new cloud vulnerabilities.)

![Image description: A graphic showing a 200% increase in cloud accounts advertised on the dark web.](Image description: A graphic illustrating a 200% surge in cloud accounts listed for sale on the dark web.)
...
![Image description: A bar chart showing the total number of cloud vulnerabilities tracked by X-Force from 2012 to 2022. The number of vulnerabilities has grown exponentially.](Figure 1. The number of tracked cloud vulnerabilities has grown exponentially in the last decade.)
...
![Image description: A dual-axis chart showing the average X-Force threat score and the total CVEs tracked from 2012 to 2022. Both metrics show an increasing trend.](Figure 2. The total number of CVEs tracked and the average severity have increased steadily in the last decade.)
...
![Image description: A pie chart showing the distribution of cloud access types being sold on the dark web. RDP is 76%, Credentials is 19%, Shell is 4%, Email is 1%, and cPanel or WHM is less than 1%.](Figure 3. RDP makes up more than three-fourths of cloud access sold over a 12-month period.)

### Pricing of compromised cloud accounts

![Image description: A bar chart showing the average price in USD for RDP access and Credentials. Credentials are priced higher than RDP.](Figure 4. A notable difference exists between demands of pricing for RDP compared to credentials.)
...
- Use an open and integrated security approach, which can help connect the dots between security data that resides across fragmented cloud environments. Consider security platforms that rely on open technologies and allow for tight integrations between tools, such as IBM Cloud Pak® for Security.
