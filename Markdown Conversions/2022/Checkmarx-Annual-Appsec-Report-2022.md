...
[Current State of Application Security](#current-state-of-application-security)
  [Multiple Breaches](#multiple-breaches)
  [Negative Outcomes](#negative-outcomes)
  [Causes of Breaches](#causes-of-breaches)
  [Breach Responses/Fallout](#breach-responsesfallout)
  [Confidence in Secure Software Development](#confidence-in-secure-software-development)
[Widening Challenges](#widening-challenges)
  [Widening Concerns](#widening-concerns)
[Targeted Attacks: A Growing Threat](#targeted-attacks-a-growing-threat)
[Barriers Laid Bare](#barriers-laid-bare)
[Tackling AppSec Issues](#tackling-appsec-issues)
  [Training](#training)
  [Testing](#testing)
  [Incentives](#incentives)
  [Closing Supply Chain Loopholes](#closing-supply-chain-loopholes)
[Teaming Up for Success](#teaming-up-for-success)
  [Closer Alignment](#closer-alignment)
...
_91% of respondent organizations were breached at least once in that period._

5  //  AppSec: The View from Security and Software Development Experts
...
_To help combat the growing problem of targeted supply chain attacks, Checkmarx has acquired Dustico, a software as a service (SaaS) solution that detects malicious attacks and backdoors in open source software supply chains. Checkmarx will combine its Application Security Testing (AST) capabilities with Dustico’s behavioral analysis technology to give customers a unified view into the risk, reputation, and behavior of open source packages, resulting in a more comprehensive approach to preventing supply chain attacks._

7  //  AppSec: The View from Security and Software Development Experts
...
_22% of AppSec managers and 18% of software developers say they’re “not confident” about the overall security of the applications their firm deploys._

8  //  A checkmarx report
...
According to Gartner, “by 2025, 45% of organizations worldwide will have experienced attacks on their software supply chains, a three-fold increase from 2021.”<sup>1</sup> This makes the security of open source software paramount.

9  //  AppSec: The View from Security and Software Development Experts
...
11  //  AppSec: The View from Security and Software Development Experts
...
© 2021 Checkmarx Ltd. All rights reserved. Checkmarx is a registered trademark of Checkmarx Ltd. All other marks and trade names mentioned herein belong to their respective owners. Checkmarx reserves the right to modify, transfer, or otherwise revise this publication at its sole discretion and without notice. cx_rp_appsec-report-21_en_110521

<sup>1</sup> “How Software Engineering Leaders Can Mitigate Software Supply Chain Risks,” Gartner, 15 July 2021.
