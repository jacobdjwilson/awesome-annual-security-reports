...
- [Introduction](#introduction)
  - [A Note From Bill](#a-note-from-bill)
...
- [Cybersecurity is Infrastructure](#cybersecurity-is-infrastructure)
- [Beyond Ransomware: The Threat of BEC, Phishing and More](#beyond-ransomware-the-threat-of-bec-phishing-and-more)
- [Key Findings from 2021](#key-findings-from-2021)
  ...
  - [Cryptojacking: Bigger than Ever](#cryptojacking-bigger-than-ever)
...
- [CVEs](#cves)
  ...
  - [History Repeating: 80% of Top 10 Exploited Vulnerabilities Are From Previous Years](#history-repeating-80-of-top-10-exploited-vulnerabilities-are-from-previous-years)
...
- [Business Email Compromise](#business-email-compromise)
  ...
  - [Organizations Are Recognizing the Risk](#organizations-are-recognizing-the-risk)
- [Malware](#malware)
  - [Malware May Be Headed for a Rebound](#malware-may-be-headed-for-a-rebound-1)
  - [2021 Malware Volume: Changeabout — or Just a Correction?](#2021-malware-volume-changeabout--or-just-a-correction)
  - [Malware by Region](#malware-by-region)
  - [What is Malware Spread?](#what-is-malware-spread)
  - [Malware Spread by Country](#malware-spread-by-country)
  - [2021 Malware Spread | Top 10 Riskiest States](#2021-malware-spread--top-10-riskiest-states)
  - [Malware Risk by Country](#malware-risk-by-country)
  - [Top 10 Most Common Malware Filenames](#top-10-most-common-malware-filenames)
  - [Malware by Industry](#malware-by-industry)
- [Ransomware](#ransomware)
  - [Ransomware’s Savage Reign](#ransomwares-savage-reign-1)
  - [Ransomware by Region](#ransomware-by-region)
  - [Notable Ransomware Identified in 2021](#notable-ransomware-identified-in-2021)
  - [Top Ransomware by Signature](#top-ransomware-by-signature)
  - [Ryuk Runs Rampant](#ryuk-runs-rampant)
  - [SamSam Skyrockets](#samsam-skyrockets)
  - [Cerber Continues Climb](#cerber-continues-climb)
  - [Five Years On: The (Continuing) Legacy of WannaCry](#five-years-on-the-continuing-legacy-of-wannacry)
  - [2021 Ransomware Trends](#2021-ransomware-trends)
    - [Attackers’ Horrifying New Tactic: Triple Extortion](#attackers-horrifying-new-tactic-triple-extortion)
    - [Infrastructure Attacks](#infrastructure-attacks)
    - [Phishing Goes Old School](#phishing-goes-old-school)
    - [2021’s Biggest Busts](#2021s-biggest-busts)
- [Cryptojacking](#cryptojacking)
  ...
  - [How Cryptojacking is Spreading](#how-cryptojacking-is-spreading)
  - [The Rise of Cryptocurrency Stealers](#the-rise-of-cryptocurrency-stealers)
  - [The True Cost of Crypto Continues to Mount](#the-true-cost-of-crypto-continues-to-mount)
- [Encrypted Attacks](#encrypted-attacks)
  ...
  - [Encrypted Attacks by Industry](#encrypted-attacks-by-industry)
...
- [Intrusion Attempts](#intrusion-attempts)
  ...
  - [Malicious Intrusions by Type](#malicious-intrusions-by-type)
  - [Malicious Intrusions by Region](#malicious-intrusions-by-region)
  - [Top Intrusion Attacks](#top-intrusion-attacks)
- [Capture ATP & RTDMI](#capture-atp--rtdmi)
  - [RTDMI Gets Smarter, Faster, Better](#rtdmi-gets-smarter-faster-better)
  - [What Is RTDMI?](#what-is-rtdmi)
...
- [Malicious PDF/Office Files](#malicious-pdfoffice-files)
  ...
  - [Beware Muscle Memory](#beware-muscle-memory)
  - [Filenames to Look Out For in 2022](#filenames-to-look-out-for-in-2022)
  - [Who is Rabota?](#who-is-rabota)
- [IoT Malware](#iot-malware)
  - [IoT Malware Shows Signs of Stabilizing](#iot-malware-shows-signs-of-stabilizing)
  - [IoT Malware by Region](#iot-malware-by-region)
  - [IoT Malware by Industry](#iot-malware-by-industry)
  - [Protecting the Internet of Things](#protecting-the-internet-of-things)
  - [Safeguarding by Statute](#safeguarding-by-statute)
- [Attacks on Non-Standard Ports](#attacks-on-non-standard-ports)
  ...
  - [What is a Non-Standard Port Attack?](#what-is-a-non-standard-port-attack)
...
![Image description: A graphic showing several percentage increases and one decrease for different cyberattack types in 2021. The largest increase is +167% for Encrypted Threats, followed by +105% for Ransomware Attacks, +19% for Cryptojacking Attacks, +11% for Malware Attacks, and +6% for IoT Malware. There is a -4% decrease for Intrusion Attempts.]
...
Five years ago, a debate erupted surrounding the infamous NotPetya cyberattack: Did it constitute an act of war? This issue continued to be debated in the courts throughout 2021, but on the battlefields of business networks around the world, cybercriminals were launching a full-bore offensive. Ransomware climbed an unprecedented 105% in 2021, and the explosive growth of strategies such as double and even triple extortion ensured that these attacks were more successful than ever. But as cybercriminals have grown more sophisticated and successful, they’ve also grown more ruthless — many of the high-profile ransomware attacks in 2021 looked more like acts of war than ever before, endangering our food supply, our water supply, our fuel supply, our hospitals and our municipalities.
...
The legislation also earmarks $42.45 billion for the “Broadband Equity, Access, and Deployment” initiative, which will expand grants available to underserved communities. About half of that amount is set aside for the State, Local, Tribal and Territorial (SLTT) Cyber Grant Program and will be distributed over four years. The Act’s language offers much-needed guidance on the types of investments that governments are expected to make — specifically, firewalls (on-prem and virtual), secure mobile access (on-prem and virtual) and advanced software that provides endpoint threat detection and response.

This funding is expected to touch on local cybersecurity considerations as expansion will likely involve wireless communication and participation from local utilities (e.g., mobile, broadband).

## Beyond Ransomware: The Threat of BEC, Phishing and More

While ransomware attracted most of the headlines in 2021, the year’s data pointed to plenty of other areas of concern. Based on data collected by SonicWall Capture Labs threat respondents ranked phishing attacks as their top concern (though, again, ransomware was a close second.)
...
A recent SonicWall-sponsored survey by Osterman Research painted a slightly different picture. This group of researchers, while ransomware did make up the largest number of malware signatures detected, it amounted to only about a quarter of the total volume.
...
![Image description: A bar chart showing the percentage of respondents concerned about various cyber threats. Targeted phishing attacks are at 77%, ransomware attacks at 73%, a breach of customer data at 68%, business email compromise at 63%, a breach of employee data at 56%, supply-chain compromise attacks at 37%, accidental insider incident at 36%, malicious insider attack at 33%, the reply to an encrypted email containing sensitive information is sent back unencrypted at 31%, sensitive financial data sent unencrypted because the sender forgot to encrypt message at 31%, assumption that an email message is encrypted end-to-end but are unsure if it actually is at 28%, and eavesdropping inside a recipient's email account at 28%.]
...
The number of entirely preventable exploits once again highlights the need for more timely and widespread patching. In addition, SonicWall identified a number of even older vulnerabilities being actively exploited, including CVE-2013-3541, CVE-2016-1605, CVE-2014-6036 and many more.
