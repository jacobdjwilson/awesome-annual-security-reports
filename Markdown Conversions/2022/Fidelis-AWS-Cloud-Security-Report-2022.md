...
- [Methodology & Demographics](#methodology--demographics)
  ...
  - [Industry](#industry)
  - [Security Certifications Held](#security-certifications-held)
- [Fidelis CloudPassage Halo](#fidelis-cloudpassage-halo)
- [About Fidelis Cybersecurity](#about-fidelis-cybersecurity)
- [About Cybersecurity Insiders](#about-cybersecurity-insiders)
...
![Pie chart showing cloud provider usage: 12% use one, 40% use two, 24% use three, 23% use more than three, and 1% use none. A callout highlights that 87% of organizations in the cloud use two or more cloud providers.]
...
![Bar chart showing concern levels about public cloud security: 5% slightly, 24% moderately, 41% very, and 30% extremely concerned. A callout notes that 95% of organizations are concerned about cloud security.]

![Bar chart illustrating cloud maturity levels: 17% early adopter, experimental; 51% intermediate, repeatable; 24% advanced, well-architected; 6% leader, fully automated; and 2% no cloud readiness.]
...
![Pie chart showing that 31% of organizations experienced a public cloud-related security incident in the last 12 months, while 69% did not.]

![Bar chart detailing types of cloud security incidents: 28% wrongly configured resource or account, 17% data or files shared inappropriately by a user, 15% account compromise, 14% data or files uploaded to an unsanctioned cloud resource, 13% vulnerability exploited, 10% data or files downloaded to an unsafe device, 9% malware infection, and 7% other.]
...
![Pie chart showing preference for cloud security controls: 62% prefer cloud native security controls, and 38% prefer an independent cloud security vendor.]

![Bar chart outlining criteria for choosing between cloud native and independent cloud security solutions: 63% Cost, 58% Less solution complexity and already well integrated, 57% Ease of use, 50% Performance, 36% Quicker deployments, 31% No need to manage another vendor, 13% Cloud vendor security is good enough, and 9% Other.]
...
![Bar chart comparing the number of separate security solutions used to configure cloud security policies in 2021 and 2022, showing categories from 1-2 to +10 solutions. A callout highlights that 67% of organizations use between three to six different dashboards.]
...
![Bar chart illustrating biggest operational headaches in protecting cloud workloads: 47% Lack of qualified staff, 41% Compliance, 38% Visibility, 34% Can’t identify misconfigurations quickly, 33% Setting consistent security policies, 33% Automating and enforcing security across multiple clouds, and other challenges.]
...
![Bar chart detailing the most challenging parts of the cloud compliance process: 56% Lack of staff expertise/knowledge, 46% Continuously staying in compliance as cloud environment changes, 43% Going through audit/risk assessment within the cloud environment, 42% Monitoring for compliance with policies and procedures, 38% Monitoring for new vulnerabilities in cloud services, and 38% Staying up to date about new/changing compliance and regulatory requirements.]
...
![Bar chart showing how helpful a single cloud security platform with a single dashboard would be: 3% slightly, 16% moderately, 41% very, 38% extremely helpful, and 2% not at all helpful. A callout indicates that 95% of organizations find it moderately to extremely helpful.]
...
![Bar chart outlining main drivers for considering cloud-based security solutions: 56% Better scalability, 54% Faster time to deployment, 42% Cost savings, 39% Better visibility, 38% Meet cloud compliance expectations, 35% Better performance, 34% Our data/workloads reside in the cloud, 33% Easier policy management, 33% Better uptime, 32% Need for secure app access from any location, 26% Reduction of appliance footprint in branch offices, and 1% Other.]
...
![Bar chart showing the likelihood of deploying a new cloud security solution within the next 12 months: 34% very likely, 24% likely, 28% neither likely nor unlikely, 9% unlikely, and 5% very unlikely. A callout states that 58% of organizations will deploy a new solution.]
...
![Bar chart detailing main reasons for considering switching to a new cloud security vendor: 59% Product features/functionality, 59% Cost, 30% Lack of integration with existing solutions, 29% Solution complexity, 27% Support issues, 24% Poor product performance, 22% Contract/term, 20% Lack of scalability, 19% Provider inflexible in offering new/requested features, 19% Lack of ability to customize, 19% Lack of comprehensive, consistent protections, 19% Lack of ease of use, 16% Too many false positives, 16% Stalled/complicated deployments, 14% Too many point solutions to manage, 14% Migrating to a Managed Service, 14% Provider’s willingness to adapt and support our specific use case, 13% Inflexible terms / contract rigidity, 9% Too complicated to add new data feeds, 8% Customer reviews, and 4% Other.]
...
![Bar chart showing security controls that would most increase confidence in adopting public clouds: 51% Setting and enforcing security policies across clouds, 49% Automating compliance, 45% APIs for reporting, auditing and alerting on security events, 44% Leveraging data leakage prevention tools, 44% Creating data boundaries, 37% Leveraging threat prevention tools, 36% Isolation/protection of virtual machines, 34% Limiting unmanaged device access, 32% Protecting workloads, 25% Proxying traffic for real-time security at access, and 2% Other.]
...
### Career Level
![Pie chart showing survey respondent career levels: 21% Specialist, 19% Manager/Supervisor, 15% CTO, CIO, CISO, CMO, CFO, COO, 15% Consultant, 13% Director, 3% Vice President, and 14% Other.]

### Department
![Pie chart showing survey respondent departments: 53% IT Security, 16% IT Operations, 7% Engineering, 4% Compliance, 4% Operations, 3% SecOps, 3% Product Management, 3% DevOps, and 7% Other.]

### Company Size
![Pie chart showing survey respondent company sizes: 5% Fewer than 10, 13% 10-99, 12% 100-499, 10% 500-999, 17% 1,000-4,999, 9% 5,000-10,000, and 34% Over 10,000 employees.]

### Industry
![Pie chart showing survey respondent industries: 26% Technology, Software & Internet; 19% Financial Services; 13% Government; 7% Professional Services; 5% Healthcare, Pharmaceuticals & Biotech; 5% Manufacturing; 5% Telecommunications; 3% Education & Research; 3% Computers & Electronics; and 14% Other.]

### Security Certifications Held
![Bar chart showing security certifications held by respondents: 85% CISSP, 24% CCSP, 23% CISM, 17% CISA, 15% Security+, 15% CEH, 9% Network+, 9% CRISC, and 49% Other. (Respondents could select multiple certifications). ]
...
For more information, please visit [www.fidelissecurity.com](www.fidelissecurity.com).
...
For more information please visit [www.cybersecurity-insiders.com](www.cybersecurity-insiders.com)
