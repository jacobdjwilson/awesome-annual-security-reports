...
* [About Fidelis Cybersecurity](#about-fidelis-cybersecurity)
...
**Image Description:** A pie chart showing the distribution of cloud provider usage among organizations. The slices are labeled as follows: One (12%), Two (40%), Three (24%), More than three (23%), and None (1%). A text box next to the chart states: "87% of organizations that are in the cloud use two or more cloud providers".
...
**Image Description:** Two bar charts are displayed side-by-side. The first bar chart shows the cloud maturity level of organizations, with the following categories and percentages: No cloud readiness (2%), Early adopter, experimental (17%), Intermediate, repeatable (51%), Advanced, well-architected (24%), and Leader, fully automated (6%). The second bar chart shows the level of concern about public cloud security, with the following categories and percentages: Extremely concerned (30%), Moderately concerned (41%), Very concerned (24%), and Slightly concerned (5%). A text box next to the charts states: "95% of organizations are concerned about cloud security, which is consistent with the findings over the past three years".
...
**Image Description:** A pie chart showing the percentage of organizations that experienced a cloud-related security incident in the last 12 months. The slices are labeled as Yes (31%) and No (69%). Below the pie chart is a bar chart showing the types of incidents experienced, with the following categories and percentages: Wrongly configured resource or account (28%), Data or files shared inappropriately by a user (17%), Account compromise (15%), Data or files uploaded to an unsanctioned cloud resource (14%), Vulnerability exploited (13%), Data or files downloaded to an unsafe device (10%), Malware infection (9%), and Other (7%).
...
**Image Description:** A bar chart showing the preference for cloud security controls, with two categories: Cloud native security controls (62%) and Independent cloud security vendor (38%). Below the bar chart is a list of decision factors, with the following categories and percentages: Cost (63%), Less solution complexity and already well integrated (58%), Ease of use (57%), Performance (50%), Quicker deployments (36%), No need to manage another vendor (31%), Cloud vendor security is good enough, why would I need anything else? (13%), and Other (9%).
...
**Image Description:** A bar chart showing the number of separate security solutions used by organizations to configure cloud security policies. The chart displays data for both 2021 and 2022. The categories and percentages for 2022 are: 1-2 (7%), 3-4 (25%), 5-6 (42%), 7-8 (18%), 9-10 (6%), and +10 (2%). The categories and percentages for 2021 are: 1-2 (17%), 3-4 (28%), 5-6 (38%), 7-8 (6%), 9-10 (4%), and +10 (7%). A text box next to the chart states: "67% of organizations still use between three to six different dashboards to configure cloud security policies".
...
**Image Description:** A list of operational security headaches with their corresponding percentages: Lack of qualified staff (47%), Compliance (41%), Visibility (38%), Automating and enforcing security across multiple clouds (33%), Setting consistent security policies (33%), Can’t identify misconfigurations quickly (34%), Implementing continuous and automated security controls in the cloud (32%), Complex cloud to cloud/cloud to on-prem security rule matching (28%), Setting the correct user access privileges (28%), Lack of integration with on-prem security technologies (27%), Securing access from personal and mobile devices (26%), Security can’t keep up with the pace of changes to new/existing applications (26%), Justifying more security spending (26%), Securing traffic flows (25%), Remediating threats (25%), No automatic discovery/visibility/control to infrastructure security (24%), Reporting security threats (23%), Understanding network traffic patterns (23%), Lack of feature parity with on-prem security solution (15%), No flexibility (5%), and Not sure/Other (8%).
...
**Image Description:** A list of cloud compliance challenges with their corresponding percentages: Lack of staff expertise/knowledge (56%), Going through audit/risk assessment within the cloud environment (46%), Monitoring for new vulnerabilities in cloud services that must be secured (43%), Monitoring for compliance with policies and procedures (42%), Staying up to date about new/changing compliance and regulatory requirements (38%), Continuously staying in compliance as cloud environment changes (38%), Scaling and automating compliance activities (29%), Applying/following the Shared Responsibility Model (22%), Data quality and integrity in regulatory reporting (22%), and Not sure/other (6%).
...
**Image Description:** A bar chart showing the perceived helpfulness of having a single cloud security platform. The categories and percentages are: Extremely helpful (38%), Very helpful (41%), Moderately helpful (16%), Slightly helpful (3%), and Not at all helpful (2%). A text box next to the chart states: "95% of organizations agree that it would be moderately to extremely helpful to have a single cloud security dashboard".
...
**Image Description:** A list of drivers for considering cloud-based security solutions with their corresponding percentages: Better scalability (56%), Faster time to deployment (54%), Cost savings (42%), Better visibility (39%), Meet cloud compliance expectations (38%), Better performance (35%), Our data/workloads reside in the cloud (or are moving to the cloud) (34%), Easier policy management (33%), Better uptime (33%), Need for secure app access from any location (32%), Reduction of appliance footprint in branch offices (26%), and Other (1%).
...
**Image Description:** A bar chart showing the likelihood of organizations deploying a new cloud security solution within the next 12 months. The categories and percentages are: Very likely (24%), Likely (34%), Neither likely nor unlikely (28%), Unlikely (9%), and Very unlikely (5%). A text box next to the chart states: "58% of organizations will deploy a new cloud security solution within the next 12 months".
...
**Image Description:** A list of security controls that would increase confidence in adopting public clouds with their corresponding percentages: Setting and enforcing security policies across clouds (51%), Automating compliance (49%), APIs for reporting, auditing and alerting on security events (45%), Leveraging data leakage prevention tools (44%), Creating data boundaries (44%), Leveraging threat prevention tools (37%), Isolation/protection of virtual machines (36%), Limiting unmanaged device access (34%), Protecting workloads (32%), Proxying traffic for real-time security at access (25%), and Other (2%).
...
**Image Description:** A table showing the demographic data of the survey respondents, categorized by Career Level, Department, Industry, Company Size, and Security Certifications Held.

**Career Level:**
* Specialist (21%)
* Manager/Supervisor (19%)
* CTO, CIO, CISO, CMO, CFO, COO (15%)
* Consultant (15%)
* Director (13%)
* Vice President (3%)
* Other (14%)
...
**Industry:**
* Technology, Software & Internet (26%)
