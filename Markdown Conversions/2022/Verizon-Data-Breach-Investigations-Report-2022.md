# DBIR Data Breach Investigations Report 2022

## Table of Contents
- [About the 2022 cover](#about-the-2022-cover)
- [Table of contents](#table-of-contents)
- [01 DBIR Master’s Guide](#01-dbir-masters-guide)
  - [VERIS resources](#veris-resources)
  - [Incident vs. breach](#incident-vs-breach)
  - [Industry labels](#industry-labels)
- [Introduction](#introduction)
- [Summary of findings](#summary-of-findings)
- [2 Results and Analysis](#2-results-and-analysis)
  - [Results and Analysis: Introduction](#results-and-analysis-introduction)
  - [Actor – Friends in low places](#actor--friends-in-low-places)
  - [Actions](#actions)
  - [Assets](#assets)
  - [Attribute](#attribute)
  - [Timeline](#timeline)
- [3 Incident Classification Patterns](#3-incident-classification-patterns)
...
- [5 Regions](#5-regions)
  ...
  - [Latin America and the Caribbean (LAC)](#latin-america-and-the-caribbean-lac)
- [6 Wrap-up](#6-wrap-up)
  - [Incident Classification Patterns](#incident-classification-patterns-1)
...
- [7 Appendices](#7-appendices)
  ...
  - [Appendix D: U.S. Secret Service](#appendix-d-u.s.-secret-service)
...
- [Appendices](#appendices)
  ...
  - [Appendix E: Ransomware Pays](#appendix-e-ransomware-pays)
  - [Appendix F: Contributing Organizations](#appendix-f-contributing-organizations)
- [1 DBIR Master’s Guide](#01-dbir-masters-guide)
- [Introduction](#introduction)
- [Summary of findings](#summary-of-findings)
- [2 Results and Analysis](#2-results-and-analysis)
  - [Introduction](#results-and-analysis-introduction)
  - [Actor](#actor--friends-in-low-places)
  - [Actions](#actions)
  - [Assets](#assets)
  - [Attribute](#attribute)
  - [Timeline](#timeline)
...
*   [github.com/vz-risk/dbir/tree/gh-pages/2022](https://github.com/vz-risk/dbir/tree/gh-pages/2022) – DBIR facts, figures and figure data.
*   [veriscommunity.net](https://veriscommunity.net) features information on the framework with examples and enumeration listings.
*   [github.com/vz-risk/veris](https://github.com/vz-risk/veris) features information on the framework with examples and enumeration listings
...
![Example dot plot (n=672). Each dot represents 0.5% of organizations. Orange: lower half of 80%. Yellow: upper half of 80%. Green: 80%-95%. Blue: Outliers. 95% of orgs: 148 - 1,594,648. 80%: 1,274 - 438,499. Median: 29,774 (log scale).](https://i.imgur.com/example_dot_plot.png)
...
![Example slanted bar chart (n=205)](https://i.imgur.com/example_slanted_bar_chart.png)
...
Questions? Comments? Let us know! Drop us a line at dbir@verizon.com, find us on LinkedIn, tweet @VerizonBusiness with #dbir. Got a data question? Tweet @VZDBIR!

![Example spaghetti chart](https://i.imgur.com/example_spaghetti_chart.png)
Figure 2. Example spaghetti chart

![Example pictogram plot (n=4,110). Each glyph represents 40 breaches.](https://i.imgur.com/example_pictogram_plot.png)
...
![Select enumerations in non-Error, non-Misuse breaches (n=4,250)](https://i.imgur.com/select_enumerations.png)
Figure 5. Select enumerations in non-Error, non-Misuse breaches (n=4,250)

![Ransomware over time in breaches](https://i.imgur.com/ransomware_over_time.png)
...
![Partner vector in System Intrusion incidents (n=3,403) Each glyph represents 25 incidents.](https://i.imgur.com/partner_vector.png)
...
![Misconfiguration over time in breaches](https://i.imgur.com/misconfiguration_over_time.png)
Figure 8. Misconfiguration over time in breaches

![The human element in breaches (n=4,110) Each glyph represents 25 breaches.](https://i.imgur.com/human_element_breaches.png)
...
![Sources of Data Breaches (2008 DBIR Figure 3)](https://i.imgur.com/sources_data_breaches_2008.png)
Figure 10. Sources of Data Breaches (2008 DBIR Figure 3)

![Actors in breaches (n=5,146)](https://i.imgur.com/actors_breaches.png)
...
![Median Number of Records Compromised (2008 DBIR Figure 5)](https://i.imgur.com/median_records_compromised_2008.png)
Figure 12. Median Number of Records Compromised (2008 DBIR Figure 5)

![Records by Actor in breaches (n=54)](https://i.imgur.com/records_by_actor.png)
Figure 13. Records by Actor in breaches (n=54)

![Motive in external agents by percent of breaches within external (2012 DBIR Figure 15)](https://i.imgur.com/motive_external_agents_2012.png)
...
![Motives in External actors by org size](https://i.imgur.com/motives_external_actors_org_size.png)
...
![Top Action vectors in incidents (n=18,419)](https://i.imgur.com/top_action_vectors_incidents.png)
Figure 16. Top Action vectors in incidents (n=18,419)

![Top Action varieties in incidents (n=18,511)](https://i.imgur.com/top_action_varieties_incidents.png)
...
![Top Action vectors in breaches (n=3,279)](https://i.imgur.com/top_action_vectors_breaches.png)
Figure 18. Top Action vectors in breaches (n=3,279)

![Top Action varieties in breaches (n=3,875)](https://i.imgur.com/top_action_varieties_breaches.png)
