...
Exchange mailbox replication service creating ASPX files.process \=\= msexchangemailboxreplication.exe\&\&filemod\_extension \=\= .aspx
...
Weve come a long way from hearing cries of Macs dont get viruses and in 
...
network connections to known mining pools.process !\= (chrome \|\| firefox \|\| msedge \|\| iexplore \|\| safari)\&\&network \_connection\_includes \=\= (supportxmr \|\| xmrpool \|\| xmr \|\|nanopool \|\| monero)
...
https:www.mandiant.comresourcesdefining\-cobalt\-strike\-components
...
lsass.exe ) spawning processes that are not typically 
...
where a lot of the preliminary activitythe stuff we generally catch early for our 
full\-time customershas already occurred. In other words, were already at the 
...
destinationwhether thats a SIEM or some other aggregation point.
However, this analysis is still useful for practitioners or leaders who arent 
...
As a practitioner, youll gain a better understanding of common adversary 
actions and whats likely to occur if an adversary gains access to your 
environment. Youll learn what malicious looks like in the form of telemetry and 
the many places you can look to find that telemetry. Youll gain familiarity with 
...
existing security tooling does what you think its supposed to do.
...
capabilities, and youll see evidence of this throughout the techniques
sectionparticularly in the visibility, collection, and detection subsections. 
...
of the most prevalent forms of initial accessemail\-based phishingis under\-
...
78 l Techniques
2022 Threat Detection Report
email\-borne threats. However, Red Canary doesnt have as much early\-stage 
...
different vantage pointslike those who make firewalls or email\-monitoring 
products. 
...
discovery\-related alerts arent always actionable since, for example, you cant 
really prevent someone from scanning a public\-facing resource. This isnt to 
say we dont inform our customers of discovery activity. We absolutely do, but 
its typically done manually by our detection engineers as theyre analyzing 
potentially malicious events. Since our ATT\&CK mapping happens at the 
detection\-analytic level, prior to human analysis, the discovery activity isnt 
included in this report. 
One final note: we overwhelmingly monitor Windows endpoints, and therefore 
weve included only limited information about macOS and Linux techniques 
...
79
ConclusionThank you for devoting your time to absorbing this report; we appreciate your dedication to 
...
report offers insights into howto improve your security posture and what you can do if you 
...
at info@redcanary.com.Contributors 
