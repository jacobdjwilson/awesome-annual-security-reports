...
- [DIGGING PAST A CRAFTY COINMINER](#digging-past-a-crafty-coinminer)
  ...
  - [Intensive Investigations Reveal Deeper Threats](#intensive-investigations-reveal-deeper-threats)
  - [UNC3016](#unc3016)
  - [APT41](#apt41)
...
![Graph showing Detection by Source from 2011-2021](https://i.imgur.com/your_image_url_here.png)
...
![Bar chart showing Detection by Source by Region in 2021](https://i.imgur.com/your_image_url_here.png)
...
##### Americas Detection by Source, 2017-2021

![Line graph showing Americas Detection by Source from 2017-2021](https://i.imgur.com/your_image_url_here.png)

##### APAC Detection by Source, 2017-2021

![Line graph showing APAC Detection by Source from 2017-2021](https://i.imgur.com/your_image_url_here.png)

##### EMEA Detection by Source, 2017-2021

![Line graph showing EMEA Detection by Source from 2017-2021](https://i.imgur.com/your_image_url_here.png)
...
| External Notification    | —    | —    | —    | —    | —    | —    | —    | —    | 73   | 73   | 28   |
| Internal Detection       | 320  | 186  | 184  | 56   | 80   | 57.5 | 50.5 | 30   | 56   | 12   | 18   |
...
![Bar chart showing Global Dwell Time Distribution from 2018-2021](https://i.imgur.com/your_image_url_here.png)
...
![Bar chart showing Global Dwell Time by Investigation Type in 2021](https://i.imgur.com/your_image_url_here.png)
...
![Line graph showing Americas Median Dwell Time from 2016-2021](https://i.imgur.com/your_image_url_here.png)
...
![Bar chart showing Americas Dwell Time Distribution in 2021](https://i.imgur.com/your_image_url_here.png)
...
![Bar chart showing Americas Dwell Time by Investigation Type in 2021](https://i.imgur.com/your_image_url_here.png)
...
![Line graph showing APAC Median Dwell Time from 2016-2021](https://i.imgur.com/your_image_url_here.png)
...
![Bar chart showing APAC Dwell Time Distribution in 2021](https://i.imgur.com/your_image_url_here.png)
...
![Bar chart showing APAC Dwell Time by Investigation Type in 2021](https://i.imgur.com/your_image_url_here.png)
...
![Line graph showing EMEA Median Dwell Time from 2016-2021](https://i.imgur.com/your_image_url_here.png)
...
![Bar chart showing EMEA Dwell Time Distribution in 2021](https://i.imgur.com/your_image_url_here.png)
...
![Bar chart showing EMEA Dwell Time by Investigation Type in 2021](https://i.imgur.com/your_image_url_here.png)
...
*   **Ransomware**: 23% IN 2020, 30% IN 2021
*   **Extortion**: 9% IN 2020, 29% IN 2021
*   **Financial Gain**: 38% IN 2020, 30% IN 2021
...
*   **Data Theft**: 32% IN 2020, 30% IN 2021
*   **Involved Exploits**: 29% IN 2021
...
![Bar chart showing Multiple Threat Groups Identified from 2019-2021](https://i.imgur.com/your_image_url_here.png)
...
*   **Observed Threat Groups in 2021**: 1143
*   **Newly Tracked Threat Groups in 2021**: 283
*   **Active UNC Groups**: 51
*   **Active FIN Groups**: 6
*   **Active APT Groups**: 6
...
| Group Type | Active Groups | Geolocations