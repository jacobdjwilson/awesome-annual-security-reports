# Cisco Talos Year in Review 2022
...
![Figure 1. Current Cisco support for Ukrainitan critical infrastrucuture and government partners since the beginning of the Russia-Ukraine war.](Image description)
...
![Figure 2. Major cyber attacks against Ukraine.](Image description)
...
![Figure 3. Malspam message themed as humanitarian aid request for Ukrainian refugees.](Image description)

![Figure 4. Screenshot showing disBalancer’s “Liberator” advertisement.](Image description)
...
![Figure 5. Most active Behavioral Protections rules from Cisco Secure Endpoint across Ukrainian customers where Cisco Secure Endpoint has been deployed.](Image description)
...
![Figure 6. rundll32 detections across Ukraine customers.](Image description)

![Figure 7. rundll32 detections across all Cisco customers.](Image description)

![Figure 8. Total number of Behavioral Protection alerts across Ukrainian customers showing increases in activity in March and June.](Image description)

![Figure 9. Attacker IPs targeting Ukrainian entities based on custom detections](Image description)
...
![Figure 10. Top infection vectors based on Talos IR data.](Image description)

![Figure 11. Total alerts on malicious network traffic identified as Log4j exploitation attempts.](Image description)
...
![Figure 12. Detections for a Cobalt Strike Snort SID 53658.](Image description)

![Figure 13. Behavioral indicators alerting on Cobalt Strike-named pipe usage.](Image description)
...
![Figure 14. Range of tools observed across CTIR engagements in Q3 (July-September 2022).](Image description)
...
![Figure 16. Behavioral indicators for executables written to USB.](Image description)

![Figure 17. Behavioral indicators for setting hidden attributes for files on a USB.](Image description)
...
![Figure 18. Execution chain of Raspberry Robin.](Image description)