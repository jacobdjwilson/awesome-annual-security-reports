...
- [CEO Insight](#ceo-insight)
- [Key Global Results](#key-global-results)
...
![Infographic showing key statistics: 80% of those who paid were victims of a second attack; 73% targeted by at least one attack; 68% hit again in less than a month; 41% paid to expedite recovery; 28% paid to avoid injury/loss of life; 49% paid to avoid revenue loss; 37% forced to lay off employees; 86% increased security budgets; 35% reported C-level resignations; 33% suspended business; 64% came from supply chain; 54% reported system issues after payment; 33% increase in attacks; 88% believe they have the right talent.]
...
![Chart showing the verticals most likely to have been affected: Legal (92%), Financial Services (78%), Manufacturing (78%), Human Resources (77%).]
...
Of the organizations that paid one or more ransom demands following successful attacks, nearly half (49%) said their primary motivation for paying was to avoid any loss of revenue, while 41% cited the need to expedite recovery as the main driver for payment.

Some companies decided to pay the ransom because they weren’t prepared for a ransomware attack. For example, 27% said they paid the ransom because they hadn’t backed up their data. One-third (34%) indicated they were simply too short-staffed to attempt an effective response without the assistance of the attackers.

![Infographic of top motivations: 49% to avoid revenue loss, 41% to expedite recovery, 27% to recover data, 34% short-staffed, 28% to avoid downtime resulting in injury or loss of life.]

This research demonstrates that paying the ransom doesn’t guarantee a faster recovery from the attack. In fact, of the organizations that reported having paid a ransom demand, only 42% said the payment resulted in restoration of all systems and data, a significant decrease from the 51% who said they fully recovered systems and data in the 2021 study. Furthermore, 54% said that system issues persisted or that some data was corrupted after decryption.

## It Still Does Not Pay to Pay

One of the toughest decisions a business will ever make is whether to pay a ransom demand following a successful attack.

This research found that it clearly does not pay to pay. Of the organizations that chose to pay a ransom demand, the vast majority (nearly 80%) indicated they were victims of at least one subsequent ransomware attack. Of those who were hit a second time with ransomware, nearly half (48%) indicated the attack was perpetrated by the same attackers.

Two-thirds (68%) who paid a ransom and were hit again reported that the second attack came less than a month after the first and that the threat actors demanded an even higher ransom amount the second time around.
...
- **16%** reported that the attackers were in their networks for a year or more.
...
With double extortion, the ransomware encrypts the victim’s data and demands payment in exchange for a decryptor within the ransom note, as expected. However, the threat actor can also apply additional pressure to victims who would not usually pay a ransom by threatening to leak or sell the exfiltrated data.

![Chart of data types targeted: 54% Sensitive Customer Data, 34% PII, 30% IP, 27% PHI.]

## Ransomware’s Impact on Security Budgets

The steady increase in the volume, complexity, and severity of ransomware attacks is driving increases in security budgets, with 86% of respondents indicating an increase in their security budgets to defend against ransomware attacks.

- **93%** of respondents indicated their organizations have a cyber insurance policy in place, up from 75% in the 2021 report.
- **84%** of those with cyber insurance indicated their policies include coverage specifically for ransomware attacks, up from just 54% in last year’s report.
...
- Deploy Endpoint and Extended Detection and Response
- Lock Down Critical Accounts for Weekend and Holiday Periods
- Ensure Clear Isolation Practices
- Evaluate Managed Security Services Provider Options
- Implement Multi-Layer Prevention Capabilities
