...
- **Ongoing talent drought**: 84.1% of organizations can’t find enough skilled security people (page 15).
...
More than six out of seven organizations (85.3%) experienced a successful cyberattack within the last 12 months. That’s down a touch from the previous year’s record high of 86.2%, but still substantially larger than in any of the prior seven years of this survey. The number of organizations suffering six or more successful attacks set a new record of 40.7%.

> “A short summary of the cybersecurity landscape over the past year: gale-force winds continue.”

### Future Likelihood of Successful Cyberattacks

Expectations about successful cyberattacks over the coming 12 months reached a new high in this year’s survey. The number of respondents indicating that such an attack was either “somewhat likely” or “very likely” edged up from 75.6% to 76.1%. In addition, the mix between those two views shifted for the worse. The percentage saying a successful attack was “very likely” jumped by 3.1%, to 35.1%.

### Security Posture by IT Domain

Each year we try to gauge how security professionals feel about their ability to defend against cyberthreats across different types of systems, technologies, and environments. This year respondents chose software as a service (SaaS) cloud applications as the area where they are most comfortable about their organization’s security posture.

### Assessing IT Security Functions

This question asks respondents to rate the adequacy of their organization’s capabilities in different functional areas of IT security. Organizations remain most positive about their capabilities for governance, risk and compliance (GRC) and identity and access management (IAM).

### The IT Security Skills Shortage

A shortage of experienced IT security personnel has been a serious problem for the great majority of organizations for at least the five years. As shown on page 24, it is the single most serious barrier to establishing effective defenses against cyberthreats. Just like last year, the greatest unfilled demand is for security administrators (40.5%).
...
For the seventh year in a row, malware tops the list of threats keeping security professionals up at night. The surprise in this data is that account takeover (ATO) and credential abuse attacks moved up from fourth place last year to second place in this survey, slightly ahead of ransomware.

### Concern for Web and Mobile Attacks

In this question we drill down into worries about threats to web and mobile applications. The percentage of concerned respondents increased in all four of the categories that were repeated from last year. This year, harvesting of personally identifiable information (PII) rose to the top of the list, edging out ATO and credential stuffing attacks.

### Responding to Ransomware

2021 saw a lot of big developments in the ransomware industry. The percentage of companies victimized by a ransomware attack in the past 12 months set a new record, rising to 71.0%.
