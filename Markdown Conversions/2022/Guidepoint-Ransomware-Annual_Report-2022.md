# GRIT 2022 Annual Ransomware Report
...
- [Top 10 Ransomware Threat Actors](#top-10-ransomware-threat-actors)
...
- [Threat Actor Activity Breakdown](#threat-actor-activity-breakdown)
  - [2022 Recap](#2022-recap)
- [Rate of Publicly Posted Ransomware Victims (2022)](#rate-of-publicly-posted-ransomware-victims-2022)
- [Post Rates per Quarter](#post-rates-per-quarter)
...
- [Major Events and Observations](#major-events-and-observations)
  - [2022 Recap](#2022-recap-1)
- [Q4 Ransomware Trends Recap](#q4-ransomware-trends-recap)
  - [Q4 Summary](#q4-summary)
- [Rate of Publicly Posted Ransomware Victims](#rate-of-publicly-posted-ransomware-victims)
...
![Rate of Publicly Posted Ransomware Victims (2022) graph showing victim posts and active groups over time, with total groups and posts summarized.](placeholder_for_image_1)
...
![Rate of Publicly Posted Ransomware Victims vs Price of Bitcoin (2022) graph showing Bitcoin price and reports over time.](placeholder_for_image_2)
...
![2022 Correlating Geo-Political and World Events graph showing daily rate of victim posting and active groups overlaid with significant world events.](placeholder_for_image_3)
...
![Cumulative Victims by Threat Group graph showing the percentage of total victims attributed to various threat groups over time.](placeholder_for_image_4)

---

## Top 10 Ransomware Threat Actors

![Top 10 Ransomware Threat Actors bar chart showing victim counts for Q1, Q2, Q3, and Q4 for various threat actors.](placeholder_for_image_5)
...
In 2022, Full-Time groups accounted for the most activity in the most highly impacted industries. Unsurprisingly, Lockbit was the most impactful Full-Time ransomware group in the top four impacted industries of 2022. Surprisingly, there were more healthcare victims targeted by Lockbit after the release of Lockbit3 (51%), despite Lockbit explicitly calling out healthcare as a sensitive industry that should not be touched unless they are "for profit." Reviewing Lockbit’s late 2022 healthcare victims, some victims are for-profit organizations, but others are focused on patient health.
...
![Country Breakdown (All Threat Actors) pie chart showing the percentage of total victims by country.](placeholder_for_image_6)

As observed through all of 2022, the United States is by far the most targeted country across all ransomware groups, and Western countries made up for the vast majority (77%) of all ransomware attacks. There seems to be no direct correlation between industries targeted based on country.
...
![Rate of Publicly Posted Ransomware Victims (2022) graph showing victim posts by group type per quarter.](placeholder_for_image_7)

---

## Post Rates per Quarter

![Post Rates per Quarter bar chart showing total victim posts for each quarter, broken down by group type.](placeholder_for_image_8)
...
![2022 Average Operating Duration by Group Type bar chart showing active days by group type.](placeholder_for_image_9)
...
![Industry Targeting by Group Type stacked bar chart showing the percentage of victims by industry for each group type.](placeholder_for_image_10)
...
![Country Targeting by Group Type maps showing the top 5 countries targeted by each group type.](placeholder_for_image_11)
...
Victim posting rate was consistent in early Q4, but shortly after the mid-November start of World Cup in Qatar the rate dropped sharply. The high number of groups active from week 42 through 47 also saw a steep drop after the World Cup, but the resurgence in mid-December may correlate to a lull in new attacks as they negotiated with victims, followed by a surge in posts when negotiations went south. However, this pullback was short-lived, as we observed a surge in mid-December before returning to the average posting rate of Q4.

Overall, Q4 saw a 15.5% increase in reported victims and a minor increase from 27 active groups in Q3 to 30.

![Rate of Publicly Posted Ransomware Victims graph showing victim posts and active groups per week in Q4.](placeholder_for_image_12)
...
![Top 5 Ransomware Threat Actors – Changes from Q3 to Q4 bar chart showing victim counts for Q3 and Q4 for various threat actors.](placeholder_for_image_13)

---

## Geographic Breakdown of Ransomware Victims (Q4 2022)

Similar to Q3, ransomware attacks targeted mostly western countries in Q4. Among the top 10, only India, Taiwan, and Australia were outside Europe and the Americas.
...
![Geographic Breakdown of Ransomware Victims (Q4 2022) map showing targeted countries.](placeholder_for_image_14)
...
![Cumulative Victims by Threat Group graph showing victim posts for Lockbit, AlphV, Royal, BianLian, and BlackBasta over time in Q4.](placeholder_for_image_15)
