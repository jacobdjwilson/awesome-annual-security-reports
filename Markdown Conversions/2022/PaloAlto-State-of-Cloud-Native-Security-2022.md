...
- [The State of Cloud Adoption Groups](#the-state-of-cloud-adoption-groups)
  - [Cloud Footprints](#cloud-footprints)
  - [Future Cloud Plans](#future-cloud-plans)
  - [Cloud Spending](#cloud-spending)
  - [Approach to Compute Environment](#approach-to-compute-environment)
- [Rapid Cloud Expansion Has Polarizing Results](#rapid-cloud-expansion-has-polarizing-results)
- [The Role of Security Vendors, Teams, and Tools](#the-role-of-security-vendors-teams-and-tools)
...
![Figure 1: Percent change in cloud workload volumes since 2020](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure1.png)
...
![Figure 2: Share of workloads hosted in public vs private clouds (left); share of workloads by compute type (right)](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure2.png)
...
![Figure 3: Reasons for expanding cloud capabilities](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure3.png)
...
![Figure 4: Changes to cloud budgets](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure4.png)
...
![Figure 5: Cloud trends by global region](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure5.png)
...
![Figure 6: Challenges in moving to the cloud](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure6.png)
...
![Figure 9: Factors contributing to security posture (left); percentage of organizations with strong or weak security posture (right)](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure9.png)

To analyze cloud security friction, we asked respondents whether they agree with two statements about business outcomes as a result of cloud adoption and security. The more strongly a respondent agreed with the statements, the higher the respondent’s overall perception of their company’s cloud security friction. Here we find that just under half (48%) of organizations believe they have low security friction.

![Figure 10: Factors contributing to organizational friction (left); Percentage of organizations with high, medium, or low friction (right)](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure10.png)

By combining these two metrics, we see that achieving low security friction is essential to driving a stronger security posture. Organizations with a strong security posture are more than two times more likely to have low levels of security friction. This highlights the need to take a two-pronged approach to cloud security: organizations should strive for the most effective security capabilities, but they need to ensure those tools and processes do not interfere with the flow of business operations.

![Figure 11: Percent of “low-friction” organizations with weak or strong posture](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure11.png)

Beyond operational excellence, we also see additional advantages to achieving these best-in-class security outcomes. Organizations that enable high security posture and low friction see the greatest benefits to their workforce in terms of increased productivity and higher employee satisfaction with over 80% of organizations with low levels of security friction reporting increased or significantly increased levels of employee satisfaction.

![Figure 12: Comparing organization outcomes to overall security posture](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure12.png)
...
![Figure 13: Factors that contribute to DevSecOps integration measurement (left); comparing DevSecOps integration to automation levels (right)](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure13.png)
...
![Figure 14: Outcomes for organization that tightly integrate DevSecOps principles](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure14.png)

![Figure 15: Factors that contribute to automation measurement (left); comparing security friction to automation levels (right)](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure15.png)
...
![Figure 16: Automation as a driver of security outcomes](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure16.png)
...
![Figure 17: Security provider and team budget (top) and size (bottom)](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure17.png)

Furthermore, of those who are using primarily open source security tools, 80% have weak or very weak security posture.

![Figure 18: Security provider and security posture](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure18.png)
...
![Figure 19: Characteristics of each cloud adoption group](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure19.png)
...
![Figure 20: Cloud adoption groups by industry (left); cloud adoption groups by income (right)](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure20.png)

## Cloud Footprints

Moderate Adopters came into the pandemic with a fairly small cloud footprint and expanded minimally over the following 12 months. Rapid Expanders entered the pandemic with a similar small cloud estate but with much faster expansion. In contrast, Established Users show a significant existing cloud footprint but with slower growth, similar to the Moderate Adopters.
...
![Figure 21: Percent of workloads in the cloud by adoption group](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure21.png)
...
![Figure 22: Total cloud spend by adoption group](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure22.png)
...
![Figure 23: Compute architecture mix by adoption group](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure23.png)
...
![Figure 24: Cloud workload growth for 2020–2021 and expected for 2022–2023](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure24.png)
...
![Figure 25: Spending levels by adoption group](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure25.png)

We also see significant differences in our groups’ cloud objectives. For all groups, short-term goals such as application modernization and maintaining competitiveness were the primary drivers of cloud expansion, while more strategic thinking took a back seat. However, there were large differences in organizational alignment, where our successful Rapid Expanders were significantly more likely to integrate their cloud evolution into a larger strategic digital transformation effort. Rapid Expanders who successfully expanded their cloud infrastructure over the past year were over two times more likely to have integrated it into a wider, strategic digital transformation effort.

![Figure 26: Reasons for moving workloads to the cloud](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure26.png)
...
![Figure 27: Top challenges for cloud adoption programs](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure27.png)
...
![Figure 28: Number of separate security vendors used](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure28.png)
...
![Figure 29: Size of cloud security teams](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure29.png)
...
![Figure 30: Number of tools used, regardless of vendor](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure30.png)
...
![Figure 31: Number of security tools and security outcomes](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure31.png)
...
![Figure 32: Level of DevSecOps integration into the application lifecycle](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure32.png)
...
![Figure 33: Level of security automation across the development lifecycle](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure33.png)
...
![Figure 34: Security posture levels across adoption groups](https://www.paloaltonetworks.com/state-of-cloud-native-security/2022/images/figure34.png)
...
![Figure 35: Amount of organizational friction across adoption groups](https://www.paloaltonetworks.