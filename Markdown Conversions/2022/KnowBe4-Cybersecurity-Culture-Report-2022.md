...
[A Standard Way to Measure and Report](#a-standard-way-to-measure-and-report)
[The Global Pandemic Improved Security Culture](#the-global-pandemic-improved-security-culture)
[Security Culture Varies Around the World](#security-culture-varies-around-the-world)
[Industry Benchmarking With Trends](#industry-benchmarking-with-trends)
[Board Level Concern](#board-level-concern)
[Defining Security Culture](#defining-security-culture)
[Introduction](#introduction)
[Changes in the Security Culture Report 2022](#changes-in-the-security-culture-report-2022)
[Join the Discussion](#join-the-discussion)
[Security Culture—A High‑Level Perspective](#security-culturea-highlevel-perspective)
...
[The Five Maturity Levels](#the-five-maturity-levels)
[A Global Perspective on Security Culture](#a-global-perspective-on-security-culture)
[Global Overview](#global-overview)
[Security Culture According To Organizational Size Worldwide](#security-culture-according-to-organizational-size-worldwide)
[Security Culture in Africa](#security-culture-in-africa)
[Security Culture in Asia](#security-culture-in-asia)
[Security Culture in Europe](#security-culture-in-europe)
[Security Culture in North America](#security-culture-in-north-america)
[Security Culture in Canada](#security-culture-in-canada)
[Security Culture in the United States of America](#security-culture-in-the-united-states-of-america)
[Security Culture in Oceania](#security-culture-in-oceania)
[Security Culture in Central and South America](#security-culture-in-central-and-south-america)
[Security Culture Industry Trends](#security-culture-industry-trends)
[Global Trends as Seen Across the Dimensions of Security Culture](#global-trends-as-seen-across-the-dimensions-of-security-culture)
[Industry Benchmark](#industry-benchmark)
[Benchmark Overview](#benchmark-overview)
[Industry Benchmark](#industry-benchmark-1)
[Banking](#banking)
...
[Global Overview](#global-overview-1)
[Global Overview—Small, Medium and Large Enterprises](#global-overviewsmall-medium-and-large-enterprises)
[Country Data](#country-data)
[States in the USA](#states-in-the-usa)
[States in Canada](#states-in-canada)
[Authors](#authors)
...
This report uses the globally recognized Security Culture Index. The use of a standard index offers direct value by allowing the reader to compare the information presented in a meaningful way. The index ranges are as follows:
...
*Image Description: A diagram of the Security Culture Maturity Model. The model is represented as a horizontal bar with 5 levels, each increasing in maturity from left to right. The levels are labeled as follows: Level 1: Basic Compliance, Level 2: Security Awareness Foundation, Level 3: Programmatic Security Awareness & Behavior, Level 4: Security Behavior Management, and Level 5: Sustainable Security Culture. A dashed red line represents breach likelihood and relative cost remediation, decreasing from left to right. A solid blue line represents awareness/culture maturity gains at each stage of the model, increasing from left to right. The source is attributed to KnowBe4.*
...
Of particular interest, outside Europe and North America, we have noted a dramatic drop in organizations measuring security culture, leaving them blindsided when it comes to assessing the human factors of security. Below, we share regional breakdowns for your reference, but the important message is that organizations must step up their game and invest in security awareness, behavior and culture in the years to come. This is not a nice to have, it is a critical asset used to reduce risk and improve security.
...
### Global Overview
*Image Description: A bar graph showing the security culture scores of different regions. The regions are North America (74), Europe (73), Asia (73), Africa (72), Oceania (72), and Latin America (72). The Y-axis is labeled "Security Culture" and the X-axis is labeled "A global perspective".*
...
*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations globally. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size Global Overview".*

**Figure 3:** Security culture as seen by organizational size (Global overview).

We see an interesting pattern emerge when examining the security culture scores globally. At first glance, it seems like security culture is similar regardless of the size of the organization. In addition, the two valleys in the graph are appearing in the same place: in the Cognition and the Responsibility dimensions. Upon closer inspection, we see that large organizations report better attitudes and behaviors than smaller organizations. This may be related to the fact that many larger organizations are likely to be publicly traded, and thus regulated.

On the other hand, small organizations scored better on all other dimensions, something that is really visible on the Communication dimension, where the Large organizations scored five points less. Communication tends to be easier in smaller groups, and this is clearly demonstrated here.

### Security Culture in Africa
*Image Description: A bar graph showing the security culture score in Africa. The Y-axis is labeled "Score" and the X-axis is labeled "Africa". The title of the graph is "Security Culture".*
...
*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations in Africa. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size Africa".*
...
*Image Description: A bar graph showing the security culture score in Asia. The Y-axis is labeled "Score" and the X-axis is labeled "Asia". The title of the graph is "Security Culture".*
...
*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations in Asia. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size Asia".*
...
*Image Description: A bar graph showing the security culture score in Europe. The Y-axis is labeled "Score" and the X-axis is labeled "Europe". The title of the graph is "Security Culture".*
...
On the more favorable end of the spectrum, we find Sweden (77) and Ireland (78), both often being considered technologically advanced. Along with them, we also find that Italy (77) and Bulgaria (79) score higher. Even so, no countries in Europe report a Good score on the Security Culture Index. Considering the ongoing geopolitical situation, our recommendations are that countries in Europe take action to improve their security culture by assessing their employees and implementing training and education programs to ensure the right security behaviors.

*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations in Europe. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size Europe".*
...
*Image Description: A bar graph showing the security culture score in North America. The Y-axis is labeled "Score" and the X-axis is labeled "North America". The title of the graph is "Security Culture".*
...
*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations in North America. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size North America".*
...
*Image Description: A bar graph showing the security culture score in Canada. The Y-axis is labeled "Score" and the X-axis is labeled "Canada". The title of the graph is "Security Culture".*
...
*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations in Canada. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size Canada".*
...
*Image Description: A bar graph showing the security culture score in the United States of America. The Y-axis is labeled "Score" and the X-axis is labeled "United States of America". The title of the graph is "Security Culture".*
...
*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations in the United States of America. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size United States of America".*
...
*Image Description: A bar graph showing the security culture score in Oceania. The Y-axis is labeled "Score" and the X-axis is labeled "Oceania". The title of the graph is "Security Culture".*
...
*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations in Oceania. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size Oceania".*
...
*Image Description: A bar graph showing the security culture score in Central and South America. The Y-axis is labeled "Score" and the X-axis is labeled "Central and South America". The title of the graph is "Security Culture".*
...
Central American countries show a wide variation of security culture scores, with Mexico performing better than most. Sample sizes in many Central American countries are low, suggesting that most organizations do not have a minimum level of security measures in place. It is our strong recommendation that organizations in these regions implement adequate security culture measures, including training and assessments. Most of South America reflected low security culture scores, with the notable exception of Colombia (77). We observe that the continent as a whole is starting to measure security culture, with more countries being added every year. Still, the low sample rate across the continent suggests that there is a long way to go, and organizations need to ramp up their security game.

*Image Description: A line graph showing security culture scores across seven dimensions (Att, Beh, Cog, Com, Comp, Nor, Res) for Large, Medium, and Small organizations in Central and South America. The Y-axis is labeled "Score" and the X-axis is labeled "Att, Beh, Cog, Com, Comp, Nor, Res". The graph also includes a legend for "Organization size" showing Large (red line), Medium (green line), and Small (blue line). The title of the graph is "Security culture by organizational size Central and South America".*

**Figure 19:** Security culture in Central and South America as seen by organizational size.

Our sample size for Central and South America is 24 organizations and 2,913 employees. The most notable difference in Central and South America is how Large organizations have very large differences between Behaviors (85) and the other dimensions. Further, it is