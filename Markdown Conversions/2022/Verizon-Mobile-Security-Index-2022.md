...
words are verbatim from the opening of the FBI’s 2021 Internet Crime Report.¹
...
were over $6.9 billion.¹ Unsurprisingly, ransomware, business email compromise
...
surveyed have started working from home either full time or some of the time.²
...
![Figure 3. Factors that respondents said drove the increase in security spend that they have seen in the
preceding 12 months. [n=626]](Figure REMOG:)
...
passed a law giving workers the right to disconnect.⁵ Since then, Ireland, Italy
and Spain have enacted similar legislation. The province of Ontario is considering
enacting a similar law.

Resons for not being able to disconnect
...
The new Part V11.01 of the Act
imposes a requirement on
employers that employ 25 or more
employees to have a written policy
with respect to disconnecting
from work. The term “disconnecting
from work” is defined to mean
not engaging in work-related
communications, including emails,
telephone calls or the sending or
reviewing of other messages, so
as to be free from the performance
of work.

![Figure 7. Extract from Working for
Workers Act, 2021 in the Legislative
Assembly of Ontario.⁵](Figure 7.)
...
![Figure 6. Reasons why employees feel unable to “disconnect” from work.⁴](Figure FCOLS:)
...
those that were able to switch off.⁷

![Figure 8. Global Mental Health Index score by month.⁸](Figure JHSNI:)
...
![Figure 9. Reported incidents and losses, based on FBI data.¹⁰](Figure FFPLC:)
...
only 48% of enterprises (5,000 employees and above) agree.¹²
...
and compliance. Data from Absolute.¹³](Figure 13.)
