...
> Enterprise risk is coalescing around three critical areas: Endpoints and cloud workloads, Identity, Data
...
A
s we reflect upon 2021, two overarching themes come to the forefront: adaptability and perseverance. Businesses are finding paths forward with new technologies and solutions, adapting in the face of adversity and persevering in spite of uncertainty as we continue to navigate the challenges of living through a global pandemic. While these issues will ultimately lead to strength and innovation in organizations around the world, they will also create new risks and vulnerabilities that can be exploited.
...
| Type of Threat Activity | Description |
|---|---|
...
*Image Description: A line graph showing the quarterly growth in interactive intrusion campaigns by threat type from Q1 2020 to Q4 2021. The graph has four lines representing Unattributed, Targeted, Hacktivist and eCrime activity. The lines show a general upward trend, with eCrime activity being the most prominent.*
...
*Image Description: Two pie charts side by side. The left pie chart represents the distribution of threat types in 2020, and the right pie chart represents the distribution in 2021. Both charts show similar proportions, with eCrime being the largest segment, followed by Unattributed, Targeted, and Hacktivist.*

2020 vs. 2021

| 2021 | 2020 |
|---|---|
| 32% Unattributed | 34% Unattributed |
| 18% Targeted | 13% Targeted |
| 1% Hacktivist | 1% Hacktivist |
| 49% eCrime | 52% eCrime |
...
### Number of Ransomware-related Attacks Leading to Data Leaks, 2020 vs. 2021
*Image Description: A bar graph comparing the number of ransomware-related attacks leading to data leaks in 2020 and 2021. The 2021 bar is significantly taller than the 2020 bar, indicating a substantial increase in attacks.*
...
### Comparison of Data Leaks by Sector (Top 10), 2020 vs. 2021
*Image Description: A bar graph comparing the number of data leaks by sector in 2020 and 2021. The graph displays the top 10 sectors, with Industrials and Engineering, Manufacturing, Technology, and Professional Services being the most affected.*

Figure 3. Comparison of Data Leaks by Sector (Top 10), 2020 vs. 2021

| Sector | 2020 | 2021 |
|---|---|
| Industrials and Engineering | [Value] | [Value] |
| Manufacturing | [Value] | [Value] |
| Technology | [Value] | [Value] |
| Professional Services | [Value] | [Value] |
| Financial Services | [Value] | [Value] |
| Healthcare | [Value] | [Value] |
| Consumer Goods | [Value] | [Value] |
| Legal | [Value] | [Value] |
| Academic | [Value] | [Value] |
| Logistics | [Value] | [Value] |
...
*Image Description: An illustration depicting the lateral movement of the WIZARD SPIDER actor across four domain controllers.*
...
> China-nexus actors exploited 12 published vulnerabilities in 2021, compared to 2 published vulnerabilities in 2020.
...
*Image Description: A timeline diagram showing the progression of zero-day exploits deployed by China-nexus actors in 2021. The timeline indicates the dates when vulnerabilities were exploited, and the associated products affected.*
...
### Timeline of Log4Shell Events and Affiliated Actors
*Image Description: A timeline diagram showing the progression of Log4Shell events from November to December 2021. The timeline highlights key dates, such as the initial reporting of the vulnerability, the release of weaponized exploits, and the observation of various threat actors exploiting the vulnerability.*
...
PROPHET SPIDER used the Windows Command shell to launch their custom proxy tool