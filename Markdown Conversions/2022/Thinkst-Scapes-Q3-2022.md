...
![Footsteps in the sand by rock formations on the beach in Plettenberg Bay, South Africa](https://thinkst.com/ts)
...
- [Clever cryptography](#clever-cryptography)
  ...
  - [drand: publicly verifiable randomness explained](#drand-publicly-verifiable-randomness-explained)
  - [A dead man’s full-yet-responsible-disclosure system](#a-dead-mans-full-yet-responsible-disclosure-system)
  - [Oops... Code Execution and Content Spoofing: The First Comprehensive Analysis of OpenDocument Signatures](#oops-code-execution-and-content-spoofing-the-first-comprehensive-analysis-of-opendocument-signatures)
  - [My data in your signed code](#my-data-in-your-signed-code)
  - [Can You Trust a File’s Digital Signature? New Zloader Campaign exploits Microsoft’s Signature Verification](#can-you-trust-a-files-digital-signature-new-zloader-campaign-exploits-microsofts-signature-verification)
...
- [Nifty sundries](#nifty-sundries)
  ...
  - [Let's Dance in the Cache - Destabilizing Hash Table on Microsoft IIS](#lets-dance-in-the-cache---destabilizing-hash-table-on-microsoft-iis)
  - [Using Trātŗ to tame Adversarial Synchronization](#using-trātŗ-to-tame-adversarial-synchronization)
...
### TRENDS IN TS Q3’21
- **Into the embedded realm** – A trend of embedded or low-level research into impactful systems as skills honed on “junk hacking” were applied to critical systems.
...
![Photo by Ian Badenhorst on Unsplash](https://images.unsplash.com)
6 Q3 2022
...
![Photo by Juanita Swart on Unsplash](https://images.unsplash.com)
7 Q3 2022
...
![Figure 1: A flow-chart of the training and testing process for passively identifying an IoT device from its network traffic.](https://images.unsplash.com)
...
![Figure 2: A diagram of the high-level steps to identify the video an LTE device in the same cell is streaming.](https://images.unsplash.com)
...
![Figure 3: Views of the physical intrusion needed to gain access to the GPU’s EM emissions.](https://images.unsplash.com)
...
![Figure 4: A simplified figure of using timing information to passively locate an LTE handset.](https://images.unsplash.com)
...
![Figure 5: The high-level design goal of IRMA: allow for a user to have certain attributes attested by an issuer and then proven to a verifier – while allowing the user to protect their privacy by hiding unneeded attributes.](https://images.unsplash.com)
...
![Figure 6: A flow for how to share a collaborative document from one user to another while retaining the end-to-end encryption – preventing the server from gaining access to the document content.](https://images.unsplash.com)
...
![Figure 7: A simple diagram of the goal of encrypting data towards a clock tick in the future.](https://images.unsplash.com)
...
### ARTICLE 1
**Authors:** Simon Rohlmann, Christian Mainka, Vladislav Mladenov, and Jörg Schwenk  
**Oops... Code Execution and Content Spoofing: The First Comprehensive Analysis of OpenDocument Signatures**
...
![Figure 8: A high-level diagram of how some OpenDocument readers can be confused by documents signed with multiple certificates.](https://images.unsplash.com)
...
![Photo by Stephan Louis on Unsplash](https://images.unsplash.com)
17 Q3 2022
...
![Figure 9: A diagram showing how TLS-Anvil performs its testing on the target TLS library (Software Under Test (SUT)). Elements marked in green depict the contributions of this paper.](https://images.unsplash.com)
...
![Figure 10: A diagram of the steps Arbiter takes on binaries to test and vulnerability descriptions to identify vulnerabilities in real-world software.](https://images.unsplash.com)
...
![Figure 11: A high-level diagram of the experimental setup.](https://images.unsplash.com)
...
![Figure 12: A diagram showing how the improved SockFuzzer fits into the MacOS environment.](https://images.unsplash.com)
...
![Figure 13: An abbreviated table of the most popular Python packages that indirectly import a library that is built with --ffast-math.](https://images.unsplash.com)

22 Q3 2022

# Nifty sundries

- Attacking AAD abusing Synch API: The story behind $40K in bounties
...
- Using Trātŗ to tame Adversarial Synchronization
...
![Figure 14: The three accounts and their associated permissions that underpin the synchronisation between Azure AD and an on-premise AD directories.](https://images.unsplash.com)
...
![Figure 15: iCloud Private Relay Architecture.](https://images.unsplash.com)
...
![Figure 16: A diagram of where malware in the Docker Desktop container runs in a VM on MacOS. The container has access to the host MacOS file system.](https://images.unsplash.com)
...
### ARTICLE 2
**Authors:** Yuvraj Patel, Chenhao Ye, Akshat Sinha, Abigail Matthews, Andrea C. Arpaci-Dusseau, Remzi H. Arpaci-Dusseau, and Michael M. Swift  
**Using Trātŗ to tame Adversarial Synchronization**
...
![Figure 17: A graph of throughput for a mail server running on another container after the introduction of hash-collisions in the inode table.](https://images.unsplash.com)
...
![Photo by Wolfgang Hasselmann on Unsplash](https://images.unsplash.com)
28 Q3 2022

![Photo by Arthur Hickinbotham on Unsplash](https://images.unsplash.com)