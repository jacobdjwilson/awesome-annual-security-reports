...
- [Part 2: The Great Resignation](#part-2-the-great-resignation)
- [Part 3: Culture of Disconnect](#part-3-culture-of-disconnect)
- [Part 4: Budget & Programs](#part-4-budget--programs)
- [Part 5: Training](#part-5-training)
- [Part 6: Industry breakout](#part-6-industry-breakout)
- [Part 7: Company maturity breakout](#part-7-company-maturity-breakout)
- [Part 8: Conclusion](#part-8-conclusion)
- [Part 9: Methodology](#part-9-methodology)
...
- **71%** of business leaders, cybersecurity leaders and cybersecurity practitioners have cybersecurity concerns with levels of turnover.
- **98%** of business leaders, nearly three-fourths lack visibility over what and/or how much sensitive data departing employees take to other companies.
...
- **61%** say they have an Insider Risk Management program, while the average cybersecurity budget allocated to mitigating Insider Risk is **21%**.
- **96%** experience challenges when it comes to protecting corporate data from Insider Risks.
- **73%** report Insider Risk is a big problem within their companies.
- **91%** believe that their companies’ Board requires more understanding of Insider Risk.

Training must evolve to include education for employees on the right way to handle data.

- **55%** of respondents are concerned about employees becoming lax in their cybersecurity practices with a new hybrid work environment.
- **96%** almost all companies need to improve the data security training they provide employees, with around a third (**32%**) stating a complete overhaul is needed.

Public sector and financial services industries are leading the way in Insider Risk Management.

- **26% & 24%** are using around a quarter of their global cybersecurity budget to combat Insider Risk, on average (Public sector: 26%, Financial services: 24%).
- **84% & 76%** have the highest percentage of companies with IRM programs in place (Public sector: 84%, Financial services: 76%).
...
- **51%** are much more likely to make Insider Risk Management a top priority, compared to those who had a major merger, acquisition or divestiture occur in the last 12 months (**32%**) or who have one planned in the next 12 months (**26%**).
- **77%** of pre-IPO companies are most likely to have an IRM program.
- **85%** report Insider Risk is a Board-level priority for pre-IPO companies, with **82%** indicating Insider Risk is discussed at every Board meeting.
...
![Bar chart showing departing employee ranking second in the DBIR with 37%, behind Hacker at 45%, and ahead of Social engineering at 22%, User error at 22%, Malware at 17%, and User misuse at 8%](Figure_1_DBIR_Actions.png)

_Figure 1: What tactics are utilized? (Actions) Source: Verizon DBIR 2020_
...
- **98%** Nearly all respondents have cybersecurity concern(s) with their employees leaving their company during the Great Resignation.
- **71%** are concerned about lack of visibility over what and/or how much sensitive data departing employees take to other companies.
- **71%** are concerned about sensitive data saved on local machines/personal hard drives and/or personal cloud storage and services.

![Bar chart showing cybersecurity concerns regarding employees leaving the company across total and respondent types](Figure_2_Employee_Leaving_Concerns.png)

_Figure 2: In April 2021, a record 4 million people quit their jobs, starting what is called the “Great Resignation” period. What cybersecurity concerns do you have regarding employees leaving your company during the Great Resignation? [Base sizes in chart], split by respondent type, omitting some answer options_
...
![Bar chart showing companies' biggest cybersecurity concerns following the pandemic](Figure_3_Pandemic_Concerns.png)

_Figure 3: What are your company’s biggest cybersecurity concerns with a return to the office or a new hybrid workforce, as a result of the COVID-19 pandemic? [700] omitting some answer options_
...
- **58%** Nearly three in five cybersecurity practitioners report that cybersecurity leaders don’t communicate the company vision to the rest of the cybersecurity team.
- **57%** of practitioners report that they aren’t consulted about decisions that are made based on companies’ cybersecurity strategies.
...
- **21%** of current cybersecurity budgets go to Insider Risk Management, on average.
- **65%** believe Insider Risk Management budgets will increase this coming year.

Only **21%** of companies’ cybersecurity budgets are currently dedicated to mitigating Insider Risk, on average. In 2021[^1], **54%** of cybersecurity leaders spent less than **20%** of their budgets on Insider Risk. However, acceptance of the need to increase the budget is increasing, with **73%** of respondents stating that their companies’ budget for protecting against Insider Risk is insufficient, up from **66%** of cybersecurity leaders who cited this in last year’s report[^1]. There is positive momentum, however – companies are recognizing that Insider Risk is a pressing concern and the impacts need to be avoided. Nearly two-thirds (**65%**) believe they will be successful in securing a larger budget for Insider Risk Management in the coming year.
...
**61%** of companies surveyed have an IRM program.
...
However, while **61%** of companies say they have an Insider Risk Management program, **73%** of respondents report Insider Risk is still a big problem within their company. Surprisingly though, the majority (**63%**) of surveyed companies do not measure the success of Insider Risk detection.

This disconnect begs the question - have companies with an IRM program implemented one that is truly effective? Companies that have a program are likely to be more risk-aware because they invested in one in the first place, but these results suggest challenges persist. It could be that, for those companies, taking the first steps in implementing an IRM program has highlighted just how much data exposure exists within their company, crystalizing how much more work needs to be done. This is likely an important turning point for companies, to realize that an effective Insider Risk Management program balances and measures each element of people, process and technology.

- **98%** have fears regarding Insider Risk events in their company.
- **80%** report that reputation has/would be impacted because of an Insider Risk event involving loss or theft of sensitive information.
- **73%** report Insider Risk is a big problem within their company.
- **63%** of companies do not measure the success of Insider Risk detection.
...
![Bar chart showing current experienced issues with Insider Risk split by frequency of data security training](Figure_4_Training_Frequency.png)

_Figure 4: To what extent do you agree or disagree with the following statements? Strongly agree or somewhat agree [700] omitting some answer options, split by frequency of data security training_
...
- **96%** of companies need to improve their data security training.
- **32%** total figure state a complete overhaul is needed.
- **63%** public sector state a complete overhaul is needed.
...
**Average percentage of companies’ global cybersecurity budget dedicated to mitigating Insider Risk:**
- Total: **21%**
- Public sector: **26%**
- Financial services: **24%**
- IT, technology and telecoms: **22%**
- Retail, distribution and transport: **22%**
- Business and professional services: **21%**
- Energy, oil/gas and utilities: **21%**
- Healthcare (public or private): **21%**
- Manufacturing and production: **20%**
- Media, leisure and entertainment: **16%**
- Other commercial sector: **23%**

_Figure 5: What percentage of your company’s global cybersecurity budget is dedicated to mitigating Insider Risk? [700], showing average scores, split by industry_
...
- IT, technology and telecoms: **74%**
- Other commercial sector: **67%**
- Manufacturing and production: **56%**
- Energy, oil/gas and utilities: **54%**
- Healthcare (public or private): **53%**
- Business and professional services: **47%**
- Media, leisure and entertainment: **44%**

_Figure 6: Does your company have an Insider Risk Management program? [700], showing proportion who said “Yes” split by industry_
...
- IPO planned for the next 12-18 months
- Major Merger, Acquisition or Divestiture planned for the next 12 months
- Major Merger, Acquisition or Divestiture occurred in the last 12 months
- Major Restructuring (organizational change with potential layoffs) planned for the next 12 months
- Major Restructuring (organizational change with potential layoffs) occurred in the last 12 months
- Not aware of any major changes in the next 12 months
...
- **61%** Total Figure for IRM program
- **77%** Pre-IPO Companies with an IRM program
- **51%** Pre-IPO companies are much more likely to make IRM a top priority, compared to those who had a major merger, acquisition or divestiture occur in the last 12 months (**32%**)
- **85%** Insider Risk is a Board-level priority for pre-IPO companies

> “We had 90 to 120 days before going public to have a solution and a really tight story about our insider threat program,” says Mario Duarte, Snowflake’s VP of Security.
...
© 2022 Code42 Software, Inc. All rights reserved. Code42 and the Code42 logo are registered trademarks or trademarks of Code42 Software, Inc. in the United States and/or other countries. All other marks are properties of their respective owners.

---

[^1]: Figures were lifted from the 2021 DER. Please see methodology for more information.
