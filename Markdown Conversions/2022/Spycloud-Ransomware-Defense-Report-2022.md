...
- [Section 1 | Losing Ground to Ransomware](#section-1--losing-ground-to-ransomware)
  - [A Bleak Picture](#a-bleak-picture)
  ...
  - [Losing Confidence in Prevention and Defense](#losing-confidence-in-prevention-and-defense)
- [Section 2 | Visibility Gaps and Ineffective Countermeasures Creating Greater Risk](#section-2--visibility-gaps-and-ineffective-countermeasures-creating-greater-risk)
  - [Are Countermeasures Truly Working?](#are-countermeasures-truly-working)
  - [The Riskiest Entry Points](#the-riskiest-entry-points)
  - [The Growing Concern Over Credential-Stealing Malware](#the-growing-concern-over-credential-stealing-malware)
- [Section 3 | Overcoming Barriers and Improving Preparedness](#section-3--overcoming-barriers-and-improving-preparedness)
  - [People: The Top Barrier to Effective Defenses](#people-the-top-barrier-to-effective-defenses)
  - [Common Defenses](#common-defenses)
  - [Changes in Password and Authentication Practices](#changes-in-password-and-authentication-practices)
  - [Future Plans to Improve Defense](#future-plans-to-improve-defense)
  - [Remote Work Loses Importance](#remote-work-loses-importance)
  - [Upgrades and Additions to the Security Stack](#upgrades-and-additions-to-the-security-stack)
...
![Survey participants by IT security role](https://example.com/figure1.png)
...
![Survey participants by size of organization](https://example.com/figure2.png)
...
![Past Frequency of Ransomware Incidents (YOY)](https://example.com/figure3.png)
...
![Affected At Least Once (By Organization Size)](https://example.com/figure4.png)
...
![Response and Outcome of Ransomware Attacks](https://example.com/figure5.png)
...
![Greatest Impacts of Ransomware Attacks to Your Organization](https://example.com/figure6.png)
...
![Security Technologies Planned for Ransomware Mitigation](https://example.com/figure7.png)
...
![Most Important Countermeasures for Mitigating Ransomware Attacks](https://example.com/figure8.png)
...
![Preparations for Ransomware Incidents](https://example.com/figure9.png)
...
![Riskiest Points of Entry for Ransomware](https://example.com/figure10.png)
...
![Concerned About Credential-Stealing Malware?](https://example.com/figure11.png)
...
![Obstacles to Establishing Effective Ransomware Defenses](https://example.com/figure12.png)
...
![Top Security Solutions in Place](https://example.com/figure13.png)
...
![Password and Authentication Practices](https://example.com/figure14.png)
...
![Greatest Impact to Cybersecurity Plans](https://example.com/figure15.png)
...
![Post-Infection Remediation Workflow](https://example.com/figure16.png)
...
SpyCloud transforms recaptured darknet data to protect businesses from cyberattacks. Its products operationalize Cybercrime Analytics Enterprise Protection (C2A) to produce actionable insights that allow enterprises to proactively prevent ransomware and account takeover, protect their business from consumer fraud losses, and investigate cybercrime incidents. Its unique data from breaches, malware-infected devices, and other underground sources also powers many popular dark web monitoring and identity theft protection offerings. SpyCloud customers include half of the ten largest global enterprises, mid-size companies, and government agencies around the world. Headquartered in Austin, TX, SpyCloud is home to nearly 200 cybersecurity experts whose mission is to make the internet a safer place.

- **Enterprise Protection**
  Prevent account takeover that can lead to ransomware.
  [Learn More](https://spycloud.com/enterprise-protection)
- **Consumer Protection**
  Combat account takeover and online fraud.
  [Learn More](https://spycloud.com/consumer-protection)
- **Investigations**
  Unmask criminals attempting to harm your business.
  [Learn More](https://spycloud.com/investigations)
- **Data Partnerships**
  Enhance your solution with SpyCloud’s data.
  [Learn More](https://spycloud.com/data-partnerships)
