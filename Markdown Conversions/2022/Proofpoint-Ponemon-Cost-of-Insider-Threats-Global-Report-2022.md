...
- **278**: Total number of benchmarked
  organizations
- **56%**: Incidents relating
  to negligence
- **$6.6M**: Annualized cost
  for negligence
- **6,803**: Total number of
  insider incidents
- **26%**: Incidents relating
  to criminal insider
- **$4.1M**: Annualized cost
  for criminal insider
- **$15.4M**: Total average
  annual cost
- **18%**: Incidents relating
  to user credential theft
- **$4.6M**: Annualized cost
...
cost per incident.
The annual cost of incidents varies according
to organizational size. Large organizations with a
...
Vulnerable IoT devices are of greatest risk to data loss. Sixty-three percent of respondents say they
are worried about unmanaged IoT devices resulting in the loss of sensitive data. This is followed by the cloud
...
1. Employees are not trained to fully understand and apply laws,
   mandates, or regulatory requirements related to their work
   and that affects the organization’s security.
2. Employees are unaware of the steps they should take at all times
   to ensure that the devices they use—both company issued
   and BYOD—are secured at all times.
3. Employees are sending highly confidential data to an unsecured
   location in the cloud, exposing the organization to risk.
4. Employees break your organization’s security policies
   to simplify tasks.
5. Employees expose your organization to risk if they do not keep devices
...
1. Working sessions to establish areas of inquiry
2. Recruitment of benchmark companies
3. Development of an activity-based costing
   framework
4. Administration of research program
5. Analysis of all results with appropriate reliability
   checks
6. Preparation of a report that summarizes all
...
![Figure 1: Industry sectors of participating organizations](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig1.png)
*n = 278 companies*
...
![Figure 2: Headcount (size) for participating organizations](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig2.png)
*n = 278 companies*
...
![Figure 3: Interviewees by position level or function](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig3.png)
*n = 1,004 respondents*
...
![Figure 4: Regional distribution of global organizations](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig4.png)
*n = 278 companies*
...
- Employee or
  contractor negligence **3,807**
- Criminal or
  malicious insider **1,749**
- Credential thief
  (imposter risk) **1,247**
...
| Profile                        | Average FY 2022 | Average FY 2020 | Average FY 2018 | Average FY 2016 |
| :----------------------------- | :-------------- | :-------------- | :-------------- | :-------------- |
| Credential thief (imposter risk) | 5.7             | 3.2             | 2.7             | 1.0             |
| Criminal and malicious insider | 6.4             | 5.4             | 4.6             | 3.0             |
| Employee or contractor negligence | 13.7            | 14.5            | 13.2            | 10.5            |
...
![Figure 7: Frequency of insider-related incidents per company](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig7.png)
...
| Region                | Employee or contractor negligence | Criminal or malicious insider | Credential thief (imposter risk) |
| :-------------------- | :-------------------------------- | :---------------------------- | :------------------------------- |
| North America         | 4.0                               | 6.5                           | 5.5                              |
| Europe                | 4.2                               | 6.1                           | 5.2                              |
| Middle East & Africa  | 4.0                               | 7.3                           | 15.0                             |
| Asia-Pacific          | 15.4                              | 12.3                          | 12.0                             |
...
![Figure 9: Scattergram of insider-related incidents by company](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig9.png)
*n = 278 companies*
...
- Less than 31 days **12%**
- 31 to 61 days **29%**
- 61 to 91 days **25%**
- More than 91 days **34%**
...
cost categories. The two largest cost categories are the impact of business disruption
due to diminished employee/user productivity (23 percent of total cost) and technology, which
...
![Figure 11: Percentage of insider cost by consequence to business organization](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig11.png)
...
![Figure 12: Insider incidents in ascending order by headcount (size)](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig12.png)
...
| FY 2020 CASE PROFILES          | AVERAGE COST PER INCIDENT | MEAN NUMBER OF INCIDENTS PER YEAR | AVERAGE ANNUALIZED COST |
| :----------------------------- | :-------------------------- | :-------------------------------- | :---------------------- |
...
| FY 2022 CASE PROFILES          | AVERAGE COST PER INCIDENT | MEAN NUMBER OF INCIDENTS PER YEAR | AVERAGE ANNUALIZED COST |
| :----------------------------- | :-------------------------- | :-------------------------------- | :---------------------- |
...
![Figure 13: Percentage net increase in average annual cost from FY 2016 to FY 2022](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig13.png)
...
| ACTIVITY COST CENTERS       | EMPLOYEE OR CONTRACTOR NEGLIGENCE | CRIMINAL & MALICIOUS INSIDER | CREDENTIAL THIEF (IMPOSTER RISK) | AVERAGE COST |
| :-------------------------- | :-------------------------------- | :--------------------------- | :------------------------------- | :----------- |
...
![Figure 14: 2022 average activity cost per incident for the three types of incidents](https://www.proofpoint.com/sites/default/files/2022-09/cost-of-insider-threats-2022-fig14.png)
