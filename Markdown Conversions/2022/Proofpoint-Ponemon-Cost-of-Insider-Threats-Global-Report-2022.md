...
04
Employees break your organization’s security policies
to simplify tasks.

05
Employees expose your organization to risk if they do not keep devices
...
*A scatter plot is shown with the x-axis labeled "Ascending order of companies by cost analysis" and the y-axis labeled "Total incidents by company". The plot shows a distribution of points, with a concentration of points below the 15.4 million mark, and a few outliers with higher incident counts and costs.*
...
*A line graph is shown with the x-axis labeled "Ascending headcount (size) of 278 companies" and the y-axis labeled "Total incidents by company size (headcount)". The plot shows an upward trend, indicating a positive correlation between headcount and the number of incidents.*
...
*A bar chart is shown, with the x-axis showing the activity cost centers: Monitoring & surveillance, Investigation, Escalation, Incident response, Containment, Ex-post analysis, Remediation. The y-axis shows the percentage increase from FY 2016 to FY 2022. The bars show the following percentage increases: 114%, 102%, 113%, 58%, 50%, 103%, 26%.*
...
*A bar chart is shown with the x-axis showing the three types of incidents: Employee or contractor, Criminal & malicious insider, Credential thief (imposter risk). The y-axis shows the average cost per incident. The bars show the following costs: $484,931, $648,062, $804,997.*
...
*A bar chart is shown with the x-axis showing the four regions: North America, Middle East & Africa, Europe, Asia-Pacific. The y-axis shows the average cost in millions. The bars show the following costs: 17.53, 14.2