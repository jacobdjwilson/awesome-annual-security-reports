...
![Figure 1: How much interest and importance do executives place on security resilience?](Image description: A bar chart showing the high importance executives place on security resilience.)

![Figure 2: Has your organization experienced a security incident that impacted resilience?](Image description: A pie chart indicating the percentage of organizations that have experienced a security incident impacting resilience.)
...
![Figure 3: Types of security incidents that impacted resilience](Image description: A bar chart detailing the types of security incidents that have impacted organizational resilience.)
...
![Figure 4: Types of resilience impacts caused by security incidents](Image description: A bar chart illustrating the various types of resilience impacts caused by security incidents.)
...
![Figure 5: Most important security resilience outcomes as selected by participants](Image description: A bar chart showing the most important security resilience outcomes as ranked by participants.)
...
![Figure 6: Ranking of perceived importance of security resilience outcomes for organizations with no prior incidents versus with prior incidents.](Image description: A comparison chart showing the ranking of security resilience outcomes for organizations with and without prior incidents.)
...
![Figure 7: Ranking of perceived importance of security resilience outcomes by work role](Image description: A chart comparing the perceived importance of security resilience outcomes across different work roles.)
...
![Figure 8: Confidence in ability to remain resilient through a worst-case cyber event](Image description: A bar chart showing the confidence levels of organizations in their ability to remain resilient through a worst-case cyber event.)
...
![Figure 9: Proportion of organizations struggling with security resilience outcomes](Image description: A bar chart showing the proportion of organizations struggling with various security resilience outcomes.)
...
We find this view particularly interesting because it gives the sense that
areas of struggle change as organizations grow. For instance, mitigating financial
...
![Figure 10: Most challenging security resilience outcomes ranked by organization size](Image description: A chart ranking the most challenging security resilience outcomes by organization size.)
...
![Figure 11: Distribution of security resilience scores across participants](Image description: A histogram showing the distribution of security resilience scores among participants.)
...
![Figure 12: Effect of adherence to seven success factors on overall security resilience score](Image description: A chart illustrating the significant positive impact of adhering to the seven success factors on overall security resilience scores.)
...
![Figure 13: Effect of executive support on security resilience](Image description: A chart demonstrating the positive correlation between executive support and security resilience.)
...
![Figure 14: Effect of cloud adoption and ease of management on security resilience](Image description: A chart illustrating the impact of cloud adoption and management simplicity on security resilience.)
...
![Figure 15: Effect of zero trust implementation milestones on security resilience](Image description: A chart showing the progressive benefits of zero trust implementation milestones on security resilience.)
...
improvements to security resilience as detection and response