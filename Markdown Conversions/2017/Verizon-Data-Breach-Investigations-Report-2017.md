...
Privilege Misuse, Miscellaneous Errors, and Everything Else represent 76% of all data breaches within Healthcare
Top 3 patterns
Threat actors 56% External, 44% Internal, <1% Partner (breaches)
Actor motives 95% Financial, 5% Grudge/Other (breaches)
Data compromised 88% Medical, 32% Personal, 14% Credentials
Healthcare remains a prime target for internal actors, both malicious and accidental. Ransomware
Summary
and other forms of malware are also common.
A prescription for caution
Healthcare organizations continue to be a unique challenge for information security professionals. Unlike many other industries where payment cards or intellectual property are the primary targets, healthcare is dominated by the compromise of medical and personal records. 

As shown in Figure 20, Privilege Misuse and Miscellaneous Errors continue to be major drivers of breaches in this sector. Insiders play a significantly larger role here than in industries like Accommodation or Retail.

![Healthcare Breach Patterns Chart]

### The Insider Threat
Employees in healthcare—doctors, nurses, administrative staff—have legitimate access to sensitive patient records. Unfortunately, this access is sometimes abused. Whether it’s looking up the medical records of a celebrity, snooping on a neighbor, or stealing patient data to commit medical identity theft, internal actors account for nearly half of all breaches in this industry.

### Ransomware's Grip on Hospitals
While insiders cause many breaches, external actors are far from idle. Ransomware has found a very comfortable home in the healthcare sector. Hospitals and clinics operate under immense pressure where availability of systems is a matter of life and death. Threat actors understand this urgency, making healthcare organizations prime targets for extortion via ransomware.

Things to consider:
- **Need-to-Know Access**: Limit employee access to patient records strictly to what is required for their specific role.
- **Audit Trails**: Regularly review access logs to spot unauthorized snooping early.
- **Employee Training**: Train staff on the risks of phishing and social engineering, which often serve as the initial entry point for ransomware.

---

Information
Frequency 717 incidents, 113 with confirmed data disclosure
Web Application Attacks, Privilege Misuse, and Miscellaneous Errors represent 78% of all data breaches within Information
Top 3 patterns
Threat actors 64% External, 36% Internal (breaches)
Actor motives 53% Espionage, 44% Financial (breaches)
Data compromised 84% Credentials, 45% Personal, 12% Secrets
The Information industry—including software publishers, web portals, and data processors—faces heavy
Summary
threats from both espionage and high-volume credential theft.

Information, please
The Information sector covers a broad range of organizations, from telecommunications and broadcasting to web portals and software developers. Because these organizations often hold massive amounts of user data, credentials, and intellectual property, they are a frequent target for both financially motivated criminals and state-sponsored espionage actors.

### Mega-Breaches and Credentials
As noted earlier in the report, the Information industry accounts for some of the largest record losses due to breaches of web portals and online services. When millions of user accounts are compromised at once, the resulting haul of usernames, email addresses, and passwords feeds the broader ecosystem of credential stuffing attacks across the internet.

Things to consider:
- **Harden Web Applications**: Utilize robust secure coding practices and perform regular vulnerability assessments.
- **Protect Credentials**: Implement multi-factor authentication (MFA) across all external-facing portals and internal systems.

---

Manufacturing
Frequency 620 incidents, 124 with confirmed data disclosure
Crimeware, Cyber-Espionage, and Miscellaneous Errors represent 77% of all data breaches within Manufacturing
Top 3 patterns
Threat actors 72% External, 28% Internal (breaches)
Actor motives 62% Espionage, 35% Financial (breaches)
Data compromised 48% Secrets, 31% Internal, 22% Personal
Manufacturing organizations are prime targets for intellectual property theft through cyber-espionage,
Summary
alongside crimeware like ransomware and spyware.

Building blueprints for theft
Manufacturing is the backbone of physical creation, but its digital footprint is increasingly under siege. Unlike retail or accommodation, where the prize is payment cards, the crown jewels in manufacturing are blueprints, proprietary formulas, research data, and trade secrets.

### Espionage in the Factory
State-affiliated actors and competitors frequently target manufacturing firms to steal intellectual property. These attacks often begin with targeted phishing emails containing malicious attachments designed to install backdoors and allow long-term, stealthy access to corporate networks.

Things to consider:
- **Segment Networks**: Separate operational technology (OT) from information technology (IT) networks to prevent a corporate network breach from reaching factory floors.
- **Email Filtering**: Enhance email security gateways to block malicious attachments and links.

---

Public Administration
Frequency 21,239 incidents, 442 with confirmed data disclosure
Privilege Misuse, Miscellaneous Errors, and Physical Theft and Loss represent 81% of all data breaches within Public Administration
Top 3 patterns
Threat actors 52% External, 48% Internal (breaches)
Actor motives 51% Financial, 42% Espionage, 7% Grudge (breaches)
Data compromised 73% Personal, 18% Credentials, 9% Medical
Government entities handle massive amounts of citizen data, making them frequent targets for both
Summary
accidental disclosures and malicious attacks.

A public service
Public administration—encompassing local, state, and federal government agencies—features prominently in our dataset due to high reporting transparency and active Computer Security Incident Response Teams (CSIRTs). 

Government agencies deal with vast repositories of personally identifiable information (PII), tax records, and civil documents. Consequently, miscellaneous errors (such as misaddressed emails or misconfigured databases) and physical loss of assets (like laptops or backup drives) play a substantial role in public sector data breaches.

Things to consider:
- **Encryption Everywhere**: Ensure all portable devices and sensitive data stores are fully encrypted.
- **Data Handling Policies**: Implement strict controls and training around the handling and transfer of citizen data.

---

Retail
Frequency 326 incidents, 93 with confirmed data disclosure
Point of Sale Intrusions, Web Application Attacks, and Crimeware represent 85% of all data breaches within Retail
Top 3 patterns
Threat actors 98% External, 2% Internal (breaches)
Actor motives 99% Financial, 1% Other (breaches)
Data compromised 89% Payment, 11% Personal, 2% Credentials
Retail remains heavily targeted by point-of-sale malware and card skimmers designed to harvest payment
Summary
card data.

Shopping for data
Retailers continue to be a primary target for financially motivated cybercriminals looking for payment card data. While point-of-sale (POS) intrusions remain a dominant threat, web application attacks targeting e-commerce platforms have also grown in frequency.

### The POS Battleground
Attackers routinely target POS terminals using RAM scrapers and malware installed via compromised third-party vendor credentials or weak remote access controls. 

Things to consider:
- **Vendor Risk Management**: Strictly monitor and restrict third-party vendor access to your internal network and POS systems.
- **Monitor Outbound Traffic**: Watch for anomalous outbound traffic that could indicate command-and-control (C2) communication or data exfiltration.

---

Attack the Humans!
Phishing is the most common social attack vector. Across datasets, roughly 7% to 14% of users tested will click on malicious links or attachments in phishing simulations.

The human element remains one of the most persistent vulnerabilities in information security. Despite decades of awareness training, attackers continue to successfully manipulate users through phishing, pretexting, and social engineering. 

### The Anatomy of Phishing
Phishing campaigns range from broad, untargeted spam to highly sophisticated spear-phishing emails tailored to specific individuals. Attackers use these methods primarily to deliver malware or harvest credentials. 

---

Ransomware is the Most Profitable Form of Writing
Ransomware has exploded in popularity among cybercriminals. By encrypting victim files and demanding payment (typically in cryptocurrency) for the decryption key, attackers have found a highly lucrative and straightforward business model.

- **Low Barrier to Entry**: Ransomware-as-a-Service (RaaS) allows even low-skill criminals to launch devastating attacks.
- **Immediate Impact**: Organizations face crippling downtime, forcing many to pay the ransom to restore operations.

---

Wrap Up
As we close out the 10th edition of the Data Breach Investigations Report, the landscape of cybercrime remains dynamic, complex, and relentless. While the tools and tactics of adversaries continue to evolve—from sophisticated malware and POS intrusions to ransomware and social engineering—the fundamental principles of defense remain constant.

Know your assets, understand your adversaries, secure your perimeter, and empower your people. 

---

## Appendix A: Countering an Evolving Transnational Cybercrime Threat
Organized criminal groups operate across international borders, leveraging sophisticated infrastructure, money-laundering networks, and specialized roles to maximize profit. Combating these transnational threats requires unprecedented cooperation between private industry, international law enforcement agencies, and governments.

---

## Appendix B: The Patch Process Leftovers
Vulnerability management is a cornerstone of information security, yet patching cycles often leave gaps. Our analysis of vulnerability-scanning data reveals that while organizations make an initial push to patch vulnerabilities, a significant portion of findings—the "leftovers"—linger in environments long past recommended deadlines. Prioritize patching based on active threat intelligence rather than raw vulnerability counts alone.

---

## Appendix C: Year in Review
2016 was a watershed year for cybersecurity. From massive DDoS botnets powered by Internet of Things (IoT) devices to high-profile political hacks and ransomware outbreaks, organizations faced unprecedented challenges. The lessons learned in 2016 underscore the need for resilience, agility, and continuous monitoring.

---

## Appendix D: Methodology
The findings in this report are based on the VERIS (Vocabulary for Event Recording and Incident Sharing) framework. Our dataset comprises contributions from dozens of global security organizations, law enforcement agencies, and enterprise contributors. We strive to minimize bias by analyzing actual incident data rather than relying solely on subjective surveys.

---

## Appendix E: Contributing Organizations
We extend our deepest gratitude to the organizations, data contributors, researchers, and partners who made the 10th edition of the Data Breach Investigations Report possible. Your willingness to share data and insights directly contributes to the global elevation of information security readiness.

[^1]: http://www.verizonenterprise.com/verizon-insights-lab/data-breach-digest/2017/

---

scellaneous Errors and Physical Theft and Loss
Top 3 patterns
...
landfills, and employees giving J. Tinker’s discharge papers Disposal error 17
to J. Evers (and Evers’ to Chance) all help Miscellaneous
Errors remain a top 3 pattern again this year. The breach
counts in Figure 21 show that misdelivery, disposal errors Loss 14
and lost assets combine for almost 30% of all Healthcare
breaches—showing that it isn’t just malicious insiders that Publishing error 9
...
Things to consider
Achtung, baby—Pay attention to what you are doing. See a doctor and get rid of it—As misuse is so common,
...
to avoid publishing errors. Have a policy in place for make it clear that monitoring is taking place and it isn’t
...
of lost or stolen devices. Token of my appreciation—Where feasible, tokenize
sensitive information (such as social security number)
I love it when a backup plan comes together—Although when it is only used to identify a record and the employee
not discussed in detail in this section, ransomware is doesn’t need it for billing purposes or patient care.
...
sehcaerB
sdnoceS setuniM sruoH syaD skeeW shtnoM sraeY
...
gravitate toward hacking—specifically Denial of Service (71% unique issues within the organizations in this industry that
...
users to install C2 and keylogging software in order to got it. Another commonality is the organization size—over
...
Spyware/keylogger
31
(Malware) operating on outdated WordPress,” you say? Fair enough.
...
Programming error
1 reused to unlock the door to member or customer
(Error)
information. If feasible, extend the use of strong
Breaches authentication to your user base.
Figure 23: Top threat action breach varieties within Information Don’t be denied—Develop a DDoS response plan
...
Broadcasting and Web Search Portals). This is a catch-all returning to work—A drum that has been beaten
...
(sometimes encrypted, sometimes not), and email addresses. made available, isn’t mind blowing. But the results of
...
Physical Theft
1
or at least cheaper. A great way to make something cheaper and Loss
...
Personal 5 elsewhere—but wants to take as much data as possible with
them.
Internal 5
Credentials 2
Source code 1
...
(n=122) Keep ’em separated—If you have highly-sensitive
For a manufacturer, the intellectual property it possesses information, keep that data segregated and only allow
is of the utmost importance—whether it is a secret recipe, access to those who require it to perform their job.
...
sit and slowly siphon off the nectar for as long as they can. Just look at yourself—Internal monitoring of networks,
...
backdoor or C2, and the bad guys return at their leisure to No parting gifts—Implement data loss prevention (DLP)
...
tend to give us particular types of data, and this is probably effective but unauthorized workarounds, but you don’t pay
nowhere more marked than in the public sector. The us to speculate so we won’t. Also, there were a great number
...
within Retail. We will keep an eye on this as we don’t have an details of your provider agreement in the event of
enlightening explanation for it. an attack.
No man is an island—But perhaps your assets should
Payment Card
39 be. Keep critical assets on separate network circuits.
Skimmers
...
Eagerness. Distraction. Curiosity. Uncertainty. All of these First, let’s take a step back and examine the picture as a
are drivers of human behavior, and one or more can be whole. There were a little over 1,600 incidents and more
leveraged to influence someone to disclose information, than 800 breaches featuring social actions in this year’s
...
of both incidents and breaches that involved a social action. data, repurposing of assets and so on. In last year’s report,
...
non-incident data acquired from security awareness training of the foothold. It also holds true this year—95% of phishing
...
known). But since you’ve read the industry sections already,  The main focus of this report has, and always will be, the
...
2017 Data Breach Investigations Report
Clicks
7.3% of users across multiple data contributors were This year’s data features numerous incidents involving
successfully phished—whether via a link or an opened the impersonation of an executive to trick someone to
...
phished—and how many were phished repeatedly—let’s see Areas of focus
...
You’re never going to completely stop phishing emails getting someone will always click. Focus on detection and reporting
through and being clicked, but if you have a good process of clicks rather than just prevention. Implement and test a
for detecting and handling them, they’re less likely to impact phishing response plan that:
...
creating a scenario, or pretext, to influence your target. Yes, messages purporting to be coming from a big wig. That’s
it’s a bit like dating in high school only more cyber-y. The real not enough though, as some BEC involves hacked email
...
incidents increased to 228 in this year’s report from 159 in samples in Q3 2016, and a drastic 70% drop in Q4. This big
...
encryption—the standard practice of ransomware authors— systems toward targeting vulnerable organizations. Overall,
...
Office recent files. Mid-year, we witnessed a sudden shift in specific job functions, such as HR and accounting—whose
exploit kits used for ransomware from Angler to Neutrino, employees are most likely to open attachments or click on
followed by another shift in September from Neutrino to links—or even specific individuals.
...
Security software nomoreransom.org
...
obfuscated ransomware, behavioral analysis to prevent The group’s goal is to share information, educate users and
...
prevention rates, the volume of ransomware variants and To that end, nomoreransom.org currently hosts 27
...
| Web AWppeb App |     |     | DenialD oefnial of |     |     |
| -------------- | --- | --- | ------------------ | --- | --- |
571 571 11,24611,246
| AttackAsttacks     |     |         | ServicSeervice     |     |            |
| ------------------ | --- | ------- | ------------------ | --- | ---------- |
| CyberC-yber-       |     |         | PrivilePgerivilege |     |            |
|                    |     | 289 289 |                    |     | 7,7437,743 |
| EspionEasgpeionage |     |         | MisusMeisuse       |     |            |
PrivilePgerivilege
|     |     | 277 277 | CrimeCwraimreeware |     | 6,9256,925 |
| --- | --- | ------- | ------------------ | --- | ---------- |
MisusMeisuse
| MisceMllainsceeolulasneous |     |         | Web AWppeb App |     |            |
| -------------------------- | --- | ------- | -------------- | --- | ---------- |
|                            |     | 222 222 |                |     | 6,5026,502 |
| ErrorsErrors               |     |         | AttackAsttacks |     |            |
PhysicPahl yTshiceaftl Theft
| Point oPfo Sinat leof Sale | 207 | 207 |     |     | 5,6985,698 |
| -------------------------- | --- | --- | --- | --- | ---------- |
and Loasnsd Loss
EverytEhvinegrything 184 184 MisceMllainsceeolulasneous 2,4782,478
| Else Else                    |                  |     | ErrorsErrors                  |                    |     |
| ---------------------------- | ---------------- | --- | ----------------------------- | ------------------ | --- |
| PaymePnaty Cmaerndt Card     | 89 89            |     | EverytEhvinegrything          | 870 870            |     |
| SkimmSekrismmers             |                  |     | Else                          | Else               |     |
| PhysicPahl yTshiceaftl Theft |                  |     | CyberC-yber-                  |                    |     |
|                              | 74 74            |     |                               | 328 328            |     |
| and Loasnsd Loss             |                  |     | EspionEasgpeionage            |                    |     |
| CrimeCwraimreeware47         | 47               |     | Point oPfo Sinat leof Sa2le12 | 212                |     |
| DenialD oefnial of           |                  |     | PaymePnaty Cmaerndt Card      |                    |     |
| 5                            | 5                |     |                               | 118 118            |     |
| ServicSeervice               |                  |     | SkimmSekrismmers              |                    |     |
|                              | BreacBhreesaches |     |                               | IncideInnctsidents |     |
...
when over 90% of confirmed breaches fell into one of  danger will arise—you are less likely to be bitten by a snake
...
were to rank this year’s set of breaches without that botnet,  course, this report can only inform the reader of the trends
...
that can infect your system and then be used to encrypt your non-incident data (malware detonations—a sample of 50
data until you pay the “ransom” the criminal demands to give million on-the-wire detections), over 99% of malware is sent
you the data back. If you are an unscrupulous villain it is a by either email or web server. This means it’s coming through
...
2017 Data Breach Investigations Report
Phishing
Manufacturing and Public Administration lead the pack of 181
(Social)
targeted industries yet again, and Professional Services
Use of backdoor/C2
take the bronze for the second straight year. The interesting 138
(Hacking)
change is the rise of academia as a target of these
C2
attacks. Colleges are centers of innovation and are building (Malware) 136
technologies that would certainly be targeted by state-
Backdoor
affiliated groups. The chemical laser prototype designed by (Malware) 118
...
Capture stored data
62
with higher levels of pre-attack research, sophistication, (Malware)
patience and targeting will not be documented at the rate Export data
60
of opportunistic attacks. Even if your industry is not well (Malware)
represented in the statistics in Figure 38, if you have —or Downloader
53
may be perceived to have—useful information, then you are a (Malware)
...
llllll
|     |     |     |                                                                                                             |                                                                                                                                                          |                                                                                                    |                                                                                                               | llllllllllllllllllllllllllllllllllllllllllllllll llllllllllllll llllllllllllllllllllllll | llllllllllllllllllllllllll llllll                     |
| --- | --- | --- | ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ----------------------------------------------------- |
|     |     |     |                                                                                                             |                                                                                                                                                          | llllllllllllllllll llllllllllll                                                                    | llllllllllllllllll ll                                                                                         | llllllllll ll ll ll llllllllll lllllllllllllllll lll llllllllllll                        | ll                                                    |
|     |     |     |                                                                                                             | ll llllll                                                                                                                                                | ll llllllllllllllllllllllllllllllllllllll llllllllllllllllllllllllllllllllllllllllllllllllllllllll | llllllllllllllllllllllll llll llllll llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll | llllllllll llllllllllllllll llllllllll llllllllllll ll ll llll                           | ll llllllllllllllllllllllllllllll llllll llllllllllll |
|     |     |     |                                                                                                             | llllllllllllllllll                                                                                                                                       |                                                                                                    | ll llll llll llllllllllllllllllllllllllllllllllllllllllllllll                                                 |                                                                                          |                                                       |
|     |     |     |                                                                                                             | llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll ll llllll | ll ll                                                                                              |                                                                                                               |                                                                                          |                                                       |
|     |     |     | llllllllllllllllllllllllllllllllllllllll llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll |                                                                                                                                                          |                                                                                                    |                                                                                                               |                                                                                          |                                                       |
llll
|     |     | llllllllllllllllllllllllllllll                                                                                                                      | llllllllllllllllllllllllllllll |                                                                                                                                                                                                | llllllllllllll |     |     |     |
| --- | --- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | --- | --- | --- |
|     |     | llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll                            |                                | llllllll ll llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll |                |     |     |     |
|     |     | llllllll ll                                                                                                                                         | llll llll                      |                                                                                                                                                                                                |                |     |     |     |
|     |     | llllllllllllllllllllllllllllllllllllllllllll l l llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll | l l llll ll                    | ll                                                                                                                                                                                             |                |     |     |     |
|     |     | ll l l l l                                                                                                                                          | ll ll                          |                                                                                                                                                                                                | llllll         |     |     |     |
|     |     | l l l l                                                                                                                                             | ll ll                          |                                                                                                                                                                                                |                |     |     |     |
llll
|     |     | l l |     |     |     | llllllllllllllllllllllllllllllll |     |  |
| --- | --- | --- | --- | --- | --- | -------------------------------- | --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
l ll l l ll l
llll llllll llllll llllll l l
|     |     | ll llll llll ll llllllllllll |     |     |     |     |     |  |
| --- | --- | ---------------------------- | --- | --- | --- | --- | --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
ecruoS 2C lllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll ll llllllllllllllllllllllllll lll ll llll ll llll llllllllllllll ll ll llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll llllllllllllllllllllllllllllllllllllll ll llllllllllllll llllllllllllllllllllllllllllllllllllllllllllllllllllll ll llllllllllllllllllllllllllllllllllllllll llllllllllllllllllll llllll llll ll llllllllllllllllllllll llllllll llllllllllllllllllllllllllllllllllllllllllllllll llllllllllllllllllllllllllllll llllllllllllllllllllll ll llllllllllllllllllllllllllllllllllllllllllllllll
|                                           | ll llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll lllll llllllll ll llllll ll lllllll ll lllllllllllllllllllllllllllllllllllllllllllllllllllll l l l l llll llllllllll ll                                                                              | ll ll ll |     |      |     |     |     |     |
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | --- | ---- | --- | --- | --- | --- |
|                                           | ll ll lll ll ll ll                                                                                                                                                                                                                                                             |          |     | llll |     |     |     |     |
| llll llllllllllllllllllllllllllllllllllll | llllllllllllllllllll llll llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll | ll       | ll  |      |     |     |     |     |
llllllll ll
...
2016 to December 18, 2016. It’s a bit anecdotal, but it does  to minimize traffic. Still, many make it upstream to their
demonstrate one thing. While we heard a lot about Mirai, it’s  intended target.
...
| 2014      |          |          | 2014      |     |          |          |
| (n=2,782) |          |          | (n=2,782) |     |          |          |
|           | 1.2Gbps  | 8.57Gbps |           |     | 0.51Mpps | 3.1Mpps  |
...
| ytisneD          |           |     | ytisneD |        |          |             |
| ---------------- | --------- | --- | ------- | ------ | -------- | ----------- |
| 100 1K 10K100K1M | 10M100M1B |     |         | 100 1K | 10K 100K | 1M 10M 100M |
| Count            |           |     |         |        | Count    |             |
...
decreased. There’s also a wide range for how long  Understanding the types and levels of mitigation
...
TDoS—Because you didn’t have
enough problems already
Packet-based DDoS isn’t the only type of DoS around. Figure 43 provides an anecdotal example of a single TDoS
...
not having defenses vs. the cost of acquiring them. If you’re • But at C, the call volumes increase from the
going to need them, it’s better to know how to get them existing sources.
...
the better of them and they engage in some unsanctioned In this pattern, you’d expect the internal actor to feature
snooping (17%). These misuse scenarios are reflected in prominently—and they do. But while internal actors
...
Customer
| Disposal error | 20  |     |     |     |     | 117 |
| -------------- | --- | --- | --- | --- | --- | --- |
(External)
Found documents
| Misconfiguration | 12  |     |     |     | 17  |     |
| ---------------- | --- | --- | --- | --- | --- | --- |
(External)
...
Our corpus is rife with such antics as selling filing cabinets  display on your website, or get someone else’s medical
...
human error. phishing, so don’t forget to cover the basics of handling,
...
is installed quicker than Superman can change clothes criminal’s origin could be definitively determined. Cuba
...
results, and the comparatively low chance of being caught all criminal groups aren’t canoeing over here and installing
...
Fraud detection
should “curb their enthusiasm” as the primary change taking 28
(External)
place (at first anyway) was simply a shift in liability. Namely,
whomever had the lesser technology in place at the time of
Law enforcement
a breach, be it merchants who had yet to upgrade terminals (External) 21
...
2
our findings within this pattern. However, chip readers are (Partner)
...
Fraud detection
important to remember that these ATMs are primarily those 1
(Internal)
...
1
one hand, and the financial liability for non-compliance on the (Internal)
...
and tree-shaped air fresheners and can’t be expected to be a visual inspection of all terminals as part of your
...
and cannot be attributed to automated attacks targeting POS breaches—primarily opportunistic and external-actor-
poorly configured, internet-facing POS devices. driven—represented a little over 10% of all breaches this
...
Use of stolen creds 113 Partner 105
Use of backdoor/C2 106 Backdoor or C2 105
Brute force 58 Desktop sharing 65
SQLi 1 Third-party desktop 3
Buffer overflow 1 Web application 1
Physical access 1
Breaches Breaches
...
data contributors and regulatory requirements rather than We don’t assume a confidentiality loss for every lost device,
...
terms of number of incidents—but not a heck of a lot to talk We do have instances where the misuse action category
...
people are often careless. We can, however, take appropriate We can’t eliminate losing assets, but we can do
...
Let’s not disregard the secondary characters in our As websites are becoming more interactive and
story, they too have a purpose. As we mentioned in the versatile—and thus complex—to provide a solid user
...
attacker’s infrastructure (e.g., C2 server, serve up application that would require a completely different
...
(Social)
Footprinting
Details, details… (Hacking) 175
Everything else is the catch-all pattern; particularly for
Pretexting
48
incidents and breaches that have some information, but are (Social)
...
attacks, more sophisticated and polymorphic malwar—the support, we have enjoyed 10 years of publishing in-depth
...
target for much of this criminal activity—for the simple customers. These criminals have reinvested their proceeds
reason, as the bank robber Willie Sutton was once reported to develop formidable criminal enterprises, and facilitated
to have quipped, “That’s where the money is at.” the development of a robust underground for a wide range
...
financial and payment systems from criminal exploitation. sophistication—as they find new ways to gain unauthorized
...
cyberspace to exploit our nation’s financial payment system network defenses and traditional efforts at deterrence
...
to reduce the substantial homeland security risks posed by considered in the context of cybersecurity—but rather, we
these organizations, and to degrade the malicious cyber need to broadly consider how to minimize the illicit gains for
capabilities of a broad range of cyber threats—from nation- the perpetrator and financial harm
...
networks, to preventing and minimizing the ability of criminals sources and methods—including highly sensitive undercover
...
it is to minimize the cybercriminal’s opportunity to profit organizations have also come to contribute data to this
...
and their security, legal and IT departments to respond a critical resource...
...
doesn’t mean we are condoning a moratorium on vulnerability before the one-week and one-month scans, after which
scanning or patching vulnerabilities. Having a good patch they have patched everything they’ll be patching. In reality,
...
Figure 55 gives us a way to look at patching progress. It Each organization’s patching can be represented by
...
that? It’s the cut-off time before which findings are actively 100%
...
vulnerable—we can’t account for false positives within this a cut-off time of 100 days. The graph illustrates user devices
dataset—to roughly 23% of the findings over the course of have a higher AUC and COT (53% and 83% respectively) vs.
...
12 weeks, the upper line has a COT of 94% meaning they’ve after about a month, while servers receive their biggest jump
fixed 94% of their findings. On the other hand, with a COT of closer to a month after discovery. Network devices aren’t
61%, almost 40% of the lower line’s findings are leftovers. patched until the end of the quarter.
dexif
sgnidnif
fo
tnecreP
...
• On the other hand, the B column indicates a single device organization’s full
...
Bangladesh. Attackers used social engineering and malware Snowden’s leaks. The next event occurred when a GozNym
...
the USA’s National Security Agency. Ransomware attacks on the data breach at the Commission on Elections.
...
threat actor was May’s milestone. The Turla group has been that compromised the accounts of 500 million. Three
operating since 2008. In May, Switzerland’s CERT reported months later, it announced a different breach from 2013
...
attempted SWIFT frauds similar to February’s attack on attacks were delivered using the Mirai worm that infected IoT
...
network earlier in the year exemplified taking Sutton’s law report from Positive Technologies. One of the worst
to an extreme. In July, a variation on that theme led the cybercriminal groups, Anunak is almost certainly linked to the
Union Bank of India to thwart an attack on a US dollar nostro Cobalt gang’s ATM jackpotting attacks. Trustwave reported
...
2. D irect recording by contributors using VERIS. throughout, notably in trending figures. We also exclude
incidents and breaches affecting individuals that cannot
3. Converting contributor’s existing schema into VERIS. be tied to an organizational attribute loss. If your friend’s
...
We would like to reiterate that we make no claim that the We strive for statistical correctness in the DBIR. In this year’s
...
be appropriate for generalization—and our confidence in after seeing the data, which cannot be helped), and check
this grows as we gather more data and compare it to that of that each statement is accurate at a given confidence level
others—bias undoubtedly exists. Unfortunately, we cannot (normally 95%).
...
While we believe many of the findings presented in actions—adding up to 300%. This is normal, expected and
...
65 contributing organizations this year, we’re aggregating Another important point is that when looking at the
...
the influence of any individual shortcomings in each of the elements that have been marked as “unknown”—whether
...
Champlain College’s Senator Patrick Leahy Center for National Cybersecurity and Communications Integration
