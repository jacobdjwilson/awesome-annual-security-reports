...
The Proofpoint Quarterly Threat Report captures threats, trends and transformations we see within our customer base and in the wider security market. Each day, we analyze more than 1 billion email messages, hundreds of millions of social media posts, and more than 150 million malware samples to protect organizations from advanced threats. That gives us a unique vantage point from which see data and trends outside across the entire threat landscape. Analyzing how these threats shift quarter over quarter helps identify larger trends and equip organizations with actionable intelligence and advice for managing their security posture.

We continue to see sophisticated threats across three primary vectors: email, social media, and mobile.
...
- [Banking Trojans: Vawtrak out, ZLoader in, and Dridex Back with a Vengeance](#banking-trojans-vawtrak-out-zloader-in-and-dridex-back-with-a-vengeance)
- [Ransomware: Getting Targeted](#ransomware-getting-targeted)
- [Business Email Compromise (BEC) Attacks are not Going Away](#business-email-compromise-bec-attacks-are-not-going-away)
- [Web-based Threats Embrace Social Engineering](#web-based-threats-embrace-social-engineering)
...
> **EITEST**  
> EITest is an infection chain, or chain of actions that constitutes a malware delivery technique, that redirects users browsing compromised websites to an exploit kit to infect PCs.
...
Quarterly Threat Report | Q1 2017
...
Indexed Daily Malicious Message Volume by Attack Type, YTD  
- Document Attachment  
- URL  
- Archive Attachment  
...
Daily Message Volume - Top Branking Trojans  
- Zloader  
- Vawtrak  
- Bancos  
- Banload  
...
Key Stat: Ransomware was the primary payload in 22% of Q1 malicious email campaigns.
...
> **SPOOFING**  
> Spoofing trusted colleagues impersonates by using their name in the “from” field seen by the recipient. But the “reply-to” address—where any replies are actually sent—belongs to the attacker.
...
![Figure 9: Implementation of DMARC across surveyed organizations. None = DMARC record present but no active policies, Multiple = More than one active policy]
...
Exploit Kit Activity - share of samples collected over Q1 2017  
- Rig  
- Sundown  
- Neutrino  
- Nuclear  
