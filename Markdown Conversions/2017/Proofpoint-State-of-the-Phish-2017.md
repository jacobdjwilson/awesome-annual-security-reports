...
Report Title: State-of-the-Phish
Year: 2017

Phishing: to try to obtain financial or other confidential information from internet users, typically by sending an email that looks as if it is from a legitimate organization, encouraging an end user to take an action that compromises their computer or reveals sensitive information.

## Table of Contents
- [Introduction and Overview](#introduction-and-overview)
- [Summary of Findings](#summary-of-findings)
- [Phishing: Knowledge Is Power](#phishing-knowledge-is-power)
- [Impact of Phishing](#impact-of-phishing)
- [What Is Ransomware?](#what-is-ransomware)
- [To Pay or Not to Pay?](#to-pay-or-not-to-pay)
- [Spear Phishing](#spear-phishing)
- [Risky Behaviors](#risky-behaviors)
- [What Types of Phishing Emails Are People Falling For?](#what-types-of-phishing-emails-are-people-falling-for)
- [How Do Different Industries Perform?](#how-do-different-industries-perform)
- [Measurement Is Key](#measurement-Is-key)
- [Change Behavior. Reduce Risk.](#change-behavior-reduce-risk)

---

## Introduction and Overview

Welcome to the third annual State of the Phish™ Report. This year’s report not only looks at data around tens of millions of simulated phishing emails sent last year, but survey data from both infosec professionals and end users to give a better understanding of what the impact and understanding of phishing was in 2016 as we move into 2017. While not a scientific study, this report does offer important insights into what proactive organizations are doing to better train their end users to identify and avoid phishing messages.

Data Analyzed for This Report:
- **10s of millions of simulated phishing emails sent** over a 12-month period from October 1, 2015 to September 30, 2016. A 155% increase over the number of emails that we looked at for our last report.
- **More than 500 answers** to a survey that we launched to security professionals in our database. Responses were from companies all around the world, of all sizes, and across more than 16 industries. We worked with an independent research firm to survey 1,000 people of legal working age in each country.
...
**What is phishing?**
- **US**: 65% Answered Correctly | 17% Answered Incorrectly | 18% Do Not Know
- **UK**: 72% Answered Correctly | 18% Answered Incorrectly | 10% Do Not Know
...
In the third quarter of 2016, the Anti-Phishing Working Group’s Phishing Trends Report showed some drop in the numbers of brands targeted by phishers and also that phishers were, on average, creating fewer phishing URLs[^1].

Around the same time, we surveyed our database of infosec professionals, who seemed to be reporting the same thing -- phishing is still a threat that is evolving:
- **76.5%** reported being the victim of a phishing attack in 2016 (Down 10% from 2015)
- **51%** said the rate of phishing attacks is increasing (Down 15% from 2015)
- **45%** said the rate of phishing attacks is decreasing
- **4%** said the rate has stayed the same
- **44%** experienced phishing through phone calls (vishing) and SMS messaging (smishing) (Decrease of 20% from 2015)
- **4%** experienced phishing through USB attacks (Decrease of 33% from 2015)
...
- **38%** Disruption of Employee Activities
- **27%** Compromised Accounts
- **17%** Malware Infection
- **7%** Loss of Data
...
- **41%** Business Impacts Through Loss of Proprietary Information
- **35%** Other
- **16%** Loss of Productivity for Employees
...
- **Adobe PDF**: 31% outdated (49% reduction from 2015)
- **Microsoft Silverlight**: 17% outdated (37% reduction from 2015)
- **Adobe Flash**: 12% outdated (73% reduction from 2015)
- **Java**: 8% outdated (68% reduction from 2015)
...
**What is ransomware?**
- **US**: 34% Answered Correctly | 14% Answered Incorrectly | 52% Do Not Know
- **UK**: 38% Answered Correctly | 21% Answered Incorrectly | 41% Do Not Know
...
### Ransomware Q&A
- **What Is Ransomware?** Ransomware is a type of malicious software — i.e., malware — that blocks access to a device or data until a ransom is paid.
- **What Does Ransomware Do?** When a device is infected with ransomware, some type of encryption is applied, effectively locking you out of your files or your device. If you are infected, you will receive a ransom message from the attacker asking for payment which, allegedly, will grant you access to the digital key needed to unlock your files and/or system.
- **How Much Are Ransoms?** Many ransoms are small; they commonly range from $25 to $600. However, some ransomware strains (like those that target healthcare institutions or other larger organizations) carry significantly higher payment demands, into the thousands of dollars.
- **How Are Ransoms Collected?** Attackers generally require ransoms to be paid in Bitcoin or another “untraceable” electronic format. These “cryptocurrencies” are fully digital. They are created and held electronically, have no physical form, and are not controlled by any banking entity.

> To download the full Ransomware infographic visit the Wombat Blog.  
> [https://info.wombatsecurity.com/blog/infographic-help-users-understand-ransomware-and-prevent-infections](https://info.wombatsecurity.com/blog/infographic-help-users-understand-ransomware-and-prevent-infections)
...
- **34%** said that they had experienced a ransomware attack in 2016
- **2%** of organizations that were hit with ransomware said they paid the ransom
...
- **To Pay or Not to Pay?** Security experts generally advise against paying a ransom. Paying only encourages these types of attacks. However, if an organization has not backed up files to a secure location, paying the ransom might be regarded as the only option for recovering data. Though some services claim they can recover files without the decryption key, it can be next to impossible to reverse an infection.
- **Will Paying a Ransom Restore My Files?** Sometimes. But there have been known instances of ransomware with critical flaws that render data unrecoverable (even if the ransom is paid). In other cases, an organization has paid the ransom only to be hit with a second, larger payment request.

> DON'T COUNT ON ‘HONOR AMONG THIEVES.’  
> **Bottom Line:** DON'T BECOME A RANSOMWARE VICTIM! Know how to prevent an infection and be prepared to recover your data if you do get hit.
...
- **BACK UP**: data and files to a secure location daily or even hourly (if possible)

> Read more on our blog: [Ransomware: Don’t Count on Honor Among Thieves](https://info.wombatsecurity.com/blog/infographic-help-users-understand-ransomware-and-prevent-infections) for examples.
...
- **61%** reported experiencing spear phishing (aka targeted attacks) (Decrease of almost 10% from the previous year)
...
| Customization Type | Average Click Rates in Programs (Less Than 6 Months Old) | Average Click Rates in Programs (After a Year) |
| :--- | :--- | :--- |
...
- **Thursday**: 22%
- **Friday**: 16%
- **Saturday and Sunday**: 1% each

*When do most reported emails clock in?* The early hours of the work day are when people seem to report the most suspicious emails.
...
- **Do you check personal email on your work computer?**
  - US: 50% Answered Yes | 49% Answered No | 1% Not Sure
  - UK: 31% Answered Yes | 68% Answered No | 1% Not Sure
- **Do you check work email on your personal mobile phone?**
  - US: 49% Answered Yes | 50% Answered No | 1% Not Sure
  - UK: 29% Answered Yes | 71% Answered No | 1% Not Sure
...
- **Email/Spam Filters**: 94% (A decrease of 5% from last year)
- **Advanced Malware Analysis**: 63% (An increase of 26% over last year)
- **Outbound Proxy Protection**: 48% (A decrease of 14% from last year)
- **URL Wrapping**: 31% (An increase of 30% over last year)
...
### Average Click Rates by Category
- **Corporate**: 52%
- **Commercial**: 34%
- **Consumer**: 19%
- **Cloud**: 15%
...
- **Corporate Emails**: These types of emails look like official corporate communications. Examples include full mailbox notifications, spam quarantines, benefits enrollment messages, and confidential HR documents.
- **Commercial Emails**: These are business-related emails that are not organization-specific. Sample topics include shipping confirmations, invoices, wire transfer requests, insurance notifications, and auto insurance renewal.
- **Cloud Emails**: Examples of these business-related emails include messages about downloading documents from a cloud storage services, or going to an online file sharing service to create or edit a document.
- **Consumer Emails**: These are the types of emails the general public gets on a daily basis that may try to replicate offers or accounts they already have. Examples include emails about frequent flier accounts, bonus miles, photo tagging, frozen accounts, big-box store memberships, social networking, gift card notifications, and more.

### Most Popular Attack Templates
- **Password Update**: 24% Avg. Failure Rate
- **Corporate E-Fax**: 20% Avg. Failure Rate
- **Shipping Notification**: 19% Avg. Failure Rate
- **Email Password Change**: 18% Avg. Failure Rate
- **Email Quota Alert**: 18% Avg. Failure Rate

*(Note: A template called “Message from Corporate Administrator” had the highest average failure rate of 34%. This simulated attack asks the user to click a link if they feel they have received the message in error and didn’t sign up for a certain type of account.)*
...
- **Professional Services**: 47% improvement in click rates
- **Technology**: 32% improvement in click rates
- **Energy**: 27% improvement in click rates
- **Telecommunications**: 26% improvement in click rates *(Note: Telecommunications was the industry with the highest failure rate in our 2016 report.)*
- **Finance**: 19% improvement in click rates
...
- **67%** Computer-Based Awareness Training
- **62%** Phishing Simulation Exercises
- **49%** In-Person Security Awareness Training
- **42%** Monthly Notifications or Newsletters

**Have you been able to quantify a reduction in phishing susceptibility based on these activities?**
- **52%** said yes (A 40% increase from last year’s response)
...
- **72% SAID YES** (This is a dramatic increase of 64% year over year.)

We know that information security professionals have to assess risk in order to make decisions on what tools to invest in. And now more than ever, infosec teams have to provide data-driven reasoning. Not surprisingly, most use security awareness to measure end-user risk.

**What criteria are infosec professionals using to determine the risk end users pose?**
- **48%** Security Awareness and Training Performance
- **35%** Technical Policy Violations (e.g., web filter violations, AV infections, DLP alerts)
