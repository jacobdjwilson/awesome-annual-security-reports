...
- **Q** How many security tools do you have deployed today that generate alerts?
- ~28 20,000+ employees
- ~20 10,000 - 19,999 employees
- ~18 5,000 - 9,999 employees
- ~13 1,000 - 4,999 employees
- ~8 250 - 999 employees
- Overall average: ~16.8 tools
...
### Companies generate ~960 alerts daily; Companies generate ~1,000 alerts daily; Very large enterprises reach over 3,000 Very large enterprises reach over ~3,000

- **Q** How many alerts do you receive per day (of all severities)? Please select the choice that most closely matches your average
- Daily average number of alerts received by companies
  - ~10,000 alerts daily 6%
  - ~1,000 alerts daily 28%
  - ~10 alerts daily 20%
  - Average daily alert volume received by companies ~960 46%

Similarly, the number of security alerts an organization generates directly correlates with their size, with larger organizations using a significantly higher average number of tools and therefore generating more alerts. Very large enterprises (20,000+ employees) generate an average of ~3,000 alerts per day, while most large enterprises (10,000-19,999 employees and 5,000-9,999 employees) generate around 1,000 alerts daily.
...
- Daily average number of alerts by different sized companies
  - 3,181 20,000+ employees
  - 1,168 10,000 - 19,999 employees
  - 809 5,000 - 9,999 employees
  - ~960 daily alerts overall average
  - 380 1,000 - 4,999 employees
  - 218 250 - 999 employees
...
- **Q** What percentage of alerts of all severities (low, medium, high critical) are being ignored versus triaged or investigated?
...
- Avg. % of alerts ignored
  - 25% 20,000+ employees
  - 31% 10,000 - 19,999 employees
  - 31% 5,000 - 9,999 employees
  - 36% 1,000 - 4,999 employees
  - 37% 250 - 999 employees
- % of respondents
  - ~100% 0%
  - ~80% 6%
  - ~60% 7%
...
1/3 rd of companies ignore more than half of their alerts
...
This data highlights that while larger organizations investigate a higher proportion of alerts, companies of all sizes ignore alerts. Even the respondents that claim 0% of alerts are ignored, tend to rely on an MSSP or MDR which likely ignore some alerts. This reinforces the the reality that a significant percentage of alerts are left untriaged or ignored across the board.
...
- **Q** On average, how long does it take to investigate an alert (MTTI) and the dwell time?
  - ~56 Minutes Dwell Time
    - The period from when an alert is fired from a detection tool to when it is picked up for review
  - ~70 Minutes Mean Time to Investigate
    - The Average time it takes for a security team to thoroughly investigate a generated alert
- Avg. time (min)
  - 94 20,000+ employees
  - 63 10,000 - 19,999 employees
  - 55 5,000 - 9,999 employees
  - 56 1,000 - 4,999 employees
  - 28 250 - 999 employees
- 89 20,000+ employees
- 89 10,000 - 19,999 employees
- 76 5,000 - 9,999 employees
- 73 1,000 - 4,999 employees
- 67 250 - 999 employees
...
- **Q** What are the top 3 challenges that your SOC team currently faces? (Select up to 3 choices)
  - % of respondents
    - Triage/Investigation takes too long 36%
    - Gaps in 24/7 SOC coverage 32%
    - Analyst burnout and/or turnover 31%
    - Poor or ineffective automation 30%
    - Slow incident response or containment 29%
    - Lack of resources 29%
    - Alert volume and alert noise 28%
    - Lack of skills 22%
    - Compliance and reporting pressures 20%
    - Can’t keep up with new threats 19%
    - Tool sprawl 13%
...
- **Q** Are you currently limiting the number of detection rules in place due to limited capacity to triage and investigate alerts?
  - % of respondents
    - 57% Yes
    - 43% No
...
- **Q** Given more triage and investigation resources, which detections would you enable? (Select your top 3)
  - 65% Cloud
  - 61% Identity
  - Top 2 gaps
  - 47% Insider threat
...
- **Q** Please select the top security priorities for you? (Select up to 3 choices)
  - % of respondents
    - Data security 53%
    - Cloud security 37%
    - AI for security 33%
    ...
    - OT Security 29%
    - Security for AI 27%
    - Application / Product security 23%
    - Ransomware threats 21%
    - Security team hiring and retention 15%
    - 3rd party vendor risk 14%
    - Tool sprawl 10%
    - Other 1%
...
- **Q** What use cases do you believe AI is most valuable for in your SOC? (Select the top 3)
  - 1 Alert Triage and Investigation
    - sifting through high volumes of alerts, prioritizing critical incidents, and providing context for faster human analysis.
    - 67% of respondents
...
- **Q** Do you currently use an AI solution to help triage, investigate, and/or remediate alerts?
- **Q** Do you plan on using/evaluating an AI SOC solution in the next 12 months?
  - % of respondents
    - Yes 55%
    - No 45%
  - % of current non-AI SOC solution users (“No” respondents from pie chart)
    - No plans to evaluate or use an AI SOC solution 6%
    - Plan on evaluating AI SOC solutions 60%
    - Currently evaluating an AI SOC solution 28%
    - Currently standing up an AI SOC solution 6%
...
Director of Security, Financial Services Co (Currently evaluating AI SOC Solutions)
...
- **Q** How do you measure the ROI or effectiveness of AI-driven SOC tools? (Select the top 3 metrics)
  - 42% of respondents Improved MTTI
    - MTTI is the average time it takes for a security team to thoroughly investigate an alert, from its initial trigger to understanding its nature, scope, and potential impact.
  - 41% of respondents Improved MTTR
    - MTTR measures the total time from the initial alert firing to its complete containment, eradication, and recovery. It encompasses the investigation phase (MTTI) as well as the response actions.
  - 40% of respondents Improved 24/7 Coverage
    - This metric refers to the SOC's ability to maintain continuous, round-the-clock monitoring and response capabilities, ensuring no gaps in vigilance regardless of time of day or staffing levels.
...
By drastically improving MTTI, AI inherently shortens MTTR. Furthermore, AI can suggest and even automate response actions, orchestrate containment measures across various security tools, and initiate remediation steps with minimal human intervention. This accelerates the entire incident lifecycle.
...
- **Q** What is your biggest concern or barrier around using AI for cybersecurity? (Select all that apply)
  - % of respondents
    - Data privacy or regulatory concerns 24%
    - Integration difficulty (tools & workflows) 18%
    - Concerns of AI replacing humans 15%
    - Cost of AI tools 12%
    - Lack of explainability 10%
    - Low accuracy 10%
    - Skill attrition 10%
...
- **Q** What percentage of you SOC workload do you believe will be performed by AI in the next 3 years?

83% of security leaders believe that over half of SOC workload will be completed by AI in the next 3 years

Despite the identified barriers to adopting AI, such as data privacy concerns and integration difficulties, these challenges are likely to be overcome due to the overwhelming conviction among cybersecurity leaders regarding AI's future role in the SOC. Cybersecurity leaders broadly believe that a substantial portion of their SOC workload will be performed by AI solutions in the next three years. Specifically, the average expectation is that 57