# Data Security and Compliance Risk 2025 Annual Survey Report

## Table of Contents
- [Executive Summary](#executive-summary)
- [Letter From the Editor](#letter-from-the-editor)
- [Visibility-Governance Challenge](#visibility-governance-challenge)
- [Longitudinal Risk](#longitudinal-risk)
- [Interconnected Risk](#interconnected-risk)
- [AI Governance](#ai-governance)
- [Privacy-Enhancing Technologies](#privacy-enhancing-technologies)
- [Compliance Imperative](#compliance-imperative)
- [Detection, Response, and Resilience](#detection-response-and-resilience)
- [Scoring Data Security and Compliance Risk](#scoring-data-security-and-compliance-risk)
- [Industry and Geographic Insights](#industry-and-geographic-insights)
- [Conclusion: The Inflection Point](#conclusion-the-inflection-point)
- [Appendices](#appendices)

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 2.
...
- **36%** didn’t know their implemented zero privacy technologies
- **60%** couldn’t quantify litigation costs
- **20%** adopted basic governance frameworks

Meanwhile, only 17% of organizations have fully implemented AI governance frameworks on average across industries—a concerning gap in oversight capabilities—while 25% of ungoverned organizations rely solely on contractual approaches that may not withstand regulatory scrutiny.[^1]

Poor visibility and weak governance create a deadly combination—exponentially multiplying risk.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 3.

### 10 Critical Findings That Define 2025

1. **Detection Delays Cost Millions.** 31% of organizations with 5,000+ third parties take >90 days to detect breaches. Organizations with longer detection times face significantly higher litigation costs.
2. **AI Blind Spots Create Total Exposure.** 36% of organizations that are unaware of their AI data usage have no privacy technologies. Organizations struggle with AI oversight, with only 17% claiming to have technical governance frameworks. This gap creates dangerous blind spots as AI adoption accelerates.
3. **Third-Party Volume Predicts Breach Frequency.** Organizations with 5,000+ third parties with which they exchange private data face 10+ annual breaches at a rate of 24%, while those with <500 partners show 34% zero breaches.
4. **The 1,001–5,000 Partner Danger Zone.** Mid-sized ecosystems face 46% increased supply chain risks—the highest of any segment. They have enterprise-scale problems with mid-market resources.
5. **Breaches Drive Exponential Costs.** While 45% with 1–3 annual hacks face <$1M costs, 77% with 10+ hacks face >$3M litigation. Costs escalate dramatically with each breach tier.
6. **Motivations Shift From Proactive to Reactive.** Low-breach organizations prioritize efficiency (27%). High-breach organizations chase financial damage control (37%). Success requires staying ahead.
7. **The Privacy Dividend Emerges.** Organizations with mature privacy programs report 27% reduced security losses, 21% enhanced customer loyalty, and 21% improved operational efficiency—proving that privacy investment delivers measurable ROI beyond compliance.
8. **The 35/46 Geopolitical Squeeze.** 35% face increased operational costs from tariffs while 46% see compliance tool budget increases—creating a dual pressure that makes geographic avoidance strategies obsolete.
9. **The Hidden Cost Multiplier.** For every $1.00 spent on visible compliance, organizations incur $2.33 in hidden costs including opportunity costs, innovation delays, and audit fatigue—revealing the true burden of manual approaches. In addition, organizations with comprehensive governance achieve 3.5x better cost visibility—75% can specify their localization costs versus only 35% of those without governance plans.
10. **The Segregation Paradox.** 37% of organizations implement data segregation by geography to meet compliance, yet this fundamentally conflicts with AI’s need for unified data sets—creating a tension between compliance and innovation.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 4.

### The Four-Year Evolution: From Simple to Systemic Technology

- **Encryption**: Improved from 47% (2022) to ~54% (2024), but progress stalled in 2025
- **Visibility**: Only 50% achieved centralized governance by 2025
- **Compliance**: 70%+ still rely on manual processes
- **Privacy-Enhancing Technologies**: Stuck below 20% for advanced technologies despite growing awareness.

*(Note: Historical data from previous Kiteworks reports shows persistent gaps)*
...
Figure 1: What Drives Success vs. What Creates Risk. The difference isn’t budget or sophistication–it’s visibility and proactive investment before [risk] hits.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 5.

### Industry Variations: Not All Sectors Are Equal

#### Leading the Pack
- **Financial Services**: 63% comprehensive controls, 47% EU Data Act ready
- **Technology**: 42% claim fully implemented AI governance
- **Healthcare**: 65% “very confident” in tracking capabilities

#### Falling Behind
- **Education**: Only 14% are prepared for EU Data Act
- **Legal**: 23% have no preparation plans
- **Government**: 58% struggle with third-party compliance
...
Data Security and Compliance Risk Report: 2025 Annual Global Report 6.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 7.

---

# Visibility-Governance Challenge: What You Don’t Know Multiplies Risk
...
- **48%** of those who don’t know breach frequency can’t quantify litigation costs
- **46%** of those who don’t know third-party account also don’t know their breach frequency
- **42%** of those uncertain about hacks report uncertainty in detection times
- **32%** of those uncertain about third-party exposure conduct regular audits

![Cascade Effect: Lack of Visibility Translates Into Higher Risk]

Figure 2: Cascade Effect: Lack of Visibility Translates Into Higher Risk.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 9.
...
**Key Finding:** Even high confidence cannot fully overcome the risks of ecosystem complexity.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 10.

#### Confidence vs. Complexity: Third-Party Volume Still Drives Breach Risk
1. Confidence in tracking data alone is not a strong safeguard—even among organizations that report being “very confident” in their ability to control data exchanges, breach rates remain significant. Notably, 42% of very confident organizations with 1,001–5,000 third parties still experience 7–9 annual hacks.
2. Ecosystem complexity drives breach exposure—organizations with fewer than 500 third parties see lower breach rates overall, especially when confidence is high. But as the number of third parties increases, even high confidence levels fail to offset the elevated risk from larger digital supply chains.
...
| No Visibility | AI Data Exposure Unknown | No AI Usage Controls | Comprehensive AI Governance Model | Concerned About Leakage |
| :--- | :--- | :--- | :--- | :--- |
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 11.
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| High Performance by risk tier | Exact numbers | Percentage of private data | Hours/days to discovery | Precise hour tracking | Exact incident counts |
| Low Performance | “Don’t know” or estimates | No measurement | Uncertain or >30 days | “Don’t know” or untracked | “Don’t know” |
...
**The Difference:** Visibility drives confidence, confidence enables control.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 12.
...
![Industry Sectors and Compliance Tracking and Reporting Visibility]
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 13.

![Breach Frequency and Litigation Costs]

Figure 9: Breach Frequency and Litigation Costs.

**Critical Finding:** 48% who don’t know breach frequency also can’t quantify litigation costs.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 14.
...
- **>5,000**: 54% take >30 days
- **1,001–5,000**: 53% take >30 days
- **501–1,000**: 38% take >30 days
- **<500**: 9% take >30 days
- **Don’t Know**: 46% take >30 days

Figure 10: Detection Times by Third-Party Volume.

The data highlights a clear correlation between ecosystem complexity and detection delays, as well as the compounding risk of visibility gaps. Organizations with over 1,000 third-party connections take more than 30 days to detect breaches in over half of cases (53–54%), compared to just 9% for those with fewer than 500 third parties. Alarmingly, 42% of those who don’t even know their third-party volume also exceed 30-day detection times—demonstrating how lack of oversight magnifies risk. Similarly, 48% of respondents who don’t know how many breaches they experience annually also cannot quantify litigation costs. As breach frequency increases, so do high-cost outcomes: Nearly one-third of organizations with 10+ breaches report litigation costs over $5 million. These trends underscore a core message—visibility gaps directly impair breach detection and financial risk management.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 15.

---

# Longitudinal Risk: How Persistent Gaps Have Created Today’s Challenge

*(Note: Historical data referenced in this section is derived from previous Kiteworks annual reports.)*

![Persistent Gaps in Encryption and Visibility]

Figure 11: Persistent Gaps in Encryption and Visibility.

The data illustrates a troubling reality: Despite some year-over-year improvements in full encryption, centralized governance, and third-party inventory tracking, most organizations continue to face persistent gaps in visibility and automation. In 2025, only 56% have implemented full encryption and just over 50% have centralized governance. Meanwhile, compliance automation remains critically underdeveloped, with less than 35% adoption, and PET adoption remains stagnant at below 25%.

These plateaus in progress suggest that organizations are struggling not just with implementation, but with scalability and cross-functional integration—especially as complexity grows across larger ecosystems.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 17.

### Third-Party Risk Timeline
- **2021**: 51% Claimed Inadequate Third-Party Measurements
- **2022**: 58% Cited No Risk Measurements for Third Parties
- **2023**: 67% Said They Lack Full Third-Party Inventories
- **2024**: 39% Identified Rising Risk (1,001–5,000 Third Parties)
- **2025**: 24% With 5,000+ Third Parties Experienced 10+ Data Breaches
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 18.

| Risk Domain | 2022 | 2023 | 2024 | 2025 | Trend |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Full Encryption | 47% | 51% | 54% | 56% | Slow progress |
| Centralized Governance | 33% | 40% | 45% | 50%+ | Gradual improvement |
| Third-Party Inventory | 42% | 47% | 52% | 57% | Gap vs. growth |
| Compliance Automation | <20% | <25% | <30% | <35% | Critical gap |
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 19.

---

# Interconnected Risk: Where AI, Partners, and Compliance Collide
...
- **24%** experience 7+ annual security incidents
- **46%** report highest supply chain cyber risk increases
- **44%** faced $3M–$5M litigation breach costs
- **24%** take 31–90 days to detect breaches
...
Data Security and Compliance Risk Report: 2025 Annual Global Report 21.
...
$$\text{Risk Increase (\%)} = 100 \times \frac{\text{Number of “Yes” responses}}{\text{Total respondents in that third-party volume tier}}$$
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 22.

#### Why Mid-Size Complexity Kills
The danger zone emerges from a fatal combination:
- Security budgets remain mid-market sized
- Manual processes break under the volume
- Ecosystem complexity rivals large companies
- Visibility tools lack sophistication
- Compliance requirements multiply with partner count
...
- **42%–50%** struggle with rapidly evolving regulations
- **33%–42%** face inconsistent multi-jurisdictional requirements
- **32%–46%** cannot manage third-party vendor compliance

#### Multiplier Effect
$$\text{Each new regulation} \times \text{number of jurisdictions} \times \text{third-party count} = \text{exponential complexity.}$$
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 23.

![EU Readiness Across Industry Segments]

Figure 14: EU Readiness Across Industry Sectors.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 24.

- Large enterprises (>10,000 employees): **50%**
- Mid-size (1,001–5,000): **22%**
- Small (<500 employees): **22%**
- Micro (<100 employees): **6%**
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 25.
...
Organizations without governance plans lean heavily on contractual risk transfer, with 25% relying on legal agreements instead of technical safeguards—often a sign they lack operational readiness.

In contrast, organizations with comprehensive governance frameworks show strong adoption of advanced technical strategies: 47% use hybrid infrastructure, 46% rely on distributed cloud models, and many demonstrate confidence in managing complexity.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 26.

---

# AI Governance: Privacy-Innovation Tightrope
...
![PET Adoption by AI Measurement Capability]

Figure 16: PET Adoption by AI Measurement Capability.

**Critical Finding:** Measurement alone drives significantly better security outcomes. Organizations aware of their AI data usage are 93%–96% likely to implement at least one PET, while 36% of those unaware implement zero privacy protections.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 28.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 29.
...
![AI Governance Maturity by Organizational Visibility]

Figure 18: AI Governance Maturity by Organizational Visibility.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 30.
...
- **No Specific Policies**: 10% (High visibility 5%, Medium visibility 17%, Low visibility/Don’t know 15%)
- **Warnings Without Enforcement**: 20% (High visibility 40%, Medium visibility 26%, Low visibility/Don’t know 30%)
- **Training and Audits**: 27% (High visibility 35%, Medium visibility 25%, Low visibility/Don’t know 15%)
- **Technical Controls + DLP**: 17% (High visibility 8%, Medium visibility [N/A], Low visibility/Don’t know [N/A])

Figure 19: AI Control Mechanisms by Visibility Level.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 31.
...
![Model Leakage Concern vs. Governance Implementation]

Figure 20: Model Leakage Concern vs. Governance Implementation.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 32.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 33.

---

# Privacy-Enhancing Technologies: Maturity Divide
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 35.
...
![PET Implementation Difficulty vs. Impact]

Figure 23: PET Implementation Difficulty vs. Impact.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 36.
...
> **Recommendation:** Start with quick wins, build toward comprehensive protection.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 37.

---

# Compliance Imperative: Navigating Global Complexity
...
| :--- | :--- | :--- | :--- | :--- |
| Legal | Rapidly evolving requirements | 71% | Inconsistent regulations | 39% |
| Government | Third-party vendor compliance | 58% | Limited resources | 33% |
| Financial Services | Balancing compliance vs. business | 39% | Multi-jurisdictional complexity | 31% |
| Technology | Inconsistent requirements | 56% | Pace of change | 47% |
| Healthcare | Employee training gaps | 72% | Data inventory maintenance | 47% |
| Manufacturing | Resource limitations | 74% | Third-party compliance | 59% |
| Education | Limited budgets | 67% | Jurisdictional complexity | 44% |
| Pharmaceuticals/Life Sciences | Compliance with global data privacy laws | 63% | Complex third-party data sharing | 42% |

Figure 25: Top Compliance Challenges by Industry.

### AI Compliance Blind Spot

Despite the rapid pace of regulatory development—59 new U.S. AI laws were introduced in 2024 alone according to Stanford research—only 12% of organizations consider compliance a top AI-related concern. This mismatch creates blind spots for GDPR, CCPA, HIPAA, and SOX compliance, particularly when organizations cannot log or track AI data usage.[^2] Furthermore, only 17% of organizations have implemented AI technical governance frameworks, compounding the compliance challenge.

DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 39.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 40.
...
| North America | CCPA/CPRA | 40% | High enforcement risk; consent and opt outs |
| North America | HIPAA | 63% | PHI workflows drive logging and BAAs |
| North America | CMMC 2.0 | 45% | Contract gate for DoD revenue |
| North America | NIS 2 | 4% | Limited scope; EU ops only |
| North America | DORA | 10% | EU banking links add ICT risk duties |
| North America | UK DPA | 16% | UK subsidiaries require UK-specific handling |
| Europe/UK | GDPR | 90% | Table stakes for European organizations |
| Europe/UK | CCPA/CPRA | 12% | Applicable for firms conducting business in California |
| Europe/UK | HIPAA | 14% | Only a small portion of European firms in the U.S. |
| Europe/UK | CMMC 2.0 | 6% | Few European firms have U.S. DoD business |
| Europe/UK | NIS 2 | 54% | Regulation is a requirement and growing focus area |
| Europe/UK | DORA | 49% | Like NIS 2, DORA is a growing requirement |
| Europe/UK | UK DPA | 41% | Large number of European firms conduct business in the UK |
| Middle East | GDPR | 51% | Substantial number of Middle East firms conduct operations in Europe |
| Middle East | CCPA/CPRA | 22% | Applicable for firms conducting business in California |
| Middle East | HIPAA | 22% | Only a small portion of Middle East firms in the U.S. |
| Middle East | CMMC 2.0 | 16% | Small number of Middle East firms conduct business with the U.S. DoD |
| Middle East | NIS 2 | 24% | Compliance required of firms conducting business in the Middle East |
| Middle East | DORA | [Truncated in original text] | Compliance required of firms conducting business... |

[^1]: Internal Kiteworks 2025 Survey cross-tabulation data comparing governance adoption models to regulatory frameworks.
[^2]: Stanford University Artificial Intelligence Index Report (2024 data referenced for regional legislative output).
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 41.

2025 Annual Survey Report
North America: Compliance is U.S.-centered. HIPAA (63%) shapes PHI workflows and BAAs; CMMC
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 42.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 43.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 44.
...
Normalized Score
= (3 x Rank 1 count)
+ (2 x Rank 2 count) Composite Score
= × 100
+ (1 x Rank 3 count) Highest Composite Score
...
291 72
of processing activities (RoPAs)
...
pace with constantly changing privacy regulations. keep pace
This highlights not just the velocity of regulatory
with constantly
evolution across jurisdictions but also the difficulty
organizations face in adapting their internal policies changing privacy
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 45.
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 47.
EGATNECREP
...
22%
0%
Over 1,000– 501– Fewer Than Don’t
5,000 5,000 1,000 500 Know
<24 Hours 1–7 Days 8–30 Days 31–90 Days >90 Days Don’t Know
THIRD-PARTY VOLUME
...
0%
ANNUAL BREACHES
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 48.
ESIMORPMOC
FO
TSOC
NOITAGITIL
...
16%
12%
1–3 Hacks 4–6 Hacks 7–9 Hacks 10+ Hacks
<$1M $1M– $3M $3M– $5M >$5M Don’t Know
...
difference between detecting a breach in hours versus months can mean millions in litigation costs,
irreparable reputational damage, and the difference between business continuity and catastrophe.
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 49.
...
| ---------------- | -------------------------- | ---------- | --- |
effectiveness
|                  | Litigation costs from  |              | Quantifies real business  |
| ---------------- | ---------------------- | ------------ | ------------------------- |
| Financial Impact |                        | 1–5.5 points |                           |
|                  | breaches               |              | damage                    |
...
| -------------- | ---------- | ------------ | --------- |
| (7.0–10)       | (5.0–7.0)  | (3.5–5.0)    | (1.0-3.5) |
70 Organizations 140 Organizations 117 Organizations 134 Organizations
| 15% | 31% | 25% | 29% |
| --- | --- | --- | --- |
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 51.

2025 Annual Survey Report
The median risk score across all 461 organizations is 4.84, placing the typical organization in the upper
...
`
Algorithmic Calculation Scoring Rubric
...
1.0–3.5: Low Risk Don’t know = 4 points (Financial blind spot)
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 52.
...
|              | Breach     |            |             | Risk Score     |              |
| ------------ | ---------- | ---------- | ----------- | -------------- | ------------ |
| Third-Party  |            | Time to    | Litigation  |                | Risk         |
|              | Frequency  |            |             | (Rationalized  |              |
| Volume       |            | Resolution | Cost        |                | Assessment   |
|              | Tier       |            |             | to 1-10)       |              |
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 53.
...
score at 5.19.
The data suggests that while smaller organizations benefit from manageable complexity and larger
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 54.
...
The data reveals a striking “confidence paradox” where organizations expressing moderate confidence
...
Linear AI
Governance Maturity
The linear relationship between AI
governance maturity and risk reduction
provides a great business case for AI
governance investment.
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 55.

2025 Annual Survey Report
The analysis demonstrates a compelling “governance dividend” where AI governance implementation
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 56.
...
| 10  | 3.87 | Low-Medium |
| --- | ---- | ---------- |
11 Life Sciences/Pharmaceuticals
|     | 3.37 | Low |
| --- | ---- | --- |
...
greatest threats.
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 57.

2025 Annual Survey Report
The industry risk hierarchy reveals critical vulnerabilities in infrastructure sectors while exposing
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 58.
...
| -------- | ------------ | ----------------- | ---------------- |
88% CIO/CTO
Technology AI governance (42%) Overconfidence in capabilities
concentration
| Financial  | Comprehensive controls  |     | Regulatory  |
| ---------- | ----------------------- | --- | ----------- |
Complex vendor ecosystems
| Services      | (63%)                   |                                  | compliance burden |
| ------------- | ----------------------- | -------------------------------- | ----------------- |
|               | Tracking confidence     |                                  | PHI protection    |
| Healthcare    |                         | Legacy system integration        |                   |
|               | (65% “very”)            |                                  | requirements      |
|               | AI governance adoption  |                                  | Supply chain      |
| Manufacturing |                         | Tariff impact (46% higher costs) |                   |
|               | (57%)                   |                                  | vulnerabilities   |
Highest “don’t
| Education | Collaborative culture | EU Data Act readiness (14%) |     |
| --------- | --------------------- | --------------------------- | --- |
know” rates
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 60.

2025 Annual Survey Report
Regional Risk and Response Patterns
| Region | Key Metrics | Strengths | Primary Challenge |
| ------ | ----------- | --------- | ----------------- |
North   11% (lowest; Europe/UK is highest   Greatest scale of operations Balancing
|         | at 26%)                       |                                   | innovation       |
| ------- | ----------------------------- | --------------------------------- | ---------------- |
| America |                               |  Security-focused infrastructure |                  |
|         |  21% (strict blocking + DLP) |                                   | with litigation  |
 Leads strong encryption
|     |  77% use SFTP | coverage (76%–100%; 53%) | exposure risk |
| --- | -------------- | ------------------------ | ------------- |
Europe  56% IT roles (IT Specialist/  Regulatory maturity advantage Managing complex
Analyst + IT Director/Manager +   Highest PET adoption  multi-jurisdictional
|     | CIO/CTO) |     | requirements |
| --- | -------- | --- | ------------ |
rates globally
 35% fully ready for EU Data Act
 Deep specialization
 90% GDPR impact
APAC  46% in 1,000–4,999   Rapid growth, technology- Scaling security
|     | employee range | forward, but not encryption  | governance with   |
| --- | -------------- | ---------------------------- | ----------------- |
|     |                | leader                       | rapid AI adoption |
 44% encryption
|     | (lagging NA and Europe)             |  Rapid growth trajectory |     |
| --- | ----------------------------------- | ------------------------- | --- |
|     |  15% cite “don’t know” on AI risks |  Technology embracement  |     |
Middle   60% require security certifications  Certification-driven assurance;  Building technical
East  18% conduct compliance  strict AI controls highest— capabilities
|     | training (peak) | training remains lowest | alongside process  |
| --- | --------------- | ----------------------- | ------------------ |
maturity
|     |  31% implemented technical  |  People-first approach |     |
| --- | ---------------------------- | ----------------------- | --- |
controls; 24% enforce strict AI   High certification requirements
blocking (highest)
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 61.
...
This range shows consistently worst outcomes: The Perfect Storm:
 24% experience 7+ annual breaches  Complexity rivals large enterprises
 Only 27% achieve rapid detection  Resources remain mid-market
 46% report increased supply chain risks  Manual processes break down
 42% take 31–90 days to detect breaches  Professional attackers take notice
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 62.
...
inflection point where organizations must abandon incremental Band-Aids:
improvements for transformative change.
Why Half
Five Transformative Actions Measures
1. Achieve Total Visibility Now Cost
...
single-digit adoption rates, manual processes guarantee failure. Leading 60/81 Rule:
...
Basic encryption no longer suffices. Winners implement comprehensive Saves 60%,
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 64.
...
organization choose?
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 65.
...
suitability, or availability of the information contained in this report. Any reliance you place on
such information is strictly at your own risk. None of the sponsoring or contributing organizations
shall be liable for any loss or damage including without limitation, indirect or consequential loss
or damage, or any loss or damage whatsoever arising from loss of data or profits arising out of, or
in connection with, the use of this report. Readers should consult with qualified legal counsel and
cybersecurity professionals when addressing specific compliance requirements.
The data in this report was analyzed using AI and the content was generated with AI assistance.
While AI enhances analytical capabilities, it can occasionally produce errors or biased information
that should be considered when reviewing these findings.
About Centiment
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 67.

2025 Annual Survey Report
Collection Period: Industries:
March-April 2025  Defense and Security  Legal/Law
 Education  Life Sciences/Pharmaceuticals
Sample Size:
...
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 68.
...
| --- | -------- | ---- | ------- | ---------------- |
advanced PETs
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 69.

2025 Annual Survey Report
Appendix C:
Tool Usage by Region
|     |     | File Sharing and  | Managed File  | Secure File  |     |
| --- | --- | ----------------- | ------------- | ------------ | --- |
Region Chat Email Collaboration  Transfer   Transfer Protocol  Web Forms
|     |     | Platforms | (MFT) | (SFTP) |     |
| --- | --- | --------- | ----- | ------ | --- |
APAC
| (Australia, NZ,  | 6% 46% | 44% | 32% | 74% | 18% |
| ---------------- | ------ | --- | --- | --- | --- |
Singapore)
Europe (UK,
France,
| Germany,  | 11% 45% | 53% | 43% | 78% | 19% |
| --------- | ------- | --- | --- | --- | --- |
Austria,
Switzerland)
Middle East
| (Israel, UAE,  | 13% 71% | 49% | 49% | 73% | 27% |
| -------------- | ------- | --- | --- | --- | --- |
Saudi Arabia)
North America
|     | 12% 56% | 58% | 53% | 77% | 31% |
| --- | ------- | --- | --- | --- | --- |
(U.S., Canada)
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 70.

2025 Annual Survey Report
Appendix D:
Tool Usage By Industry
Secure File
|          |            | File Sharing and  | Managed         |       |           |       |
| -------- | ---------- | ----------------- | --------------- | ----- | --------- | ----- |
|          |            |                   |                 |       | Transfer  | Web   |
| Industry | Chat Email | Collaboration     | File Transfer   | Other |           |       |
|          |            |                   |                 |       | Protocol  | Forms |
|          |            | Platforms         | (MFT)           |       |           |       |
(SFTP)
Defense and
...
| ----------------------------------------------- | ------ | --- | --- | --- | --- | --- |
| DATA SECURITY AND COMPLIANCE RISK REPORT SERIES |        |     |     |     |     | 71. |
...
| Chat                                      | 5.07 | 5.48 |
References:
1 “AI Data Security and Compliance Risk Report,” Kiteworks, June 2025.
2 “The 2025 AI Index Report,” Stanford, April 2025.
DATA SECURITY AND COMPLIANCE RISK REPORT SERIES 72.

2025 Annual Survey Report
Copyright © 2025 Kiteworks. Kiteworks’ mission is to empower
organizations to effectively manage risk in every send, share,
receive, and use of private data. The Kiteworks platform
provides customers with a Private Data Network that delivers
data governance, compliance, and protection. The platform
unifies, tracks, controls, and secures sensitive data moving
within, into, and out of their organization, significantly
improving risk management and ensuring regulatory
compliance on all private data exchanges. Headquartered in
