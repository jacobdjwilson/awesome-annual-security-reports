...
![Cover image depicting a stylized brain with circuit patterns, symbolizing AI risks and navigation.](image-01.png)
...
This timeline highlights key AI tech milestones, risks related to AI use, new adversarial tools and techniques, known attacks and breaches, and new AI security measures and legislation throughout 2024.
...
- **OCT**: Lawsuit filed against Character.ai states that AI companion chatbot to blame for teenager’s suicide
...
Although constantly fine-tuned and improved, GenAI models still suffer from occasional hallucinations, where they output misleading information, refer to non-existing objects, or present events that never happened as facts. This lack of accuracy is intrinsic to the