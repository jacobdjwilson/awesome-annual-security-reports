...
- [Claims and loss trends](#claims-and-loss-trends)
- [Cyber insureds take back control and gain momentum against attackers, but challenges remain](#cyber-insureds-take-back-control-and-gain-momentum-against-attackers-but-challenges-remain)
- [Ransomware migrates to mid-sized and less well-protected firms as threat actors adapt to hardened cyber security](#ransomware-migrates-to-mid-sized-and-less-well-protected-firms-as-threat-actors-adapt-to-hardened-cyber-security)
- [Data exfiltration ranks as top loss driver](#data-exfiltration-ranks-as-top-loss-driver)
- [The rise of social engineering – threat actors target employees as the weakest link](#the-rise-of-social-engineering--threat-actors-target-employees-as-the-weakest-link)
- [Keys to the kingdom: Credentials overtake malware](#keys-to-the-kingdom-credentials-overtake-malware)
- [AI driving more effective social engineering and malware](#ai-driving-more-effective-social-engineering-and-malware)
- [Retailers becoming the most targeted sector](#retailers-becoming-the-most-targeted-sector)
- [CBI/supply chain emerges as a key threat](#cbisupply-chain-emerges-as-a-key-threat)
- [Expanding risk landscape drives non-attack losses](#expanding-risk-landscape-drives-non-attack-losses)
- [Tech failure and outages make first large claims appearance](#tech-failure-and-outages-make-first-large-claims-appearance)
- [Privacy regulation and litigation continues to develop](#privacy-regulation-and-litigation-continues-to-develop)
- [Detection, response and training](#detection-response-and-training)
- [Reducing the cost of a claim](#reducing-the-cost-of-a-claim)
- [Widening gap: Insureds grow more resilient](#widening-gap-insureds-grow-more-resilient)
- [Be prepared with tabletop exercises](#be-prepared-with-tabletop-exercises)
- [Ransomware attacks highlight need for BI workarounds](#ransomware-attacks-highlight-need-for-bi-workarounds)
- [The transformative power of AI-powered detection](#the-transformative-power-of-ai-powered-detection)
- [Regulation set to raise the cyber resiliency bar](#regulation-set-to-raise-the-cyber-resiliency-bar)
- [Insurance market trends](#insurance-market-trends)
...
This resilience gap reflects cyber insurance policyholders’ heightened awareness of risk and their actions to mitigate it, many of which are a condition of obtaining insurance. It also reflects the effectiveness of risk prevention services and advice and incident response assistance provided by insurers. Regular tabletop exercises and preparedness training can improve response effectiveness, minimizing business interruption, which accounts for over 50% of cyber claim values. Business interruption losses are closely corelated to early detection and containment and incident response, and business continuity planning will significantly reduce costs. Conversely, weak communication, coordination and indecision can prolong the impact of an event.
...
| Category | 2025 (6M) | 2024 | 2023 | 2022 | 2021 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Attack-driven losses (with data exfiltration) | 41% | 25% | 32% | 37% | 42% |
| Attack-driven losses (without data exfiltration) | 19% | 15% | 25% | 20% | 39% |
| Non-attack data breaches | 6% | 18% | 21% | 15% | 14% |
| Business interruption (technical failure) | 10% | 29% | 8% | 7% | 6% |
| CBI/supply chain | 25% | 6% | 15% | 19% | 15% |
| Tech/media professional indemnity | 15% | 14% | 37% | 6% | 15% |
...
Ransomware is now disproportionately affecting mid-sized and smaller organizations. According to telecoms firm, Verizon, ransomware was a component of 88% of data breaches involving small and medium-sized firms, compared with 39% of breaches at large firms.

---

## Data exfiltration ranks as top loss driver
As large companies have improved their response capabilities, recent years have seen a shift from purely extortion-based ransomware attacks to double extortion including data exfiltration. Around 40% of large cyber claim (>€1mn) by value during 1H, 2025 included data exfiltration, up on 25% for the full year 2024.
...
1. **Information gathering**: Prior to attacks, scammers often utilize information shared on social media, such as an employee’s job title or responsibilities, in order to deliver a convincing impersonation.
2. **Building trust or creating urgency**: Hackers can either spend time building rapport to gain a person’s trust or introduce a sense of urgency by creating a fake emergency to get the victim to take action.
3. **Exploitation**: After their targets have either begun to trust them or respond to a fake emergency, hackers then trick people into turning over sensitive information.
4. **Covering their tracks**: Once their goal is achieved, hackers can look to erase any sign of their activities.

---

## Keys to the kingdom: Credentials overtake malware
Related to social engineering and phishing is the growing use of access credentials, such as usernames and passwords, as the initial point of access in a cyber-attack. Compromised credentials is now the most common attack vector.
...
Retailers top the list of industries attacked during 1H, 2025 and are the third most impacted sector by cyber incidents, behind manufacturing and professional services.

### Most impacted industries according to large cyber claims (>€1mn)
*Percentage share according to value of claims:*
- Manufacturing: 33%
- Professional services and consulting: 18%
- Retail: 9%
- IT service provision: 7%
- Food and beverage: 6%
- Entertainment: 6%
...
A key trend over the past 18 months has been the emergence of claims related to growing dependencies of IT supply chains. Contingent business interruption (CBI) supply chain events accounted for 15% of large cyber claims (>€1mn) by value in 1H, 2025, compared with 6% in 2024.
...
While attack-driven losses continue to drive cyber insurance claims, losses from technical faults and data privacy liability are accounting for a greater proportion than previously – a record 28% of the value of large claims (>€1mn) analyzed in 2024. Business interruption due to technical failure was present for the first time in Allianz Commercial’s large loss claims data in 2024.

---

## Privacy regulation and litigation continues to develop
Non-attack data breaches and privacy actions, such as wrongful collection and processing of data, have increased in relevance in recent years, accounting for a record 18% of cyber claims by value in 2024.

### AI liability and litigation exposures
Artificial intelligence (AI) is a hot topic among insureds, as organizations come under competitive pressure to adopt AI tools in an evolving regulatory environment. In addition to its role in cyber security, AI is also likely to drive future liability exposure and claims. For example, AI systems could facilitate breach of privacy regulation through unauthorized collection and use of data.
...
Recent cyber-attacks have demonstrated the value of good cyber hygiene and detection and response capabilities, as well as the need for adequate training programs for employees. Analysis of Allianz Commercial claims shows how basic controls – such as patching, segmentation, backups and the use of multi-factor authentication (MFA) can make all the difference preventing and mitigating cyber losses.

### €20,000 or €20mn? How early detection and response can make all the difference
- **Incident outcome 1**: One or more of the employees’ computers is successfully attacked. The attack is detected and contained early. Costs: Approximately €20,000.
- **Incident outcome 2**: The attacker is not detected and contained early and is able to successfully gain a foothold in the company’s IT system. Costs: Approximately €20mn (1,000 times more).

---

## Widening gap: Insureds grow more resilient
The cyber-resilience gap between uninsured and insured organizations continues to widen. In Germany, insurance industry figures show that the loss impact of cyber insureds increased by around 70% over four years, well below the 250% increase in the economic impact of cyber crime during the same period.

---

## Be prepared with tabletop exercises
Tabletop exercises prepare companies for a cyber incident and give them confidence in their response plans. Businesses and the threat landscape are constantly changing, so regular resilience training and preparation will help people feel capable when something happens.

---

## Ransomware attacks highlight need for BI workarounds
BI remains the largest single driver for loss for cyber claims, accounting for over 50% of the value of losses. Cyber and business interruption were the top two risks of concern in this year’s Allianz Risk Barometer.

---

## The transformative power of AI-powered detection
Artificial intelligence (AI) is helping to transform cyber security, speeding up and automating threat detection and response, as well as helping organizations identify vulnerabilities and increase resilience. On average, organizations that used AI and automation in prevention saved US$2.2mn in breach costs, versus those that did not.

---

## Regulation set to raise the cyber resiliency bar
New regulations like the EU’s Digital Operational Resilience Act (DORA) and the Network and Information Security Directive (NIS2) aim to raise cyber security standards across critical sectors, including supply chains.

---

## Insurance market trends
The global cyber insurance market is expected to more than double to nearly US$30bn by the end of the decade, driven by increasing digitalization and growing awareness. Despite relatively low penetration, demand is rising, especially among mid-sized firms and regions with a historically low uptake.

[^1]: Qantas data breach, July 2025.
[^2]: UK National Crime Agency, July 2025.
[^3]: CrowdStrike Global Threat Report 2025.
[^4]: BlackFog Q1 2025 Ransomware Report.
...
[^8]: Sophos State of Ransomware 2025.
[^9]: AT&T data breach reports, 2024.
[^10]: AT&T class action settlement, August 2025.
[^11]: Verizon Data Breach Investigations Report 2024.
[^12]: Cybereason Cyber Incident Report 2025.
[^13]: Verizon Data Breach Investigations Report 2025.
[^14]: CrowdStrike Threat Intelligence 2024.
[^15]: CrowdStrike Incident Response Analysis 2025.
[^16]: CrowdStrike Global Threat Report 2025.
[^17]: Cybereason Security Report 2025.
[^18]: Research on AI-generated phishing, 2024.
[^19]: Louis Vuitton cyber-attack reports, 2025.
[^20]: Jaguar Land Rover incident report, September 2025.
[^21]: World Economic Forum Supply Chain Cyber Resilience Report 2025.
[^22]: CrowdStrike Cloud Threat Report 2025.
[^23]: H&M IT outage report, 2025.
[^24]: Volkswagen data breach report, 2024.
[^25]: Economic impact report, Spain/Portugal blackout 2025.
[^26]: Duane Morris Data Privacy Litigation Report 2024.
[^27]: BakerHostetler Data Privacy Law Forecast 2026.
[^28]: Precedence Research MDR Market Forecast 2034.
[^29]: IBM Ransomware Trends 2024.
[^30]: FBI IC3 Internet Crime Report 2024.
[^31]: German Insurance Association (GDV) Cyber Impact Report 2025.
[^32]: World Economic Forum Global Cybersecurity Outlook 2025.
[^33]: Marks & Spencer financial results 2025.
[^34]: Co-operative Group cyber incident report 2025.
[^35]: International Data Corporation (IDC) IT Skills Gap Report 2026.
...
DE TECTION, RE SPONSE  AND  T RA INING
...
The global cyber insurance market is predicted to more than double to
...
IBM, IBM report: Escalating data breach disruption pushes costs to new highs, July 30, 2024
...
IBM, Research finds 56% increase in active ransomware groups, November 18, 2024
...
International Data Corporation, IT skills shortage expected to impact nine out of ten organizations by 2026 with
