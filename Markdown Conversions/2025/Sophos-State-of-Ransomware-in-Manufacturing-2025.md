...
- The average (median) ransom demand made to manufacturing and production organizations has fallen 20% over the last year, coming in at $1.2 million in 2025 compared to $1.5 million in 2024.
- The average (median) ransom paid by manufacturing and production organizations has also dropped, coming in at $1 million in 2025 compared to $1.2 million in 2024.
...
### Business impact of ransomware
- The average cost for manufacturing and production organizations to recover from a ransomware attack dropped by 24% over the last year, coming in at $1.3 million, down from $1.7 million in 2024.
...
- 47% cited increased anxiety or stress.
- 45% reported a change of team priorities/focus.
- 44% reported increased pressure from senior leaders.
- 41% cited an increased workload and changes to team/organizational structure.
- 40% cited feelings of guilt.
- 27% saw team leadership replaced.
- 20% experienced staff absence due to stress/mental health issues.
...
Exploited vulnerabilities are the leading root cause of ransomware attacks on manufacturing and production organizations, responsible for 32% of incidents.
...
This year’s report explores for the first time the organizational factors that left manufacturing and production organizations exposed to attacks.

![Chart 3: Operational root cause of ransomware attacks on manufacturing and production organizations]

A lack of expertise is the most common individual reason given (42.5%), followed by unknown security gaps (41.6%) and a lack of protection (41%).
...
Data encryption in manufacturing and production is at its lowest reported rate in the five years of our study (40%).

![Chart 5: Data encryption rate in ransomware attacks on manufacturing and production organizations 2021 - 2025]

### Data theft
Within the manufacturing and production sector, 15% of all ransomware victims and 39% of those that had data encrypted experienced data theft.

![Chart 6: Data encryption and theft by industry]

### Extortion-style attacks
The percentage of manufacturing and production organizations that did not have data encrypted but were held to ransom anyway (extortion) surged to 10% of attacks in 2025 from just 3% in 2024.

### Recovery of encrypted data in manufacturing and production
91% of manufacturing and production organizations that had data encrypted were able to recover it.
...
The average (median) ransom demand dropped 20% to $1.2 million.

### Manufacturing and production ransom payments
The average (median) ransom paid dropped to $1 million.
...
### Recovery costs in manufacturing and production organizations
The average recovery cost dropped 24% to $1.3 million.

![Chart 11: Ransomware recovery cost split by industry]

### Recovery time in manufacturing and production
58% of organizations recovered within a week in 2025, up from 44% in 2024.
...
The survey makes clear that having data encrypted in a ransomware attack has significant repercussions for IT and cybersecurity teams.
...
- **Prevention**: Take steps to eliminate the technical and operational root causes highlighted in this report.
- **Protection**: Ensure endpoints and servers are well defended, including dedicated anti-ransomware protection to stop and roll back malicious encryption.
- **Detection and response**: Around-the-clock threat detection and response is now an essential layer of defense. If you lack the resources or skills to deliver this in-house, look to work with a trusted managed detection and response (MDR) provider.
- **Planning and preparation**: Have an incident response plan, make quality backups, and regularly practice restoring data from them.
