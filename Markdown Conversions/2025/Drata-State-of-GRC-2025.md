...
![Chart showing distribution of manual vs automated GRC functions: 32% All manual, 31% Mostly manual, 20% Equally manual & automated, 9% Mostly automated, 7% All automated]

Out of all companies surveyed, 93% would like to see more critical aspects of GRC functions become automated that are manual today. The reason: Manual interventions account for 14 hours per week on average, with the Retail sector spending more than 19 hours per week on average in cumbersome manual work.
...
Yet, survey results demonstrate that most GRC programs are not where they need to be in terms of maturity. 41% of companies see themselves at an adolescent stage, monitoring and scaling, or shy of full maturity (37%).

### Trends to drive maturity:
1. **91%**: Adding a dedicated GRC leader to oversee strategy and drive outcomes.
2. **38%**: Making revenue growth a key priority for GRC investments and programs.
3. **33%**: Building strong GRC programs to safeguard the company’s brand and demonstrate commitment to security.
4. **98%**: Transparently sharing GRC impact to build trust internally and externally.
5. **74%**: Moving from a reactive to proactive stance in protection, communication, and showcasing ROI.
...
- **Continuous monitoring**: Utilizes real-time data and automated processes to provide ongoing oversight.
- **Risk assessment & mitigation**: Helps identify, categorize, and manage potential risks.
- **Compliance management**: Ensures adherence to relevant laws, regulations, and industry standards.
- **Transparency & communication**: Facilitates sharing security information with stakeholders.
- **Performance management**: Provides tools for assessing and improving program maturity.
- **Automation & efficiency**: Leverages technology to streamline processes and reduce manual effort.
- **AI assisted questionnaire response**: Streamlines the inbound security review response process.
- **Robust CRM integrations**: Share the right trust reports with the right customers and prospects.
- **Analytics dashboards**: Demonstrate the impact of security and GRC enabled revenue.
