...
*   **THE MACHINE IDENTITY EXPLOSION FUELS PRIVILEGE SPRAWL**:
    ...
    *   68% of machine identities have access to sensitive data.
...
![Figure 1. Key trends highlighting the impact of AI, machine identity and silos on identity risk (n=2,600).](Image description)
...
![Figure 2. AI is both a powerful ally and a potential liability (n=2,600).](Image description)
...
![Figure 3. Top processes respondents are considering for securing identities with AI (n=2,600).](Image description)
...
![Figure 4. Use cases and LLM applications (n=2,600).](Image description)
...
![Figure 5. AI adoption is outpacing security controls (n=2,600).](Image description)
...
*   Public cloud environment: 66%
*   Specialized on-premises machines: 59%
*   External service: 53%

*   Public cloud environment: 77%
*   Specialized on-premises machines: 71%
*   External service: 63%
...
*   Technology: 58%
*   Education: 58%
*   Other commercial sector: 50%

![Figure 6. Organizations are likely to use multiple approaches across sectors when hosting their AI models (multi-select question; n=2,600).](Image description)
...
*   Lack of relevant expertise within the organization: 60%
*   Manipulation of AI agent behavior by unauthorized access: 56%
*   AI agents accessing critical or sensitive resources: 40%
*   Impact on business resilience: 33%

![Figure 7. The top challenges organizations face with AI agents (multi-select question; n=2,600).](Image description)
...
*   37% of human users have sensitive access.
*   42% of machine identities have sensitive access.
*   88% of respondents define ‘privileged user’ as human-only.

![Figure 8. Machine identities outpace humans in volume and access risk (n=2,600).](Image description)
...
![Figure 9. Organization-wide definition of privileged identity (n=2,600).](Image description)
...
![Figure 10. The projected proliferation of identities beyond AI (n=2,600).](Image description)
...
*   Privileged access management (PAM) and least privilege controls are critical to ensure that every identity has only the necessary access rights required for their role.
...
Which of the following, if any, have created identity silos in your organization? (Multi-select question)
...
![Figure 11. The causes of identity silos in organizations (n=2,600).](Image description)
...
![Figure 12. Respondents’ level of visibility across their cloud environment (n=2,600).](Image description)
...
![Figure 13. Identity security controls across different environments (n=2,600).](Image description)

**WHAT WE ASKED**

What are your organization’s top strategic security priorities in 2025? (Multi-select question)
...
![Figure 14. Identity security priorities for 2025 (n=2,600).](Image description)
