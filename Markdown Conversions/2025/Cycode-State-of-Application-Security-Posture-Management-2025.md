...
Written by Lior Levy, CEO of Cycode, and signed by Roland Cloutier, Former CSO at TikTok.
...
- [Key Insights](#key-insights)
  - [Insight 1 - GenAI is Exacerbating the Unmanageable Attack Surface](#insight-1---genai-is-exacerbating-the-unmanageable-attack-surface)
  - [Insight 2 - Tool Sprawl Continues to Fuel AppSec Chaos](#insight-2---tool-sprawl-continues-to-fuel-appsec-chaos)
  - [Insight 3 - Blindspots are Growing as Code Volume Surges](#insight-3---blindspots-are-growing-as-code-volume-surges)
  - [Insight 4 - Security Leaders are Losing Track of Their Budgets](#insight-4---security-leaders-are-losing-track-of-their-budgets)
  - [Insight 5 - Securing Code Must be a Priority in 2025](#insight-5---securing-code-must-be-a-priority-in-2025)
  - [Insight 6 - AppSec Tool Sprawl is Stretching the Talent Gap](#insight-6---appsec-tool-sprawl-is-stretching-the-talent-gap)
  - [Insight 7 - Compliance is Forcing Change in AppSec](#insight-7---compliance-is-forcing-change-in-appsec)
  - [Insight 8 - The Relationship Between Security and Developer Teams Remains Strained](#insight-8---the-relationship-between-security-and-developer-teams-remains-strained)
  - [Insight 9 - Security Teams are Already Taking Steps to Combat Tool Sprawl](#insight-9---security-teams-are-already-taking-steps-to-combat-tool-sprawl)
  - [Insight 10 - ASPM Platforms are Helping Teams Collaborate, Combat Alert Fatigue, and Focus on the Risks that Matter Most](#insight-10---aspms-platforms-are-helping-teams-collaborate-combat-alert-fatigue-and-focus-on-the-risks-that-matter-most)
- [How Can Cycode Help?](#how-can-cycode-help)
- [About Cycode](#about-cycode)

## Executive Summary

The 2025 State of ASPM Report marks the second annual study from Cycode, building on the industry’s first ASPM report released last year.
...
*   **GenAI is Exacerbating the Unmanageable Attack Surface**: 59% of security professionals agree that today’s attack surface is unmanageable, with GenAI and code security emerging as the top blindspots.
...
Cycode commissioned an independent, vendor-agnostic survey of 701 CISOs, AppSec Directors, and DevSecOps managers across the UK, US, and Germany, with 50% of respondents working within companies with 5,000+ employees.

*   **Survey conducted in November 2024**
*   **700 Respondents**
*   **Market**: US, UK, Germany
*   **Respondent Roles**:
    *   40% CISO
    *   40% AppSec Team
    *   20% DevSecOps Team
...
*   Insight 1 - GenAI is Exacerbating the Unmanageable Attack Surface
*   Insight 2 - Tool Sprawl Continues to Fuel AppSec Chaos
*   Insight 3 - Blindspots are Growing as Code Volume Surges
*   Insight 4 - Security Leaders are Losing Track of Their Budgets
*   Insight 5 - Securing Code Must be a Priority in 2025
*   Insight 6 - AppSec Tool Sprawl is Stretching the Talent Gap
*   Insight 7 - Compliance is Forcing Change in AppSec
*   Insight 8 - The Relationship Between Security and Developer Teams Remains Strained
*   Insight 9 - Security Teams are Already Taking Steps to Combat Tool Sprawl
*   Insight 10 - ASPM Platforms are Helping Teams Collaborate, Combat Alert Fatigue, and Focus on the Risks that Matter Most
...
This highlights the urgent need for organizations to rethink how they manage and secure their applications. It’s no wonder 72% of security leaders agree that the age of AI necessitates a complete overhaul in how organizations approach application security.
...
AppSec Chaos continues to prevent organizations from managing risks, fostering collaboration, and delivering secure software at scale.
...
**35%** of organizations are allocating the lion’s share of their security budget to the evaluation of security tools and technology.
...
**67%** of security professionals say managing multiple different security tools is challenging
...
1.  Visibility into security & risk posture (45%)
2.  Software supply chain security (39%)
3.  Velocity of development teams (38%)
...
*   GenAI (71%)
*   Exponential Increase in Code (70%)
*   Secret Detection (68%)
...
**50%** of security professionals surveyed who currently use under 20 security tools across their security and developer teams.
**73%** of respondents with 81-100 security tools in use.
...
**77%** of security professionals admit their organization lacks a full understanding of where their annual budget is being spent.

This disconnect becomes even more pronounced in organizations with large tool stacks. Among respondents with fewer than 20 tools in use, 57% report budget visibility challenges. However, this figure skyrockets to 90% among those with 61-80 tools and 87% among those with 81-100 tools. This highlights a troubling trend: the more tools an organization uses, the harder it becomes to track and justify spending.

> "My organization lacks a full understanding of where the annual budget is being spent."
...
*   **71%** in organizations with under 1k employees
*   **84%** in organizations with over 1k employees
...
Security professionals expect their budgets to increase by an average of **50%** over the next 12 months.

**63%** agree that CISOs don’t invest enough in code security
...
> "Code is everywhere, securing code is vital" (73% of respondents)

**86%** of respondents believe that ASPMs and CNAPPs are complementary solutions that shouldn’t come together as one platform.
...
**71%** of organizations stating that they have unfilled cybersecurity positions.
**71%** of security leaders say they have unfilled cybersecurity positions.

**39%** of security professionals say that a shortage of staff is holding them back from adopting new AppSec solutions.

**65%** of security professionals say they find balancing the shortage of talent with AppSec challenging.
...
> "I find balancing the shortage of talent with AppSec needs challenging."

*   **4 in 5** agree that having too many tools require specialist skills, and those skills that are increasingly difficult to find due to the ongoing cybersecurity talent gap.

| Number of tools | Under 20 | 20-40 | 41-60 | 61-80 | 81-100 |
| :-------------- | :------- | :---- | :---- | :---- | :----- |
| Challenging     | 61%      | 63%   | 48%   | 75%   | 82%    |
...
**56%** report that maintaining compliance is becoming more and more difficult.

**59%** agree that the increase in regulation has brought a sense of urgency to their organization’s security practices
...
Almost three quarters (74%) of security professionals surveyed agree¹ that the relationship between security and developers needs to improve.

**74%** of security professionals agree that the relationship between security and developers needs to improve
...
**Balance of Responsibility for Resolving Security Vulnerabilities:**
*   **Security Teams vs. Developer Teams**
    *   They are both equally responsible (48% AppSec Team, 51% DevSecOps Team)
    *   Security is responsible (26% AppSec Team, 25% DevSecOps Team)
    *   Developer is responsible (26% AppSec Team, 24% DevSecOps Team)

Clearly, more could be done to implement a culture of collaboration between these two teams. Unfortunately, this is something almost 7 in 10 (68%) security professionals surveyed find challenging.
...
> “It’s challenging implementing collaboration between security and developer teams.”

| Respondents with | Challenging |
| :--------------- | :---------- |
| under 20 security tools | 55%         |
| 81-100 security tools | 83%         |
...
**88%** of security leaders have consolidated all of their AppSec tools into a single platform in the next 12 months if given the opportunity.
...
**43%** Say they have consolidated all of their AppSec tools into a single solution.

Those who haven’t are also keen to take this step, with the findings also suggesting that budgets for 2025 will allow for this. See Insight #05.
...
Two-thirds (66%) of security professionals surveyed say it’s challenging to manage too many alerts.

It’s no surprise, then, that 65% struggle to know what vulnerabilities to fix. Likewise, 81% of security professionals report that they feel their developer teams are experiencing too many false positives and alert fatigue.

**66%** of security professionals say it’s challenging to manage too many alerts.
...
**90%** of security professionals with a commercial ASPM platform say their organization has a systematic way of understanding overall risk and are always working on the most important vulnerabilities.
...
**97%** who have consolidated their security tool stack have seen an improvement in their relationship with developers.
...
**Impact of Consolidating Tool Stack on Developer Relationships**

## How Can Cycode Help?

*   **5 Minutes**: Time to value and enhanced visibility
*   **99%**: Reduction in the number of critical vulnerabilities month over month
*   **200%**: Increase in remediated vulnerabilities
...
[BOOK A DEMO](https://cycode.com/state-of-aspm-2025/)