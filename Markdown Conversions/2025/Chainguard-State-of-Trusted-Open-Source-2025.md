...
- [Key Findings](#key-findings)
  - [AI is reshaping the baseline stack](#ai-is-reshaping-the-baseline-stack)
  - [Over half of production happens outside of the most popular projects](#over-half-of-production-happens-outside-of-the-most-popular-projects)
  - [Popularity doesn’t map to risk](#popularity-doesnt-map-to-risk)
  - [Compliance can be the catalyst for action](#compliance-can-be-the-catalyst-for-action)
  - [Trust is built on remediation speed](#trust-is-built-on-remediation-speed)
- [Methodology](#methodology)
- [Usage: What Teams Actually Run in Production](#usage-what-teams-actually-run-in-production)
  - [Most Popular Images: AI is Reshaping the Baseline Stack](#most-popular-images-ai-is-reshaping-the-baseline-stack)
  - [Most Popular by Region: Similar Foundations, Different Longtail Mix](#most-popular-by-region-similar-foundations-different-longtail-mix)
- [The Longtail of Images is Crucial to Production, Not Edge Cases](#the-longtail-of-images-is-crucial-to-production-not-edge-cases)
- [FIPS Usage: Compliance is a Catalyst for Action](#fips-usage-compliance-is-a-catalyst-for-action)
- [CVEs: Popularity Doesn’t Map to Risk](#cves-popularity-doesnt-map-to-risk)
- [Trust is Built on Remediation Speed (Detailed)](#trust-is-built-on-remediation-speed-detailed)
- [A New Baseline for Trusted Open Source](#a-new-baseline-for-trusted-open-source)
...
Python led the way as the most popular open source image among our global customer base, powering the modern AI stack.

### Over half of production happens outside of the most popular projects
Most teams may standardize on a familiar set of images, but real-world infrastructure is powered by a broad portfolio that extends far beyond the top 20 most popular, what we refer to in this report as *longtail images*.
...
## Methodology
Before we dive in, a note on our methodology: This report analyzes 1800+ unique container image projects, 10,100 total vulnerability instances, and 154 unique CVEs tracked from September 1, 2025, through November 30, 2025. When we use terms like “top 20 projects” and “longtail projects” (as defined by images outside of the top 20), we’re referring to real usage patterns observed across our customer portfolio and in production pulls.

![Chart: Report Methodology Overview]
...
![Chart: Most Popular Images by Region]
...
![Chart: Regional Image Portfolio Breakdown]
...
![Chart: CVE Distribution by Popularity]
...
## Trust is Built on Remediation Speed (Detailed)
...
![Chart: Trusted Open Source Baseline Summary]
