...
- [Publicly Exposed Services in Hospitality](#publicly-exposed-services-in-hospitality)
  - [Top 10 Exposed Ports](#top-10-exposed-ports)
    - [1. Port 161 (SNMP)](#1-port-161-snmp)
    - [2. Port 123 (NTP)](#2-port-123-ntp)
    - [3. & 10. Ports 443 / 8443 (HTTPS / Alt HTTPS)](#3--10-ports-443--8443-https--alt-https)
    - [4. Port 80 (HTTP)](#4-port-80-http)
    - [5. Port 22 (SSH)](#5-port-22-ssh)
    - [6. Port 2628 (DICT Protocol)](#6-port-2628-dict-protocol)
    - [7. Port 179 (BGP)](#7-port-179-bgp)
    - [8. Port 2000 (Cisco SCCP)](#8-port-2000-cisco-sccp)
    - [9. Port 53 (DNS)](#9-port-53-dns)
...
![An educational article about hotel booking types on a dark web forum](Image 1. An educational article about hotel booking types on a dark web forum)
...
![The landing page of a dark web-advertised travel agency](Image 2. The landing page of a dark web-advertised travel agency)
...
![Bar chart showing Credential Access Techniques. Brute Force T1110: 95.4%, Modify Authentication Process T1556: 3.6%, OS Credential Dumping T1003: 0.9%, Forced Authentication T1178: 0.1%.](Image of Credential Access Techniques bar chart)
...
![Bar chart showing Execution Techniques. User Execution T1204: 58.7%, Command and Scripting Interpreter T1059: 37%, Windows Management Instrumentation T1047: 2.5%, Scheduled Task/Job T1053: 1.8%.](Image of Execution Techniques bar chart)
...
![Bar chart showing Initial Access Techniques. Exploit Public-Facing Application T1190: 61.5%, Phishing T1566: 23.4%, Valid Accounts T1078: 15.1%.](Image of Initial Access Techniques bar chart)
...
![Pie chart showing Exploit Public-Facing Application techniques. CVE-2021-44228 Apache Log4J: 49%, Cross-Site Scripting: 26%, Directory Traversal Request Attempt: 20%, SQL Injection: 20%, CVE-2020-1472 Possible ZeroLogon attempt: 2%, CVE-2012-0158: 1%, CVE-2021-26897 Windows DNS Server Remote Code Execution Vulnerability: 1%, Java Object Deserialization: 1%, Remote Stack Overflow Vulnerability: 1%.](Image of Exploit Public-Facing Application pie chart)
...
![Bar chart showing Privilege Escalation techniques. Account Manipulation T1098: 73.7%, Valid Accounts T1078: 24.6%, Abuse Elevation Control Mechanism T1548: 1.8%.](Image of Privilege Escalation techniques bar chart)

### Discovery Techniques

Discovery techniques utilized by attackers relied mostly on account and network service discovery.

![Bar chart showing Discovery Techniques. Network Service Discovery T1046: 84%, Account Discovery T1087: 8.6%, Network Share Discovery T1135: 6.7%, System Network Configuration Discovery T1016: 0.6%.](Image of Discovery Techniques bar chart)
...
![Bar chart showing Command and Control Techniques. Web Service: 36.5%, Proxy T1090: 29.4%, Application Layer Protocol T1071: 23%, Ingress Tool Transfer T1105: 11.1%.](Image of Command and Control Techniques bar chart)
...
![Bar chart showing Defense Evasion Techniques. Access Token Manipulation T1134: 43.7%, Masquerading T1036: 33.8%, Impair Defenses T1562: 14.1%, Process Injection T1055: 8.5%.](Image of Defense Evasion Techniques bar chart)
...
![Bar chart showing Persistence techniques. Create Account T1136: 89.3%, Event Triggered Execution T1546: 5.4%, Boot or Logon Autostart Execution T1547: 3.6%, Server Software Component T1505: 1.8%.](Image of Persistence techniques bar chart)
...
![Bar chart showing Lateral Movement Techniques. Remote Services T1021: 85.2%, Use Alternate Authentication Material T1550: 13%.](Image of Lateral Movement Techniques bar chart)
...
![Bar chart showing Top 10 Values for: port. Port 161: 9627, Port 123: 5525, Port 443: 4372, Port 80: 4372, Port 22: 2402, Port 2628: 2178, Port 179: 1967, Port 2000: 1914, Port 53: 1130, Port 8443: 1066.](Image of Top 10 Exposed Ports bar chart)

#### 1. Port 161 (SNMP)

Count: 9,627

Usage: SNMP is used to monitor and manage hotel systems like HVAC, lighting, IP cameras,