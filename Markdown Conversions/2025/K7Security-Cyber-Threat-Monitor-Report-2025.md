Organization: K7Security  
Report Title: Cyber-Threat-Monitor-Report  
Year: 2025  

# K7 Cyber Threat Monitor: Q2 2025-26

## Table of Contents
- [Phishing's Evolving Disguise: Human-Centric Attacks](#phishings-evolving-disguise-human-centric-attacks)
- [Infection Rate (IR)](#infection-rate-ir)
- [Vulnerabilities and Industry Impact](#vulnerabilities-and-industry-impact)
- [Industries Under Siege: A Sector-by-Sector Threat Profile](#industries-under-siege-a-sector-by-sector-threat-profile)
- [Worldwide Cyber Threat Landscape](#worldwide-cyber-threat-landscape)
- [Windows Threat Landscape](#windows-threat-landscape)
- [Top Malware Targeting Windows Systems](#top-malware-targeting-windows-systems)
- [Unpatched Vulnerabilities: The Achilles' Heel of Windows Systems](#unpatched-vulnerabilities-the-achilles-heel-of-windows-systems)
- [Heuristic Host Intrusion Prevention System (HIPS)](#heuristic-host-intrusion-prevention-system-hips)
- [Cyber Threat Landscape - India](#cyber-threat-landscape---india)
...
- [The Mac Attack](#the-mac-attack)
- [The Prevalence of Trojans](#the-prevalence-of-trojans)
- [The Adware Brouhaha](#the-adware-brouhaha)
- [The Share of PUPs](#the-share-of-pups)
- [Vulnerabilities Galore](#vulnerabilities-galore)
- [Latest Security News](#latest-security-news)
- [Cyber Threats Executive Briefing: Q2 2025-26](#cyber-threats-executive-briefing-q2-2025-26)
...
![Infection Rate calculation and blocked threat notification diagram]
...
*(Risk Brackets: 10-18%, 19-26%, 27-35%)*
...
- **Adw.Win32.Cpp**: 41%
- **Hack.Win32.AddUser**: 23% *(variants combined)*
- **Hack.Win32.MSIL.IdleKMSS**: 9%
- **Hack.Win64.KMSS**: 8%
- **Unwanted.Adw.Win32.E**: 6%
- **Adw.Win32.M**: 5%
- **Unwanted.Downloader.Win32.E**: 4%
...
- **MS17-010 SMB TRANS2**: 42%
- **MS17-010 SMB TRANS2 (CRYPTOWORM)**: 17%
- **MS17-010 eternalblue**: 16%
- **Block Malicious IP**: 5%
- **Log4j Security Vulnerabilities**: 4%
- **SMB Remcom Service**: 3%
- **MS17-010 zzzexploit_worawit_EternalBlue**: 2%
- **Lateral network worm_DOC001.EXE**: 2%
- **Block Powershell Remoting Port**: 2%
- **SMBV3 Remote Code Execution**: 1%
...
- **Susp_Powershell**: 18%
- **Susp_dropper**: 14%
- **Susp_LolBin_Write_PE**: 12%
- **Impair_Windows_Security**: 5%
- **Injector**: 5%
- **Susp_Obfuscate**: 4%
...
![Geographic map of India showing regional infection rates across cities and states, ranging from 10% to 21%]
...
- **Ahmedabad**: ScanEngine (86%), Behaviour (4%), Firewall (10%)
- **Bengaluru**: ScanEngine (85%), Behaviour (4%), Firewall (11%)
- **Chennai**: ScanEngine (86%), Behaviour (4%), Firewall (10%)
- **Delhi**: ScanEngine (87%), Behaviour (2%), Firewall (11%)
- **Hyderabad**: ScanEngine (86%), Behaviour (3%), Firewall (11%)
- **Kolkata**: ScanEngine (88%), Behaviour (1%), Firewall (11%)
- **Mumbai**: ScanEngine (86%), Behaviour (4%), Firewall (10%)
- **Pune**: ScanEngine (84%), Behaviour (2%), Firewall (14%)
...
- **Ludhiana / Mathura**: ~20%
- **Bhubaneswar / Guwahati / Jaipur / Jammu / Kurnool / Lucknow / Mangaluru / Patna / Rajahmundry / Thrissur / Vijayawada / Visakhapatnam**: 13% - 18% range
...
In one of our enterprises’ networks, Purplefox malware was attempted to be installed using SMB. The kill-chain is as detailed below:
1. Threat actors discover SMB shares exposed to the internet, beaconed by multiple Keygens and KMSAuto being used by customers.
2. Threat actors then bruteforce themselves into the enterprise’s network.
3. Network settings are changed for installing the RDPWrap application for better remote access.
4. Firewall is turned off, and threat actors reassign the server’s port numbers.
5. The PAExcel tool is then used to remotely create a service, which in turn downloads the Purplefox malware.
...
For CXOs, C-level leaders, and SMB decision-makers alike, these developments underscore the urgent need to review and strengthen security frameworks regardless of organizational scale. The landscape has moved beyond low-risk nuisances; sophisticated, Trojan-driven attacks now represent the primary threat to both corporate and SMB digital assets.
...
- **Downloaders**: 24%
- **CoinMiners**: 13%
- **Ngrok (Reverse-tunneling tools)**: 13%
- **Riskware (Meterpreter)**: 8%
- **Spyware (Monitors & Packed executables)**: 8%
- **Miscellaneous / Other PUP variants**: 34% combined

While often overshadowed by Trojans, Potentially Unwanted Applications (PUAs) introduce significant backdoor risks that demand strategic oversight. Within this category, Downloaders are the most prevalent at 24%, acting as gateways for more malicious software. In comparison, CoinMiners and reverse-tunneling tools like Ngrok (both at 13%) directly siphon corporate resources and create hidden network access points.
...
- **Microsoft SharePoint**
  ...
  - *MITRE*: T1055 (Process Injection), T1068 (Exploitation for Privilege Escalation)
...
- **Citrix NetScaler VPN/ADC**
  ...
  - *MITRE*: T1190 (Exploit Public-Facing Application), T1068 (Privilege Escalation)
...
- **Apple ImageIO Framework**
  ...
  - *MITRE*: T1566 (Phishing - Malicious Images), T1203 (Arbitrary Code Execution)
...
- **Microsoft SharePoint**
  ...
  - *MITRE*: T1055 (Process Injection), T1068 (Privilege Escalation)
...
- **Google Chrome Browser**
  ...
  - *MITRE*: T1203 (Arbitrary Code Execution), T1211 (Defense Evasion)
  ...
  - *MITRE*: T1203 (Arbitrary Code Execution), T1055 (Process Injection)
...
- **WinRAR Archive Tool**
  ...
  - *MITRE*: T1566 (Phishing - Malicious Archives), T1027 (Obfuscated Files or Information)
...
- **Git Version Control**
  ...
  - *MITRE*: T1195.001 (Compromise Software Dependencies and Development Tools), T1005 (Data from Local System)
...
- **Microsoft SharePoint**
  ...
  - *MITRE*: T1078 (Valid Accounts), T1550 (Use Alternate Authentication)
...
- **An Android App could reroute calls to Attackers**  
  A malware targeting Indian banking users has the capability to forward their calls to threat actors and execute malicious activities. *(Refer Spybanker for details)*
- **Cmimai – A Silent Stealer**  
  This covers Cmimai, a stealer Trojan that quietly gathers system info and browser data along with periodical screenshots, sending the exfiltrated data to Discord. *(Refer Silently Dangerous)*
- **BQTLock - Encrypting data using double-extortion mode**  
  BQTLock, a Ransomware-as-a-Service (RaaS) marketed on the dark web and social platforms like X and Telegram, encrypts files and demands ransoms in Monero (XMR) under a double-extortion mode. *(Refer BQTLock for more info)*
- **Deploying RAT through LNK Files**  
  A simple deceptive `.lnk` file hides a powerful Remote Access Trojan (RAT)—allowing attackers to steal data, execute remote commands, share screenshots, and maintain persistence via a Windows login entry. *(Refer LNKTrojan for more info)*
...
3. **Key Findings**  
   ...
   - *Platform-Specific Threats*: Windows remains the most targeted platform for enterprise attacks, focusing on credential theft and lateral movement. Android and macOS are increasingly targeted with sophisticated Trojans (86% of Android threats, 88% of macOS threats) aimed at stealing credentials and compromising corporate data.
