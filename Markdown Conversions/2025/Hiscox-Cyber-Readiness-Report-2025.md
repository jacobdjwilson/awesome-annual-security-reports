...
- [State of Attacks](#state-of-attacks)
- [Taking Action](#taking-action)
- [Cyber Resilience](#cyber-resilience)
- [AI and Future Threats](#ai-and-future-threats)
- [Mandatory Disclosures](#mandatory-disclosures)
- [Country Comparisons](#country-comparisons)
- [Cyber Security Tips for SMEs](#cyber-security-tips-for-smes)
...
But these opportunities also present challenges. As businesses embrace new technologies, they must also navigate a landscape where evolving cyber threats can jeopardise their success in new ways.

This ninth edition of the Hiscox Cyber Readiness Report is designed to help small- and medium-sized enterprises (SMEs) better understand the risks they face in our fast-evolving, technologically driven world, and the steps they can take to minimise their exposure to those risks. Having previously built and grown my own small business, it’s something I’m particularly passionate about.
...
When it comes to cyber security and business resilience, we cannot afford to rest on our laurels and consider our work finished. Instead, must maintain our collective resolve to overcome cyber crime, and prioritise an ongoing commitment to cyber risk management.
...
![Infographic highlighting that 83% reported improvement in cyber resilience, and 59% of SMEs faced a cyber attack over the past 12 months while investing, training, and updating systems.]

04

## Key Findings

- **59%** of respondents experienced a cyber attack in the last 12 months.
- **33%** were fined a significant amount after a cyber incident.
- **94%** are increasing investment in cyber security and data protection.
- **60%** are recruiting additional staff to increase their cyber resilience.
- **88%** conduct quarterly supplier and partner risk assessments.
- **91%** perform cyber vulnerability checks at least once a quarter.
- **27%** experienced a ransomware attack in the last 12 months.
- **71%** support mandatory disclosure of ransomware payments.
...
![Chart showing outcomes of attacks experienced by businesses in the past 12 months: 44% Payment diversion fraud, 42% Distributed denial of service, 42% IT resource misuse.]
...
> — **Ana Silva**, Head of PSC, Hiscox Iberia

### Key Cyber Risks
The top three biggest risks for organisations:
- **37%**: The inability to protect or internal data from breaches.
- **37%**: Regulatory or legislative changes around cyber security and data.
- **36%**: Any event where company data is potentially compromised.
...
> — **Mike Maletsky**, VP, Practice Leader, Technology and Cyber, Hiscox USA
...
- **87%**: Investing in training and experienced a cyber attack.
- **68%**: Investing in training but did not experience a cyber attack.
...
> — **Diva Aoun**, Head of Cyber, Hiscox Europe

### Improving Cyber Resilience
Organisations are safeguarding against future threats:
- **70%**: Hiring additional staff members to boost their cyber resilience.
- **60%**: Updating the types of cyber security training for employees.
- **54%**: Investing in software to help identify and manage threats.
...
> — **Nicolas Kaddeche**, Technical Underwriting and Direct Sales Director, Hiscox France
...
Companies can more effectively deal with cyber threats if employees are more aware of what those threats might be and what to do in the event of an attack. Nearly all who have experienced an attack (96%) believe better awareness or understanding of cyber attacks and procedures is key to better response times for future breaches.
...
- **37%**: Ensure insurance policies include AI.
- **36%**: Train employees on AI risks.
- **36%**: Perform regular AI usage audits.
- **33%**: Hire AI-savvy employees.
- **33%**: Employ AI security consultants.
...
> — **Alana Muir**, Head of Cyber, Hiscox UK
...
- **54%** say disclosures give customers and stakeholders a clearer picture of a company’s financial health.
- **52%** think increased transparency could help authorities respond to other ransomware incidents.

#### Opposition to Disclosure
- **53%** feel private firms should not be obligated to reveal financial details.
- **49%** warn that disclosures could incentivise bad actors to engage in ransomware schemes.

13

## Country Comparisons

| Cyber Vulnerability | Data Recovery | Regulation |
| :--- | :--- | :--- |
| Ireland (42%) had the lowest rate of experiencing a cyber attack in the last 12 months. Germany (67%) and the UK (65%) were most likely to experience at least one attack. | For those who paid a ransom, the USA (74%) had the highest rate of data recovery after a ransomware attack, with Ireland (53%\*) at the other end of the scale. | Portugal (86%) and Ireland (85%) are more confident in their company’s ability to adapt to new cyber security regulatory requirements compared to the USA (76%). |

| AI | Mandatory Disclosure | Insurance |
| :--- | :--- | :--- |
| Portugal (86%) is much more likely to view AI as a security asset rather than a vulnerability. The USA (58%) and the UK (59%) are less inclined to feel this way. | The USA (80%) has the strongest support for mandatory ransomware payment disclosure. Support is lower in Germany (65%), Portugal (65%) and Spain (62%). | Cyber insurance coverage – either as a stand-alone policy or as part of another policy – varies by country, with the lowest take-up rate in France at 61%. |

*\*Low base size; findings are directional.* 14
