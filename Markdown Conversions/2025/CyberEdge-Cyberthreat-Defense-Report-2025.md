...
3.  **Twists and Turns for Ransomware.** It’s hard to summarize the changing dynamics of ransomware this year. After rising for a decade, the percentage of organizations affected by ransomware fell for the second year in a row (good news J), but average ransom demands have continued to rise (bad news L). The percentage of victimized organizations that paid ransoms fell (probably good news J), but the percentage of ransom payers who recovered their data fell (bad news L). If you want to know the factors we think are behind these gyrations, see pages 20-22.
...
*   **Cloud complexity**: Organizations are struggling to cope with the challenges of defending hybrid multi-cloud environments (page 27).
...
![Figure 3: Percentage of organizations compromised by at least one successful attack in the past 12 months, by country.](placeholder_for_image_3)
...
> “We can’t say the patient is in perfect health, the sun is shining brightly, or we have emerged from the tunnel... but at least we can say that we have held the line, stanched the flood, turned the corner…okay, okay, no more metaphors.”

![Figure 4: Percentage of organizations compromised by at least one successful attack in the past 12 months, by number of employees.](placeholder_for_image_4)
...
![Figure 5: Percentage of organizations indicating that compromise by a successful cyberattack in 2025 is somewhat or very likely.](placeholder_for_image_5)
...
![Figure 6: Percentage of organizations indicating that compromise by a successful cyberattack in 2025 is somewhat or very likely, by country.](placeholder_for_image_6)

![Figure 7: Percentage of organizations indicating that compromise by a successful cyberattack in 2025 is somewhat or very likely, by industry.](placeholder_for_image_7)
...
![Figure 8: Perceived security posture by IT domain.](placeholder_for_image_8)
...
![Figure 10: Perceived adequacy of security capabilities by functional area.](placeholder_for_image_10)
...
One of the relatively bright spots was “Incident investigation and response,” which moved from the fifth position from the top last year to the second position this year. “Brand protection” also moved up, from eighth place to fifth.
...
![Figure 11: Relative concern for cyberthreats.](placeholder_for_image_11)

The threats doing the most to cause sleepless nights are not going to surprise you. Our leading nightmares are malware (with a score of 3.92 on a scale of 1 to 5), phishing (3.87), ransomware (3.83), “Account takeover and credential abuse attacks” (3.79), “Denial of service (DoS/DDoS) attacks” (3.74), and “Advanced persistent threats (APTs)/targeted attacks” (also 3.74). These are the same top six as last year, in exactly the same order, except for ransomware and ATO switching places in the third and fourth positions. These are the cyberthreats most directly connected with data breaches and extortion, i.e., the threats that produce the biggest monetary returns for adversaries.

The bottom (relatively least concerning) end of the list also changed very little over the past few years. The leaders there are “Attacks on brand and reputation in social media and on the web” (3.64), “Drive-by downloads/watering-hole attacks” (3.63), “Supply chain threats” (3.62), and “Zero-day attacks (against publicly unknown vulnerabilities)” (3.59).
...
![Figure 12: Threat Concern Index, depicting overall concern for cyberthreats.](placeholder_for_image_12)
...
![Figure 13: Most-concerning web and mobile application attacks.](placeholder_for_image_13)
...
![Figure 14: Organizations affected by a web or mobile application attack.](placeholder_for_image_14)

![Figure 15: Organizations affected by a web or mobile application attack, by industry.](placeholder_for_image_15)
...
![Figure 16: Percentage of organizations victimized by ransomware.](placeholder_for_image_16)

The percentage of organizations affected by ransomware fell for the second year in a