...
- [Section 2: Perceptions and Concerns](#section-2-perceptions-and-concerns)
  ...
  - [Attack Surface Management Challenges](#attack-surface-management-challenges)
  - [Challenges Caused by Hybrid, Multi-cloud Environments](#challenges-caused-by-hybrid-multi-cloud-environments)
...
- [Section 3: Current and Future Investments](#section-3-current-and-future-investments)
  ...
  - [Top Priorities for Improving Identity Security](#top-priorities-for-improving-identity-security)
  - [Preferences for AI in Security Products](#preferences-for-ai-in-security-products)
...
- [Section 4: Practices and Strategies](#section-4-practices-and-strategies)
  - [Frameworks and Standards Used to Assess Cybersecurity](#frameworks-and-standards-used-to-assess-cybersecurity)
  - [Impact of Implementing Zero Trust Network Access (ZTNA)](#impact-of-implementing-zero-trust-network-access-ztna)
  - [Information Regularly Reported to the Board of Directors](#information-regularly-reported-to-the-board-of-directors)
...
![Chart showing the percentage of organizations experiencing at least one successful attack and those experiencing six or more from 2016 to 2025.]
...
The pattern for the percentage of organizations experiencing six or more successful attacks was roughly the same. It climbed from 2016 to 2021, flattening out for two years, then dropping to a significantly lower plateau for the past two reports.

![Chart showing frequency of successful cyberattacks in the past 12 months: 18.4% not once, 53.0% between 1 and 5 times, 20.8% between 6 and 10 times, and 7.9% more than 10 times.]

### Future Likelihood of Successful Cyberattacks

![Chart showing the percentage of organizations indicating that compromise by a successful cyberattack in 2025 is somewhat or very likely, trending from 62.1% in 2016 to 64.0% in 2025.]
...
The pattern is roughly the same: rising, leveling out, then falling back a bit. Specifically, the percentage predicting a successful attack in the coming 12 months increased from 62.1% in 2016 to 76.1% in the 2022 CDR and has since fallen in steps to 64.0%.

### Security Posture by IT Domain

![Chart showing perceived security posture by IT domain, with Cloud applications (SaaS) at 4.07 and Mobile devices (smartphones, tablets) at 3.87.]

Cybersecurity teams need to protect many different types of devices, applications, and infrastructure components. Our survey asked respondents to rate their organization’s security posture in 13 of those domains.
...
![Chart showing perceived adequacy of security capabilities by functional area, ranging from 4.05 for Identity and access management to 3.95 for Third-party risk management.]
...
![Chart showing relative concern for cyberthreats, with Malware at 3.92 and Zero-day attacks at 3.59.]
...
![Chart showing most-concerning web and mobile application attacks: Account takeover (46.2%), PII harvesting (45.7%), Carding/payment fraud (38.9%), Digital skimming (27.8%), Ad fraud (22.5%), Denial of inventory (17.5%), and Hoarding attacks (15.2%).]
...
![Chart showing percentage of organizations victimized by ransomware from 2018 to 2025, showing a decline to 56.1% in 2025.]

The percentage of organizations affected by ransomware fell for the second year in a row, reversing the trend of the previous decade. The decline of 10.1% over two years is quite significant.

### Barriers to Establishing Effective Defenses

![Chart showing inhibitors to establishing effective defenses, with Low security awareness and Lack of skilled personnel tied at 3.55.]

Two inhibiting factors have traded places at the top of the list for many years now, and in this survey they ended in a tie for first: “Low security awareness among employees” and “Lack of skilled personnel” both came in at 3.55 on our scale of 1 to 5.

---

## Section 3: Current and Future Investments

*(Content omitted for brevity in this example, but would follow the same structure as above.)*
...
*(Content omitted for brevity in this example.)*
...
18 2019 2020 2021 2022 2023 2024 2025
...
Table of Contents IntroductionResearch HighlightsCurrent  Security PosturePerceptions  and ConcernsCurrent and Future InvestmentsPractices and  StrategiesThe Road AheadSurvey DemographicsResearch MethodologyResearch SponsorsAbout CyberEdge GroupOrganizations
that have
ASM challenges
...
Not surprisingly, another of the most serious challenges is
...
The top choice is “Security management” (selected by 44 1% of
...
These five were the leading five in the last CDR, too, but the order
...
Patch management will probably never go out of style  It
...
Table of Contents IntroductionResearch HighlightsCurrent  Security PosturePerceptions  and ConcernsCurrent and Future InvestmentsPractices and  StrategiesThe Road AheadSurvey DemographicsResearch MethodologyResearch SponsorsAbout CyberEdge GroupWe also gave respondents an option to select “We do not
...
The second type of information on the list is “Quantified
