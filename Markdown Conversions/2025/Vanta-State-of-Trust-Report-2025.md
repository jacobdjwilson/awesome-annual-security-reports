...
- [Risks are rising, but budgets aren’t budging](#01-risks-are-rising-but-budgets-arent-budging)
- [The AI readiness gap](#02-the-AI-readiness-gap)
- [Agentic AI adoption is high, but control is low](#03-agentic-AI-adoption-is-high-but-control-is-low)
- [Trust is a business imperative](#04-trust-is-a-business-imperative)
- [Third-party networks bring more risk and more reviews](#05-third-party-networks-bring-more-risk-and-more-reviews)
- [The promise of automation and AI](#06-the-promise-of-automation-and-AI)
...
- **Risk is higher, and ecosystems are leaking**: **72%** say overall risk is at an all‑time high (▲ 17% YoY), and more than half report a recent vendor breach (56%).
- **AI readiness lags adoption — governance is the gap**: **79%** are using or actively planning to use agentic AI. But 65% say their use of agentic AI outpaces their understanding of it—and only 48% have a framework in place to limit autonomy.
- **Pressure to prove trust is rising**: **82%** tie stronger security/compliance to higher trust. **77%** say stakeholders now demand verified proof of compliance.
- **Manual proof work is choking teams**: Almost 2/3 say they spend more time proving security rather than improving it. Teams now spend 12 weeks/year on compliance (▲ 1) and 9 weeks on vendor reviews (▲ 2).
- **Governed automation is the release valve**: **95%** report gains from AI/automation, with 1 in 2 seeing improved accuracy and faster assessments.

---

## 01 Risks are rising, but budgets aren’t budging
...
> 
> **72%** of security decision‑makers say risk has never been higher *(55% in 2024)*

### Organizations face mounting threats

**Threat encounter frequency:**
- **56%** At least once a week
...
| Threat Type | Companies up to 1,000 employees | Companies with 1,000+ employees |
| :--- | :--- | :--- |
| **Phishing** | 49% | 55% |
| **Malware** | 48% | 54% |
| **Identity theft/Fraud** | 47% | 55% |
...
> 
> **3 in 5** say AI threats outpace expertise *(67% in companies with 1,000+ employees)*
...
**The governance gap**
- **41%** Less than half apply strict data minimization
- **35%** Only 35% rely solely on anonymized data to train AI
- **31%** Only 31% use customer data to train AI and require opt‑in

**Rules and reviews are gaining traction**
- **44%** have developed and implemented a company AI policy *(vs 36% last year)*
- **45%** of teams conduct regular AI risk assessments and audits *(vs 37% last year)*
...
> 
> **Mohan Shamachar**, Director of Information Security and Compliance, RSI Security

---

## 03 Agentic AI adoption is high, but control is low
...
> **65%** believe use of agentic AI outpaces understanding of it

**Which tasks would be most effectively handled by an AI agent?**
- **35%** Forensic log analysis and timeline reconstruction
- **33%** Automated threat correlation and anomaly detection
- **31%** Generate compliance reports and audit logs
- **31%** Automated vulnerability scanning and prioritization
...
- **71%** Comfortable with agentic AI in an advisory role
- **61%** Comfortable with agentic AI overriding human decisions in some scenarios
...
- **48%** have developed a framework for granting or limiting autonomy in AI systems
- **62%** of organizations say agentic AI could erode customer trust

---

## 04 Trust is a business imperative
...
- **Security/compliance boosts trust**: **82%** (2025) vs **67%** (2024)
- **Stakeholders demand proof of security and compliance**: **77%** (2025) vs **65%** (2024)
...
- **61%** of respondents say they spend more time proving security rather than improving it
...
- **12 weeks a year on compliance** (2025)
- **11 weeks a year on compliance** (2024)
...
> 
> **Clementine Markman**, Founding Operations Lead, Granola

---

## 05 Third-party networks bring more risk and more reviews
...
- **9 working weeks** Teams spend 9 working weeks a year on vendor reviews—up from 7 last year
- **67%** say they have strong visibility into third‑party risk—but breaches are more common than ever

### Confidence vs lived reality

While 8 in 10 businesses are confident their vendors would inform them of a breach—that doesn’t mean breaches are any less common. In fact, a majority (56%) of organizations have had a vendor experience a data breach in the past 6‑12 months (up from 48% last year)[^1].

Security concerns are also why there’s an increase in partners parting ways: nearly 6 in 10 (57%) of businesses have terminated a vendor relationship due to security concerns in the past 6‑12 months—up from just 50% last year[^2].
...
- **80%** are confident vendors would disclose a breach
- **56%** have actually experienced a vendor breach *(from 48% in 2024)*
- **57%** have terminated a vendor over security concerns *(from 50% in 2024)*
...
> 
> **Marciano Kruithof**, VP of InfoSec, Bynder

---

## 06 The promise of automation and AI
...
> **95%** of businesses believe AI and automation have improved security team effectiveness
...
**Top AI benefits for security and compliance**
- **79%** say their security team is increasing its usage of AI in security programs
- **51%** Faster risk assessments
- **50%** Improved accuracy
- **48%** Faster incident response and remediation
- **48%** More time for strategic, high‑value work
- **40%** Better cross‑team visibility and collaboration
- **36%** Streamlined compliance
...
3. **Proactively demonstrate your security posture**  
