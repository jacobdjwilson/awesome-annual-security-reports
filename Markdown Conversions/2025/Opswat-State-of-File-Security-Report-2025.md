# State of File Security Report 2025
...
Content Disarm & Reconstruction (CDR) is a cybersecurity technology that removes unapproved objects without relying on malware detection. Unlike traditional malware analysis, CDR assumes all files could be malicious and rebuilds them using only the known safe elements.

![Figure 11. Reasons to use CDR]

Sandboxing is a practice of isolating potentially malicious software or code in a secure, controlled environment (a "sandbox") for analysis and testing without risking the main system or network.

![Figure 12. Reasons to use sandboxing]

Data Loss Prevention (DLP) helps prevent potential data breaches and regulatory compliance violations by detecting and blocking sensitive, out-of-policy and confidential data in files and emails.

![Figure 13. Reasons to use DLP]

File vulnerability refers to a weakness within a file or the way it is processed that can be exploited to compromise a system.

![Figure 14. Reasons to use file vulnerability assessment]

Threat intelligence is evidence-based knowledge that includes context, mechanisms, indicators, implications and actionable advice about an existing or emerging menace or hazard to assets.

![Figure 15. Reasons to use threat intelligence]

Country of origin refers to the nation where a software, hardware or digital service was developed manufactured or maintained.

![Figure 16. Reasons to use country of origin]

Software Bill of Materials (SBOM) is a detailed inventory of all closed and open-source components, libraries and dependencies in an application.

![Figure 17. Reasons to use SBOM]

### AI as part of organizations’ file security strategy

Organizations are using AI to reduce file security risks. Thirty-three percent of respondents say their organizations have made AI a part of their organizations’ file security strategy and 29 percent plan to add AI in 2026.

![Figure 18. The top reasons for using or planning to use AI]

Generative artificial intelligence (GenAI) refers to a category of AI algorithms that generates new outputs based on the large language models (LLMs) they have been trained on.

![Figure 19. Has your organization adopted GenAI?]
![Figure 20. Does your organization us GenAI to unlock files?]

AI workloads refer to the tasks and processes that AI systems perform. AI guardrails are sets of policies, rules, and mechanisms designed to ensure AI systems operate safely, ethically, and within defined boundaries.
...
A sampling frame of 18,602 IT and IT security practitioners in the United States, who are knowledgeable about their organizations’ approach to file security were selected as participants to this survey. Our final sample consisted of 612 surveys or a 3.3 percent response rate.
...
- **Sampling-frame bias**: The accuracy is based on contact information and the degree to which the list is representative of individuals who are cybersecurity and IT security practitioners.
