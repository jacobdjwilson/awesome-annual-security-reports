...
![Chart showing organizations experiencing data loss incidents in past 12 months](placeholder_for_chart_1)
*85.1% Organizations experiencing data loss incidents*
*14.9% Organizations experiencing data loss incidents in past 12 months*
*No data loss incidents in past 12 months*
...
*   58% say that careless employees or third-party contractors were a cause of data loss incidents.
...
*   Oversharing or overprivileged access to sensitive data: 39.7%
*   Use of sensitive data in AI training datasets: 38%
*   Data loss via public or enterprise GenAI tools: 35.9%
*   Discovering and securing sensitive data beyond compliance use cases: 30.7%
*   Unsupervised data access and other risks from agentic AI: 25.3%
*   Insider threats from new employees: 32.7%
*   Risk and cost of redundant, obsolete and trivial (ROT) data: 31.7%
...
*   More than 1,000 TB/1 Petabyte: 26.5%
*   501-1,000 TB: 32.5%
*   251-500 TB: 23.9%
*   101-250 TB: 12.6%
*   51-100 TB: 3.2%
...
*   41% of companies with over 10,000 employees manage more than a petabyte (PB) of enterprise data.

How does the volume of data inside your organization compare between this year and last year?

*   Increased by 50% or more: 6.2%
*   Increased by 30-49%: 23.0%
*   Increased by 10-29%: 59.2%
*   Stayed about the same: 8.2%
*   Decreased by 10-29%: 2.9%
*   Decreased by 30% or more: 0.5%
...
*   46% say that data sprawl across cloud and SaaS applications is a significant data security challenge.
...
*   55% say that 21-40% of their data is sensitive.
...
*   44% say that lack of visibility and data security controls for GenAI tools is a top challenge for securing sensitive data.
...
*   48% say that limited visibility into risky user behavior is a top challenge for securing sensitive data.
...
![Chart showing email data security incidents by organization size](placeholder_for_chart_2)
*Misdirected emails*
*Exfiltration attempts*
*5,000 mailboxes*
*10,000 mailboxes*
*Organization size*
*(Number of incidents in 12-month period)*
...
*   Between one and five: 10.7%
*   Between six and ten: 35.9%
*   Between eleven and fifteen: 28.3%
*   Between sixteen and twenty: 20.1%
*   Twenty-one or more: 5.0%
...
*   21% of security teams take one to four weeks to resolve data loss incidents.
...
*   Reduce risk of data loss: 54.6%
*   Enable safe and productive use of AI: 49.8%
*   Get better visibility of sensitive data and exposures from data sprawl: 49.6%
*   Reduce insider threats: 42%
*   Reduce administration by consolidating overlapping tools: 40.6%
*   Mitigate industry/regulatory compliance risk: 39.6%
*   Support organization-wide changes (e.g., expansions, mergers and acquisitions): 36%
*   Reduce spend on software subscriptions: 30.8%
*   Get customer support from one vendor: 30.2%
...
*   50% see one of the biggest benefits of a unified solution as enabling safe and productive use of AI in their organizations.
...
*   Classifying data: 65.4%
*   Detecting anomalous user behavior: 59.2%
*   Remediating incidents: 57.1%
*   Detecting anomalous data exfiltration: 54%
*   Triaging and investigating alerts: 53.6%
*   Creating policies: 52.3%
*   Using natural language processing to enhance search: 46.5%
