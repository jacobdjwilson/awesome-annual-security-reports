# API Security Perspectives 2025: AI-Enhanced Threats and API Security
...
- [API Security Incidents and Costs](#api-security-incidents-and-costs)
- [Confidence vs. Reality](#confidence-vs-reality)
- [Mitigation and Governance](#mitigation-and-governance)
- [AI Models and LLM Security](#ai-models-and-llm-security)
...
The rapid adoption of AI tech and large language models (LLMs) is leading to previously unfathomable innovation — but has also resulted in a total reshaping of the cybersecurity threat landscape. However, without proper management, visibility, and processes in place, APIs can be a potential hole in your security.
...
AI can lower the barrier to entry for cyberattacks and provides another attack vector to potentially breach organizational defenses around API security. Those working in tech clearly recognize the risk, with 74% saying they’re extremely or very concerned about AI-enhanced attacks, and 32% say they’re the single biggest security threat to organizations today.

![Chart: What’s the biggest security threat to your organization today? Showing AI-enhanced cyberattacks at 32%, followed by unauthorized access or breaches at 26%, misconfigured APIs at 14%, shadow APIs at 9%, API versioning and dependency vulnerability at 7%, insufficient encryption and data protection at 7%, DDoS attacks at 3%, and other at 2%.]
...
## API Security Incidents and Costs
...
![Chart: Have you experienced an API security incident in the past 12 months? 55% Yes, 27% No but concerned, 11% No and confident, 7% Not sure.]
...
Despite the number of people who have recently experienced an attack, most are confident in their ability to secure APIs against current and emerging threats.

- **85%** are confident in their ability to secure APIs.
- **97%** view API security as a top cybersecurity concern relative to others.
- **40%** are unsure that their organization’s investment is enough to cover API security risks.

---

## Mitigation and Governance

When it comes to what preventative measures organizations are taking to mitigate API security risks, API monitoring and anomaly detection tools top the list.

**Steps taken to mitigate API security risks:**
...
**Measures to secure APIs against AI-enhanced threats:**
- Increased monitoring and traffic analysis (66%)
- Educating staff (60%)
- AI-driven threat detection systems (51%)
- Leveraging API security solutions with AI/ML capabilities (44%)
- Partnering with third-party security services (40%)

---

## AI Models and LLM Security
...
**How organizations plan to mitigate risks related to AI:**
- Implementing AI-specific security policies (33%)
- Adopting an AI gateway (21%)
- Enhancing monitoring and anomaly detection for AI traffic (19%)
- Auditing the LLMs used (13%)
- Educating employees on AI security practices (12%)

84% say AI and LLMs will increase the complexity of securing APIs over the next 2–3 years.

---

## Conclusion

The convergence of AI and APIs presents both unprecedented opportunities and risks. While most organizations report being extremely concerned about AI-enhanced attacks, 40% remain unsure whether their current security investments are sufficient. With API attacks projected to grow by 548% by 2030, the time to act is now. Kong’s unified API platform helps organizations navigate these challenges by providing robust security, complete visibility, and simplified management across your entire API ecosystem.
