# AI, Risk, and the Road Ahead: Key Findings from Team8's 2025 CISO Village Survey
...
![Chart showing budget changes: 52% Increased, 37% Did not change, 11% Decreased]

### Best-of-Breed Makes a Comeback
60% of CISOs prefer best-of-breed tools over best-of-suite platforms. This potentially marks a turning point in the “platformization” wave. While platforms once promised simplicity and scale, many CISOs are finding that breadth often comes at the expense of depth.

---

## 2. The AI Arms’ Race

AI is no longer on the horizon, it’s in the kill chain. We are witnessing a true arms race between attackers and defenders. 

**25%**: One in four CISOs reported experiencing an AI-generated attack within the past 12 months.

### 2.1. AI-Powered Attacks
In our survey, 1 in 4 CISOs reported experiencing an AI-generated attack within the past year. The most visible examples today remain AI-generated social engineering attacks: deepfakes, voice cloning, and real-time impersonation tactics.

### 2.2. Securing Enterprise AI Adoption
In 2025, AI risk has become the defining security challenge for CISOs. Two specific issues rise to the top: securing AI agents (37%) and governing employee use of AI tools (36%).

### 2.2.1. AI Agents
AI agents are autonomous software entities that can perceive, reason, and act across enterprise systems. 
- 67% of enterprises are deploying agents in 2025.
- 23% are planning to follow in 2026.
- 9% have no plans to introduce agents.

![Chart showing development methods: 67% Developing in-house, 59% Deploying SaaS, 58% Using no-code, 49% Productizing Agentic AI]

### 2.2.2. Securing Employee AI Usage
Shadow AI refers to tools that enter the organization through individual teams or employees without going through IT or security review. 
- 43.4% restrict usage to approved tools.
- 25.7% allow use with policies but no monitoring.
- 22.1% allow and monitor usage.
- 5.3% allow use with no formal policy or monitoring.
- 3.5% strictly block all external AI tools.

### 2.2.3. AI for Security
CISOs expect AI to replace human labor in specific use cases:
- SOC Analyst: 77%
- Third-party risk management: 27%
- Pentesting: 27%
- Provisioning and access reviews: 26%
- Design review threat modeling: 22%
...
3. **Data leakage prevention (DLP)**: 33%
4. **AI-Augmented SOC**: 28%
5. **TPRM**: 23%
6. **Infrastructure vulnerability management**: 24%
...
The 2025 edition was launched at the annual CISO Village Summit, hosted across Miami and the Florida Keys. This report presents the survey results gathered from over 110 CISOs.

### 4.1. Industry Breakdown
- Technology: 34.5%
- Financial services: 27.4%
- Industrial and Manufacturing: 15%
- Health and Pharma: 8%
