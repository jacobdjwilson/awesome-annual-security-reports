...
### 1. End User Data Control (IT teams)
- Data Loss Prevention
- SaaS Access control
- Secure Code Creation

### 2. AI Posture Management (Infrastructure teams)
- Infrastructure Discovery
- ML-BOM/AI-BOM
- Data Pipeline Posture
- Static Code Testing

### 3. Application Runtime (AppSec/DevSecOps)
- Prompt Injection Protection
- Visibility into runtime models
- Authn/Authz
- Dynamic Testing

### 4. AI for Security (SOC and AppSec)
- AI for SOC
