...
- **AI Posture Management** (IT teams)
  1. Infrastructure Discovery
  2. ML-BOM/AI-BOM
  3. Data Pipeline Posture
  4. Static Code Testing

- **Application Runtime** (Infrastructure teams)
  1. Prompt Injection Protection
  2. Visibility into runtime models
  3. Authn/Authz
  4. Dynamic Testing

- **AI for Security** (AppSec/DevSecOps)
  1. AI for SOC
