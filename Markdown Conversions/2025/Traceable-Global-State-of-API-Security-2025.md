...
- [Top Findings At a Glance Continued...](#top-findings-at-a-glance-continued)
...
- [57% of organizations experienced an API-related data breach in the past two years. Of those that experienced a breach, 73% had at least three API-related breaches.](#57-of-organizations-experienced-an-api-related-data-breach-in-the-past-two-years-of-those-that-experienced-a-breach-73-had-at-least-three-api-related-breaches)
- [DDoS and Fraud Continue to be the Primary Breach Method; Brute Force Enters the Top 3.](#ddos-and-fraud-continue-to-be-the-primary-breach-method-brute-force-enters-the-top-3)
- [Financial Loss, Loss of Intellectual Property, and Brand Value Erosion are Top Consequences of API-related Data Breaches.](#financial-loss-loss-of-intellectual-property-and-brand-value-erosion-are-top-consequences-of-api-related-data-breaches)
- [Over Half (55%) of Organizations Have at Least 500 APIs](#over-half-55-of-organizations-have-at-least-500-apis)
- [Diverse API Types and Their Implications for Security](#diverse-api-types-and-their-implications-for-security)
- [API sprawl continues to be the top API security challenge](#api-sprawl-continues-to-be-the-top-api-security-challenge)
- [Part II: Traditional Solutions Fall Short](#part-ii-traditional-solutions-fall-short)
- [Organizations deploy multiple solutions to protect their APIs.](#organizations-deploy-multiple-solutions-to-protect-their-apis)
- [Persistent Reliance on Ineffective API Security Solutions](#persistent-reliance-on-ineffective-api-security-solutions)
- [API Attack Protection: Gaps in Detection and Prevention](#api-attack-protection-gaps-in-detection-and-prevention)
- [Part III: The Escalating Threat of Bot Attacks on APIs](#part-iii-the-escalating-threat-of-bot-attacks-on-apis)
- [53% of organizations reporting at least one bot-related incident targeting their APIs](#53-of-organizations-reporting-at-least-one-bot-related-incident-targeting-their-apis)
- [Part IV: Generative AI and API Security](#part-iv-generative-ai-and-api-security)
- [Key API Security Concerns with Generative AI Applications](#key-api-security-concerns-with-generative-ai-applications)
...
- [API Security Ownership: A Mixed Bag](#api-security-ownership-a-mixed-bag)
- [Compliance Drives Security Budget Decisions in 2025](#compliance-drives-security-budget-decisions-in-2025)
- [Where do we go from here?](#where-do-we-go-from-here)
- [About Traceable](#about-traceable)

The official report URL is: https://www.traceable.ai/2025-state-of-api-security
...
| Year | API are a security risk because they expand the attack surface across all layers of the technology stack | Traditional security solutions are not effective in distinguishing legitimate from fraudulent activity at the API layer | The volume of APIs make it difficult to prevent attacks |
|---|---|---|---|
| 2023 | 58% | 57% | 56% |
| 2025 | 54% | 53% | 55% |
...
| Year | 1 or 2 | 3 or 4 | 5 or 6 | 6 or 7 | > 7 | Unknown |
|---|---|---|---|---|---|---|
| 2023 | 20% | 34% | 17% | 12% | 11% | 7% |
| 2025 | 22% | 32% | 14% | 14% | 13% | 5% |
...
|---|---|---|
| DDoS | 37% | 38% |
| Fraud, Abuse and Misuse | 29% | 29% |
| Known Attacks | 23% | 23% |
| Brute Force | 31% | 25% |
| Business Logic Attack | 27% | 23% |
| Unknown Attacks (Zero-Day) | 18% | 17% |
| Account Takeover | 16% | 16% |
| Enumeration | 17% | 19% |
| Other | 10% | 3% |
...
*   54% say APIs expand the attack surface
*   53% say legacy solutions not effective
*   55% say volume of APIs make it difficult to stop attacks

#### Reasons why APIs are at risk

| | 2023 | 2025 |
|---|---|---|
| API are a security risk because they expand the attack surface across all layers of the technology stack | 58% | 54% |
| Traditional security solutions are not effective in distinguishing legitimate from fraudulent activity at the API layer | 57% | 53% |
| The volume of APIs make it difficult to prevent attacks | 56% | 55% |
...
*   54% preventing API Sprawl
*   53% Growth in API vulnerabilities
*   52% prioritizing remediation
*   51% Prevent fraud, abuse, misuse
...
| Alerting teams to API anomalies or attacks | 28% | 24% |
| Risk Ranking APIs | 21% | 23% |
...
| Prevent exﬁltration of sensitive data | 24% | 49% |
| Prevent fraud, abuse, misuse | 51% | 51% |
| Mitigate bot attacks | 44% | 44% |
...
| Identiﬁcation of Vulnerabilities | 51% | 51% |
| Basic Authentication | 47% | 52% |
| Data Loss Prevention | 52% | 50% |
| API Lifecycle Management Tools | 44% | 44% |
| OpenID Connect | 36% | 34% |
| Web Application and API Protection (WAAP) | 32% | 29% |
| Tokens | 28% | 33% |
| API Gateway | 32% | 29% |
| An API Key | 24% | 30% |
...
| | Zero | <5% | 5% to 10% | 11% t0 15% | 16% to 20% | 21% to 30% | 31% to 40% | 41% to 50% | >50% |
|---|---|---|---|---|---|---|---|---|---|
| 2023 | 3% | 12% | 13% | 11% | 7% | 19% | 10% | 12% | 13% |
| 2025 | 3% | 12% | 13% | 11% | 7% | 19% | 10% | 12% | 13% |
...
| Active Trafﬁc Monitoring |  |  |  |  |  |  |
| API Rate Limiting |  |  |  |  |  |  |
| Blocking Policies |  |  |  |  |  |  |
| Other |  |  |  |  |  |  |

## Part IV: Generative AI and API Security
...
| | 60% | 60% | 60% | 50% | 34% | 33% |
|---|---|---|---|---|---|---|
| Increased attack surface due to additional API integrations |  |  |  |  |  |  |
| Potential data leakage through API calls to generative AI services |  |  |  |  |  |  |
| Unauthorized access to sensitive data |  |  |  |  |  |  |
| Difﬁculty in monitoring and analyzing trafﬁc to and from generative AI APIs |  |  |  |  |