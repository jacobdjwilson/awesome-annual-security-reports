# Global State of API Security 2025

**Organization:** Traceable  
**Report Title:** Global State of API Security  
**Year:** 2025

## Table of Contents
- [About This Research](#about-this-research)
- [Report Contents](#report-contents)
- [Executive Summary: The Urgent Need for API Security in Enterprise Organizations](#executive-summary-the-urgent-need-for-api-security-in-enterprise-organizations)
- [Top Findings At-A-Glance](#top-findings-at-a-glance)
...
## Report Contents
- Executive Summary: The Urgent Need for API Security in Enterprise Organizations 4
- Top Findings At-A-Glance 5
- Research Methodology 7
- Key Findings 8
- Part I: API-related Data Breaches Continue to Wreak Havoc 9
- Part II: Traditional Solutions Fall Short 17
- Part III: The Escalating Threat of Bot Attacks on APIs 21
- Part IV: Generative AI Adoption and Associated API Security Risks 23
- Part V: Governance, Ownership and Budget: The Strategy and Finance of API Security 25
- Where Do We Go From Here? 28

## Executive Summary: The Urgent Need for API Security in Enterprise Organizations
...
![Reasons why APIs are at risk chart: 57% had an API related breach in the past two years; 58% agree APIs expand the attack surface; 57% agree traditional solutions are ineffective; 56% agree volume of APIs makes it difficult to prevent attacks.]
...
- **To prevent API exploitations**, organizations need to make identifying API endpoints that handle sensitive data without appropriate authentication more of a priority. An API endpoint is a specific location within an API that accepts requests and sends back responses.
- **Bad bots impact the security of APIs.** Fifty-three percent of respondents say their organizations experienced one or more bot attacks involving APIs. The security solutions most often used to reduce the risk from bot attacks are web application firewalls, content delivery network deployment and active traffic monitoring on an API endpoint.

### Top Findings At a Glance Continued...
- **Generative AI and API security:** Generative artificial intelligence is being adopted by many organizations for its many benefits such as in business intelligence, content development and coding. In this research, 67 percent of respondents say their organizations have currently adopted (21 percent), in the process of adopting (30 percent) or plan to adopt generative AI in the next year (16 percent).
...
This research report is a collaborative study with the Ponemon Institute that surveyed 1,548 respondents, across roughly 100 countries and over 6 major industries. This included organizations with at least 1,000 employees, to those with over 75,000 employees.
...
The data presents a multifaceted landscape of the root causes behind data breaches. Leading the charge are DDoS attacks, reported by a significant 38% of respondents. Equally concerning is the fact that both known attacks, which have established signatures, and fraud, abuse, and misuse were cited by 29% of participants.

### Financial Loss, Loss of Intellectual Property, and Brand Value Erosion are Top Consequences of API-related Data Breaches.
Financial consequences and loss of intellectual property (IP) equally resonate as the most severe, both experienced by 51% of the affected organizations. Not far behind, brand value erosion was reported by 48% of respondents. Operational disruptions were faced by 37%.

### Over Half (55%) of Organizations Have at Least 500 APIs
The proliferation of digital platforms and services has led to a surge in the number of APIs used by organizations. 16% operate with over 2,500 APIs (up from 13% in 2023), indicative of vast enterprises with intricate digital touch points. 6% still lack clarity on their API count, signaling lack of visibility and potential security blind spots.

### Diverse API Types and Their Implications for Security
Recent data unveils that organizations are widely using a range of APIs: Open APIs (33%), Public APIs (31%), Private APIs (30%), Partner APIs (25%), Internal APIs (25%), Composite APIs (17%), and Third-party APIs (15%).

### API sprawl continues to be the top API security challenge
It’s clear that the API threat landscape is set to intensify. A substantial 61% of respondents anticipate that API risks will either significantly increase or increase over the next 12 to 24 months. Over half of respondents (54%) highlight preventing API sprawl as a top issue.
...
Different solutions are deployed by organizations to secure their APIs, with encryption and signatures (60%), identification of vulnerabilities (52%), and basic authentication (52%) emerging as the most popular options. New methods were noted this year with Content Delivery Networks (CDN) (46%), Multi-Factor Authentication (48%), Zero Trust architecture (50%), Rate Limiting (47%) and Logging and Monitoring (51%) being used for API protection.

### Persistent Reliance on Ineffective API Security Solutions
Only 19% of respondents rate their API security solutions as "highly effective" (scores of 9 or 10). Alarmingly, a combined 23% of respondents give their solutions low effectiveness scores (1 to 4), signaling a significant portion of organizations that acknowledge their current approaches are failing.

### API Attack Protection: Gaps in Detection and Prevention
In terms of prevention, only 13% of organizations can prevent more than half of API attacks—a number unchanged from last year. The majority are unable to block even 20% of attacks, with 19% preventing just 11-15%.

## Part III: The Escalating Threat of Bot Attacks on APIs
APIs are a growing target for bot attacks, which can disrupt services, steal data, and compromise systems. 53% of organizations report at least one bot-related incident targeting their APIs. Despite awareness of the issue, only 21% of organizations describe their ability to mitigate bot traffic as “high.”
...
- Increased attack surface due to additional API integrations (60%)
- Potential data leakage through API calls (60%)
- Unauthorized access to sensitive data (60%)

## Part V: Governance, Ownership and Budget: The Strategy and Finance of API Security
Effective API security goes beyond technology—it requires clear ownership, strategic governance, and well-aligned budget priorities.

### API Security Ownership: A Mixed Bag
Ownership of API usage and security programs remains fragmented. 21% of organizations assign this responsibility to the CIO/CTO, while another 21% place it under the head of software development. 13% of organizations report that no one person or department officially owns the API security program.
...
APIs are now a critical part of the digital infrastructure, but their rapid growth has brought significant security challenges. 57% of organizations reported at least one API-related breach in the past two years, yet only 19% rate their existing security measures as effective. Traditional methods, like web application firewalls and API gateways, are proving inadequate in the face of evolving threats. The data underscores the need for a more proactive, unified, and effective approach to API security.
