...
Report
2025
Global Incident Response Report 2025 1
...
Global Incident Response Report 2025 4

When Unit 42 is called, our Incident Response team works swiftly to contain threats, investigate
...
- How Threat Actors Succeed: Analysis of the most common effective tactics, techniques and
...
Unit 42
Global Incident Response Report 2025 5

# 2. Emerging Threats and Trends
In 2025, organizations face a complex mix of threats from financially driven cybercriminals, well-
...
Global Incident Response Report 2025 6
...
extortion tactic has become less effective. Backups have helped more organizations recover faster
...
Global Incident Response Report 2025 7

### Wave 2: Upping the Ante With Data Exfiltration
As focusing solely on encryption became less effective, attackers pivoted to a new
...
malicious messages.
However, while data theft remains a popular tactic, its effectiveness has started
...
are finding leak site extortion less effective in compelling payments.
...
Global Incident Response Report 2025 8
...
deleted virtual machines and destroyed data (section 5.1 offers a full breakdown of
...
Figure 2.
Global Incident Response Report 2025 10
...
Incidents of this type can affect an organization on a
wide scale, and can also affect other organizations if
...
jumping off point to attack other organizations on a large
...
expose critical data and can also be difficult to detect
...
activity within legitimate organizational traffic.
Global Incident Response Report 2025 11
...
struggle to differentiate between legitimate access and
...
the world. The result of a “multi-year effort,” the issue
...
Global Incident Response Report 2025 12

In a different matter worked by Unit 42, threat actors spent months brute-forcing a
...
off the originating host to prevent tampering, and aggregate them for correlation
...
In 2024, the median time to exfiltration in attacks that
...
and contain an attack. In some cases, they have less
...
Global Incident Response Report 2025 14
...
Global Incident Response Report 2025 15
...
referrer, using different fake identities to pose as
...
no mistake: GenAI is already transforming offensive
attack capabilities.
...
required significant manual effort, accelerating the
...
convincing deepfakes (these range from free offerings
to “enterprise plans” that offer deepfakes for as little
as $249/month).
Global Incident Response Report 2025 1166

In malware development, LLMs assist in generating
...
attacks is the increase in the speed and efficiency
...
multiple sources.
- Train staff to recognize AI-generated phishing,
...
Global Incident Response Report 2025 17

# 3. How Threat Actors Succeed: Common
...
difficult for organizations to detect their activity and
mitigate it efficiently.
...
prepare to access and efficiently process information
...
files, combined with insufficient security controls led to
...
Global Incident Response Report 2025 18
...
![Figure 4. Initial access vectors observed in incidents Unit 42 responded to over the years.]

Other social engineering includes SEO poisoning, malvertising, smishing, MFA bombing and compromising the help desk. Other initial access vectors include abuse of trusted relationships or tools, as well as insider threats.

The initial access vectors alone don’t tell the whole story. Different initial access vectors often
corresponded to different threat actor profiles and objectives. For example, when threat actors gained
...
Global Incident Response Report 2025 19

Nation-state actors, which account for a small but
...
especially through “living off the land” techniques.
...
that proxy command and control network traffic
delivered to or from additional victims.
Global Incident Response Report 2025 20

Actors have also been observed targeting and compromising technology vendors to
...
also see incidents in which adversaries avoid triggering alerts and make an effort to
...
compromised environment, an approach known as “living off the land.” The success
...
As a very common real-world example, can you immediately tell the difference between
...
| :--- | :--- |
| T1078 - Valid Accounts | This was one of the top techniques observed as an Initial Access vector, which represents more than 40% of the kinds of grouped techniques observed in association with this tactic. It is likely enabled by weaknesses in identity and access management and attack surface management (ASM) such as:<br>• No MFA (28% of cases)<br>• Weak/default passwords (20% of cases)<br>• Insufficient brute force/account lockout controls (17% of cases)<br>• Excessive account permissions (17% of cases) |
...
| T1021 - Remote Services | Abuse of these services was overwhelmingly the most observed technique for Lateral Movement (of the kinds of grouped techniques observed in association with this tactic, over 86% involved remote services). This further extends the trend highlighting reuse of legitimate credentials.<br>Instead of more traditional uses of these credentials, here we see them used to authenticate through internal network protocols such as RDP (over 48% of cases), SMB (over 27% of cases), and SSH (over 9% of cases). |

Table 3. Most prominent living off the land techniques from Unit 42 IR cases.

In addition to living off the land, we have observed a number of actors — particularly involved with ransomware —
...
Global Incident Response Report 2025 22
...
### 1. Security Complexity: A Killer for Effective
...
Global Incident Response Report 2025 23
...
readily accessible or effectively operationalized, allowing
attackers to exploit the gaps undetected.

At the same time, multiple data sources are essential to
detect and respond effectively. About 85% of incidents
...
Enterprise-wide visibility is the backbone of effective
security operations, yet gaps remain common. Cloud
services, in particular, present a significant challenge.

Unit 42 found that organizations spin up an average of
...
accounts to move laterally and escalate privileges after brute-forcing a VPN without multi-factor authentication. This excessive trust allowed the attackers to deploy ransomware across 700 ESXi servers, ultimately disrupting the company’s main business operations and impacting over 9,000 systems.
...
downtime and expensive breach remediation...
...
In fact, in 41% of incidents, there was at least one technology to identify the signal in the noise.
contributing factor related to issues with identity and
• I●ngest all relevant security data: Aggregate and
...
Here too, cloud environments are especially the complexity of juggling multiple tools. Map the
vulnerable: Unit 42 researchers found that in nearly internal and external attack surface to inventory all
half of cloud-related incidents, there was at least one assets and owners and integrate threat intelligence
contributing factor related to issues with identity and to prioritize high-risk indicators.
access management, including overly permissioned • Detect and prioritize threats with AI-driven
accounts and roles. capabilities: Use artificial intelligence and machine
...
Global Incident Response Report 2025 24
...
• I●dentify and verify all users, devices and applications: Consistently authenticate
...
• A● pply holistic security inspection: Analyze network traffic — including encrypted
...
• C● ontrol data access and movement: Safeguard sensitive information by classifying
...
25 Global Incident Response Report 2025 2255

By adopting these Zero Trust principles — even one actionable step at a time — you not
...
• P● revent security issues from reaching production: Integrate security early in the
...
• R● emediate newly discovered security weaknesses: Continuously monitor cloud
...
Global Incident Response Report 2025 27
...
T105~ - (cid:134)o(cid:139)(cid:139)and and Scriwtinu tnterwreter 44%
T1204 - ¤ser Execution 21%
T1053 - Scheduled Task/Job 1˜%
T15(cid:148)~ - S(cid:154)ste(cid:139) Services 12%
T104˜ - Windo”s (cid:192)anaue(cid:139)ent tnstru(cid:139)entation 4%
T10˜2 - Soft”are (cid:10)ewlo(cid:154)(cid:139)ent Tools 1%
T155~ - tnter-Process (cid:134)o(cid:139)(cid:139)unication 1%
T110(cid:148) - 6ative APt <1%
T1203 - Exwloitation for (cid:134)lient Execution <1%
...
Global Incident Response Report 2025 28

5.1 Overview of Observed MITRE ATT&CK Techniques by Tactic (Cont.)
T1053 - Scheduled Task/Job 1(cid:211)%
T1136 - (cid:147)reate Account 15%
T107fl - fialid Accounts 1˚%
T15˚3 - (cid:147)reate or »odif• S•ste(cid:181) Process 13%
T10(cid:211)fl - Account »ani(cid:221)ulation 10%
T15˚7 - (cid:24)oot or (cid:9)o(cid:8)on Autostart (cid:4)Æecution 7%
T1505 - Server Soft(cid:29)are (cid:147)o(cid:181)(cid:221)onent 6%
T15˚6 - (cid:4)vent Tri(cid:8)(cid:8)ered (cid:4)Æecution 5%
T1133 - (cid:4)Æternal Re(cid:181)ote Services 5%
T11(cid:211)7 - (cid:24)LTS Jobs 2%
T1556 - »odif• Authentication Process 2%
T1037 - (cid:24)oot or (cid:9)o(cid:8)on LnitialiXation Scri(cid:221)ts 1%
T157˚ - (cid:132)i{ack (cid:4)Æecution vlo(cid:29) 1%
T1176 - (cid:24)ro(cid:29)ser (cid:4)Ætensions <1%
0 5% 10% 15% 20%
...
Global Incident Response Report 2025 29

5.1 Overview of Observed MITRE ATT&CK Techniques by Tactic (Cont.)
Figure 10. Relative Prevalence of Techniques Observed in Association With the Defense Evasion Tactic
T1003 - O· Credential (cid:228)u…pin¤ 44%
T1110 - (cid:222)rute fiorce 25%
T1555 - Credentials firo… Pass»ord ·tores 9%
T155(cid:181) - ·teal or fior¤e §erberos Tic‡ets 7%
T1552 - %nsecured Credentials 4%
T1212 - Exploitation for Credential Access 3%
T155(cid:17) - (cid:15)odif(cid:8) Authentication Process 3%
T1557 - Adversar(cid:8)-in-the-(cid:15)iddle 2%
T1040 - Ret»or‡ ·niLn¤ 1%
T105(cid:17) - ]nput Capture 1%
T1(cid:17)21 - (cid:15)ulti-fiactor Authentication Request leneration 1%
T1(cid:17)49 - ·teal or fior¤e Authentication Certi(cid:137)cates 1%
0 5% 10% 15% 20% 25% 30% 35% 40% 45%
...
Global Incident Response Report 2025 30

5.1 Overview of Observed MITRE ATT&CK Techniques by Tactic (Cont.)
Figure 12. Relative Prevalence of Techniques Observed in Association With the Lateral Movement Tactic
T1074 - Data Staged 31%
T15£0 - Archive Collected Data 25%
T103¿ - Data „ro‡ –et†orfi Shared Drive 13%
T1005 - Data „ro‡ ˝ocal S¨ste‡ 11%
T1557 - Adversar¨-in-the-(cid:5)iddle 5%
T1114 - (cid:24)‡ail Collection 3%
T111¿ - Auto‡ated Collection 3%
T1530 - Data „ro‡ Cloud Storage 3%
T105£ - 5n4ut Ca4ture 2%
T11U5 - Rro†ser Session IiSacfiing 2%
T1£02 - Data „ro‡ Con^guration Re4ositor¨ 2%
...
Global Incident Response Report 2025 31
...
Global Incident Response Report 2025 32
...
Global Incident Response Report 2025 33
...
Global Incident Response Report 2025 34

5.2. Data by Region and Industry (Cont.)
Investigation Type by Industry
Figure 21. Investigation Type by Industry – Manufacturing
Figure 22. Investigation Type by Industry – Wholesale & Retail
Global Incident Response Report 2025 35

5.2. Data by Region and Industry (Cont.)
Investigation Type by Industry
Figure 23. Investigation Type by Industry – Financial Services
Figure 24. Investigation Type by Industry – Healthcare
Global Incident Response Report 2025 36

6 Data and
Methodology
We sourced data for this report from more than  Incident responders have also shared their observations
500 cases Unit 42 responded to between October  of key trends based on working directly with clients.
...
Our clients range from small organizations with fewer  organizations with more mature security postures. We
than 50 personnel to Fortune 500 and Global 2000  have also chosen to emphasize cases that we believe
companies and government organizations with more  reveal emerging trends, which for some topics means
than 100,000 employees.  focusing on smaller segments of the dataset.
The affected organizations were headquartered in  For some topics, we chose to filter our data to remove
38 unique countries. About 80% of the targeted  factors that could skew our results. For example, we
organizations in these cases were located in the U.S.  offered our incident response services to help our
Cases related to organizations based in Europe, the  customers investigate potential impacts of CVE-
Middle East and Asia-Pacific form the other 20% of  2024-3400, which caused that vulnerability to be
the work. Attacks frequently have impact beyond the  overrepresented in our dataset. In places, we corrected
locations where organizations are headquartered.  the data to remove this overrepresentation.
We combine this case data with insights from our threat  Our guiding principle throughout has been to provide
research, which is based on product telemetry as well  the reader with insights into the present and future
as on observations of dark web leak sites and other  threat landscape, enabling improved defense.
open-source data.
Contributors
| Aditi Adya  | Eva Mehlert  | Prashil Pattni  | Mike Savitz  |
| ----------- | ------------ | --------------- | ------------ |
Consultant Senior Executive and Internal  Senior Threat Researcher  Senior Consulting Director
Communications Manager,
| Jim Barber  |     | Laury Rodriguez  | Michael Sikorski  |
| ----------- | --- | ---------------- | ----------------- |
Unit 42
| Senior Consultant  |             | Consultant | CTO & VP of Engineering,   |
| ------------------ | ----------- | ---------- | -------------------------- |
|                    | Lysa Myers  |            | Unit 42                    |
| Richard Emerson    |             | Sam Rubin  |                            |
Senior Technical Editor
Manager, Intel Response Unit  SVP, Unit 42 Consulting and  Samantha Stallings
|     | Erica Naone  | Threat Intelligence | Senior Production Editor |
| --- | ------------ | ------------------- | ------------------------ |
Evan Gordenker
Senior Manager, Unit 42
| Consulting Senior Manager |     | Doel Santos  | Jamie Williams  |
| ------------------------- | --- | ------------ | --------------- |
External Engagement
|                              |            | Principal Threat Researcher  | Principal Threat Intelligence  |
| ---------------------------- | ---------- | ---------------------------- | ------------------------------ |
| Michael J. Graven            | Dan O’Day  |                              | Researcher                     |
| Director, Global Consulting  |            |                              |                                |
Consulting Director
| Operations |     |     |     |
| ---------- | --- | --- | --- |
Global Incident Response Report 2025 37
