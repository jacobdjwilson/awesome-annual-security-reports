...
- **End users**: Individuals working for organizations participating in the procurement, management, or use of physical security technology.
- **Channel partners**: Individuals who consult, install, service, or produce physical security solutions.
- **Consultants**: Individuals who consult on the design, installation, maintenance, and operation of physical security solutions.
...
**Insights**
Political changes could also have played a role. Time magazine referred to 2024 as being “the election year” with at least 64 countries including the USA, India, Taiwan, South Korea, and the UK holding key national elections in 2024.[^1]
...
76% of channel partners said that “Installation Technician” is the toughest role to fill.
...
> — **Nadia Boujenoui**, Vice-President of Customer Experience and Operations, Genetec Inc.
...
48% of respondents stated that their CapEx budget increased or remained flat in 2024. Of this group 48% indicated that it increased between 11-25%.
...
38% of consultants indicated that they’re planning to grow their coverage into cybersecurity.
...
> — **Mathieu Chevalier**, Manager and Principal Security Architect, Genetec Inc.
...
**Insights**
Most organizations lack proactive cloud cost-saving strategies. A Gartner survey shows that companies waste an average of 35% of their cloud spending, with waste levels ranging from 15% in well-optimized environments to 55% in unoptimized ones.
...
- 78% felt there would be an increase in new cloud systems in 2025, up from 73% last year.
- 2% expect a decrease, down from 5% last year.

**Consultants**
Physical security consultants also predict cloud deployments will continue to grow:
- 58% estimate that the typical timeline for their customers to move some workloads to the cloud would be within the next 12 months.
- 66% say they would specify hybrid-cloud security deployments over the next 5 years.
- 25% expect to specify full cloud deployments.
...
- 23% want data analysis and visualization tools.
- 22% want collaboration with other departments for other business outcomes.
- 22% want security data democratization across the organization and better reporting.
...
> — **Pervez Siddiqui**, Vice-President of Offerings and Transformation, Genetec Inc.
...
> — **Florian Matusek, PhD, MSc**, Director of Al Strategy, Genetec Inc.
...
- 75% of end users have concerns about AI design and implementation, particularly around responsible and ethical guidelines.
- 48% of channel partners said that end users are concerned about vendors that don’t follow Responsible AI guidelines.
...
> — **Michel Chalouhi**, Vice-President of Global Sales, Genetec Inc.
...
![Figure P: Distribution of top priorities for IT teams vs physical security teams]
...
**Access control #1**: Access control is the top priority for the 5th year running. Projects focused on video surveillance ranked second.

### Takeaway 2: IT shapes decision-making
...
**50+%** of all respondents say IT departments are involved in purchasing decisions.

### Takeaway 3: From cost center to ROI
...
**22%** of end users plan to focus on security data access and better reporting in 2025.
...
- **Lack of local data center infrastructure**: 21% of end users cited “no data center infrastructure in my region” as a reason for slowing their cloud adoption. The global average was 6%.

### Asia-Pacific
Minimal disruption of 2024 projects, strong cloud and hybrid-cloud adoption in physical security environments.
- **High hybrid-cloud use**: End users from Asia-Pacific reported the highest use of hybrid-cloud overall across all regions. Only 40% of end users describe their physical security environment as entirely on-premises.
...
- **Most positive story for 2024 project deployments**: End users from Asia-Pacific reported the highest portion of 2024 projects which were not impacted by delays.

### Europe
Mature markets focusing on the replacement of aging systems, intrusion detection popular.
- **2025 replacement cycle**: End users in Europe selected migration and replacement of legacy systems as their #1 focus for 2025.
- **Lack of cloud video storage**: 55% of end users in Europe stated they would not be storing any video at all in the cloud in 2025.
- **Intrusion detection systems more popular**: 55% vs 33% global average.

### Latin America
Concerns over staffing in the region but most optimistic about future cloud movement.
- **Staffing challenges in 2025**: Channel partners from Latin America were most worried about looming staffing challenges ahead with 88% stating they would increase or greatly increase in 2025.
- **Most optimistic about future cloud use**: Over a quarter of end users from Latin America felt that in 5 years they would have all their physical security systems 100% hosted in the cloud.
- **Less on-premises storage**: 33% claimed to mostly store on-premises compared to the global average of 50%.

### Middle East, Turkey, and Africa
Big budgets, strong AI implementations but struggling with qualified staff.
- **Strongest budgets**: End users from META were most likely to report an increased 2024 OpEx budget, with 37% stating they had an increase; globally the average was 23%.
- **Staff training the top challenge**: End users from META selected “training and upskilling staff” as their #1 challenge in 2024.
- **AI implementations**: 60% of end users versus the global average of 47% had already implemented AI or were planning to in 2025.

### USA and Canada
More IT involvement and hence a strong focus on cyber security, yet, more cautious on AI use.
- **Less immediate plans for AI integration**: 57% stated they had no plans to integrate machine learning, AI, or LLMs in their physical security environments. The global average was 42%.
- **Investing in cyber education**: 77% of end users in the US and Canada educated employees within their organization on cybersecurity best practices.
- **Stronger IT involvement**: 61% of the channel partners found IT departments involved in purchasing decisions vs 51% on average globally.
...
Genetec Inc. surveyed physical security professionals from August 12 to September 15, 2024. The goal was to get a view into physical security operations, understand responses to external challenges, and understand the global focus for 2024. 5,696 respondents were included in the final analysis.
