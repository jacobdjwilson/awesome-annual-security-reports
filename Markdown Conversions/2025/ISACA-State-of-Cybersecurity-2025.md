...
- [Cybersecurity Workforce Challenges](#cybersecurity-workforce-challenges)
...
![Figure 1: Respondent Demographics - Main Area of Responsibility, Regions, Staff Size](https://via.placeholder.com/600x400?text=Figure+1:+Respondent+Demographics)

![Figure 2: Industries Represented](https://via.placeholder.com/600x400?text=Figure+2:+Industries+Represented)
...
![Figure 3: Open Roles](https://via.placeholder.com/600x400?text=Figure+3:+Open+Roles)

![Figure 4: Open Cybersecurity Position Levels](https://via.placeholder.com/600x400?text=Figure+4:+Open+Cybersecurity+Position+Levels)

![Figure 5: Factors Indicating Candidate Qualification](https://via.placeholder.com/600x400?text=Figure+5:+Factors+Indicating+Candidate+Qualification)

![Figure 6: Anticipated Demand for Cybersecurity Positions](https://via.placeholder.com/600x400?text=Figure+6:+Anticipated+Demand+for+Cybersecurity+Positions)
...
![Figure 7: Sources of Job Stress](https://via.placeholder.com/600x400?text=Figure+7:+Sources+of+Job+Stress)

![Figure 8: Retention Difficulties (2020-2025)](https://via.placeholder.com/600x400?text=Figure+8:+Retention+Difficulties+(2020-2025))

![Figure 9: Retention Difficulty by Region](https://via.placeholder.com/600x400?text=Figure+9:+Retention+Difficulty+by+Region)
...
![Figure 10: Reasons for Leaving Current Job](https://via.placeholder.com/600x400?text=Figure+10:+Reasons+for+Leaving+Current+Job)

![Figure 11: Employer Benefits](https://via.placeholder.com/600x400?text=Figure+11:+Employer+Benefits)
...
![Figure 12: Workforce Age](https://via.placeholder.com/600x400?text=Figure+12:+Workforce+Age)
...
To remedy the skill gaps associated with nontechnical skills, enterprises are leveraging online learning websites (51%), mentoring (41%), corporate training events (34%), and academic tuition reimbursement (19%).
...
![Figure 13: Skill Gaps in Today’s Cybersecurity Professionals](https://via.placeholder.com/600x400?text=Figure+13:+Skill+Gaps+in+Today’s+Cybersecurity+Professionals)

![Figure 14: Global University Degree Requirements](https://via.placeholder.com/600x400?text=Figure+14:+Global+University+Degree+Requirements)

![Figure 15: Career Preparedness](https://via.placeholder.com/600x400?text=Figure+15:+Career+Preparedness)
...
![Figure 16: CISO Reporting](https://via.placeholder.com/600x400?text=Figure+16:+CISO+Reporting)

![Figure 17: Cybersecurity Budget Funding](https://via.placeholder.com/600x400?text=Figure+17:+Cybersecurity+Budget+Funding)

![Figure 18: Cybersecurity Budget Forecasts](https://via.placeholder.com/600x400?text=Figure+18:+Cybersecurity+Budget+Forecasts)
...
![Figure 23: Confidence in Detecting and Responding to Cyberthreats](https://via.placeholder.com/600x400?text=Figure+23:+Confidence+in+Detecting+and+Responding+to+Cyberthreats)
...
![Figure 24: Use of Cyberinsurance Policy](https://via.placeholder.com/600x400?text=Figure+24:+Use+of+Cyberinsurance+Policy)

![Figure 25: Frequency of Cyberrisk Assessments](https://via.placeholder.com/600x400?text=Figure+25:+Frequency+of+Cyberrisk+Assessments)

![Figure 26: Obstacles to Conducting Cyberrisk Assessments](https://via.placeholder.com/600x400?text=Figure+26:+Obstacles+to+Conducting+Cyberrisk+Assessments)
...
![Figure 27: Use of AI for Security Operations](https://via.placeholder.com/600x400?text=Figure+27:+Use+of+AI+for+Security+Operations)

![Figure 28: Involvement in AI Life Cycle](https://via.placeholder.com/600x400?text=Figure+28:+Involvement+in+AI+Life+Cycle)

![Figure 29: Involvement in Developing AI Policy](https://via.placeholder.com/600x400?text=Figure+29:+Involvement+in+Developing+AI+Policy)

## Conclusion: Preparing for an Uncertain Future

Although many findings from this year’s State of Cybersecurity Survey are similar to those reported last year, some findings have potentially troubling implications for the future of the cybersecurity workforce.

Burnout remains a considerable challenge, so it is concerning that almost one-quarter of respondents say their enterprises have not taken any action to mitigate burnout. Despite many respondents reporting that their jobs are more stressful now than in previous years, the job market and broader economic uncertainty has helped enterprises with retention.
