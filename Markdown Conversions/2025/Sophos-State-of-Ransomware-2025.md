...
- The average (median) ransom payment has fallen by 50% in the last year, down from $2M in 2024 to $1M in 2025.
...
For the third year running, victims identified exploited vulnerabilities as the most common root cause of ransomware incidents, used to penetrate organizations in 32% of attacks overall. Compromised credentials remains the second most common perceived attack vector.
...
- Compromised credentials were the most common root cause in the 100–250 employee segment.
...
This year’s report explores for the first time the organizational factors that left companies exposed to attacks. The findings reveal that victims are typically facing multiple operational challenges with respondents citing 2.7 factors, on average.

![Chart 3: Operational root cause of ransomware attacks]

Lack of expertise is the most common operational reason given (40.2%), followed by unknown security gaps (40.1%) and lack of people/capacity (39.4%).

## What happens to the data

### Data encryption
Data encryption is at the lowest reported rate in the six years of our study, with 50% of attacks resulting in data being encrypted.

![Chart 6: Data encryption rate in ransomware attacks 2020–2025]

### Data theft
14% of all ransomware victims and 28% of those that had data encrypted experienced data theft. Smaller organizations are almost 40% less likely to have data stolen than larger ones.

### Extortion-style attacks
The percentage of organizations that did not have data encrypted but were held to ransom anyway (extortion) doubled in the last year, reported in 6% of attacks in 2025 compared to just 3% in 2024.

## Recovery of encrypted data
97% of organizations that had data encrypted were able to recover it. Just over half (54%) restored their data using backups. 49% paid the ransom and got their data back.
...
### Ransom demands
The average (median) ransom demand fell by 34% over the last year, coming in at $1,324,439. Ransom demands increase in line with organization revenue.

![Chart 9: Ransom demands split by company annual revenue]

### Ransom payments
The average (median) ransom payment fell by 50% in the last year, down from $2 million in 2024 to $1 million in 2025.

### How actual payments stack up with the initial demand
826 organizations that paid the ransom shared both the initial demand and their actual payment, revealing that they paid, on average, 85% of the initial ransom demand. 53% paid less than the initial ask, 18% paid more, and 29% matched the initial demand.
...
### Recovery costs
The average (mean) cost to recover from a ransomware attack (excluding any ransom payment) dropped by 44% over the last year, coming in at $1.53 million.

![Chart 11: Ransomware recovery cost split by company size]

### Recovery time
Organizations are getting faster at recovering from attacks with 53% fully recovered within a week, a significant jump from the 35% reported in 2024.

![Chart 12: Recovery time from ransomware attacks 2022–2025]

## Human consequences of ransomware
Having data encrypted in a ransomware attack has significant repercussions for the IT/cybersecurity team.
...
- **Protection**: Ensure endpoints are well defended, including dedicated anti-ransomware protection.
- **Detection and response**: Around-the-clock threat detection and response is now an essential layer of defense.
- **Planning and preparation**: Have an incident response plan, take quality backups, and regularly practice restoring data.
