...
- [DeepSeek’s staggering growth rate](#deepseek’s-staggering-growth-rate)
...
*   **DeepLeak**[^2], an exposed DeepSeek database leaking sensitive information – including usage history and over a million lines of log streams – and allowing full control over database operations.
*   A critical NVIDIA AI vulnerability[^3] that affected containers using NVIDIA GPUs, including over 35% of cloud environments. CVE-2024-0132 presented a high level of risk to AI workloads and environments.
*   **SAPwned**[^4], vulnerabilities in SAP AI Core that would allow malicious actors to take over the service and access customer data, including private AI artifacts and cloud keys.
*   **Probllama**[^5], an easy-to-exploit Remote Code Execution vulnerability in the open-source AI infrastructure project Ollama.

Our work with AI-as-a-service providers Hugging Face[^6] and Replicate[^7] revealed that without proper isolation, malicious models pose a major risk to AI systems and customer data in particular.
...
![Graph showing the growth rate of DeepSeek AI model adoption in January 2025, with DeepSeek-R1 release date marked.](placeholder_image_1.png)
*Caption: Growth rates over the course of January 2025*
...
![Bar chart showing AI hosted technologies by percentage of organizations, with OpenAI SDK at 63% and other technologies listed.](placeholder_image_2.png)
...
![Bar chart showing the adoption of self-hosted AI model families, with BERT at 74% and other models listed.](placeholder_image_3.png)
*Caption: Most popular self-hosted AI model families*
...
![Pie chart showing the percentage of cloud environments using managed AI services in 2024 and 2025.](placeholder_image_4.png)
...
[^1]: Gartner, 2025 Planning Guide for Security by William Duper, Patrick Hevesi et al, October 2024.
[^2]: Wiz Research Team.
[^3]: CVE-2024-0132.
[^4]: Wiz Research Team.
[^5]: Wiz Research Team.
