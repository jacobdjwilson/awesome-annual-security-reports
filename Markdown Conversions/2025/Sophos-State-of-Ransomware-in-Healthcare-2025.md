...
A Sophos Whitepaper. October 2025

## Table of Contents
- [Introduction](#introduction)
- [Key findings](#key-findings)
- [Why healthcare providers fall victim to ransomware](#why-healthcare-providers-fall-victim-to-ransomware)
- [What happens to the data](#what-happens-to-the-data)
- [Ransoms: Demands and payments](#ransoms-demands-and-payments)
- [Business impact of ransomware](#business-impact-of-ransomware)
- [Human impact of ransomware](#human-impact-of-ransomware)
...
### Organizational root cause of incidents in healthcare
...
- **LACK OF/POOR QUALITY PROTECTION**: Lack of protection or poor-quality protection solutions that could not stop the attack (62%)
- **LACK OF PEOPLE/SKILLS**: Lack of human expertise (skills or capacity) to detect and stop the attack in time (64%)
- **SECURITY GAP (KNOWN/UNKNOWN)**: Had a known or unknown weakness in their defenses (65%)
...
### Recovery of encrypted data in healthcare
97% of healthcare providers that had data encrypted were able to recover it.
