...
- [The 2024 Threat Landscape](#the-2024-threat-landscape)
  - [Proliferation of Remote Access Trojans (RATs)](#proliferation-of-remote-access-trojans-rats)
  - [Shifts in Ransomware Strategies](#shifts-in-ransomware-strategies)
  - [Increased Exploitation of Remote Monitoring and Management (RMM) Tools](#increased-exploitation-of-remote-monitoring-and-management-rmm-tools)
  - [Sophisticated Use of “Living Off the Land” Techniques](#sophisticated-use-of-living-off-the-land-techniques)
  - [Rising Phishing Sophistication](#rising-phishing-sophistication)
...
- [Breaking Down Hacker Activity](#breaking-down-hacker-activity)
  - [Hands-On-Keyboard (HOK) Activity](#hands-on-keyboard-hok-activity)
...
![Figure 1: Most common threat categories throughout 2024](Image description)
...
![Figure 2: Industries targeted by percentage in 2024](Image description)
...
![Figure 3: Threat frequency by industry in 2024](Image description)
...
![Figure 4: Healthcare threats by type in 2024](Image description)
...
![Figure 5: Healthcare hands-on-keyboard activity in 2024](Image description)
...
![Figure 6: Technology threats by type in 2024](Image description)
...
![Figure 7: Education threats by type in 2024](Image description)
...
![Figure 8: Government threats by type in 2024](Image description)

![Extract of a Huntress intrusion where ScreenConnect and Cobalt Strike were leveraged in a county government’s network](Image description)
...
![Figure 9: Manufacturing threats by type in 2024](Image description)
...
![Figure 10: Most prevalent ransomware affiliates in 2024](Image description)
...
![Figure 11: Ransomware groups incident frequency from 2023 to 2024](Image description)

![Figure 12: Table of ransomware gains and losses since 2023](Image description)
...
![Figure 13: Average time-to-ransom (TTR) by ransomware group](Image description)
...
![Figure 14: Activity prior to ransomware deployment by group](Image description)

![An example from the BianLian ransomware group, forgoing malicious encryption with their malicious tooling to prioritize data exfiltration and extortion](Image description)
...
![Figure 15: Actions taken immediately before ransom](Image description)
...
![Figure 16: Most common remote access methods used across 2024](Image description)
...
![Figure 17: Hacking tool usage in 2024](Image description)
...
![An example of AsyncRAT leveraging multi-staged malware, which ultimately makes itself persistent as multiple scheduled tasks](Image description)

![Figure 18: Remote access trojan frequency in 2024](Image description)
...
![Figure 19: RMM and remote tool abuse during 2024](Image description)
...
In 2024, Huntress saw 17.3% of all remote access methods originating from RMM abuse, making it the second-most used method for attackers to control compromised devices. Abuse of these tools comes in many forms, but mostly either hijacking and using existing software already installed on victims’ computers or deploying and installing the attacker’s preferred