...
- [1. Introduction](#1-introduction)
  ...
  - [1.2 Vision and Alignment](#12-vision-and-alignment)
  - [1.3 Methodology](#13-methodology)
  - [1.4 Enduring Principles](#14-enduring-principles)
  - [1.5 S&T Partnerships](#15-st-partnerships)
  - [1.6 S&T Roles: Lead, Follow, Watch](#16-st-roles-lead-follow-watch)
  - [1.7 Strategic Focus](#17-strategic-focus)
  - [1.8 Significant Past Progress](#18-significant-past-progress)
  - [1.9 Cyber Vision 2025 Integrating Themes and Desired Outcomes](#19-cyber-vision-2025-integrating-themes-and-desired-outcomes)
    - [1.9.1 Mission Assurance and Empowerment](#191-mission-assurance-and-empowerment)
    - [1.9.2 Agility and Resilience](#192-agility-and-resilience)
    - [1.9.3 Optimized Human-Machine Systems](#193-optimized-human-machine-systems)
    - [1.9.4 Foundations of Trust](#194-foundations-of-trust)
    - [1.9.5 Overarching Cyberspace S&T Desired Outcomes and Recommendations](#195-overarching-cyberspace-st-desired-outcomes-and-recommendations)
  - [1.10 Structure of Cyber Vision 2025 Document](#110-structure-of-cyber-vision-2025-document)
- [2. Future Environment and Cyberspace Threat](#2-future-environment-and-cyberspace-threat)
  - [2.1 Demographics, Economy, and Adversaries - 2025](#21-demographics-economy-and-adversaries---2025)
  - [2.2 Technological Change - 2025](#22-technological-change---2025)
  - [2.3 Impacts](#23-impacts)
  - [2.4 Cyber Threats to Air Force Missions](#24-cyber-threats-to-air-force-missions)
    - [2.4.1 Threat Vectors](#241-threat-vectors)
    - [2.4.2 Areas of Concern: Threat Increase and Attack Surface Expansion](#242-areas-of-concern-threat-increase-and-attack-surface-expansion)
    - [2.4.3 Cyber Operations (CO) Actors in 2025 - Refer to classified Annex.](#243-cyber-operations-co-actors-in-2025---refer-to-classified-annex)
    - [2.4.4 Threat Recommendations](#244-threat-recommendations)
- [3. Cyberspace](#3-cyberspace)
  - [3.1 Cyber Domain Strategic Context](#31-cyber-domain-strategic-context)
  - [3.2 Findings and Recommendations](#32-findings-and-recommendations)
    - [3.2.1 Broaden Limited Cyber Mindset](#321-broaden-limited-cyber-mindset)
    - [3.2.2 Enhance Situational Awareness & Understanding](#322-enhance-situational-awareness--understanding)
    - [3.2.3 Assure Missions and Protect Critical Information in Fragile Architectures](#323-assure-missions-and-protect-critical-information-in-fragile-architectures)
    - [3.2.4 Create Hardened, Trusted, Self-Healing Networks & Cyber Physical Systems](#324-create-hardened-trusted-self-healing-networks--cyber-physical-systems)
    - [3.2.5 Develop Integrated and Full Spectrum Effects](#325-develop-integrated-and-full-spectrum-effects)
  - [3.3 Cyber S&T Technologies](#33-cyber-st-technologies)
    - [3.3.1 Assure and Empower Missions](#331-assure-and-empower-missions)
    - [3.3.2 Agile Operations and Resilient Defense](#332-agile-operations-and-resilient-defense)
    - [3.3.3 Optimize Human-Machine Systems](#333-optimize-human-machine-systems)
    - [3.3.4 Trusted Foundations](#334-trusted-foundations)
- [4. Air Domain](#4-air-domain)
  - [4.1 Air Domain Strategic Context](#41-air-domain-strategic-context)
  - [4.2. Findings and Recommendations](#42-findings-and-recommendations)
    - [4.2.1 Design-in Security to Address Insufficient Intelligence](#421-design-in-security-to-address-insufficient-intelligence)
    - [4.2.2 Reduce Complexity and Enable Verification](#422-reduce-complexity-and-enable-verification)
    - [4.2.3 Secure Full Life Cycle to Overcome Insufficient Security Architectures](#423-secure-full-life-cycle-to-overcome-insufficient-security-architectures)
    - [4.2.4 Secure Platform Information Technology (IT)](#424-secure-platform-information-technology-it)
    - [4.2.5 Secure Command and Control (C2) Architecture to Address Brittleness](#425-secure-command-and-control-c2-architecture-to-address-brittleness)
    - [4.2.6 Overcome Insufficient Cyberspace Situational Awareness](#426-overcome-insufficient-cyberspace-situational-awareness)
  - [4.3 Science and Technology Solutions](#43-science-and-technology-solutions)
    - [4.3.1 Anti-Tamper Root-of-Trust (L)](#431-anti-tamper-root-of-trust-l)
    - [4.3.2 Cyber Black Box (L)](#432-cyber-black-box-l)
    - [4.3.3 Secure Maintenance Aids (L)](#433-secure-maintenance-aids-l)
    - [4.3.4 GPS Hardening and Alternatives (L)](#434-gps-hardening-and-alternatives-l)
    - [4.3.5 Collaborative/Cooperative Control (L)](#435-collaborativecooperative-control-l)
    - [4.3.6 Advanced Satellite Communications (L)](#436-advanced-satellite-communications-l)
    - [4.3.7 Managed Information Objects (L)](#437-managed-information-objects-l)
    - [4.3.8 Trusted Cloud Computing (L)](#438-trusted-cloud-computing-l)
    - [4.3.9 Mission Mapping (L)](#439-mission-mapping-l)
    - [4.3.10 5th to 5th Platform Communications (L)](#4310-5th-to-5th-platform-communications-l)
  - [4.4 Conclusions of Air Domain](#44-conclusions-of-air-domain)
- [5. Space](#5-space)
  - [5.1 Space Domain Strategic Context](#51-space-domain-strategic-context)
  - [5.2 Findings and Recommendations](#52-findings-and-recommendations)
    - [5.2.1 Develop a Resilient Architecture to Address Space Network Vulnerabilities](#521-develop-a-resilient-architecture-to-address-space-network-vulnerabilities)
    - [5.2.2 Enhance Space Anomaly Detection and Attack Attribution](#522-enhance-space-anomaly-detection-and-attack-attribution)
  - [5.3 Space S&T Recommendations](#53-space-st-recommendations)
    - [5.3.1 Near Term: Cyber Test Beds, Space Sensors, Reconfigurable Antennas, Foundries](#531-near-term-cyber-test-beds-space-sensors-reconfigurable-antennas-foundries)
    - [5.3.2 Mid Term: Survivable Command, Control and Communications (C3), Malware Detection, Autonomous Self-healing Systems, Trusted Architectures](#532-mid-term-survivable-command-control-and-communications-c3-malware-detection-autonomous-self-healing-systems-trusted-architectures)
    - [5.3.3 Far Term: Verified Code Generation, Intent Detection, Cognitive Communications, Space Quantum Key Distribution](#533-far-term-verified-code-generation-intent-detection-cognitive-communications-space-quantum-key-distribution)
- [6. C2 and ISR](#6-c2-and-isr)
  - [6.1 C2 and ISR Domain Strategic Context](#61-c2-and-isr-domain-strategic-context)
  - [6.2 Findings and Recommendations](#62-findings-and-recommendations)
    - [6.2.1 Focus Teams of Experts to Assure Contested C2 and Intelligence, Surveillance, and Reconnaissance (ISR)](#621-focus-teams-of-experts-to-assure-contested-c2-and-intelligence-surveillance-and-reconnaissance-isr)
    - [6.2.2 Create Intelligent Processing Capability to Overcome Massive Data Deluge](#622-create-intelligent-processing-capability-to-overcome-massive-data-deluge)
    - [6.2.3 Assure Information Integrity of Cyber-enabled C2 and ISR at the Tactical Edge](#623-assure-information-integrity-of-cyber-enabled-c2-and-isr-at-the-tactical-edge)
    - [6.2.4 Mature Cross Domain Synchronization](#624-mature-cross-domain-synchronization)
  - [6.4 C2 and ISR S&T](#64-c2-and-isr-st)
    - [6.4.1 Assure and Empower the Mission](#641-assure-and-empower-the-mission)
    - [6.4.2 Optimize Human-Machine Systems](#642-optimize-human-machine-systems)
    - [6.4.3 Resilience and Agility](#643-resilience-and-agility)
    - [6.4.4 Foundations of Trust](#644-foundations-of-trust)
  - [6.5 Conclusion](#65-conclusion)
- [7. Enabling Science and Technology](#7-enabling-science-and-technology)
  - [7.1 Technology Area Overview](#71-technology-area-overview)
    - [7.1.1 Foundations](#711-foundations)
    - [7.1.2 Agility and Resilience](#712-agility-and-resilience)
    - [7.1.3 Human/Social/Machine Systems](#713-humansocialmachine-systems)
    - [7.1.4 Mission Assurance and Empowerment](#714-mission-assurance-and-empowerment)
  - [7.2 Enabling Technology Examples](#72-enabling-technology-examples)
    - [7.2.1 Foundations](#721-foundations)
    - [7.2.2 Agility and Resilience](#722-agility-and-resilience)
    - [7.2.3 Human/Social/Machine Systems Enabling Technology](#723-humansocialmachine-systems-enabling-technology)
    - [7.2.4 Mission Assurance and Empowerment Enabling Technology](#724-mission-assurance-and-empowerment-enabling-technology)
  - [7.3 Air Force Research: Near, Mid, and Far Term](#73-air-force-research-near-mid-and-far-term)
    - [7.3.1 Foundations](#731-foundations)
    - [7.3.2 Agility and Resilience](#732-agility-and-resilience)
    - [7.3.3 Human/Social/Machine Systems](#733-humansocialmachine-systems)
    - [7.3.4 Mission Assurance and Empowerment](#734-mission-assurance-and-empowerment)
- [8. Mission Support](#8-mission-support)
  - [8.1 Cyber Acquisition](#81-cyber-acquisition)
    - [8.1.1 Acquisition of Cyber Systems](#811-acquisition-of-cyber-systems)
    - [8.1.2 Acquisition of Cyber-physical Systems](#812-acquisition-of-cyber-physical-systems)
    - [8.1.3 Cyber and Cyber-physical System Requirements](#813-cyber-and-cyber-physical-system-requirements)
    - [8.1.4 Cyber Assessment and Vulnerability Evaluations](#814-cyber-assessment-and-vulnerability-evaluations)
    - [8.1.5 Cyber Acquisition Recommendations](#815-cyber-acquisition-recommendations)
  - [8.2 Test and Evaluation](#82-test-and-evaluation)
    - [8.2.1 Certification and Accreditation Shortfalls](#821-certification-and-accreditation-shortfalls)
    - [8.2.2 Test and Evaluation Infrastructure](#822-test-and-evaluation-infrastructure)
    - [8.2.3 Test and Evaluation Recommendations](#823-test-and-evaluation-recommendations)
  - [8.3 Education and Training](#83-education-and-training)
    - [8.3.1 Accessing Cyber Talent into the Air Force](#831-accessing-cyber-talent-into-the-air-force)
    - [8.3.2 Education and Training within the Air Force](#832-education-and-training-within-the-air-force)
    - [8.3.3 Education and Training Recommendations](#833-education-and-training-recommendations)
  - [8.4 Cyber Workforce Development](#84-cyber-workforce-development)
    - [8.4.1 Cyber Warrior of the Future](#841-cyber-warrior-of-the-future)
    - [8.4.2 Cyber Workforce Development](#842-cyber-workforce-development)
    - [8.4.3 Cyber Workforce Recommendations](#843-cyber-workforce-recommendations)
  - [8.5 Conclusions](#85-conclusions)
- [9. Conclusion, Summary Findings and Recommendations](#9-conclusion-summary-findings-and-recommendations)
- [10. References](#10-references)
- [Appendix A: Acronyms](#appendix-a-acronyms)
- [Appendix B: Terms and Definitions](#appendix-b-terms-and-definitions)
- [Appendix C: Cyber Vision 2025 Team and Senior Independent Expert Reviewer Group](#appendix-c-cyber-vision-2025-team-and-senior-independent-expert-reviewer-group)
- [Appendix D: Cyber Vision 2025 Working Meetings](#appendix-d-cyber-vision-2025-working-meetings)
- [Appendix E: Cyber Vision 2025 Terms of Reference](#appendix-e-cyber-vision-2025-terms-of-reference)
...
> "Everything we do can be affected either by or through [cyberspace] in either a good or bad way."
> 
> Gen Mark Welsh  
...
Force focus on Global Vigilance, Global Reach, and Global Power, joint, interagency,
combatant command (COCOM) and MAJCOM requirements, and Air Force Core Function
Master Plans (CFMPs).

![Figure 1.1: Strategic Alignment of Cyber Vision 2025](Figure 1.1)
...
![Figure 1.2: Cyberspace Vision Alignment](Figure 1.2)
...
![Figure 1.3: RFI Responses](Figure 1.3)
...
![Figure 1.4: Extensive Subject Matter Expert Engagement](Figure 1.4)
...
- **Survivability** - fitness/readiness, awareness, speed (responsiveness), agility (e.g., flexibility/maneuver), and evolvability
...
![Figure 1.6: Partnerships](Figure 1.6)
...
- Defense industrial base companies who focus Independent Research and
...
Table 1.1: Cyberspace S&T Desired Outcomes  
Technology Leader (L), Follower (F), Watcher (W)

| Area | Near (FY12-FY15) | Mid (FY16-20) | Far (FY21-25) |
| :--- | :--- | :--- | :--- |
| **Assure and Empower the Mission** | • Semi-Automated Mission Mapping and Anomaly Resolution for Cyber SA (L)<br>• Secure Communication (L)<br>• Access and $D^5$ Cyber Effects (L/F)¹ | • Real-time AFNET SA & C2 (L)<br>• Cyber Mission Verification and Assurance Across Sensors/ Platforms<br>• Survivable C3 (L)<br>• Advanced Access, $D^5$ Effects (L/F) | • Autonomous Cyber Mission Assurance/ Management (L)<br>• Predictable Cyber Effects on Mission Systems (L) |
| **Enhance Agility and Resilience** | • Fractionated², Morphable, Reconstituting Architectures (L)<br>• Cyber Maneuver (L)<br>• Intelligent Mix of GOTS/COTS (F) | • Online Vulnerability Identification and Adaptation (F)<br>• Resilient Virtualization (F) | • Autonomous, Secure, Agile Composable Cyber-Physical Systems (L)<br>• Cognitive Comm/Networks (agile, reconfigure, self heal) (L) |
| **Optimize Human-Machine Systems** | • Operator Selection (e.g., traits, methods) (L/F)<br>• Operator Measurement (e.g., stress, cognition, perf., trust) (L)<br>• Adversarial/Social Modeling (L) | • Automated Individual Performance Assessment and Training (L)<br>• Initial Augmented Cognition (L)<br>• Auto Cyber Battle Damage Assess (L) | • Intent/Behavior Detection and Forecasting (L)<br>• Human-Machine Perf Optimize (L)<br>• Neuroscience based brain computer interfaces (L/F) |
| **Foundations of Trust** | • Measurement, Vulnerability Model/Analysis, & Verification (L)<br>• Real-Time Cyber Reverse Engineering (L/F)<br>• Software Anti-Tamper (L)<br>• Secure Virtualization (F) | • Information Integrity V&V<br>• Quantum Communication (L)<br>• Root of Trust for Cyber C2 (L)<br>• Embedded Anti-Tamper (F)<br>• Semi Autonomous Supply Chain Assurance (F) | • Quantum Methods for V&V, Trust, and Vulnerability Assessment (F)<br>• Provable Mission Assurance in Contested Domains (L) |

¹$D^5$ = Degrade, Deceive, Destroy, Deny, Disrupt  
²Fractionated = physically and functionally distributed
...
Table 1.2: Cyberspace S&T Focus Areas *(Primary: Red, Secondary: Yellow, Tertiary: Green)*

| Area | Near (FY12-FY15) | Mid (FY16-20) | Far (FY21-25) |
| :--- | :--- | :--- | :--- |
| **Assure and Empower the Mission** | • Semi-Automated Mission Mapping and Anomaly Resolution for Cyber SA (L)<br>• Secure Communication (L)<br>• Access and $D^5$ Cyber Effects (L/F) | • Real-time AFNET SA & C2 (L)<br>• Cyber Mission Verification and Assurance Across Sensors/ Platforms<br>• Survivable C3 (L)<br>• Advanced Access, $D^5$ Effects (L/F) | • Autonomous Cyber Mission Assurance/ Management (L)<br>• Predictable Cyber Effects on Mission Systems (L) |
| **Enhance Agility and Resilience** | • Fractionated, Morphable, Reconstituting Architectures (L)<br>• Cyber Maneuver (L)<br>• Intelligent Mix of GOTS/COTS (F) | • Online Vulnerability Identification and Adaptation (F)<br>• Resilient Virtualization (F) | • Autonomous, Secure, Agile Composable Cyber-Physical Sys (L)<br>• Cognitive Comm/Networks (agile, reconfigure, self heal) (L) |
| **Optimize Human-Machine Systems** | • Operator Selection (e.g., traits, methods) (L/F)<br>• Operator Measurement (e.g., stress, cognition, perf., trust) (L)<br>• Adversarial/Social Modeling (L) | • Automated Individual Performance Assessment and Training (L)<br>• Initial Augmented Cognition (L)<br>• Auto Cyber Battle Damage Assess (L) | • Intent/Behavior Detection and Forecasting (L)<br>• Human-Machine Perf Optimize (L)<br>• Neuroscience based brain computer interfaces (L/F) |
| **Foundations of Trust** | • Measurement, Vulnerability Model/Analysis, & Verification (L)<br>• Real-Time Cyber Reverse Engineering (L/F)<br>• Software Anti-Tamper (L)<br>• Secure Virtualization (F) | • Information Integrity V&V<br>• Quantum Communication (L)<br>• Root of Trust for Cyber C2 (L)<br>• Embedded Anti-Tamper (F)<br>• Semi Autonomous Supply Chain Assurance (F) | • Quantum Methods for V&V, Trust, and Vulnerability Assessment (F)<br>• Provable Mission Assurance in Contested Domains (L) |
...
![Figure 2.1: Strategic Trends 1999-2025](Figure 2.1)
...
10 ExaFLOPS ($10^{18}$ floating point operations per second) level and new devices will have
...
**Telecommunications Bandwidth** - The rate at which users can move data will reach $10^{13}$ bps.
...
large number of variables that could drastically effect estimates as far out as 2025. These variables... [Text truncated in source PDF]
...
opportunities for attack during the “The most menacing foreign intelligence
...
opportunities for those with malicious intent to contaminate the building blocks of integrated
...
Bring Your Own AF personnel demanding to stay current and more effective while circumventing slow
Device (BYOD) acquisition process and reducing acquisition costs by bringing in their own devices
...
devices.
Software-driven Performing critical operations via millions of lines of code increases the attack surface as
Failure Modes the ability to validate software functionality exceeds capability.
Reliance on Industrial Replacing physical controls and access with remote IT control systems that rely on
Control Systems (ICS) network connectivity and software/hardware functionality, which were not designed for
...
Android’s Law The desire to incorporate the latest IT hardware and software advancements in support of
(Shrinking Android network centric mission operations is resulting in new operating systems and hardware
manufacturing cycles; being introduced faster than their vulnerabilities can be identified and mitigated.
9.7 to 6.7 months)
Moore’s Law The dependence on increasing processing power in support of mission logistics, planning
(transistors on a chip and execution provides cyber actors with greater capability and an expanding suite of
doubles every 18 tools compounded with an increasing ease of mobility.
months)
Quantum The employment of quantum technologies will provide enhanced capabilities to AF
Communication and computing and communications while simultaneously posing significant challenges to
Encryption AF cyber security.
...
Mission • Mission Mapping for • Real-time C2 for AFNET (L) • Assured mission
Assure awareness
Selected Missions (L) • 100 Gigabit Dynamic operations in a
• 10 Gigabit Mission Aware mission awareness (L/F) cloud environment
from
and Routing (L) (F)
managed
Empower • Self-Protecting
information
the Information (L)
Mission • Access and D5 Effects (L/F) • Access and D5 Effects (L/F) • Access and D5
Empower • Scalable Cyber Operations • Cyber/SIGINT & EW (L/F) Effects (L/F)
Framework (L)
...
Area   Thread   Near (F12-FY15)   Mid (FY16-20)   Far (FY21-25)
|     |     | • Real-time encryption  |     | • Embedded anti-tamper     | •  Anticipatory   |     |
| --- | --- | ----------------------- | --- | -------------------------- | ----------------- | --- |
|     |     | at 10Gbits (F)          |     | power (F)                  | defense(L)        |     |
|     |     | • Secure mobile         |     | • Red team automation (F)  | • Autonomic anti- |     |
Resilience
|     |     | platforms (F)  |     |     | tamper (L)   |     |
| --- | --- | -------------- | --- | --- | ------------ | --- |
Enhance
• Self Healing
Agility
Networks (F)
and
|             |          | • Morphable               |     | • Protected root of trust  | • Agile VM         |     |
| ----------- | -------- | ------------------------- | --- | -------------------------- | ------------------ | --- |
| Resilience  | Agility  |                           |     |                            |                    |     |
|             |          | architectures (L)         |     | for cyber C2 (L)           | replacement (L)    |     |
|             |          | • Virtualization for the  |     | • Formal logic (W)         | •  Composable      |     |
|             | Cloud    | AOC (L)                   |     | • Resilient services (F)   | architectures (F)  |     |
• Cloud services (W)
...
Area   Thread   Near (F12-FY15)   Mid (FY16-20)   Far (FY21-25)
|     | • Common operating platform  |     | • Augment human  |     | Automated          |     |
| --- | ---------------------------- | --- | ---------------- | --- | ------------------ | --- |
|     | (L)                          |     | performance (L)  |     | mission view  (L)  |     |
  Visualize
• Automated
decision tools (L)
|     | • Objective measures, sensors,  |     | • Automated  |     | • Individual and  |     |
| --- | ------------------------------- | --- | ------------ | --- | ----------------- | --- |
Optimize
|     | and assessments of operator  |     | individual  |     | group  |     |
| --- | ---------------------------- | --- | ----------- | --- | ------ | --- |
Human-
|     | cognitive state, performance,  |     | performance  |     | performance  |     |
| --- | ------------------------------ | --- | ------------ | --- | ------------ | --- |
Machine  Measure
|     | and trust in automation (L)  |     | measurement (L)  |     | prediction (L)  |     |
| --- | ---------------------------- | --- | ---------------- | --- | --------------- | --- |
Systems
• Cyber operator stress and
vigilance analysis (L)
Train,  •  Operator selection criteria(F)  • Human battle  •  Automated
Educate  •  Adversarial/social reasoning  damage  cyber refresh (F)
|     |     |     | assessment (L)  |     |     |     |
| --- | --- | --- | --------------- | --- | --- | --- |
(L)
...
Area   Thread   Near (F12-FY15)   Mid (FY16-20)   Far (FY21-25)
• System decomposition and  • Supply chain  • Quantitative risk modeling
|     | trust-worthiness modeling  |     | assurance       | (F)  |     |     |
| --- | -------------------------- | --- | --------------- | ---- | --- | --- |
|     | tools (F)                  |     | techniques (F)  |      |     |     |
Trust
| Foundations   | • Reverse engineering and     |     | • Threat     |                              |     |     |
| ------------- | ----------------------------- | --- | ------------ | ---------------------------- | --- | --- |
| of Trust and  | vulnerability analysis tools  |     | avoidance    |                              |     |     |
| Assurance     | (L)                           |     | metrics (L)  |                              |     |     |
|               | • Formal representations of   |     |              | • Formally provable mission  |     |     |
| Assure        | missions (L)                  |     |              | assurance in a contested     |     |     |
cyber domain (L)
...
%
erawtfoS
4-F 7-A 111-F 51-F 61-F 2-B 22-F 53-F
...
Recommendation: Future acquisitions must take
...
(OPR: MAJCOMs, AFLCMC). It is important that the AF
...
environment. The DoD Information Assurance Certification and
Figure 4.6: RPA
Crash in Sychelles

Cyber Vision 2025 32
Accreditation Process (DIACAP) proved ineffective and potentially detrimental for mission
...
Prognostics
|     |     | • Embedded Cyber  | • Secure Maintenance Aids (L)  | • Cyber Dashboard &  |     |
| --- | --- | ----------------- | ------------------------------ | -------------------- | --- |
& Health  Diagnostics (L)  • Dynamic Msn Prioritization (L)  Dynamic Msn Retasking (L)
|     |     | • Sensor s/w tamper  |     | • Attack resistant sensor sys  |     |
| --- | --- | -------------------- | --- | ------------------------------ | --- |
Sensors  • Ingested Data Integrity (L)
|     |     | protection (L)  |     | (L)  |     |
| --- | --- | --------------- | --- | ---- | --- |
th th
Communi- • 5  to 4  Plat. Comm (L)  th th • Cognitive, Self-Healing
• 5  to 5  Platform Comm (L)
Mission  cations  • Frequency Agile Spectrum  • Agile, Virtual Networks (L)  Airborne Networks (L)
| Systems  |             | (L/W)                 |                         |     |     |
| -------- | ----------- | --------------------- | ----------------------- | --- | --- |
...
Crypto- • Lightweight / Adaptive
|         |         | • Suite B Applications (F)   |             | • Quantum Encryption (F)  |     |
| ------- | ------- | ---------------------------- | ----------- | ------------------------- | --- |
| Ground  | graphy  |                              | Encrypt(W)  |                           |     |
Systems
|     | Launch &  | • Collaborative/Cooperative  | • Autonomous Launch /  |     |     |
| --- | --------- | ---------------------------- | ---------------------- | --- | --- |
|     | Recovery  | Control (L)                  | Recovery (F)           |     |     |
...
Support
| Systems   | DCGS  | • Composable Security (L)   | • Trusted Cloud Computing (L)  |     |     |
| --------- | ----- | --------------------------- | ------------------------------ | --- | --- |
...
over great distances leaves open the possibility of loss of those systems to our adversaries. The
...
COLSE
snoilliM
Figure 5.1: Space Systems
Software Growth (Source: SEI)

Cyber Vision 2025 37
forums that they can take control of our satellites through the Command and Control (C2) links.
...
| ----- | ---------------- | -------------- | -------------- | --- |
• Space/cyber test beds  • Survivable, assured  • Small, networked satellite
|     | (fractionated, fight- | real-time C3 in theater  | constellations for  |     |
| --- | --------------------- | ------------------------ | ------------------- | --- |
through demos, shorter  (Software Defined  communications, GPS, missile
Assure and
|     | time to need) (L)  | Radio) (L)  | warning (L)  |     |
| --- | ------------------ | ----------- | ------------ | --- |
Empower the
• Space environment
Mission
...
• Enable and exploit
cloud computing (W)
Optimize  • Restructure cyber  • Detect hidden  • Tools for intent and behavior
|     | acquisition and  | functions, malware in  | determination (F)  |     |
| --- | ---------------- | ---------------------- | ------------------ | --- |
Human-
|     | operations policy -  | the integrated  |     |     |
| --- | -------------------- | --------------- | --- | --- |
Machine
|     | allow for full spectrum  | space/cyber networks  |     |     |
| --- | ------------------------ | --------------------- | --- | --- |
Systems
|     | (F)   | (hypervisors, etc) (F)   |     |     |
| --- | ----- | ------------------------ | --- | --- |
Enhance  • Reconfigurable  • Autonomous self- • Cognitive communications -
|     | antennas and  | healing systems (F)    | agile, reconfigurable,  |     |
| --- | ------------- | ---------------------- | ----------------------- | --- |
Agility and
|     | algorithms (L)  |     | composable communications  |     |
| --- | --------------- | --- | -------------------------- | --- |
Resilience
and sensors (L)
• Foundations of trust –  • Trusted satellite-cyber  • Flexible, scalable high-rate
|     | hardware foundries,  | architectures (L)  | encryption (F)  |     |
| --- | -------------------- | ------------------ | --------------- | --- |
Foundations
|     | trusted software  | • Strong satellite C2  | • Space Quantum Key  |     |
| --- | ----------------- | ---------------------- | -------------------- | --- |
of Trust and
|     | generation (W)  | authentication (L)  | Distribution (QKD)  (F)  |     |
| --- | --------------- | ------------------- | ------------------------ | --- |
Assurance
|     |     | • Generate, detect single  | • Autocode generators that  |     |
| --- | --- | -------------------------- | --------------------------- | --- |
|     |     | photons/radiation (W)      | produce software that is    |     |
...
retail and manufacturing are making large investments in large data for competitive advantage
...
mission, the obvious utility of cyber power to create far-reaching effects requires the AF to
...
Area Near (F12-FY15) Mid (FY16-20) Far (FY21-25)
• Semi-automated Cyber- • Automated Cyber- • Dynamically Generated
Mission Mapping (L) Mission Mapping (F) Cyber-Mission Mapping
Assure and • Integrated Physical-space • Validated Physical-Cyber (L)
Empower and Cyber-space M&S (L) Space Models Integrated • Fully Integrated
the Mission • Cyber asset with Test Beds (L/F) Capability to Predict
characterization (F) • Large scale cyber Cyber Effects on Mission
Systems (F)
• New Data Compression (F) quantification and effects
estimation (L)
...
Area Near (F12-FY15) Mid (FY16-20) Far (FY21-25)
• Visualization of cyber • Mapping human perceptual • Mapping human intuitive
impacts on missions (L) skills to representations of reactions to representations
Human-
• Autonomic responses to cyber situations (F) of cyber situations (F)
Machine
reliable indicators of • Integration of autonomic • Optimization of human-
Systems
adversary activity (F) “triage” with human cyber responses to complex
• Validated framework decision-making for complex cyber situations (L)
defining a cyber cyber situations (L) • Foundations for projecting
“situation” (L) • Foundations for cyber data adversary trajectories
fusion (L) through cyberspace (L)
...
Area Near (F12-FY15) Mid (FY16-20) Far (FY21-25)
• Secure Clouds (F) • Identification of the • Automatic Compromise
• Cloud-based Point of Compromise (L) Detection (F)
implementations of AF • Secure Manual Rollback • Dynamic Rollback (F)
Agility and C2 and ISR functions to an Uncompromised • Living Plan for Agile
Resilience (L) State (F) Operations (L)
• Analysis of Moving • Agile Integrated • Sequencing OCO and DCO
Target Defense (F) Operations Planning (L)
Actions (L)
• Integrated Air, Space • Sequencing Kinetic &
and Cyber Plans (L) Non-Kinetic Actions (L)
...
Area Near (F12-FY15) Mid (FY16-20) Far (FY21-25)
• Commercial HW support for • Trusted foundry or • Contextual
platform attestation (F) verified HW support for verification for
Foundations • Faster, more secure cryptographic platform attestation (F) information
of Trust technology (F)
• N-version verification of integrity (L)
information integrity (L)
• Dynamic keying (F)
• Anti-tamper protection
• Anti-tamper protection for software for devices in the field (L)
...
Measurement, Analysis, Taxonomy of System Quantum Methods for
Foundations & Verification Vulnerability Vulnerability Assessment
and Security
Agility and Secure Virtualization for Online Vulnerability Autonomous Physically
Resilience Critical Infrastructure Identification, Adaptation Secure Cyber Systems
(e.g. the AOC) and System Repair
Human/ Social/ Advanced Situational Online Assessment of Cyber Cyber Operator
Machine Awareness for Cyber Operator Performance Performance
Systems Operators Augmentation
Mission Mission Mapping to Cyber Mission Verification Dynamic Cyber Mission
Assurance and Systems Components Across Sensors/Platforms Configuration
Empowerment
...
warfare capabilities, and has divided this area into two categories -- Rapid Cyber Acquisition
...
federal deficits, limited production paralyze this nation from a cyber attack is very
of U.S. computer graduates, and real.”
...
Northrop, Linda. 2006. Ultra-Large-Scale Systems: The Software Challenge of the Future.
...
Director of Nationl Intelligence. 2 February 2012.
...
mission. JP 3-13.4
Mission Assuran ce (cyberspace). Measures required to accomplish essential objectives of
...
Cyber Vision 2025 85
Appendix C: Cyber Vision 2025 Team and
...
• Air:
3
• Prof Mark Lewis , University of Maryland
6
...
• Space
3, 6
• Dr. Mike Yarymovych , President Sarasota Space Associates
2
• Don Kerr
2
• Mr. Keith Hall , Booze Allen Hamilton
6
...
3
• Prof. Werner Dahm , Director Security & Defense Systems Initiative (SDSI), Arizona State Univ
• Charles Bouldin, NSF
