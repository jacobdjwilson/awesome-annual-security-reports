...
- [Claims Trends](#claims-trends)
- [Cause of Loss](#cause-of-loss)
- [Point of Failure](#point-of-failure)
- [Rogues Gallery](#rogues-gallery)
- [Top Ransomware Gangs - Current Threats](#top-ransomware-gangs---current-threats)
- [Highlight: Scattered Spider](#highlight-scattered-spider)
- [Industry Focus](#industry-focus)
- [ROC in Action: Case Studies in Loss Control](#roc-in-action-case-studies-in-loss-control)
...
![Vendor-Related Cyber Claims Frequency chart]
...
![Share of Cyber Losses from Vendor Risk chart]
...
1. **AI is making social engineering more effective.** According to CrowdStrike's 2025 Threat Hunting Report, 78% of enterprises experienced at least one AI-specific breach in 2025, with AI-generated phishing campaigns achieving a 54% success rate, compared to just 12% for traditional attempts.
2. **Attackers are working smarter, not harder.** The ransomware playbook is evolving. While Resilience data shows that 79% of clients who were attacked with ransomware over the entire lifetime of our portfolio successfully avoided paying a ransom, these attacks are still costly and disruptive to recover from. For ransomware attacks that lead to incurred claims, the average claim in 2025 so far is over $1.18m.
3. **Ecosystem risks are connected — and compounding.** The interconnected nature of modern businesses compounds this issue: complex technical ecosystems, complex corporate structures, shared risk pools, and franchise relationships all link risk across portfolios.
...
In the first half of 2025, the average loss per incurred claim decreased by 11% compared to the same period in 2024. However, ransomware attacks grew in severity by 17%, now accounting for 76% of incurred losses. The number jumps to 91% if you include losses from a vendor experiencing ransomware.
...
![H1 2025 Cyber Claims: Cause of Loss table]

---

## Point of Failure
Point of failure analysis indicates the control failure that leads to the loss.

![2024 Point of Failure chart]
![2025 H1 Point of Failure chart]

---

## Rogues Gallery
This year has underscored a troubling reality: cybercriminals are increasingly exploiting human error. Rather than relying solely on advanced malware or zero-day exploits, they are perfecting social engineering—using carefully crafted phone calls and impersonation schemes.

### Top Ransomware Gangs Attacking the Resilience Portfolio
![Top Ransomware Gangs chart]

- **Medusa**: Operates as a ransomware-as-a-service (RaaS) variant that employs a double extortion model.
- **Akira**: A RaaS gang that emerged in March 2023, linked to the dissolved Conti gang.
- **Interlock**: Known for targeting organizations across North America and Europe using double extortion tactics.
- **Chaos**: Operates as a ransomware builder that functions more like destructive wiper malware.

---

## Highlight: Scattered Spider
Scattered Spider stole the spotlight again in H1 2025, with high visibility attacks on retail, aviation, and insurance. A sophisticated, English-speaking cybercriminal group, Scattered Spider is believed to consist primarily of young UK- and US-based operatives and has been in operation since at least 2022.

---

## Industry Focus
- **Manufacturing**: Organizations encountered significant cyber challenges in the first half of 2025, with several ransomware incidents generating claims averaging over $1 million in severity.
- **Retail**: Losses from the Scattered Spider attacks in the spring affected the entire retail supply chain.
- **Healthcare**: In 2024, the healthcare sector suffered the most severe cyberattacks of any industry in the Resilience portfolio, with average losses reaching $1.3 million per incurred claim.

---

## ROC in Action: Case Studies in Loss Control
- **Chaos Ransomware Data Suppression**: In February 2025, a high-end real estate firm was compromised by the Chaos Ransomware group. Resilience's crisis team achieved an 85% reduction from the initial $4 million demand, with final settlement at approximately $615,000.
- **Microsoft SharePoint ToolShell Vulnerability**: In July 2025, Eye Security observed active exploitation of a zero-day Microsoft SharePoint vulnerability. The ROC proactively identified the threat and had targeted notifications out to high-risk clients before most organizations even knew they were vulnerable.

---

## Appendices
### Methodology
The data and insights presented in this report are derived from Resilience's internal insurance claims portfolio and threat research team. Our analysis covers claims reported and processed during the first half of 2025, with comparative data extending back to 2023.

### Definitions and Glossary
- **Incurred claim**: A claim notice that resulted in or is expected to result in a non-zero dollar loss.
- **Point of failure**: The initial method or vulnerability that cybercriminals exploit to gain unauthorized access.
