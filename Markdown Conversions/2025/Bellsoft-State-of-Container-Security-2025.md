...
![Bar chart titled "What is the most important factor for you when choosing a base container image?" showing: Security (minimal number of CVEs) 29%, Performance 21%, Image size 17%, Java support 17%, License compliance 11%, Ease of use 4%, and Other 1%.]
...
![Bar chart titled "What parameters are critical for your company for Java application performance in containers?" showing: Efficient memory usage 86%, High throughput under load 68%, Fast startup time 66%, Minimal OS overhead 46%, and Compatibility with cloud-native tools 32%.]
...
![Bar chart titled "Which of the following do you find essential inside the base container?" showing: Shell 54%, Package manager (rpm, apt, apk, etc) 39%, curl/wget 34%, Editor (nano, vi, vim, ed...) 25%, None of the above/I use distroless 17%, binutils/coreutils 14%, and openssh 28%.]
...
![Donut chart titled "Base Operating Systems" showing: Alpine Linux 41%, Ubuntu/Debian 34%, Red Hat/Red Hat-based distributions (Rocky, AlmaLinux, CentOS) 21%, Alpaquita Linux 2%, and other distributions 1%. A callout notes that 55% of respondents report using bloated general-purpose Linux distributions.]
...
![Bar chart titled "Which JDKs do you use inside your containers?" showing: Oracle/OpenJDK 48%, Adoptium/Temurin 21%, Amazon Corretto 14%, I do not use JVM containers 8%, BellSoft’s Liberica JDK 7%, and Other 2%.]
...
![Bar chart titled "What container security mechanisms do you currently apply?" showing: Working only with trusted image registries 45%, Vulnerability scanning (e.g., Trivy, Clair...) 43%, Only standard Docker/Kubernetes tools 36%, Software Bill of Materials (SBOM) generation 18%, Image signing (e.g., Cosign) 16%, No additional measures used 10%, and Secure container isolation using hardware virtualization (gVisor, Kata Containers) 6%.]
...
![Bar chart showing update frequency: With every application release 31%, Only when critical vulnerabilities are found 26%, Monthly 19%, Rarely (every few months or less) 14%, and Weekly 10%.]
...
![Pie chart titled "In the past 12 months, has your organization experienced any security incidents related to containerized applications?" showing: No incidents 60%, Yes, minor incident(s) 18%, and Yes, major incident(s) 5%. (Remaining percentage not explicitly labeled in the visual but implied as unknown/no answer).]
...
![Bar chart titled "Main challenges you see in securing containers?" showing: Human errors 62%, Time and resource constraints 49%, Difficulties with regular patching 36%, Lack of organizational priority 36%, Gaps before patches become available 32%, False positives from scanning tools 29%, and Limitations of standard tools 27%.]
...
![Bar chart titled "What would most help your organization improve container security?" showing: Pre-hardened, security-focused base images 48%, Better/easier automated tools 43% (Note: text says 47% in summary, chart says 43%), More time and resources 36%, Clearer best practices and guidelines 29%, Better integration with development workflows 21%, and Executive support and prioritization 19%.]
