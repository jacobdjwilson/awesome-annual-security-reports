...
![Chart: Which of the following do you find essential inside the base container? shell: 54%; package manager: 39%; curl/wget: 34%; openssh: 28%; Editor (nano, vi, vim, ed…): 25%; none of the above, I use distroless: 17%; binutils, coreutils: 14%]
...
![Chart: Base Operating Systems. Alpine Linux: 41%; Ubuntu/Debian: 34%; Red Hat/Red Hat-based distributions (Rocky, AlmaLinux, CentOS): 21%; Alpaquita Linux: 2%; other distributions: 1%]
...
![Chart: Which JDKs do you use inside your containers? Oracle/OpenJDK: 48%; Adoptium/Temurin: 21%; Amazon Corretto: 14%; I do not use JVM containers: 8%; BellSoft’s Liberica JDK: 7%; Other: 2%]
...
1.  **Human resources:** errors dominate at 62% — even with the best tools, implementation failures remain the primary vulnerability.
...
![Chart: What would most help your organization improve container security? Pre-hardened, security-focused base images: 48%; Better/easier automated tools: 43% (Note: text says 47%, chart says 43%); More time and resources: 36%; Clearer best practices and guidelines: 29%; Better integration with development workflows: 21%; Executive support and prioritization: 19%]
