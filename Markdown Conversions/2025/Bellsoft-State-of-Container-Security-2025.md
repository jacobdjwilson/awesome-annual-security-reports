...
![Chart showing factors for choosing a base container image: Security (29%), Performance (21%), Image size (17%), Java support (17%), Ease of use (11%), License compliance (4%), Other (1%)]
...
![Chart showing critical parameters for Java performance: Efficient memory usage (86%), High throughput under load (68%), Fast startup time (66%), Minimal OS overhead (46%), Compatibility with cloud-native tools (32%)]
...
![Chart showing essential items inside the base container: Shell (54%), package manager (39%), curl/wget (34%), openssh (28%), Editor (25%), None/distroless (17%), binutils/coreutils (14%)]
...
![Chart showing Base Operating Systems: Alpine Linux (41%), Ubuntu/Debian (34%), Red Hat/Red Hat-based distributions (21%), Alpaquita Linux (2%), Other (1%). Note: 55% use bloated general-purpose distributions.]
...
![Chart showing JDK usage: Oracle/OpenJDK (48%), Adoptium/Temurin (21%), Amazon Corretto (14%), Do not use JVM containers (8%), BellSoft’s Liberica JDK (7%), Other (2%)]
...
![Chart showing container security mechanisms: Working with trusted registries (45%), Vulnerability scanning (43%), Only standard tools (36%), SBOM generation (18%), Image signing (16%), No additional measures (10%), Hardware isolation (6%)]
...
![Chart showing update frequency: With every release (31%), Only when critical vulnerabilities found (26%), Monthly (19%), Rarely (14%), Weekly (10%)]
...
![Pie chart showing security incidents: No incidents (60%), Minor incidents (18%), Major incidents (5%), (Unaccounted/Other 17%)]
...
![Chart showing main challenges: Human errors (62%), Time and resource constraints (49%), Lack of organizational priority (36%), Difficulties with regular patching (36%), Gaps before patches available (32%), False positives (29%), Limitations of standard tools (27%)]
...
![Chart showing what would help improve security: Pre-hardened images (48%), Better/easier automated tools (43%), More time and resources (36%), Best practices/guidelines (29%), Better integration with workflow (21%), Executive support (19%)]
