...
![Bar chart showing the most important factors when choosing a base container image: Security (minimal number of CVEs) 29%, Performance 21%, Java support 17%, Image size 17%, License compliance 11%, Ease of use 4%, and Other 1%.]
...
![Bar chart showing essential elements found inside the base container: shell 54%, package manager (rpm, apt, apk, etc) 39%, curl/wget 34%, openssh 28%, Editor (nano, vi, vim, ed…) 25%, none of the above/distroless 17%, and binutils/coreutils 14%.]
...
![Pie chart showing Base Operating Systems: 55% of respondents report using bloated general-purpose Linux distributions (Ubuntu/Debian 34%, Red Hat/Red Hat-based distributions 21%). Alpine Linux accounts for 41%, Alpaquita Linux 2%, and other distributions 1%.]
...
![Bar chart showing which JDKs are used inside containers: Oracle/OpenJDK 48%, Adoptium/Temurin 21%, Amazon Corretto 14%, I do not use JVM containers 8%, BellSoft’s Liberica JDK 7%, and Other 2%.]
...
![Bar chart showing how often container images are updated: With every application release 31%, Only when critical vulnerabilities are found 26%, Monthly 19%, Weekly 14%, and Rarely (every few months or less) 10%.]
...
![Pie chart showing security incidents in the past 12 months: No incidents 60%, Yes, minor incident(s) 18%, and Yes, major incident(s) 5%.]
