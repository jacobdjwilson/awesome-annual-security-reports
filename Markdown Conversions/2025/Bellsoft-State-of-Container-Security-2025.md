...
## Executive Summary
The container ecosystem has matured significantly over the past decade, yet fundamental questions about security practices remain unresolved. To better understand how teams manage container security today, we surveyed 427 professionals at Devoxx 2025[^1] to examine:
...
## Key Findings
![Infographic showing key statistical findings of the 2025 report]
...
![Bar chart: What is the most important factor for you when choosing a base container image? Security (29%), Performance (21%), Image size (17%), Java support (17%), Ease of use (11%), License compliance (4%), Other (1%)]
...
![Bar chart: What parameters are critical for your company for Java application performance in containers? Efficient memory usage (86%), High throughput (68%), Fast startup time (66%), Minimal OS overhead (46%), Compatibility with cloud-native tools (32%)]
...
![Bar chart: Which of the following do you find essential inside the base container? Shell (54%), package manager (39%), curl/wget (34%), openssh (28%), Editor (25%), none/distroless (17%), binutils/coreutils (14%)]
...
![Pie chart: Base Operating Systems. Ubuntu/Debian (34%), Red Hat-based (21%), Alpine Linux (41%), Alpaquita Linux (2%), Other (1%)]
...
![Bar chart: Which JDKs do you use inside your containers? Oracle/OpenJDK (48%), Adoptium/Temurin (21%), Amazon Corretto (14%), I do not use JVM containers (8%), BellSoft’s Liberica JDK (7%), Other (2%)]
...
![Bar chart: What container security mechanisms do you currently apply? Working only with trusted image registries (45%), Vulnerability scanning (43%), Only standard Docker/Kubernetes tools (36%), SBOM generation (18%), Image signing (16%), No additional measures (10%), Hardware isolation (6%)]
...
![Bar chart: How often do you update your container images? With every application release (31%), Only when critical vulnerabilities are found (26%), Monthly (19%), Rarely (14%), Weekly (10%)]
...
![Pie chart: Has your organization experienced any security incidents related to containerized applications? No incidents (60%), Yes - minor (18%), Yes - major (5%)]
...
![Infographic: Main challenges in securing containers. Human errors (62%), Time and resource constraints (49%), Difficulties with regular patching (36%), Lack of organizational priority (36%), Gaps before patches (32%), False positives (29%), Limitations of standard tools (27%)]
...
---
[^1]: The official report is based on a survey of 427 professionals at Devoxx 2025. URL: https://www.google.com/search?q=Bellsoft+State+Of+Container+Security