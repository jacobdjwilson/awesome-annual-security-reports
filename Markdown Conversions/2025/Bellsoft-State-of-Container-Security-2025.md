...
*   Security (minimal number of CVEs): 29%
*   Image size: 17%
*   Java support: 17%
*   Performance: 21%
*   Ease of use: 11%
...
*   none of the above, I use distroless: 17%
...
*   Ubuntu/Debian: 34%
*   Red Hat/Red Hat-based distributions (Rocky, AlmaLinux, CentOS): 21%
*   Alpine Linux: 41%
*   Alpaquita Linux: 2%
*   other distributions: 1%

55% of respondents report using bloated general-purpose Linux distributions.
...
*   Weekly: 10%
*   Monthly: 19%
*   Rarely (every few months or less): 14%
...
*   **Human errors dominate at 62%**—even with the best tools, implementation failures remain the primary vulnerability.
*   The second cluster revolves around **resource constraints**: patching difficulties at 36%, gaps before patches at 32%, and false positives at 29%.
*   The third centers on **time constraints** at 49% and lack of organizational priority at 36%.
...
*   Human errors and mistakes: 62%
*   Difficulties with regular patching: 36%
*   Gaps before patches become available: 32%
*   False positives from scanning tools: 29%
*   Limitations of standard tools: 27%
*   Lack of organizational priority: 36%
*   Time and resource constraints: 49%
...
want pre-hardened, security-focused images: 48%