...
The official report URL is: https://github.com/jacobdjwilson/awesome-annual-security-reports/blob/main/Annual%20Security%20Reports/2025/DigitalAI-Application-Security-Threat-Report-2025.pdf
...
What does this mean? These apps[^1] were either run in an unsafe
...
of a data breach approaching 5 million USD[^2], organizations cannot delay in
fortifying their investments. With an explosion of freely available tools and
AI-powered capabilities, threat actors can now effortlessly reverse-engineer,
...
years’ findings, incorporating industry-specific trends, regional differences,
...
![Figure 1: In January 2025, 83% of Digital.ai-monitored client-side apps were attacked](Image description: A bar chart showing that 83% of client-side apps monitored by Digital.ai were attacked in January 2025.)

---

## Key Findings

1.  **Rising Attacks on Client-Side Apps**: The percentage of apps experiencing attacks has surged from 65% in
...
2.  **More Apps Are Released More Frequently**: Organizations continue the frenetic pace of delivering apps to their
    customers. This trend is most obvious in the mobile application
    app space— Apple’s App Store® and the Google Play™ store
    offered nearly 4 million apps[^3] with 137.8 billion downloads in
    2024—while desktop and web apps also remain popular.

3.  **Threats Are not Limited to FinServ Apps**: While financial services have traditionally been a primary
...
4.  **Urgent Need for App Security**: Organizations must prioritize resilience against reverse engineering
...
with remarkably effective protection, saving businesses millions of dollars,
reducing risk, and increasing the most valuable asset of all: customer trust.

[^3]: https://42matters.com/stats

![Figure 2: Attacks rose on client-side apps from 2024-2025 across device types](Image description: A bar chart comparing app attacks on iOS and Android from 2024 to 2025, showing an increase in both categories.)

![Figure 3: Significant attacks in the Telecom and Automotive industries in 2025](Image description: A visual representation showing attack percentages for Automotive (86%) and Telecom (91%) industries in 2025.)
...
customers of Digital.ai’s Application Security offerings around the world.
...
Apple’s App Store® and the Google Play™ store together offer nearly
4 million apps[^5] for download, with 137.8 billion downloads in 2024.
...
5 million USD[^6] and any app in the wild is a potential threat vector.
...
have made threat actors more efficient and prolific than ever before.
...
3.  Finally, the growing attack surface not only leads to an increase
    ...
    offers ample opportunities for them to hone their skills.

What’s different in 2025? Attack rates have surged across all
...
![Figure 4: Client-side app attacks increased by 27% between 2024 and 2025](Image description: A bar chart showing the increase in client-side app attacks from 65% in 2024 to 82.7% in 2025.)
...
attack detection, giving enterprises clearer insight into the risks they face.

![Figure 5 (A-D): Attacks on client-side applications increased across all industries in 2025](Image description: Four pie charts showing attack rates by industry: FinServ (87.5%), Healthcare (78.5%), Automotive (86%), and Telecom (91%).)
...
mobile device experiencing attacks. While Android has historically
been targeted more often, the gap has narrowed as iOS attacks increase, likely
...
rooted or jailbroken devices, affected 84.2% of Android™ platform apps
...
![Figure 6: Increase in attacks across device types between 2023 and 2025](Image description: A line graph showing the increase in attacks on Android and iOS devices from 2023 to 2025.)
...
![Figure 7: Environment attacks in 2025](Image description: A bar chart showing the percentage of Android and iOS apps experiencing environment attacks in 2025.)
...
![Figure 8: Instrumentation attacks in 2025](Image description: A bar chart showing the percentage of Android and iOS apps experiencing instrumentation attacks in 2025.)

Integrity attacks, where app code is modified or repackaged, affected 51.4%
...
![Figure 9: Integrity attacks in 2025](Image description: A bar chart showing the percentage of Android and iOS apps experiencing integrity attacks in 2025.)

Ultimately, both platforms face persistent threats, but differences in
architecture and security policies affect attack techniques. As a result,
organizations apply different levels, layers, and types of protections
to apps running on the two different operating systems.
...
or enterprises that develop mobile apps. For instance, if two different
...
were attacked. This approach focuses on the proportion of affected apps
...
with which they are interacting may be negatively affected.
...
![Figure 10: Hypothesized attack % across versions](Image description: A hypothetical line graph showing attack percentages across different Android OS versions, suggesting an inverted bell curve.)
...
1.  OS developers, such as Apple and Google, have progressively
    ...
    attention until effective attack techniques and tools are developed.
2.  Threat actors aim to create tools that are usable across the widest
    ...
    difficult over time, and maintaining support for these devices
...
developers to support. Apple’s efforts to ensure that all users, including
threat actors, adopt the latest OS versions are evident in the data.

![Figure 11: Attack % across versions](Image description: A line graph showing real-world attack percentages across different Android OS versions.)

![Figure 12: Attack % across versions](Image description: A line graph showing attack percentages across different iOS versions.)
...
-   EMEA’s high attack rate is likely influenced by its strong fintech adoption
...
-   Lower attack rates in APAC and LATAM are encouraging but may also
    ...
    LATAM and APAC, having different reporting and data security requirements,
...
lower visibility into these threats due to differing regulatory frameworks found there.
...
![Figure 13: Attack rates by region](Image description: A bar chart showing attack rates by region: EMEA (0.69%), North America (0.64%), LATAM (0.58%), and APAC (0.42%).)
...
> “Organizations can no longer afford to leave
...
to bypass security controls. Regional differences suggest that regulation
...
no longer afford to leave their doors unlocked or rely on subpar locks.
...
Digital.ai’s Application Security solutions deliver cost-effective, simple-to-
implement, and remarkably effective protection against these attacks. As
...
The AI-Powered Software Delivery
...
[Demo Now](https://www.digital.ai/demo)

About Digital.ai

Digital.ai is the only AI-powered software delivery platform purpose-built for the enterprise, enabling the world’s
largest organizations to build, test, secure, and deliver high-quality software. By unifying AI-driven insights, automation,
...
AI-driven world. Additional information about Digital.ai can be found at digital.ai and on LinkedIn, YouTube, and X.