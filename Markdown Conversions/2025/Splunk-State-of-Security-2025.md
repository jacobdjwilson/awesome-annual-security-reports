...
![Decorative image of a stylized network or data flow]
...
![Bar chart showing top sources of inefficiency in the SOC]
...
![Pie chart showing levels of trust in AI for mission-critical activities in the SOC]
...
This is the future of generative AI, and respondents are enthusiastic about its role in cybersecurity. Nearly two thirds (63%) agree that it extremely or significantly enhances security operations compared to publicly available tools.
...
![Bar chart comparing current skills gaps with top skills needed for a resilient future SOC]
...
DevSecOps | 36% | 74%
Compliance management | 30% | 60%
Analytical investigation of incidents | 28% | 55%
Threat hunting | 20% | 18%
...
![Bar chart showing top staffing challenges for SOC teams]
...
![Bar chart showing leading causes of poor detection quality]
...
Detection as code will be front and center in the SOC of the future