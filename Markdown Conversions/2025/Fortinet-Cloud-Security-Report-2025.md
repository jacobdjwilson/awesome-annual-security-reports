...
Key Insights and Strategies for Protecting
Cloud Environments
...
This report underscores the importance of unified cloud security solutions that streamline policy enforcement, automate threat detection, and ensure consistent protection across hybrid and multi-cloud environments. By leveraging these insights and best practices, organizations can build a resilient cloud security posture that adapts to evolving threats and business demands.
...
82% of organizations are using a
...
------- | --------
Microsoft Azure: 76% | Microsoft Azure: 20%
AWS: 70% | AWS: 16%
Google Cloud Platform: 52% | Google Cloud Platform: 25%
Oracle Cloud: 9% | Oracle Cloud: 14%
IBM Cloud: 6% | IBM Cloud: 18%
Other: 10% | Other: 17%
...
- 61% Security and compliance concerns
- 54% Organizational and operational factors
- 51% Resource constraints
- 48% Technical challenges
- 28% Cloud service concerns
- 25% Provider-related issues and legalities
...
Additional responses include: Shadow IT and unauthorized app usage 46% | Cloud integration and automation 43% | Endpoint security 40% | Resource allocation 38% | DevSecOps practices 31% | Operational agility and complexity 25%
...
Additional responses include: Managing the costs of different solutions 41% | Understanding service integration options 40% | Providing seamless access to users based on their credentials 37% | Selecting the right set of services 30% | Other 1%
...
How confident are you in your organization's ability to detect and respond to threats across all of your cloud environments in real-time?

64% have little to no confidence in their
...
1. Cloud Security Posture Management (CSPM): 67%
2. Cloud Native Application Protection Platform (CNAPP): 62%
3. Cloud Workload Protection Platform (CWPP): 60%
4. Cloud Detection and Response (CDR): 59%
5. Data Security Posture Management (DSPM): 54%
6. Cloud Infrastructure Entitlement Management (CIEM): 50%
7. Application Security Posture Management (ASPM): 48%
...
- 52% Security monitoring
  and operations
- 50% Governance, Risk, and
  Compliance (GRC)

Additional responses include: Training and Awareness 45% | Communication and Strategy 39% | Not Sure 3%
...
5.  **UTILIZE POLICY-AS-CODE FOR CONSISTENT SECURITY ENFORCEMENT**
    As 43% of respondents reported challenges understanding how different solutions integrate, leveraging policy-as-code approaches ensures consistent enforcement across platforms. Policy-as-code simplifies audits and enables automated configuration management, ensuring that security controls remain aligned with organizational requirements.
...
**INDUSTRY**
- Technology, Software & Internet: 23%
- Financial Services: 14%
- Government: 12%
- Healthcare, Pharmaceuticals & Biotech: 9%
...
We encourage the reuse of data, charts, and text published in this report under the terms of this Creative Commons Attribution 4.0 International License. You’re free to share and make commercial use of this work as long as you attribute the report as stipulated in the terms of the license. For example: “2025 Cloud Security Report by Cybersecurity Insiders and Fortinet.”
