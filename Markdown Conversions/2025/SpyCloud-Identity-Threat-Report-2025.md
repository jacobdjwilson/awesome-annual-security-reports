# 2025 Identity Threat Report

![2025 SpyCloud Identity Threat Report Cover]
...
**When it comes to initial access vectors, organizations are most concerned about:**
- Phishing
- Supply chain exposures
- Malware infections leading to follow-on attacks (such as the North Korean fraudulent IT worker scheme)
...
Today’s adversaries are orchestrating hybrid attacks that blend technical exploits with human deception. Rather than relying solely on software vulnerabilities, which have long been standard fare, attackers now increasingly weaponize identity sprawl.
...
- **Phishing**: 40% extremely concerned.
- **Ransomware**: 37% extremely concerned.
- **Nation-State Adversaries**: 36% extremely concerned.
- **Unmanaged or Unauthorized Devices**: 36% extremely concerned.

---

## Top Phishing Threats of 2025

SpyCloud recaptures data from phishing-as-a-service (PhaaS) platforms and kits. Analyzing these tools is helpful for understanding how bad actors are quickly evolving their phishing tactics.

- **FlowerStorm**: A PhaaS platform that emerged in mid-2024, designed to steal Microsoft 365 credentials and MFA tokens using Adversary-in-the-Middle (AitM) attacks.
- **Tycoon 2FA**: A sophisticated PhaaS platform active since August 2023, specializing in bypassing MFA protections by capturing session cookies.
- **Evilginx**: A modular AitM phishing framework designed to intercept login credentials and session cookies.

---

## The Confidence Trap: Perception vs. Reality

While 86% of organizations report feeling somewhat or very confident in their ability to prevent a ransomware attack, 85% actually experienced an attempt or successful attack in the past year. 

**The Confidence Divide:**
- 45% of CIOs and CISOs report feeling very confident in their ransomware defense capabilities.
- Only 28% of security directors and team leads say the same.

Practitioners—those in the trenches—see the cracks up close, including alert fatigue, limited automation, and inconsistent follow-through.

---

## Identity Black Holes: The Remediation Lag

What makes identity exposure uniquely dangerous is its ability to penetrate an organization from nearly any angle. 
...
Ransomware and identity-driven attacks trigger a cascade of operational and reputational fallout. 

- **56%** of organizations reported ransomware-related costs exceeding $1 million.
- **55%** experienced significant operational downtime.
- **50%** cited significant reputational damage.

---

## AI: The Force Accelerating Threats

Almost all organizations surveyed (92%) agree that AI-powered cybercrime has intensified risk. Adversaries are using generative AI to:
...
Despite this, only 47% of organizations currently leverage AI tools in their security stack.

---

## Recalibrating Fundamentals and Expanding Your Mission Scope

The threat landscape has irrevocably changed. Now is a critical time for teams to take a hard look under the hatch, confront any confidence biases, and set identity-centric priorities for the year ahead.

**Back to Operational Basics:**
- Routine credential resets after phishing or malware exposure.
...
The study surveyed 507 security professionals across a wide spectrum of organizational roles, sizes, and industries. All respondents had direct or indirect responsibility for identity security within their organizations. The research captured perspectives from key regions including the United States, Canada, and the United Kingdom.
