...
![Exhibit 2: Diagram illustrating how identity, as a central control point in the security tech stack, enables and enhances capabilities across multiple domains. Domains include Endpoint security, Network security, Cloud security, Data protection, Application security, Governance, Risk & Compliance, Threat detection/SIEM, and Third party security, each with a brief description of identity's role.](image-description-exhibit-2.png)
...
![Exhibit 3: Diagram showing how integrated identity will power dynamic access across users, unified visibility, and automated response. It categorizes identity security trends into "Nascent," "Emerging," and "Mainstream" for 2024 and beyond, across four themes: Identity governance, Privileged access, Identity fabric, and Integrated identity telemetry.](image-description-exhibit-3.png)
...
![Exhibit 4: Table showing proof points from the last 12-18 months supporting progress across elements shaping the future of identity, categorized by Identity, Data, and Security. It lists specific examples for Identity-centric governance, Privileged access, Identity fabric, and Integrated identity telemetry.](image-description-exhibit-4.png)
...
![Exhibit 5: Diagram illustrating the SailPoint Horizons maturity framework, clustering key criteria into 5 maturity horizons (Insufficient, Foundational, Advanced, Extended and unified identity) based on strategy, talent, operating model, and technology capabilities.](image-description-exhibit-5.png)
...
![Exhibit 7: Bar chart showing the distribution of organizations across the 5 customer identity journey horizons by industry. It indicates that Tech and banking see a greater share in H4 and H5, while healthcare and manufacturing lag behind the average.](image-description-exhibit-7.png)
...
![Exhibit 8: Bar chart showing the distribution of organizations across the 5 customer identity journey horizons by geography. It indicates that North American and APAC see a greater share in H4+, while Europe and LATAM lag behind the average.](image-description-exhibit-8.png)
...
![Exhibit 9: Two bar charts showing that organizations across horizons govern a breadth of identity types, and machine and AI agent identities are expected to grow the fastest in the next 3-5 years. The first chart shows current governance of various identity types, and the second shows the expected growth rate for each type.](image-description-exhibit-9.png)
...
![Exhibit 10: Table listing prerequisite steps to enable automation and AI, and prerequisite steps to manage automation & AI risks.](image-description-exhibit-10.png)
...
![Exhibit 11: Table showing that organizations adopting emerging identity AI and data capabilities see greater cost savings, productivity, and risk reduction. It quantifies the likelihood of experiencing benefits for organizations that optimize identity data workflows, deploy agentic AI, adopt identity-centric detection and response, and govern identity data in the cloud.](image-description-exhibit-11.png)
...
![Exhibit 12: Bar chart showing the adoption of identity data capabilities at scale for Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. It highlights that Horizon 1 and 2 organizations often lack clean and normalized identity data essential for advanced use-case adoption.](image-description-exhibit-12.png)
...
![Exhibit 13: Bar chart showing the adoption of agentic AI identity capabilities at scale for Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. It indicates that H3+ organizations adopt agentic AI identity capabilities at ~2x higher rates than the average.](image-description-exhibit-13.png)
...
![Exhibit 14: Bar chart showing the adoption of identity-centric detection, response & observability capabilities at scale for Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. It indicates that organizations are showing an increasing appetite to utilize identity as a detection mechanism vs. point of control.](image-description-exhibit-14.png)
...
![Exhibit 15: Bar chart showing the adoption of identity cloud data governance at scale for Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. It indicates that organizations are adopting cloud data access controls, but adoption for dynamic, content-aware access models trails behind.](image-description-exhibit-15.png)
...
While outperforming organizations are seeing productivity gains, cost savings, and risk reduction from identity