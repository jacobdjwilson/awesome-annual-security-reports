...
![Exhibit 1: Bar chart showing investments in IAM provide the highest perceived ROI when compared to all other security domains. IAM is ranked highest at 30% of respondents, followed by Endpoint Detection & Response (EDR) at 22%, Data security at 13%, Governance, Risk, and Compliance (GRC) at 12%, Cloud Security Posture Management (CSPM) at 10%, Network security/perimeter at 8%, and Application security at 5%.](image-1.png)
...
![Exhibit 2: Diagram showing identity as a central control point in the security tech stack, enabling and enhancing capabilities across multiple domains. Domains include Endpoint security, Network security, Cloud security, Data protection, Application security, Governance, Risk & Compliance, Threat detection/SIEM, and Third party security. Each domain has a brief description of how identity enhances it.](image-2.png)
...
![Exhibit 3: Diagram illustrating how integrated identity will power dynamic access across users, unified visibility, and automated response. It shows a progression from 2024 trends to Nascent, Emerging, and Mainstream capabilities across four themes: Identity governance expanding across human and non-human identity types, Privileged access moving from static to dynamic, Identity fabric expanding breadth of coverage and depth of context, and Integrated identity telemetry powering automated threat response. Examples are provided for each stage and theme, such as "AI agent lifecycles managed" (Emerging for Identity governance) and "Continuous adaptive trust using JIT access" (Mainstream for Privileged access).](image-3.png)
...
![Exhibit 4: Table showing proof points in the last 12-18 months supporting progress across the elements shaping the future of identity, categorized by Identity, Data, and Security. It lists examples from OWASP, Cloud Security Alliance, TechTarget, NIST, CISA, OpenID, KuppingerCole, CrowdStrike, and MITRE, with corresponding links to sources.](image-4.png)
...
![Exhibit 5: Diagram showing 5 maturity horizons for identity security programs, from Horizon 1 (Insufficient) to Horizon 5 (Extended and unified identity). Each horizon describes the characteristics of strategy, technology & tools, operating model, and talent. Horizon 1 is "Fragmented identity experience across organization," Horizon 2 is "Started on identity management but mostly manual," Horizon 3 is "Digitalized at-scale identity management," Horizon 4 is "Advanced digital tools and predictive use cases," and Horizon 5 is "Extended and unified identity."](image-5.png)
...
![Exhibit 6: Bar chart showing the distribution of organizations across 5 customer identity journey horizons for 2023, 2024, and 2025 surveys. In 2025, 42% are in Horizon 1, 20% in Horizon 2, 27% in Horizon 3, 9% in Horizon 4, and ~1% in Horizon 5. The chart also notes that for every 3 organizations that moved forward, 2 moved backward, and that the 2025 framework added new capability requirements making advancement more challenging.](image-6.png)
...
![Exhibit 7: Stacked bar chart showing the distribution of organizations across the 5 customer identity journey horizons by industry. Technology and Banking & securities have higher percentages in Horizon 4+, while Manufacturing has the highest percentage in Horizon 1 (61%) and the lowest in Horizon 4+ (4%). Healthcare is close to the aggregate average.](image-7.png)
...
![Exhibit 8: Stacked bar chart showing the distribution of organizations across the 5 customer identity journey horizons by geography. APAC and North America have higher percentages in Horizon 4+, while Europe and LATAM lag behind the aggregate average. APAC also shows the highest percentage in Horizon 1 (56%).](image-8.png)
...
![Exhibit 9: Two bar charts. The first shows the percentage of organizations across horizons that govern various identity types (Employee, Internal contractor, Machine, AI agent, External 3rd party, External consumer). The second shows the expected growth of these identity types in the next 3-5 years, indicating AI agent and Machine identities will grow fastest.](image-9.png)
...
![Exhibit 10: Table listing prerequisite steps to enable automation and AI, and prerequisite steps to manage automation & AI risks. Examples for enabling include "Clean and unify identity data" and "Deploy modern IAM platform." Examples for managing risks include "Adopt AI governance policies" and "Enable extensive monitoring and detailed logging capabilities."](image-10.png)
...
![Exhibit 12: Bar chart comparing the adoption of identity data capabilities at scale between Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. Capabilities include Real-time identity data synchronization, Automated identity lifecycle workflows, Cross-system identity resolution and account linking, and Identity graph / relationship mapping. Horizon 3+ organizations consistently show significantly higher adoption rates.](image-12.png)
...
![Exhibit 13: Bar chart comparing the adoption of agentic AI identity capabilities at scale between Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. Capabilities include AI-powered session termination, AI-driven access policy optimization, Real-time privilege adjustment, AI agent credential lifecycle management, and Self-remediating identity workflows. Horizon 3+ organizations show higher adoption rates across all.](image-13.png)
...
![Exhibit 14: Bar chart comparing the adoption of identity-centric detection, response & observability capabilities at scale between Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. Capabilities include Real-time identity threat protection, Privileged account monitoring, Identity Threat Detection and Response (ITDR), Security operations integration, Identity forensics and investigation, AI-driven identity risk scoring, Automated identity remediation, and Dedicated identity security operations center (IdSOC). Horizon 3+ organizations show significantly higher adoption rates across all.](image-14.