...
- [Executive summary](#executive-summary)
  - [What we found](#what-we-found)
    - [1. Organizations are falling behind as the attack landscape intensifies, AI agents proliferate, and the bar for mature identity security rises](#1-organizations-are-falling-behind-as-the-attack-landscape-intensifies-ai-agents-proliferate-and-the-bar-for-mature-identity-security-rises)
    - [2. Organizations that adopt advanced AI and identity data capabilities see significantly higher cost savings, productivity, and risk reduction](#2-organizations-that-adopt-advanced-ai-and-identity-data-capabilities-see-significantly-higher-cost-savings-productivity-and-risk-reduction)
    - [3. Deployment is a critical unlock in moving across horizons, and many get it wrong](#3-deployment-is-a-critical-unlock-in-moving-across-horizons-and-many-get-it-wrong)
    - [4. Organizations need to quantify the full value of identity to secure funding for advanced capabilities, including margin, compliance, and risk impact](#4-organizations-need-to-quantify-the-full-value-of-identity-to-secure-funding-for-advanced-capabilities-including-margin-compliance-and-risk-impact)
...
![Exhibit 3: Diagram illustrating how integrated identity will power dynamic access across users, unified visibility, and automated response. It shows a progression from "Nascent" to "Emerging" to "Mainstream" for four integrated identity security trends: Identity governance expanding across human and non-human identity types, Privileged access moving from static to dynamic, Identity fabric expanding breadth of coverage and depth of context, and Integrated identity telemetry powering automated threat response. Each trend lists specific capabilities at different maturity stages.]
...
![Exhibit 4: Table showing proof points from the last 12-18 months supporting progress across the elements shaping the future of identity, categorized by Identity, Data, and Security. It lists specific examples and sources for Identity-centric governance, Privileged access, Identity fabric, and Integrated identity telemetry.]
...
![Exhibit 5: Diagram illustrating the 5 maturity horizons for identity security programs, guided by survey results over 4 years. It describes each horizon (1-5) based on strategy, technology & tools, operating model, and talent, ranging from "Insufficient" (Horizon 1) to "Foundational" (Horizon 2-3) to "Advanced" (Horizon 4-5). Horizon 1 is "Fragmented identity experience across organization," Horizon 2 is "Started on identity management but mostly manual," Horizon 3 is "Digitalized at-scale identity management," Horizon 4 is "Advanced digital tools and predictive use cases," and Horizon 5 is "Extended and unified identity." Each horizon has bullet points detailing its characteristics.]
...
![Exhibit 6: Stacked bar chart showing the distribution of organizations across the 5 customer identity journey horizons for 2023, 2024, and 2025 surveys. It indicates that some organizations are leapfrogging across horizons while others moved backwards, with a net increase from Horizons 1 & 2 and Horizons 1-3. The chart highlights that for every 3 organizations that moved forward, 2 moved backward, and notes the introduction of new capability requirements in 2025 for Horizons 4 and 5.]
...
![Exhibit 7: Stacked bar chart showing the distribution of organizations across the 5 customer identity journey horizons by industry. It indicates that Tech and banking see greater share in H4 and H5 while healthcare and manufacturing lag behind average. Aggregate, Technology, Banking & securities, Healthcare, and Manufacturing industries are shown.]
...
![Exhibit 8: Stacked bar chart showing the distribution of organizations across the 5 customer identity journey horizons by geography. It indicates that North American and APAC see greater share in H4+ while Europe and LATAM lag behind average. Aggregate, APAC, North America, Europe, and LATAM regions are shown.]
...
![Exhibit 9: Bar charts showing that AI agent and machine identities will grow faster than all other identity types in the next 3-5 years. The left chart shows the percentage of organizations governing various identity types (Employee, Internal contractor, Machine, AI agent, External 3rd party, External consumer). The right chart shows the expected growth of these identity types in the next 3-5 years, categorized by percentage decrease, no change, and percentage increase. It highlights that AI agents are governed in less than 4 in 10 organizations today, but they will grow faster in number than any other identity type.]
...
![Exhibit 10: Table listing prerequisite steps to enable automation and AI, and prerequisite steps to manage automation & AI risks. Steps include cleaning and unifying identity data, deploying modern IAM platforms, adopting AI governance policies, enabling extensive monitoring, formalizing identity lifecycle workflows, enabling just-in-time access, defining roles and access models, integrating dynamic risk scoring, assembling cross-functional teams, and implementing strong data classification.]
...
- **Unified identity data capabilities