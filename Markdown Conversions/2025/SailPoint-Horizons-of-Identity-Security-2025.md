...
![Exhibit 1: Bar chart showing Investments in IAM provide the highest perceived ROI when compared to all other security domains. IAM is at 30%, followed by Endpoint Detection & Response (EDR) at 22%, Data security at 13%, Governance, Risk, and Compliance (GRC) at 12%, Cloud Security Posture Management (CSPM) at 10%, Network security/perimeter at 8%, and Application security at 5%.](image-1.png)
...
![Exhibit 2: Diagram showing how identity, as a central control point in the security tech stack, enables and enhances capabilities across multiple domains. Domains include Endpoint security, Network security, Cloud security, Data protection, Application security, Governance, Risk & Compliance, Threat detection/SIEM, and Third party security, each with a brief description of identity's role.](image-2.png)
...
![Exhibit 3: Diagram showing how integrated identity will power dynamic access across users, unified visibility, and automated response, evolving from 2024 trends to nascent, emerging, and mainstream capabilities across Identity, Data, and Security. Key themes include Identity governance expanding across human and non-human identity types, Privileged access moving from static to dynamic, Identity fabric expanding breadth of coverage and depth of context, and Integrated identity telemetry powering automated threat response.](image-3.png)
...
![Exhibit 4: Table showing proof points in the last 12-18 months supporting progress across elements shaping the future of identity, categorized by Identity, Data, and Security. It lists specific examples from OWASP, Cloud Security Alliance, TechTarget, NIST, CISA, OpenID, KuppingerCole, CrowdStrike, and MITRE.](image-4.png)
...
![Exhibit 5: Diagram illustrating the 5 maturity horizons for identity security programs, from Horizon 1 (Insufficient) to Horizon 5 (Extended and unified identity). Each horizon describes the strategy, technology & tools, operating model, and talent capabilities.](image-5.png)
...
![Exhibit 6: Bar chart showing the distribution of organizations across the 5 customer identity journey horizons for 2023, 2024, and 2025 surveys. It highlights that some organizations are leapfrogging across horizons while others moved backwards, with a net increase in Horizons 1 & 2 and a note that for every 3 organizations that moved forward, 2 moved backward.](image-6.png)
...
![Exhibit 7: Bar chart showing the distribution of organizations across the 5 customer identity journey horizons by industry. It compares Aggregate, Technology, Banking & securities, Healthcare, and Manufacturing, highlighting that Tech and banking see greater share in H4 and H5 while healthcare and manufacturing lag behind average.](image-7.png)
...
![Exhibit 8: Bar chart showing the distribution of organizations across the 5 customer identity journey horizons by geography. It compares Aggregate, APAC, North America, Europe, and LATAM, indicating that North American and APAC see greater share in H4+ while Europe and LATAM lag behind average.](image-8.png)
...
![Exhibit 9: Two bar charts. The first shows the percentage of organizations across horizons that govern various identity types (Employee, Internal contractor, Machine, AI agent, External 3rd party, External consumer). The second shows the expected growth of these identity types in the next 3-5 years, indicating that AI agent and machine identities will grow fastest.](image-9.png)
...
![Exhibit 10: Table listing prerequisite steps to enable automation and AI (Clean and unify identity data, Deploy modern IAM platform, Formalize identity lifecycle workflows, Clearly define roles and access models, Assemble cross-functional teams) and prerequisite steps to manage automation & AI risks (Adopt AI governance policies, Enable extensive monitoring and detailed logging capabilities, Enable just-in-time access and zero standing privileges, Integrate dynamic risk scoring and predictive anomaly detection, Implement strong data classification and sensitivity-based access controls).](image-10.png)
...
![Exhibit 11: Table showing that organizations adopting emerging identity AI and data capabilities see greater cost savings, productivity, and risk reduction. It lists four capabilities (Optimize identity data workflows, Deploy agentic AI for identity operations, Adopt identity-centric detection and response, Govern identity data in the cloud) and the corresponding likelihood of experiencing productivity improvements, cost savings, risk reduction, or fewer audit findings.](image-11.png)
...
![Exhibit 12: Bar chart showing the adoption of identity data capabilities at scale for Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. Capabilities include Real-time identity data synchronization, Automated identity lifecycle workflows, Cross-system identity resolution and account linking, and Identity graph / relationship mapping. It highlights that Horizon 1 and 2 organizations often lack clean and normalized identity data essential for advanced use-case adoption.](image-12.png)
...
![Exhibit 13: Bar chart showing the adoption of agentic AI identity capabilities at scale for Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. Capabilities include AI-powered session termination, AI-driven access policy optimization, Real-time privilege adjustment, AI agent credential lifecycle management, and Self-remediating identity workflows. It indicates that H3+ organizations adopt agentic AI identity capabilities at ~2x higher rates than the average.](image-13.png)
...
![Exhibit 14: Bar chart showing the adoption of identity-centric detection, response & observability capabilities at scale for Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. Capabilities include Real-time identity threat protection, Privileged account monitoring, Identity Threat Detection and Response (ITDR), Security operations integration, Identity forensics and investigation, AI-driven identity risk scoring, Automated identity remediation, and Dedicated identity security operations center (IdSOC). It shows organizations are increasingly utilizing identity as a detection mechanism vs. point of control.](image-14.png)
...
![Exhibit 15: Bar chart showing the adoption of identity cloud data governance at scale for Overall/Aggregate, Horizon 1-2, and Horizon 3+ organizations. Capabilities include Cloud data access controls, Enterprise IAM integration, Unified policy enforcement, Real-time data access monitoring, Cloud-native data encryption, Automated data classification, Just-in-time data access, and Attribute-based data access control. It indicates that organizations