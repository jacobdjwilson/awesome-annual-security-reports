...
Organization: Kroll  
Report Title: Threat-Landscape-Report  
Year: 2025  

Authors: George Keith, Edward Glass, Wojcieszek Currie  

## Table of Contents
- [Introduction](#introduction)
- [The Changing Crypto Landscape: Political Shifts and Physical Threats](#the-changing-crypto-landscape-political-shifts-and-physical-threats)
- [Achieving Crypto Compliance: Evolving Regulatory Requirements](#achieving-crypto-compliance-evolving-regulatory-requirements)
- [Crypto Oversight: Charting the Regulatory Landscape](#crypto-oversight-charting-the-regulatory-landscape)
- [Taking a Bite out of Bybit: A Timeline of the World’s Biggest Crypto Hack](#taking-a-bite-out-of-bybit-a-timeline-of-the-worlds-biggest-crypto-hack)
- [The Malware Spotlight](#the-malware-spotlight)
- [CLEARFAKE: Powered by Blockchain](#clearfake-powered-by-blockchain)
- [Case Study: Havoc Reigns After Major Cryptocurrency Theft](#case-study-havoc-reigns-after-major-cryptocurrency-theft)
- [Navigating the Crypto Gold Rush: All That Glitters Is Not Gold](#navigating-the-crypto-gold-rush-all-that-glitters-is-not-gold)
- [Stay Ahead of Threats with Expert Guidance](#stay-ahead-of-threats-with-expert-guidance)
...
Penetration testing (pen testing) is a crucial aspect of an organization’s overall cybersecurity and compliance efforts, and serves dual purposes for crypto exchanges: first, by enhancing overall security posture and helping businesses meet compliance requirements set by various regulatory bodies. Secondly, documented penetration tests provide tangible evidence of an organization’s commitment to security and compliance, which may be required during regulatory audits or assessments.

While no single, universal law mandates pen testing, several regulations and frameworks require or strongly encourage it.
...
![Amount Stolen in $ at Time of Hack by Centralized Crypto Exchange chart showing values ranging from $105M to $1.4B across exchanges including CoinBene, Bitgrail, Bitmart, WazirX, KuCoin, DMM, Mt. Gox, FTX, Coincheck, and Bybit]
...
1. **User Browses Compromised Web Page**  
...
3. **JavaScript Function Embedded**  
...
### Key Findings
| Kroll researchers | This malware led to | Havoc C2 is |
| --- | --- | --- |
| discovered two new pieces of malware, a backdoor and a loader named “PRELUDE” and “DELPHYS,” respectively. | deployment of Havoc C2’s agent, “Demon,” while investigating a large-scale cryptocurrency theft. | an open-source, post-exploitation command and control framework. |
...
### Services Matrix
- **React**: Incident Response & Recovery, Breach Notification & Recovery, Data Discovery & Security Management, Expert Witness & Litigation Advisory, Cyber Due Diligence & Investigations
- **Advise**: Security Assessments & Advisory, Penetration Testing & Red Teaming, Security Program Development, Regulatory Compliance Assessments, Financial Crime Compliance & Investigations
- **Transform**: Cloud & Application Security and Technology Implementation (IAM, Threat & Vulnerability Management, OT Security etc.), AI Risk Management, Zero Trust Security and Prevention, Cyber Security Training
- **Operate**: Managed Detection and Response, Digital Risk Protection, Security Technology & Process Management (OT, IAM, AI etc.), Fraud Detection, Cyber Security Operations, Corporate Legal Operations

### Kroll Risk Intelligence
Frontline intelligence from thousands of IR, regulatory response, financial crime, and M&A due diligence engagements a year
...
### Contact Hotlines
- **North America**: T: 877 300 6816
- **UK**: T: 808 101 2168
- **Hong Kong**: T: 800 908 015
- **Singapore**: T: 800 101 3633
- **Australia**: T: 1800 870 399
- **Brazil**: T: 0800 761 2318  
Additional hotlines at: [kroll.com/hotlines](kroll.com/hotlines)  
Or via email: [CyberResponse@kroll.com](mailto:CyberResponse@kroll.com)

Browse the latest editions of Kroll’s Quarterly Threat Landscape reports and subscribe for free at [kroll.com/cyberblog](kroll.com/cyberblog).

### About Kroll
As the leading independent provider of financial and risk advisory solutions, Kroll leverages our unique insights, data and technology to help clients stay ahead of complex demands. Kroll’s global team continues the firm’s nearly 100-year history of trusted expertise spanning risk, governance, transactions and valuation. Our advanced solutions and intelligence provide clients the foresight they need to create an enduring competitive advantage. At Kroll, our values define who we are and how we partner with clients and communities. Learn more at [Kroll.com](Kroll.com).
...
© 2025 Kroll, LLC. All rights reserved. KR25040775
