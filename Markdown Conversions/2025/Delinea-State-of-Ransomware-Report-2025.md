...
### [Report URL](https://delinea.com/resources/2025-ransomware-survey-report)
...
- [Key Finding 1: Ransomware breaches continue to spiral even as fewer victims pay](#key-finding-1-ransomware-breaches-continue-to-spiral-even-as-fewer-victims-pay)
  - [Ransomware is pervasive](#ransomware-is-pervasive)
  - [U.S. ransomware attacks surged last year](#us-ransomware-attacks-surged-last-year)
  - [Which industries are seeing the biggest threat increase?](#which-industries-are-seeing-the-biggest-threat-increase)
  - [Which industries are hit the hardest?](#which-industries-are-hit-the-hardest)
  - [The big question is why does the number of successful ransomware attacks continue to increase?](#the-big-question-is-why-does-the-number-of-successful-ransomware-attacks-continue-to-increase)
  - [Ransomware groups are resilient shape-shifters](#ransomware-groups-are-resilient-shape-shifters)
  - [Most ransomware today includes data theft extortion](#most-ransomware-today-includes-data-theft-extortion)
  - [Fewer companies are paying, but there’s plenty of road left to run](#fewer-companies-are-paying-but-theres-plenty-of-road-left-to-run)
- [Key Finding 2: Executives are increasingly concerned, but security is falling short](#key-finding-2-executives-are-increasingly-concerned-but-security-is-falling-short)
  - [Ransomware is causing chaos and disruption](#ransomware-is-causing-chaos-and-disruption)
  - [Recovery time is slow](#recovery-time-is-slow)
  - [Executives are rightly concerned](#executives-are-rightly-concerned)
  - [Executive leaders are increasingly concerned](#executive-leaders-are-increasingly-concerned)
  - [An insurance policy can help to mitigate financial risk](#an-insurance-policy-can-help-to-mitigate-financial-risk)
  - [Anti-ransomware tactics are not bearing fruit](#anti-ransomware-tactics-are-not-bearing-fruit)
  - [Least privilege is woefully under-deployed](#least-privilege-is-woefully-under-deployed)
- [Key Finding 3: AI use is surging as ransomware threats evolve](#key-finding-3-ai-use-is-surging-as-ransomware-threats-evolve)
  - [AI is empowering ransomware actors](#ai-is-empowering-ransomware-actors)
  - [AI is widely adopted in the fight against ransomware](#ai-is-widely-adopted-in-the-fight-against-ransomware)
  - [Other AI use cases](#other-ai-use-cases)
- [How businesses can protect themselves](#how-businesses-can-protect-themselves)
...
To understand what’s really happening behind the headlines, Delinea turned to those on the frontlines: IT and security leaders who work tirelessly to safeguard their organizations. This year’s study captures insights from over 1,000 security professionals across multiple regions, offering a broader perspective on the state of cybersecurity. The message is clear: ransomware attacks are increasing, even as ransom payments under pressure. Business disruption can last for weeks. What’s more, extortion now accounts for over half of ransomware attacks. These network defenders are adopting AI, but that alone is no guarantee of success.
...
## Key Finding 1:
Ransomware breaches continue to
spiral even as fewer victims pay
...
![Chart showing ransomware breach statistics: 69% of organizations were breached by ransomware actors, 27% of firms were breached more than once, U.S. breaches increased from 53% in 2023 to 71%.](placeholder-image-1)
...
![Chart showing U.S. ransomware attack statistics by organization size: U.S. Enterprise (500+ employees): 68% vs 22% in 2023; U.S. Mid-sized (50-500 employees): 74% vs 62% in 2023; U.S. Small (1-49 employees): 40% vs 10% in 2023.](placeholder-image-2)
Q: Has your company been the victim of a ransomware attack in the last 12 months?
...
![Chart showing ransomware payment and data recovery statistics: 57% of organizations paid ransomware, 60% of U.S. organizations paid ransomware vs. 76% in 2023, 54% of UK organizations paid ransomware, 26% of organizations that paid a ransom did not get their data back (35% in the UK; 18% in the U.S.).](placeholder-image-3)
...
## Key Finding 2:
Executives are increasingly concerned,
but security is falling short
...
![Chart showing ransomware recovery time: 46% of victims took up to a week to recover from a ransomware breach (50% of UK firms and 42% of U.S. firms), 75% of victims took up to two weeks to recover, Only 18% of victims recovered within 24 hours.](placeholder-image-4)
...
![Chart showing executive concern about ransomware: 90% of executives/boards are concerned with the threat of ransomware, 52% of U.S. firms are very concerned vs. 21% in 2023, $250MM-$499MM revenue U.S. firms: 60% are very concerned vs. 9% in 2023, $500MM+ revenue U.S. firms: 52% are very concerned vs. 21% in 2023.](placeholder-image-5)
...
![Chart showing cyber insurance coverage by firm size: 100% of firms with $250-$499MM revenue have cyber insurance coverage, 85% of firms with $500MM+ revenue have cyber insurance coverage, 65% of firms with under $10MM revenue have cyber insurance coverage.](placeholder-image-6)
...
![Chart showing U.S. preventive measures against ransomware: Regular updates (U.S. 78% vs. 52% in 2023), Backups (U.S. 71% vs. 50% in 2023), Password best practices (U.S. 68% vs. 48% in 2023), Implement application control (U.S. 60% vs. 46% in 2023).](placeholder-image-7)
...
![Chart showing adoption of least privilege: 34% of U.S. firms, 37% of UK firms, 30% of respondents have adopted the principle of least privilege.](placeholder-image-8)
...
## Key Finding 3:
AI use is surging as ransomware
threats evolve

### AI is empowering ransomware actors

The future of AI is increasingly agentic: a model whereby the AI operates autonomously and dynamically, solving problems and completing tasks on the fly in order to achieve its goals. Delinea is already seeing examples of this nascent technology, to automate many of the stages of a typical ransomware attack, including reconnaissance, exploitation, exploration and exfiltration. The danger here is that it further lowers the barriers to entry for would-be ransomware affiliates, and empowers bad actors to launch highly targeted attacks at scale—using few resources. The challenge for your organization is that this could not only increase the volume of attacks but also shorten the lifecycle of the typical kill chain. That makes detection and response much more challenging, and again puts the focus back on preventative, proactive security.
...
![Chart showing how organizations are using AI to protect against ransomware: 64% in the Security Operations Center, 62% to analyze Indicators of Compromise, 51% for Phishing prevention.](placeholder-image-9)
