...
- [The AI Threat Landscape](#the-ai-threat-landscape)
  ...
  - [Case Study: Talos Research on Malicious LLMs](#case-study-talos-research-on-malicious-llms)
  - [How Threat Actors Leverage AI as a Tool for Cyber Attacks](#how-threat-actors-leverage-ai-as-a-tool-for-cyber-attacks)
...
- [Developments in AI Policy](#developments-in-ai-policy)
  ...
  - [Looking Ahead: Direction for AI Policy 2025](#looking-ahead-direction-for-ai-policy-2025)
- [AI Security Research](#ai-security-research)
  ...
  - [Applying Algorithmic Jailbreaking to Frontier Reasoning Models](#applying-algorithmic-jailbreaking-to-frontier-reasoning-models)
  ...
  - [Poisoning Web-Scale Training Datasets](#poisoning-web-scale-training-datasets)
...
![Reference article (top) and our LLM prompting flow to extract training data (middle) and our results (bottom)](Image description)
...
![Screenshot of a cybercriminal LLM (DarkGPT) dashboard](Image description)
...
This section provides a high-level overview of our methodologies, key findings, and real-world implications of