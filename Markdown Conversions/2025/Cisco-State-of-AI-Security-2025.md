...
![Reference article (top) and our LLM prompting flow to extract training data (middle) and our results (bottom)]
...
![Screenshot of a cybercriminal LLM (DarkGPT) dashboard]
...
| Method | Target LLM | Fraction of Jailbreaks | Queries |
| :--- | :--- | :--- | :--- |
| TAP | GPT-4 | **0.80** | 15 |
| TAP | Llama 2 | **0.95** | 12 |
| PAIR | GPT-4 | 0.65 | 20 |
| PAIR | Llama 2 | 0.85 | 18 |
...
![Validation results for Llama-2-7B and a fine-tuned variant. Results indicate degraded model safety and security alignment after fine-tuning for legal expertise.]
...
- **Emile Antone** (Product Marketing Manager, Cisco) - Lead Contributor
- **Amy Chang** (AI Researcher, Cisco) - Lead Contributor
- **Alie Fordyce** (Engineering Product Manager, Cisco) - Lead Contributor
