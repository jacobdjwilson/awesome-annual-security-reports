# 2025 State of Identity Security: Challenges and Strategies from IT and Security Leaders

The official report URL is: https://duo.com/blog/research-insights-4-trends-reshaping-identity-security-in-2025

## Table of Contents
- [Introduction](#introduction)
- [Highlights](#highlights)
- [Survey Methodology](#survey-methodology)
- [What You Will Learn in this eBook](#what-you-will-learn-in-this-ebook)
- [Who This eBook is For](#who-this-ebook-is-for)
- [Facing Complexity and a Confidence Crisis](#facing-complexity-and-a-confidence-crisis)
- [Confidence in Identity Providers is Worryingly Low](#confidence-in-identity-providers-is-worryingly-low)
- [ISPM Tools Are Underutilized](#ispm-tools-are-underutilized)
- [Identity Security Often Comes Too Late](#identity-security-often-comes-too-late)
- [Telemetry is Valued but Incomplete](#telemetry-is-valued-but-incomplete)
- [Visibility Into Identity is Fragmented](#visibility-into-identity-is-fragmented)
- [Complexity Is the Core Issue](#complexity-is-the-core-issue)
- [ITDR Is Held Back by Deployment Friction](#itdr-is-held-back-by-deployment-friction)
- [Identity Sprawl is Unchecked](#identity-sprawl-is-unchecked)
- [Persistent Phishing Threats & MFA Gaps](#persistent-phishing-threats--mfa-gaps)
- [MFA Gaps and Phishing Resistance](#mfa-gaps-and-phishing-resistance)
- [MFA Still Incomplete](#mfa-still-incomplete)
- [The Biggest Phishing Resistance Hurdles](#the-biggest-phishing-resistance-hurdles)
- [Passwordless is a Goal, Not Yet a Reality](#passwordless-is-a-goal-not-yet-a-reality)
- [FIDO2 Adoption is Low](#fido2-adoption-is-low)
- [A Need for Security-First IAM](#a-need-for-security-first-iam)
- [Integrated Solutions Are Essential](#integrated-solutions-are-essential)
- [Third-Party and Insider Threats Are Growing](#third-party-and-insider-threats-are-growing)
- [Device Hygiene Needs Improvement](#device-hygiene-needs-improvement)
- [Top Identity Threats for 2025](#top-identity-threats-for-2025)
- [Vendor Consolidation is Gaining Ground](#vendor-consolidation-is-gaining-ground)
- [Security Investment is Rising](#security-investment-is-rising)
- [Financial Impact of Identity Failures](#financial-impact-of-identity-failures)
...
33% of security leaders are confident their identity provider protects against identity-based attacks.
...
32% believe they have a fully effective Identity Security Posture Management solution.
...
74% of IT leaders admit identity security is often an afterthought in infrastructure planning.

97% value identity and device telemetry, but only 52% have it fully integrated.
...
69% lack full visibility into identity vulnerabilities, and 55% into admin access.
...
94% say complexity in identity infrastructure challenges security posture.
...
### ITDR Is Held Back by Deployment Friction
...
Identities are stored in an average of 4.8 systems.
...
69% are worried that MFA isn’t deployed across all devices and apps.
...
87% prioritize phishing-resistant MFA, but only 30% feel confident in their phishing controls.

*   Token management: 57%
*   Extra training/support: 53%
*   Hardware token cost: 47%
*   Compatibility issues: 45%
*   Only 2% say there’s no business need
...
61% want to move to passwordless access, but expect challenges.
...
76% say identity tools must integrate with AWS, Microsoft, and Google.
...
86% are worried about inadequate contractor controls. 57% reported unauthorized access.
...
79% are exploring it to improve identity security visibility.
...
82% of financial decision-makers have increased budgets for identity security.
...
51% of organizations have suffered financial losses due to identity breaches.
