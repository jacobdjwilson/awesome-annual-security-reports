...
- [Findings by Industry](#findings-by-industry)
- [Findings by Revenue Segment](#findings-by-revenue-segment)
- [How Costly is CVE Management?](#how-costly-is-cve-management)
...
### Key Findings
- **CVE Management Costs You More Than You Think**: Engineering teams are often bogged down with CVE management tasks like triaging, patching, and compliance reporting. This takes valuable time away from revenue-generating activities like feature development and product innovation.
- **The Hidden Costs of DIY CVE Remediation**: Many organizations continue to handle CVE management internally, which often results in inefficiencies and high labor costs. On average, companies that outsource CVE remediation to Chainguard realize $2.1 million in annual savings from that specific task alone.
- **Outsourcing CVE Management Delivers Tangible Business Value**: Organizations experience cost savings, increased revenue, faster innovation, and decreased risk.
- **ROI Across Industries**: Healthcare organizations saved $50 million annually on average, with $39 million of that coming from reduced risk.

## Findings by Industry
![Table showing total benefits, cost savings, increased revenue, faster innovation, and decreased risk by industry: Financial Services, Consumer & Commerce, Healthcare, Technology, and Telecom.]

## Findings by Revenue Segment
![Table showing total benefits, cost savings, increased revenue, faster innovation, and decreased risk by revenue segment: Enterprise, Large, Mid-Market, Growth-Stage, and Early-Stage.]
...
## Methodology
To enable meaningful comparison and actionable insight, Chainguard developed a standardized methodology to quantify both the direct costs and return on investment of outsourcing CVE management efforts. All data is anonymized to protect customer privacy and confidentiality.

## The Costs of DIY CVE Management
When we began assessing the data our customers shared, we were particularly interested in the key area of cost savings. Engineering teams building CVE management programs in-house often dedicate enormous time and effort to areas outside of the core business functions.

### DIY CVE Remediation
The customers participating in this analysis saved an average of $2.1 million annually by outsourcing CVE remediation. 

### DIY Image Hardening
Image hardening—the process of securing container base images through proactive vulnerability prevention—delivered significant savings. These organizations saved an average of over $400,000 annually by outsourcing image hardening.

### Compliance
Organizations saved an average of over $278,000 annually by outsourcing compliance requirements around CVEs and continuous monitoring.

### Customer Escalations
Many organizations saw tangible savings in this area, with an annual average of $70,000 across all organizations.

## Value Unlocked by Industry
![Chart showing Average Overall Value Unlocked by Industry: Healthcare, Telecom, Consumer & Commerce, Financial Services, and Technology.]
...
![Chart showing Overall Value Unlocked by Revenue Segment: Enterprise, Large, Mid-Market, Growth Stage, and Early-Stage.]
...
## Reduce Your Cost of CVEs with Chainguard Containers
As demonstrated across both industry and revenue segments, CVE management imposes measurable costs on organizations of all sizes. Outsourcing CVE management using a solution like Chainguard Containers can lead to serious, tangible return on investment.

On average, Chainguard customers saw the following returns on investment after transitioning from in-house CVE Management:
- $1.9 million per year of cost saving
