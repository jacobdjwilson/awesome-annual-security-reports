...
- **51%** Fully addressed and actively monitored
- **46%** Partially addressed, ongoing improvement
- **3%** Acknowledged, but not fully addressed
...
- **49%** 11% to 15%
- **40%** 16% to 20%
- **0%** of respondents selected “More than 20%”
...
- **50%** Secure code reviews
- **42%** Security unit testing
- **36%** Threat modeling
- **31%** Pen testing
- **12%** Managing scanners
