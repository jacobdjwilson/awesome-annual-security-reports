# 2023 Report: The State of Cloud-Native Security
...
- [About the 2023 Cover](#about-the-2023-cover)

---

# Executive Summary

Few can relate to the adage "the only constant is change" like cloud security professionals. Cloud security is dynamic and unpredictable, but the move to hybrid work has accelerated change and increased the complexity of application security. As cloud-native application development evolves, so too do organizations’ cloud infrastructure (80% of survey respondents say their cloud infrastructure is evolving). What’s more, the cloud has changed the applications lifecycle, with DevOps now delivering production code at warp speed and security personnel struggling to keep pace.
...
![Figure 1. % Workload Distribution by Architecture Type, 2023](Image description: A bar chart showing the distribution of cloud workload by architecture type in 2023. PaaS & Serverless is the largest category at 36%, followed by VMs at 22%, CaaS at 18%, and Containers at 18%.)

### Cloud Workloads Publicly Hosted by Region
*   NAM: 54%
*   APJ: 53%
*   EMEA: 50%

![Figure 2. % Cloud Workloads Publicly Hosted by Region, 2023](Image description: A bar chart showing the percentage of cloud workloads publicly hosted by region in 2023. North America (NAM) is at 54%, Asia, Pacific, and Japan (APJ) is at 53%, and Europe, the Middle East, and Africa (EMEA) is at 50%.)
...
1.  Building new and expanding existing products and services
2.  Increasing efficiency and agility
...
![Figure 3. Primary Method for Application Deployment to the Cloud, 2023](Image description: A pie chart showing the primary method for application deployment to the cloud in 2023. Cloud-Native is the largest slice at 37%, followed by Lifted and Shifted at 36%, and Refactored or Rebuilt at 27%.)

### Method for Application Deployment to the Cloud by Region

| Method              | NAM  | APJ  | EMEA |
| :------------------ | :--- | :--- | :--- |
| Lifted and Shifted  | 35%  | 32%  | 40%  |
| Refactored or Rebuilt | 25%  | 34%  | 26%  |
| Cloud-Native        | 40%  | 34%  | 34%  |

![Figure 4. Primary Method for Application Deployment to the Cloud by Region, 2023](Image description: A stacked bar chart showing the primary method for application deployment to the cloud by region. Each region (NAM, APJ, EMEA) has bars representing Lifted and Shifted, Refactored or Rebuilt, and Cloud-Native percentages.)

**Lifted and Shifted**: Migrated application to the cloud as-is or with only minor modifications.
**Refactored or Rebuilt**: Migrated application to the cloud with significant modifications.
**Cloud-Native**: Net new applications that were completely built in the cloud.
...
![Figure 5. Percentage Workload in the Cloud, 2023](Image description: A bar chart showing the percentage of workload in the cloud for previous 12 months, currently, and expected in the next 24 months. The current percentage is 53%, and the expected future percentage is 64%.)

In the next 24 months, respondents expect an 11% increase in workload moved to the cloud.

---

# NOW TRENDING: #CLOUDMIGRATION
...
![Figure 6. Frequency of Deployment of Code to Production or Release to End Users, 2023](Image description: A bar chart showing the frequency of code deployment to production or release to end users in 2023. Weekly deployment is the highest at 77%, followed by Daily at 38%, and On Demand at 17%.)
...
| :-------- | :-------- | :-------------- | :-------- |
| Total     | 68%       | 22%             | 10%       |
| Cloud-Native | 61%       | 28%             | 11%       |
| Non-Cloud-Native | 68%       | 22%             | 10%       |

![Figure 7. Changes to Deployment Frequency Over the Last 12 Months, 2023](Image description: A grouped bar chart showing changes to deployment frequency over the last 12 months for Total, Cloud-Native, and Non-Cloud-Native enterprises. For each category, bars represent Increased, Stayed the Same, and Decreased percentages.)
...
1.  **Managing holistic security across teams**
    Breaking down silos and creating processes that teams can adhere to make all the difference when it comes to comprehensive security. In addition to a shared responsibility model between cloud service providers and cloud users, there is another shared responsibility model within organizations. Development, operations, security teams, and every stakeholder along the application development lifecycle share responsibility. Effective collaboration between teams is important, regardless of how good security tools are. One of the central topics today is shift-left security. To effectively go upstream and prevent vulnerabilities at source before deployment requires aligned teams and security products with value to every member contributing to the app development lifecycle.
...
1.  Ease
2.  Best-in-breed capabilities
3.  Potential impact on performance
4.  Familiarity with vendor and/or tool
5.  Competitive pricing and/or cost
...
| Aspect of Cloud Development | Cloud Service Provider | One Vendor/Tool | Multiple Vendors/Tools | In-House/ Open Source | None/Don't Know |
| :-------------------------- | :--------------------- | :-------------- | :--------------------- | :-------------------- | :-------------- |
| Cloud Security              | 9%                     | 9%              | 29%                    | 33%                   | 26%             |
| Network Security            | 9%                     | 3%              | 37%                    | 33%                   | 17%             |
| Application Security        | 9%                     | 5%              | 35%                    | 34%                   | 19%             |

![Figure 8. Primary Provider of Cloud Security for Different Aspects of Cloud Development, 2023](Image description: A table showing the primary provider of cloud security for different aspects of cloud development. Columns include Cloud Service Provider, One Vendor/Tool, Multiple Vendors/Tools, In-House/Open Source, and None/Don't Know. Rows represent Cloud Security, Network Security, and Application Security.)
...
## Palo Alto Networks
Palo Alto Networks, the global cybersecurity leader, is shaping the Cloud-centric future with technology that is transforming the way people and organizations operate. Our mission is to be the cybersecurity partner of choice, protecting our digital way of life. We help address the world’s greatest security challenges with continuous innovation that seizes the latest breakthroughs in artifcial intelligence, analytics, automation, and orchestration. By delivering an integrated platform and empowering a growing ecosystem of partners, we are at the forefront of protecting tens of thousands of organizations across clouds, networks, and mobile devices. Our vision is a world where each day is safer and more secure than the one before. For more information, visit www.paloaltonetworks.com.
