...
![Top 10 threat actor groups in manufacturing over past 365 days chart](https://i.imgur.com/example.png)
...
![Black Basta ransomware group claiming a successful attack on a leading light metal manufacturer](https://i.imgur.com/example.png)
...
![The top malicious attachment filetypes for manufacturing chart](https://i.imgur.com/example.png)
...
![Activity trends in the major email botnet operations (Emotet and Qakbot) chart](https://i.imgur.com/example.png)
...
![Top URL categories used for distribution of phishing attacks chart](https://i.imgur.com/example.png)
...
![Breakdown of brands being impersonated in phishing attacks chart](https://i.imgur.com/example.png)
...
![Word cloud of the most common phrases used in phishing email subject lines](https://i.imgur.com/example.png)
...
![Word cloud of the most common phrases used in BEC attacks](https://i.imgur.com/example.png)
...
![Incidents in manufacturing categorized using MITRE ATT&CK matrix](https://i.imgur.com/example.png)
...
The advertised access included an AnyDesk remote desktop account, an administrative account, a VPN account, and additional accounts, all reportedly equipped with remote connectivity capabilities. This provides everything needed for an attacker to gain initial access and the means to later move within the organization. Also note that this is not a unique occurrence as there are many other examples in various Dark Web and underground forums as seen in the examples below.

![Post taken form a Russian Dark Web forum with a threat actor selling Citrix access to manufacturers’ networks in US](https://i.imgur.com/example.png)

![Post taken form a Russian Dark Web forum with a threat actor selling root access to external websites for an industrial automation company](https://i.imgur.com/example.png)

![Post taken form a Russian Dark Web with a threat actor selling domain admin access to a US manufacturer](https://i.imgur.com/example.png)
...
![Version of JScript that communicates with remote SocGolish infrastructure](https://i.imgur.com/example.png)
...
![Publicly accessible ports and services for the manufacturing sector](https://i.imgur.com/example.png)
...
![Top 10 publicly accessible ports for the manufacturing sector chart](https://i.imgur.com/example.png)
...
![Multiple Fortinet Firewalls are exposed to CVE-2023-27997](https://i.imgur.com/example.png)
![Sophos firewalls are currently vulnerable to CVE-2022-3236](https://i.imgur.com/example.png)
![Huge uptick of attacks on Cisco ASA SSL VPN’s](https://i.imgur.com/example.png)
![Now discontinued, Boa webservers were used to attack Indian power grids back in 2022](https://i.imgur.com/example.png)
![CVE-2023-30799 is a vulnerability in Mikrotik router OS](https://i.imgur.com/example.png)
![Multiple instances of gSoap vulnerable to Devil’s Ivy (CVE-2017-9765)](https://i.imgur.com/example.png)
![A plex bug has been actively exploited according to CISA](https://i.imgur.com/example.png)
