# State-of-the-Cloud
Organization: Wiz  
Report Title: State-of-the-Cloud  
Year: 2023  
...
> **Even in this market, cloud is winning**  
> ![Q3 Cloud Revenue Bar Chart showing AWS, Azure, and GCP revenue for 2021 and 2022]
...
> ![Line chart showing AWS API count in constant growth from 2016 to 2022]
...
> ![Privilege count per cloud provider 2022 line chart comparing AWS, Azure, and GCP across months]
...
## Cloud usage
### How many clouds does it take to run a company?
...
> **How real is multi-cloud?**  
> ![Bar chart representing the percentage of workloads in primary vs other platforms, showing 8 out of 10 companies have over 80% of workloads in a single provider]
...
> **VMs per platform across all customers vs Breakdown of all customers' primary platforms**  
> ![Pie charts displaying VM distribution (72% AWS, 13% Azure, 10% GCP, 3% Other) and primary platform breakdown (62% AWS, 27% Azure, 10% GCP, 1% Other)]
...
> **Breakdown of multi-cloud customers' secondary and tertiary platforms**  
> ![Pie charts showing secondary platforms (41% Azure, 30% GCP, 16% AWS, 13% Other) and tertiary platforms (44% GCP, 32% Azure, 10% AWS, 14% Other)]

> **Percentage of customers using various combinations of AWS, Azure, and GCP as their primary and secondary platforms**  
> ![Sankey diagram showing flow between primary and secondary cloud platforms]
...
> ![Bar chart showing top 20 database flavors with PostgreSQL leading, followed by Redis, MySQL, Elasticsearch, DynamoDB, MongoDB, etc.]

> **Managed DBs + Unmanaged DBs = Percent of environments with each database flavor: managed vs. non-managed - Top 5**  
> ![Bar chart comparing managed vs non-managed for top 5 databases (PostgreSQL, Redis, MySQL, MSSQL, Elasticsearch)]
...
> ![Infographic showing an exposed S3 bucket referenced in a GitHub repo found in 7 hours, and an exposed S3 bucket with a common name found in 13 hours]
