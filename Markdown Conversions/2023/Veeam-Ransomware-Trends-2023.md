...
- [Recoverability and Ransom Payments](#recoverability-and-ransom-payments)
- [The Importance of Survivable Backups](#the-importance-of-survivable-backups)
- [The Role of Immutability](#the-role-of-immutability)
- [Recoverability and Portability](#recoverability-and-portability)
- [Preventing Re-infection During Recovery](#preventing-re-infection-during-recovery)
...
The full 2023 Ransomware Trends Report is available at [https://vee.am/RW23](https://vee.am/RW23).

## Organizational Alignment
“IT takes a village” … but organizations aren’t aligned. While many organizations may say that ‘ransomware is a disaster’ and therefore include cyberattacks within their Business Continuity or Disaster Recovery (BC/DR) planning, the actual interaction between the teams leaves much to be desired.
...
## Recoverability and Ransom Payments
...
## The Importance of Survivable Backups
...
## Preventing Re-infection During Recovery
...
So, it is important to thoroughly scan data during the recovery process. When asked to the cyber-victims within the survey:
