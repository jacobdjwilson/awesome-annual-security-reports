...
[02 → X-Force insights from the field](#x-force-insights-from-the-field)
[03 → Recommendations and best practices](#recommendations-and-best-practices)
[04 → About the IBM X-Force team](#about-the-ibm-x-force-team)
[05 → Appendix](#appendix)
...
_Image description: A graphic with the text "194% increase of new cloud-related CVEs from the prior year"_
...
[Read X-Force threat activity report summaries →](#appendix)
...
_Image description: A graphic with the text "36% of cloud security incidents the X-Force team responded to where the use of valid credentials was the initial access vector"_
...
_Image description: A line graph showing the number of total cloud vulnerabilities tracked by X-Force Red Vulnerability Management Services from 2013 to 2023. The graph shows a steady increase in the number of vulnerabilities over the decade, with a significant jump in the last few years._
...
_Image description: A line graph showing the average X-Force threat score and total CVEs tracked from 2013 to 2023. The graph shows a general upward trend in both the threat score and the number of CVEs, with a slight dip in 2022 followed by a significant increase in 2023._
...
### CVE impact
_Image description: A pie chart showing the percentage of new CVEs that allows an attacker to obtain information (21%), gain access (20%), or gain privileges (16%). The remaining 43% is attributed to other impacts._
...
_Image description: A graphic with the text "57% Percentage of new CVEs that allows an attacker to obtain information, gain access or gain privileges" and "3,900 Number of cloud-related vulnerabilities the X-Force team is tracking, a number that has doubled since 2019"_
...
_Image description: A bar graph showing the top-mentioned SaaS solutions on the dark web. Microsoft Outlook is the most mentioned, followed by WordPress and Zoom._

**Top-mentioned SaaS solutions on the dark web**

### Understanding what type of cloud access
_Image description: A pie chart showing the distribution of cloud access types sold on the dark web. Credentials make up 90%, followed by Shell or SSH at 5%, and Email at 3%. The remaining 2% is attributed to other types._
...
_Image description: A bar graph showing the average price by access type for various cloud access types. RDP access is priced at USD 10.67, Credentials at USD 10.68, Shell/SSH at USD 7.35, cPanel at USD 7.00, and Leads at USD 1.30._
...
_Image description: A graphic with the text "64% Number of incidents the X-Force team responded to in Europe, among clients worldwide"_
