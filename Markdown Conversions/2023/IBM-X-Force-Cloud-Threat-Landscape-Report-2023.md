...
In 2022, the Apache Log4j vulnerability⁵
...
profit per month.⁶ Additionally, proxyjacking
...
servers (CVE-2021-21974)⁷ to gain access,
...
and Google Drive
 ...
 - Generic malware using OneDrive⁸
...
![Figure 1. The number of tracked cloud vulnerabilities has grown exponentially in the last decade.](Figure 1. The number of tracked cloud vulnerabilities has grown exponentially in the last decade.)
...
trending upward.⁹ Despite a dip in 2022,
...
in the last decade.](Figure 2. The total number of tracked CVEs and their average severity has increased steadily
in the last decade.)
...
CVE impact.](Figure 3. Obtaining information is the number one
CVE impact.)
...
dark web marketplace discussions.](Figure 4. Top-mentioned SaaS solutions are based on
...
types sold during the reporting period.](Figure 5. Credentials comprise 90% of cloud access
...
the first time this year.](Figure 6. A jump in pricing for RDP access and a slight
decrease in credential pricing were observed. Pricing
data for shell and cPanel access is being reported for
...
platforms.¹¹ This percentage equates to
...
AWS, Alibaba and other cloud providers.
 ...
 - Installation of Shodan for scanning
...
using a valid account. Throughout
the duration of this malicious activity,
the Windows server experienced tens of
