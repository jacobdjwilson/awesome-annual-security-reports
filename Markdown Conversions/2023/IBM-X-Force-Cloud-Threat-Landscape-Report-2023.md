...
![194% increase of new cloud-related CVEs from the prior year]
...
- The use of valid cloud credentials (T1078.004) was the most observed initial access vector in cloud environments, seen in 36% of cases the X-Force team responded to. The exploitation of public-facing applications (T1190)—along with phishing and spear phishing links (T1566.002)—tied for second place, both representing approximately 14% of incidents.
...
![36% of cloud security incidents the X-Force team responded to where the use of valid credentials was the initial access vector]
...
![3,900 Number of cloud-related vulnerabilities the X-Force team is tracking, a number that has doubled since 2019]
![57% Percentage of new CVEs that allows an attacker to obtain information, gain access or gain privileges]
...
![64% Number of incidents the X-Force team responded to in Europe, among clients worldwide]
