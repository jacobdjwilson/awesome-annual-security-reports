...
[Letter From Our Vice President, Threat Research](#a-letter-from-our-vice-president-threat-research)
...
*   Ransomware continues to be the primary threat facing organizations, because of the scope of disruption it can cause and its prevalence. Attack numbers returned to and then exceeded historical norms, after last year's brief slowdown following the invasion of Ukraine. Average dwell times between initial access and ransomware payload delivery have dropped significantly to a median figure of just 24 hours. 2023 may be the most prolific year for ransomware attacks to date.
*   Drive-by downloads are becoming increasingly popular as a malware delivery method and over the past year have surged in use as an initial access vector for ransomware. Two major strains of malware delivered this way are Gootloader and SocGholish, often via compromised websites.
*   Infostealer activity has also increased, associated in large part with use by ransomware affiliates. Stolen credentials now vie with scan-and-exploit as some of the most significant precursors of ransomware attacks. On a single day on one underground marketplace, as many as seven million infostealer logs were available for sale, well over twice as many as on the same day last year. The case for organizations to monitor underground forums for stolen data is clear.
*   Supply chain attacks on and through suppliers provide threat actors with maximum impact for effort expended. Threat actors as diverse as North Korean state-sponsored groups and ransomware operators have conducted notable supply chain attacks over the past year, leveraging initial victims to gain access to their customers.
...
Over the past year, the number of victims named on ransomware leak sites returned to normal levels (after the brief dip in early 20221) and then continued to grow to reach unprecedented heights. The last four months have proved the most fertile in terms of victim numbers since name-and-shame emerged.

*Figure 1. Ransomware name-and-shame leak site victim listings—2020 to 2023. (Source: Secureworks)*

*A line graph showing the number of victims listed on ransomware leak sites from January 2020 to December 2023. The graph shows a dip in early 2022, followed by a sharp increase in 2023, reaching over 600 victims per month.*
...
*A bar graph showing the number of victims listed by different ransomware schemes per month from July 2022 to August 2023. The graph highlights a few schemes with very high victim counts in certain months, such as LockBit, CL0P, and MalasLocker.*
...
*Figure 3. Name-and-shame victims listed per year July-June. (Source: Secureworks)*

*A bar graph showing the total number of victims listed on name-and-shame sites per year from July to June, for the years 2020-21, 2021-22, and 2022-23. The graph shows a significant increase in the number of victims in 2022-23.*

\* The 10,000th name-and-shame ransomware victim name was posted to the BlackCat/ALPHV leak site in mid-August.

However, new schemes have also posted numerous victims: MalasLocker, 8BASE and Akira all emerged only in May 2023. 8BASE listed nearly 40 victims on its leak site during June 2023, only slightly fewer than LockBit. Analysis indicates it posted a dump of victims going as far back as mid-2022 all at the same time. MalasLocker attacks, targeting Zimbra servers from the end of March 20233 and listed on their leak site in May, accounted for at least 171 victims. This provides just one illustration of how valuable scan-and-exploit (where threat actors use search engines to identify vulnerable systems) can be as a tactic for ransomware groups.
...
*A bar graph showing the 20 most active ransomware groups by the number of victims listed on their name-and-shame sites between July 2022 and June 2023. The graph shows LockBit with the highest number of victims, followed by BlackCat/ALPHV, CL0P, and others.*
...
*An infographic showing the different types of data that can be found in an infostealer log, including crypto wallets, VPN data, credentials, visited domains, cookies, tokens, local application data, documents, system information, network information, software information, and web browser data.*
...
*A screenshot of a Telegram channel showing a list of infostealer logs for sale, with prices and deals listed.*
...
*A screenshot of an underground forum post advertising access to corporate resources via a personal computer, including VNC credentials and cookies.*
...
*Figure 8. Extract from an advertisement for the Meduza Stealer. (Source: Secureworks)*

*A screenshot of an advertisement for the Meduza Stealer, showing its features and capabilities.*
...
*A timeline showing the different file transfer solutions that have been exploited by GOLD TAHOE, including Accellion FTA, SolarWinds Serv-U, GoAnywhere MFT, and MOVEit Transfer.*
...
As a result, many groups publicly ban the targeting of critical national infrastructure, government organizations and the healthcare and education verticals in the hope of avoiding scrutiny. For example, following their widescale exploitation of the MOVEit Transfer zero-day vulnerability to steal data from multiple victims, Clop operator GOLD TAHOE announced15 they had deleted data related to any “government, city or police service.” Despite this, they have listed public sector victims on their leak site from several countries. Operating a private ransomware group or exercising tight control over affiliates makes avoiding certain victims in this way much easier to achieve than it can be in less rigidly managed organizations.
