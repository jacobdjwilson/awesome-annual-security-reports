...
- [The Mobile Attack Surface](#the-mobile-attack-surface)
  ...
  - [2.3: State of Mobile Endpoint Security in 2023](#23-state-of-mobile-endpoint-security-in-2023)
...
_Shridhar Mittal, CEO at Zimperium_
...
![Graphic: 45% of companies surveyed suffered a compromise in the past 12 months, up 22% over the prior year]
...
_Jon Paterson, CTO at Zimperium_
...
![Graphic: The escalating Vulnerability Gap chart showing Volume vs Time]
...
**Let's Get Practical**
There’s no turning back. The mobile-powered business is here to stay. Given that reality, what are some practical steps that security teams can take?

*(The report continues with detailed checklists for Corporate Device/Application Usage, Mobile Application Development, and Security Considerations for Mobile Users.)*

---

### 1.3: Artificial Intelligence and the Future of Mobile Security
_Nico Chiaraviglio, Chief Scientist at Zimperium_

In 1977, the first West Coast Computer Fair was held. During the fair, Ted Nelson gave an exposition titled, “Those unforgettable next two years,” highlighting the explosion of personal computers that was about to occur. Thanks to artificial intelligence (AI), we are now experiencing a new version of those “unforgettable next two years.”

**Why AI is Such a Game-Changer in Cybersecurity**
AI is also revolutionizing cybersecurity, demonstrating its facility as the most effective way for organizations to adapt to an evolving threat landscape. AI is such a great leap forward because it can automate and perform tasks such as threat detection, vulnerability management, and network monitoring, to name a few.

Since Zimperium’s inception, AI has been at the core of its technology and innovation, being the only mobile threat defense (MTD) provider that can run machine learning models on device to perform a myriad of tasks such as detecting malware, phishing, system exploits, jailbreak/rooting, and system anomalies. Our models are constantly evolving to adapt to changing threats and are updated continuously to deliver peak performance.

---

### 1.4: The Way Forward for Unmanaged Devices
_Jim Taylor, Chief Product Officer, RSA_
...
While unmanaged devices may help an organization’s bottom line, they still come at a high cost. By their very nature, unmanaged devices aren’t as secure as managed hardware. And threat actors are taking notice: Verizon’s 2022 Mobile Security Index found that mobile-related compromise had doubled from 2021 to 2022.
...
The Zimperium zLabs Advanced Research Group continuously investigates mobile device and application threats targeting users worldwide. The zLabs team detected an average of 77,000 unique malware samples every month in 2022. Between 2021 and 2022, the team saw the total number of malware samples rise by 51%, with more than 920,000 samples detected.

**Key Discoveries:**
- **Dirty RatMilad**: Android Spyware targeting users via social media links.
- **MoneyMonger**: Malware disguised by Flutter framework to bypass legacy security.
- **Dark Herring**: Scamware affecting over 100 million installations.
- **Cloud9**: Malicious Chrome extension enabling remote device control.
- **Schoolyard Bully**: Trojan credential stealer affecting 300,000 victims.

---

### 2.2: 10 Mobile Attacks that Made Headlines in 2022
1. **Pegasus Spyware**: Continued surveillance tool developed by NSO Group.
2. **Emotet**: Malware-as-a-service returning with advanced evasion.
3. **QBot**: Banking trojan targeting corporate users via zero-day exploits.
4. **IcedID (aka BokBot)**: Modular banking trojan used for initial network access.
5. **FluBot**: Fast-growing Android botnet taken down by international law enforcement.
6. **MaliBot**: Successor to FluBot targeting banking customers.
7. **Hydra**: Banking trojan tricking users into granting dangerous permissions.
8. **Godfather**: Banking trojan targeting over 400 financial applications.
9. **Joker**: Stealthy malware conducting unauthorized premium service subscriptions.
10. **AgentTesla**: Advanced remote access trojan (RAT) collecting keystrokes and screenshots.

---

### 2.3: State of Mobile Endpoint Security in 2023
Worldwide, there were 7.1 billion mobile device users in 2021, and that number is expected to reach 7.5 billion by 2025. Mobile internet traffic now accounts for nearly 60% of global web traffic.

**Mobile Security Trends:**
- **Ransomware**: In 2022, Zimperium detected 17,000 unique ransomware samples and protected organizations against over 90,000 attacks.
- **Phishing**: 80% of phishing sites now specifically target mobile devices.
- **Spyware**: Zimperium detected over 3,000 unique spyware samples in 2022.

---

### 2.4: State of Mobile Application Security 2022
Securing mobile apps differs fundamentally from securing web and desktop apps due to easy access to app code, the fact that they run outside the corporate perimeter, and unique platform-specific vulnerabilities.

**Top 5 Trends in Mobile App Protection:**
1. **Constantly Evolving Reverse Engineering Technology**: Attackers use hooking and scripting to bypass security.
2. **Shortage of Security Engineers**: Lack of low-level security skills in the workforce.
3. **Evolution of SecDevOps**: Integrating security into CI/CD pipelines.
4. **Proliferation of Supply Chain Attacks**: Compromised third-party libraries and SDKs.
5. **Hybrid Applications**: Rise of frameworks like Flutter and React Native requiring new security approaches.

---

esources available, making it easier for developers to learn and master hybrid app development techniques.
...
The Anti-Phishing Working Group (APWG) reported more than
...
As security controls and cyber defense techniques increasingly
...
Mobile Malware: Evolving Attacks,
Expanding Risks
...
In March 2022, Zimperium detected 132,000 samples, making it the highest-volume month. June represented the month with the fewest
...
Zimperium’s Detection of Unknown
...
Machine learning algorithms can process and analyze vast amounts of data and learn to identify patterns and behavior associated
...
Hidden or disguised. In order to work and remain installed, spyware needs to be undetected by the victim. Generally, the more
...
TrackViewPro is a tracking application found on many devices. While this app may be available in third-party app stores, it nevertheless
...
Ransomware functions differently on mobile devices. This is because Android and Apple iOS devices employ sandboxing and
...
In 2022, Mandiant tracked 55 zero-day vulnerabilities that were actively being exploited in the wild. On these six affected mobile operating
...
Of the reported and tracked iOS vulnerabilities in 2022:
...
Of course, with each detection, anti-detection mechanisms are created to trick apps, devices, and supporting infrastructure into
...
Reconnaissance is a critical step for an attacker as it helps them identify vulnerabilities and weaknesses that can be exploited in later
...
Device Compromise: Malware Infects Pixel 7 Device in
Austria
...
How Malicious Actors Are Attempting
...
As the story goes, the Trojan Horse, a large wooden structure, was presented as a gift to the
...
Securing Mobile Payments in 2023
and Beyond
...
The Emergence of MPoC and the Implications
...
Here’s a breakdown of the type of cloud storage instances being
...
Average OWASP  Privacy related findings %

Average OWASP  Security related findings %

Average OWASP  % of findings with high severity
...
61
  ...
  Statista, “Forecast number of mobile users worldwide from 2020 to 2025,” URL: https://www.statista.com/statistics/218984/number-of-global-mobile-users-since-2010/#:~:text=In%202021%2C%20the%20number%20of,to%207.26%20billion%20by%202022.

  Statista, “Mobile app usage – Statistics & Facts,” November 2022

  Statista, “eCommerce – Worldwide,” 2022, URL: https://www.statista.com/topics/1002/mobile-app-usage/

  Insider Intelligence, “State of mobile banking in 2022: top apps, features, statistics and market trends,“ April 15, 2022,URL: https://www.insiderintelligence.com/insights/mobile-banking-market-trends/

  Statista, “Value of e-commerce losses to online payment fraud worldwide from 2020 to 2023,” October 2022, URL: https://www.statista.com/statistics/1273177/ecommerce-payment-fraud-losses-globally/

  RSA, “RSA Quarterly Fraud Report,” 2022

  Verizon, “2022 Mobile Security Index,” URL: https://www.verizon.com/business/resources/reports/mobile-security-index/

