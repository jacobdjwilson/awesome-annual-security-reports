...
Organizations increasingly recognize the role cyber plays in enabling broad business success. Looking ahead to 2023 and beyond, cyber is growing far beyond its technology roots. For many organizations, cyber now weaves more tightly into business operations, outcomes, and opportunities.
...
Deloitte designed its 2023 Global Future of Cyber Survey based on the complexity of today’s business and technology landscape. Deloitte based its research on a survey of more than 1,000 cyber decision-makers at the director level or higher, across 20 countries and limited to organizations with at least 1,000 employees and US$500 million in annual revenue.

![Map showing survey distribution: 35% Americas, 25% APAC, 40% EMEA]

---

## The imperative
### The future is cyber
Today, cyber means business, and it is difficult to overstate the importance of cyber as a foundational and integral business imperative. For any enterprise, the future of cyber will be shaped by the C-suite and the board’s commitment, and by the business value that the entire organization can envision with cyber.
...
Since our previous report in the last quarter of 2021, global industries have continued to navigate constant disruption.

![Chart comparing 2021 vs 2023 digital transformation priorities: Cloud, Data Analytics, ERP, OT/ICS, AI/Cognitive Computing, and 5G]

---

## The role of cyber
Executives see cyber playing a crucial role for all digital transformation priorities, especially when it comes to cloud, data analytics, and 5G.

![Figure 1: Cyber in the spotlight - Bar chart showing the extent of cyber's role in various digital initiatives]

### Insights on incidents and impact
The frequency of cyber incidents or breaches has been growing, with 91% of organizations reporting at least one.

![Figure 2: Number of significant cybersecurity events - Bar chart comparing low, medium, and high maturity organizations]

![Figure 3: Feeling the pain - Table showing negative consequences of cyber incidents including operational disruption, revenue loss, and customer trust]

---

## Why maturity matters
### Understanding what it means to be cyber mature
We segmented respondents according to their cyber maturity based on three sets of leading practices:
1. **Robust cyber planning**
2. **Key cyber activities**
3. **Effective board engagement**

**38%** Low cyber maturity
**41%** Medium cyber maturity
**21%** High cyber maturity

### Connecting maturity to value, for the entire enterprise
High-maturity organizations are 31% less likely to cite inadequate governance as a top challenge.

![Figure 4: Where industries stand - Matrix showing implementation levels of cyber activities and planning strategies across industries]

### Bolstering the business with cyber
**55%** of highly mature organizations said cyber provides them with confidence to try new things.

![Figure 5: Recognizing the bigger potential - Bar chart showing impact on business initiatives]
![Figure 6: Reaping real benefits - Bar chart showing positive contributions of cyber initiatives]
...
![Figure 7: Getting value with vendors - Bar chart showing value derived from third-party services]

---

## Key insights
### Five areas of focus
1. **Multidirectional engagement**: High-maturity organizations are nearly three times as likely to have a governing body comprising senior business and IT leaders.
2. **Criticality to digital transformation initiatives**: High-maturity organizations are much more likely to value cyber as central to key digital transformation priorities.
3. **Robust planning**: 91% of high-maturity organizations have an operational and strategic plan to defend against cyber threats.
4. **Appreciating and investing in talent**: High-maturity organizations are significantly more likely to cite a lack of skilled cyber professionals as a top challenge, indicating a deeper awareness of the talent gap.
5. **A diverse ecosystem of tools and services**: High-maturity organizations rely on an extended ecosystem of technologies and external offerings.

![Figure 8: Evolving with cyber - Bar chart showing importance to digital transformation]
![Figure 9: The planning reality - Bar chart showing implementation of specific planning actions]
![Figure 10: How they are tapping their talent - Bar chart showing retention and development strategies]
![Figure 11: Relying on others - Bar chart showing usage of third-party services]

---

## Outlook
### So where do we go from here?
The days of “cyber as an afterthought” are gone. For starters, a zero trust approach should be central to your efforts involving new technology. By removing the assumption of trust from the security architecture and authenticating every action, user, and device, zero trust helps enable a more robust and resilient security posture.
