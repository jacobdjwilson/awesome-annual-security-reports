...
Organization: FBI  
Report Title: IC3-Report  
Year: 2023  

## Table of Contents
- [Introduction](#introduction)
- [The IC3](#the-ic3)
- [The IC3’s Role in Combatting Cyber Crime](#the-iczs-role-in-combatting-cyber-crime)
...
![Image description: Image lists the IC3’s primary functions including partnering with private sector and with local, state, federal, and international agencies: hosting a reporting portal at www.ic3.gov; providing a central hub to alert the public to threats; Perform Analysis, Complaint Referrals, and Asset Recovery; and hosting a remote access database for all law enforcement via the FBI’s LEEP website.](ic3_role_image.png)

---

## IC3 CORE FUNCTIONS

![Image description: Image contains icons with the core functions. Core functions - Collection, Analysis, Public Awareness, and Referrals - are listed in individual blocks as components of an ongoing process.](ic3_core_functions.png)
...
Over the last five years, the IC3 has received an average of 758,000 complaints per year. These complaints address a wide array of Internet scams affecting individuals across the globe.[^1]

**Complaints and Losses over the Last Five Years\***
- **2019**: 467,361 Total Complaints | $3.5 Billion Total Losses
- **2020**: 791,790 Total Complaints | $4.2 Billion Total Losses
- **2021**: 847,376 Total Complaints | $6.9 Billion Total Losses
- **2022**: 800,944 Total Complaints | $10.3 Billion Total Losses
- **2023**: 880,418 Total Complaints | $12.5 Billion Total Losses
*(Cumulative over this time: 3.79 million complaints, $37.4 Billion in losses)*

---

### TOP FIVE CRIME TYPE COMPARISON

![Image description: Chart includes a loss comparison for the top five reported crime types for the years of 2019 to 2023. Top five types include Tech Support, Extortion, Non-Payment/Non-Delivery, Personal Data Breach, and Phishing.](top_five_crime_types.png)
...
![Image description: Image shows the different stages of a complaint in the RAT process.](rat_process.png)
...
- File a detailed complaint with [www.ic3.gov](https://www.ic3.gov). It is vital the complaint contain all required data in provided fields, including banking information.
...
![Image description: Image shows Success to Date to include 71% Success Rate; 3,008 Incidents; $758.05 Million in Losses; and $538.39 Million Frozen.](rat_successes.png)
...
![Image description: 2023 Investment Complaints Reported to IC3 by Age Range (Under 20: 387; 20-29: 3,363; 30-39: 6,654; 40-49: 6,680; 50-59: 5,608; Over 60: 6,404). Does not include complainants that did not provide an age range.](investment_age_range.png)

![Image description: Chart shows Investment Fraud Losses Reported to the IC3 by Year for 2019 to 2023.](investment_losses_chart.png)
...
The IC3 received 1,193 complaints from organizations belonging to a critical infrastructure sector that were affected by a ransomware attack. Of the 16 critical infrastructure sectors, IC3 reporting indicated 14 sectors had at least 1 member that fell to a ransomware attack in 2023.[^3]
...
The five top ransomware variants reported to the IC3 that affected a member of a critical infrastructure sector were Lockbit, ALPHV/Blackcat, Akira, Royal, and Black Basta.[^4]
...
| Category | Complaints | Losses | Trend |
| :--- | :--- | :--- | :--- |
...
- **2,412**: Average complaints received daily
- **758,000+**: Average complaints received per year (last 5 years)
- **Over 8 Million**: Complaints reported since inception

---

## 2023 - COMPLAINANTS BY AGE GROUP

- **Under 20**: 18,174 Complaints | $40.7 Million losses
- **20-29**: 62,410 Complaints | $360.7 Million losses
- **30-39**: 88,138 Complaints | $1.2 Billion losses
- **40-49**: 84,052 Complaints | $1.5 Billion losses
- **50-59**: 65,924 Complaints | $1.7 Billion losses
- **60+**: 101,068 Complaints | $3.4 Billion losses

*(Note: Not all complaints include an associated age range—those without this information are excluded from this list. Please see Appendix B for more information regarding IC3 data.)*

---

## 2023 - TOP 20 INTERNATIONAL COMPLAINT COUNTRIES

**Compared to the United States (< Ten Thousand):**
- Colombia: 545
- Poland: 548
- Japan: 551
- Netherlands: 573
...
1. California: $2,159.5M
2. Texas: $1,021.6M
3. Florida: $874.7M
4. New York: $750.0M
5. New Jersey: $441.2M
6. Pennsylvania: $360.3M
7. Illinois: $335.8M
8. Arizona: $324.4M
9. Georgia: $301.0M
10. Washington: $288.7M
...
| Crime Type | 2023 | Trend | 2022 | Trend | 2021 | Trend |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Advanced Fee | 8,045 |  | 12,264 |  | 11,034 |  |
...
| 24 | Indiana | $49,381,324 | 53 | United States Minor Outlying Islands | $947,386 |
...
*(The official report continues with definitions, additional data insights, and public service announcements as indicated in the Table of Contents.)*

[^1]: Accessibility description: Chart includes yearly and aggregate data for complaints and losses over the years 2019 to 2023. Over this time, the IC3 received a total of 3.79 million complaints, reporting a loss of $37.5 billion. * Please see Appendix B for more information regarding IC3 data.
[^2]: Accessibility description: 2023 Investment Complaints Reported to IC3 by Age Range, and Chart shows Investment Fraud Losses Reported to the IC3 by Year for 2019 to 2023.
[^3]: Accessibility description: Chart shows Infrastructure Sectors Affected by Ransomware. Healthcare and Public Health was highest with 249; followed by Critical Manufacturing 218; Government Facilities 156; Information Technology 137; Financial Services 122; Commercial Facilities 87; Food and Agriculture 75; Transportation 44; Communications 32; Energy 30; Chemical 24; Emergency Services 9; Water and Wastewater Systems 8; Defense Industrial Base 2.
[^4]: Accessibility description: Chart shows Top Ransomware Variants Affecting Critical Infrastructure 2023 Incidents. Lockbit, ALPHV/Blackcat, Akira, Royal, and Black Basta.
...
| ----------------- | --- | ------------ | ----- | ------------ | ------------ |
| 26                |     | $2,729,130   |   52  | Kentucky     | $1,076,986   |
Georgia
*Note: This information is based on the estimated 2023 Census data and the total number of complaints from each
state, the District of Columbia, and Puerto Rico when the complainant provided state information. Please see
Appendix B for more information regarding IC3 data.
...
Business Email Compromise: The $50 Billion Scam 7/9/2023
