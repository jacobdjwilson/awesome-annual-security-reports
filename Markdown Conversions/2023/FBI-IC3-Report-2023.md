...
![Accessibility description: Image lists the IC3’s primary functions including partnering with private sector and with local, state, federal, and international agencies: hosting a reporting portal at www.ic3.gov; providing a central hub to alert the public to threats; Perform Analysis, Complaint Referrals, and Asset Recovery; and hosting a remote access database for all law enforcement via the FBI’s LEEP website.][^1]

[^1]: Accessibility description: Image lists the IC3’s primary functions including partnering with private sector and with local, state, federal, and international agencies: hosting a reporting portal at www.ic3.gov; providing a central hub to alert the public to threats; Perform Analysis, Complaint Referrals, and Asset Recovery; and hosting a remote access database for all law enforcement via the FBI’s LEEP website.

---

## IC3 CORE FUNCTIONS

![Accessibility description: Image contains icons with the core functions. Core functions - Collection, Analysis, Public Awareness, and Referrals - are listed in individual blocks as components of an ongoing process.][^2]
...
- **Total (2019–2023)**: 3.79 Million Complaints | $37.4 Billion Total Losses

[^3]: Accessibility description: Chart includes yearly and aggregate data for complaints and losses over the years 2019 to 2023. Over this time, the IC3 received a total of 3.79 million complaints, reporting a loss of $37.5 billion. * Please see Appendix B for more information regarding IC3 data.

---

### TOP FIVE CRIME TYPE COMPARISON

![Accessibility description: Chart includes a loss comparison for the top five reported crime types for the years of 2019 to 2023.][^4]

[^4]: Accessibility description: Chart includes a loss comparison for the top five reported crime types for the years of 2019 to 2023.
...
[^6]: Accessibility description: Image shows Success to Date to include 71% Success Rate; 3,008 Incidents; $758.05 Million in Losses; and $538.39 Million Frozen.
...
[^9]: Accessibility description: Chart shows Infrastructure Sectors Affected by Ransomware. Healthcare and Public Health was highest with 249; followed by Critical Manufacturing 218; Government Facilities 156; Information Technology 137; Financial Services 122; Commercial Facilities 87; Food and Agriculture 75; Transportation 44; Communications 32; Energy 30; Chemical 24; Emergency Services 9; Water and Wastewater Systems 8; Defense Industrial Base 2.
[^10]: Accessibility description: Chart shows Top Ransomware Variants Affecting Critical Infrastructure 2023 Incidents. Lockbit, ALPHV/Blackcat, Akira, Royal, and Black Basta.

---

### TECH/CUSTOMER SUPPORT AND GOVERNMENT IMPERSONATION[^11]
...
- **Government Impersonation**: 14,190 Complaints | $394,050,518 Losses | 63% Trend
- **Tech and Customer Support**: 37,560 Complaints | $924,512,658 Losses | 15% Trend
- **TOTAL**: 51,750 Complaints | $1,318,563,176 Losses
...
[^11]: Accessibility description: Chart shows number of Government Impersonation and Tech and Customer Support complainants and losses for 2023.

---

## IC3 BY THE NUMBERS[^12]
...
[^13]: Not all complaints include an associated age range—those without this information are excluded from this table. Please see Appendix B for more information regarding IC3 data. Accessibility description: Chart shows number of Complaints and Losses by Age Group.
...
[^15]: Accessibility description: Chart depicts the top 10 states based on number of complaints are labeled. These include California, Texas, Florida, New York, Ohio, Arizona, Pennsylvania, Illinois, Michigan, and Washington. Please see Appendix B for more information regarding IC3 data.

---

## 2023 - TOP 10 STATES BY LOSS (IN MILLIONS)[^16]

1. **California**: $2,159.5
2. **Texas**: $1,021.6
3. **Florida**: $874.7
4. **New York**: $750.0
5. **New Jersey**: $441.2
6. **Pennsylvania**: $360.3
7. **Illinois**: $335.8
8. **Arizona**: $324.4
9. **Georgia**: $301.0
10. **Washington**: $288.7

[^16]: Accessibility description: Chart depicts the top 10 states based on reported losses are labeled. These include California, Texas, Florida, New York, New Jersey, Pennsylvania, Illinois, Arizona, Georgia, and Washington. Please see Appendix B for more information regarding IC3 data.
...
*(Referenced from the report structure)*
