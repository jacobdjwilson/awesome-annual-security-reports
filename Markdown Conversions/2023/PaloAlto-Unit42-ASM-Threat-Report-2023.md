...
- [About Cortex Xpanse](#about-cortex-xpanse)
- [About the Unit 42 Attack Surface Assessment](#about-the-unit-42-attack-surface-assessment)
...
Exposures on publicly facing assets put them at risk of being compromised, and sometimes this leads to organizations becoming victims of opportunity as opposed to a targeted attack.

Understanding what you need to protect is a precursor to any successful cybersecurity program — but companies and government agencies struggle to understand what they own and what services expose the most risk.
...
![Figure 1: Time elapsed before the first reported attack against 30 vulnerabilities exploited by a known threat actor in the last 12 months](Image description: A bar chart showing the time elapsed before the first reported attack against 30 vulnerabilities exploited by a known threat actor in the last 12 months. The x-axis represents time in weeks, and the y-axis represents the number of vulnerabilities. Several vulnerabilities were exploited within hours, while others took up to 12 weeks.)
...
![Figure 2: Time elapsed before the first reported ransomware attack against 15 RCE vulnerabilities by a known threat actor in the last 12 months](Image description: A bar chart showing the time elapsed before the first reported ransomware attack against 15 RCE vulnerabilities by a known threat actor in the last 12 months. The x-axis represents time in weeks, and the y-axis represents the number of vulnerabilities. Some vulnerabilities were exploited within hours, and others within eight weeks.)
...
1.  **Risks related to attacker actions taken on a compromised device that can directly harm the organization:**
    *   Examples include exfiltration of ransomware attacks that disrupt payments processing, and physical damage from a compromised building control or industrial control system.
...
![Figure 3: Distribution of exposure categories observed across the 250 organizations in the last 12 months](Image description: A pie chart showing the distribution of exposure categories observed across 250 organizations in the last 12 months. The largest slices are "Web framework takeover" (22%) and "Remote access services" (20%).)
...
According to the 2022 Unit 42 Incident Response Report, the top suspected means of initial access for ransomware cases investigated by Unit 42 are software vulnerabilities (48%), followed by brute-force credential attacks (20%).[^2] The heavy use of software vulnerabilities matches the opportunistic behavior of ransomware actors, who typically scan the internet at scale for vulnerabilities and weak points. This approach, along with brute-force credential attacks, focused on RDP.
...
![Figure 4: Top five most common exposed remote access services by geography in the last 12 months](Image description: A stacked bar chart showing the top five most common exposed remote access services by geography (North America, EMEA, JAPAC) in the last 12 months. RDP Server is the most prevalent service across all geographies.)
...
| Industry                     | Median Days RDP Exposed |
| :--------------------------- | :---------------------- |
...
Across over 600 incident response cases, the 2022 Unit 42 Incident Response Report found that 50% of targeted organizations lacked multifactor authentication (MFA) on key internet-facing systems.[^3] The prevalence of RDP exposures in each industry studied in this report, combined with the rarity of compensating controls like MFA, make it likely that ransomware attacks will continue for the foreseeable future.
...
![Figure 5: Median proportion of new services introduced by a typical company in each industry during a given month](Image description: A horizontal bar chart showing the median proportion of new services introduced by a typical company in each industry during a given month. Transportation & Logistics has the highest proportion at 27%, followed by Insurance and Financial Services at 24%.)
...
![Figure 6: Median proportion of cloud-hosted exposures that are high risk observed on a typical company’s attack surface in each industry during a given month](Image description: A horizontal bar chart showing the median proportion of cloud-hosted exposures that are high risk observed on a typical company’s attack surface in each industry during a given month. Transportation & Logistics has the highest proportion at 85%, followed by Insurance at 64%.)
...
![Figure 7: Distribution of exposures (Critical, High, Medium) in the cloud versus on-premises in 2022](Image description: A pie chart showing the distribution of exposures (Critical, High, Medium) in the cloud versus on-premises in 2022. The cloud segment is significantly larger than the on-premises segment, indicating that most exposures are in the cloud.)
...
Any of these exposures being accessible over the public internet is a cause for concern since they can act as a toehold for attackers to gain unauthorized access to an organization’s network and access sensitive data.

![Figure 8: Distribution of different categories of Exposures (Critical, High, Medium) in the Cloud vs. On-Premises in the last 12 months](Image description: A stacked bar chart comparing the distribution of different categories of exposures (Critical, High, Medium) in the Cloud versus On-Premises in the last 12 months. For most categories, the cloud distribution is significantly higher than on-premises. Notably, EOL Systems, Development Infrastructure, and Insecure File Sharing show a very high proportion in the cloud.)
...
Last year, Palo Alto Networks published the 2022 Cortex Xpanse Attack Surface Threat Report,[^4] which included a study of attack surface exposures in different industry verticals. In this year’s report, Unit 42 provides an update for each sector, showing the frequency of exposures and explaining the potential consequence of a successful attack.
...
Additionally, these companies rely heavily on remote access services, which amount to 31% of all the exposures for a typical company in this industry. This can be a significant attack vector due to accidental misconfigurations or inadequate security practices. Insecure implementation of SSH servers is the leading contributor to remote access exposures in this industry.
...
![Figure 9: Median distribution of top exposures in the high-tech industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the high-tech industry in 2022. The largest category is "IT Security and Networking Infrastructure" at 34%, followed by "Remote Access Services" at 31%.)
...
![Figure 10: Median distribution of top exposures in national governments in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in national governments in 2022. The largest categories are "IT Security and Networking Infrastructure" at 28%, "File Sharing" at 23%, and "Databases" at 23%.)
...
![Figure 11: Median distribution of top exposures in the professional services industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the professional services industry in 2022. The largest category is "File Sharing" at 50%, followed by "IT Security and Networking Infrastructure" at 17%.)
...
![Figure 12: Median distribution of top exposures in the healthcare industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the healthcare industry in 2022. The largest category is "Development Infrastructure" at 56%, followed by "IT Security and Networking Infrastructure" at 18%.)
...
![Figure 13: Median distribution of top exposures in the utilities and energy industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the utilities and energy industry in 2022. The largest category is "IT Security and Networking Infrastructure" at 47%, followed by "Remote Access Services" at 15%.)
...
![Figure 14: Median distribution of top exposures in the manufacturing industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the manufacturing industry in 2022. The largest category is "IT Security and Networking Infrastructure" at 48%, followed by "File Sharing" at 19%.)
...
![Figure 15: Median distribution of top exposures in the education industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the education industry in 2022. The largest category is "IT Security and Networking Infrastructure" at 31%, followed by "File Sharing" at 26%.)
...
In a Palo Alto Networks–sponsored survey of IT leaders from US state and local governments, nearly one-third of respondents did not know whether remote work had impacted their organization.[^5] Unit 42 found that remote access services are responsible for 24% of remote access risks in state and local governments, as shown in figure 16. Many state and local governments also exposed IT, networking, and security infrastructure and file-sharing services.
...
![Figure 16: Median distribution of top exposures in state and local government in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in state and local government in 2022. The largest category is "IT Security and Networking Infrastructure" at 45%, followed by "Remote Access Services" at 24%.)
...
![Figure 17: Median distribution of top exposures in the transport and logistics industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the transport and logistics industry in 2022. The largest category is "IT Security and Networking Infrastructure" at 34%, followed by "Databases" at 27%.)
...
![Figure 18: Median distribution of top exposures in the finance industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the finance industry in 2022. The largest category is "File Sharing" at 38%, followed by "IT Security and Networking Infrastructure" at 28%.)
...
![Figure 19: Median distribution of top exposures in the wholesale and retail industry in 2022](Image description: A horizontal bar chart showing the median distribution of top exposures in the wholesale and retail industry in 2022. The largest category is "Remote Access Services" at 78%, followed by "IT Security and Networking Infrastructure" at 9%.)
...
For delineation between cloud and on-premises assets, on-premises assets of an organization are publicly accessible systems and services owned by an organization