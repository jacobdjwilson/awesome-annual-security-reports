...
- [2022 Themes](#2022-themes)
  - [eCrime Actors Gained Notoriety for High-Profile Attacks](#ecrime-actors-gained-notoriety-for-high-profile-attacks)
    - [SLIPPY SPIDER Targeted Technology Giants with Data Theft and Extortion](#slippy-spider-targeted-technology-giants-with-data-theft-and-extortion)
    - [SCATTERED SPIDER Used Social Engineering to Overcome MFA](#scattered-spider-used-social-engineering-to-overcome-mfa)
  ...
  - [Discovery, Rediscovery and Circumvention: The 2022 Vulnerability Intelligence Landscape](#discovery-rediscovery-and-circumvention-the-2022-vulnerability-intelligence-landscape)
    ...
    - [Falcon OverWatch Case Study: Unattributed Adversary Exploits Zoho ManageEngine Vulnerability](#falcon-overwatch-case-study-unattributed-adversary-exploits-zoho-manageengine-vulnerability)
  ...
  - [Dominating the Espionage Landscape: China-Nexus Adversaries Significantly Increased 2022 Operational Scale](#dominating-the-espionage-landscape-china-nexus-adversaries-significantly-increased-2022-operational-scale)
    ...
    - [Falcon OverWatch Case Study: ETHEREAL PANDA Deploys SoftEther VPN Post Web Service Compromise](#falcon-overwatch-case-study-ethereal-panda-deploys-softether-vpn-post-web-service-compromise)
- [CrowdStrike eCrime Index](#crowdstrike-ecrime-index)
- [Conclusion](#conclusion)
- [Recommendations](#recommendations)
  - [Five Steps to Be Prepared](#five-steps-to-be-prepared)
    - [Gain Visibility into Your Security Gaps](#gain-visibility-into-your-security-gaps)
    - [Prioritize Identity Protection](#prioritize-identity-protection)
    - [Prioritize Cloud Protection](#prioritize-cloud-protection)
    - [Know Your Adversary](#know-your-adversary)
    - [Practice Makes Perfect](#practice-makes-perfect)
- [CrowdStrike Products and Services](#crowdstrike-products-and-services)
  - [Endpoint Security and XDR](#endpoint-security-and-xdr)
  - [Threat Intelligence](#threat-intelligence)
  - [Cloud Security](#cloud-security)
  - [Security and IT Operations](#security-and-it-operations)
...
The official report URL is: https://www.crowdstrike.com/en-us/resources/reports/crowdstrike-2023-global-threat-report/
...
CrowdStrike Intelligence began tracking
33
new adversaries,
raising the total number of actors
tracked to
200+
...
The Russia-Ukraine war that began in