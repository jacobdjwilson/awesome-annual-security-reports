...
![Figure 1: ENISA Threat Landscape 2022 - Prime threats](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-1-enisa-threat-landscape-2022-prime-threats)
...
![Figure 2: Breakdown of analysed incidents by threat type (July 2022 till June 2023)](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-2-breakdown-of-analysed-incidents-by-threat-type-july-2022-june-2023)
...
*   Several threat actors have been observed to further professionalize¹² ¹³ their As-a-Service programmes. They not only used novel tactics and methods to infiltrate environments but also delved into alternative approaches to pressure and extort victims, all the while advancing their illicit enterprises.
...
*   Information manipulation is a key element of Russia’s war of aggression against Ukraine. Information manipulation has been an essential and well-established component of Russia’s security strategies¹⁶ ¹⁷. The number of analysed events for the reporting period has also grown significantly.
...
![Figure 3: Break down of Global and EU events (July 2022 – June 2023)](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-3-break-down-of-global-and-eu-events-july-2022-june-2023)
...
![Figure 4: Timeline of EU events (count of number of observed incidents per month)](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-4-timeline-of-eu-events-count-of-number-of-observed-incidents-per-month)

![Figure 5: EU breakdown of number of threats by threat group](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-5-eu-breakdown-of-number-of-threats-by-threat-group)
...
![Figure 7: Observed events related to prime ETL threats in terms of the affected sector](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-7-observed-events-related-to-prime-etl-threats-in-terms-of-the-affected-sector)
...
![Figure 8: Threat actor by sector](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-8-threat-actor-by-sector)
...
![Figure 9: Threat type breakdown by Impact](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-9-threat-type-breakdown-by-impact)
...
![Figure 10: Motivation of threat actors per threat category](https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023/figures/figure-10-motivation-of-threat-actors-per-threat-category)

### 1.7 METHODOLOGY

The ENISA Cybersecurity Threat Landscape (CTL) methodology²⁰ was used to produce the ETL 2023 report. The methodology was published in July 2022.
...
Within the report, we differentiate between what has been reported by our sources and what is our assessment. When conducting an assessment, we convey probability by using words that express an estimate of probability²¹.

When we refer to threat actors in this report, we use the naming convention used by the company revealing the campaign, as well as a number of synonyms²² commonly used in the industry.
