...
The official report URL is: https://www.enisa.europa.eu/publications/enisa-threat-landscape-2023
...
Neither ENISA nor any person acting on behalf of ENISA is responsible for the use that might be made
...
According to ENISA’s Threat Landscape for Ransomware Attacks³ report, ransomware is defined as a type
of attack where threat actors take control of a target’s assets and demand a ransom in exchange for the return of
the asset’s availability. This action-agnostic definition is needed to cover the changing ransomware threat landscape,
