...
![Respondent Demographics Chart](Image description: A chart showing respondent demographics including top industries, years of experience, total revenue, region, number of employees at organization, and the distribution of respondents across these categories.)
...
![Staff Privacy Roles Chart](Image description: A bar chart showing the percentage of staff in different privacy roles: Legal/compliance practitioners, Technical IT staff (excluding security professionals), Risk professionals, and Security professionals. The chart breaks down the percentages into ranges like 1%-20%, 21%-40%, etc.)

Both legal/compliance and technical privacy teams are understaffed, according to the ISACA survey results. Forty-four percent of respondents indicate that legal/compliance privacy teams are somewhat or significantly understaffed, and 53 percent of respondents report that technical privacy teams are somewhat or significantly understaffed. Larger understaffing in technical privacy teams than in legal/compliance teams is consistent with previous years’ findings. Although understaffing remains concerning, it has improved from last year (figure 3).

This may be due to enterprises prioritizing privacy more compared to last year and/or increasing privacy budgets—35 percent of last year’s survey respondents reported that their privacy budget would increase in the next 12 months.
...
![Privacy Understaffing Compared With Last Year Chart](Image description: A bar chart comparing the understaffing of privacy roles (Legal/compliance and Technical privacy) between 2022 and 2023, showing percentages for each category.)

![Time to Fill Open Legal/Compliance Privacy Positions Chart](Image description: A pie chart showing the average time it takes to fill open legal/compliance privacy positions with a qualified candidate, with categories like <2 weeks, 1–3 months, 3–6 months, >6 months, Cannot fill open positions, and Don’t know.)

![Time to Fill Open Technical Privacy Positions Chart](Image description: A pie chart showing the average time it takes to fill open technical privacy positions with a qualified candidate, with categories like <2 weeks, 1–3 months, 3–6 months, >6 months, Cannot fill open positions, and Don’t know.)
...
![Importance of Factors Determining an Applicant’s Qualifications Chart](Image description: A stacked bar chart showing the importance of various factors (Compliance/legal experience, Prior hands-on experience in privacy role, Technical experience, Credentials held, Completion of hands-on training courses in privacy, University degree, Recommendation from previous employer) in determining if a privacy candidate is qualified, with categories for Very important, Somewhat important, Not very important, and Not at all important.)
...
![Methods of Addressing the Privacy Skills Gap Chart](Image description: A bar chart showing various methods organizations have undertaken to help decrease the privacy skills gap, such as Training to allow nonprivacy staff, Increased use of contract employees, Increased use of performance-based training, Increased reliance on credentials, Increased reliance on artificial intelligence or automation, Nothing has been done, Don’t know, Organization has no privacy skills gap, and Other.)
...
Ensuring the appropriate person is accountable for privacy is essential because this individual can help guide efforts in the event of a breach and advocate for the privacy team, including advocating for funding and other resources. This accountability also improves the alignment of privacy with other organizational objectives.

![Accountability for Privacy Chart](Image description: A bar chart showing who is primarily accountable for privacy in organizations, with categories like Chief privacy officer, Chief information officer, Executive-level security officer, Chief executive officer, General counsel/chief legal officer, Chief compliance officer, Board of directors, Don't know, Other, and The organization does not have a person accountable for privacy.)

![Obstacles to Forming a Privacy Program Chart](Image description: A bar chart listing obstacles faced by organizations in their ability to form a privacy program, such as Lack of competent resources, Lack of clarity on the mandate, roles and responsibilities, Lack of executive or business support, Lack of visibility and influence within the organization, Complex international legal and regulatory landscape, Management of risk associated with new technologies, Lack of a privacy strategy and implementation roadmap, No obstacles exist, Don't know, and Other.)
...
![Frequency of Meetings Between Technical and Legal/Compliance Privacy Professionals Chart](Image description: A bar chart showing the frequency of meetings between technical and legal/compliance privacy professionals to understand legal and regulatory requirements, with categories like Never, Monthly, 1–2 times per year, Quarterly, Weekly, and As new privacy laws/regulations go into effect.)
...
![How Boards of Directors View Privacy Programs Chart](Image description: A pie chart showing how boards of directors view an enterprise’s privacy program, with categories like Compliance driven, Ethically driven, and A combination of both.)
...
To evaluate if employees are benefitting from privacy training programs. Figure 14 shows the metrics that respondent enterprises use to evaluate privacy training program effectiveness.
...
![Metrics to Evaluate Privacy Awareness Training Effectiveness Chart](Image description: A bar chart showing metrics organizations track to evaluate the privacy training program’s effectiveness, such as Number of employees who have completed privacy training, Number of privacy incidents, Number of privacy complaints received from customers, Comparison of pre- and post-training assessments, and Other.)
...
![Frequency of Practicing Privacy by Design Chart](Image description: A pie chart showing how often an enterprise practices privacy by design, with categories like Always, Frequently, Sometimes, Rarely, and Never.)

![Trends in Enterprises That Always Use Privacy by Design Chart](Image description: A bar chart comparing trends in enterprises that always practice privacy by design versus total respondents, showing metrics like The median privacy staff size, Feel that their privacy department is adequately staffed, and Feel that their board properly prioritizes privacy.)

¹ ISACA, “Eight Strategies to Help Organizations Implement Privacy by Design and Default,” 21 October 2021, https://www.isaca.org/why-isaca/about-us/newsroom/press-releases/2021/eight-strategies-to-help-organizations-implement-privacy-by-design-and-default

## The Future of Privacy

The numerous new privacy laws and regulations—and data subjects’ increased attention to privacy—indicate that privacy is important, and the work of privacy professionals is crucial to an enterprise’s success. Given the various requirements privacy teams must meet and the growing number of international privacy laws and regulations, it makes sense that the demand for privacy professionals is expected to grow in the next year. Sixty-two percent of respondents say the demand for legal/compliance roles will increase in the next year, and 69 percent say the demand for technical privacy positions will increase.
...
![Likelihood of a Material Privacy Breach in the Next Year Chart](Image description: A bar chart showing the likelihood that an organization will experience a material privacy breach next year, with categories like Very likely, Likely, Neither likely nor unlikely, Unlikely, Very unlikely, Don't know, and Prefer not to answer.)
...
![Plans to Use AI for Privacy-Related Tasks Chart](Image description: A bar chart showing an organization’s plans to use AI (bots or machine learning) to perform any privacy-related tasks, with options like We currently use AI for this function, We plan to use AI for this function in the next 12 months, We have no plans to use AI for this function, and Don’t know.)

² Pearce, G.; “Beware the Privacy Violations in Artificial Intelligence Applications,” ISACA Now Blog, 28 May 2021, https://www.isaca.org/resources/news-and-trends/isaca-now-blog/2021/beware-the-privacy-violations-in-artificial-intelligence-applications
...
*   Veronica Rose
    Senior Information Systems Auditor–Advisory Consulting, KPMG Uganda, Kenya
