# 2023 ITRC Data Breach Report: Key Findings and Solutions
...
- [Trends](#trends)
  ...
  - [Trend 2: Underlying Flaw in Data Breach Notice Laws](#trend-2-underlying-flaw-in-data-breach-notice-laws)
- [Solutions](#solutions)
  - [Uniform Breach Notice Laws](#uniform-breach-notice-laws)
  - [Digital Credentials & Facial Comparison Systems](#digital-credentials-facial-comparison-systems)
  - [Improve Vendor Due Diligence](#improve-vendor-due-diligence)
...
![Figure 1 | Total Compromises, Year over Year showing a bar chart with data for 2023, 2022, and 2021 for Compromises and Victims.](figure1.png)
...
*   **Organizations Impacted Since 2018**: +2,600 PERCENTAGE POINTS
*   **Estimated Number of Victims Since 2018**: +1,400 PERCENTAGE POINTS

### Top 5 Compromises by Victim Count

1.  **T-MOBILE**: 37,000,000 VICTIMS IMPACTED
2.  **XFINITY**: 35,879,455 VICTIMS IMPACTED
3.  **PEOPLECONNECT, INC.**: 20,221,007 VICTIMS IMPACTED
4.  **NATIONSTAR MORTGAGE LLC**: 14,690,284 VICTIMS IMPACTED
5.  **PBI RESEARCH SERVICES – MOVEIT TRANSFER**: 11,781,156 VICTIMS IMPACTED

### Total Attack Vectors

*   **CYBER ATTACKS**: 2,365 Breaches | 343,338,964 Victims
*   **SYSTEM AND HUMAN ERRORS**: 729 Breaches/Exposures | 6,715,385 Victims
*   **PHYSICAL ATTACKS**: 53 Breaches/Exposures | 127,832 Victims
*   **SUPPLY CHAIN ATTACKS**: 242 Breaches/Exposures | 2,769 Entities Affected | 54,432,431 Victims
...
Two clear trends emerged in 2023 beyond the dramatic rise in overall data compromises:
1) an equally dramatic increase in the number of organizations being impacted by Supply Chain Attacks, and 2) a trend highlighted by the rise in Supply Chain Attacks – the further break-down in the breach notification framework.
...
![Figure 2 | Total Compromises, Year-Over-Year showing bar charts for Compromises and Victims from 2018 to 2023.](figure2.png)
...
![Figure 3 | Compromises by Industry, Year-Over-Year showing a table with data for 2023 and 2022 for Compromises and Victims across various industries.](figure3.png)
...
![Figure 4 | Public Compromises & Victims, 2023 showing a table comparing Public and Other Entities for Compromises and Victims.](figure4.png)
...
![Figure 5 | Sensitive vs Non-Sensitive Records, Year-Over-Year showing a table with data for 2018-2023 for Compromises involving Sensitive, Non-Sensitive, and Unknown Records, along with their percentages.](figure5.png)
...
![Figure 6 | Attack Vectors, Year-Over-Year showing a table with data for 2018-2023 for various attack vectors.](figure6.png)
...
![Figure 7 | Actionable vs Non-Actionable Notices, 2023 showing a table comparing Notices with Victim Count and Attack Vector Details, Notices with Victim Count and Attack Vector, and Notices with Victim Count for 2018-2023.](figure7.png)
...
![Figure 8 | Top 10 Compromises, 2023 showing a table listing the top 10 compromises by victim count.](figure8.png)
...
![Figure 9 | Total Annual Compromises, 2005 – Present showing bar charts for Compromises and Victims from 2005 to 2023.](figure9.png)
...
![Figure 10 | Supply Chain Attack illustrating how attackers bypass large organization’s cybersecurity by attacking smaller vendors.](figure10.png)

![Figure 11 | Supply Chain Attacks, Year-Over-Year showing a table with data for Third-Party/Supply Chain Attacks and Entities Impacted from 2018 to 2023.](figure11.png)

![Figure 12 | MOVEit Supply Chain Attack, Direct and Indirect Impacts showing a bar chart illustrating the direct and indirect entities impacted by the MOVEit attack.](figure12.png)
...
![Figure 13 | Blackbaud Supply Chain Attack Notices showing a comparison of Total Customers Impacted vs. Filed Public Notices.](figure13.png)
...
*   In the event the release of information regarding the data breach