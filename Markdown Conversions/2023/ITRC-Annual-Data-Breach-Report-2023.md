# Annual Data Breach Report 2023
...
- **Total Compromises in 2023**: 3,205
- **Total Victims**: 353,027,892
- **Breakdown**:
...
- **Key Findings**:
  - 1,400+ Public Data Breach Notices did not contain information about an attack vector.
  - Total Compromises: 72 percentage point increase from all-time-high in 2021.
  - Total Victim Count: 16 percentage point decrease from 2022.
  - Supply Chain Attacks: Organizations impacted since 2018 up +2,600 percentage points.

- **Top 5 Compromises by Victim Count**:
  1. T-Mobile (37,000,000)
  2. Xfinity (35,879,455)
  3. PeopleConnect, Inc. (20,221,007)
  4. Nationstar Mortgage LLC (14,690,284)
...
- **Total Attack Vectors**:
  ...
  - Physical Attacks: 53 Breaches/Exposures | 127,832 Victims
...
The estimated number of victims impacted represents a 16 percentage point reduction from 2022. This is consistent with a general trend of the number of estimated victims dropping slightly each year, as organized identity criminals focus on specific information and identity-related fraud rather than mass attacks.
...
1. **Trend 1: Supply Chain Attacks Grow**: The number of organizations impacted has surged by more than 2,600 percent (2,600%) since 2018.
2. **Trend 2: Underlying Flaw in Data Breach Notice Laws**: The rise in Supply Chain Attacks has called into question who is responsible for making the determination of risk and notifying victims. The Blackbaud incident illustrates that breaches are under-reported.

### Solutions
The ITRC suggests three areas for action:
1. **Uniform Breach Notice Laws**: The current patchwork of 50 state laws makes compliance difficult and expensive.
2. **Digital Credentials & Facial Comparison Systems**: Expanded use of facial verification and digital credentials is crucial to reducing identity crimes.
3. **Improve Vendor Due Diligence**: Understanding the risk represented by vendors is imperative. The ITRC will launch a due diligence tool, **Breach Alert for Business (BA4B)**.
...
The estimated number of victims impacted represents a 16 percent (16%) reduction from 2022. This is consistent with a general trend of the number of estimated victims dropping slightly each year.

### Sensitive vs Non-Sensitive Data
Compromises involving sensitive personal information remained the most common type of breach in 2023. The number of attacks involving only sensitive information dropped by 10 percentage points but increased in absolute terms in 2023 compared to the previous year.

### Actionable vs Non-Actionable Notices
The trend toward opaque breach notices accelerated in 2023. The number of breach notices without specific information about the root cause of an attack nearly doubled year-over-year. In the 12 months that just ended, more than 1,400 public breach notices did not contain information about an attack vector compared to 716 in 2022 – a 98 percentage point increase.

### Top 10 Compromises in 2023
1. T-Mobile: 37,000,000 victims
2. Xfinity: 35,879,455 victims
3. PeopleConnect, Inc.: 20,221,007 victims
4. Nationstar Mortgage LLC, dba Mr. Cooper: 14,690,284 victims
5. PBI Research Services – MOVEit Transfer: 11,781,156 victims
6. HCA Healthcare, Inc.: 11,270,000 victims
7. Weee! Inc.: 11,000,000 victims
8. Maximus, Inc. – MOVEit Transfer: 11,000,000 victims
9. Perry Johnson & Associates, Inc.: 8,952,212 victims
10. Zacks Investment Research, Inc.: 8,929,503 victims

### Total Annual Compromises Since 2005
The ITRC has been tracking publicly reported data compromises since 2005. Growth in compromises has been fueled primarily by cyberattacks since 2018.
...
Third-Party Vendor Attacks, also known as Supply Chain Attacks, are typically attacks that fall into one of the primary root causes of a compromise, most often a cyberattack. What makes them unique is the target is not data owned by the breached organization but rather the information of the business’s customers, clients or other vendors in a supply chain.

### Trend 2: Data Breach Notice System Flaws Emerge
...
The ITRC believes that state data breach laws and federal agency regulations can be more helpful to victims by adopting uniform provisions, including a uniform definition of PII and a 24-hour filing requirement for breach notices.

### Digital Credentials & Facial Comparison Systems
The ITRC concluded that the expanded use of facial verification and digital credentials is crucial to reducing the number of identity crimes involving the use of stolen personal information.

### Increased Due Diligence
Knowing both the breach history of an organization and being able to verify that history is a key to proper due diligence on current and future suppliers.
...
## Appendix
*(The Appendix contains detailed statistical tables for 2005–Present, 2023 quarterly breakdowns, and methodology notes. Please refer to the original document for full data tables.)*
