...
- [Introduction](#introduction)
  - [About the 2023 Open Source Security and Risk Analysis Report and the CyRC](#about-the-2023-open-source-security-and-risk-analysis-report-and-the-cyrc)
- [Overview](#overview)
  - [2023 by the Numbers](#2023-by-the-numbers)
  - [Open Source by Industry](#open-source-by-industry)
...
- [Vulnerabilities and Security](#vulnerabilities-and-security)
  ...
  - [The Gordian Knot: Open Source Software Risk and Supply Chain Security](#the-gordian-knot-open-source-software-risk-and-supply-chain-security)
  - [Vulnerabilities in Industries](#vulnerabilities-in-industries)
  - [Vulnerability Severity Scoring](#vulnerability-severity-scoring)
  - [Five-Year Rewind](#five-year-rewind)
    - [Finding 1. Open source adoption varies by industry](#finding-1-open-source-adoption-varies-by-industry)
    - [Finding 2. Organizations aren’t fixing high-risk vulnerabilities](#finding-2-organizations-arent-fixing-high-risk-vulnerabilities)
- [Licensing](#licensing)
...
- [Open Source Maintenance](#open-source-maintenance)
  ...
  - [Beyond Known Risk](#beyond-known-risk)
  - [Maintenance by Open Source Consumers](#maintenance-by-open-source-consumers)
- [Conclusion](#conclusion)
  - [“Trust, but Verify”](#trust-but-verify)
  - [The Problem with Trust](#the-problem-with-trust)
  - [Verify with an SBOM](#verify-with-an-sbom)
...
![Bar chart showing trends from 2018-2022 for percentage of codebases containing open source, percentage of code in codebases that was open source, percentage of codebases containing at least one vulnerability, and percentage of codebases containing high-risk vulnerabilities.]

### Open Source by Industry
![Multiple bar charts showing open source adoption trends by industry from 2018-2022, including Aerospace, Aviation, Automotive, Transportation, Logistics; Big Data, AI, BI, Machine Learning; Computer Hardware and Semiconductors; Cybersecurity; EdTech; Energy and Clean Tech; Enterprise Software/SaaS; Financial Services and FinTech; Healthcare, Health Tech, Life Sciences; Internet and Mobile Apps; Internet and Software Infrastructure; Internet of Things; Manufacturing, Industrials, Robotics; Marketing Tech; Retail and eCommerce; Telecommunications and Wireless; and Virtual Reality, Gaming, Entertainment, Media.]
...
![Bar chart showing trends from 2018-2022 for percentage of codebases containing open source, percentage of codebases containing at least one vulnerability, and percentage of codebases containing high-risk vulnerabilities.]

![List of top components with vulnerabilities, including jQuery (47%), Lodash (31%), Bootstrap (Twitter) (23%), jackson-databind (11%), Spring Framework (10%), Netty Project (6%), XStream (5%), Apache Tomcat* (5%), PHP* (0.4%), and Linux Kernel* (0.1%), where * indicates components containing high-risk vulnerabilities.]
...
![Multiple bar charts showing open source and vulnerability trends by industry from 2018-2022, including Aerospace, Aviation, Automotive, Transportation, Logistics; Big Data, AI, BI, Machine Learning; Computer Hardware and Semiconductors; Cybersecurity; EdTech; Energy and Clean Tech; Enterprise Software/SaaS; Financial Services and FinTech; Healthcare, Health Tech, Life Sciences; Internet and Mobile Apps; Internet and Software Infrastructure; Internet of Things; Manufacturing, Industrials, Robotics; Marketing Tech; Retail and eCommerce; Telecommunications and Wireless; and Virtual Reality, Gaming, Entertainment, Media.]
...
![List of the 10 most common CVEs/BDSAs found in codebases, including BDSA-2020-0964 (CVE-2020-11023), BDSA-2019-1138 (CVE-2019-11358), BDSA-2021-3651, BDSA-2017-2930 (CVE-2015-9251), BDSA-2014-0063, BDSA-2015-0567, CVE-2019-5428, BDSA-2021-0375 (CVE-2020-28500), BDSA-2021-0392 (CVE-2021-23337), and BDSA-2020-3839.]

![List of the 10 most common high-risk CVEs/BDSAs found in codebases, including BDSA-2015-0753 (CVE-2015-6420), CVE-2021-31597, CVE-2021-41720, CVE-2021-3749, CVE-2020-8022, CVE-2016-1000027, CVE-2018-1000613, CVE-2017-1000487, CVE-2017-7657, and BDSA-2018-4597 (CVE-2018-14719).]
...
![Multiple bar charts showing open source and high-risk vulnerability trends by industry from 2018-2022, including Aerospace, Aviation, Automotive, Transportation, Logistics; Big Data, AI, BI, Machine Learning; Computer Hardware and Semiconductors; Cybersecurity; EdTech; Energy and Clean Tech; Enterprise Software/SaaS; Financial Services and FinTech; Healthcare, Health Tech, Life Sciences; Internet and Mobile Apps; Internet and Software Infrastructure; Internet of Things; Manufacturing, Industrials, Robotics; Marketing Tech; Retail and eCommerce; Telecommunications and Wireless; and Virtual Reality, Gaming, Entertainment, Media.]
...
![List of industries with the largest increases in high-risk vulnerabilities over five years, including Retail and eCommerce (+557%), Computer Hardware and Semiconductors (+317%), Manufacturing, Industrials, Robotics (+277%), Big Data, AI, BI, Machine Learning (+236%), and Aerospace, Aviation, Automotive, Transportation, Logistics (+232%).]
...
![Multiple bar charts showing open source and license conflict trends by industry from 2018-2022, including Aerospace, Aviation, Automotive, Transportation, Logistics; Big Data, AI, BI, Machine Learning; Computer Hardware and Semiconductors; Cybersecurity; EdTech; Energy and Clean Tech; Enterprise Software/SaaS; Financial Services and FinTech; Healthcare, Health Tech, Life Sciences; Internet and Mobile Apps; Internet and Software Infrastructure; Internet of Things; Manufacturing, Industrials, Robotics; Marketing Tech; Retail and eCommerce; Telecommunications and Wireless; and Virtual Reality, Gaming, Entertainment, Media.]
...
![Bar chart showing trends from 2018-2022 for percentage of codebases with license conflicts and percentage of codebases containing open source with no license or custom license.]

![List of the 10 most common license conflicts, including Creative Commons Attribution ShareAlike 3.0, Creative Commons Attribution ShareAlike 4.0, GNU Lesser General Public License v2.1 or later (utilized in 43% of scanned codebases), GNU General Public License v2.0 or later, Apache License 2.0 (utilized in 90% of scanned codebases), Creative Commons Attribution 3.0, GNU General Public License v3.0 or later, GNU Lesser General Public License v3.0 or later, Eclipse Public License 1.0, and Mozilla Public License 2.0 (utilized in 34% of scanned codebases).]
...
![Bar chart showing trends from 2018-2022 for percentage of codebases containing components with no new development in the past two years and percentage of codebases with open source more than four years out-of-date.]
...
![List of issues with versioning, including 91% of codebases containing components that were not the latest version, 88% of codebases containing components with no activity for the last 24 months and latest version of the component not in use, 72% of codebases containing components with no activity for the last 24 months and latest version of the component in use, and 15% of codebases using more than 10 versions of a component.]
...
- Article: M&A Activity Looks Anemic Heading to Year-End as LBOs Shrivel
