...
| Impact Area            | 2022 | 2023 |
|------------------------|------|------|
| Reputation             | 80%  | 88%  |
| Business continuity    | 74%  | 87%  |
| Company culture        | 72%  | 86%  |
| Ability to compete     | 73%  | 86%  |
| Employee acquistion and retention | 72% | 79% |
| Compliance             | 77%  | 72%  |
...
*   27% Insider Risk
*   26% Cloud data exposures
*   22% Malware/ransomware
*   17% Exploited software vulnerabilities/Zero days
*   10% Unauthorized access to internal systems by intruder
...
*   64% Technology (inability to implement the right technology or get the technology to function)
*   62% Visibility (the technology you have today doesn’t provide the right visibility into data loss)
*   55% Prioritization (the company has not prioritized stopping data loss from insiders)
*   44% Ownership (no one team is responsible for data loss from insiders)
*   42% Cultural/organizational (not embraced by employees, process and procedures)
*   33% Budgetary (insufficient funding)
...
*   87% Source code sent to repositories
*   84% Files sent to personal email accounts (e.g., Google if G-suite)
*   83% Data exfiltrated on USBs
*   83% Mac environment (operating system)
*   82% Browser uploads
*   82% CRM data file downloads
