...
The headlines in 2022 were dominated by cases of IP theft and insider threats. Pharmaceutical
...
A lack of confidence in job security means that
...
# Data Exposure is Getting Worse
...
The 2022 Data Exposure Report highlighted
...
[Image description: A bar chart showing the top three most valuable data types: Research Data (67%), Source Code (53%), and Product Roadmaps (50%).]
...
[Image description: A bar chart showing the estimated number of insider-driven data exposure, loss, leak and theft events per month. The bars represent: 2020 (19 events), 2021 (25 events), 2022 (22 events), 2023 (22 events).]
...
In fact, the research suggests the issue has only worsened – since our last report there has been
...
[Image description: A grouped bar chart comparing the impact of Insider Risk events in 2022 and 2023 across several categories: Reputation, Business continuity, Company culture, Ability to compete, Employee acquisition and retention, and Compliance. In 2023, the percentages for each category are: Reputation (88%), Business continuity (87%), Company culture (86%), Ability to compete (83%), Employee acquisition and retention (82%), and Compliance (79%). In 2022, the percentages were: Reputation (86%), Business continuity (86%), Company culture (77%), Ability to compete (72%), Employee acquisition and retention (72%), and Compliance (73%).]
...
Insider Risk events range from malicious, to negligent, to accidental in nature. While the
...
[Image description: A horizontal bar chart showing the percentage of CISOs who rank different types of threats as the most difficult to detect. Insider Risk is at 27%, Cloud data exposures at 26%, Malware/ransomware at 22%, Exploited software vulnerabilities/Zero days at 17%, and Unauthorized access to internal systems by intruder at 10%.]
...
technology or get the technology to function): 64%
- Visibility (the technology you have today doesn’t
provide the right visibility into data loss): 62%
- Prioritization (the company has not prioritized
stopping data loss from insiders): 55%
- Ownership (no one team is responsible
for data loss from insiders): 44%
- Cultural/organizational (not embraced by
employees, process and procedures): 42%
- Budgetary (insufficient funding): 33%

[Image description: A horizontal bar chart showing the top challenges when building a program to protect against data loss from insiders. Technology is at 64%, Visibility at 62%, Prioritization at 55%, Ownership at 44%, Cultural/organizational at 42%, and Budgetary at 33%.]
...
Building a program to protect against data loss from insiders is
...
Most companies are facing challenges when it comes to their data exfiltration technology and
...
[Image description: A horizontal bar chart showing the level of visibility companies need over various data exfiltration vectors. 'A lot more visibility' and 'A little more visibility' are combined. Source code sent to repositories is at 87%, Files sent to personal email accounts (e.g., Google if G-suite) at 84%, Data exﬁltrated on USBs at 83%, Mac environment (operating system) at 83%, Browser uploads at 82%, and CRM data ﬁle downloads at 82%.]
...
However, the data shows that simply increasing the frequency of training is not enough. Those
...
is needed. 58% of companies conduct training on a routine
...
[Image description: A pie chart showing the frequency of employee data security training. Just in time is 11%, Daily is 15%, Weekly is 30%, Monthly is 28%, Quarterly is 12%, and Annually is 4%.]
...
1.  Ensure the technology used is easy to
...
2.  Strengthen program efforts by
...
The Company has several offices across the United States and its clients include large multinational
