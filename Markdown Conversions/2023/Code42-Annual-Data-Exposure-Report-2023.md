...
72% of companies say they have a program dedicated to Insider Risk or threats, but conflicting data shows that these same companies are still struggling with the problem.
...
86% Company culture
86% Ability to compete
82% Employee acquisition and retention
82% Compliance

To what extent has/would the following be impacted as a result of an Insider Risk event involving loss or theft of sensitive information in your company? [700] Showing ‘Major impact’ or ‘Moderate impact’ combined, split by survey year
...
90% of companies indicated they used a combination of IRM, DLP, CASB and UEBA to protect data from exfiltration by insiders
...
*   Source code sent to respositories: 87%
*   Files sent to personal email accounts (e.g., Google if G-suite): 84%
*   Data exﬁltrated on USBs: 83%
*   Mac environment (operating system): 83%
*   Browser uploads: 82%
*   CRM data ﬁle downloads: 82%
