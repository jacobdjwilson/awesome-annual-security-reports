...
- [Helpful definitions and chart guidance](#helpful-definitions-and-chart-guidance)
  - [VERIS Framework resources](#veris-framework-resources)
  - [Incident vs. breach](#incident-vs-breach)
  - [Industry labels](#industry-labels)
  - [I’m sorry, this all happened when?](#im-sorry-this-all-happened-when)
  - [Being confident of our data](#being-confident-of-our-data)
  - [Credit where credit is due](#credit-where-credit-is-due)
  - [Questions? Comments? Organizing a bank run?](#questions-comments-organizing-a-bank-run)
...
- [Results and analysis](#results-and-analysis)
  ...
  - [Attributes](#attributes)
    - [Virtual money, real problems](#virtual-money-real-problems)
...
- [Incident Classification Patterns](#incident-classification-patterns)
  ...
  - [System Intrusion](#system-intrusion)
    ...
    - [Actor motives](#actor-motives)
    - [Data compromised](#data-compromised)
    - [This is mine, and this is mine …](#this-is-mine-and-this-is-mine-)
    - [Relevant ATT&CK techniques](#relevant-attck-techniques)
    - [Jiggling locks](#jiggling-locks)
    [Well, that escalated quickly.](#well-that-escalated-quickly)
    - [Results](#results)
    - [Ransomware … seriously, we’re still doing this section?](#ransomware--seriously-were-still-doing-this-section)
    - [Splitting the Log4j](#splitting-the-log4j)
    - [CIS Controls for consideration](#cis-controls-for-consideration)
      - [Protecting devices](#protecting-devices)
      - [Protecting accounts](#protecting-accounts)
      - [Security awareness programs](#security-awareness-programs)
    - [Just one more (Ransomware) note](#just-one-more-ransomware-note)
- [Social Engineering](#social-engineering)
  - [Summary](#summary-1)
  - [Frequency](#frequency-1)
  - [What is the same?](#what-is-the-same-1)
  - [Threat actors](#threat-actors-1)
  - [Actor motives](#actor-motives-1)
  - [Data compromised](#data-compromised-1)
  - [Professional engineers?](#professional-engineers)
  - [Relevant ATT&CK techniques](#relevant-attck-techniques-1)
...
![Image of a magnifier over a graph showing cumulative breach counts from 2005 to 2020, with labels 10K, 20K, 30K.](Image-of-a-magnifier-over-a-graph-showing-cumulative-breach-counts-from-2005-to-2020-with-labels-10K-20K-30K)
...
![Figure 1. Example slanted bar chart (n=205)](Figure-1.-Example-slanted-bar-chart)
...
![Figure 2. Example spaghetti chart](Figure-2.-Example-spaghetti-chart)
...
![Figure 3. Example dot plot (n=672). Each dot represents 0.5% of organizations. Orange: lower half of 80%. Yellow: upper half of 80%. Green: 80%–95%. Blue: Outliers. 95% of orgs: 148–1,594,648. 80%: 1,274–438,499. Median: 29,774 (log scale).](Figure-3.-Example-dot-plot)
...
![Figure 4. Example pictogram plot (n

---

il Accounts: T1586.002
