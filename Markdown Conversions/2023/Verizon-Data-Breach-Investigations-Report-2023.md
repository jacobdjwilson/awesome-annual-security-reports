...
Assets pattern.18However, not caring for them properly could cause liabilities that would go on the right side.
...
popular entry point for breaches.Of course, we still get specific data 
...
next unscheduled encryption event.Figure 34\. Median transaction 
...
Breaches and 10% of Incidents).Relevant ATT\&CK 
...
into an account they control.Alternatively, actors can target 
...
in first place at 42%.Figure 56\. Select Actions over time in 
...
Credentials (33%), 
Internal (32%) 
(breaches)This sector continues 
to be targeted by 
Financially motivated 
external threat 
actors as well as 
...
cooperation we want to see fostered.Thats no 
moon!Whether data is stolen by stealthy 
...
call it a day for now.The System Intrusion pattern remains 
...
the highest.Within the System Intrusion pattern, we 
...
income for the adversaries.While it is possible to reach their goals 
...
only at 2%.50 There are explosions and car chases in there too, were sure of it.2023 DBIR Industries62Retail NS
C
AI5
4

4
4If you are in the Retail world and you 
...
several different tricks (Figure 61\).FrequencyTop patternsThreat actors406 incidents,
193 with confirmed 
data disclosureSystem Intrusion, 
Social Engineering 
and Basic Web 
...
Multiple (2%),
Partner (2%) 
(breaches)Actor motives Financial (100%),Data 
compromisedWhat is the 
same?Espionage (1%) 
(breaches)Payment (37%), 
Credentials (35%), 
Other (32%), 
Personal (23%) 
(breaches)Retail organizations 
continue to be 
lucrative targets for 
cybercriminals 
looking to collect 
Payment card data.Summary
...
and Basic Web Application Attacks.Can you breach 
me now?Some people turn to the Retail sector 
...
industrys heavy use of payment data.Top actions
top vectorsWhen it comes down to how these 
...
or find a way to collect payment cards.Figure 60\. Top Action varieties for 
Retail breaches (n\=182\)51In laymans terms, it is when wizards race each other in go\-carts.2023 DBIR Industries63Stolen 
credentials: 
$5\. Domain 
hosting: $12\. 
Malicious 
...
$50\. Snagging 
all the fullz: 
priceless.Considering the function of this 
...
remain a popular target.This begs the question: Where is this 
...
Data Security Standard (DSS) 4\.0\.52Figure 61\. Top Action vectors in Retail 
breaches (n\=130\)Figure 62\. Payment card over time in Retail breaches52 https:www.pcisecuritystandards.orgresources\-overview2023 DBIR Industries64Small and
medium business Lets do 
some word 
problems!
 said no one ever (exceptmath teachers)In certain prior reports, we have 
...
that they are attacked.The tables on the right illustrate the fact 
...
and how they may overlap or differ.In past reports we have discussed the 
...
protective controls.Small businesses (less than
1,000 employees)FrequencyTop patternsThreat actors699 incidents,
381 with confirmed 
data disclosureSystem Intrusion, 
Social Engineering 
and Basic Web 
...
Grudge (1%) 
(breaches)Data 
compromisedCredentials (54%), 
Internal (37%),
Other (22%),
System (11%) 
(breaches)Table 3\. At a glance for SMBLarge businesses (more than
1,000 employees)FrequencyTop patternsThreat actors496 incidents,
227 with confirmed 
data disclosureSystem Intrusion, 
Social Engineering 
and Basic Web 
...
Convenience (1%), 
Fun (1%) (breaches)Data 
compromisedInternal (41%), 
Credentials (37%), 
Other (30%),
System (22%) 
(breaches)Table 4\. At a glance for large 
organizations53 Again, there is that refocusing thing we keep talking about.2023 DBIR Small and medium business65When you drill further into the Sub\-
...
to sleeping at night.Its not easy 
being small.Lets assume youre a startupa tiny 
...
who wears many hats and never sleeps.The first step is to see which controls 
...
them to various security standards thatControlDescriptionan organization may want to comply 
...
our scenario.You can see in Tables 3 and 4 that 
...
(89%), 11 (80%) and then 5 (67%).14115Security Awareness and Skills Training
...
and software.Table 5\. CIS Implementation Group 1 Controls for Incident Classification Patterns 
most commonly encountered by SMBs54 https:www.cisecurity.orgcontrolscis\-controls\-navigator
55 2022 DBIR, Appendix B: VERIS and Standards, p. 962023 DBIR Small and medium business66Midsize is
the right size.Youve been at this a while. Youre 
...
to the next level of protection.With that in mind, lets take a look at 
...
control is different for this pattern:Control 17 Incident ResponseManagement 
...
and quickly respond to an attack.An Incident Response Management 
...
quickly you can address them. You get a 
resource!
You get a 
resource! 
Everybody 
gets a 
resource!Now lets pivot to look at the larger 
...
ready for IG3 Controls.These Controls mature along with 
...
18 (100%) we have not yet discussed.Control 16 ApplicationSoftware Security 
...
impact the enterprise.Control 18 Penetration TestingTest the effectiveness and 
...
actions of an attacker.Control 16 is certainly timely, 
...
both of those cases.56 And this never really hurts, does it?2023 DBIR Small and medium business67Once an entity has reached the larger 
...
should be trusted.Now that youve already looked at the 
...
implementing a road map.A few final things to consider at this 
...
to steer your security strategy.From the Center for Internet Security:Report after report, and study 
...
you dont know you have.After understanding your 
...
financial information.Safeguards selected for IG1 should 
...
(COTS) hardware and software.But no matter the size or 
...
Defense Model v2\.057\).57 https:www.cisecurity.orginsightswhite\-paperscis\-community\-defense\-model\-2\-02023 DBIR Small and medium business685
RegionsRegions:
IntroductionThis edition of the DBIR marks the fourth year we have examined cybercrime 
...
significant section.We define the regions of the world in accordance with the United Nations M4958 
standards, which combines the super\-region and sub\-region of a country together. 
By so doing, the regions we will examine are as follows:APAC: Asia Pacific, including Southern Asia (034\), South\-eastern Asia (035\), 
Central Asia (143\), Eastern Asia (030\) and Oceania (009\)EMEA: Europe, Middle East and Africa, including Northern Africa (015\), Europe 
(150\) and Eastern Europe (151\), and Western Asia (145\)LAC: Latin America and the Caribbean, 
including South America (005\), Central 
America (013\) and Caribbean (029\)NA: Northern America (021\), including 
the United States and CanadaAs in previous years, we have sliced and 
...
the frequency, top patterns, etc.RegionFrequencyTop patternsThreat actorsActor motivesData compromisedAPAC699 incidents,
164 with confirmed 
data disclosureEMEA2,557 incidents,
637 with confirmed 
data disclosure535 incidents,
65 with confirmed
data disclosureSocial Engineering, 
System Intrusion and 
Basic Web Application 
Attacks represent 93% 
of breachesExternal (92%),
Internal (9%),
Partner (2%),
Multiple (2%) 
(breaches)Financial (61%), 
Espionage (39%), 
Convenience (2%), 
Grudge (2%), 
Secondary (1%) 
(breaches)System Intrusion, Social 
...
Espionage (8%), 
Ideology (1%),
Fun (1%) (breaches)System Intrusion, Social 
Engineering and Basic 
Web Application Attacks 
represent 94% of 
breachesExternal (95%),
...
Multiple (9%),
Partner (2%) 
(breaches)Financial (99%), 
Espionage (1%), 
Grudge (1%) 
(breaches)Table 6\. At a glance for regions58 https:unstats.un.orgunsdmethodologym492023 DBIR RegionsInternal (56%), 
Secrets (42%),
Other (33%), 
Credentials (29%) 
(breaches)Credentials (53%), 
Internal (37%), 
System (35%),
Other (15%) 
(breaches)System (55%), 
...
Personal (38%), 
Other (24%) 
(breaches)70It is readily apparent that the System 
...
(hint: were looking at you, MFA).Just feast your eyes on these lovely 
...
region as well as across regions.Hopefully this is illustrative of what 
...
information in this report.Figure 63\. Incidents and breaches by region2023 DBIR Regions716
Wrap\-upThis wraps up another year of
delving deep into data breaches 
to mine for useful nuggets
of information and analysis.As always, be well, be 
prosperous and be 
prepared for anything.60It is, as always, our hope that you found 
...
improve this report.59 OK, that might be a stretch. How about not the all\-around cure for insomnia?
60 Unofficial DBIR team motto, by the way2023 DBIR Wrap\-up73Year in reviewJanuaryFebruaryMarchThe VTRAC Intelligence Analysts experienced dj vu as we began 2022 tracking attacks exploiting 
...
patched a zero\-day vulnerability impacting iPhones and iPads.Collection and analysis of intelligence covering cyberattacks supporting Russias February 2022 invasion 
...
in bait themes in their malspam.Zero\-day exploitation of vulnerabilities in Chrome, Firefox, Trend Micro Apex Central and Mitel business 
...
claiming compromises at Microsoft, Okta, Nvidia and Samsung.61Now known as the Main Directorate of the General Staff of the Armed Forces of the RussianFederationhows that for a mouthful?2023 DBIR Wrap\-up74AprilMayJunePatch management teams were especially harried in April mitigating zero\-day vulnerabilities under 
...
Conti continued unabated.Vulnerabilities in infrastructure components began to emerge as a recurring theme in 2022\. In the 
...
execution vulnerability in the Microsoft Support Diagnostic Tool (MSDT).Days after the discovery of Folina, Atlassian announced patches for a zero\-day remote code 
...
to successfully exploit Log4j in unpatched VMware Horizon servers.2023 DBIR Wrap\-up75JulyAugustThe release of cyber intelligence reports usually precedes the Black Hat USA and DEF CON conferences. 
...
successfully exploiting one, CVE\-2022\-26138, since June.In addition to Folina a second zero\-day remote code vulnerability in the Microsoft Windows Support 
...
Oktapus TA.SeptemberSeptember was the zero\-day\-palooza month for 2022\. Two days into the new month, Google Chrome
...
and Windows servers.2023 DBIR Wrap\-up76OctoberMicrosoft did not patch ProxyNotShell in Octobers Patch Tuesday release, but they did release a patch 
...
and, separately, iOS and iPadOS.NovemberSeveral strains of malware highlighted InfoSec risk intelligence in November. Forty days after the initial 
...
Raspberry Robin worm evolved into initial access brokers for deploying other payloads.DecemberBreaking the string of end\-of\-year InfoSec milestones set in 2020 with SolarWinds Orion and in 2021 
...
to Bureau 121 in the Reconnaissance General Bureau (RGB), North Koreas military intelligence agency.Special thanks to Dave Kennedy of the Verizon Threat Research Advisory Center (VTRAC) for his 
continued support and yearly contribution to this report.2023 DBIR Wrap\-up777
...
corrections.Second, we check our work. The same 
...
disclaimerWe must reiterate that we make no 
...
compare it to that of others), bias exists.The DBIR 
...
to accomplish this:1\.Direct recording of paid externalforensic investigations and related 
intelligence operations conducted by 
Verizon using the VERIS Webapp2\.Direct recording by partnersusing VERIS3\.Converting partners existing schemainto VERISAll contributors received instruction to 
...
is collected and analyzed.62 https:github.comvz\-riskdbirtreegh\-pages
63 As does this sentence2023 DBIR Appendices79Incident dataOur data is non\-exclusively multinomial 
...
in our analysis and tooling.Another important point is that when 
...
of the other bars if found in a bar chart).Finally, Not Applicable, (normally 
NA), may be counted or not counted 
depending on the claim being analyzed.This year we have made liberal use 
...
30 samples.1\.Sample sizes smaller than five are toosmall to analyze.2\.We wont talk about count orpercentage for small samples. 
This goes for figures, too, and is 
why some figures lack the dot 
for the median frequency.3\.For small samples we may talk about 
...
eligibilityFor a potential entry to be eligible 
...
the baseline definition of securityincident, the entry is assessed 
for quality. We create a subset of 
incidents (more on subsets later) that 
pass our quality filter. The details 
of what is a quality incident are:The incident must have at least sevenenumerations (e.g threat actor 
...
less than seven enumerations.The incident must have at least one 
...
would not be included in this report.Lastly, for something to be eligible
for inclusion into the DBIR, we have
to know about it, which brings us
to several potential biases we will 
discuss below.2023 DBIR Appendices80Acknowledgement and
...
this process introduces bias.BreachesBreachesFigure 64\. Individual contributors
per ActionFigure 65\. Individual contributors 
per ActorBreachesBreachesFigure 66\. Individual contributors
per AssetFigure 67\. Individual contributors
...
total incidents along those axes.2023 DBIR Appendices81Youll notice rather large contributions 
...
the specific areas ahead of release.Non\-incident 
...
of the data.Data subsetsWe already mentioned the subset 
...
six years as well.Finally, we create some subsets to 
...
aforementioned two subsets.64 A unique finding is more likely to be something mundane, such as a data collection issue,than an unexpected result.2023 DBIR Appendices82Appendix B:
VERIS mappings to 
MITRE ATT\&CKWhen it comes to sailing the stormy 
...
cyber mariners.Over the years, new guiding frameworks 
...
benefits of both in their navigation.The results of that work are remarkable: 
...
were leveraged.This combination of forces is timely due 
...
to fruition.The second version of this mapping 
...
ATT\&CK for ICS.If this interests you at all, please hop over 
...
journey to full control coverage.Our team puts a lot of thought and 
...
with the DBIR team at dbir@verizon.com.65 https:verisframework.org 
...
69 How dare you?2023 DBIR Appendices83Appendix C:
VTRAC 20\-year 
retrospectiveBy Chris Novak, 
Managing Director
Cyber Security Consulting 
VerizonIts hard to believe that the Verizon 
...
or should I say the zero\-day?Over those 20 years, weve had a few 
...
fill a single full\-height server rack.It bears reminding that, 20 years ago, 
...
but also masters degrees and Ph.D.s.I can still remember some of the first 
...
the trips to Vegas Today, we rarely need to travel. We 
...
infrastructure outages.The then and now comparisons over 
...
locations. The VTRAC supportsorganizations across more than 100 
...
sovereignty concern.Of course, I cannot forget to mention the 
...
DBIRs college tuition.70I couldnt be prouder of what the past and 
...
rating as a leader by industry analysts.I look forward to the adventures, 
innovation and excitement to come
in our next 20 years!Happy 20th birthday, VTRAC!Chris Novak70Editors note: We hope the DBIR is actually helping you pay for tuition for your human children.2023 DBIR Appendices84Appendix D: 
Contributing 
organizationsAAkamai TechnologiesAnkuraApura Cyber IntelligenceBBit\-x\-bitBitSightBlackBerryCCensys, Inc.CrowdStrikeFCybersecurity and Infrastructure 
Security Agency (CISA)CyberSecurity Malaysia, an agency 
under the Ministry of Communications 
and Multimedia (KKMM)CybersixgillCYBIRDDellDepartment of Government Services, 
Victorian State Government, AustraliaCenter for Internet SecurityDomainToolsCequence SecurityCERT Division of Carnegie Mellon 
Universitys Software Engineering 
InstituteEEnergy Analytic Security Exchange 
(EASE)CERT European UnionCERT PolskaCheck Point Software
Technologies Ltd.ChubbCoalitionComputer Incident Response Center 
Luxembourg (CIRCL)CovewareEdgescanElevate SecurityEmergence InsuranceEUROCONTROLEvidenFederal Bureau of Investigation 
Internet Crime Complaint Center
(FBI IC3\)FortinetGGlobal Resilience FederationGreyNoiseHHackEDUIIrish Reporting and Information Security 
Service (IRISS\-CERT)IvantiJJPCERTCCKK\-12 Security Information Exchange 
(K\-12 SIX)KasperskyKordaMentha2023 DBIR Appendices85LLegal Services Information Sharing and 
Analysis Organization (LS\-ISAO)MMalicious StreamsMaritime Transportation System ISAC 
(MTS\-ISAC)mnemonicNNetDiligenceNETSCOUTOOktaOpenText CybersecurityPPalo Alto NetworksProofpointSS21secSecurityTrails, a Recorded
Future CompanyShadowserver FoundationSISAP Sistemas AplicativosShodanSwisscomUU.S. Secret ServiceVVERIS Community DatabaseVerizon Cyber Risk ProgramsVerizon Cyber Security ConsultingVerizon DDoS DefenseVerizon Network Operations 
and EngineeringVerizon Threat Research Advisory 
Center (VTRAC)Vestige Digital InvestigationsWWatchGuard Technologies, Inc.2023 DBIR Appendices862023 DBIR Appendices87Verizon Cyber 
...
Research Advisory 
Center (VTRAC)2023 DBIR Appendices88 2023 Verizon.OGWP1950623