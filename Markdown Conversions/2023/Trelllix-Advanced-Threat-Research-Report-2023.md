...
## Table of Contents
- [Authored by Trellix’s Advanced Research Center](#authored-by-trellixs-advanced-research-center)
- [UNDERSTANDING THE RISKS, THREATS, AND VULNERABILITIES ATTACKERS ARE TARGETING – AND ACTIVELY HUNTING THEM](#understanding-the-risks-threats-and-vulnerabilities-attackers-are-targeting--and-actively-hunting-them)
...
*   **Outdated Technology**: Many organizations
    ...
    their entity from cyber threats.³
...
*   **Insufficient Resources**: With limited SecOps
    ...
    analyst tenure? Approximately two years.⁶
...
as cURL to access remote payloads, or Rclone to exfiltrate data to
cloud storage.
...
### TOP RANSOMWARE USED IN Q1 2023
...
landscape, particularly with Mustang Panda driving a significant majority
of detections in Q1 2023. Since they rely heavily on sideloading
