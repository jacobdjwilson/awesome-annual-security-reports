...
- [Shifting Focus and Uncommon Techniques Brought Threat Actors Success in 2022](#shifting-focus-and-uncommon-techniques-brought-threat-actors-success-in-2022)
  - [Initial Intrusions](#initial-intrusions)
...
![Detection by Source, 2011-2022 graph](placeholder_for_image_1)
...
![Detection by Source by Region, 2022 graphs for Americas, APAC, EMEA](placeholder_for_image_2)

### Detection by Source by Region, 2017–2022

![Detection by Source by Region, 2017-2022 graphs for Americas, APAC, EMEA](placeholder_for_image_3)
...
![Detection by Source, by Investigation Type, 2022 graph](placeholder_for_image_4)
...
![Change in Median Dwell Time graph](placeholder_for_image_5)
...
![Global Median Dwell Time, 2011-2022 graph](placeholder_for_image_6)
...
![Global Dwell Time Distribution, 2018-2022 graph](placeholder_for_image_7)

#### Change in Global Investigations Involving Ransomware

![Change in Global Investigations Involving Ransomware graph](placeholder_for_image_8)

#### Change in Global Median Dwell Time – Ransomware

![Change in Global Median Dwell Time – Ransomware graph](placeholder_for_image_9)

#### Change in Global Median Dwell Time—Non-Ransomware

![Change in Global Median Dwell Time—Non-Ransomware graph](placeholder_for_image_10)

#### Global Median Dwell Time by Detection Source

![Global Median Dwell Time by Detection Source graph](placeholder_for_image_11)
...
![Global Dwell Time by Investigation Type, 2022 graph](placeholder_for_image_12)

### Americas

#### Change in Americas Median Dwell Time

![Change in Americas Median Dwell Time graph](placeholder_for_image_13)
...
![Americas Median Dwell Time, 2016-2022 graph](placeholder_for_image_14)
...
![Americas Dwell Time Distribution, 2021-2022 graph](placeholder_for_image_15)

#### Change in Americas Investigations Involving Ransomware

![Change in Americas Investigations Involving Ransomware graph](placeholder_for_image_16)

#### Change in Americas Median Dwell Time – Ransomware

![Change in Americas Median Dwell Time – Ransomware graph](placeholder_for_image_17)

#### Change in Americas Median Dwell Time – Non-Ransomware

![Change in Americas Median Dwell Time – Non-Ransomware graph](placeholder_for_image_18)

#### Americas Median Dwell Time by Detection Source

![Americas Median Dwell Time by Detection Source graph](placeholder_for_image_19)
...
![Americas Dwell Time Investigation by Type, 2022 graph](placeholder_for_image_20)

### APAC

#### Change in APAC Median Dwell Time

![Change in APAC Median Dwell Time graph](placeholder_for_image_21)
...
![APAC Median Dwell Time, 2016-2022 graph](placeholder_for_image_22)
...
![APAC Dwell Time Distribution, 2021-2022 graph](placeholder_for_image_23)

#### Change in APAC Investigations Involving Ransomware

![Change in APAC Investigations Involving Ransomware graph](placeholder_for_image_24)

#### Change in APAC Median Dwell Time – Ransomware

![Change in APAC Median Dwell Time – Ransomware graph](placeholder_for_image_25)

#### Change in APAC Median Dwell Time – Non-Ransomware

![Change in APAC Median Dwell Time – Non-Ransomware graph](placeholder_for_image_26)

#### APAC Median Dwell Time by Detection Source

![APAC Median Dwell Time by Detection Source graph](placeholder_for_image_27)
...
![APAC Dwell Time by Investigation Type, 2022 graph](placeholder_for_image_28)

### EMEA

#### Change in EMEA Median Dwell Time

![Change in EMEA Median Dwell Time graph](placeholder_for_image_29)
...
![EMEA Median Dwell Time, 2016-2022 graph](placeholder_for_image_30)
...
![EMEA Dwell Time Distribution, 2021-2022 graph](placeholder_for_image_31)

#### Change in EMEA Investigations Involving Ransomware

![Change in EMEA Investigations Involving Ransomware graph](placeholder_for_image_32)

#### Change in EMEA Median Dwell Time – Ransomware

![Change in EMEA Median Dwell Time – Ransomware graph](placeholder_for_image_33)

#### Change in EMEA Median Dwell Time – Non-Ransomware

![Change in EMEA Median Dwell Time – Non-Ransomware graph](placeholder_for_image_34)

#### EMEA Median Dwell Time by Detection Source

![EMEA Median Dwell Time by Detection Source graph](placeholder_for_image_35)
...
![EMEA Dwell Time Investigation by Type, 2022 graph](placeholder_for_image_36)
...
![Global Industries Targeted, 2022 graph](placeholder_for_image_37)
...
![Initial Infection Vector (when identified) graph](placeholder_for_image_38)
...
![Most Prevalent Initial Intrusion Vector by Region graphs for EMEA, Americas, APAC](placeholder_for_image_39)
...
![Financial Gain, 2020-2022 graph](placeholder_for_image_40)
...
![Data Theft Observed, 2020-2022 graph](placeholder_for_image_41)
...
![Compromised Architecture graph](placeholder_for_image_42)
...
Across all investigations where a vulnerability was targeted, abuse of the Log4j1 vulnerability represented 16% of investigations. The second and third most notable vulnerabilities identified were related to F5 Big-IP2 and VMware Workspace ONE Access and Identity Manager3.

![Exploit Activity When Identified graph](placeholder_for_image_43)
...
![Multiple Threat Groups Identified graph](placeholder_for_image_44)

### Threat Groups

![Threat Groups 2022 infographic](placeholder_for_image_45)

Mandiant tracks more than 3500 threat groups, including 900+ newly tracked threat groups in this M-Trends reporting period. Of the newly tracked groups, 265 threat groups were first identified during Mandiant investigations in 2022. Mandiant identified a total of 343 unique threat groups across all intrusions in 2022. Organizations faced intrusions by four named Advanced Persistent Threat (APT) groups. This includes government sponsored groups from China and Russia, five named financially motivated threat (FIN) groups, and 335 uncategorized threat (UNC) groups. Overall, organizations are still facing and responding to well-established threat groups while also contending with newly attributed groups.
...
![Observed Threat Groups by Goal, 2022 graph](placeholder_for_image_46)
...
![Observed Threat Groups by Goal, 2022 graph](placeholder_for_image_47)
...
In 2022, Mandiant began tracking 588 new malware families to increase its knowledge base of malware. Compared to the 700+ newly tracked malware reported in the reporting period for M-Trends 2022 which