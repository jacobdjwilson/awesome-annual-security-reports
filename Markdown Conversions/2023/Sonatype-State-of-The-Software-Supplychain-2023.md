...
- _“More mature software supply chain management equate to more job satisfaction.”_
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 2
...
1. Figure estimated using npm download counts from January to August 2022[^1]  
2. YoY growth estimated based on known PyPI downloads from January to August 2022[^2]  
3. YoY growth estimated based on known NuGet Gallery downloads from January to August 2022[^3]  
*( * the .Net ecosystem shrank in 2022)*

SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 4
...
**Java (Maven)**
- 675 billion packages project requests volume.
- 36% YoY growth.
...
A type of attack that leverages a popular component as a vector for the malicious payload. It relies on an adversary gaining access to the source code of a library either through compromise or pretending to be a benevolent open source committer.
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 7
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 9
...
Sitting in the reactive zone is not only suboptimal, but it puts you at an immediate disadvantage and penalizes those development teams when an issue arises. (Fig. 3.2)

SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 12

Open source consumers are proliferating the majority of open source risk. We can’t solve the issue of open source security without consumers changing their behaviors. (Fig. 3.3)
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 13
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 14
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 15
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 16
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 18

There is still room for improvement in terms of software supply chain maturity. (Fig. 4.1)

Across the various themes, we see that the majority of respondents were graded less than the “4 - Control” level of maturity. The “Control” level of maturity is when an organization transitions from “figuring it out” to a minimal level of maturity that will enable high-quality outcomes. (Fig. 4.2)
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 19
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 20

SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 21

---

## Section 5: Establishment and Expansion of Software Supply Chain Regulation and Standards

A global update on what’s happened about software supply chain regulation and standards since the last report.
...
#### April 2022
- The Food and Drug Administration (FDA) sought comment on medical device cybersecurity in “Cybersecurity in Medical Devices: Quality System Considerations and Content of Premarket Submissions.”
...
- SBOMs are evolving. The Department of Homeland Security (DHS) Cybersecurity and Infrastructure Security Agency (CISA) has continued to evolve and refine the concept of an SBOM.
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 24

### What’s Happening in Canada?

#### June 2022
- The Canadian government completed the first reading of Bill C-26, titled “An Act respecting cyber security, amending the Telecommunications Act and making consequential amendments to other Acts.”
...
- Data shows that software supply chain integrity is a concern across the broader Canadian business community.
- In its “2022 Canadian Digital Trust Insights” survey, PwC reported that 54% of Canadian respondents expect a reportable increase in 2022 from attacks on the software supply chain. But only 44% say they thoroughly understand their third-party cyber and privacy risks.
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 25
...
#### May 2022
- Japan passed “Act on Promotion of Economic Security by Integrated Implementation of Economic Measures,” landmark national security legislation.
...
SONATYPE’S 8TH ANNUAL STATE OF THE SOFTWARE SUPPLY CHAIN | 26
...
**Headquarters**: 8161 Maple Lawn Blvd, Suite 250 Fulton, MD 20759 USA • 1.877.866.2836  
**APAC Office**: 60 Martin Place, Level 1 Sydney 2000, NSW Australia  
**European Office**: 168 Shoreditch High St, 5th Fl London E1 6JE United Kingdom
