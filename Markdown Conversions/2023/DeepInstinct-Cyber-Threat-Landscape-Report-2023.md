...
*   MALAS RANSOMWARE - ZIMBRA VULNERABILITY
*   CLOP RANSOMWARE - MOVEIT VULNERABILITY
*   8BASE RANSOMWARE CAMPAIGN
*   ALPHV - BLACKCAT
*   VICE SOCIETY AND HIVE
*   LOCKBIT2
*   ROYAL AND CUBA RANSOMWARE
*   LOCKBIT3

![Graph showing ransomware victims during 2022 and 2023, with spikes in 2023 exceeding 2022 totals.](Figure 1: Ransomware Victims During 2022 and 2023)
...
![Bar chart comparing the number of ransomware victims in 2022 H1, 2022 H2, 2022 Full Year, and 2023 H1. 2023 H1 shows a significant increase.](Figure 2: Number of Ransomware Victims in 2022 vs 2023)

MID-YEAR REPORT 2023 | 5

### Ransomware threat actors: 2023 H1

![Bar chart showing ransomware victims by threat group during 2023 H1, with Lockbit3, ALPHV, and Cl0p being the most prominent.](Figure 3: Ransomware Victims by Threat Group During 2023)
...
![Image of a tweet from a Clop ransomware member.](Figure 4: Clop Ransomware Member Tweeted “Let’s Go!” After the FBI Identified Him as Wanted Following Several Major Campaigns in the US.)

![Image showing Clop ransomware using torrents to leak data.](Figure 5: Clop Using Torrents to Leak Data)
...
![Bar chart showing top threat groups in 2022 H2, with Lockbit3, Conti, and Hive being the most prominent.](Figure 6: Top Threat Groups in 2022 H2)
...
![Pie chart showing the distribution of banking trojans/stealers/spyware, with Emotet, Agent Tesla, and NanoCore being the largest segments.](Figure 7: Banking Trojans/Stealers/Spyware)
...
![Line graph showing the trend of JS, PowerShell, and LNK file usage by threat actors from June 2022 to August 2023.](Figure 8: Threat Actors 2022 H2/2023 H1)
...
![Line graph showing the trend of artificially inflated files in zip trends from June 2022 to August 2023.](Figure 9: Artificial Inflated Files in Zip Trends 2022 H2/2023 H1)
...
![Line graph showing the number of vulnerabilities exploited in the wild from July 2022 to August 2023.](Figure 10: Vulnerabilities Exploited in the Wild)
...
![Image of WormGPT pricing and subscription options.](Figure 11: WormGPT)
