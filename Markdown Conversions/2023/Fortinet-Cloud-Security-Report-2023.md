...
- [Current State of Cloud Adoption](#current-state-of-cloud-adoption)
  - [WORKLOADS IN THE CLOUD](#workloads-in-the-cloud)
  - [MULTI-CLOUD ADOPTION](#multi-cloud-adoption)
  - [PREFERRED CLOUD PROVIDERS](#preferred-cloud-providers)
  - [CLOUD SERVICES PRIORITIES](#cloud-services-priorities)
  - [BARRIERS TO CLOUD ADOPTION](#barriers-to-cloud-adoption)
- [Benefits of the Cloud](#benefits-of-the-cloud)
  - [KEY CLOUD BENEFITS](#key-cloud-benefits)
  - [CLOUD BUSINESS OUTCOMES](#cloud-business-outcomes)
- [Security Challenges in the Cloud](#security-challenges-in-the-cloud)
  ...
  - [RISK OF A BREACH](#risk-of-a-breach)
...
- [Key Priorities for Cloud Security](#key-priorities-for-cloud-security)
  ...
  - [KEY DRIVERS FOR CLOUD-BASED SECURITY](#key-drivers-for-cloud-based-security)
  - [SINGLE CLOUD SECURITY PLATFORM](#single-cloud-security-platform)
- [METHODOLOGY & DEMOGRAPHICS](#methodology--demographics)
  - [CA R EER LE V EL](#ca-r-eer-le-v-el)
  - [D EPA RTM ENT](#d-epa-rtm-ent)
  - [CO M PA N Y S IZE](#co-m-pa-n-y-s-ize)
  - [I N DUSTRY](#i-n-du-str-y)
  - [S ECU R IT Y C ERTI FI CATI O N S H ELD](#s-ecu-r-it-y-c-erti-fi-cati-o-n-s-h-eld)
- [Fortinet](#fortinet)
- [Cybersecurity Insiders](#cybersecurity-insiders)
...
![Chart showing current and projected percentage of workloads in the cloud, with 39% currently having more than 50% in the cloud, and 58% planning to reach this level in the next 12-18 months.]
...
![Bar chart showing the number of cloud providers organizations currently use, with 69% using two or more.]
...
![Bar chart comparing current and future use of cloud IaaS providers, with Microsoft Azure (72%) and Amazon Web Services (67%) dominating current use, and Google Cloud Platform (+21%) and Oracle Cloud (+20%) showing highest future adoption.]
...
![Bar chart showing cloud services and workloads organizations are deploying, with Security (56%) as the top workload, followed by Compute (54%) and Storage (52%).]

What services and workloads is your organization deploying in the cloud?

56%
Security
(identity management, access control, data protection, etc.)
...
(CRM, marketing automation, ERP, BI, etc.)

Productivity applications (email, collaboration, instant messaging, etc.) 50% | Virtualization 49% | Database (relational, NoSQL, caching, etc.)
46% | IT operations applications (administration, backup, provisioning, monitoring, etc.) 45% | Developer/testing applications 40% |
...
Middleware 22% | Runtime 14% | Don’t know/other 6%
...
![Bar chart showing the biggest barriers to cloud adoption, with lack of qualified staff (37%) as the top impediment, followed by legal and regulatory compliance (30%) and data security issues (29%).]
...
Fear of vendor lock-in 24% | General security risks 23% | Lack of budget 22% | Cost/lack of ROI 21% | Internal resistance and inertia 20% |
...
Lack of maturity of cloud service models 13% | Lack of management buy-in 13% | Dissatisfaction with cloud service offerings/performance/
...
![Bar chart showing overall benefits realized from cloud deployment, with more flexible capacity/scalability (53%) as the top benefit, followed by increased agility (45%) and improved availability and business continuity (44%).]
...
Improved performance 36% | Accelerated time to market 34% | Moved expenses from fixed CapEx (purchase) to variable OpEx (rental/
subscription) 34% | Reduced cost 32% | Improved security 32% | Increased geographic reach 27% | Increased employee productivity 25%
Reduced complexity 23% | Improved regulatory compliance 22% | Not sure/other 12%
...
![Bar chart showing business outcomes realized from moving to the cloud, with increased responsiveness to customer needs (52%) as the top outcome, followed by accelerated time to market (48%) and decreased risk and improved security (42%).]
...
Expanded market reach to new markets 23% | Accelerated revenue growth in existing markets 22% | Achieved parity with competitors 22% |
Other 7%
...
![Bar chart showing concern levels about public cloud security, with 95% of organizations moderately to extremely concerned, and 35% extremely concerned.]
...
![Bar chart showing perception of security breach risk in public cloud vs. on-premises, with 43% saying public cloud risk is somewhat to significantly higher than on-premises.]
...
![Bar chart showing biggest operational headaches in protecting cloud workloads, with lack of qualified staff (43%) and compliance (37%) at the top.]
...
Controls and automation 30% | Can’t identify misconfigurations quickly 29% | Automatically enforcing security across multiple clouds 29% |
Complex cloud to cloud/cloud to on-premises security rule matching 25% | Securing traffic flows 25% | Securing access from personal and
mobile devices 25% | Security can’t keep up with the pace of changes to new/existing applications 25% | Lack of integration with on-premises
...
Understanding network traffic patterns 23% | No automatic discovery/visibility/control to infrastructure security 22% | Reporting security threats
21% | Lack of feature parity with on-premises security solution 21% | No flexibility 6% | Not sure/other 10%
...
![Bar chart showing biggest challenges in securing multi-cloud environments, with having the right skills (58%) and ensuring data protection and privacy (52%) as leading concerns.]
...
Keeping up with the rate of change 38% | Managing the costs of different solutions 37% | Providing seamless access to users based on their
credentials 37% | Selecting the right set of services 36% | Other 3%
...
![Bar chart showing biggest security threats in public clouds, with misconfiguration (59%) as the top threat, followed by exfiltration of sensitive data (51%) and insecure interfaces/APIs (51%).]
...
Hijacking of accounts, services, or traffic 45% | External sharing of data 39% | Malicious insiders 38% | Malware/ransomware 37% |
Foreign state-sponsored cyberattacks 37% | Denial of service attacks 31% | Cloud cryptojacking 21% | Theft of service 20% |
Lost mobile devices 13% | Don’t know/other 7%
...
![Chart showing cloud security budget changes, with 60% of organizations expecting an increase, and the average increase being 33%.]
...
![Bar chart showing cloud security priorities, with preventing cloud misconfigurations (51%) and securing major cloud apps (48%) as top priorities.]
...
Cloud security training 12% | Securing mobile devices 7% | Discovering unsanctioned cloud apps in use 7% | Securing BYOD
(bring your own device) 5% | Securing less popular cloud apps already in use 4%
...
![Bar chart showing main drivers for considering cloud-based security solutions, with better scalability (56%) and faster time to deployment (48%) as leading factors.]
...
Better visibility into user activity and system behavior 38% | Better uptime 36% | Easier policy management 35% | Meet cloud compliance
expectations 35% | Better performance 35% | Need for secure app access from any location 34% | Our data/workloads reside in the cloud
(or are moving to the cloud) 30% | Reduction of appliance footprint in branch offices 29% | Other 3%
...
![Bar chart showing the perceived helpfulness of a single cloud security platform, with 90% of professionals considering it moderately to extremely helpful.]
...
Not at all helpful
Extremely helpful
Not at all/not sure Slightly Moderately Very Extremely
...
![Demographic breakdown charts showing survey respondents by career level, department, company size, industry, and security certifications held.]
