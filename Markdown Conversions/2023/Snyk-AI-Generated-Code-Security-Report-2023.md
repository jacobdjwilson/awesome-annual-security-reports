# SNYK REPORT: AI Code, Security, and Trust: Organizations Must Change Their Approach

## Table of Contents
- [AI Code, Security, and Trust: Organizations Must Change Their Approach](#ai-code-security-and-trust-organizations-must-change-their-approach)
...
- [How would you rate the security of ai code fix suggestions?](#how-would-you-rate-the-security-of-ai-code-fix-suggestions)
- [HOW FREQUENTLY DO YOU ENCOUNTER ISSUES DUE TO CODE SUGGESTED BY AN AI TOOL?](#how-frequently-do-you-encounter-issues-due-to-code-suggested-by-an-ai-tool)
- [What percentage of your security scanning is automated?](#what-percentage-of-your-security-scanning-is-automated)
- [how often do developers in your organization bypass security policies in order to use ai code completion tools?](#how-often-do-developers-in-your-organization-bypass-security-policies-in-to-use-ai-code-completion-tools)
- [DO YOU USE AI CODE COMPLETION TOOLS FOR WORK ON OPEN SOURCE PROJECTS?](#do-you-use-ai-code-completion-tools-for-work-on-open-source-projects)
- [how do you verify the security of open source packages and libraries included in ai-generated code suggestions?](#how-do-you-verify-the-security-of-open-source-packages-and-libraries-included-in-ai-generated-code-suggestions)
- [does your organization consider ai code completion to be part of its software supply chain?](#does-your-organization-consider-ai-code-completion-to-be-part-of-its-software-supply-chain)
- [how has your organization changeD your software security practices as a result of ai code completion?](#how-has-your-organization-changed-your-software-security-practices-as-a-result-of-ai-code-completion)
- [Are Concerned About AI Security, Indicating Cognitive Dissonance](#are-concerned-about-ai-security-indicating-cognitive-dissonance)
- [Developers Recognize Risks of AI Blindness, Reliance](#developers-recognize-risks-of-ai-blindness-reliance)
- [How concerned are you that developers are relying too much on ai code completion tools?](#how-concerned-are-you-that-developers-are-relying-too-much-on-ai-code-completion-tools)
...
- [is your appsec or security team struggling to adapt to the speed of development due to ai code completion?](#is-your-appsec-or-security-team-struggling-to-adapt-to-the-speed-of-development-due-to-ai-code-completion)
- [About this report](#about-this-report)

---

The official report URL is: https://view.snyk.io/the-state-of-open-source-report-2024/p/1
...
![Bar chart showing the percentage of code submissions that are secure, comparing code using AI versus code not using AI, across different categories like Encryption & Decryption, Signing a Message, Sandboxed Directory, and SQL.](https://i.imgur.com/example.png)
*Percentage of code submissions with secure answers, comparing AI usage.*

## AI Code, Security, and Trust: Organizations Must Change Their Approach
### PART ONE

![Pie chart showing the breakdown of how frequently users encounter issues due to code suggested by an AI tool.](https://i.imgur.com/example.png)
*How frequently do you encounter issues due to code suggested by an AI tool?*

![Pie chart showing how users rate the security of AI code fix suggestions.](https://i.imgur.com/example.png)
*How would you rate the security of AI code fix suggestions?*

### Developers commonly found security issues with AI suggestions but...
...
![Bar chart showing the percentage of security scanning that is automated.](https://i.imgur.com/example.png)
*What percentage of your security scanning is automated?*

![Bar chart showing how often developers bypass security policies to use AI code completion tools.](https://i.imgur.com/example.png)
...
![Bar chart showing the percentage of respondents who use AI code completion tools for work on open source projects.](https://i.imgur.com/example.png)
...
![Bar chart showing how users verify the security of open source packages and libraries included in AI-generated code suggestions.](https://i.imgur.com/example.png)
*How do you verify the security of open source packages and libraries included in AI-generated code suggestions?*

![Bar chart showing the percentage of respondents whose organizations consider AI code completion to be part of their software supply chain.](https://i.imgur.com/example.png)
...
![Bar chart showing how organizations have changed their software security practices as a result of AI code completion.](https://i.imgur.com/example.png)
...
![Bar chart showing how concerned users are about the broader security implications of using AI code completion tools.](https://i.imgur.com/example.png)
*How concerned are you about the broader security implications of using AI code completion tools?*

![Bar chart showing how concerned users are that developers are relying too much on AI code completion tools.](https://i.imgur.com/example.png)
...
![Bar chart showing the reasons for restrictions on AI coding tools in organizations.](https://i.imgur.com/example.png)
...
![Bar chart showing whether AppSec or security teams are struggling to adapt to the speed of development due to AI code completion.](https://i.imgur.com/example.png)
