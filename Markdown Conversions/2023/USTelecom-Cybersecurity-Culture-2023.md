# 2023 USTELECOM CYBERSECURITY CULTURE REPORT
...
[Methodology and Analytical Framework](#methodology-and-analytical-framework)
[Introduction](#introduction)
[SECTION 1: Cybersecurity Culture by Critical Infrastructure Sector](#section-1-cybersecurity-culture-by-critical-infrastructure-sector)
[SECTION 2: Cybersecurity Culture by Organizational Size](#section-2-cybersecurity-culture-by-organizational-size)
[SECTION 3: Segmentation Analysis of Cybersecurity Culture](#section-3-segmentation-analysis-of-cybersecurity-culture)
...
*   Cybersecurity culture is a reliable predictor of confidence and preparedness. The data and supplemental analyses indicate that cybersecurity culture is a driving force in defending against cyberattacks. As strength and maturity of cybersecurity culture increases, so does preparedness. Of note, the frequency of cybersecurity-related communication is significantly higher among respondents with a Mature cybersecurity culture. This insight reinforces the notion that increased communication related to cybersecurity will foster confidence, transparency and truth telling, which leads to a stronger and more mature cybersecurity culture. Higher confidence directly translates to employees knowing what to do when faced with a cyberattack and departments being capable of working together.
...
S
ome 374 respondents from small and medium-sized enterprises assessed 27 statements exploring five dimensions of their organization’s cybersecurity culture: employee, management, organization, company and training. See Appendix A for full survey. Researchers used the responses to create average scores for each dimension and an overall composite score. Segmentation analysis then produced a cybersecurity culture index divided into four segments: Mature, Growing, Emerging and Weak. See Appendix B for details.

**SAMPLE BREAKDOWN**

*   **Percentage of Respondents by Critical Infrastructure Sector**
    *   A pie chart shows the distribution of respondents across various sectors:
        *   FOOD & AGRICULTURE: 6.4%
        *   ENERGY: 3.5%
        *   HEALTHCARE: 5.3%
        *   CRITICAL MANUFACTURING: 7.2%
        *   OTHER*: 26.2%
        *   TELECOM: 17.4%
...
*   **Percentage of Respondents by Organizational Size**
    *   A bar chart shows the distribution of respondents by the number of employees:
        *   1-50: 39%
        *   51-100: 21%
        *   101-500: 36%
        *   501-1000: 4%
*   **Percentage of Respondents by Revenue**
    *   A bar chart shows the distribution of respondents by annual revenue (in millions of USD):
        *   <1: 18%
        *   1-5: 21%
        *   6-10: 23%
        *   11-20: 16%
...
C
ybersecurity culture refers to the attitudes and beliefs of people within an enterprise regarding cybersecurity and how these attitudes and beliefs manifest themselves in the behavior of employees. Cybersecurity culture is an important component of an enterprise’s organizational culture, as it creates a sense of accountability in employees at all levels to ensure their enterprise is secure.
...
I
n the first section of our findings, we look at how the critical infrastructure sector an organization belongs to can affect cybersecurity culture and practices. Respondents were asked to provide the critical infrastructure that best described the company where they worked.  
...
*   **Figure 1:** A bar chart titled "Cybersecurity Culture by Critical Infrastructure Sector" shows the composite score for each sector. The y-axis ranges from 3.5 to 4.4. The x-axis labels are: Food/Agr, IT, Telecom, FinServ, Energy, CritMan, Healthcare. The values are as follows:
    *   Food/Agr: 3.7
    *   IT: 4.3
    *   Telecom: 4.12
    *   FinServ: 4.1
...
*   **Figure 2:** A table titled "Cybersecurity Culture by Organizational Size" shows the percentage of respondents who agree with various statements, broken down by company size. The columns are labeled 1-50, 51-100, 101-500, and 501-1000. The rows are:
...
*   **Figure 3:** A table titled "Cybersecurity Culture Practices by Organizational Size" shows the percentage of respondents who agree that their enterprise performs certain practices, broken down by company size. The columns are labeled 1-50, 51-100, 101-500, and 501-1000. The rows are:
...
*   **Figure 4:** A pie chart titled "Cybersecurity Culture Segments" shows the distribution of respondents across the four segments:
    *   MATURE: 28.1%
    *   GROWING: 14.7%
    *   EMERGING: 26.5%
    *   WEAK: 30.7%

*   **Figure 5:** A bar chart titled "Cybersecurity Culture Segment by Confidence" shows the average confidence defending against attacks for each segment. The y-axis ranges from 2.5 to 4.5. The x-axis labels are: Weak, Emerging, Growing, Mature. The values are as follows:
    *   Weak: 3.1
    *   Emerging: 4.06
    *   Growing: 4.09
    *   Mature: 4.25
...
*   **Figure 6:** A stacked bar chart titled "Cybersecurity Culture Segment by Revenue" shows the distribution of revenue within each cybersecurity culture segment. The x-axis labels are: Mature, Growing, Emerging, Weak. Each bar is divided into six segments representing revenue ranges:
    *   < 1 MIL
    *   1 - 5 MIL
    *   6 - 10 MIL
    *   11 - 20 MIL
...
*   **Figure 7:** A bar chart titled "Cybersecurity Culture Segment by Budget" shows the total budget for maintaining cybersecurity for each segment. The y-axis ranges from $0 to $700,000. The x-axis labels are: Weak, Emerging, Growing, Mature. The values are as follows:
    *   Weak: $37,183
    *   Emerging: $169,567
    *   Growing: $641,944
    *   Mature: $239,157
...
*   **Figure 8:** A table titled "Cybersecurity Culture Segment by Spending Factors" shows the percentage of respondents in each segment who indicated that various factors influence their cybersecurity spending. The columns are labeled MATURE, GROWING, EMERGING, and WEAK. The rows are:
...
T
he findings in this report demonstrate the importance of cybersecurity culture in small and medium-sized enterprises. After analyzing several variables, we were able to see which factors have the largest influence on the strength of an enterprise’s cybersecurity culture. Both the critical infrastructure sector an enterprise belongs to, as well as the organizational size of an enterprise, were shown to have a significant impact on the strength of a cybersecurity culture. 
...
*   **Figure 9:** A table titled "Cybersecurity Culture Segment Characteristics" shows the composite scores for each dimension within each segment. The columns are labeled MATURE, GROWING, EMERGING, and WEAK. The rows are:
...
## ENDNOTES
<sup>1</sup> Widup, S., Pinto, A., Hylender, D., Bassett, G. & Langlois, P. (2021). 2021 Verizon Data Breach Investigations Report. Verizon. https://www.verizon.com/business/resources/reports/dbir/
<sup>2</sup> Widup, S., Pinto, A., Hylender, D., Bassett, G. & Langlois, P. (2021). 2021 Verizon Data Breach Investigations Report. Verizon. https://www.verizon.com/business/resources/reports/dbir/
