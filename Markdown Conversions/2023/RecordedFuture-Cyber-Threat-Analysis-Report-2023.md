# Cyber-Threat-Analysis-Report 2023
...
**THREAT ANALYSIS By Insikt Group®**
March 21, 2024
2023 Annual Report
...
In 2023, threat groups successfully exploited several vulnerabilities at scale in singular third-party tools (GoAnywhere, MOVEit, and Citrix NetScaler devices) to inflict widespread damage on thousands of organizations.
...
#### Third-Party Threats
In 2023, Insikt Group identified an 11.8% increase in reported software supply-chain attacks. PyPI and npm package managers retained the top spots as the most frequently targeted technologies.
...
The year 2023 saw an acceleration of hacktivist activity associated with ongoing and emerging geopolitical conflicts.
...
Among the initial access methods Insikt Group observed in 2023, phishing, external remote services, and the use of valid accounts stood out.
...
2023 was the year of new records in covert influence operations. Russia-linked Doppelgänger and China-linked Spamouflage Dragon (Empire Dragon) continued their operations, with early signs of adopting generative AI.
...
Assessing the accuracy of past predictions is a crucial part of the intelligence lifecycle.
...
### Section IV Outlook
Our predictions for the cyber threat landscape in 2024 include:
- **Vulnerabilities**: We predict that at least one ransomware group will carry out a successful compromise of hundreds of targets via exploiting vulnerabilities in an enterprise third-party file transfer service.
- **Third-party threats**: We expect to see software supply-chain attacks dominate the third-party threats landscape, with at least a 15% growth in reported incidents.
...
- **Geopolitics**: Iran will continue to rely on a mixture of proxy warfare and cyber influence operations to sow unrest in the region.
