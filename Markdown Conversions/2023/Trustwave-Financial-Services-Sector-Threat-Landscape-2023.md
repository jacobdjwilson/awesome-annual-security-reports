...
![Sample of stolen bank account logins being sold in underground marketplaces](Image description)
...
![Screenshot of the Lockbit Leak site claiming to have data from a breach of Banco De Venezuela](Image description)
...
![Phishing Email](Image description)
![HTML Attachment](Image description)
...
![Spam email with HTML attachment](Image description)
![HTML containing an encrypted blob](Image description)
![User Action Required](Image description)
![Opens](Image description)
![Launches](Image description)
![LNK Shortcut file](Image description)
![Qakbot DLL](Image description)
![Opens](Image description)
![Contains](Image description)
![Archive](Image description)
![Password-protected archive](Image description)
...
![Prevalence of email malware attachments](Image description)
...
![Word cloud based on the subject lines for emails with malicious attachments](Image description)
...
![Top spoofed brands in emails with malicious attachments](Image description)
...
![Wordcloud based on the subject lines for phishing emails (no malicious attachments)](Image description)

The brands most spoofed in phishing attacks are Microsoft at 52%, DocuSign at 10%, and American Express at 8%.

![Top impersonated brands in phishing emails](Image description)
...
![Lures used in BEC messages](Image description)
...
![Threat Actor](Image description)
![VPN Acess Point](Image description)
...
![Top tactics not detected by security technologies](Image description)
...
![Threat Actor](Image description)
![CVE-2021-44228](Image description)
...
![Exploit procedures used by attackers](Image description)
...
![Publicly exposed services for financial services sector](Image description)
...
![Top 10 ports used by financial services](Image description)
...
![Cloud network administrator management portal open to the internet](Image description)

![Access portal to a server monitoring system belonging to the head office of a major bank readily accessible to anyone on the internet](Image description)

![A logged in RDP session with an older Windows 7 version. Banks in some part of the world refuse to upgrade their systems and use EOL products leading to attackers using it as a vector.](Image description)
...
![Threat Actor](Image description)
![Business Partner](Image description)
...
Cybercriminals commonly prefer to attack these third parties as a flanking maneuver targeting their weakest link. If the attack succeeds, the attacker gains access to the targeted company’s data, even though the company itself may have a