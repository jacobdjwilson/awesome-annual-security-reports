# Annual Cyber-Threat Report: 2023
...
- [The Evolving Cyber Threat Landscape: Understanding the Current Risks](#the-evolving-cyber-threat-landscape-understanding-the-current-risks)
  ...
  - [GreyMatter Digital Risk Protection (GMDRP) Alert Trends](#grey<bos>matter-digital-risk-protection-gmdrp-alert-trends)
...
![Figure 1: Number of true-positive tracked incidents per month](Image description)
...
![Figure 2: Average number of incidents per customer sector](Image description)
...
![Figure 3: Kill chain phases detected in incidents, ranked by prevalence](Image description)
...
![Figure 4: Top 10 most detected techniques](Image description)
...
![Figure 5: Top 10 most commonly observed sub-techniques](Image description)
...
![Figure 6: Most common risk types, by thousands of GMDRP alerts](Image description)
...
![Figure 7: Ten ReliaQuest-customer sectors that received the most alerts, divided by total number of clients](Image description)
...
| Risk Type                     | Professional, Scientific, and Technical Services | Health Care and Social Assistance | Accommodation and Food Services | Retail Trade | Information | Wholesale Trade | Manufacturing | Mining, Quarrying, and Oil and Gas | Public Administration | Finance and Insurance |
| :---------------------------- | :--------------------------------------------- | :-------------------------------- | :------------------------------ | :----------- | :---------- | :-------------- | :------------ | :--------------------------------- | :-------------------- | :-------------------- |
...
| EXPIRED CERTIFICATE           | 58.12                                          | 34.24                             | 28.44                           | 60.71        | 215.1       | 89.81           | 64.54         | 138.64                             | 17.55                 | 17.55                 |
| OPEN PORT                     | 35.95                                          | 18.92                             | 113.39                          | 63.12        | 34.08       | 6.75            | 65.81         | 201                                | 2812.43               | 272.31                |
| EVIDENCE OF CREDENTIAL ACCESS | 288.14                                         | 278.88                            | 125.6                           | 20.87        | 291.38      | 64.69           | 81            | 5.64                               | 13.64                 | 12.64                 |
...
![Figure 8: Excerpt of a port-scanning guide shared on a cybercriminal forum](Image description)
...
![Figure 9: Forum advertisement of a phishing kit dedicated to spoofing Google](Image description)
...
![Figure 10: Most common IAB access types listed for sale, and price ranges from 01 Feb 2022 – 01 Feb 2023](Image description)
...
![Figure 11: AVC site Russian Market sells compromised RDP credentials](Image description)
...
![Figure 12: Countries most commonly targeted by IAB activity between 01 Feb 2022 – 01 Feb 2023](Image description)
...
![Figure 13: Sectors most commonly targeted by IAB activity](Image description)
...
![Figure 14: Typical IAB lifecycle, as observed with Exotic Lily](Image description)
...
![Figure 15: HTML Smuggling attack lifecycle](Image description)

#### Emotet

The Emotet malware has had a checkered history. It was, in effect, disabled in January 2021