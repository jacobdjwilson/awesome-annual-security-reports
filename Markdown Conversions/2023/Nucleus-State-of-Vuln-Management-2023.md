```markdown
# Table of Contents
  * [The Escalating Problem in Vulnerability Management](#the-escalating-problem-in-vulnerability-management)
  * [You can no longer use a hands-on approach to tackle vulnerabilities](#you-can-no-longer-use-a-hands-on-approach-to-tackle-vulnerabilities)
  * [You can't fix what you don't know](#you-cant-fix-what-you-dont-know)
  * [Attackers are weaponizing vulnerabilities quicker](#attackers-are-weaponizing-vulnerabilities-quicker)
  * [Time is money... so are unresolved vulnerabilities](#time-is-money-so-are-unresolved-vulnerabilities)
...
Six years ago, vulnerability exploitation was barely on people's radar as a factor in prioritization. Today, 37% of incidents start with vulnerability exploitation, according to a 2022 Mandiant M-Trends report, making it the leading attack vector for initial access into organizations and a top cybersecurity risk, even bypassing phishing emails.
...
**Image Description:** A graphic showing "100+" above the word "ACTIVE" and "VULNS" below it, next to the words "THE AVERAGE ASSET" and then "3-5%" above "RESOLVED VULNS" below it. The source is Nucleus.
...
In 2022, there were more than 24,000+ new vulnerabilities discovered globally. At this rate, the sheer number of new vulnerabilities coming into your system each day will always be greater than the number you are able to fix with a hands-on approach. We see this in the fact that an average of 72% of vulnerabilities remain unpatched within 30 days, according to the Security Navigator 2023 report by Orange Cyberdefense.
...
**Image Description:** A line graph showing "TOTAL VULNERABILITIES BY YEAR" from 1999 to 2022. The number of vulnerabilities increases over time. The source is NIST National Vulnerability Database.
...
**Image Description:** A graphic showing "BETWEEN 5%-20%" above the text "The number of known vulnerabilities firms are able to fix per month". The source is First.org.

## Attackers are weaponizing vulnerabilities quicker

78% of identified attack paths use known vulnerabilities (CVEs) as an initial attack vector. Palo Alto researchers found threat actors typically scan for systems with a just-disclosed flaw minutes after the CVE is announced.
...
A study by Rapid7 showed that the mean time to known exploitation for vulnerabilities in 2021 was just 12 days — a 71% decrease from 42 days in 2020 — which they attribute to a sharp rise in zero-day exploit activity.
...
**Image Description:** A pie chart showing the percentages of different initial attack vectors. "Prior Compromise" is 14%, "Phishing" is 11%, "Supply Chain Compromise" is 17%, "Stolen Credentials" is 9%, "Other" is 12%, and "Exploits" is 37%. The source is Mandiant.

[CONTACT US](Click here to schedule a meeting.)

[LEARN MORE](Check out our other content.)

## Time is money... so are unresolved vulnerabilities

However, while the amount of time that it takes to identify and contain a breach is an average of 277 days (or about 9 months), it’s been confirmed that shortening that amount of time to 200 days or less can actually minimize the full cost of breaches for your organization. Companies who were able to contain data breaches in under 200 days saw an average savings of $1.12m, with organizations who had deployed AI and automation programs saving nearly $3.05m in breach costs, as they were able to identify and contain a breach 28 days faster than those who didn’t.
...
As we stated earlier, vulnerability exploitation is involved in over half of all breaches, making it not just an overwhelming problem for your vulnerability team, but an expensive one for your entire company. The average cost of a data breach in the United States in 2022 was $9.44m, with the US holding the record for the highest cost of data breaches for the 12th year in a row.

## Conclusion

**Image Description:** A graphic showing "$9.44M" above "Average cost of a data breach in the United States" and "83%" above "Number of organizations with more than one data breach". The source for both is IBM.
