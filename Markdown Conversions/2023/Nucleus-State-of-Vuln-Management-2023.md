...
![A graphic showing the average asset with 3-5% resolved vulns and 100+ active vulns.](Image description)
...
![A bar chart showing the total number of vulnerabilities by year from 2000 to 2022.](Image description)
...
![A graphic showing that between 5%-20% of known vulnerabilities firms are able to fix per month.](Image description)
...
For example, they observed an authentication bypass flaw in an F5 network appliance (CVE-2022-1388) being targeted 2,552 times in the first 10 hours alone after vulnerability disclosure. In addition to searching for vulnerabilities quickly, attackers have also gotten faster at exploiting the vulnerabilities they find.

![A pie chart showing the breakdown of initial attack vectors, with Exploits at 37%.](Image description)
...
![A graphic showing the average cost of a data breach in the United States is $9.44M.](Image description)
