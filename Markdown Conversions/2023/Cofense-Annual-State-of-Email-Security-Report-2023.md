# 2023 Cofense Annual State of Email Security Report
...
- [SECTION 2 Phish Swimming in Murky Waters](#section-2-phish-swimming-in-murky-waters)
  ...
  - [Adobe is the Top Domain Abused to Deliver Phishing Emails](#adobe-is-the-top-domain-abused-to-deliver-phishing-emails)
...
![Figure 1: Top Themes in Active Threat Reports](placeholder_for_image_1)
...
![Figure 2: Cofense Auto-Quarantine Summary](placeholder_for_image_2)
...
![Figure 3: Percentage of Malicious Emails Missed by SEG in 2022](placeholder_for_image_3)
...
![Figure 4: Malicious Threats Observed by PDC](placeholder_for_image_4)
...
![Figure 5: Top 5 Malware Families in 2022](placeholder_for_image_5)
...
![Figure 6: Malware Characteristics](placeholder_for_image_6)
...
![BEC Threat Technique: "Are you in the office? I need to update my direct deposit. Can I provide a voided check?"](placeholder_for_image_BEC_TECHNIQUE)

![Figure 7: BEC Domains](placeholder_for_image_7)
...
![Figure 8: The Blockchain and Cryptocurrencies in Phishing](placeholder_for_image_8)
...
![Figure 9: Use of HTML Attachments in Malicious Email Campaigns](placeholder_for_image_9)
...
In 2022, Cofense Intelligence reported that the abuse of hosting providers to deliver malicious files has become a popular method for threat actors to bypass security and deliver malware in credential phishing attacks as seen in Figure 10. It is common to see trusted cloud providers like Amazon AWS, Google, SharePoint, and other well-known organizations such as Adobe abused by threat