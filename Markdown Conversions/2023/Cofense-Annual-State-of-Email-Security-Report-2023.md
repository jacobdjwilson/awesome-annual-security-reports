# Cofense 2023 Annual State of Email Security Report

Organization: Cofense
Report Title: Annual-State-of-Email-Security-Report
Year: 2023
...
- [SECTION 1 Executive Summary](#section-1-executive-summary)
  ...
  - [BEC Continues to be One of the Top Cybercrimes for the 8th Year in a Row Related to Financial Losses](#bec-continues-to-be-one-of-the-top-cybercrimes-for-the-8th-year-in-a-row-related-to-financial-losses)
    - [Successfully Bypassing Two-Factor Authentication (2FA) to Gain Access to Accounts](#successfully-bypassing-two-factor-authentication-2fa-to-gain-access-to-accounts)
...
- [SECTION 2 Phish Swimming in Murky Waters](#section-2-phish-swimming-in-murky-waters)
...
- [SECTION 3 So Now What?](#section-3-so-now-what)
...
![Figure 1: Bar chart showing top themes in Active Threat Reports. Finance (37%) and Notification/Other (36%) are the highest, followed by Account/Password Alert (8%), Document (6%), Shipping (5%), Voicemail (3%), Order (2%), Response (2%), Benefits (1%), and Fax (1%).]
...
![Figure 2: Bar chart showing Cofense Auto-Quarantine Summary. Unique Campaigns Identified: 255,863. Total Malicious Emails Identified: 480,754. A line graph shows Malicious Emails Detected Using Cofense Intelligence increasing from Q1 2021 to Q4 2022, reaching over 150,000 in Q4 2022.]
...
![Figure 3: Stacked bar chart showing the percentage of malicious emails missed by Secure Email Gateways (SEG) in 2022, broken down by SEG vendor (Cisco, Fortinet, Google, Mimecast, Microsoft, Proofpoint, Symantec) and threat type (BEC, Credential Phishing, Malware, Threat Unavailable). For example, Cisco missed 70% Credential Phishing, 29% BEC, 1% Malware. Microsoft missed 63% Credential Phishing, 21% BEC, 16% Malware.]
...
### Top Attack Vector in 2022: Credential Phishing
...
![Figure 4: Stacked bar chart comparing malicious threats observed by the Phishing Defense Center (PDC) in 2021 and 2022. In 2021, Credential Phishing was 67%, BEC 23%, Malware 7%, Threat Unavailable 3%. In 2022, Credential Phishing increased to 61%, BEC 26%, Malware 10%, Threat Unavailable 3%.]
...
![Figure 5: Line graph showing the number of malware threats identified per month in 2022 for the top 5 malware families: Emotet, FormBook, Agent Tesla, Snake, and QakBot. Emotet consistently has the highest volume, often exceeding 500 threats per month, with peaks in March and October. FormBook and Agent Tesla show moderate activity, while Snake and QakBot have lower but consistent presence.]

The continued position of Emotet (and consequently malware loaders, which are often the first stage of a compromise) at the top of the list is a testament to its outscaling of all other malware-delivery campaigns. There was an overall increase in volume for keyloggers and Remote Access Trojans (RATs). Information stealers saw the largest increase with malware families like FormBook being high commodities in the phishing threat landscape. We continued to watch Snake Keylogger in 2022, which is a staple in the phishing threat landscape as it is a keylogger written in .NET. It can monitor a user’s keystrokes, scan applications to steal saved credentials, and exfiltrate this data through a variety of protocols. Although it is not as popular as other malware families such as FormBook or Agent Tesla, it did maintain a significant presence throughout 2022, and its usage continues to increase. This banking trojan malware type passed RATs due to a high volume of QakBot phishing emails. Despite not having as high of volume as others in the Top 5, Qakbot remains at the top of our list of families to watch since it has been far more successful at bypassing SEGs and reaching inboxes.
...
![Figure 6: Table showing characteristics of malware families: Emotet/Geodo, FormBook, Agent Tesla, Snake, QakBot. Characteristics include Information, Keylogging, Remote Access, Loader Capabilities, and Backdoor Controls. Emotet/Geodo has Loader Capabilities and Backdoor Controls. FormBook has Information, Keylogging, Remote Access. Agent Tesla has Information, Keylogging, Remote Access. Snake has Information, Keylogging, Remote Access. QakBot has Information, Keylogging, Remote Access, Loader Capabilities, and Backdoor Controls.]

### BEC Continues to be One of the Top Cybercrimes for the 8th Year in a Row Related to Financial Losses
...
![Figure 7: Pie chart showing the distribution of BEC domains. 81% are Free, 14% ISP, 3% Mobile, and 2% Spoof.]
...
Overall, in 2022 there was a **341% INCREASE** in Web3 Technologies used in phishing campaigns.
...
Among phishing emails reaching inboxes over the course of 2022, the utilization of Telegram bots as exfiltration destinations for phished information increased gradually but significantly, resulting in a year-over-year increase of more than **800%** between 2021 and 2022.

## SECTION 2 Phish Swimming in Murky Waters
...
![Figure 8: Diagram illustrating the connection between Blockchain and Cryptocurrencies in Phishing. It shows how crypto-themed phishing emails lead to financial fraud, ransomware payments, crypto malware, and email scams (Romance Scam, Advance-Fee Scam, Sextortion).]
...
![Figure 9: Line graph showing the increase in the use of HTML attachments in malicious email campaigns from 2021 to 2022. The volume of HTML attachments significantly increased in 2022, especially from March onwards, reaching over 500 instances in some months, compared to consistently low numbers in 2021.]

In total, we observed a 295% increase in the use of malicious HTML files across both malware delivery and credential phishing throughout the year.

### Adobe is the Top .com Domain Abused to Deliver Phishing Emails
...
![Figure 10: Bar chart showing the top 10 domains abused in phishing emails reaching inboxes. Adobe (5.52%) is the highest, followed by SharePoint (4.15%), Google (3.60%), Canva (1.32%), Amazon AWS (1.26%), Evernote (1.16%), Dropbox (1.08%), Box (1.02%), Microsoft (0.93%), and Clickfunnels (0.88%).]

![Figure 11: Bar chart showing the top 10 Top Level Domains (TLDs) used in credential phishing in 2022. .COM (54.28%) is overwhelmingly the highest, followed by .NET (7.23%), .ORG (2.45%), .IO (2.33%), .CO (2.05%), .COM.BR (2.00%), .MS (1.29%), .IN (1.26%), .XYZ (1.24%), and .ME (1.22%).]
...
![Figure 12: Bar chart showing the top attachment types used in phishing emails reaching inboxes. .pdf (42.96%) is the highest, followed by .html (25.47%), .htm (15.10%), .docx (2.92%), .zip (2.86%), .shtml (1.62%), .xml (1.50%), .xlsx (1.29%), .shtm (0.67%), and .ics (0.59%).]
...
![Figure 13: Timeline showing key events for the QakBot malware family in 2022. Events include QakBot using Microsoft Windows Installer files (MSI) in January, abusing the Follina exploit (CVE-2022-30190) in May, using LNK shortcut files in June, updating to version 5 in September, and using HTML smuggling in October.]
...
![Figure 14: Table describing the "Operate as Business – Top to Bottom Model" for cybercrime organizations. Departments include C-Suite (sets design and targets), IT Wing (carries out hacking, malware, email monitoring), HR/Recruitment (recruits IT wing, financial actors), Finance/Banking (sets process for wire transfers and money laundering), Enforcers (ensures financial cooperation), Admins (maintain shell companies), and Burn Party (burns all materials after schemes).]
...
- **HEALTHCARE**
  - Hit hard with BEC
  - Resilience is a bit lower than the overall average. This workforce tends to be more likely to access email via mobile devices, with a lag in reporting time.
...
![Figure 15: Stacked bar chart showing Cofense Phishing Defense Center industry trends for various sectors (Administrative, Education, Financial Services, Healthcare, Information, Manufacturing, Mining, Professional, Public, Real Estate, Retail, Trade, Transportation, Utilities). Each bar shows the percentage breakdown of BEC, Credential Phishing, Malware, and Threat Unavailable for that industry. For example, Financial Services shows 79% Credential Phishing, 18% BEC, 3% Malware.]

![Figure 16: Bar chart showing simulation industry trends, specifically "Susceptible %", "Report %", and "Resiliency %" for various industries. The chart shows values like 36% Susceptible, 36% Report, 39% Resiliency for an unspecified industry, and 32% Susceptible, 24% Report, 1% Resiliency for another.]

## SECTION 3 So Now What?
