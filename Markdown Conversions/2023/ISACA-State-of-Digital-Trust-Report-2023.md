# State of Digital Trust 2023: An ISACA Global Research Report
...
> "Customers, employees, suppliers and other stakeholders need to know that their online relationships with an organization are reliable and trustworthy. The tolerance for any breach of digital trust is near zero."[^1]
> — GREG WITTE, Senior Security Engineer at Huntington Ingalls Industries

When transactions were mostly conducted in person, many felt that trust was built through eye contact, handshakes and physical signatures. At one time, these were enough, but with online shopping revenue in the U.S. expected to exceed US$1.7 trillion by 2027[^2] and 51 percent of hybrid employees saying they are considering transitioning to fully remote employment in the year ahead,[^3] digital-first work and transactions have become the normal way of conducting business.
...
![Figure 1: Survey Demographic Information showing regional breakdown (North America 46%, Europe 17%, Asia 25%, Africa 7%, Latin America 3%, Oceania 3%), top industries (Financial/Banking 26%, Technology Services/Consulting 21%, Government/Military 11%), enterprise size (68% employed in an enterprise with at least 1,000 employees), and main area of responsibility (Audit/Assurance 31%, Compliance 10%, Risk 13%, Security 27%, Other 19%).]
...
Currently, digital trust as a concept has more recognition than digital trust as a term. Only 33 percent of survey respondents were extremely or very familiar with digital trust as a term prior to being shown ISACA’s definition. After hearing the definition, recognition of the term digital trust jumped to 55 percent.
...
While 84 percent of respondents feel that digital trust is extremely/very important to organizations today, and 75 percent feel it is relevant to their organization, fewer (64 percent) say their organization prioritizes digital trust corresponding to its level of importance.
...
![Figure 2: Digital Trust-related Benefits: Positive reputation (67%), More reliable data for decision making (57%), Fewer privacy breaches (56%), Fewer cybersecurity incidents (56%), Stronger customer loyalty (55%), Faster innovation (42%), Higher revenue (27%).]

![Figure 3: Consequences of a Lack of Digital Trust: Reputation decline (63%), More cybersecurity incidents (59%), More privacy breaches (58%), Loss of customers (56%), Less reliable data for decision making (54%), Negative impact on revenue (42%), Slower ability to innovate (36%).]

## Confidence and Maturity Related to Digital Trust

More than half (53 percent) of respondents are completely or very confident in the digital trustworthiness of their organization. Among those that already measure digital trust maturity, this confidence jumps to 81 percent.

![Figure 4: Digital trustworthiness of organizations: Completely confident (7%), Very confident (43%), Somewhat confident (40%), Not so confident (10%), Not at all confident (1%).]

![Figure 5: Popular Methods for Measuring Digital Trust (Customer-facing): Customer satisfaction surveys (52%), Tracking issues raised to customer service (44%), Monitoring customer retention (37%), Monitoring patterns in customer behavior (31%), Customer recommendation surveys (26%).]

![Figure 6: How Digital Trust is Measured in Organizations (Internal): Internal review of trust-related practices (43%), Customer/client research (38%), Benchmarking against similar enterprises (34%).]

## Obstacles to Attaining Digital Trust

![Figure 7: Obstacles for Attaining Digital Trust: Lack of skills and training (52%), Lack of leadership buy-in (42%), Lack of alignment with enterprise goals (42%), Lack of budget (41%), Lack of technological resources (38%), Digital trust not a priority (38%).]

## Responsibility for Digital Trust

![Figure 8: Top Three Roles Responsible for Digital Trust: IT strategy/governance (85%), Security (81%), Information technology (75%).]
...
Digital transformation continues to progress and mature in nearly all sectors around the world. As organizations further commit to digital transformation—and implement innovative, digitally enabled services and processes—they must take equal time to understand the new vulnerabilities they are creating.
...
1. **Ask the Right Questions**: Does my organization understand all the trust factors that go into what our customers and stakeholders expect?
2. **Establish Enterprisewide Digital Trust Guidelines**: Ensure that the organization has established digital trust as a holistic enterprise approach.
3. **Ensure All Roles Are Involved**: Everyone has a role to play in ensuring digital trust.

## Five Key Takeaways

1. **Definition**: A generally accepted definition of digital trust is the confidence in the integrity of the relationships, interactions and transactions among providers and consumers within an associated digital ecosystem.
2. **Impact**: Digital trust can make or break an organization. It can be the factor that enables some organizations to recover after a major incident while others suffer from serious, time-consuming and expensive ramifications.
3. **Budget**: Digital trust does not necessarily require a significant budget allocation or the creation of a new C-suite position. In many instances, digital trust can be approached as an umbrella that ensures existing functions are operating in the most optimal manner.
4. **Transparency**: Today’s 24/7 Internet-connected society means that one person’s bad experience can be broadcast around the world in real time.
5. **Frameworks**: Many organizations can benefit from digital trust-related guidance and frameworks by selecting the knowledge areas that directly benefit their unique context and business model.

## Conclusion

There is little disagreement that new, serious and likely unexpected digital issues and incidents will continue in the future. In an era of accelerating digital transformation, enterprises and professionals must address digital trust by selecting the right framework and implementing appropriate policies, procedures and practices. Digital trust professionals need to be creative problem solvers who can add value using relevant technology.

## Acknowledgments

ISACA would like to recognize the Board of Directors:
- Pamela Nigro, Chair
