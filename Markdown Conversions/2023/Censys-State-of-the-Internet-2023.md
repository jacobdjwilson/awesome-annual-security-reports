...
- [Part Two: What is the Internet?](#part-two-what-s-the-internet)
  - [What is the Internet?](#what-is-the-internet-1)
- [Part Three: Web Entities on the Internet](#part-three-web-entities-on-the-internet)
  - [Web Entities on the Internet](#web-entities-on-the-internet-1)
  - [HTTP At-a-Glance](#http-at-a-glance)
  - [Who’s Down with HTTP?](#who-s-down-with-http)
  - [What Comprises HTTP Services on the Internet?](#what-comprises-http-services-on-the-internet)
- [Part Four: X.509 Certificates and the Quest for a More Secure Internet](#part-four-x-509-certificates-and-the-quest-for-a-more-secure-internet)
  - [X.509 Certificates and the Quest for a More Secure Internet](#x509-certificates-and-the-quest-for-a-more-secure-internet-1)
  - [Encryption of Web Entities on the Internet](#encryption-of-web-entities-on-the-internet)
- [Part Five: The State of Web Entity Security](#part-five-the-state-of-web-entity-security)
  - [The State of Web Entity Security](#the-state-of-web-entity-security-1)
...
- [Part Six: Conclusion](#part-six-conclusion)
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 3

- Let’s Encrypt, an organization that provides free TLS certificates, has been a
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 4

## Glossary
Before we get into the data, we wanted to provide definitions of some common
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 6

- Encrypted service: An HTTPS service utilizing TLS encryption, which
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 7

## Summary of Findings
- While misconfigurations don’t often make headlines, they remain a major
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 8
...
Censys has two perspectives on the internet: the **unnamed** and
the **named**. The unnamed internet view consists of hosts and
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 10

In summary, SNI allows the web server to respond with a hostname-specific
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 11
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 13
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 14
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 15
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 16

By examining a higher-level breakdown of the HTTP server technologies across all
...
> administrative-level access to affected devices. **There are**
> **potentially tens of thousands of Hikvision devices worldwide**
> **that are still vulnerable.**

2023 STATE OF THE INTERNET REPORT • CENSYS.IO 17

Boa is an open-source web server primarily designed for embedded applications
...
> various known vulnerabilities. **There are over a million of these**
> **exposed servers currently running on unnamed hosts.** An ongoing
> **attack on critical Indian electrical grid assets** was found to
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 18

Besides web servers and load balancers, there are other types of software products
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 19

Microsoft software products such as Microsoft Office 365 and Azure. We mostly
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 20

Although not exhaustive, this provides a glimpse into the wide range of technologies
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 21
...
## X.509 Certificates and the Quest for a More Secure Internet
We interact with certificates daily while using the modern internet. They’re now such
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 23

domain’s certificate protection will lapse sans human intervention. Chromium
...
**66.7 billion certificates**. We use Mozilla’s NSS root store to
find that over **514 million** are browser-trusted, 4.4 billion were
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 24

Examining CA market share over the last 10 years, we can see that it has shifted
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 25
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 26
...
(Figure 7) above. Below are the top ASes where these services are still negotiating
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 27

There are various reasons why some organizations may still use older versions of
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 28
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 29

not how user traffic is distributed among those web entities. To gain a more holistic
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 30
...
## The State of Web Entity Security
Now that we’ve started to unravel the nebulous concept of web entities on the
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 32

And in 2022, confidential and personal data on 1.8 million Texas residents was
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 33
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 34

Furthermore, the situation could escalate if these credentials are shared with other
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 35
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 36
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 37
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 38
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 39
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 40

SwaggerUI is an open-source tool using the OpenAPI standard that allows
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 41

By default, SwaggerUI will run on HTTP port 8080. If an administrator exposes
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 42
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 43

In this section, we have only begun to explore the security issues frequently observed
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 44
...
## Conclusion
The internet, with all its complexities, has become an integral part of our lives and
...
2023 STATE OF THE INTERNET REPORT • CENSYS.IO 46

---

## Appendix
All data unless otherwise specified is pulled from our Universal Internet Dataset
...
Our host and certificate data is freely available to search at [https://search.censys.io](https://search.censys.io).
