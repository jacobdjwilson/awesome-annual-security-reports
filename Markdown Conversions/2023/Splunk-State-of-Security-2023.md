...
#### How SOCs Work
A pie chart shows the distribution of SOC operation hours:
* 58% operate beyond business hours but not 24/365
* 15% operate 24/365 but with reduced bandwidth outside of business hours
* 11% operate 24/365 at full bandwidth
* 17% operate only during business hours
...
A table shows the types of incidents experienced and their effects:
...
| Analytics and supply chain security | 33% |
| DevSecOps           | 31%        |
...
A pie chart shows the level of integration:
* 1% No; not interested
