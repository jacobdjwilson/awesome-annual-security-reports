...
_Note: Items in italic green refer to specific BSIMM activities in Part 6._
...
![Table 1: BSIMM14 Top 10 Activities by Observation Percentage]

![Table 2: BSIMM14 Top 10 Activities Growth by Count]
...
In the subset of firms that secure cloud-native architectures via the _implement cloud security controls_ activity, we see gains in the Penetration Testing, Compliance & Policy, and Software Environment practices of 35%, 21%, and 44%, respectively. Activities that are made easier in cloud environments also saw growth from BSIMM13 to BSIMM14.

---

avior monitoring and diagnostics
...
BSIMM14 BSIMM13 BSIMM12 BSIMM11 BSIMM10 BSIMM9
...
time-consuming security tests to smaller, faster, timelier, pipeline-
...
environments. Product management teams that create non-
functional security requirements (NFSRs) greatly improve the
...
that are then implemented in automation to provide governance-
as-code, there must be ongoing verification that the criteria remain
...
existing generalized attack patterns to create the needed technology-
specific ones, but simply adding “for microservices” at the end of a
...
upon format (e.g., diagramming language and icons, not simply
...
conditions are met. More mature configurations typically include risk-
...
code, etc., deserves some security testing as well.
...
automation in different environments, such as in multi- and hybrid-
cloud environments.
...
with-human-review approach to enforcement. This tends to
...
built architectures, development kits, and libraries is
