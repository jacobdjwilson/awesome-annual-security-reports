...
*   [3 Mend Perspectives](#mend-perspectives)
*   [5 About the Author](#about-the-author)
*   [6 Executive Summary](#executive-summary)
*   [8 Research Synopsis](#research-synopsis)
*   [9 High Concerns Over Supply Chain Risk](#high-concerns-over-supply-chain-risk)
*   [11 Work in Progress: Software Supply Chain Security](#work-in-progress-software-supply-chain-security)
*   [13 Profound Impact on Supply Chain Practices](#profound-impact-on-supply-chain-practices)
*   [14 Conclusion](#conclusion)
*   [16 Appendix](#appendix)

### Figures

*   Figure 1: Priority Level of Supply Chain Security
*   Figure 2: Top Supply Chain Issues
*   Figure 3: Importance of Supply Chain Risks
*   Figure 4: Response to a Supply Chain Attack
*   Figure 5: Time to Mitigate Supply Chain Issues
...
**About the Author:** A veteran of Computerworld and CIO magazine, Carol Hildebrand is an award-winning technology writer who focuses on cybersecurity and how it impacts business innovation.
...
**Figure 1.**
*A pie chart showing the priority level of supply chain security. The chart is divided into 7 sections with the following percentages: It's our top priority (12%), It's among our top 3 priorities (34%), It's among our top 5 priorities (25%), It's among our top 10 priorities (13%), It's important, but not part of our top 10 (10%), It's not a priority at this time (5%), Don't know (1%). A second pie chart shows the same data from 2022 with the following percentages: It's our top priority (12%), It's among our top 3 priorities (28%), It's among our top 5 priorities (30%), It's among our top 10 priorities (17%), It's important, but not part of our top 10 (9%), It's not a priority at this time (3%), Don't know (1%).*
...
**Figure 2.**
*A horizontal bar chart comparing the top supply chain issues in 2023 and 2022. The chart lists the following issues and their corresponding percentages for both years: Attacks targeting vulnerabilities in commercial platforms (49% in 2023, 36% in 2022), Attackers targeting my organization after compromising my suppliers and partners (42% in 2023, 44% in 2022), Ransomware attacks that originated from a supply chain compromise (41% in 2023, 51% in 2022), Vulnerabilities in open source software components that are used by commercial applications (40% in 2023, 40% in 2022), Business processes being disrupted because the supplier is offline after a cyberattack (38% in 2023, 20% in 2022), Vulnerabilities in frameworks and other developer tools used to create applications (34% in 2023, 27% in 2022), Being tricked into downloading malicious components (24% in 2023, 16% in 2022), Adversaries steal secrets, such as tokens, and gain unauthorized access to our systems (24% in 2023, 25% in 2022), Scanning and remediating vulnerabilities in containers (22% in 2023, N/A in 2022), Downstream attacks after adversaries compromised a code repository and inserted malicious packages (21% in 2023, 20% in 2022), Firmware-based attacks (13% in 2023, 10% in 2022), Backdoored hardware components incorporated in devices used by my organization (13% in 2023, 25% in 2022), Securing open source software in containers (12% in 2023, N/A in 2022), I do not have visibility over my supply chain to accurately assess risk (12% in 2023, 10% in 2022), Attackers intercept my digital keys and certificates to sign malicious code (11% in 2023, 20% in 2022).*
...
**Figure 4.**
*A table showing the level of agreement with statements about responding to a supply chain attack. The table lists the following statements and their corresponding percentages for each level of agreement: My organization has clear processes for how to handle a supply chain incident (Strongly agree: 28%, Somewhat agree: 39%, Neither agree nor disagree: 24%, Somewhat disagree: 7%, Strongly disagree: 2%), We have designated staff to respond to supply chain issues, or we know whom to call in case of a supply chain attack (Strongly agree: 31%, Somewhat agree: 39%, Neither agree nor disagree: 20%, Somewhat disagree: 8%, Strongly disagree: 2%), My organization will need to hire an outside team or consultant to deal with a supply chain incident (Strongly agree: 16%, Somewhat agree: 27%, Neither agree nor disagree: 31%, Somewhat disagree: 16%, Strongly disagree: 10%), My organization will need to shut down operations/business processes to deal with an attack (Strongly agree: 10%, Somewhat agree: 20%, Neither agree nor disagree: 32%, Somewhat disagree: 24%, Strongly disagree: 14%).*
...
**Figure 5.**
*A bar chart showing the time it would take to mitigate supply chain issues. The chart is divided into 6 sections with the following percentages: Less than a 24 hours (22%), 1 to 3 days (35%), 4 days to approximately 1 week (19%), 2 to 3 weeks (6%), More than a month (14%), Don't know (4%). A second bar chart shows the same data from 2022 with the following percentages: Less than a 24 hours (15%), 1 to 3 days (31%), 4 days to approximately 1 week (24%), 2 to 3 weeks (12%), More than a month (10%), Don't know (8%).*
...
**Figure 6.**
*A pie chart showing the state of the software supply chain. The chart is divided into 7 sections with the following percentages: Our software supply chain is secure (24%), We are almost finished securing our software supply chain (11%), We are about halfway finished with the process of securing our software supply chain (33%), We have a ways to go to secure our software supply chain (23%), We have not started to secure our software supply chain, but we plan to do so (8%), We have no plans to secure our software supply chain (1%), Don't know (10%). A second pie chart shows the same data from 2022 with the following percentages: Our software supply chain is secure (19%), We are almost finished securing our software supply chain (22%), We are about halfway finished with the process of securing our software supply chain (21%), We have a ways to go to secure our software supply chain (21%), We have not started to secure our software supply chain, but we plan to do so (6%), We have no plans to secure our software supply chain (3%), Don't know (11%).*
...
**Figure 7.**
*A table ranking concerns about the software supply chain. The table lists the following concerns and their corresponding scores: Vulnerabilities in third-party libraries affecting the security of our application (Rank 1, Score 800), Developers downloading and importing malicious packages and components (Rank 2, Score 724), Attackers tampering with libraries and code repositories to include malicious code (Rank 3, Score 602), Software components used in our code, which is no longer being maintained (Rank 4, Score 590), Vulnerabilities in build tools and development frameworks used in software development (Rank 5, Score 552).*
...
**Figure 8.**
*A horizontal bar chart comparing how organizations manage the software supply chain in 2023 and 2022. The chart lists the following practices and their corresponding percentages for both years: We use dependencies that come from only trusted repositories and registries (40% in 2023, 37% in 2022), We regularly check container images for high or critical vulnerabilities (36% in 2023, 40% in 2022), We rely on third-party tools to manage dependencies and vulnerabilities (36% in 2023, 32% in 2022), We rely on automation to minimize inputs and reduce the attack surface (33% in 2023, 39% in 2022), We accept signed components and verify signatures before deployment (32% in 2023, 27% in 2022), We require administrator access for build processes and tools (28% in 2023, 24% in 2022), We verify code components and build binaries from source code before importing (26% in 2023, 28% in 2022), We require all code to be reviewed by at least one other person (26% in 2023, 15% in 2022), We verify the changelog and commit history for the code component and project before importing (25% in 2023, 25% in 2022), For application builds, we execute the steps in ephemeral, isolated, or hermetically sealed environments (25% in 2023, 14% in 2022), We are currently defining and developing our process (20% in 2023, N/A in 2022), We only accept commits signed with a developer’s GPG key (14% in 2023, N/A in 2022), We verify provenance attestation of source code (14% in 2023, 9% in 2022).*
...
**Figure 9.**
*A pie chart showing whether organizations rely on vendor scorecards to assess the security of open source components. The chart is divided into 3 sections with the following percentages: Yes (47%), No (33%), Don't know (20%).*
