...
*(Ranked: TA2541, TA577, TA2725, TA580, TA542, TA558, TA578, TA570, TA551, TA2722)*
...
While URLs are also the most popular delivery mechanism for cybercrime, the distribution is more even. Some of this may be down to the influence of a handful of large-scale actors. As we’ll see when we take a closer look at EMOTET in [Spotlight on Emotet](#spotlight-on-emotet), TA542 has a strong attachment to… well, attachments.
...
A good example of this tendency in 2022 was TA2536, a cyber criminal group we’ve been tracking since 2015. TA2536 largely uses commodity malware, delivering 15 different payloads over the course of the year. AgentTesla and LokiBot information stealers appeared often in the group’s campaigns, but payloads varied widely (including Xloader, Redline, Vidar, njRAT, Snake Keylogger, NanoCore, HawkEye, GuLoader, Formbook, Ave Maria, AsyncRAT, AgentTesla, Remcos, Loki Bot, and AZORult).
...
3. `biterika.ru` - 81%
4. `netprotect.com` - 80%
5. `colorcrossing.com` - 79%
6. `cloudflare.com` - 79%
7. `blazingseollc.com` - 79%
8. `servermania.com` - 78%
9. `hetzner.de` - 77%
10. `egihosting.com` - 75%
