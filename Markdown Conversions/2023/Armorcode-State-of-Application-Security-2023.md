...
- [What is your job role?](#what-is-your-job-role)
- [Let’s talk maturity](#lets-talk-maturity)
- [Security check - How are we doing?](#security-check---how-are-we-doing)
- [Are we doing DevSecOps right?](#are-we-doing-devsecops-right)
- [A stocktaking of best practices](#a-stocktaking-of-best-practices)
- [What initiatives do you leverage as part of your software security program?](#what-initiatives-do-you-leverage-as-part-of-your-software-security-program)
...
While we’re on the topic of software supply chain risk, a Software Bill of Materials goes a long way to understanding the full extent of an application’s threat surface. Generating, consuming, and leveraging SBOMs provides a far more comprehensive and fair assessment of and organization’s AppSec posture.
