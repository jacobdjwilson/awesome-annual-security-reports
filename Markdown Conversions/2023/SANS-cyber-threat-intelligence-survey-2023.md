...
![Image description: Figure 1. Survey Demographics shows charts and diagrams illustrating the distribution of survey respondents by industry, organization size, operational and headquarters locations, and job roles.]

SANS 2023 CTI Survey: Keeping Up with a Changing Threat Landscape

3

This year we had several respondents from a new industry not previously included in our data collection: the water industry (including utilities and waste). In October 2021, the Cybersecurity and Infrastructure Security Agency (CISA) released an alert on the ongoing attacks against the water sector, highlighting the critical importance of water services and the active threats that the sector faces.1 Although we have had survey respondents in the past who identified themselves as water and wastewater sector employees, beginning this year we are including their responses as one of the 18 sectors listed in the survey. CTI work is done across many more fields than those 18, and each year we have many respondents from industry types not listed by default. This year we see a notable increase in the diversity of those fields, including agriculture, mining, civil engineering, construction, gaming, health and wellness, and law.

Figure 2 illustrates some of those various industries represented by the survey respondents. This demonstrates that CTI continues to be a growing field and that organizations of many types can benefit from CTI. Recent attacks show that no one particular industry is being targeted; instead, attackers continue to find ways to monetize attacks in nearly every vertical. In addition to organizations in these fields benefiting from experienced CTI analysts, the CTI field itself will gain from the increased diversity of thought, experience, and perspective as analysts work against threats that can impact organizations in unique ways.

Another notable change observed in this 2023 survey is that the primary industry of respondents is cybersecurity service providers, as compared to 2022 when it was banking and finance. This notable shift suggests that CTI analysts working for cybersecurity service providers represent a substantial portion of the community. Cybersecurity service vendors often approach CTI differently than “end-user” organizations such as banks because these vendors often have visibility into many organizations while also working to balance requirements from those many stakeholders.

This year’s respondents were heavily skewed toward the United States, with 71% of their organizations being primarily headquartered in the United States, up from 58.6% of last year’s respondents. Although this is not surprising, it’s important to note this as a limitation of the survey, because respondents are heavily influenced by their country of operations.

![Image description: Figure 2. Industries Represented in 2023 Survey shows a pie chart illustrating the distribution of survey respondents across various industries.]
...
![Image description: Figure 3. Growth of Formal CTI Teams shows a bar chart illustrating the percentage of organizations with formal dedicated CTI teams from 2018 to 2023.]
...
![Image description: Figure 4. CTI Requirements shows a stacked bar chart comparing the responses to the question "Are CTI requirements clearly defined in your organization?" for 2022 and 2023.]
...
**How important are geopolitics in developing your intelligence requirements (or tasks for the CTI function if you do not have formal requirements)?**
*   Very important: 38.1%
*   Somewhat important: 33.1%
*   A little important: 21.3%
*   Not at all important: 3.4%
*   Unknown: 4.1%

![Image description: Figure 5. Geopolitics’ Influence on Requirements shows a bar chart illustrating the importance of geopolitics in developing intelligence requirements.]
...
![Image description: Figure 6. Effect of the War in Ukraine shows a bar chart illustrating how the war in Ukraine affected intelligence requirements in 2022.]
...
*   Vulnerability data: 57.2%
*   Threat feeds from general security vendors: 56.1%
*   Social media: 53.5%
*   Incident response and forensics: 51.7%
*   Security data gathered from internal IDS, firewall, endpoint, and other security systems: 46.7%
*   SIEM platform: 45.8%
*   Other formal and informal groups with a shared interest: 41.1%
*   Network traffic analysis packet and flow: 37.4%
*   Closed or dark web sources: 36.5%
*   Application logs: 34.7%
*   Security analytics platform other than SIEM: 33.0%
*   Honey pot data: 30.5%
*   User behavior data: 23.8%
*   Shared spreadsheets and/or email: 22.8%
*   Other: 1.3%

![Image description: Figure 7. Information Sources shows a horizontal bar chart illustrating the various types of information used for intelligence gathering by survey respondents.]
...
| Category | 2019 | 2022 | 2023 |
|---|---|---|---|
| **Produce** | 4.6% | 12.8% | 15.2% |
| **Consume** | 49.1% | 47.8% | 44.6% |
| **Both** | 4.3% | 11.7% | 11.7% |

**Raw threat data**
*   Produce: 3.8% (2019), 4.3% (2022), 11.9% (2023)
*   Consume: 50.6% (2019), 50.0% (2022), 45.6% (2023)
*   Both: 39.7% (2019), 32.8% (2022), 36.4% (2023)

**Contextual threat alerts**
*   Produce: 4.3% (2019), 11.7% (2022), 11.7% (2023)
*   Consume: 50.6% (2019), 48.8% (2022), 60.5% (2023)
*   Both: 41.3% (2019), 35.6% (2022), 41.6% (2023)
...
![Image description: Figure 8. Year-over-Year CTI Usage shows stacked bar charts comparing the production, consumption, and combined use of raw threat data, contextual threat alerts, and published threat intelligence from 2019 to 2023.]
...
*   Automated tracking of all actions taken based on CTI: 47.6%
*   Manual tracking of actions taken based on CTI: 47.2%
*   Measure number of preventions accounted for by using CTI: 46.3%
*   Measure time to respond to alerts generated using CTI: 44.0%
*   Measure time to respond to queries using CTI: 42.4%
*   Measure number of reports or written summaries disseminated: 39.5%
*   Measure number of legitimate alerts generated using CTI: 38.2%
*   Request feedback on performance directly from CTI consumers: 23.3%
*   Other: 1.0%

![Image description: Figure 10. Measuring CTI Effectiveness shows a horizontal bar chart illustrating the methods used to measure the effectiveness of CTI.]
...
*   Lack of trained staff or lack of skills needed to fully utilize CTI: 44.3%
*   Interoperability issues/ lack of automation: 42.1%
*   Lack of funding: 39.9%
*   Lack of time to implement new processes: 38.3%