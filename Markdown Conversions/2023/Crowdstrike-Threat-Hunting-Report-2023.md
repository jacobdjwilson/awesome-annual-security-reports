...
![Figure 1. Interactive intrusions over time, 2019 to 2023](https://i.imgur.com/your_image_link_here.png)
...
![Figure 2. Top 10 targeted verticals, July 2022 to June 2023](https://i.imgur.com/your_image_link_here.png)
*Figure 2. Top 10 targeted verticals, July 2022 to June 2023*

![Figure 3. Top five targeted verticals separated by adversary threat type, July 2022 to June 2023](https://i.imgur.com/your_image_link_here.png)
...
![Figure 4. Intrusion activity by threat actor heat map, July 2022 to June 2023](https://i.imgur.com/your_image_link_here.png)
...
![Figure 5. MITRE ATT&CK heat map highlighting the top five techniques Falcon OverWatch observed adversaries use in each tactic area, June 2022 to July 2023](https://i.imgur.com/your_image_link_here.png)
...
![Figure 6. Intrusions featuring Kerberoasting attacks](https://i.imgur.com/your_image_link_here.png)
...
$domain = '[REDACTED IPAddress]' # host
$dport = 4001 # port
...
```powershell
$Null = [Reflection.Assembly]::LoadWithPartialName( 'System.IdentityModel' ); $search = New-Object DirectoryServices.DirectorySearcher( [ADSI]'' ); $search.filter = '(&(servicePrincipalName=*)(objectCategory=user))'; $results = $search.Findall();
