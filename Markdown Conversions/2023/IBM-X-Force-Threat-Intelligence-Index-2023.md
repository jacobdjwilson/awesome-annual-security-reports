...
![Image description: Top initial access vectors X-Force observed in 2022. Source: X-Force](Image description: Top initial access vectors X-Force observed in 2022. Source: X-Force)
...
- Attachment: 62%
- Link: 33%
- Phishing via service: 5%

![Image description: Types of phishing subtechniques as a
percentage of total phishing cases observed by
X-Force in 2022. Source: X-Force](Image description: Types of phishing subtechniques as a
percentage of total phishing cases observed by
...
advent of the Common Vulnerabilities and
Exposures (CVE) system, X-Force
...
| Year | Sum of total vulnerabilities | Sum of total exploits |
|------|------------------------------|-----------------------|
| 2018 | 17,923                       | 6,505                 |
| 2019 | 18,115                       | 6,090                 |
| 2020 | 19,391                       | 5,479                 |
...
![Image description: X-Force vulnerability database view showing
vulnerabilities and exploits over the past five years.
Source: X-Force](Image description: X-Force vulnerability database view showing
vulnerabilities and exploits over the past five years.
Source: X-Force)
...
![Image description: X-Force vulnerability database showing
severity of vulnerabilities tracked in our system.
Source: X-Force](Image description: X-Force vulnerability database showing
severity of vulnerabilities tracked in our system.
Source: X-Force)
...
![Image description: Graphic showing the growth of vulnerabilities, exploits and zero days since 1988. Also
included is a timeline of major event involving vulnerabilities since 1993. XFDB stands for X-Force
Database and Exploit DB stands for Exploit Database. Source: X-Force](Image description: Graphic showing the growth of vulnerabilities, exploits and zero days since 1988. Also
included is a timeline of major event involving vulnerabilities since 1993. XFDB stands for X-Force
...
- Malware - Backdoors: 21%
- Malware - Ransomware: 17%
- Business email compromise (BEC): 6%
- Malware - Maldoc: 5%
- Spam campaign: 5%
- Tool - Remote access: 5%
- Server access: 5%

![Image description: Top actions on objectives observed by X-Force in 2022. Source: X-Force](Image description: Top actions on objectives observed by X-Force in 2022. Source: X-Force)

---

## Top actions on objectives

### Distribution of Emotet cases across
2022

![Image description: Graph showing spike in Emotet cases in early
2022. Source: X-Force](Image description: Graph showing spike in Emotet cases in early
2022. Source: X-Force)
...
![Image description: Ransomware variants and the frequency
with which they were observed in X-Force Incident
Response engagements in 2022. Source: X-Force](Image description: Ransomware variants and the frequency
with which they were observed in X-Force Incident
...
ransomware or BEC, and often included
the use of remote access tools, cryptominers,
...
![Image description: Top impacts X-Force observed in incident
response engagements in 2022. Source: X-Force](Image description: Top impacts X-Force observed in incident
response engagements in 2022. Source: X-Force)
