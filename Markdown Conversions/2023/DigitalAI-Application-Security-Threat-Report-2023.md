...
### Key Findings
1. **Attack Probability**: The study found that 57% of monitored apps experienced at least one attack.
2. **Industry Vulnerability**: Gaming and financial services (FinServ) apps face the highest risk of attack (63% and 62%, respectively). The likelihood of attacks in other industries is slightly lower (54%) but remains a significant concern.
3. **Android vs. iPhone**: Android apps are more likely to be targeted than iPhone apps (76% vs. 55%, respectively); however, the difference in the likelihood of attack was smaller than predicted.
4. **Attack Vector and Outcome**: The popularity of an app is not correlated with the likelihood of attack on an app: In many cases, less popular apps were attacked more often than popular apps.
...
Based on 20 years of closely observing threat actors, recent risk trends, and preliminary data, the study’s authors initially hypothesized that the likelihood of any app running in an unsafe environment would be greater than 50%. The actual figure was significantly higher: **57% of all apps are under attack**.
...
![Chart showing Gaming Apps Under Attack vs All others and FinServ Apps Under Attack vs All others]

**Several factors cause the risks to be higher in gaming:**
- **There is money to be made**: Selling pirated games in grey-market app stores such as Cydia can give hackers direct income. In addition, money can be made in the micro-economies that popular games create and foster.
- **“Street cred” from hacking games**: Some of the most active Reddit communities and forums revolve around “cracking” or reverse engineering games.
...
[^2]: https://www.bankinfosecurity.com/7-iranians-indicted-for-ddos-attacks-against-us-banks-a-8989

### Other Industries
- Apps outside of FinServ and gaming still have a 54% chance of being attacked.
- Bluetooth-connected phone apps that start our cars are increasingly available and are also obvious targets.
...
### iOS vs. Android
The popular notion is that iOS is more secure than Android because Apple is vocal about its commitment to privacy and has a legacy of running a “closed” environment. However, the reality is more complicated. Android OS is more open and thus more accessible to threat actors.
...
- **iOS likelihood of unsafe environment**: 34%
- **Android likelihood of being put in an unsafe environment**: 55%

The margin is larger when we look JUST at the odds of running with modified code:
- **iOS likelihood of being run with modified code**: 6%
- **Android likelihood of being run with modified code**: 17%
- **Difference in likelihood of being run with modified code**: 28%

---

## Does Risk Depend on App Popularity?

When fraudsters want to exploit the popularity of an app to do their dirty deeds, they often run the app in a virtualized environment and/or open multiple accounts on the same app.

![Table showing popularity of various virtualization spaces like Parallel Space, VirtualXposed, etc.]
...
### Risk and Popularity
The study also found no correlation between the likelihood of being attacked and the app’s popularity. 

![Scatterplot of data from Digital.ai App Aware showing Number of Active Users vs Number of Attacks]

While the lack of correlation between the popularity of an app and the likelihood of it being attacked might be illogical to a casual observer, we know from experience that the reasons and motivations for attacking any particular app are varied.

---

## Protecting Your Apps in the Wild

Digital.ai has hundreds of application security customers worldwide who protect over 1 billion instances of applications.
...
[Read more about our Application Security solution.](https://digital.ai/why-digital-ai/contact/)
...
- **Telemetry data**: Includes the types of guards that are used for a particular app but does not contain information on whether or not a guard has been “tripped” or fired.
- **App Aware data**: Customers who use App Aware have data on the number and locations of app instances they have in production, as well as information on when and where each of those apps is either modified or placed in an unsafe environment.
