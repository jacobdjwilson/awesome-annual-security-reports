...
- [Risks to App By Industry (cont.)](#risks-to-app-by-industry-cont)
...
- [Risk and Popularity (cont.)](#risk-and-popularity-cont)
...
Based on 20 years of closely observing threat actors, recent risk trends, and preliminary data, the study’s authors initially hypothesized that the likelihood of any app running in an unsafe environment would be greater than 50%. The actual figure was significantly higher:
...
**Gaming Apps Under Attack**
(Image description: A bar chart showing "All others" and "Attacked" for gaming apps. The "Attacked" bar is significantly higher than "All others".)

**FinServ Apps Under Attack**
(Image description: A bar chart showing "All others" and "Attacked" for FinServ apps. The "Attacked" bar is significantly higher than "All others".)
...
*   **Difference in likelihood of being run with modified code: 55% (Android) vs. 76% (iOS)**
...
(Image description: A pie chart showing the popularity of various types of virtualization spaces. "Parallel Space (best choice)" is the largest slice at 49.08%.)
...
(Image description: A scatterplot titled "Digital.ai App Aware" showing "Number of Active Users" on the Y-axis and "Reported Tamper" on the X-axis. The data points are spread across the graph, with no clear correlation between the two axes.)
...
Get more information about our Digital.ai Application Security solution and its capabilities by accessing the resource below. Then contact us to get started on your journey.
