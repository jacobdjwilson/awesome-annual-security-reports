...
- [Five Risk Facts Learned from Threat Analytics in 2022](#five-risk-facts-learned-from-threat-analytics-in-2022)
  ...
  - [Risk Fact 5: Infrastructure Misconfigurations Open the Door to Ransomware](#risk-fact-5-misconfigurations-open-the-door-to-ransomware)
...
![Qualys Platform — Deploying Anywhere](https://www.qualys.com/forms/tru-research-report/images/figure1.png)
...
![Evolution of vulnerability threat landscape, 1988 – 2022](https://www.qualys.com/forms/tru-research-report/images/figure2.png)
...
![Evolution of vulnerability threat landscape in 2022](https://www.qualys.com/forms/tru-research-report/images/figure3.png)
...
| CVE-2022-1040  | 100 | Y        | 2                    | Y          | 1               | 70.0        | 34.70%     |
...
additional exploit techniques for gaining code execution abilities. It results in an Elevation
of Privilege (EoP) in the Windows Common Log File System (CLFS) driver. Vulnerabilities like
...
![Time to Weaponize vs. MTTR for Vulnerabilities in 2022](https://www.qualys.com/forms/tru-research-report/images/figure5.png)
...
| :------------ | :----------------------------------------------------------------------- | :------------------- | :---------- |
| CVE-2022-2856 | Google Chrome Intents Insufficient Input Validation Vulnerability        | 22.4                 | 2.03        |
| CVE-2022-41049 | Microsoft Windows Mark of the Web (MOTW) Security Feature Bypass Vulnerability | 17.1                 | 13.8        |
| CVE-2022-4135 | Google Chromium Heap Buffer Overflow Vulnerability                       | 17.0                 | 9.8         |
| CVE-2022-2294 | WebRTC Heap Buffer Overflow Vulnerability                                | 16.5                 | 13.2        |
| CVE-2022-3075 | Google Chromium Insufficient Data Validation Vulnerability               | 16.1                 | 11.5        |
| CVE-2022-30170 | Windows Credential Roaming Service Elevation of Privilege Vulnerability  | 15.4                 | 10.3        |
| CVE-2022-24521 | Microsoft Windows Common Log File System CLFS Driver Privilege Escalation Vulnerability | 14.0                 | 20.5        |
| CVE-2022-26904 | Microsoft Windows User Profile Service Privilege Escalation Vulnerability | 13.9                 | 21.0        |
| CVE-2022-37969 | Microsoft Windows CLFS Driver Privilege Escalation Vulnerability         | 13.7                 | 13.3        |
| CVE-2022-1096 | Google Chromium V8 Type Confusion Vulnerability                          | 13.3                 | 10.8        |
...
![Comparing Weaponized Vulnerabilities in 2022 by Age vs. Percentage Remediated](https://www.qualys.com/forms/tru-research-report/images/figure6.png)
...
![Comparing Weaponized Chrome/Windows Vulnerabilities in 2022 by Age vs. Percentage Remediated](https://www.qualys.com/forms/tru-research-report/images/figure7.png)
...
![Comparing Weaponized Non-Chrome/Windows Vulnerabilities in 2022 by Age vs. Percentage Remediated](https://www.qualys.com/forms/tru-research-report/images/figure8.png)
...
![MTTR vs. Patch Rate for Chrome in Windows Vulnerabilities in 2022](https://www.qualys.com/forms/tru-research-report/images/figure9.png)
*Figure 9: MTTR vs. Patch Rate for Chrome in Windows Vulnerabilities in 2022*

![MTTR vs. Patch Rate for Chrome in Windows Vulnerabilities in 2022](https://www.qualys.com/forms/tru-research-report/images/figure10.png)
...
![Automated Patching Improves MTTR for Vulnerabilities in 2022](https://www.qualys.com/forms/tru-research-report/images/figure11.png)
...
![Attack Paths Used by Initial Access Brokers (IABs)](https://www.qualys.com/forms/tru-research-report/images/figure12.png)
