...
Cybercrime continues to rise at the same time CISOs are being challenged to do more with less. Research from early 2023<sup>1</sup> revealed that one-third of companies had made security budget cuts in the past 12 months and that a quarter were planning to make cuts in the following 12 months, with 40% saying they were planning to make headcount cuts in the same timeframe. Of the security professionals surveyed, 67% said they believed reducing budget and headcount in security would negatively affect their ability to handle cybersecurity incidents.
...
<sup>1</sup> Survey conducted by CensusWide March 29-31, 2023. Censuswide abides by and employs members of the Market Research Society, which is based on the ESOMAR principles. Respondents include 100 US cybersecurity professionals aged 18+.
...
*A graphic shows two statistics: 96% of HackerOne customers say their organization is better positioned to resist cyberattacks and 70% of HackerOne customers say hacker efforts have helped them avoid a significant security incident.*

# What You Will Learn From the Hacker-Powered Security Report
*A graphic shows a statistic: 55% of hackers say that generative AI (GenAI) tools themselves will become a major target for them in the coming years.*
...
*A graphic shows three statistics: One-quarter of hackers hack full-time, Nearly two-thirds of hackers spend less than 20 hours a week hacking, and Almost one-third of hackers have day jobs in the cybersecurity industry.*
...
*A graphic shows a list of industries and the percentage of hackers that focus on them: Internet & online services 58%, Financial services & insurance 53%, Government 40%, Cryptocurrency & blockchain 16%, Retail & e-commerce 48%.*

*A graphic shows a more detailed list of industries and the percentage of hackers that focus on them: Financial services & insurance 53%, Government 40%, Healthcare 33%, Computer software 43%, Internet & online services 58%, Retail & e-commerce 48%, Media & entertainment 40%, Automotive & ground transport 19%, Aviation & aerospace 15%, Electronics & semiconductor 15%, Cryptocurrency & blockchain 16%, Professional services 30%, Computer hardware & peripherals 14%, Education 41%, Travel & hospitality 32%, Non-profit 19%, Telecommunications 29%, Medical technology 24%, Consumer goods 30%.*
...
*A graphic shows a list of hacking specializations and the percentage of hackers that specialize in them: Wireless penetration testing 18%, Web application testing 95%, Vulnerability research 63%, Purple team testing 10%, Social engineering testing 20%, Red team testing 40%, Network penetration testing 47%.*

# Where Hackers Consider Themselves Most Skilled
*A graphic shows a list of hacking skills and the percentage of hackers that consider themselves most skilled in them: Large scale scanning 6%, Exploitation 20%, Escalating bugs 7%, Explaining the impact 11%, Chaining bugs 8%, Gaining privileged access 12%, Reconnaissance 36%.*
...
*A graphic shows a list of technologies and applications and the percentage of hackers that specialize in them: Operating systems 11%, Hardware devices 7%, Firmware 6%, iOT 8%, AI tools 7%, Blockchain 6%, Windows mobile applications 9%, iOS mobile applications 17%, Desktop software 17%, APIs 55%, Open source 23%, Android mobile applications 43%, Websites 98%.*
...
*A graphic shows three statistics: 28% of hackers are concerned about criminal exploitation of AI, 53% of hackers are using GenAI in some way, and 66% of hackers said that they do or will use GenAI to write better reports.*
...
While 38% of hackers say they think GenAI will reduce the number of vulnerabilities in code, 43% say it will lead to an increase in vulnerabilities. Find out more in our [blog post](https://www.hackerone.com/blog/potential-risks-genai-poses) on the potential risks GenAI poses
...
*A graphic shows two pie charts. The first is titled "What is your organization most concerned about?" and shows the following percentages: Nation-state actors 9%, Phishing 20%, Exploited vulnerabilities 59%, Insider threats 13%. The second is titled "What are organizations biggest security risks according to hackers?" and shows the following percentages: Infrequent testing 11%, Third-party software 12%, Insufficiently deep testing 22%, Lack of visibility into the attack surface 23%, Lack of in-house skills and expertise 32%.*
...
*A graphic shows a list of reasons why hackers choose a particular program and the percentage of hackers that chose that reason: Like the brand 3%, Dislike the brand 45%, Challenge and opportunity to learn 73%, Bounties 27%, I use the company’s products 21%, The program was recommended to me 46%, Varied scope 17%, Relationship with the security team 16%, The opportunity for public disclosure 20%, Recognition 39%, Fast resolution time 42%, Fast bounty time 50%, A lot of vulnerabilities.*
...
*A graphic shows a list of reasons why hackers are put off a program and the percentage of hackers that chose that reason: Poor communication 55%, Slow response times 60%, Slow time to bounty 37%, No opportunity for public disclosure 14%, Low bounties 48%, Limited scope 58%, Dislike the brand 17%, Skills mismatch 29%, Negative reviews from others 44%, NDAs 9%.*
...
*A table shows the Average, Median, and 90th Percentile for Bounties on the HackerOne Platform for various industries: Telecoms: 50th percentile $0.5k, 90th percentile $1.25k, Average bounty $3.8k, Media & Entertainment: 50th percentile $0.5k, 90th percentile $1k, Average bounty $5k, Retail & E-commerce: 50th percentile $0.5k, 90th percentile $1k, Average bounty $1.5k, Automotive: 50th percentile $0.5k, 90th percentile $1.1k, Average bounty $3k, Internet & Online Services: 50th percentile $0.5k, 90th percentile $1.2k, Average bounty $3k, Financial Services: 50th percentile $0.4k, 90th percentile $3.1k, Average bounty $6k, Computer Software: 50th percentile $0.5k, 90th percentile $0.9k, Average bounty $3k, Cryptocurrency & Blockchain: 50th percentile $0.5k, 90th percentile $1.2k, Average bounty $2.5k, Travel & Hospitality: 50th percentile $0.75k, 90th percentile $1.2k, Average bounty $3.4k, Government: 50th percentile $0.3k, 90th percentile $0.7k, Average bounty $1.5k. The average bounty for all industries is $1k, and the 90th percentile average for all industries is $3k.*
...
*A table shows the Average, Median, and 90th Percentile for Bounties on the HackerOne Platform for various industries for high and critical vulnerabilities: Telecoms: 50th percentile $2k, 90th percentile $4.2k, Average bounty $8.4k, Media & Entertainment: 50th percentile $5k, 90th percentile $2.9k, Average bounty $5k, Retail & E-commerce: 50th percentile $1k, 90th percentile $2.6k, Average bounty $12k, Automotive: 50th percentile $3k, 90th percentile $3.2k, Average bounty $12.5k, Internet & Online Services: 50th percentile $3.1k, 90th percentile $5.7k, Average bounty $21k, Financial Services: 50th percentile $10k, 90th percentile $24.8k, Average bounty $100k, Computer Software: 50th percentile $2.5k, 90th percentile $2.4k, Average bounty $5k, Cryptocurrency & Blockchain: 50th percentile $5k, 90th percentile $3.3k, Average bounty $6k, Travel & Hospitality: 50th percentile $3.1k, 90th percentile $3.1k, Average bounty $7.5k, Government: 50th percentile $3k, 90th percentile $2.9k, Average bounty $7k. The average bounty for all industries is $3.7k, and the 90th percentile average for all industries is $12k.*
...
*A graphic shows a diagram of the SDLC with three stages: Stage 1 Development, Stage 2 Pentest, Stage 3 Bug Bounty Program. Under Development, it lists "Secure by design frameworks and libraries", "Automated Testing", and "Analysis on code changes and live applications". Under Pentest, it lists "Frequent testing to validate coverage". Under Bug Bounty Program, it lists "Continuous testing by security experts". The diagram also includes the text "SDLC", "Customer", and "HackerOne".*
...
*A graphic shows a diagram of the software development lifecycle with the following stages: Plan, Build, Code, Test, Deploy, Release, Operate, Monitor. It also includes the text "DEV", "OPS", "SEC", "HackerOne", "Pentest", "HackerOne Code Security Audit", and "HackerOne Bug Bounty". Below the diagram, it lists "Secure development training", "Static application testing", "Human code review", and "Small pentests/security hygiene checks".*
...
<sup>2</sup> Calculations based off median bounty reward figures across a sample of 1,100+ active HackerOne programs

*A graphic shows three figures: $29,437 Estimated bounty cost if found in bug bounty program, $18,037 Estimated bounty cost savings, and $11,400 40-hour Code Security Audit. Below the figures is the text "Eliminating bugs before live user data is at risk: Priceless."*
...
*A graphic shows three statistics: 54% increase in pentests since 2022, 16% increase in the number of vulnerabilities being surfaced by pentests, and 15% of vulnerabilities found being rated as high or critical severity.*
...
*A table shows the Top Ten Vulnerabilities Surfaced in a Pentest and their ranking in a Bug Bounty program: Misconfiguration 1, Cross-site scripting (XSS) 2, Information disclosure 3, Improper access control - generic 4, Using components with known vulnerabilities 5, Insecure direct object reference (IDOR) 6, Cryptographic 7, Insufficient session expiration 8, Violation of secure design principles 9, Exploiting incorrectly configured SSL/TLS 10. The corresponding Bug Bounty rankings are 6, 1, 3, 2, 8, 4, 44, 39, 14, 420.*

*A table shows the Top Ten Vulnerabilities Surfaced in a Bug Bounty and their ranking in a Pentest: Cross-site scripting (XSS) 1, Improper access control 2, Information disclosure 3, Insecure direct object reference 4, Privilege escalation 5, Misconfiguration 6, Improper authentication - generic 7, Business logic errors 8, Open redirect 9, Improper authorization 10. The corresponding Pentest rankings are 2, 4, 3, 6, 23, 1, 16, 21, 15, 13.*
...
We’ve taken a look at the top ten vulnerabilities reported on the HackerOne platform across all HackerOne products and calculated what percentage of the total reports is attributable to each vulnerability type. And we’ve cross-referenced