...
96% of HackerOne customers say their organization is better positioned to resist cyberattacks
...
55% of hackers say that generative AI (GenAI) tools themselves will become a major target for them in the coming years
...
- 80% of hackers hack to earn money (up from 71% in 2022)
- 78% of hackers also say they do it to learn
- 47% of hackers say they hack to protect and defend businesses and end users
...
- Internet & online services 58%
- Financial services & insurance 53%
- Government 40%
- Cryptocurrency & blockchain 16%
- Retail & e-commerce 48%

![Chart showing industries hackers focus on with percentages: Internet & online services 58%, Financial services & insurance 53%, Computer software 43%, Government 40%, Telecommunications 40%, Education 41%, Retail & e-commerce 48%, Travel & hospitality 32%, Consumer goods 30%, Media & entertainment 30%, Professional services 29%, Medical technology 24%, Non-profit 19%, Automotive & ground transport 19%, Cryptocurrency & blockchain 16%, Aviation & aerospace 15%, Electronics & semiconductor 15%, Computer hardware & peripherals 14%.]
...
- 95% Web application testing
- 40% Red team testing
- 47% Network penetration testing
- 10% Purple team testing
- 63% Vulnerability research
- 18% Wireless penetration testing
...
- 8% Chaining bugs
- 12% Gaining privileged access
- 36% Reconnaissance

36% of hackers consider themselves most skilled in reconnaissance
...
- 98% Websites
- 43% Android mobile applications
- 23% Open source
- 55% APIs
- 17% iOS mobile applications
- 17% Desktop software
...
28% of hackers are concerned about criminal exploitation of AI
66% of hackers said that they do or will use GenAI to write better reports
...
While 38% of hackers say they think GenAI will reduce the number of vulnerabilities in code, 43% say it will lead to an increase in vulnerabilities. Find out more in our [blog post on the potential risks GenAI poses](URL).
...
OWASP has already published their top ten vulnerabilities for LLM applications. Check out the [HackerOne blog](URL) for more information about these vulnerabilities.
...
- 9% Nation-state actors
- 20% Phishing
- 59% Exploited vulnerabilities
- 13% Insider threats

### What are organizations biggest security risks according to hackers?
- 11% Infrequent testing
- 12% Third-party software
- 22% Insufficiently deep testing
- 23% Lack of visibility into the attack surface
- 32% Lack of in-house skills and expertise
...
![Chart showing reasons hackers choose a program: Bounties 73%, A lot of vulnerabilities 50%, Challenge and opportunity to learn 45%, Fast resolution time 39%, Fast bounty time 42%, Like the brand 42%, Varied scope 46%, Recognition 20%, I use the company’s products 27%, The program was recommended to me 21%, Relationship with the security team 17%, The opportunity for public disclosure 16%, Dislike the brand 3%.]
...
![Chart showing reasons hackers are put off a program: Slow response times 60%, Poor communication 55%, Limited scope 58%, Low bounties 48%, Negative reviews from others 44%, Slow time to bounty 37%, Skills mismatch 29%, Dislike the brand 17%, No opportunity for public disclosure 14%, NDAs 9%.]
...
$1k Average bounty for all industries
$3k 90th percentile average for all industries

![Chart showing average, median, and 90th percentile bounties by industry: Telecoms (Median $0.5k, 90th $3.8k, Avg $1.25k), Automotive (Median $0.5k, 90th $5k, Avg $1k), Computer Software (Median $0.5k, 90th $3k, Avg $1.1k), Media & Entertainment (Median $0.5k, 90th $3k, Avg $1.2k), Internet & Online Services (Median $0.4k, 90th $6k, Avg $3.1k), Cryptocurrency & Blockchain (Median $0.5k, 90th $3k, Avg $0.9k), Retail & E-commerce (Median $0.5k, 90th $2.5k, Avg $1.2k), Financial Services (Median $0.75k, 90th $3.4k, Avg $1.2k), Government (Median $0.3k, 90th $1.5k, Avg $0.7k), Travel & Hospitality (Median $0.5k, 90th $3k, Avg $1k).]
...
![Chart showing average, median, and 90th percentile bounties for high and critical vulnerabilities by industry: Telecoms (Median $2k, 90th $8.4k, Avg $4.2k), Automotive (Median $5k, 90th $5k, Avg $2.9k), Computer Software (Median $1k, 90th $12k, Avg $2.6k), Media & Entertainment (Median $3k, 90th $12.5k, Avg $3.2k), Internet & Online Services (Median $3.1k, 90th $21k, Avg $5.7k), Cryptocurrency & Blockchain (Median $10k, 90th $100k, Avg $24.8k), Retail & E-commerce (Median $2.5k, 90th $5k, Avg $2.4k), Financial Services (Median $5k, 90th $6k, Avg $3.3k), Government (Median $3.1k, 90th $7.5k, Avg $3.1k), Travel & Hospitality (Median $3k, 90th $7k, Avg $2.9k). Average bounty for all industries $3.7k, 90th percentile average for all industries $12k.]
...
![Diagram illustrating the Software Development Life Cycle (SDLC) and HackerOne's role. Stages include: Plan, Dev, Build, Test, Release, Ops, Monitor. HackerOne services are mapped to these stages: Code Security Audit (Development), Pentest (Automated Testing), Bug Bounty Program (Continuous Testing). Key concepts: Secure by design frameworks and libraries, Analysis on code changes and live applications, Secure auditing of your code base, Frequent testing to validate coverage, Continuous testing by security experts. Stage 1, Stage 2, Stage 3 are also indicated.]
...
![Diagram showing HackerOne services integrated into the SDLC: HackerOne Code Security Audit (DEV), HackerOne Pentest (Test), HackerOne Bug Bounty (Operate/Monitor).]
...
![Infographic showing estimated bounty cost if found in bug bounty program ($29,437), estimated bounty cost savings ($18,037), and a 40-hour Code Security Audit costing $11,400. Text: "Eliminating bugs before live user data is at risk: Priceless."][^2]
...
![Table listing Top Ten Vulnerabilities Surfaced in a Pentest and their Bug Bounty Ranking: 1. Misconfiguration (Bug Bounty Ranking 6), 2. Cross-site scripting (XSS) (1), 3. Information disclosure (3), 4. Improper access control - generic (2), 5. Using components with known vulnerabilities (8), 6. Insecure direct object reference (IDOR) (4), 7. Cryptographic (4), 8. Insufficient session expiration (3), 9. Violation of secure design principles (9), 10. Exploiting incorrectly configured SSL/TLS (14).]
...
54% increase in pentests since 2022
16% increase in the number of vulnerabilities being surfaced by pentests
15% of vulnerabilities found being rated as high or critical severity
...
![Table listing Top Ten Vulnerabilities Surfaced in a Bug Bounty and their Pentest Ranking: 1. Cross-site scripting (XSS) (Pentest Ranking 2), 2. Improper access control (4), 3. Information disclosure (3), 4. Insecure direct object reference (IDOR) (6), 5. Privilege escalation (23), 6. Misconfiguration (1), 7. Improper authentication - generic (11), 8. Business logic errors (5), 9. Open redirect (13), 10. Improper authorization (20).]
...
![Chart showing Platform Average Vulnerability Type by Industry: Improper access control - generic 13%, Information disclosure 11%, Cross-site scripting (XSS) - Reflected 10%, Insecure direct object reference (IDOR) 7%, Privilege escalation 5%, Cross-site scripting (XSS) - stored 5%, Misconfiguration 5%, Improper authentication - generic 3%, Business logic errors 3%, Cross-site scripting (XSS) - DOM 3%.]

![Detailed chart showing Vulnerability Type by Industry compared to Platform Average. Industries include Travel & Hospitality, Government, Telecoms, Automotive, Computer Software, Financial Services, Retail & E-commerce, Cryptocurrency & Blockchain, Internet & Online Services, Media & Entertainment. Vulnerability types are Improper access control - generic, Information disclosure, Cross-site scripting (XSS) - Reflected, Insecure direct object reference (IDOR), Privilege escalation, Cross-site scripting (XSS) - stored, Misconfiguration, Improper authentication - generic, Business logic errors, Cross-site scripting (XSS) - DOM. Each vulnerability type shows its percentage for each industry, with indicators for above, below, or average performance compared to the platform average.]
...
![Chart showing Platform Average High and Critical Vulnerabilities: Information disclosure 12%, Improper access control - generic 11%, Insecure direct object reference (IDOR) 9%, Cross-site scripting (XSS) - stored 8%, Privilege escalation 7%, Misconfiguration 7%, Improper authentication - generic 5%, SQL injection 4%, Cross-site scripting (XSS) - reflected 3%, Server-side request forgery (SSRF) 3%.]

![Detailed chart showing High and Critical Vulnerabilities by Industry compared to Platform Average. Industries include Travel & Hospitality, Government, Telecoms, Automotive, Computer Software, Financial Services, Retail & E-commerce, Cryptocurrency & Blockchain, Internet & Online Services, Media & Entertainment. Vulnerability types are Information disclosure, Improper access control - generic, Insecure direct object reference (IDOR), Cross-site scripting (XSS) - stored, Privilege escalation, Misconfiguration, Improper authentication - generic, SQL injection, Cross-site scripting (XSS) - reflected, Server-side request forgery (SSRF). Each vulnerability type shows its percentage for each industry, with indicators for above, below, or average performance compared to the platform average.]
...
2022 average days to remediation: 35.5
2023 average days to remediation: 25.5

![Chart showing The Median Time For Organizations To Resolve Vulnerabilities (in days) for 2022 and 2023 by industry: Telecoms (2022: 51, 2023: 46), Automotive (2022: 45, 2023: 21), Computer Software (2022: 43, 2023: 29), Media & Entertainment (2022: 39, 2023: 20), Internet & Online Services (2022: 31, 2023: 27), Cryptocurrency & Blockchain (2022: 15, 2023: 9), Retail & E-commerce (2022: 44, 2023: 21), Financial Services (2022: 26, 2023: 18), Government (2022: 89, 2023: 44), Travel & Hospitality (2022: 36, 2023: 26). Overall average days to remediation: 2022: 35.5, 2023: 25.5.]
...
![Chart showing how organizations measure the ROI of their HackerOne security program: Absence of incidents or breaches 71%, Estimated savings of reputational or customer-related impacts as a result of a security program 59%, Financial savings estimated from avoiding risk 54%, Risk assessment (internal or external) 51%, Agility and speed of security teams’ responsiveness 32%, Discount on cyber insurance 7%.]
