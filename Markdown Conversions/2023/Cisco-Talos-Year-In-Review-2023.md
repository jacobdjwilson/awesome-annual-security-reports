...
.................................................... 3
[Strategic findings and trends based on our vast data sets.](#strategic-findings-and-trends-based-on-our-vast-data-sets)
[Ransomware and extortion.](#ransomware-and-extortion)
.................................... 8
[A look at major changes and top players we observed in this dynamic threat space.](#a-look-at-major-changes-and-top-players-we-observed-in-this-dynamic-threat-space)
[Network infrastructure.](#network-infrastructure)
......................................... 13
[Threat actor and attack trends related to frequent, high-impact attacks on network devices.](#threat-actor-and-attack-trends-related-to-frequent-high-impact-attacks-on-network-devices)
[APTs: China.](#apts-china)
........................................................... 18
[Analysis on Chinese adversaries, including victimology and increased pace of operations.](#analysis-on-chinese-adversaries-including-victimology-and-increased-pace-of-operations)
[APTs: Russia.](#apts-russia)
......................................................... 21
[Major players, top threats and trends from our Ukraine Task Force and global monitoring efforts.](#major-players-top-threats-and-trends-from-our-ukraine-task-force-and-global-monitoring-efforts)
[APTs: Middle East.](#apts-middle-east)
................................................. 28
[A preview of the complex and often dire political climate that impacts the cyber threat landscape.](#a-preview-of-the-complex-and-often-dire-political-climate-that-impacts-the-cyber-threat-landscape)
[Commodity loaders: Qakbot, Emotet, Trickbot, IcedID, Ursnif .](#commodity-loaders-qakbot-emotet-trickbot-icedid-ursnif)
............ 32
[Major developments for these common threats, including activity trends and changes in TTPs.](#major-developments-for-these-common-threats-including-activity-trends-and-changes-in-ttps)
...
Ransomware, commodity loaders and APTs
...
*   Chinese President Xi Jinping meets with Russian President Vladimir Putin in Russia, while Japanese Prime Minister visits Ukraine in dueling diplomatic efforts
*   China brokers Iran-Saudi Arabia mediation
*   Chinese President Xi Jinping elected to a third five-year term
*   Clop ransomware actors begin exploiting zero-day vulnerability in the MOVEit file transfer software affecting hundreds of organizations
*   Ukrainian miliary begins counteroffensive to reclaim Russian-held territory
*   Anonymous Sudan claims DDoS attacks against Microsoft Outlook
*   Rebels depose Niger’s Western-allied president, causing global security implications
*   New Rhysida ransomware group likely responsible for attack that disrupts several U.S. hospitals
*   U.S., Japan, and South Korea presidents meet at summit aimed at countering threats from China and North Korea
*   Powerful earthquake kills more than 40,000 people in Turkey and Syria, prompting humanitarian crisis that threat actors commonly exploit for financial gain
*   U.S. downs suspected Chinese spy balloon, sparking international incident
*   “ESXiArgs” ransomware attacks infect thousands of servers worldwide

*A line graph shows the volume of suspicious activity over time, with the x-axis representing the month of 2023 from January to September, and the y-axis representing the volume of suspicious activity. The graph displays four lines, each representing a different region: North America (NA), Asia Pacific, Japan and China (APJC), Europe, the Middle East and Africa (EMEA), and Latin America (LATAM). The lines show varying levels of suspicious activity throughout the year, with spikes and dips corresponding to different events.*
...
*A pie chart shows the top initial access vectors, with the largest segment being "Unknown" at 32%, followed by "Compromised credentials on valid accounts" at 28%, "Phishing" at 23%, "Exploit vulnerability in public-facing application" at 19%, and "Drive-by compromise" at 6%.*

*A horizontal bar chart shows the top brands spoofed in sender names, including DocuSign, FedEx, Banco Bradesco, Walmart, DHL, Aeon, American Airlines, Royal Bank of Canada, Bank of America, Paypal, Capital One, Western Union, Google, American Express, and AT&T.*

*A pie chart shows the top blocked attachment file extensions, with the largest segment being "PDF" at 36%, followed by "Other" at 32%, "HTML" at 14%, "HTM" at 8%, "DOCX" at 5%, and "ZIP" at 5%.*
...
*A horizontal bar chart shows the volume of attacks using each technique and associated tactics. The techniques are listed on the y-axis, and the volume of attacks is represented by the length of the bars. The bars are colored according to the associated tactic, with a key indicating the color for each tactic: Defense evasion, Credential access, Collection, Command and control, Persistence, Privilege escalation, Lateral movement, Initial access, Impact, Execution, and Discovery.*
...
The ransomware space remained dynamic in 2023, with groups continuing
...
*   **FIGURE 1**
    *A bar chart shows the Talos IR ransomware and pre-ransomware incidents per sector. The y-axis represents the percentage of incidents, and the x-axis represents different sectors, including Healthcare, Public Health, Education, Government, Manufacturing, Financial Services, and Other. The Healthcare and Public Health sector has the highest percentage of incidents.*

*   **FIGURE 2**
    *A bar chart shows the number of posts made to ransomware data leak sites. The y-axis represents the number of posts, and the x-axis represents different ransomware groups, including LockBit, ALPHV, Clop, BianLian, and Others. LockBit has the highest number of posts.*
...
*   **FIGURE 3**
    *A line graph shows LockBit activity throughout the year. The x-axis represents the month of 2023, and the y-axis represents the number of posts made to the group's data leak site. The graph shows peaks in activity in March, and then again in August.*
