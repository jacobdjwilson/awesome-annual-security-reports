...
The official report URL is: https://snyk.io/blog/snyk-state-of-open-source-security-2023/
...
In late 2021, the vulnerability was discovered in Log4j — the open source logging library of applications and open source projects. Beyond that headlining vulnerability, bad actors continuously attempt to compromise users of package managers, like npm and Maven, and package repositories like PyPI, which are critical components in the distribution and updating of the broad open source ecosystem. The interconnectedness is so profound that even disgruntled maintainers of small but widely-adopted packages can adversely impact large swathes of the public internet. This is precisely what happened with the incident when an unhappy maintainer pulled down public repositories for a small JavaScript module that was used for aligning text, causing thousands of applications to cease functioning normally.
...
* 4% Less Frequently
* 10% Monthly
* 27% Continuously through automation
* 27% Daily
* 29% Weekly
...
* 66.8% We track all our dependencies - direct and indirect
* 25.5% We track direct dependencies
...
* 68% I use information in the registry or package manager
* 40% I use a tool like Snyk Advisor
* 34% I check the security scorecard
* 30% I look at repository ratings or package downloads statistics
* 20% I check that the project has an active community
* 15% I check that the project has a responsible disclosure policy
* 10% I look at the frequency of releases/ commits
* 5% I don’t check the safety of open source packages
...
**IN YOUR ORGANISATION, WHERE DO DEVELOPERS HAVE SECURITY TOOLS INTEGRATED INTO THEIR WORKFLOW?**

* 67% Build system
* 66% Build system
* 48% Pre-Commit Checks
* 45% CI/CD pipeline
* 40% IDE
* 30% CLI
* 4% Don’t know
...
Between the United States Executive Order on Improving the Nation’s Cybersecurity, the Cyber Resilience Act in the European Union, and a steady stream of supply chain attacks, the past year has brought increasing pressure on engineering and security teams to improve software supply chain security broadly and open source security in particular.
...
* 60.9% We implemented new tooling and practices to better handle supply chain vulnerabilities
* 53.2% We trained our development team to help them better understand supply chain vulnerabilities
* 52.7% We had to patch one or more supply chain vulnerabilities
* 12.4% We have not been impacted by open source software supply chain vulnerabilities in the past year
...
* 63.4% Increased code scan frequency
* 59.4% Added new security tooling
* 58.2% Applied patches more quickly
* 52.7% Gave development teams additional training
...
* 62.6% Implementing a software lifecycle security assurance process (for instance, using SLSA)
* 58.2% Implementing code signing for attribution and provenance (for instance using Sigstore)
* 55.9% Regular audits of our software supply chain
* 53.2% Implementing a formal software supply chain security program
* 42.1% Using software bill of materials (SBOMs)
...
* 68.1% Code scanning and security tools
* 57.9% Build tools
* 45.3% CI/CD tools
* 52.7% Dedicated supply chain security tool
...
* 76.5% Yes
* 11.6% No
* 6.8% We are not using AI code suggestion tools
* 5% Not sure
...
* 14.3% Deserialization
* 12.5% Prototype Pollution
* 7.1% Information Exposure
* 2.7% Remote Code
* 2.7% Directory Traversal
* 2.7% Arbitrary File Write
* 2.7% Arbitrary File Write
* 1.8% Command Injection
* 1.8% XML External Entity
* 1.8% Open Redirect
* 1.8% Improper Input Valid
* 1.8% Improper Verification
