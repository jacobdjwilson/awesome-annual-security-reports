...
## Table of Contents
  ...
  * [Cyberthreats 2023: Reality from the Front Lines](#cyberthreats-2023-reality-from-the-front-lines)
    * [Top Cyberthreat Concerns for 2023](#top-cyberthreat-concerns-for-2023)
    * [Adversaries Now Execute Myriad Attacks at Scale](#adversaries-now-execute-myriad-attacks-at-scale)
    * [Active Adversary Attacks Are Now Commonplace](#active-adversary-attacks-are-now-commonplace)
    * [Understanding Active Adversaries](#understanding-active-adversaries)
  * [Cybersecurity 2023: The State of the Defenders](#cybersecurity-2023-the-state-of-the-defenders)
    * [Top Cyber Risk Concerns](#top-cyber-risk-concerns)
    * [Differing Approaches to Alert Investigation](#differing-approaches-to-alert-investigation)
    * [Detection, Investigation and Response Overhead](#detection-investigation-and-response-overhead)
    * [Organizations Lack Essential Security Operations Skills](#organizations-lack-essential-security-operations-skills)
    * [Adversaries Have Outpaced Defenders](#adversaries-have-outpaced-defenders)
  * [The Business Impact](#the-business-impact)
    * [Program Delivery Impact](#program-delivery-impact)
    * [Financial Impact](#financial-impact)
    * [Team Impact](#team-impact)
  * [Recommendations](#recommendations)
    * [Strong Shields Are Essential](#strong-shields-are-essential)
    * [Address The Root Cause with People and Technology](#address-the-root-cause-with-people-and-technology)
    * [Accelerating the Defender Flywheel](#accelerating-the-defender-flywheel)
  * [Sophos Can Help](#sophos-can-help)
...
| Revenue                  | Count |
| ------------------------ | ----- |
| Less than $10,000,000    | 682   |
| $10 - $50 million        | 271   |
| $50 - $250 million       | 383   |
| $250 - $500 million      | 429   |
| $500 million - $1 billion | 676   |
| $1 - $5 billion          | 450   |
| $5 billion +             | 104   |
...
*Image Description: A graphic showing the survey parameters: <$10M - $5B+ Annual revenue, Jan/Feb 23 research conducted, 14 countries, 3,000 respondents, 100-5,000 employees.*
...
*Image Description: A table showing the percentage of respondents who consider each cyberthreat a top concern.*

*Quote: Thinking about 2023, which cyberthreats are you most concerned about affecting your organization? (n=3,000)*

### Adversaries Now Execute Myriad Attacks at Scale

The concerns of IT professional closely match the reality of what is happening on the front lines with 94% of organizations experienced at least one cyberattack in the last year. While ransomware was the most reported attack, adversaries execute a wide range of attacks at scale. This breadth and depth of attacks creates a considerable and growing challenge for defenders.
...
*Image Description: A graphic showing a selection of non-ransomware cyberattacks experienced and the percentage of organizations that reported them. The attacks listed are: Cyber Extortion (24%), Business Email Compromise (24%), Mobile Malware (21%), Malicious Email (27%), Data Exfiltration (by attacker) (26%), Phishing (including spear phishing) (27%), CryptoMiners (18%), Denial of Service (DDoS) (24%), Wipers (14%).*
...
*   **30%** say Active Adversaries are one of their top cyberthreat concerns for 2023
...
*Image Description: A bar chart showing Active Adversary Attack Experience by Revenue. The percentages are: Less than $10 million (11%), $10-$50 million (23%), $50-$250 million (22%), $250-$500 million (22%), $500 million to $1 billion (22%), $1 billion to $5 billion (24%), $5 billion plus (25%).*

*Quote: Have you experienced any cyberattack(s) in the last year? Yes - Active adversaries (human hands-on-keyboard attackers)*
...
*Image Description: A diagram showing an adversary attack sequence. The adversary makes multiple attempts to gain remote access, with some attempts blocked and one successful attempt leading to ransomware deployment.*
...
Zero-day attacks, i.e., attacks that take advantage of a previously unknown security vulnerability or software flaw, are in second position, rated a top three security risk at 26.8%. A shortage of in-house cybersecurity skills/expertise is third on the list, rated a top three security risk by 25% of respondents.
...
*Image Description: A graphic showing the top three cybersecurity risks: #1 Security Tool Misconfiguration (27.4%), #2 Zero-Day Threat (26.8%), #3 Shortage of In-House Cybersecurity Skills/Expertise (24.7%).*
...
*Image Description: A table showing the percentage of respondents who consider each cybersecurity risk a top three concern.*

*Quote: Who/ what do you consider to be your organization’s top three cybersecurity risks? Combination of responses ranked first, second and third (n=3,000)*
...
*Image Description: A table showing the median time to detect, investigate, and respond to an alert across different organization sizes and industries.*

*Quote: How long does it take for your organization to detect, investigate and, when necessary, remediate a potential incident? (n=2,812 respondents that investigate alerts in-house)*
...
*   **93%** find security operations challenging
*   **75%** find it hard to identify the root cause of the incident
*   **71%** struggle to identify which alerts to investigate

*Image Description: A bar chart showing the percentage of respondents who find security operations tasks 'very challenging' or 'somewhat challenging' when investigating suspicious alerts, broken down by revenue. The chart also shows the breakdown of which tasks are most challenging.*

*Quote: Respondents whose organization finds security operations tasks ‘very challenging’ or ‘somewhat challenging’ when investigating suspicious alerts (n=2,812 respondents that investigate security alerts in-house)*
...
*Image Description: A bar chart showing the percentage of respondents who agree that cyberthreats are too advanced for their organization to deal with on their own, broken down by revenue.*

*Quote: To what extent do you agree or disagree with the statement: cyberthreats are too advanced for our organization to deal with on their own? Strongly agree, somewhat agree (base numbers in chart)*
...
*Image Description: A bar chart showing the percentage of respondents who agree that dealing with cybersecurity incidents has negatively impacted the IT team's work on other projects, and who would like the IT team to spend more time on strategic issues and less time firefighting security incidents, broken down by revenue.*

*Quote: To what extent do you agree or disagree with the statement: Dealing with cybersecurity incidents has negatively impacted the IT team’s work on other projects, I would like the IT team to spend more time on strategic issues and less time firefighting security incidents (base numbers in chart)*
...
*Image Description: A bar chart showing the percentage of respondents who say that worrying about the organization being hit by a cyberattack keeps them up at night, broken down by revenue.*

*Quote: To what extent do you agree or disagree with the statement: Worrying about the organization being hit by a cyberattack sometimes keeps me up at night (base numbers in chart)*
...
*Image Description: A graphic showing the three key aspects of strong shields: Optimize Prevention, Reduce Exposure, Disrupt Attackers.*
...
*Image Description: A diagram showing the flow of security data from various security controls (Endpoint/EDR, Firewall, Email, Cloud, NDR, Identity, Network, Soho) into an XDR Data Lake, which then feeds into an Investigation and Response Platform and/or 24/7 Managed Detection and Response Services.*
...
*Image Description: A graphic showing the percentage of organizations that plan to adopt detection and response solutions within the next 12 months: EDR/XDR (78%), MDR (44%).*
...
*Image Description: A diagram showing the Sophos security ecosystem, including Security Control Points (Endpoint, Email, Cloud, Identity, Network), Outcome Optimization and Automation (Sophos Health Check, Solution Optimization, Sophos Factory, Orchestration and Automation), and Threat Detection and Response (Sophos MDR, Threat Response Platform, Sophos XDR, Sophos Endpoint EDR, Sophos Firewall and SASE, Sophos Email, Sophos Cloud, Sophos X-Ops, Sophos AI).*
