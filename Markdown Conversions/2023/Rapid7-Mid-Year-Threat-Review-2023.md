...
![1H 2023 Average Security Maturity (NIST Benchmark) chart]
...
![H1 2023 Initial Access Vectors chart]
...
![Ransomware incident distribution chart]

_Note: The number of incidents attributed to Cl0p in this chart is likely to be (significantly) low, since the group is still actively claiming new victims from their May 2023 zero-day attack on MOVEit Transfer._
...
**Block .one at the perimeter or email gateway.** Microsoft OneNote has been abused to spread malware and credential stealers, predominantly through phishing emails. This was the root cause of the majority of phishing incidents our team observed in 1H 2023.
