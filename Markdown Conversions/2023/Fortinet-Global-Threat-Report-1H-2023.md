...
*The image is a chart titled "Figure 1: Top malware families by type". It shows a table with five columns: Cryptominer, InfoStealer, Ransomware, and RAT. Under Cryptominer, the following are listed: XMRig Miner, CoinMiner, Monero, LemonDuck, MyKings, IntelRapid, and H2Miner. Under InfoStealer: Tofsee, Purple Fox, PhotoMiner, Formbook, Loki, RedLine stealer, Glupteba, Amadey, SmokeLoader, AVE_MARIA, KRBanker, and Snake Keylogger. Under Ransomware: Dridex, Conti, Lockbit, STOP Ransomware, DarkSide, TargetCompany Ransomware, GandCrab, BlackMatter Ransomware, TeslaCrypt, Sodinokibi, Mira, and Cuba Ransomware. Under RAT: Agent Tesla, Emotet, REMCOS, AVE_MARIA, NetWire RAT, NanoCoreRAT, Phorpiex, Cobalt Strike, AutoKMS, Neshta, OceanLotus, and Indexsinas.*
...
*The image is a chart titled "Figure 2: All CVEs by presence on endpoints and among attacks". It is a stacked bar chart with three sections: Unobserved on endpoints (blue), Observed on endpoints (yellow), and Observed and under attack (red). The red section is a small portion of the overall bar, with a note stating "About 0.7% of all CVEs observed on endpoints and under attack."*

*The image is a chart titled "Figure 3: CVEs for multiple platforms by presence on endpoints and among attacks". It shows six stacked bar charts, one each for Linux, Oracle, Google, Adobe, Microsoft, and Apple. Each bar is divided into three sections: Unseen on endpoints (blue), Seen on endpoints (yellow), and Seen & attacked (red). The proportions of each section vary across the different platforms.*
...
*The image is a timeline chart titled "Figure 4: Evolution of EPSS and exploitation for the MOVEit vulnerability". The timeline shows the progression of the MOVEit vulnerability from June 2 to June 26. Key events include: June 2: CVE Published, FortiGuard Labs released a Threat Signal, CISA adds CVE to KEV; June 3: EPSS scores 87% of CVEs lower than this one; June 13: Exploit on Github, NVD added details; June 14: Added into Intrigue, EPSS scores 97.8% of CVEs lower than this one; June 21: Added into Nuclei, NVD added details; June 23: Metasploit module published, Fortinet Outbreak Alert, Exploitation in the wild observed. The timeline is overlaid with a line chart showing the EPSS Percentile Rank increasing from 0% to 100% over the same period.*
...
*The image is a chart titled "Figure 5: Exploitation rate of vulnerabilities with different EPSS scores". It is a bar chart comparing the exploitation rates of vulnerabilities with top 1% EPSS scores versus bottom 50% EPSS scores. For the top 1%, the exploitation rate within one week of CVE publication is 22.3% and within one year is 85.3%. For the bottom 50%, the exploitation rate is <0.1% for both within one week and within one year. The chart includes the text: "A CVE that EPSS scores in the top 1% warrants your immediate attention because it’s over 300 times more likely to be exploited within a week than the majority of other vulnerabilities on your radar" and "... and that gap significantly widens over the first year".*
...
*The image is a table titled "Figure 6: ATT&CK techniques in cloud data by tactic". It displays the top 10 most detected techniques for each tactic within the MITRE ATT&CK framework. The tactics are: Initial Access, Execution, Persistence, Privilege Escalation, Defense Evasion, Credential Access, Discovery, Lateral Movement, Collection, Command and Control, Exfiltration, and Impact. Each tactic has a list of techniques with percentages, representing the prevalence of each technique. For example, under Initial Access, Replication Through Removable Media is at 60%, Phishing at 28%, Drive-by Compromise at 5%, Exploit Public-Facing Application at 4%, External Remote Services at 2%, and Valid Accounts at 1%. The other tactics have similar lists of techniques with their respective percentages.*
...
*The image is a table titled "Figure 7: Top ATT&CK techniques detected by FortiEDR by month". It shows the top 5 ATT&CK techniques detected by FortiEDR each month from January to May. The techniques are: Process Injection (Defense Evasion), Input Capture (Credential Access), OS Credential Dumping (Credential Access), Exploit Public-Facing Application (Initial Access), and Exploitation for Defense Evasion (Defense Evasion). The order of the techniques varies slightly from month to month.*
...
*The image is a screenshot of the MITRE ATT&CK Flow Builder, titled "Figure 8: MITRE ATT&CK Flow Builder - Example Flow". It shows a visual representation of an attack flow, with nodes representing different techniques and arrows indicating the sequence of actions. The flow includes Initial Access, Execution, Persistence, Privilege Escalation, Defense Evasion, Credential Access, Discovery, Lateral Movement, Collection, Command and Control, Exfiltration, and Impact.*

We’re also starting to incorporate standards in our reports, such as the Wintapix driver work published by two of our 
researchers.[^26]
...
appear exceedingly complex. However, the field is