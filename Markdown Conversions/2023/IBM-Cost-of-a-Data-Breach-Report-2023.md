...
**USD 4.45M: Average total cost of a breach**
...
**51%: Percentage of organizations planning to increase security investments as a result of a breach**
...
**USD 1.76M: The effect of extensive security AI and automation on the financial impact of a breach**
...
**1 in 3: Number of breaches identified by an organization’s own security teams or tools**
...
**USD 470,000: Additional cost experienced by organizations that didn’t involve law enforcement in a ransomware attack**
...
**53.3%: Since 2020, healthcare data breach costs have increased 53.3%**
...
**USD 1.68M: Cost savings from high levels of DevSecOps adoption**
...
**USD 1.49M: Cost savings achieved by organizations with high levels of IR planning and testing**
...
**USD 1.44M: Increase in data breach costs for organizations that had high levels of security system complexity**
...
**USD 1.02M: Average cost difference between breaches that took more than 200 days to find and resolve, and those that took less than 200 days**
...
![Chart showing global average total cost of a data breach: USD 4.45M]

![Figure 1: Total cost of a data breach from 2017 to 2023, showing a steady increase to USD 4.45 million]

![Figure 2: Per-record cost of a data breach from 2017 to 2023, showing an increase to USD 165]

![Figure 3: Cost of a data breach by country or region, with the United States at USD 9.48 million and Middle East at USD 8.07 million]

![Figure 4: Cost of a data breach by industry, with Healthcare at USD 10.93 million]

![Figure 5: Mean times to identify (MTTI) and contain (MTTC) breaches from 2017 to 2023]

![Figure 6: Cost of a data breach divided into four cost segments: Notification, Post-breach response, Detection and escalation, and Lost business cost]

![Figure 7: Cost of a data breach by head count, showing higher costs for smaller organizations in 2023]

![Figure 8: Percentage of organizations that increased the cost of services and products as a result of a data breach (57% Yes, 43% No)]

![Figure 9a/9b: Type of data compromised and per-record cost by type, with Customer PII being the costliest at USD 183]

### Initial attack vectors

![Figure 10: Cost and frequency of a data breach by initial attack vector, highlighting Malicious insider as the costliest at USD 4.90 million]

![Figure 11: Time to identify and contain a data breach by initial attack vector]

### Identifying attacks

![Figure 12: How breaches were identified (40% Benign third party, 33% Internal teams, 27% Disclosure from attacker)]

![Figure 13: Cost of a data breach by how the breach was identified, with Disclosure from attacker at USD 5.23 million]

![Figure 14: Time to identify and contain a breach by how the breach was identified]

### Data breach lifecycle

![Figure 15: Cost of a data breach based on the breach lifecycle (under 200 days vs over 200 days)]

### Key cost factors

![Figure 16: Impact of 27 factors on the mean cost of a data breach, showing cost mitigators and amplifiers]

![Figure 17: Cost of a data breach for organizations with a high level versus low level of three cost-amplifying factors]

![Figure 18: Cost of a data breach for organizations with a high level versus low level of three cost-mitigating factors]

### Ransomware and destructive attacks

![Figure 19: Share of total breaches by type of malicious attack]

![Figure 20: Cost of a ransomware or destructive attack]

![Figure 21: Share of ransomware attacks with law enforcement involved]

![Figure 22: Cost of a ransomware attack by law enforcement involvement]

![Figure 23: Time to identify and contain a ransomware attack with law enforcement involvement]

![Figure 24: Impact of automated response playbooks or workflows for ransomware on time to contain a ransomware breach]

![Figure 25: Cost of a ransomware attack based on whether the ransom was paid]

### Business partner supply chain attacks

![Figure 26: Cost of a data breach due to a business partner supply chain compromise]

![Figure 27: Time to identify and contain a data breach based on occurrence of a business partner supply chain compromise]

### Software supply chain attacks

![Figure 28: Cost of a data breach based on occurrence of a software supply chain compromise]

![Figure 29: Time to identify and contain a data breach based on occurrence of a software supply chain compromise]

### Regulatory environments

![Figure 30a/30b: Distribution over time of data breach costs in low-data versus high-data regulation environments]

![Figure 31: Cost of a data breach for critical infrastructure industries versus other industries]

![Figure 32: Percentage of organizations that incurred fines due to data breaches]

![Figure 33: Distribution of cost of fines incurred from a data breach]

### Cloud breaches

![Figure 34: Where the breached data was stored]

![Figure 35: Cost of a data breach by storage location of breached data]

![Figure 36: Time to identify and contain a data breach by storage location of breached data]

### Mega breaches

![Figure 37: The cost of mega breaches by number of records lost]

### Security investments

![Figure 38: Percentage of organizations increasing security investments after a breach]

![Figure 39: Most common investment types among those increasing security investments following a breach]

### Security AI and automation

![Figure 40: State of security AI and automation comparing three usage levels]

![Figure 41: Cost of a data breach by security AI and automation usage level]

![Figure 42: Extensive security AI and automation reduced the time to identify and contain a breach by more than 100 days]

[^1]: This study examined breaches sized between 2,200 and 102,000 records.
[^2]: Percentages for each attack type shown are out of total breaches; bars will not sum to 100%.
[^3]: Destructive attacks are defined as attacks that render systems inoperable.

---

te security AI and automation into
