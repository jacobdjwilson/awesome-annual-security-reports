# GRIT Ransomware Report 2023 ANNUAL REPORT

## Table of Contents
- [Methodology](#methodology)
- [Annual Ransomware Summary](#annual-ransomware-summary)
  - [Key Highlights](#key-highlights)
  - [Annual Ransomware Summary (cont'd)](#annual-ransomware-summary-contd)
- [2023 Ransomware Activity by the Numbers](#2023-ransomware-activity-by-the-numbers)
  - [Victim Posting Rates per Quarter](#victim-posting-rates-per-quarter)
  - [Most Impactful Ransomware Threat Groups - 2023](#most-impactful-ransomware-threat-groups---2023)
  - [Cumulative Victims by Threat Group - 2023](#cumulative-victims-by-threat-group---2023)
  - [Most Impacted Industries - 2023](#most-impacted-industries---2023)
  - [Geographic Breakdown of Ransomware Victims (2023)](#geographic-breakdown-of-ransomware-victims-2023)
  - [Most Impacted](#most-impacted)
- [2023 Threat Group Breakdown](#2023-threat-group-breakdown)
  - [2023 Activity by GRIT Taxonomy Classification](#2023-activity-by-grit-taxonomy-classification)
  - [Industry Victims by Taxonomy Classification](#industry-victims-by-taxonomy-classification)
  - [Industry Victims by Taxonomy Classification (cont'd)](#industry-victims-by-taxonomy-classification-contd)
  - [Geographic Victims by Taxonomy Classification](#geographic-victims-by-taxonomy-classification)
  - [Geographic Victims by Taxonomy Classification (cont'd)](#geographic-victims-by-taxonomy-classification-contd)
  - [Top 5 Countries By Taxonomy Classification](#top-5-countries-by-taxonomy-classification)
- [Ransomware in Depth: Major Events, Observations, and Trends in 2023](#ransomware-in-depth-major-events-observations-and-trends-in-2023)
  - [Rate of Posted Ransomware Victims vs Price of Bitcoin in USD (2023)](#rate-of-posted-ransomware-victims-vs-price-of-bitcoin-in-usd-2023)
  - [Rate of Posted Ransomware Victims vs Price of Bitcoin in USD, Outliers Removed (2023)](#rate-of-posted-ransomware-victims-vs-price-of-bitcoin-in-usd-outliers-removed-2023)
  - [Rate of Posted Ransomware Victims vs Price of Bitcoin in USD, Outliers Removed (2023) (cont'd)](#rate-of-posted-ransomware-victims-vs-price-of-bitcoin-in-usd-outliers-removed-2023-contd)
  - [Major Events in Ransomware: 2023 at a Glance](#major-events-in-ransomware-2023-at-a-glance)
  - [Major Events in Ransomware: Clop’s MOVEit Campaign](#major-events-in-ransomware-clops-moveit-campaign)
  - [Major Events in Ransomware: Scattered Spider attacks Major Casinos](#major-events-in-ransomware-scattered-spider-attacks-major-casinos)
  - [Major Events in Ransomware: LockBit’s new Affiliate Rules](#major-events-in-ransomware-lockbits-new-affiliate-rules)
  - [Major Events in Ransomware: SEC Updates Guidance on incident notifications](#major-events-in-ransomware-sec-updates-guidance-on-incident-notifications)
  - [Major Events in Ransomware: Law Enforcement Disruption of Alphv](#major-events-in-ransomware-law-enforcement-disruption-of-alphv)
  - [Major Events in Ransomware: Published Decryptors impact Ransomware Operations](#major-events-in-ransomware-published-decryptors-impact-ransomware-operations)
  - [Types of ransomware – single, double, triple extortion](#types-of-ransomware--single-double-triple-extortion)
  - [Blurring of the Ransomware/Data-Theft Divide](#blurring-of-the-ransomwaredata-theft-divide)
  - [The Rise of Data Extortion Operations](#the-rise-of-data-extortion-operations)
  - [Data Extortion Group Examples](#data-extortion-group-examples)
  - [Incentives for deceit/fabrication](#incentives-for-deceitfabrication)
  - [Hacktivism and data extortion](#hacktivism-and-data-extortion)
  - [Ephemeral and “No Name” Groups defined](#ephemeral-and-no-name-groups-defined)
  - [Use of Leaked Builders and Commodity Malware by Ephemeral Groups](#use-of-leaked-builders-and-commodity-malware-by-ephemeral-groups)
    - [Observed Behavior](#observed-behavior)
    - [Risks](#risks)
  - [Novel Coercive Techniques in 2023](#novel-coercive-techniques-in-2023)
    - [Intent and effectiveness](#intent-and-effectiveness)
    - [Assessed future use](#assessed-future-use)
    - [Novel Coercive Techniques Defined](#novel-coercive-techniques-defined)
    - [Examples of Novel Coercive Techniques in 2023](#examples-of-novel-coercive-techniques-in-2023)
      - [BlogXX releases patient information](#blogxx-releases-patient-information)
      - [LockBit releases failed negotiation chats](#lockbit-releases-failed-negotiation-chats)
      - [Alphv releases cancer patient photos](#alphv-releases-cancer-patient-photos)
      - [Medusa publishes student data](#medusa-publishes-student-data)
      - [Additional Alphv publicity seeking behavior](#additional-alphv-publicity-seeking-behavior)
      - [LockBit's use of social media bot accounts in October](#lockbits-use-of-social-media-bot-accounts-in-october)
      - [Hunters International Extorts Healthcare Client](#hunters-international-extorts-healthcare-client)
- [Signposts of Ransomware Activity and 2024 Outlook](#signposts-of-ransomware-activity-and-2024-outlook)
  - [Signpost analysis defined](#signpost-analysis-defined)
...
Total Publicly Posted Ransomware Victims: 4,519
...
![Chart showing total posts, average posts per week, total groups, and average groups per week by month for 2023](https://example.com/chart1.png)

Total Posts: 4,519
Average Posts / Week: 86.9
Total Groups: 63
Average Groups / Week: 16.6

### Victim Posting Rates per Quarter

![Bar chart comparing victim posting rates per quarter for 2021, 2022, and 2023, and a bar chart of most impactful ransomware threat groups in 2023 by quarter](https://example.com/chart2.png)
...
(Data for this section is part of the chart above, showing groups like LockBit, Alphv, Clop, Play, 8Base, Bianlian, Akira, Medusa, Royal, NoEscape across quarters.)

### Cumulative Victims by Threat Group - 2023

![Line chart showing cumulative victims by top 10 threat groups over 2023](https://example.com/chart3.png)
...
![Bar chart showing the number of victims per industry in 2023, with a list of top groups impacting the top 5 industries](https://example.com/chart4.png)
...
![Line chart showing post rates per month by GRIT taxonomy classification (Established, Developing, Rebrand, Emerging, Ephemeral) for 2023](https://example.com/chart5.png)
...
| Group Type | Victim Industry | Number of Public Victims |
|---|---|---|
| **Established** | Manufacturing | 440 |
| | Technology | 274 |
| | Healthcare | 158 |
| | Banking and Finance | 213 |
| | Retail and Wholesale | 205 |
| **Emerging** | Government | 13 |
| | Manufacturing | 11 |
| | Entertainment, Hospitality, & Tourism | 8 |
| | Healthcare | 8 |
| | Technology | 5 |
| **Developing** | Manufacturing | 53 |
| | Consulting | 37 |
| | Legal | 35 |
| | Construction | 30 |
| | Education | 25 |
| **Ephemeral** | Manufacturing | 12 |
| | Healthcare | 6 |
| | Education | 6 |
| | Technology | 5 |
| | Construction | 5 |
| **Rebrand** | Government | 13 |
| | Manufacturing | 11 |
...
### Industry Victims by Taxonomy Classification (cont'd)

![Bar chart showing the percentage of victims per industry across all group classifications (Rebrand, Ephemeral, Emerging, Developing, Established)](https://example.com/chart6.png)
...
![Map showing geographic distribution of victims by Established and Developing ransomware groups](https://example.com/chart7.png)

### Geographic Victims by Taxonomy Classification (cont'd)

![Map showing geographic distribution of victims by Emerging and Ephemeral ransomware groups](https://example.com/chart8.png)
...
![Line chart comparing the rate of posted ransomware victims with the price of Bitcoin in USD for 2023](https://example.com/chart9.png)

### Rate of Posted Ransomware Victims vs Price of Bitcoin in USD, Outliers Removed (2023)

![Line chart comparing the rate of posted ransomware victims with the price of Bitcoin in USD for 2023, with outliers removed](https://example.com/chart10.png)
...
![Continuation of line chart comparing the rate of posted ransomware victims with the price of Bitcoin in USD for 2023, with outliers removed](https://example.com/chart11.png)
...
> - Discourages Ransom Payments or Reduces Ransomware Operations
> - Has no Impact on Ransom Payments or Ransomware Operations
> - Encourages Ransom Payments or Increases Ransomware Operations
>
> **Assessed Direction of Trend**
> - Likely to Decrease in Frequency
> - Unlikely to Increase or Decrease in Frequency
> - Likely to Increase in Frequency

| Trend | Impact on Ransomware | Direction in 2024 |
|---|---|---|
| Posted ransomware victims continue to increase in volume. Increases in ransomware victim volume are expected to continue until the point of saturation, with additional actors seeking entry while prospects of revenue generation remain. | Encourages Ransom Payments or Increases Ransomware Operations | Likely to Increase in Frequency |
| Instances of novel coercive techniques increase in frequency and sophistication. Effective and novel coercive techniques are expected to continue, with fear of reputational impacts, news coverage, and client/customer extortion impacting willingness of some victims to pay. | Encourages Ransom Payments or Increases Ransomware Operations | Likely to Increase in Frequency |
| Additional ransomware builders of Established ransomware groups, and/or commodity malware are released or leaked. Sporadic. | Encourages Ransom Payments or Increases Ransomware Operations | Unlikely to Increase or Decrease in Frequency |

---

leaks of ransomware builders and commodity
