...
- [Executive Summary](#executive-summary)
  - [Who is Behind Data Breaches?](#who-is-behind-data-breaches)
  - [How Do Breaches Occur?](#how-do-breaches-occur)
  - [What Commonalities Exist?](#what-commonalities-exist)
  - [Where Should Mitigation Efforts Be Focused?](#where-should-mitigation-efforts-be-focused)
...
- [Threat Agents](#threat-agents)
  - [Breach Size by Threat Agents](#breach-size-by-threat-agents)
...
Because fraud alerts are the leading method of discovering breaches, it stands to reason that many breaches could occur without anyone being the wiser if the criminal decided it was in his best interest to be patient.
...
![Figure 1. Industry groups represented by percent of breaches: Financial Services (33%), Hospitality (23%), Retail (15%), Manufacturing (6%), Tech Services (5%), Business Services (4%), Government (4%), Media (4%), Healthcare (3%), Other (4%)]

### Figure 1. Industry groups represented by percent of breaches
| Industry Group | Percent of Breaches |
| :--- | :--- |
...
![Figure 2. Compromised records by industry group: Financial Services accounts for 94%, Other Industries account for 6%]
...
![Figure 4. Organizational size by percent of breaches (number of employees): Over 100,000 (2%), 10,001 to 100,000 (20%), 1,001 to 10,000 (26%), 101 to 1,000 (23%), 11 to 100 (18%), 1 to 10 (9%)]

### Figure 4. Organizational size by percent of breaches (number of employees)
| Number of Employees | Percent of Breaches |
| :--- | :--- |
| Over 100,000 | 2% |
...
![Figure 5. Threat agents (inclusive) by percent of breaches: External (70% / 62%), Internal (48% / 46%), Partner (11% / 10%)]

### Figure 5. Threat agents (inclusive) by percent of breaches
| Agent Category | Confirmed Breaches | Suspected Breaches |
| :--- | :--- | :--- |
| External | 70% | 62% |
| Internal | 48% | 46% |
| Partner | 11% | 10% |
...
![Figure 6. Threat agents over time by percent of breaches (2005-2009) comparing Verizon (VZ) External, Internal, Partner with USSS External, Internal, Partner]
...
| Agent Category (Exclusive) | Percent of Breaches |
| :--- | :--- |
| External only | 45% |
| Internal only | 27% |
| Partner only | 1% |
...
| Threat Agent Category | Compromised Records |
| :--- | :--- |
| External only | 138,566,355 |
| Internal only | 2,640,240 |
| Partner only | 130 |
| Multiple agents | 2,436,297 |
...
| Threat Agent Category | Compromised Records |
| :--- | :--- |
| External only | 800,720,651 |
| Internal only | 28,853,827 |
| Partner only | 43,744,573 |
| Multiple agents | 46,451,904 |
...
| External Agent Type | Percent of Breaches |
| :--- | :--- |
...
![Figure 10. Percent of compromised records attributed to organized crime: Organized criminal groups (85%), Other agents (15%)]

### Figure 10. Percent of compromised records attributed to organized crime
- **Organized criminal groups**: 85%
- **Other agents**: 15%
...
| Geographic Origin | Percent of Breaches |
| :--- | :--- |
...
### Internal Agents
*(48% of breaches, 3% of records)*

![Figure 12. Role of internal agents by percent of breaches within Internal: Deliberate (90%), Inappropriate (6%), Unintentional (4%)]
...
| Internal Agent Type | Percent of Breaches |
| :--- | :--- |
...
### Partner Agents
*(11% of breaches, 1% of records)*

![Figure 13. Role of partner agents by percent of breaches within Partner: Another agent via partner (8), Deliberate (6), Unintentional (1)]

### Figure 13. Role of partner agents by percent of breaches within Partner
- **Another agent via partner**: 8
- **Deliberate**: 6
- **Unintentional**: 1
...
| Partner Agent Type | Percent of Breaches |
| :--- | :--- |
...
### Figure 15. Flashback: Threat action categories by percent of breaches in Financial Services (2008 Supplemental DBIR)
| Category | Percent of Breaches |
| :--- | :--- |
| Malware | 23% |
| Hacking | 26% |
| Social | 42% |
...
![Figure 16. Threat action categories over time by percent of breaches (Verizon cases, 2005-2009) showing Malware, Hacking, Social, Misuse, Physical, Error, Environmental]

![Figure 17. Threat actions over time by percent of breaches (USSS cases, 2007-2009) showing Malware, Hacking, Social, Misuse]
