...
## Purpose
Provide a concise two-sentence summary of a security report (50-80 words) highlighting the report's main focus, methodology, and key quantitative findings.
...
6. **Word Count**: MUST be between 50-80 words.
...
6. **Word Count**: Strictly between 50-80 words (count every word).
